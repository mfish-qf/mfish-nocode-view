...
type _BuildPropType<T, V, C> =
  ...
  | V
  | C;
export type BuildPropType<T, V, C> = _BuildPropType<IfUnknown<T, never>,
  IfUnknown<V, never>,
  IfUnknown<C, never>>;
 ...
 */
export function buildProp<T = never,
...
export const buildProps = <O extends {
  ...
  fromPairs(
    ...
    [K in keyof O]: O[K] extends { [propKey]: boolean }
      ...
      : [O[K]] extends NativePropType
        ? O[K]
        : O[K] extends BuildPropOption<infer T,
