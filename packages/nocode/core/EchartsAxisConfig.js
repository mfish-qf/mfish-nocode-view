...
const z = { style: { display: "flex", gap: "2px" } }, F = { class: "check-group" }, A = b(e({ __name: "EchartsGridConfig", setup(e2) {
  ...
  return (e3, a2) => (i(), d("div", { class: n(o(L2)) }, [v("div", M, [a2[2] || (a2[2] = c(" 线条颜色 ", -1)), v("div", null, [s(o(T), { placeholder: "设置线条颜色，格式#FFFFFF", type: 1, value: w2.value, onConfirmChange: A2, onInputChange: E2 }, null, 8, ["value"])])]), v("div", X, [a2[3] || (a2[3] = c(" 线条类型 ", -1)), s(o(x), { size: "small", value: U2.value, "onUpdate:value": a2[0] || (a2[0] = (e4) => U2.value = e4), onChange: W2 }, { default: u(() => [(i(), d(h, null, p(I2, (e4, a3) => s(o(m), { key: a3, value: e4.value }, { default: u(() => [c(g(e4.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])]), v("div", j, [a2[4] || (a2[4] = c(" 线条宽度 ", -1)), s(o(y), { value: F2.value, "onUpdate:value": a2[1] || (a2[1] = (e4) => F2.value = e4), min: 1, max: z2.value, onChange: O2 }, null, 8, ["value", "max"])])], 2));
  ...
  return l(() => z2.getCurConfigComponent, (e3) => {
    ...
    const r2 = C("AInput");
    return i(), d("div", { class: n(o(U2)) }, [s(_, { title: `${e2.axisType}轴配置`, "default-expand": false, "allow-check": true, "title-check": e2.axis?.show, onChecked: de }, { default: u(() => [v("div", W, [c(g(`${e2.axisType}轴位置`) + " ", 1), s(o(x), { size: "small", value: Z.value, "onUpdate:value": l2[0] || (l2[0] = (e3) => Z.value = e3), onChange: Se }, { default: u(() => [(i(true), d(h, null, p(ee[e2.axisType], (e3, a3) => (i(), t(o(m), { key: a3, value: e3.value }, { default: u(() => [c(g(e3.title), 1)]), _: 2 }, 1032, ["value"]))), 128))]), _: 1 }, 8, ["value"])]), s(_, { title: "名称配置" }, { default: u(() => [v("div", O, [v("div", null, [s(r2, { value: F2.value, "onUpdate:value": l2[1] || (l2[1] = (e3) => F2.value = e3), "show-count": "", maxlength: 50, onChange: ve }, null, 8, ["value"])])]), s(I, { "hide-font-style": [o(w).Underline, o(w).Strikethrough], "color-type": 1, "text-style": A2.value, onFontChange: ce, onSizeChange: ce, onColorChange: ce, onHAlignChange: re, onFontStyleChange: se }, null, 8, ["hide-font-style", "text-style"])]), _: 1 }), s(_, { title: "标签配置", "default-expand": false, "allow-check": true, "title-check": e2.axis?.axisLabel?.show, onChecked: he }, { default: u(() => [v("div", Y, [l2[11] || (l2[11] = c(" 标签间隔 ", -1)), s(o(x), { size: "small", value: X2.value, "onUpdate:value": l2[2] || (l2[2] = (e3) => X2.value = e3), onChange: pe }, { default: u(() => [(i(), d(h, null, p(N, (e3) => s(o(m), { key: e3.value, value: e3.value }, { default: u(() => [c(g(e3.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])]), s(I, { "hide-font-style": [o(w).Underline, o(w).Strikethrough], "hide-align": true, "color-type": 1, "text-style": M2.value, onFontChange: xe, onSizeChange: xe, onColorChange: xe, onFontStyleChange: fe }, null, 8, ["hide-font-style", "text-style"]), v("div", $, [l2[12] || (l2[12] = c(" 标签与轴线间距 ", -1)), s(o(y), { value: te.value, "onUpdate:value": l2[3] || (l2[3] = (e3) => te.value = e3), min: -100, max: 100, onChange: ge }, null, 8, ["value"])]), v("div", B, [l2[13] || (l2[13] = c(" 标签角度 ", -1)), s(o(y), { value: ie.value, "onUpdate:value": l2[4] || (l2[4] = (e3) => ie.value = e3), min: -90, max: 90, onChange: Ce }, null, 8, ["value"])]), v("div", G, [l2[14] || (l2[14] = c(" 标签格式 ", -1)), v("div", null, [s(r2, { value: ne.value, "onUpdate:value": l2[5] || (l2[5] = (e3) => ne.value = e3), placeholder: "格式{value}kg 详情参考echarts formatter属性", onChange: me }, null, 8, ["value"])])])]), _: 1 }, 8, ["title-check"]), s(_, { title: "轴线配置", "default-expand": false, "allow-check": true, "title-check": e2.axis?.axisLine?.show, onChecked: ye }, { default: u(() => [s(E, { "axis-type": e2.axisType, "line-style": e2.axis?.axisLine?.lineStyle, onLineStyleChange: be }, null, 8, ["axis-type", "line-style"]), v("div", H, [l2[15] || (l2[15] = c(" 轴线箭头 ", -1)), s(o(x), { size: "small", value: R.value, "onUpdate:value": l2[6] || (l2[6] = (e3) => R.value = e3), onChange: Le }, { default: u(() => [(i(), d(h, null, p(V, (e3, a3) => s(o(m), { key: a3, value: e3.value }, { default: u(() => [c(g(e3.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])])]), _: 1 }, 8, ["title-check"]), s(_, { title: "刻度配置", "default-expand": false, "allow-check": true, "title-check": e2.axis?.axisTick?.show, onChecked: ke }, { default: u(() => [v("div", q, [l2[16] || (l2[16] = c(" 刻度方向 ", -1)), s(o(x), { size: "small", value: P.value, "onUpdate:value": l2[7] || (l2[7] = (e3) => P.value = e3), onChange: Te }, { default: u(() => [(i(), d(h, null, p(Q, (e3, a3) => s(o(m), { key: a3, value: e3.value }, { default: u(() => [c(g(e3.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])]), v("div", D, [l2[17] || (l2[17] = c(" 刻度类型 ", -1)), s(o(x), { size: "small", value: ae.value, "onUpdate:value": l2[8] || (l2[8] = (e3) => ae.value = e3), onChange: Ue }, { default: u(() => [(i(), d(h, null, p(le, (e3, a3) => s(o(m), { key: a3, value: e3.value }, { default: u(() => [c(g(e3.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])]), v("div", J, [l2[18] || (l2[18] = c(" 刻度长度 ", -1)), s(o(y), { value: oe.value, "onUpdate:value": l2[9] || (l2[9] = (e3) => oe.value = e3), min: 1, max: K2.value, onChange: _e }, null, 8, ["value", "max"]), l2[19] || (l2[19] = c(" 刻度宽度 ", -1)), s(o(y), { value: ue.value, "onUpdate:value": l2[10] || (l2[10] = (e3) => ue.value = e3), min: 1, max: j2.value, onChange: we }, null, 8, ["value", "max"])])]), _: 1 }, 8, ["title-check"]), s(_, { title: "分隔线配置", "default-expand": false, "allow-check": true, "title-check": e2.axis?.splitLine?.show, onChecked: Ie }, { default: u(() => [s(E, { "axis-type": e2.axisType, "line-style": e2.axis?.splitLine.lineStyle, onLineStyleChange: ze }, null, 8, ["axis-type", "line-style"])]), _: 1 }, 8, ["title-check"])]), _: 1 }, 8, ["title", "title-check"])], 2);
  };
