...
import { u as S, h as L, _ as b, n as T, f as _, T as w, ao as U } from "./index.js";
import "@vueuse/core";
...
const z = { style: { display: "flex", gap: "2px" } }, F = { class: "check-group" }, A = b(e({ __name: "EchartsGridConfig", setup(e2) {
  ...
  function pe() {
    T2.value.axisLabel = { ...T2.value.axisLabel, interval: M2.value }, b2("axisChange", T2.value);
  }
  function ge() {
  ...
  return l(() => z2.getCurConfigComponent, (e3) => {
    e3 && function() {
      ...
      A2.value.fontStyle = { ...a2, ...l2 }, A2.value.hAlignType = "start" === (e4 == null ? void 0 : e4.nameLocation) ? "left" : "end" === (e4 == null ? void 0 : e4.nameLocation) ? "right" : e4 == null ? void 0 : e4.nameLocation, void 0 !== ((_g = e4 == null ? void 0 : e4.axisLabel) == null ? void 0 : _g.interval) && (M2.value = (_h = e4 == null ? void 0 : e4.axisLabel) == null ? void 0 : _h.interval);
