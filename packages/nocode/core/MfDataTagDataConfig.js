...
const D = v(t({ __name: "MfDataTagDataConfig", setup(t2) {
  ...
  function M(t3) {
    t3.length > 0 ? (D2("icon", t3), I()) : (x("icon"), F(v2.getCurConfigComponent.chart));
  }
  return (t3, a2) => {
    const u2 = e("AInput");
    return o(), n(g, { class: i(l(j)), onRefreshData: w }, { "data-select": s(() => [d(t3.$slots, "data-select", {}, void 0, true)]), "static-data": s(() => [a2[1] || (a2[1] = c("div", { class: "title" }, "标签内容", -1)), r(u2, { value: l(v2).getCurConfigComponent.chart.data.dataSet.title, "onUpdate:value": a2[0] || (a2[0] = (t4) => l(v2).getCurConfigComponent.chart.data.dataSet.title = t4), "show-count": "", maxlength: 50 }, null, 8, ["value"]), a2[2] || (a2[2] = c("div", { class: "title" }, "图标", -1)), r(l(f), { value: l(v2).getCurConfigComponent.chart.data.dataSet.icon, onChange: T }, null, 8, ["value"])]), "target-data": s(() => [a2[3] || (a2[3] = c("div", { class: "title" }, "标签内容", -1)), r(C, { "max-count": 1, height: 150, onDataChange: A, fields: b.value }, null, 8, ["fields"]), a2[4] || (a2[4] = c("div", { class: "title" }, "图标", -1)), r(C, { "max-count": 1, height: 150, onDataChange: M, fields: k.value }, null, 8, ["fields"])]), _: 3 }, 8, ["class"]);
  };
