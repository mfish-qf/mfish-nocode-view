...
import { u as C, j as g, aq as m, _ as h } from "./index.js";
...
const D = h(t({ __name: "MfMapChunksDataConfig", setup(t2) {
  ...
  return (t3, a2) => (n(), e(f, { class: o(s(S)), onRefreshData: b }, { "data-select": i(() => [d(t3.$slots, "data-select", {}, void 0, true)]), "static-data": i(() => [l(p, { title: "地图数据", data: J.value, onDataChange: y }, null, 8, ["data"])]), "target-data": i(() => [a2[0] || (a2[0] = r("div", { class: "title" }, "区域", -1)), l(c, { "max-count": 1, height: 100, onDataChange: M, fields: k.value }, null, 8, ["fields"]), a2[1] || (a2[1] = r("div", { class: "title" }, "数据值", -1)), l(c, { "max-count": 1, height: 100, onDataChange: q, fields: F.value }, null, 8, ["fields"])]), _: 3 }, 8, ["class"]));
