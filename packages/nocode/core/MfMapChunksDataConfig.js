...
const D = h(t({ __name: "MfMapChunksDataConfig", setup(t2) {
  const h2 = C(), { setFields: D2, deleteFields: v, getFields: _, setDataTable: x } = g(), { prefixCls: S } = u("map-chunks-data-config"), { resetDefault: j } = m(), k = a(() => {
    var _a;
    return h2.getCurConfigComponent.chart.data.fields ? ((_a = h2.getCurConfigComponent.chart.data.fields) == null ? void 0 : _a.name) ?? [] : [];
  }), F = a(() => {
    var _a;
  ...
  const I = (t3, a2) => {
    (a2 == null ? void 0 : a2.length) > 0 ? D2(t3, a2) : v(t3), b();
  };
  function M(t3) {
    I("name", t3);
  }
