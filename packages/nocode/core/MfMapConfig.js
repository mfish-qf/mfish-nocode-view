...
const B = R(o({ __name: "MfColorIntervalConfig", props: { themeColors: { type: Array, default: () => [] } }, setup(o2) {
  ...
  return t(() => d2.themeColors, (o3) => {
    ...
    }(n3) }, null, 8, ["onClick"])) : g("", true)]))), 128)), c(n2, { onClick: w2 }, { icon: p(() => [c(r(A), { icon: "ant-design:plus-outlined" })]), default: p(() => [e2[3] || (e2[3] = m(" 添加区间颜色 ", -1))]), _: 1, __: [3] })]), _: 1 })], 2);
  };
  ...
  }, { immediate: true }), (o3, e2) => (l(), f(v, { class: s(r(a2)) }, { default: p(() => [c(_, { onThemeChange: h2 }), c(M), c(r(x), { checked: i2.value, "onUpdate:checked": e2[0] || (e2[0] = (o4) => i2.value = o4), onChange: C2 }, { default: p(() => e2[1] || (e2[1] = [m(" 提示框", -1)])), _: 1, __: [1] }, 8, ["checked"]), d(o3.$slots, "default", {}, void 0, true), c(B, { "theme-colors": u2.value }, null, 8, ["theme-colors"])]), _: 3 }, 8, ["class"]));
