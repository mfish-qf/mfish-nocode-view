...
import { u as b, f as k, aq as E, _ as M, n as x, ap as R } from "./index.js";
...
const A = { class: "title" }, B = { key: 0, class: "title" }, L = M(e({ __name: "MfEffectScatterConfig", setup(e2) {
  ...
  n(() => v2.getCurConfigComponent, (e3) => {
    var _a, _b, _c;
    e3 && ((_a = v2.getCurConfigComponent.chart.options.series) == null ? void 0 : _a.length) > 1 && (void 0 !== v2.getCurConfigComponent.chart.options.series[1].symbol && (y2.value = v2.getCurConfigComponent.chart.options.series[1].symbol), void 0 !== v2.getCurConfigComponent.chart.options.series[1].symbolSize && (R2.value = v2.getCurConfigComponent.chart.options.series[1].symbolSize), void 0 !== v2.getCurConfigComponent.chart.options.series[1].symbolRotate && (U2.value = v2.getCurConfigComponent.chart.options.series[1].symbolRotate), void 0 !== ((_b = v2.getCurConfigComponent.chart.options.series[1].label) == null ? void 0 : _b.show) && (j2.value = v2.getCurConfigComponent.chart.options.series[1].label.show), void 0 !== ((_c = v2.getCurConfigComponent.chart.options.series[1].rippleEffect) == null ? void 0 : _c.brushType) && (M2.value = v2.getCurConfigComponent.chart.options.series[1].rippleEffect.brushType));
  }, { immediate: true });
  ...
  return n(() => o2.themeColors, (e3) => {
    ...
    const t2 = h("AButton");
    return a(), i("div", { class: l(s(d2)) }, [r(k, { title: "颜色区间配置", "default-expand": true }, { default: u(() => [(a(true), i(c, null, g(y2.value, (e4, t3) => (a(), i("div", { class: "title", key: t3 }, [o3[0] || (o3[0] = f(" 区间颜色 ")), p("div", null, [r(s(x), { type: 1, placeholder: "设置区间颜色，格式#FFFFFF", value: e4, "hide-cancel": true, "hide-confirm": true, onInputChange: (e5) => function(e6, o4) {
  ...
  }, { immediate: true }), (e3, o2) => (a(), v(d, { class: l(s(i2)) }, { default: u(() => [r(y, { onThemeChange: g2 }), r(_), r(s(U), { checked: p2.value, "onUpdate:checked": o2[0] || (o2[0] = (e4) => p2.value = e4), onChange: c2 }, { default: u(() => o2[1] || (o2[1] = [f(" 提示框")])), _: 1 }, 8, ["checked"]), r(L), r(q, { "theme-colors": C2.value }, null, 8, ["theme-colors"])]), _: 1 }, 8, ["class"]));
