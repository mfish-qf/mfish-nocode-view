...
import { u as b, h as k, aq as M, _ as E, M as x, ap as R } from "./index.js";
...
const A = { class: "title" }, B = { key: 0, class: "title" }, L = E(e({ __name: "MfEffectScatterConfig", setup(e2) {
  const { prefixCls: h2 } = F("effect-scatter-config"), v2 = b(), { getSeries: d2 } = M(), _2 = o("circle"), y2 = [{ title: "圆形", value: "circle" }, { title: "方形", value: "rect" }, { title: "三角形", value: "triangle" }, { title: "菱形", value: "diamond" }, { title: "定位", value: "pin" }, { title: "箭头", value: "arrow" }], E2 = o("stroke"), x2 = [{ title: "描边", value: "stroke" }, { title: "填充", value: "fill" }], R2 = o(10), U2 = o(0), j2 = o(true), T2 = o(3), L2 = t(() => {
    var _a;
  ...
  n(() => v2.getCurConfigComponent, (e3) => {
    var _a, _b, _c;
    e3 && ((_a = v2.getCurConfigComponent.chart.options.series) == null ? void 0 : _a.length) > 1 && (void 0 !== v2.getCurConfigComponent.chart.options.series[1].symbol && (_2.value = v2.getCurConfigComponent.chart.options.series[1].symbol), void 0 !== v2.getCurConfigComponent.chart.options.series[1].symbolSize && (R2.value = v2.getCurConfigComponent.chart.options.series[1].symbolSize), void 0 !== v2.getCurConfigComponent.chart.options.series[1].symbolRotate && (U2.value = v2.getCurConfigComponent.chart.options.series[1].symbolRotate), void 0 !== ((_b = v2.getCurConfigComponent.chart.options.series[1].label) == null ? void 0 : _b.show) && (j2.value = v2.getCurConfigComponent.chart.options.series[1].label.show), void 0 !== ((_c = v2.getCurConfigComponent.chart.options.series[1].rippleEffect) == null ? void 0 : _c.brushType) && (E2.value = v2.getCurConfigComponent.chart.options.series[1].rippleEffect.brushType));
  }, { immediate: true });
...
} }), [["__scopeId", "data-v-a73fcec4"]]), D = E(e({ __name: "MfMapConfig", setup(e2) {
