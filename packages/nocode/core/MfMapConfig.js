...
const B = R(o({ __name: "MfColorIntervalConfig", props: { themeColors: { type: Array, default: () => [] } }, setup(o2) {
  ...
  return t(() => d2.themeColors, (o3) => {
    ...
    const n2 = a("AButton");
    return l(), i("div", { class: s(r(_2)) }, [c(F, { title: "颜色区间配置", "default-expand": true }, { action: p(() => [c(r(x), { checked: M2.value, "onUpdate:checked": e2[0] || (e2[0] = (o4) => M2.value = o4), onChange: B2 }, { default: p(() => e2[1] || (e2[1] = [m(" 显示颜色条 ")])), _: 1, __: [1] }, 8, ["checked"])]), default: p(() => [(l(true), i(u, null, C(R2.value, (o4, n3) => (l(), i("div", { class: "title", key: n3 }, [e2[2] || (e2[2] = m(" 区间颜色 ")), h("div", null, [c(r(I), { type: 1, placeholder: "设置区间颜色，格式#FFFFFF", value: o4, "hide-cancel": true, "hide-confirm": true, onInputChange: (o5) => function(o6, e3) {
    ...
    }(n3) }, null, 8, ["onClick"])) : g("", true)]))), 128)), c(n2, { onClick: w2 }, { icon: p(() => [c(r(A), { icon: "ant-design:plus-outlined" })]), default: p(() => [e2[3] || (e2[3] = m(" 添加区间颜色 "))]), _: 1, __: [3] })]), _: 1 })], 2);
  };
  ...
  }, { immediate: true }), (o3, e2) => (l(), f(v, { class: s(r(a2)) }, { default: p(() => [c(_, { onThemeChange: h2 }), c(M), c(r(x), { checked: i2.value, "onUpdate:checked": e2[0] || (e2[0] = (o4) => i2.value = o4), onChange: C2 }, { default: p(() => e2[1] || (e2[1] = [m(" 提示框")])), _: 1, __: [1] }, 8, ["checked"]), d(o3.$slots, "default", {}, void 0, true), c(B, { "theme-colors": u2.value }, null, 8, ["theme-colors"])]), _: 3 }, 8, ["class"]));
