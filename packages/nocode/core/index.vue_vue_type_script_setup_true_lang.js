import { defineComponent as o, ref as t, computed as r, watch as n, openBlock as e, createBlock as a, resolveDynamicComponent as c, normalizeStyle as i, withCtx as p, renderSlot as h } from "vue";
...
const l = o({ name: "MfDataV", __name: "index", props: { component: { type: Object, required: true }, chart: { type: Object }, chartContain: { type: Object } }, setup(o2) {
  ...
  return (t2, r2) => (e(), a(c(o2.component), { key: s.value, style: i(m.value), color: u.value, "background-color": l2.chart?.options.backgroundColor ? l2.chart?.options.backgroundColor : "transparent" }, { default: p(() => [h(t2.$slots, "default")]), _: 3 }, 8, ["style", "color", "background-color"]));
} });
export {
  l as _
};
