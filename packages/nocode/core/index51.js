import { defineComponent as e, useTemplateRef as a, onMounted as t, createElementBlock as r, openBlock as o, mergeProps as s, toHandlers as i, unref as n } from "vue";
...
import { u as c } from "./UseEchartsMap.js";
const f = e({ name: "MfMapLine", __name: "index", props: { chart: { type: Object, required: true }, chartContain: { type: Object, required: true } }, setup(e2) {
  const f2 = e2, d = a("mfMapLineRef"), { commonEvents: h } = p(f2.chart);
  c(f2.chart.options.geo), t(() => {
    m(d.value, f2.chart, f2.chartContain, v);
  });
  function v(e3, a2) {
    const t2 = { ...l(f2.chart.options), backgroundColor: "transparent" }, r2 = ((e4) => {
      ...
      const i2 = (e5, t4) => {
        ...
        } else a3.push({ name: e5, value: [...u[e5], t4] }), o2 < t4 && (o2 = t4), s2 > t4 && (s2 = t4), r3.add(e5);
      };
      for (const [a4, r4] of e4.entries()) if (a4 > 0) {
        const e5 = u[r4[0]], a5 = u[r4[1]], o3 = Number.parseFloat(r4[2]) || 0;
        t3.push({ fromName: r4[0], toName: r4[1], coords: [e5, a5], value: o3 }), i2(r4[1], o3), i2(r4[0], 0);
      }
  ...
  return (e3, a2) => (o(), r("div", s({ ref_key: "mfMapLineRef", ref: d, style: { width: "100%", height: "100%" } }, i(n(h), true)), null, 16));
} });
export {
  f as default
};
