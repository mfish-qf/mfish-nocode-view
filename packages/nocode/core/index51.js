import { defineComponent as e, useTemplateRef as a, onMounted as t, openBlock as r, createElementBlock as o, mergeProps as n, toHandlers as i, unref as s } from "vue";
  ...
  function g(e3, a2) {
    const t2 = { ...u(f2.chart.options), backgroundColor: "transparent" }, r2 = ((e4) => {
      ...
      const i2 = (e5, t4) => {
        ...
        } else a3.push({ name: e5, value: [...v[e5], t4] }), o2 < t4 && (o2 = t4), n2 > t4 && (n2 = t4), r3.add(e5);
      };
      for (const [a4, r4] of e4.entries()) if (a4 > 0) {
        const e5 = v[r4[0]], a5 = v[r4[1]], o3 = Number.parseFloat(r4[2]) || 0;
