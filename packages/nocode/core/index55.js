import { defineComponent as e, useTemplateRef as t, computed as o, watch as r, nextTick as s, openBlock as a, createBlock as i, unref as n, mergeProps as c, toHandlers as h } from "vue";
...
const v = d(e({ name: "MfScrollTable", __name: "index", props: { chart: { type: Object, required: true }, chartContain: { type: Object, required: true } }, setup(e2) {
  ...
  return (e3, t2) => (a(), i(n(f), c({ class: b.value, ref_key: "scrollTableRef", ref: I, theme: n(C).getTheme, config: g.value }, h(n(v2)), { onRowClick: x }), null, 16, ["class", "theme", "config"]));
