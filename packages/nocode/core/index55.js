...
import { i as m, u as l, au as f, av as p, _ as d } from "./index.js";
...
const v = d(e({ name: "MfScrollTable", __name: "index", props: { chart: { type: Object, required: true }, chartContain: { type: Object, required: true } }, setup(e2) {
  ...
  return (e3, t2) => (i(), a(n(f), c({ class: k.value, ref_key: "scrollTableRef", ref: I, theme: n(C).getTheme, config: g.value }, h(n(v2)), { onRowClick: b }), null, 16, ["class", "theme", "config"]));
