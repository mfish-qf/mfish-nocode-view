...
import { u as C, f as p, n as g, _ as f } from "./index.js";
...
const v = { class: "title" }, k = { class: "title" }, w = { class: "title" }, F = { class: "title" }, _ = { class: "title" }, x = { class: "title" }, I = f(t({ __name: "MfWheelConfig", setup(t2) {
  ...
  return o(() => f2.getCurConfigComponent, (t3) => {
    ...
    return [c(p, { title: "数值样式", "allow-check": true, "title-check": (_c = (_b = (_a = i(f2).getCurConfigComponent.chart.options.style.chart) == null ? void 0 : _a.layout) == null ? void 0 : _b.percentage) == null ? void 0 : _c.show, onChecked: A }, { default: r(() => [u("div", v, [e2[8] || (e2[8] = s(" 字体大小 ")), c(i(y), { value: W.value, "onUpdate:value": e2[0] || (e2[0] = (t4) => W.value = t4), min: 8, max: 100, onChange: B }, null, 8, ["value"]), c(i(d), { checked: i(f2).getCurConfigComponent.chart.options.style.chart.layout.percentage.bold, "onUpdate:checked": e2[1] || (e2[1] = (t4) => i(f2).getCurConfigComponent.chart.options.style.chart.layout.percentage.bold = t4) }, { default: r(() => e2[7] || (e2[7] = [s(" 加粗 ")])), _: 1 }, 8, ["checked"])]), u("div", k, [e2[9] || (e2[9] = s(" 小数位数 ")), c(i(y), { value: i(f2).getCurConfigComponent.chart.options.style.chart.layout.percentage.rounding, "onUpdate:value": e2[2] || (e2[2] = (t4) => i(f2).getCurConfigComponent.chart.options.style.chart.layout.percentage.rounding = t4), min: 0, max: 6 }, null, 8, ["value"])])]), _: 1 }, 8, ["title-check"]), c(p, { title: "内环配置", "allow-check": true, "title-check": (_f = (_e = (_d = i(f2).getCurConfigComponent.chart.options.style.chart) == null ? void 0 : _d.layout) == null ? void 0 : _e.innerCircle) == null ? void 0 : _f.show, onChecked: M }, { default: r(() => [e2[11] || (e2[11] = u("div", { class: "title" }, "内环颜色", -1)), c(i(g), { placeholder: "设置数字颜色，格式#FFFFFF", type: 1, value: U.value, onConfirmChange: b, onInputChange: j }, null, 8, ["value"]), u("div", w, [e2[10] || (e2[10] = s("内环宽度 ")), c(i(y), { value: S.value, "onUpdate:value": e2[3] || (e2[3] = (t4) => S.value = t4), max: 25, onChange: q }, null, 8, ["value"])])]), _: 1 }, 8, ["title-check"]), c(p, { title: "外环配置" }, { default: r(() => [u("div", F, [e2[12] || (e2[12] = s(" 激活颜色 ")), u("div", null, [c(i(g), { placeholder: "设置外环颜色，格式#FFFFFF", type: 1, value: z.value, onConfirmChange: H, onInputChange: R }, null, 8, ["value"])])]), u("div", _, [c(i(d), { checked: i(f2).getCurConfigComponent.chart.options.style.chart.layout.wheel.ticks.gradient.show, "onUpdate:checked": e2[4] || (e2[4] = (t4) => i(f2).getCurConfigComponent.chart.options.style.chart.layout.wheel.ticks.gradient.show = t4) }, { default: r(() => e2[13] || (e2[13] = [s(" 渐变色 ")])), _: 1 }, 8, ["checked"]), c(i(y), { value: i(f2).getCurConfigComponent.chart.options.style.chart.layout.wheel.ticks.gradient.shiftHueIntensity, "onUpdate:value": e2[5] || (e2[5] = (t4) => i(f2).getCurConfigComponent.chart.options.style.chart.layout.wheel.ticks.gradient.shiftHueIntensity = t4), min: 0, max: 100 }, null, 8, ["value"])]), u("div", x, [e2[14] || (e2[14] = s(" 圆环比例 ")), c(i(y), { value: i(f2).getCurConfigComponent.chart.options.style.chart.layout.wheel.ticks.sizeRatio, "onUpdate:value": e2[6] || (e2[6] = (t4) => i(f2).getCurConfigComponent.chart.options.style.chart.layout.wheel.ticks.sizeRatio = t4), step: 0.1, min: 0, max: 1 }, null, 8, ["value"])])]), _: 1 })];
  }), _: 1 }, 8, ["class"]));
