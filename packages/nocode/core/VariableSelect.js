...
import { u as B, _ as w, j as A, H as L } from "./index.js";
import { E as O } from "./UseEventSelect.js";
import { cloneDeep as R } from "lodash-es";
import { ScrollContainer as G } from "@mfish/core/components/Container";
const N = ["title", "onClick", "onMouseenter"], D = { class: "title" }, F = { class: "title" }, H = { class: "operator" }, q = { key: 1, class: "param-edit" }, J = { key: 2, class: "error" }, K = w(e({ __name: "GlobalParamsSelect", props: { value: { type: Object, default: () => ({}) } }, emits: ["selectChange"], setup(e2, { emit: b2 }) {
  ...
  function W() {
    var _a;
    X() && (T2.value.push({ name: "", defaultValue: "" }), A2.value = T2.value.length - 1, w2.value = A2.value, (_a = K2.value) == null ? void 0 : _a.scrollBottom());
  }
  function X() {
    ...
    return T2.value.some((a2, l2) => l2 !== A2.value && a2.name === e3) ? (O2.value = "error", Q2.value = "参数名不能重复", false) : (P2.getCanvasConfig.globalParams = R(T2.value), I2("selectChange", R(T2.value[A2.value])), A2.value = -1, O2.value = "", Q2.value = "", true);
  }
  function Y(e3) {
  ...
  return o(() => P2.getCurConfigComponent, (e3) => {
    ...
    const l2 = u("AButton");
    return s(), i("div", { class: r(v(M2)) }, [T2.value.length > 0 ? (s(), c(v(G), { key: 0, ref_key: "scrollContainerRef", ref: K2, class: r(`${v(M2)}-items`) }, { default: p(() => [(s(true), i(m, null, f(T2.value, (e4, n2) => (s(), i(m, { key: n2 }, [A2.value !== n2 ? (s(), i("div", { key: 0, class: r(["item", w2.value === n2 ? "select" : ""]), title: e4.name, onClick: (e5) => function(e6) {
      w2.value = e6, I2("selectChange", R(T2.value[e6]));
    }(n2), onMouseenter: (e5) => L2.value = n2, onMouseleave: a2[0] || (a2[0] = (e5) => L2.value = -1) }, [d("div", D, C(e4.name), 1), d("div", F, C(e4.defaultValue), 1), d("div", H, [h(k(l2, { type: "link", size: "small", style: { padding: "0" }, "pre-icon": "ant-design:edit-outlined", onClick: (e5) => function(e6) {
  ...
  const l2 = e2, t2 = a2, { prefixCls: u2 } = $("variable-select"), i2 = n(false), m2 = B(), f2 = n(), h2 = n([]), y2 = n(""), x2 = n(false), z2 = j().getThemeColor, w2 = n([{ value: 1, payload: "组件变量" }, { value: 2, payload: "全局变量" }]), G2 = n(1), N2 = () => {
    var _a, _b;
    if ((_a = l2.variable) == null ? void 0 : _a.id) {
    ...
    return 2 === ((_b = l2.variable) == null ? void 0 : _b.paramType) ? l2.variable.name : "";
  };
  function D2() {
  ...
  const H2 = (e3) => {
    ...
    }() : y2.value = N2(), f2.value = R(l2.variable), G2.value = ((_a = f2.value) == null ? void 0 : _a.paramType) ?? 1;
  };
  function q2(e3) {
  ...
  return (a3, l3) => (s(), c(v(I), { trigger: ["click"], open: i2.value, onOpenChange: H2, placement: "bottom", arrow: { pointAtCenter: true }, "overlay-style": { width: "300px" } }, { overlay: p(() => [k(v(P), null, { default: p(() => [k(v(P).Item, { disabled: "", style: { padding: "0", cursor: "default" } }, { default: p(() => [k(v(T), { value: G2.value, options: w2.value, onChange: W, block: "" }, { label: p(({ payload: e3 }) => [_(C(e3), 1)]), _: 1 }, 8, ["value", "options"]), 2 === G2.value ? (s(), c(K, { key: 0, value: f2.value, onSelectChange: J2 }, null, 8, ["value"])) : (s(), c(O, { key: 1, class: "mt-2", "hide-header": true, "hide-event": true, value: f2.value, "component-list": h2.value, onSelectChange: q2 }, null, 8, ["value", "component-list"])), d("div", { class: r(`${v(u2)}-ok-button`) }, [k(v(U), { class: "mr-2", onClick: D2 }, { default: p(() => l3[4] || (l3[4] = [_("取消")])), _: 1, __: [4] }), k(v(U), { type: "primary", onClick: F2 }, { default: p(() => l3[5] || (l3[5] = [_("确定")])), _: 1, __: [5] })], 2)]), _: 1 })]), _: 1 })]), default: p(() => [d("div", { class: r(v(u2)), onMouseenter: l3[2] || (l3[2] = (e3) => x2.value = true), onMouseleave: l3[3] || (l3[3] = (e3) => x2.value = false) }, [k(v(E), { class: r(`${v(u2)}-drop-input`), placeholder: "请选择变量来源", value: y2.value, "onUpdate:value": l3[0] || (l3[0] = (e3) => y2.value = e3), onChange: l3[1] || (l3[1] = (e3) => i2.value = true) }, b({ suffix: p(() => [x2.value && y2.value ? (s(), c(v(V), { key: 0, class: "delete-icon", size: 14, icon: "ant-design:close-circle-filled", onClick: S(Q2, ["stop"]) })) : g("", true), k(v(V), { class: "drop-icon", size: 12, icon: i2.value ? "ant-design:up-outlined" : "ant-design:down-outlined" }, null, 8, ["icon"])]), _: 2 }, [y2.value ? { name: "prefix", fn: p(() => {
    var _a;
    return [2 === ((_a = e2.variable) == null ? void 0 : _a.paramType) ? (s(), c(v(M), { key: 0, color: v(z2) }, { default: p(() => l3[6] || (l3[6] = [_("全局")])), _: 1, __: [6] }, 8, ["color"])) : (s(), c(v(M), { key: 1, color: v(z2) }, { default: p(() => l3[7] || (l3[7] = [_("组件")])), _: 1, __: [7] }, 8, ["color"]))];
