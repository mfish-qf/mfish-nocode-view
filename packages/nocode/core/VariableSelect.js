...
const G = ["title", "onClick", "onMouseenter"], N = { class: "title" }, F = { class: "title" }, q = { class: "operator" }, H = { key: 1, class: "param-edit" }, J = { key: 2, class: "error" }, K = w(e({ __name: "GlobalParamsSelect", props: { value: { type: Object, default: () => ({}) } }, emits: ["selectChange"], setup(e2, { emit: b2 }) {
  a((e3) => ({ "14eab416": U2.value }));
  const S2 = e2, z2 = b2, { prefixCls: M2 } = B("global-params-select"), P2 = j(), T2 = n([]), { token: V2 } = x.useToken(), U2 = l(() => V2.value.colorInfoBg);
  ...
  return (a3, l3) => (s(), c(v(z), { trigger: ["click"], open: i2.value, onOpenChange: q2, placement: "bottom", arrow: { pointAtCenter: true }, "overlay-style": { width: "300px" } }, { overlay: p(() => [k(v(P), null, { default: p(() => [k(v(P).Item, { disabled: "", style: { padding: "0", cursor: "default" } }, { default: p(() => [k(v(T), { value: D2.value, options: w2.value, onChange: W, block: "" }, { label: p(({ payload: e3 }) => [_(C(e3), 1)]), _: 1 }, 8, ["value", "options"]), 2 === D2.value ? (s(), c(K, { key: 0, value: f2.value, onSelectChange: J2 }, null, 8, ["value"])) : (s(), c(O, { key: 1, class: "mt-2", "hide-header": true, "hide-event": true, value: f2.value, "component-list": h2.value, onSelectChange: H2 }, null, 8, ["value", "component-list"])), d("div", { class: r(`${v(u2)}-ok-button`) }, [k(v(V), { class: "mr-2", onClick: N2 }, { default: p(() => l3[4] || (l3[4] = [_("取消", -1)])), _: 1, __: [4] }), k(v(V), { type: "primary", onClick: F2 }, { default: p(() => l3[5] || (l3[5] = [_("确定", -1)])), _: 1, __: [5] })], 2)]), _: 1 })]), _: 1 })]), default: p(() => [d("div", { class: r(v(u2)), onMouseenter: l3[2] || (l3[2] = (e3) => x2.value = true), onMouseleave: l3[3] || (l3[3] = (e3) => x2.value = false) }, [k(v(E), { class: r(`${v(u2)}-drop-input`), placeholder: "请选择变量来源", value: y2.value, "onUpdate:value": l3[0] || (l3[0] = (e3) => y2.value = e3), onChange: l3[1] || (l3[1] = (e3) => i2.value = true) }, b({ suffix: p(() => [x2.value && y2.value ? (s(), c(v($), { key: 0, class: "delete-icon", size: 14, icon: "ant-design:close-circle-filled", onClick: S(Q2, ["stop"]) })) : g("", true), k(v($), { class: "drop-icon", size: 12, icon: i2.value ? "ant-design:up-outlined" : "ant-design:down-outlined" }, null, 8, ["icon"])]), _: 2 }, [y2.value ? { name: "prefix", fn: p(() => [2 === e2.variable?.paramType ? (s(), c(v(M), { key: 0, color: v(I2) }, { default: p(() => l3[6] || (l3[6] = [_("全局", -1)])), _: 1, __: [6] }, 8, ["color"])) : (s(), c(v(M), { key: 1, color: v(I2) }, { default: p(() => l3[7] || (l3[7] = [_("组件", -1)])), _: 1, __: [7] }, 8, ["color"]))]), key: "0" } : void 0]), 1032, ["class", "value"])], 34)]), _: 1 }, 8, ["open"]));
