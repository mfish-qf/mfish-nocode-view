...
const h = "fieldName", D = u(a({ __name: "MfTableDataConfig", setup(a2) {
  ...
  return (a3, t2) => (o(), e(f, { class: n(s(j)), onRefreshData: x }, { "data-select": i(() => [l(a3.$slots, "data-select", {}, void 0, true)]), "static-data": i(() => [r(p, { data: b.value, onDataChange: F }, null, 8, ["data"])]), "target-data": i(() => [t2[0] || (t2[0] = d("div", { class: "title" }, "显示内容", -1)), r(c, { height: 500, onDataChange: J, fields: S.value }, null, 8, ["fields"])]), _: 3 }, 8, ["class"]));
