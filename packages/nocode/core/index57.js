...
import { l as d, u as f, aw as v } from "./index.js";
...
const m = e({ name: "MfSelect", __name: "index", props: { chart: { type: Object, required: true }, chartContain: { type: Object, required: true } }, setup(e2) {
  ...
  const m2 = e2, { commonEvents: x, emitEvent: b } = d(m2.chart, void 0, ["selectChange"]), S = a(() => m2.chart.data?.dataSet?.map((e3) => ({ label: e3.label, value: e3.value || e3.label }))), y = a(() => m2.chartContain?.background || (E.getTheme === p.DARK ? "#141414" : "#ffffff")), g = a(() => m2.chartContain?.border?.radius || 4), C = a(() => m2.chart.options?.showSearch || false), w = a(() => m2.chart.options?.allowClear || false), j = a(() => m2.chart.options?.textStyle?.textColor), k = a(() => m2.chart.options?.textStyle?.font), $ = a(() => m2.chart.options?.textStyle?.fontSize || 14), q = a(() => m2.chart.options?.textStyle?.fontStyle?.bold ? "bold" : ""), z = a(() => m2.chart.options?.textStyle?.fontStyle?.italic ? "italic" : ""), D = a(() => m2.chart.options?.textStyle?.fontStyle?.underline ? "underline" : ""), E = f(), I = a(() => m2.chartContain?.dropInfo?.height), O = l(), { prefixCls: _ } = h("mf-select");
  function A(e3) {
    O.value = e3;
  ...
  return o(() => m2.chart?.data?.defaultValue, (e3) => {
