...
import { i as v, u as d, az as f } from "./index.js";
...
const m = e({ name: "MfSelect", __name: "index", props: { chart: { type: Object, required: true }, chartContain: { type: Object, required: true } }, setup(e2) {
  t((e3) => ({ v7763483c: y.value, v3e2e4374: `${g.value}px`, v4d71b16e: I.value - 6 + "px", a382bd30: j.value, aa8c3c46: k.value, v499bc0f4: `${z.value}px`, aa8fdfda: $.value, v2db03784: q.value, v9f258c04: D.value }));
  const m2 = e2, { commonEvents: x, emitEvent: b } = v(m2.chart, void 0, ["selectChange"]), S = a(() => m2.chart.data?.dataSet?.map((e3) => ({ label: e3.label, value: e3.value || e3.label }))), y = a(() => m2.chartContain?.background || (E.getTheme === p.DARK ? "#141414" : "#ffffff")), g = a(() => m2.chartContain?.border?.radius || 4), C = a(() => m2.chart.options?.showSearch || false), w = a(() => m2.chart.options?.allowClear || false), j = a(() => m2.chart.options?.textStyle?.textColor), k = a(() => m2.chart.options?.textStyle?.font), z = a(() => m2.chart.options?.textStyle?.fontSize || 14), $ = a(() => m2.chart.options?.textStyle?.fontStyle?.bold ? "bold" : ""), q = a(() => m2.chart.options?.textStyle?.fontStyle?.italic ? "italic" : ""), D = a(() => m2.chart.options?.textStyle?.fontStyle?.underline ? "underline" : ""), E = d(), I = a(() => m2.chartContain?.dropInfo?.height), O = o(), { prefixCls: _ } = h("mf-select");
  function A(e3) {
    O.value = e3;
