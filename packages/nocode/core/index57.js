...
const m = e({ name: "MfSelect", __name: "index", props: { chart: { type: Object, required: true }, chartContain: { type: Object, required: true } }, setup(e2) {
  t((e3) => ({ v7763483c: y.value, v3e2e4374: `${g.value}px`, v4d71b16e: I.value - 6 + "px", a382bd30: j.value, aa8c3c46: k.value, v499bc0f4: `${$.value}px`, aa8fdfda: q.value, v2db03784: z.value, v9f258c04: D.value }));
