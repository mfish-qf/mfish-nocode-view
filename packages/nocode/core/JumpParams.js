import { defineComponent as e, ref as a, onMounted as l, openBlock as t, createElementBlock as n, normalizeClass as o, unref as i, createVNode as s, withCtx as r, createElementVNode as u, toDisplayString as c, reactive as d, watch as m, createSlots as v, createBlock as p, withModifiers as f, createCommentVNode as g, useCssVars as h, computed as y, Fragment as C, renderList as _, createTextVNode as k } from "vue";
...
const D = { target: "_blank", onClick: () => {
  ...
  h((e3) => ({ v213aa1d6: x2.value }));
  const d2 = e2, v2 = l2, { prefixCls: f2 } = j("jump-params"), w2 = T(), b2 = a([]), { token: I2 } = z.useToken(), x2 = y(() => I2.value.colorBorder), U2 = a(-1);
  function N2() {
  ...
  return m(() => w2.getCurConfigComponent, (e3) => {
    ...
    v2("paramsChange", e3);
  }, { deep: true }), (e3, a2) => (t(), n("div", { class: o(i(f2)) }, [(t(true), n(C, null, _(b2.value, (e4, l3) => (t(), n("div", { class: "items", key: l3, onMouseenter: (e5) => U2.value = l3, onMouseleave: a2[0] || (a2[0] = (e5) => U2.value = -1) }, [u("div", le, [a2[1] || (a2[1] = u("span", { class: "title" }, "参数名", -1)), s(i(S), { placeholder: "输入参数名", value: e4.name, "onUpdate:value": (a3) => e4.name = a3, maxlength: 20, status: e4.errorInfo ? "error" : "", onChange: (a3) => (function(e5, a4) {
    ...
    e5.value = "";
  })(e4) }, { default: r(() => [s(i(A), { class: o(`${i(f2)}-radio-button`), value: i(F).CONSTANT }, { default: r(() => [...a2[3] || (a2[3] = [k("常量", -1)])]), _: 1 }, 8, ["class", "value"]), s(i(A), { class: o(`${i(f2)}-radio-button`), value: i(F).VARIABLE }, { default: r(() => [...a2[4] || (a2[4] = [k("变量", -1)])]), _: 1 }, 8, ["class", "value"])]), _: 1 }, 8, ["value", "onUpdate:value", "onChange"])]), _: 2 }, 1024)]), u("div", oe, [a2[5] || (a2[5] = u("span", { class: "title" }, "参数值", -1)), u("div", ie, [0 === e4.type ? (t(), p(i(S), { key: 0, placeholder: "输入参数值", value: e4.value, "onUpdate:value": (a3) => e4.value = a3, maxlength: 20 }, null, 8, ["value", "onUpdate:value"])) : (t(), p(W, { key: 1, variable: e4.value || {}, onOk: (a3) => (function(e5, a4) {
    a4.value = e5;
  })(a3, e4) }, null, 8, ["variable", "onOk"]))])])]), U2.value === l3 ? (t(), p(i(M), { key: 0, size: "18", class: "delete-button", icon: "ant-design:close-circle-filled", onClick: (e5) => (function(e6) {
    b2.value.splice(e6, 1);
  })(l3) }, null, 8, ["onClick"])) : g("", true)], 40, ae))), 128)), u("div", { class: "add-button", onClick: N2 }, [s(i(M), { icon: "ant-design:plus-outlined" }), a2[6] || (a2[6] = k(" 添加跳转参数 ", -1))])], 2));
} }), [["__scopeId", "data-v-bd8a7253"]]);
export {
  se as J,
  ee as P
};
