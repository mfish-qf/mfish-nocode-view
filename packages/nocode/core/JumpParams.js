import { defineComponent as e, ref as a, onMounted as l, createElementBlock as t, openBlock as n, normalizeClass as o, unref as i, createVNode as s, withCtx as r, createElementVNode as u, toDisplayString as c, reactive as d, watch as m, createSlots as v, createBlock as p, createCommentVNode as f, withModifiers as g, useCssVars as h, computed as _, Fragment as y, renderList as C, createTextVNode as k } from "vue";
...
const D = { target: "_blank", onClick: () => {
  ...
  const m2 = d2, v2 = a(), p2 = a(), f2 = a(), { prefixCls: g2 } = j("page-list"), h2 = a([]), { paginationProp: _2, getPageNum: y2, setCurrentPage: C2, getPageSize: k2, setTotal: x2 } = L(S2, { showSizeChanger: false, showQuickJumper: false });
  function S2(e3) {
    e3 && C2(e3), V({ folderId: v2.value, name: f2.value, pageNum: e3 ?? y2(), pageSize: k2() }).then((e4) => {
  ...
  const c2 = e2, h2 = l2, { prefixCls: _2 } = j("page-select"), y2 = a(false), C2 = T(), k2 = a(false), w2 = d({ name: void 0, value: void 0, img: void 0, width: void 0, height: void 0 }), { open: b2 } = G($);
  m(() => C2.getCurConfigComponent?.chart.id, (e3) => {
    y2.value = false, e3 && (w2.value = c2.page?.value, w2.name = c2.page?.name, w2.img = c2.page?.img);
  }, { immediate: true });
  const I2 = (e3) => {
    y2.value = e3;
  };
  ...
  function P2(e3) {
    if (y2.value = false, w2.value = e3?.id ?? void 0, w2.name = e3?.name ?? void 0, w2.img = e3?.thumbnail ?? void 0, e3.canvasConfig) {
  ...
  return (e3, a2) => (n(), t("div", Y, [s(i(x), { trigger: ["click"], open: y2.value, onOpenChange: I2, placement: "bottom", arrow: { pointAtCenter: true }, "overlay-style": { width: "400px" } }, { overlay: r(() => [s(i(U), null, { default: r(() => [s(i(U).Item, { disabled: "", style: { padding: "0", cursor: "default" } }, { default: r(() => [s(X, { onSelectScreen: P2 })]), _: 1 })]), _: 1 })]), default: r(() => [u("div", { class: o(i(_2)), onMouseenter: a2[2] || (a2[2] = (e4) => k2.value = true), onMouseleave: a2[3] || (a2[3] = (e4) => k2.value = false) }, [s(i(S), { class: o(`${i(_2)}-drop-input`), placeholder: "请选择页面", value: w2.name, "onUpdate:value": a2[0] || (a2[0] = (e4) => w2.name = e4), onChange: a2[1] || (a2[1] = (e4) => y2.value = true) }, v({ suffix: r(() => [w2.value && k2.value ? (n(), p(i(M), { key: 0, title: "编辑页面", class: "edit-icon", size: 14, icon: "ant-design:edit-outlined", onClick: g(O2, ["stop"]) })) : f("", true), w2.value && k2.value ? (n(), p(i(M), { key: 1, class: "delete-icon", size: 14, icon: "ant-design:close-circle-filled", onClick: g(z2, ["stop"]) })) : f("", true), s(i(M), { class: "drop-icon", size: 12, icon: y2.value ? "ant-design:up-outlined" : "ant-design:down-outlined" }, null, 8, ["icon"])]), _: 2 }, [w2.img ? { name: "prefix", fn: r(() => [u("img", { alt: "screen", src: i(E)(i(H)(w2.img)), class: "screen_img" }, null, 8, Z)]), key: "0" } : void 0]), 1032, ["class", "value"])], 34)]), _: 1 }, 8, ["open"])]));
  ...
  const d2 = e2, v2 = l2, { prefixCls: g2 } = j("jump-params"), w2 = T(), b2 = a([]), { token: I2 } = z.useToken(), x2 = _(() => I2.value.colorBorder), U2 = a(-1);
  function N2() {
  ...
  return m(() => w2.getCurConfigComponent, (e3) => {
    ...
    e5.value = "";
  }(e4) }, { default: r(() => [s(i(A), { class: o(`${i(g2)}-radio-button`), value: i(F).CONSTANT }, { default: r(() => a2[3] || (a2[3] = [k("常量")])), _: 1, __: [3] }, 8, ["class", "value"]), s(i(A), { class: o(`${i(g2)}-radio-button`), value: i(F).VARIABLE }, { default: r(() => a2[4] || (a2[4] = [k("变量")])), _: 1, __: [4] }, 8, ["class", "value"])]), _: 2 }, 1032, ["value", "onUpdate:value", "onChange"])]), _: 2 }, 1024)]), u("div", oe, [a2[5] || (a2[5] = u("span", { class: "title" }, "参数值", -1)), u("div", ie, [0 === e4.type ? (n(), p(i(S), { key: 0, placeholder: "输入参数值", value: e4.value, "onUpdate:value": (a3) => e4.value = a3, maxlength: 20 }, null, 8, ["value", "onUpdate:value"])) : (n(), p(W, { key: 1, variable: e4.value, onOk: (a3) => function(e5, a4) {
    a4.value = e5;
  ...
  }(l3) }, null, 8, ["onClick"])) : f("", true)], 40, ae))), 128)), u("div", { class: "add-button", onClick: N2 }, [s(i(M), { icon: "ant-design:plus-outlined" }), a2[6] || (a2[6] = k(" 添加跳转参数 "))])], 2));
