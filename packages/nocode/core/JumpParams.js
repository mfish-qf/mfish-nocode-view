...
const D = { target: "_blank", onClick: () => {
  ...
  return m(() => w2.getCurConfigComponent, (e3) => {
    ...
    e5.value = "";
  }(e4) }, { default: r(() => [s(i(A), { class: o(`${i(g2)}-radio-button`), value: i(F).CONSTANT }, { default: r(() => a2[3] || (a2[3] = [k("常量", -1)])), _: 1, __: [3] }, 8, ["class", "value"]), s(i(A), { class: o(`${i(g2)}-radio-button`), value: i(F).VARIABLE }, { default: r(() => a2[4] || (a2[4] = [k("变量", -1)])), _: 1, __: [4] }, 8, ["class", "value"])]), _: 2 }, 1032, ["value", "onUpdate:value", "onChange"])]), _: 2 }, 1024)]), u("div", oe, [a2[5] || (a2[5] = u("span", { class: "title" }, "参数值", -1)), u("div", ie, [0 === e4.type ? (n(), p(i(S), { key: 0, placeholder: "输入参数值", value: e4.value, "onUpdate:value": (a3) => e4.value = a3, maxlength: 20 }, null, 8, ["value", "onUpdate:value"])) : (n(), p(W, { key: 1, variable: e4.value, onOk: (a3) => function(e5, a4) {
    a4.value = e5;
