...
const u = d(o({ __name: "MfDecoration8Config", setup(o2) {
  ...
  return (o3, m2) => (t(), e(f, { class: r(n(d2)) }, { default: s(() => [i(n(c), { checked: n(u2).getCurConfigComponent.chart.options.reverse, "onUpdate:checked": m2[0] || (m2[0] = (o4) => n(u2).getCurConfigComponent.chart.options.reverse = o4) }, { default: s(() => m2[1] || (m2[1] = [a(" 是否反转")])), _: 1 }, 8, ["checked"])]), _: 1 }, 8, ["class"]));
