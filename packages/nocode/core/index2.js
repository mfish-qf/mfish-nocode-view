...
const q = ["onMouseenter"], F = { class: "setting" }, H = e({ __name: "AnimationSet", setup(e2) {
  ...
  })(e4) }, { default: u(() => [...n2[1] || (n2[1] = [r(" 无限循环", -1)])]), _: 1 }, 8, ["checked", "onUpdate:checked", "onChange"]), d(K, { "hide-param": true, events: e4?.events, onOk: (n3) => (function(e5, n4) {
    n4?.events || (n4.events = []);
  ...
  n((e3) => ({ v3b9d7e0c: $2.value, v6e53613f: i(G2) }));
