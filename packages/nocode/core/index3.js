...
const V = ["onClick"], W = H(e({ __name: "EventListen", setup(e2) {
  ...
  return n(() => f2.getCurConfigComponent?.chart.id, (e3) => {
    ...
    const n2 = C("AInput");
    return a(), o("div", { class: l(u(h2)) }, [r(T, { title: "页面跳转", "allow-check": true, tooltip: "组件开启页面跳转功能，开启后点击组件页面跳到配置页面，配置页面不支持跳转，请在预览界面查看效果", "title-check": u(f2).getCurConfigComponent.chart.jump?.open, onChecked: L2 }, { default: v(() => [s("div", G, [t2[5] || (t2[5] = d(" 跳转方式 ", -1)), r(u(A), { size: "small", value: k2.value, "onUpdate:value": t2[0] || (t2[0] = (e4) => k2.value = e4), onChange: P2 }, { default: v(() => [(a(), o(i, null, c(_2, (e4, t3) => r(u(R), { key: t3, value: e4 }, { default: v(() => [d(p(e4), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])]), s("div", Q, [t2[6] || (t2[6] = d(" 跳转页面 ", -1)), r(u(A), { size: "small", value: x2.value, "onUpdate:value": t2[1] || (t2[1] = (e4) => x2.value = e4), onChange: $2 }, { default: v(() => [(a(), o(i, null, c(b2, (e4, t3) => r(u(R), { key: t3, value: e4 }, { default: v(() => [d(p(e4), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])]), x2.value === u(U).System ? (a(), m(B, { key: 0, page: H2.value, onOk: z2 }, null, 8, ["page"])) : (a(), m(n2, { key: 1, placeholder: "请输入外部链接，例如https://www.bing.com", value: S2.value, "onUpdate:value": t2[2] || (t2[2] = (e4) => S2.value = e4), onChange: N2 }, null, 8, ["value"])), k2.value === u(E).Dialog ? (a(), o("div", X, [r(u(I), { prefix: "W", placeholder: "宽度", value: O2.value, "onUpdate:value": t2[3] || (t2[3] = (e4) => O2.value = e4), min: 0, max: 99999, maxlength: 5, onChange: K2 }, null, 8, ["value"]), r(u(I), { prefix: "H", placeholder: "高度", value: M2.value, "onUpdate:value": t2[4] || (t2[4] = (e4) => M2.value = e4), min: 0, max: 99999, maxlength: 5, onChange: J2 }, null, 8, ["value"])])) : g("", true), t2[7] || (t2[7] = s("div", { class: "title" }, " 跳转参数 ", -1)), r(D, { "params-value": u(f2).getCurConfigComponent.chart.jump?.params, onParamsChange: q2 }, null, 8, ["params-value"])]), _: 1, __: [7] }, 8, ["title-check"])], 2);
  };
