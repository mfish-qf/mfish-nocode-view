...
const V = ["onClick"], W = H(e({ __name: "EventListen", setup(e2) {
  ...
  const f2 = w(), { prefixCls: h2 } = y("page-jump-config"), _2 = [E.CurPage, E.NewTab, E.Dialog], k2 = t(), b2 = [U.System, U.External], x2 = t(), H2 = t(), S2 = t(), O2 = t(), M2 = t();
  function L2(e3) {
  ...
  function P2() {
    f2.getCurConfigComponent.chart.jump = { ...f2.getCurConfigComponent.chart.jump, type: k2.value };
  }
  function $2() {
  ...
  return n(() => f2.getCurConfigComponent?.chart.id, (e3) => {
    e3 && (f2.getCurConfigComponent.chart.jump?.type ? k2.value = f2.getCurConfigComponent.chart.jump?.type : (k2.value = E.CurPage, P2()), f2.getCurConfigComponent.chart.jump?.pageType ? x2.value = f2.getCurConfigComponent.chart.jump?.pageType : (x2.value = U.System, $2()), x2.value === U.System ? H2.value = f2.getCurConfigComponent.chart.jump?.page : S2.value = f2.getCurConfigComponent.chart.jump?.page?.value, O2.value = f2.getCurConfigComponent.chart.jump?.page?.width, M2.value = f2.getCurConfigComponent.chart.jump?.page?.height);
  }, { immediate: true }), (e3, t2) => {
    const n2 = C("AInput");
    return a(), o("div", { class: l(u(h2)) }, [r(T, { title: "页面跳转", "allow-check": true, tooltip: "组件开启页面跳转功能，开启后点击组件页面跳到配置页面，配置页面不支持跳转，请在预览界面查看效果", "title-check": u(f2).getCurConfigComponent.chart.jump?.open, onChecked: L2 }, { default: v(() => [s("div", G, [t2[5] || (t2[5] = d(" 跳转方式 ")), r(u(A), { size: "small", value: k2.value, "onUpdate:value": t2[0] || (t2[0] = (e4) => k2.value = e4), onChange: P2 }, { default: v(() => [(a(), o(i, null, c(_2, (e4, t3) => r(u(R), { key: t3, value: e4 }, { default: v(() => [d(p(e4), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])]), s("div", Q, [t2[6] || (t2[6] = d(" 跳转页面 ")), r(u(A), { size: "small", value: x2.value, "onUpdate:value": t2[1] || (t2[1] = (e4) => x2.value = e4), onChange: $2 }, { default: v(() => [(a(), o(i, null, c(b2, (e4, t3) => r(u(R), { key: t3, value: e4 }, { default: v(() => [d(p(e4), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])]), x2.value === u(U).System ? (a(), m(B, { key: 0, page: H2.value, onOk: z2 }, null, 8, ["page"])) : (a(), m(n2, { key: 1, placeholder: "请输入外部链接，例如https://www.bing.com", value: S2.value, "onUpdate:value": t2[2] || (t2[2] = (e4) => S2.value = e4), onChange: N2 }, null, 8, ["value"])), k2.value === u(E).Dialog ? (a(), o("div", X, [r(u(I), { prefix: "W", placeholder: "宽度", value: O2.value, "onUpdate:value": t2[3] || (t2[3] = (e4) => O2.value = e4), min: 0, max: 99999, maxlength: 5, onChange: K2 }, null, 8, ["value"]), r(u(I), { prefix: "H", placeholder: "高度", value: M2.value, "onUpdate:value": t2[4] || (t2[4] = (e4) => M2.value = e4), min: 0, max: 99999, maxlength: 5, onChange: J2 }, null, 8, ["value"])])) : g("", true), t2[7] || (t2[7] = s("div", { class: "title" }, " 跳转参数 ", -1)), r(D, { "params-value": u(f2).getCurConfigComponent.chart.jump?.params, onParamsChange: q2 }, null, 8, ["params-value"])]), _: 1, __: [7] }, 8, ["title-check"])], 2);
  };
  ...
  const i2 = e2, c2 = o2, { prefixCls: p2 } = y("event-single-select"), C2 = t(false), h2 = w(), _2 = t(), k2 = t([]), j2 = t(""), b2 = t(false), { getEventComponents: H2 } = F(), E2 = () => {
    if (i2.event?.id) {
  ...
  function T2() {
    c2("ok", J(_2.value)), C2.value = false;
  }
  ...
  const I2 = (e3) => {
    C2.value = e3, e3 ? k2.value = H2(i2.filterSelf) : j2.value = E2(), _2.value = J(i2.event);
  };
  function O2(e3) {
    _2.value = e3;
  }
  ...
  return (e3, t2) => {
    const f3 = C("AInput");
    return a(), o("div", { class: l(u(n2)) }, [r(T, { title: "条件显隐", "allow-check": true, tooltip: "组件开启条件显示隐藏功能。开启后当事件触发时满足下面设置条件时显示，否则隐藏。", "title-check": u(p2).getCurConfigComponent.chart.showHide?.open, onChecked: x2 }, { default: v(() => [(a(true), o(i, null, c(u(p2).getCurConfigComponent.chart.showHide?.conditions, (e4, n3) => (a(), o("div", { class: "condition", key: n3, onMouseenter: (e5) => j2.value = n3, onMouseleave: t2[0] || (t2[0] = (e5) => j2.value = -1) }, [s("div", ne, [t2[1] || (t2[1] = d(" 触发 ")), r(ee, { "filter-self": true, event: e4.event, onOk: (e5) => function(e6, t3) {
      p2.getCurConfigComponent.chart.showHide.conditions[e6].event = t3;
    }(n3, e5) }, null, 8, ["event", "onOk"])]), s("div", oe, [t2[2] || (t2[2] = d(" 条件 ")), r(u(N), { style: { flex: "1" }, placeholder: "选择比较条件", class: "select-com", value: e4.condition, "onUpdate:value": (t3) => e4.condition = t3, options: b2 }, null, 8, ["value", "onUpdate:value"]), t2[3] || (t2[3] = d(" 值 ")), r(f3, { style: { width: "120px" }, placeholder: "请输入值", value: e4.value, "onUpdate:value": (t3) => e4.value = t3, maxlength: 100 }, null, 8, ["value", "onUpdate:value"])]), j2.value === n3 ? (a(), m(u(K), { key: 0, size: "18", class: "delete-button", icon: "ant-design:close-circle-filled", onClick: (e5) => function(e6) {
      p2.getCurConfigComponent.chart.showHide.conditions.splice(e6, 1), delete p2.getCurConfigComponent.chart.showHide?.show;
    }(n3) }, null, 8, ["onClick"])) : g("", true)], 40, te))), 128)), s("div", { class: "add-button", onClick: H2 }, [r(u(K), { icon: "ant-design:plus-outlined" }), t2[4] || (t2[4] = d(" 添加显隐条件 "))])]), _: 1 }, 8, ["title-check"])], 2);
  };
} }), le = H(ae, [["__scopeId", "data-v-50189189"]]), ue = H(e({ name: "AdvanceConfig", __name: "index", setup(e2) {
  const { prefixCls: t2 } = y("advance-config");
  return (e3, n2) => (a(), m(u(k), null, { default: v(() => [s("div", { class: l(u(t2)) }, [r(T, { title: "事件开启" }, { default: v(() => [r(W)]), _: 1 }), r(Z), r(le)], 2)]), _: 1 }));
