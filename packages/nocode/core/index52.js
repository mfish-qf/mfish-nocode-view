import { defineComponent as e, useTemplateRef as a, onMounted as t, openBlock as r, createElementBlock as o, mergeProps as n, toHandlers as s, unref as i } from "vue";
import { at as m, i as p, ar as c } from "./index.js";
...
const g = e({ name: "MfMapLine3D", __name: "index", props: { chart: { type: Object, required: true }, chartContain: { type: Object, required: true } }, setup(e2) {
  ...
  function M(e3, a2) {
    const t2 = { ...l(g2.chart.options), backgroundColor: "transparent" }, r2 = ((e4) => {
      ...
      const s2 = (e5, t4) => {
        ...
        } else a3.push({ name: e5, value: [...D[e5], 0, t4] }), o2 < t4 && (o2 = t4), n2 > t4 && (n2 = t4), r3.add(e5);
      };
      for (const [a4, r4] of e4.entries()) if (a4 > 0) {
        const e5 = D[r4[0]], a5 = D[r4[1]], o3 = Number.parseFloat(r4[2]) || 0;
  ...
  return (e3, a2) => (r(), o("div", n({ ref_key: "mfMapLineRef", ref: y, style: { width: "100%", height: "100%" } }, s(i(x), true)), null, 16));
} });
export {
  g as default
};
