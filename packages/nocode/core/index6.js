import { defineComponent as t, watch as o, nextTick as i, computed as e, openBlock as r, createBlock as s, unref as n, mergeProps as a, toHandlers as d } from "vue";
...
const h = t({ name: "MfDigits", __name: "index", props: { chart: { type: Object, required: true }, chartContain: { type: Object, required: true } }, setup(t2) {
  ...
  return (o2, i2) => (r(), s(n(l), a({ dataset: t2.chart.data.dataSet, config: C.value }, d(n(u))), null, 16, ["dataset", "config"]));
} });
export {
  h as default
};
