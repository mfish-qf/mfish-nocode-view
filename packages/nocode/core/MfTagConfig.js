...
import { u as g, M as v, _ } from "./index.js";
...
const I = { key: 0, class: "title" }, S = { class: "check-group" }, T = _(o({ __name: "MfTagConfig", props: { hideTitle: { type: Boolean, default: false }, hideIcon: { type: Boolean, default: false } }, setup(o2) {
  const _2 = g(), { prefixCls: T2 } = m("tag-config"), x = e();
  function j(o3) {
  ...
  function M(o3) {
    _2.getCurConfigComponent.chart.options.iconColor = o3;
  }
  return t(() => _2.getCurConfigComponent, (o3) => {
    o3 && (x.value = _2.getCurConfigComponent.chart.options.iconColor);
  }, { immediate: true }), (e2, t2) => (a(), n(k, { class: i(r(T2)) }, { default: l(() => [s(e2.$slots, "default", {}, void 0, true), o2.hideTitle ? u("", true) : (a(), c("div", I, "标签内容")), o2.hideTitle ? u("", true) : (a(), n(r(C), { key: 1, value: r(_2).getCurConfigComponent.chart.data.dataSet.title, "onUpdate:value": t2[0] || (t2[0] = (o3) => r(_2).getCurConfigComponent.chart.data.dataSet.title = o3), "show-count": "", maxlength: 50 }, null, 8, ["value"])), t2[3] || (t2[3] = p("div", { class: "title" }, "图标", -1)), o2.hideIcon ? u("", true) : (a(), n(r(y), { key: 2, value: r(_2).getCurConfigComponent.chart.data.dataSet.icon, onChange: j }, null, 8, ["value"])), d(r(v), { placeholder: "设置图标颜色，格式#FFFFFF", type: 1, value: x.value, onConfirmChange: B, onInputChange: M }, null, 8, ["value"]), d(F), p("div", S, [d(r(h), { checked: r(_2).getCurConfigComponent.chart.options.hide, "onUpdate:checked": t2[1] || (t2[1] = (o3) => r(_2).getCurConfigComponent.chart.options.hide = o3) }, { default: l(() => t2[2] || (t2[2] = [f(" 文字超出隐藏", -1)])), _: 1, __: [2] }, 8, ["checked"])])]), _: 3, __: [3] }, 8, ["class"]));
