...
const h = { class: "title" }, C = l(o({ __name: "MfBorder8Config", setup(o2) {
  ...
  return (o3, f2) => (t(), e(c, { class: r(s(l2)) }, { default: n(() => [i(s(p), { checked: s(C2).getCurConfigComponent.chart.options.reverse, "onUpdate:checked": f2[0] || (f2[0] = (o4) => s(C2).getCurConfigComponent.chart.options.reverse = o4) }, { default: n(() => f2[2] || (f2[2] = [m(" 是否反转")])), _: 1, __: [2] }, 8, ["checked"]), a("div", h, [f2[3] || (f2[3] = m(" 单次动画时长 ")), i(s(d), { suffix: "秒", style: { width: "120px" }, value: s(C2).getCurConfigComponent.chart.options.duration, "onUpdate:value": f2[1] || (f2[1] = (o4) => s(C2).getCurConfigComponent.chart.options.duration = o4), placeholder: "单次动画时长", min: 1, max: 100, maxlength: 3 }, null, 8, ["value"])])]), _: 1 }, 8, ["class"]));
