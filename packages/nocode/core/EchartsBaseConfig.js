...
import { u as k, f as z, T as U, ao as T, h as A, _ as F, ap as I } from "./index.js";
import "@vueuse/core";
...
const E = { class: "title" }, W = { style: { display: "flex", gap: "6px" } }, B = F(t({ __name: "EchartsTitleConfig", setup(t2) {
  ...
  return (t3, e3) => (i(), l("div", { class: a(u(f2)) }, [s(z, { title: "基础配置" }, { default: r(() => [e3[0] || (e3[0] = c("div", { class: "title" }, " 主题", -1)), s(j, { color: u(n2).getCurConfigComponent.chart.options.themeColor, onThemeChange: p2 }, null, 8, ["color"]), v(t3.$slots, "default", {}, void 0, true)]), _: 3 })], 2));
