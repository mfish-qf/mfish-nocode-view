...
const E = { class: "title" }, W = { style: { display: "flex", gap: "6px" } }, j = A(t({ __name: "EchartsTitleConfig", setup(t2) {
  ...
  return (t3, e2) => (i(), g(u(S), { value: r2.value, "onUpdate:value": e2[0] || (e2[0] = (t4) => r2.value = t4), placeholder: "选择一个主题", onChange: d2 }, { default: s(() => [(i(true), l(f, null, C(u(F), (t4, e3) => (i(), g(u(b), { label: t4.name, value: t4.name, key: e3 }, { default: s(() => [c("div", { class: a(u(v2)) }, [p(h(t4.name) + " ", 1), c("div", B, [(i(true), l(f, null, C(t4.color, (t5) => (i(), l("div", { class: "color-box", style: m({ backgroundColor: t5 }), key: t5 }, null, 4))), 128))])], 2)]), _: 2 }, 1032, ["label", "value"]))), 128))]), _: 1 }, 8, ["value"]));
} }), [["__scopeId", "data-v-2778f8a0"]]), q = { class: "title" }, O = A(t({ __name: "EchartsBaseConfig", props: { title: { type: String, default: "主题" } }, emits: ["themeChange"], setup(t2, { emit: e2 }) {
  ...
  return (e3, o3) => (i(), l("div", { class: a(u(p2)) }, [r(z, { title: "基础配置" }, { default: s(() => [c("div", q, h(t2.title), 1), r(H, { color: u(n2).getCurConfigComponent.chart.options.themeColor, onThemeChange: f2 }, null, 8, ["color"]), v(e3.$slots, "default", {}, void 0, true)]), _: 3 })], 2));
