...
import { u as k, T as z, am as U, f as T, _ as A, an as F } from "./index.js";
import "@vueuse/core";
import { Icon as I } from "@mfish/core/components/Icon";
import "lodash-es";
import "@mfish/core/enums";
import "@mfish/core/utils/Is";
import { C as w } from "./ConfigGroup.js";
const E = { class: "title" }, W = { style: { display: "flex", gap: "6px" } }, j = A(t({ __name: "EchartsTitleConfig", setup(t2) {
  ...
  function F2(t3) {
    var _a, _b;
    (_a = g2.getCurConfigComponent.chart.options.title.textStyle) == null ? true : delete _a.fontStyle, (_b = g2.getCurConfigComponent.chart.options.title.textStyle) == null ? true : delete _b.fontWeight, j2(t3);
  }
  function j2(t3) {
  ...
  function B2(t3) {
    var _a, _b;
    (_a = g2.getCurConfigComponent.chart.options.title.subtextStyle) == null ? true : delete _a.fontStyle, (_b = g2.getCurConfigComponent.chart.options.title.subtextStyle) == null ? true : delete _b.fontWeight, H2(t3);
  }
  function H2(t3) {
  ...
  return o(() => g2.getCurConfigComponent, (t3) => {
    ...
    var _a;
    const o2 = n("AInput");
    return i(), l("div", { class: a(u(v2)) }, [r(w, { title: "标题", "default-expand": false, "allow-check": true, "title-check": (_a = u(g2).getCurConfigComponent.chart.options.title) == null ? void 0 : _a.show, onChecked: G2 }, { default: s(() => [e2[7] || (e2[7] = c("div", { class: "title" }, " 主标题", -1)), r(o2, { value: u(g2).getCurConfigComponent.chart.options.title.text, "onUpdate:value": e2[0] || (e2[0] = (t4) => u(g2).getCurConfigComponent.chart.options.title.text = t4), "show-count": "", maxlength: 50 }, null, 8, ["value"]), r(u(z), { "hide-font-style": [u(U).Underline, u(U).Strikethrough, u(U).Bold], "hide-align": true, "color-type": 1, "text-style": h2.value, onFontChange: j2, onSizeChange: j2, onHAlignChange: A2, onFontStyleChange: F2, onColorChange: j2 }, null, 8, ["hide-font-style", "text-style"]), e2[8] || (e2[8] = c("div", { class: "title" }, " 副标题", -1)), r(o2, { value: u(g2).getCurConfigComponent.chart.options.title.subtext, "onUpdate:value": e2[1] || (e2[1] = (t4) => u(g2).getCurConfigComponent.chart.options.title.subtext = t4), "show-count": "", maxlength: 50 }, null, 8, ["value"]), r(u(z), { "hide-font-style": [u(U).Underline, u(U).Strikethrough], "hide-align": true, "color-type": 1, "text-style": m2.value, onFontChange: H2, onSizeChange: H2, onHAlignChange: A2, onFontStyleChange: B2, onColorChange: H2 }, null, 8, ["hide-font-style", "text-style"]), c("div", E, [e2[6] || (e2[6] = f(" 标题位置 ")), r(u(d), { size: "small", value: u(g2).getCurConfigComponent.chart.options.title.left, "onUpdate:value": e2[2] || (e2[2] = (t4) => u(g2).getCurConfigComponent.chart.options.title.left = t4) }, { default: s(() => [(i(), l(p, null, C(S2, (t4) => r(u(y), { key: t4.value, placement: "top", title: t4.title }, { default: s(() => [r(u(x), { class: "radio-button", value: t4.value }, { default: s(() => [r(u(I), { size: 12, icon: t4.icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["value"])]), _: 2 }, 1032, ["title"])), 64))]), _: 1 }, 8, ["value"]), r(u(d), { size: "small", value: u(g2).getCurConfigComponent.chart.options.title.top, "onUpdate:value": e2[3] || (e2[3] = (t4) => u(g2).getCurConfigComponent.chart.options.title.top = t4) }, { default: s(() => [(i(), l(p, null, C(b2, (t4) => r(u(y), { key: t4.value, placement: "top", title: t4.title }, { default: s(() => [r(u(x), { class: "radio-button", value: t4.value }, { default: s(() => [r(u(I), { size: 12, icon: t4.icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["value"])]), _: 2 }, 1032, ["title"])), 64))]), _: 1 }, 8, ["value"])]), c("div", W, [r(u(T), { prefix: "左", "is-number": false, placeholder: "数字或百分比", value: u(g2).getCurConfigComponent.chart.options.title.left, "onUpdate:value": e2[4] || (e2[4] = (t4) => u(g2).getCurConfigComponent.chart.options.title.left = t4) }, null, 8, ["value"]), r(u(T), { prefix: "上", "is-number": false, placeholder: "数字或百分比", value: u(g2).getCurConfigComponent.chart.options.title.top, "onUpdate:value": e2[5] || (e2[5] = (t4) => u(g2).getCurConfigComponent.chart.options.title.top = t4) }, null, 8, ["value"])])]), _: 1 }, 8, ["title-check"])], 2);
  };
} }), [["__scopeId", "data-v-73b5e00b"]]), B = { class: "color-contain" }, H = A(t({ __name: "EchartsThemeConfig", props: { color: { type: String, default: "默认" } }, emits: ["themeChange"], setup(t2, { emit: o2 }) {
  const n2 = o2, r2 = e(t2.color), { prefixCls: v2 } = _("echarts-theme-config");
  function d2() {
    const t3 = F.find((t4) => t4.name === r2.value);
    t3 && n2("themeChange", t3);
  }
  return (t3, e2) => (i(), g(u(S), { value: r2.value, "onUpdate:value": e2[0] || (e2[0] = (t4) => r2.value = t4), placeholder: "选择一个主题", onChange: d2 }, { default: s(() => [(i(true), l(p, null, C(u(F), (t4, e3) => (i(), g(u(b), { label: t4.name, value: t4.name, key: e3 }, { default: s(() => [c("div", { class: a(u(v2)) }, [f(h(t4.name) + " ", 1), c("div", B, [(i(true), l(p, null, C(t4.color, (t5) => (i(), l("div", { class: "color-box", style: m({ backgroundColor: t5 }), key: t5 }, null, 4))), 128))])], 2)]), _: 2 }, 1032, ["label", "value"]))), 128))]), _: 1 }, 8, ["value"]));
} }), [["__scopeId", "data-v-2778f8a0"]]), G = A(t({ __name: "EchartsBaseConfig", emits: ["themeChange"], setup(t2, { emit: e2 }) {
  ...
  return (t3, e3) => (i(), l("div", { class: a(u(f2)) }, [r(w, { title: "基础配置" }, { default: s(() => [e3[0] || (e3[0] = c("div", { class: "title" }, " 主题", -1)), r(H, { color: u(n2).getCurConfigComponent.chart.options.themeColor, onThemeChange: p2 }, null, 8, ["color"]), v(t3.$slots, "default", {}, void 0, true)]), _: 3 })], 2));
