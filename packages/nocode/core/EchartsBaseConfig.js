import { defineComponent as t, ref as e, watch as o, resolveComponent as n, openBlock as l, createElementBlock as i, normalizeClass as a, unref as u, createVNode as r, withCtx as s, createElementVNode as c, createTextVNode as p, Fragment as f, renderList as C, createBlock as g, toDisplayString as h, normalizeStyle as m, renderSlot as v } from "vue";
...
import { u as k, d as z, O as U, e as T, _ as A, ap as F } from "./index.js";
import "@vueuse/core";
...
const E = { class: "title" }, W = { style: { display: "flex", gap: "6px" } }, j = A(t({ __name: "EchartsTitleConfig", setup(t2) {
  ...
  return (t3, e2) => (l(), g(u(S), { value: r2.value, "onUpdate:value": e2[0] || (e2[0] = (t4) => r2.value = t4), placeholder: "选择一个主题", onChange: d2 }, { default: s(() => [(l(true), i(f, null, C(u(F), (t4, e3) => (l(), g(u(b), { label: t4.name, value: t4.name, key: e3 }, { default: s(() => [c("div", { class: a(u(v2)) }, [p(h(t4.name) + " ", 1), c("div", B, [(l(true), i(f, null, C(t4.color, (t5) => (l(), i("div", { class: "color-box", style: m({ backgroundColor: t5 }), key: t5 }, null, 4))), 128))])], 2)]), _: 2 }, 1032, ["label", "value"]))), 128))]), _: 1 }, 8, ["value"]));
} }), [["__scopeId", "data-v-2778f8a0"]]), O = { class: "title" }, $ = A(t({ __name: "EchartsBaseConfig", props: { title: { type: String, default: "主题" } }, emits: ["themeChange"], setup(t2, { emit: e2 }) {
  const o2 = e2, n2 = k(), { prefixCls: p2 } = _("echarts-base-config");
  function f2(t3) {
  ...
  return (e3, o3) => (l(), i("div", { class: a(u(p2)) }, [r(z, { title: "基础配置" }, { default: s(() => [c("div", O, h(t2.title), 1), r(H, { color: u(n2).getCurConfigComponent.chart.options.themeColor, onThemeChange: f2 }, null, 8, ["color"]), v(e3.$slots, "default", {}, void 0, true)]), _: 3 })], 2));
} }), [["__scopeId", "data-v-444121b4"]]);
export {
  j as E,
  $ as a
};
