...
import { u as F, j as _, d as x, M as I, _ as w } from "./index.js";
...
const G = { class: "title" }, U = { style: { width: "90px", "font-weight": "500" } }, S = w(o({ __name: "MfTableConfig", setup(o2) {
  const { prefixCls: w2 } = k("scroll-table-config"), S2 = e(), z = e(), R = e(), T = F(), j = e(35), M = e(5), P = e(1.5), A = e(""), D = e(true), $ = e("single"), q = e([]), E = [{ title: "左", value: "left" }, { title: "中", value: "center" }, { title: "右", value: "right" }], { setDataTable: J } = _(), K = n(() => {
    let o3;
