...
const G = { class: "title" }, U = { style: { width: "90px", "font-weight": "500" } }, S = _(o({ __name: "MfTableConfig", setup(o2) {
  ...
  return (o3, e2) => {
    const n2 = a("AInput");
    return l(), i(d, { class: u(C(_2)) }, { default: r(() => [s(I, { title: "表头设置" }, { default: r(() => [e2[3] || (e2[3] = g("div", { class: "title" }, " 背景颜色", -1)), s(C(w), { placeholder: "设置背景颜色，格式#FFFFFF", value: S2.value, onConfirmChange: N, onInputChange: O }, null, 8, ["value"]), s(I, { title: "行号设置", "allow-check": true, "title-check": C(T).getCurConfigComponent.chart.options?.index, onChecked: oo }, { default: r(() => [e2[2] || (e2[2] = g("div", { class: "title" }, " 行号表头名称", -1)), s(n2, { value: A.value, "onUpdate:value": e2[0] || (e2[0] = (o4) => A.value = o4), onChange: eo }, null, 8, ["value"])]), _: 1 }, 8, ["title-check"])]), _: 1 }), s(I, { title: "表体设置" }, { default: r(() => [g("div", G, [e2[4] || (e2[4] = c(" 表行数（行） ", -1)), s(C(H), { value: M.value, "onUpdate:value": e2[1] || (e2[1] = (o4) => M.value = o4), min: 1, max: 50, onChange: V }, null, 8, ["value"])]), e2[5] || (e2[5] = g("div", { class: "title" }, " 奇数行颜色", -1)), s(C(w), { placeholder: "设置奇数行颜色，格式#FFFFFF", value: z.value, onConfirmChange: W, onInputChange: X }, null, 8, ["value"]), e2[6] || (e2[6] = g("div", { class: "title" }, " 偶数行颜色", -1)), s(C(w), { placeholder: "设置偶数行颜色，格式#FFFFFF", value: R.value, onConfirmChange: Y, onInputChange: Z }, null, 8, ["value"])]), _: 1 }), K.value > 0 ? (l(), i(I, { key: 0, title: "列配置" }, { default: r(() => [(l(true), f(h, null, m(K.value, (o4) => (l(), f("div", { key: o4, class: "title" }, [c(v(`${o4}列`) + " 宽度 ", 1), s(C(H), { value: L.value[o4 - 1], "onUpdate:value": (e3) => L.value[o4 - 1] = e3, min: 0, max: 1e3, onChange: (e3) => (function(o5) {
