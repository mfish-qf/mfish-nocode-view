import { defineComponent as e, ref as o, watch as t, openBlock as n, createBlock as a, normalizeClass as l, unref as u, withCtx as i, createElementVNode as c, createTextVNode as r, createVNode as p, createElementBlock as v, createCommentVNode as s } from "vue";
...
const k = { class: "title" }, U = { class: "title" }, y = { key: 0, class: "title" }, w = { key: 1, class: "title" }, A = { key: 2, class: "title" }, _ = { key: 3, class: "title" }, b = g(e({ __name: "MfInputConfig", props: { textArea: { type: Boolean, default: false } }, setup(e2) {
  ...
  }, { immediate: true }), (o2, t2) => (n(), a(d, { class: l(u(g2)) }, { default: i(() => [c("div", k, [t2[10] || (t2[10] = r(" 提示信息 ", -1)), c("div", null, [p(u(m), { value: E.value, "onUpdate:value": t2[0] || (t2[0] = (e3) => E.value = e3), onChange: R }, null, 8, ["value"])])]), c("div", U, [t2[11] || (t2[11] = r(" 最大长度 ", -1)), c("div", null, [p(u(x), { style: { width: "100%" }, value: M.value, "onUpdate:value": t2[1] || (t2[1] = (e3) => M.value = e3), onChange: N }, null, 8, ["value"])])]), e2.textArea ? s("", true) : (n(), v("div", y, [t2[12] || (t2[12] = r(" 前置标签 ", -1)), c("div", null, [p(u(m), { value: B.value, "onUpdate:value": t2[2] || (t2[2] = (e3) => B.value = e3), onChange: F }, null, 8, ["value"])])])), e2.textArea ? s("", true) : (n(), v("div", w, [t2[13] || (t2[13] = r(" 后置标签 ", -1)), c("div", null, [p(u(m), { value: j.value, "onUpdate:value": t2[3] || (t2[3] = (e3) => j.value = e3), onChange: G }, null, 8, ["value"])])])), e2.textArea ? s("", true) : (n(), v("div", A, [t2[14] || (t2[14] = c("span", { style: { width: "55px" } }, "前缀", -1)), c("div", null, [p(u(m), { value: q.value, "onUpdate:value": t2[4] || (t2[4] = (e3) => q.value = e3), onChange: O }, null, 8, ["value"])])])), e2.textArea ? s("", true) : (n(), v("div", _, [t2[15] || (t2[15] = c("span", { style: { width: "55px" } }, "后缀", -1)), c("div", null, [p(u(m), { value: z.value, "onUpdate:value": t2[5] || (t2[5] = (e3) => z.value = e3), onChange: P }, null, 8, ["value"])])])), p(C, { title: "允许清空", tooltip: "可以点击清除图标删除内容", checked: I.value, "onUpdate:checked": t2[6] || (t2[6] = (e3) => I.value = e3), onChange: H }, null, 8, ["checked"]), p(C, { title: "显示边框", tooltip: "勾选后显示边框", checked: S.value, "onUpdate:checked": t2[7] || (t2[7] = (e3) => S.value = e3), onChange: K }, null, 8, ["checked"]), p(C, { title: "是否禁用", tooltip: "勾选后禁用输入框，默认否", checked: J.value, "onUpdate:checked": t2[8] || (t2[8] = (e3) => J.value = e3), onChange: L }, null, 8, ["checked"]), p(C, { title: "显示字数", tooltip: "勾选后显示字数", checked: D.value, "onUpdate:checked": t2[9] || (t2[9] = (e3) => D.value = e3), onChange: Q }, null, 8, ["checked"])]), _: 1 }, 8, ["class"]));
