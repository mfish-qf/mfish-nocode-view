...
const V = D(a({ __name: "MfInputDataConfig", props: { isNumber: { type: Boolean, default: false } }, setup(a2) {
  ...
  return n(() => D2.getCurConfigComponent, (a3) => {
    ...
    const n2 = o("AInput");
    return u(), l(g, { class: s(i(I)), onRefreshData: F, onDataTypeChange: U }, { "data-select": r(() => [c(e2.$slots, "data-select", {}, void 0, true)]), "static-data": r(() => [t2[2] || (t2[2] = d("div", { class: "title" }, "默认值", -1)), a2.isNumber ? (u(), l(i(x), { key: 0, style: { width: "100%" }, value: k.value, "onUpdate:value": t2[0] || (t2[0] = (a3) => k.value = a3), maxlength: 500, onChange: T }, null, 8, ["value"])) : (u(), l(n2, { key: 1, value: k.value, "onUpdate:value": t2[1] || (t2[1] = (a3) => k.value = a3), "show-count": "", maxlength: 500, onChange: T }, null, 8, ["value"]))]), "target-data": r(() => [t2[3] || (t2[3] = d("div", { class: "title" }, "默认值", -1)), f(C, { "max-count": 1, height: 150, onDataChange: N, fields: w.value }, null, 8, ["fields"])]), _: 3 }, 8, ["class"]);
  };
