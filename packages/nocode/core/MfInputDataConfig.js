...
const _ = D(a({ __name: "MfInputDataConfig", setup(a2) {
  ...
  function w() {
    const a3 = V("value");
    a3 && a3.length > 0 ? I() : j(D2.getCurConfigComponent.chart);
  }
  function A(a3) {
    D2.getCurConfigComponent.chart.data.defaultValue = void 0, a3.length > 0 ? (_2("value", a3), I()) : (x("value"), j(D2.getCurConfigComponent.chart));
  }
  function M() {
