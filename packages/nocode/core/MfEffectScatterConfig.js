import { defineComponent as e, ref as l, watch as a, openBlock as u, createElementBlock as t, normalizeClass as v, unref as o, createVNode as i, withCtx as n, createElementVNode as c, Fragment as s, renderList as f, createTextVNode as d, toDisplayString as r, createCommentVNode as p } from "vue";
...
const x = { class: "title" }, _ = { key: 0, class: "title" }, w = g(e({ __name: "MfEffectScatterConfig", props: { config: { type: Object, default: void 0 }, allowCheck: { type: Boolean, default: true }, defaultExpand: { type: Boolean, default: false } }, emits: ["change", "showScatterChecked"], setup(e2, { emit: g2 }) {
  ...
  return a(() => U.getCurConfigComponent, (e3) => {
    ...
    A.value = !!e3, e3 && D();
  }, { immediate: true }), (l2, a2) => (u(), t("div", { class: v(o(z)) }, [i(h, { title: "气泡配置", "default-expand": e2.defaultExpand, "allow-check": e2.allowCheck, "title-check": A.value, onChecked: F }, { default: n(() => [a2[9] || (a2[9] = c("div", { class: "title" }, " 形状", -1)), i(o(C), { size: "small", value: j.value, "onUpdate:value": a2[0] || (a2[0] = (e3) => j.value = e3), onChange: G }, { default: n(() => [(u(), t(s, null, f(R, (e3) => i(o(y), { key: e3.value, value: e3.value }, { default: n(() => [d(r(e3.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"]), c("div", x, [a2[5] || (a2[5] = d(" 大小 ", -1)), i(o(k), { value: L.value, "onUpdate:value": a2[1] || (a2[1] = (e3) => L.value = e3), min: 5, max: 50, onChange: H }, null, 8, ["value"]), a2[6] || (a2[6] = d(" 角度 ", -1)), i(o(k), { value: M.value, "onUpdate:value": a2[2] || (a2[2] = (e3) => M.value = e3), min: 0, max: 360, onChange: J }, null, 8, ["value"])]), i(E, { series: q.value, onLabelChange: K }, null, 8, ["series"]), o(U).getCurConfigComponent?.chart?.options?.geo ? (u(), t("div", _, [a2[7] || (a2[7] = d(" 涟漪类型 ", -1)), i(o(C), { size: "small", value: T.value, "onUpdate:value": a2[3] || (a2[3] = (e3) => T.value = e3), onChange: N }, { default: n(() => [(u(), t(s, null, f(B, (e3) => i(o(y), { key: e3.value, value: e3.value }, { default: n(() => [d(r(e3.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"]), a2[8] || (a2[8] = d(" 数量 ", -1)), c("div", null, [i(o(k), { value: O.value, "onUpdate:value": a2[4] || (a2[4] = (e3) => O.value = e3), min: 0, max: 10, onChange: P }, null, 8, ["value"])])])) : p("", true)]), _: 1 }, 8, ["default-expand", "allow-check", "title-check"])], 2));
