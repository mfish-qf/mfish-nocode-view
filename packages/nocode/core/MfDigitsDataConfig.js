...
import { InputNumber as m } from "ant-design-vue";
import { u as g, m as p, _ as C } from "./index.js";
const h = "num", v = C(t({ __name: "MfDigitsDataConfig", setup(t2) {
  const C2 = g(), { setFields: v2, deleteFields: D, setDataTable: _ } = p(), { prefixCls: x } = u("digits-data-config"), j = a(() => C2.getCurConfigComponent.chart.data.fields ? C2.getCurConfigComponent.chart.data.fields[h] ?? [] : []);
  function F() {
    _();
  }
  function I(t3) {
  ...
  return (t3, a2) => (s(), e(f, { class: o(i(x)), onRefreshData: F }, { "data-select": n(() => [r(t3.$slots, "data-select", {}, void 0, true)]), "static-data": n(() => [a2[1] || (a2[1] = l("div", { class: "title" }, "显示内容", -1)), d(i(m), { style: { width: "100%" }, value: i(C2).getCurConfigComponent.chart.data.dataSet, "onUpdate:value": a2[0] || (a2[0] = (t4) => i(C2).getCurConfigComponent.chart.data.dataSet = t4), placeholder: "显示内容", step: 1 }, null, 8, ["value"])]), "target-data": n(() => [a2[2] || (a2[2] = l("div", { class: "title" }, "显示内容", -1)), d(c, { "max-count": 1, height: 150, onDataChange: I, fields: j.value }, null, 8, ["fields"])]), _: 3 }, 8, ["class"]));
