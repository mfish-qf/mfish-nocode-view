...
const y = { class: "title" }, B = { class: "title" }, G = { class: "title" }, R = { class: "title" }, T = { style: { width: "90px", "font-weight": "500" } }, W = x(e({ __name: "MfScrollTableConfig", setup(e2) {
  ...
  return n(() => P.getCurConfigComponent, (e3) => {
    ...
    const o2 = a("AInput");
    return u(), l(m, { class: i(C(x2)) }, { default: r(() => [g(k, { title: "表头设置", "allow-check": true, "title-check": C(P).getCurConfigComponent.chart.options?.showHeader, onChecked: oe }, { default: r(() => [t2[8] || (t2[8] = c("div", { class: "title" }, " 背景颜色", -1)), g(C(w), { placeholder: "设置背景颜色，格式#FFFFFF", value: W2.value, onConfirmChange: Q, onInputChange: V }, null, 8, ["value"]), c("div", y, [t2[6] || (t2[6] = v(" 表头高度 ", -1)), g(C(U), { value: b.value, "onUpdate:value": t2[0] || (t2[0] = (e4) => b.value = e4), min: 0, max: A.value, onChange: ne }, null, 8, ["value", "max"])]), g(k, { title: "行号设置", "allow-check": true, "title-check": C(P).getCurConfigComponent.chart.options?.index, onChecked: le }, { default: r(() => [t2[7] || (t2[7] = c("div", { class: "title" }, " 行号表头名称", -1)), g(o2, { value: $.value, "onUpdate:value": t2[1] || (t2[1] = (e4) => $.value = e4), onChange: ue }, null, 8, ["value"])]), _: 1 }, 8, ["title-check"])]), _: 1 }, 8, ["title-check"]), g(k, { title: "表体设置" }, { default: r(() => [c("div", B, [t2[9] || (t2[9] = v(" 表行数（行） ", -1)), g(C(U), { value: j.value, "onUpdate:value": t2[2] || (t2[2] = (e4) => j.value = e4), min: 1, max: 50, onChange: X }, null, 8, ["value"])]), t2[13] || (t2[13] = c("div", { class: "title" }, " 奇数行颜色", -1)), g(C(w), { placeholder: "设置奇数行颜色，格式#FFFFFF", value: M.value, onConfirmChange: Y, onInputChange: Z }, null, 8, ["value"]), t2[14] || (t2[14] = c("div", { class: "title" }, " 偶数行颜色", -1)), g(C(w), { placeholder: "设置偶数行颜色，格式#FFFFFF", value: N.value, onConfirmChange: ee, onInputChange: te }, null, 8, ["value"]), c("div", G, [t2[10] || (t2[10] = v(" 轮播方式 ", -1)), c("div", null, [g(C(S), { size: "small", value: D.value, "onUpdate:value": t2[3] || (t2[3] = (e4) => D.value = e4), onChange: Ce }, { default: r(() => [(u(), h(s, null, d(E, (e4) => g(C(H), { key: e4.value, value: e4.value }, { default: r(() => [v(f(e4.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])])]), c("div", R, [t2[11] || (t2[11] = v(" 轮播间隔（秒） ", -1)), g(C(U), { value: z.value, "onUpdate:value": t2[4] || (t2[4] = (e4) => z.value = e4), min: 0.1, max: 5, step: 0.1, onChange: ae }, null, 8, ["value"])]), g(C(I), { checked: q.value, "onUpdate:checked": t2[5] || (t2[5] = (e4) => q.value = e4), onChange: ie }, { default: r(() => [...t2[12] || (t2[12] = [v(" 悬浮暂停轮播", -1)])]), _: 1 }, 8, ["checked"])]), _: 1 }), L.value > 0 ? (u(), l(k, { key: 0, title: "列配置" }, { default: r(() => [(u(true), h(s, null, d(L.value, (e4) => (u(), h("div", { key: e4, class: "title" }, [v(f(`${e4}列`) + " 宽度 ", 1), g(C(U), { value: O.value[e4 - 1], "onUpdate:value": (t3) => O.value[e4 - 1] = t3, min: 0, max: 500, onChange: ge }, null, 8, ["value", "onUpdate:value"]), c("span", T, [g(C(S), { size: "small", value: J.value[e4 - 1], "onUpdate:value": (t3) => J.value[e4 - 1] = t3, onChange: re }, { default: r(() => [(u(), h(s, null, d(K, (e5) => g(C(H), { key: e5.value, value: e5.value }, { default: r(() => [v(f(e5.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 2 }, 1032, ["value", "onUpdate:value"])])]))), 128))]), _: 1 })) : p("", true)]), _: 1 }, 8, ["class"]);
  };
