...
const y = { class: "title" }, B = { class: "title" }, G = { class: "title" }, R = { class: "title" }, T = { style: { width: "90px", "font-weight": "500" } }, W = w(e({ __name: "MfScrollTableConfig", setup(e2) {
  const { prefixCls: w2 } = x("scroll-table-config"), W2 = t(), b = t(), N = t(), P = _(), j = t(35), z = t(5), M = t(1.5), A = o(() => Math.round(P.getCurConfigComponent.chartContain.dropInfo.height / 2)), $ = t(""), q = t(true), D = t("single"), E = [{ title: "单条", value: "single" }, { title: "整页", value: "page" }], J = t([]), K = [{ title: "左", value: "left" }, { title: "中", value: "center" }, { title: "右", value: "right" }], L = o(() => {
    var _a, _b, _c;
    let e3;
