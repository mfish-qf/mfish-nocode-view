...
import { c as S, u as _, _ as k } from "./index.js";
import { P as x, J as j } from "./JumpParams.js";
const w = { class: "title" }, P = k(e({ __name: "MfFrameConfig", setup(e2) {
  const { prefixCls: k2 } = d("frame-config"), P2 = [S.System, S.External], I = a(S.System), J = _(), T = a(), U = a();
  function b() {
  ...
  return t(() => J.getCurConfigComponent, (e3) => {
    ...
    const t2 = o("AInput");
    return u(), n(c, { class: l(r(k2)) }, { default: p(() => [s("div", w, [a2[2] || (a2[2] = m(" 组件类型 ", -1)), i(r(h), { size: "small", value: I.value, "onUpdate:value": a2[0] || (a2[0] = (e4) => I.value = e4), onChange: b }, { default: p(() => [(u(), C(g, null, v(P2, (e4, a3) => i(r(y), { key: a3, value: e4 }, { default: p(() => [m(f(e4), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])]), I.value === r(S).System ? (u(), n(x, { key: 0, page: T.value, onOk: z }, null, 8, ["page"])) : (u(), n(t2, { key: 1, placeholder: "请输入外部链接，例如https://www.bing.com", value: U.value, "onUpdate:value": a2[1] || (a2[1] = (e4) => U.value = e4), onChange: A }, null, 8, ["value"])), a2[3] || (a2[3] = s("div", { class: "title" }, " 传入参数 ", -1)), i(j, { "params-value": r(J).getCurConfigComponent.chart.options?.params, onParamsChange: E }, null, 8, ["params-value"])]), _: 1 }, 8, ["class"]);
  };
