...
const _u = { class: "share-title" }, Du = e({ __name: "ScreenPreview", props: { fixScale: { type: Number, default: 1 }, borderRadius: { type: String } }, setup(e2) {
  ...
  const o2 = e2, n2 = t2, a2 = y(o2.titleCheck), l2 = y(o2.defaultExpand), { prefixCls: i2 } = se("config-group"), c2 = pi();
  function m2() {
    o2.allowCollapse ? l2.value = !l2.value : l2.value = true;
  }
  function C2() {
    l2.value = !!a2.value, n2("checked", a2.value);
  }
  function v2() {
    n2("copy", (e3) => {
      c2.setCopyConfig(e3);
  ...
  function b2() {
    n2("paste", c2.getCopyConfig);
  }
  return (t3, o3) => (s(), r("div", { class: p(u(i2)) }, [d("div", { class: p(["group-title", [e2.allowCollapse ? "collapsed" : ""]]), onClick: m2 }, [d("div", zu, [e2.allowCheck ? (s(), h(u(Z), { key: 0, checked: a2.value, "onUpdate:checked": o3[0] || (o3[0] = (e3) => a2.value = e3), onClick: o3[1] || (o3[1] = x(() => {
  }, ["stop"])), onChange: C2 }, null, 8, ["checked"])) : f("", true), e2.tooltip ? (s(), h(u(V), { key: 1, title: e2.tooltip }, { default: w(() => [S(k(e2.title), 1)]), _: 1 }, 8, ["title"])) : (s(), r("span", Nu, k(e2.title), 1)), !e2.allowCheck && e2.allowCollapse || e2.allowCheck && e2.titleCheck ? (s(), h(u(ge), { key: 3, icon: `ant-design:${l2.value ? "up" : "down"}-outlined`, size: 12 }, null, 8, ["icon"])) : f("", true)]), d("div", { onClick: o3[2] || (o3[2] = x(() => {
  }, ["stop"])) }, [A(t3.$slots, "action", {}, void 0, true)]), e2.allowCopy ? (s(), r("div", Ou, [g(u(V), { placement: "top", title: `复制${e2.title}` }, { default: w(() => [g(u(ge), { "aria-hidden": "false", size: 12, icon: "iconfont:icon-mfish-copy", onClick: x(v2, ["stop"]) })]), _: 1 }, 8, ["title"]), g(u(V), { placement: "top", title: `粘贴${e2.title}` }, { default: w(() => [g(u(ge), { "aria-hidden": "false", size: 12, icon: "iconfont:icon-mfish-paste", onClick: x(b2, ["stop"]) })]), _: 1 }, 8, ["title"])])) : f("", true)], 2), g(u(Je), { show: !e2.allowCheck && l2.value || e2.allowCheck && l2.value && e2.titleCheck }, { default: w(() => [d("div", Ru, [A(t3.$slots, "default", {}, void 0, true)])]), _: 3 }, 8, ["show"])], 2));
} }), Au = $t(ju, [["__scopeId", "data-v-9aa90d73"]]), Eu = { class: "table-bordered" }, Pu = e({ __name: "GlobalParamsConfig", setup(e2) {
  ...
  return i(() => {
    ...
    const i2 = M("AInput");
    return s(), h(u(We), null, { default: w(() => [d("div", { class: p(u(t2)) }, [l2[8] || (l2[8] = d("div", { class: "title" }, "大屏名称", -1)), g(i2, { value: u(o2).getCanvasConfig.screenName, "onUpdate:value": l2[0] || (l2[0] = (e4) => u(o2).getCanvasConfig.screenName = e4), "show-count": "", maxlength: 30 }, null, 8, ["value"]), l2[9] || (l2[9] = d("div", { class: "title" }, " 描述", -1)), g(u(ae), { value: u(o2).getCanvasConfig.screenDesc, "onUpdate:value": l2[1] || (l2[1] = (e4) => u(o2).getCanvasConfig.screenDesc = e4), "show-count": "", maxlength: 200 }, null, 8, ["value"]), l2[10] || (l2[10] = d("div", { class: "title" }, "大屏尺寸", -1)), g(Tu), d("div", Hu, [l2[5] || (l2[5] = S(" 主题 ")), g(u(X), { size: "small", value: u(o2).getCanvasConfig.theme, "onUpdate:value": l2[2] || (l2[2] = (e4) => u(o2).getCanvasConfig.theme = e4) }, { default: w(() => [(s(), r(m, null, C(a2, (e4, t3) => g(u(Y), { key: t3, value: e4.value }, { default: w(() => [S(k(e4.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])]), l2[11] || (l2[11] = d("div", { class: "title" }, "背景颜色", -1)), g(u(po), { value: n2.value, onConfirmChange: f2, onInputChange: v2 }, null, 8, ["value"]), l2[12] || (l2[12] = d("div", { class: "title" }, "背景图片", -1)), g(u(qe), { "file-keys": u(o2).getCanvasConfig.backgroundImage, accepts: ".jpg,.jpeg,.png,.svg", "button-text": "上传背景", "max-count": 1, "is-pic": true, onSuccess: b2, onRemove: x2 }, null, 8, ["file-keys"]), d("div", Fu, [l2[6] || (l2[6] = S(" 水印 ")), d("div", null, [g(i2, { value: u(o2).getCanvasConfig.watermark, "onUpdate:value": l2[3] || (l2[3] = (e4) => u(o2).getCanvasConfig.watermark = e4), placeholder: "清空无水印", "show-count": "", maxlength: 50 }, null, 8, ["value"])])]), d("div", Gu, [l2[7] || (l2[7] = S(" 适配方式 ")), d("div", null, [g(u(X), { value: u(o2).getCanvasConfig.fitType, "onUpdate:value": l2[4] || (l2[4] = (e4) => u(o2).getCanvasConfig.fitType = e4) }, { default: w(() => [(s(true), r(m, null, C(Object.keys(c2), (e4) => (s(), h(u(V), { key: e4, placement: "bottomRight", title: c2[e4].description }, { default: w(() => [g(u(Y), { class: p(`${u(t2)}-radio-button`), value: e4 }, { default: w(() => [g(u(ge), { icon: c2[e4].icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["class", "value"])]), _: 2 }, 1032, ["title"]))), 128))]), _: 1 }, 8, ["value"])])]), g(Pu)], 2)]), _: 1 });
  };
