...
import { CodeEditor as Dt, MODE as It } from "@mfish/core/components/CodeEditor";
...
class Xt {
  ...
  fromString(e2) {
    ...
    if (e2.includes("hsl")) {
      ...
      if (4 === o2.length ? this._alpha = 100 * Number.parseFloat(o2[3].toString()) : 3 === o2.length && (this._alpha = 100), o2.length >= 3) {
        const { h: e3, s: a2, v: l2 } = Zt(o2[0], o2[1], o2[2]);
        t2(e3, a2, l2);
      }
    } else if (e2.includes("#")) {
      ...
      let a2, l2, n2;
      3 === o2.length ? (a2 = Yt(o2[0] + o2[0]), l2 = Yt(o2[1] + o2[1]), n2 = Yt(o2[2] + o2[2])) : 6 !== o2.length && 8 !== o2.length || (a2 = Yt(o2.slice(0, 2)), l2 = Yt(o2.slice(2, 4)), n2 = Yt(o2.slice(4, 6))), 8 === o2.length ? this._alpha = Yt(o2.slice(6)) / 255 * 100 : 3 !== o2.length && 6 !== o2.length || (this._alpha = 100);
      const { h: i2, s: r2, v: s2 } = Zt(a2, l2, n2);
      t2(i2, r2, s2);
    }
  }
  compare(e2) {
  ...
  doOnChange() {
    ...
    if (this.enableAlpha) switch (l2) {
      ...
      case "hex":
        ...
        break;
      default: {
        const { r: a3, g: l3, b: n2 } = Kt(e2, t2, o2);
...
function eo(e2, t2) {
  const o2 = function(e3) {
    ...
    var _a2;
    document.removeEventListener("mousemove", o2), document.removeEventListener("mouseup", a2), document.removeEventListener("touchmove", o2), document.removeEventListener("touchend", a2), document.onselectstart = null, document.ondragstart = null, Jt = false, (_a2 = t2.end) == null ? void 0 : _a2.call(t2, e3);
  }, l2 = function(e3) {
    var _a2;
    Jt || (e3.preventDefault(), document.onselectstart = () => false, document.ondragstart = () => false, document.addEventListener("mousemove", o2), document.addEventListener("mouseup", a2), document.addEventListener("touchmove", o2), document.addEventListener("touchend", a2), Jt = true, (_a2 = t2.start) == null ? void 0 : _a2.call(t2, e3));
  };
...
const to = (e2, t2) => {
...
} }), [["__scopeId", "data-v-b2d0e443"]]), lo = { class: "background" }, no = { class: "color-text" }, io = { class: "color-input" }, ro = { class: "color-input-percentage" }, so = { class: "color-input-percentage" }, uo = { class: "color-input-percentage" }, co = { class: "color-input-percentage a" }, po = to(e({ __name: "ColorText", props: { color: { type: Object, required: true } }, setup(e2) {
  ...
  const o2 = e2, n2 = m(zt), i2 = m([]), { prefixCls: f2 } = xe("color-recently"), { token: h2 } = P.useToken(), g2 = a(() => h2.value.colorBorder);
  function C2(e3, t2) {
    return e3.map((e4) => {
      const o3 = new Xt();
...
} }), bo = to(Co, [["__scopeId", "data-v-be7486eb"]]), Mo = { class: "hue-slider" }, ko = ["onMousedown", "onDblclick"], wo = { class: "color-input-percentage" }, xo = e({ __name: "GradientColor", props: { isShow: { type: Boolean, default: false }, colors: { type: Object, default: () => ({ deg: 45, colors: [{ rgba: "rgba(255, 255, 0, 1)", rgbaLength: "0%" }, { rgba: "rgba(0, 0, 255, 0.9)", rgbaLength: "100%" }] }) } }, emits: ["colorChange", "startEyeDropper", "endEyeDropper"], setup(e2, { emit: n2 }) {
  t((e3) => ({ 40133406: T2.value }));
  const i2 = e2, f2 = n2, h2 = m(new Xt({ enableAlpha: true, format: "rgba" }));
  ...
  }, { deep: true }), (t2, o2) => (s(), r("div", null, [p("div", { class: c(d(D2)) }, [p("div", Mo, [g(d(G), { title: "点击增加新颜色", placement: "left" }, { default: M(() => [p("div", { class: "bar", ref_key: "barRef", ref: $2, onClick: k(q2, ["stop", "prevent"]), style: u(N2.value) }, null, 4)]), _: 1 }), (s(true), r(y, null, v(x2.value, (e3, t3) => (s(), r("div", { class: "thumb", ref_for: true, ref: (e4) => function(e5, t4) {
    L2.value[t4] = e5;
...
} }), So = to(xo, [["__scopeId", "data-v-cf05475f"]]), _o = { class: "header" }, $o = { key: 0, class: "content" }, Lo = { key: 1, class: "content" }, Do = { class: "confirm" }, Io = { key: 0 }, To = { key: 1 }, No = e({ __name: "PickerDropdown", props: { type: { type: Number, default: 3 }, selectType: { type: Number, default: 1 }, color: { type: Object, required: true }, colors: { type: Object, default: () => ({ deg: 45, colors: [{ rgba: "rgba(255, 255, 0, 1)", rgbaLength: "0%" }, { rgba: "rgba(0, 0, 255, 0.9)", rgbaLength: "100%" }] }) }, isShow: { type: Boolean, default: false }, hideConfirm: { type: Boolean, default: false }, hideCancel: { type: Boolean, default: false } }, emits: ["changeGradientColor", "pickColor", "restColor", "selectTypeChange", "startEyeDropper", "endEyeDropper"], setup(e2, { emit: t2 }) {
  ...
  return (t3, a3) => {
    const l2 = w("AButton");
    return s(), r("div", { class: c(d(k2)) }, [p("div", _o, [g(d(U), { value: C2.value, options: y2.value, onChange: b2, block: "" }, { label: M(({ payload: e3 }) => [x(S(e3), 1)]), _: 1 }, 8, ["value", "options"])]), 1 !== C2.value || 1 !== e2.type && 3 !== e2.type ? f("", true) : (s(), r("div", $o, [g(oo, { style: { "margin-top": "4px" }, color: e2.color, "is-show": e2.isShow }, null, 8, ["color", "is-show"]), g(ao, { style: { "margin-top": "8px" }, color: e2.color, onEndEyeDropper: T2, onStartEyeDropper: I2 }, null, 8, ["color"]), g(po, { style: { "margin-top": "15px" }, color: e2.color }, null, 8, ["color"]), g(mo, { style: { "margin-top": "8px" }, color: e2.color, "is-show": e2.isShow }, null, 8, ["color", "is-show"])])), 2 !== C2.value || 2 !== e2.type && 3 !== e2.type ? f("", true) : (s(), r("div", Lo, [g(So, { onColorChange: d(L2), colors: e2.colors, "is-show": e2.isShow, onStartEyeDropper: I2, onEndEyeDropper: T2 }, null, 8, ["onColorChange", "colors", "is-show"])])), p("div", Do, [o2.hideCancel ? f("", true) : (s(), h(l2, { key: 0, onClick: $2 }, { default: M(() => a3[0] || (a3[0] = [x("取消")])), _: 1, __: [0] })), g(l2, { onClick: D2, color: d(u2) ? "warning" : "primary" }, { default: M(() => [d(u2) ? (s(), r("span", To, "!已拷贝")) : (s(), r("span", Io, "拷贝"))]), _: 1 }, 8, ["color"]), o2.hideConfirm ? f("", true) : (s(), h(l2, { key: 1, onClick: _2, color: "success" }, { default: M(() => a3[1] || (a3[1] = [x("确定")])), _: 1, __: [1] }))])], 2);
  };
} }), Bo = { key: 0, class: "color-background-text" }, Ro = { class: "color-background-show-box" }, qo = { key: 1, style: { display: "flex" } }, Ao = { class: "color-text" }, Oo = { class: "color-show-box" }, jo = ["title"], zo = e({ name: "MfishColorPicker", __name: "index", props: { value: String, showAlpha: { type: Boolean, default: true }, type: { type: Number, default: 3 }, isDelete: { type: Boolean, default: false }, placeholder: { type: String, default: "请输入颜色，格式#FFFFFF" }, title: { type: String, default: "清空则为无色" }, hideConfirm: { type: Boolean, default: false }, hideCancel: { type: Boolean, default: false } }, emits: ["inputChange", "confirmChange"], setup(e2, { emit: o2 }) {
  t((e3) => ({ "018cd00d": D2.value }));
  const n2 = e2, i2 = o2, { prefixCls: y2 } = xe("color-picker"), v2 = m(1), b2 = Se().getDarkMode, w2 = m(false), x2 = m(new Xt({ value: d(b2) === Ge.DARK ? "#000000" : "#FFFFFF", enableAlpha: n2.showAlpha, format: "rgba" })), S2 = m({ deg: 120, colors: [{ rgba: "rgba(243, 231, 233, 1)", rgbaLength: "0%" }, { rgba: "rgba(227,238,255,1)", rgbaLength: "100%" }] }), _2 = m(""), $2 = m(100), { token: L2 } = P.useToken(), D2 = a(() => L2.value.colorBorder), I2 = m(), T2 = m(), N2 = a(() => ({ background: d(I2), height: "100%" }));
  l(() => n2.value, () => {
    A2();
  }, { immediate: true }), l(x2, (e3) => {
  ...
  function G2(e3) {
    e3.startsWith("linear-gradient(") ? (I2.value = e3, S2.value = Pt(e3), i2("inputChange", e3)) : (e3.value.fromString(e3), _2.value = e3.value.toHex());
  }
  function U2(e3) {
    R2.value = false, 2 === v2.value ? (I2.value = e3, S2.value = Pt(e3), Y2(e3), C(() => i2("confirmChange", d(I2), d(_2)))) : z2();
  }
  function W2() {
  ...
  function Y2(e3) {
    ...
    o3(localStorage.getItem(Ot), zt, e3), t2 = t2.slice(0, 20), localStorage.setItem(Ot, JSON.stringify(t2));
  }
  function Z2(e3) {
...
`("border"), Xo = e({ name: "BorderBox1", props: Ho(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: a2, refreshLayoutSize: l2, domSize: n2 } = Po();
  return o2({ refreshLayoutSize: l2 }), () => {
    const { color: o3, backgroundColor: l3 } = e2, { width: i2, height: r2 } = n2, s2 = Qo(Yo, o3);
    return g(Vo, { class: Uo.getClassNameForBind("border-box-1"), ref: a2 }, { default: () => [g(Ko, { width: i2, height: r2 }, { default: () => [g("polygon", { fill: l3, points: `10, 27 10, ${r2 - 27} 13, ${r2 - 24} 13, ${r2 - 21} 24, ${r2 - 11} 38, ${r2 - 11}
...
`("border-svg-container"), ta = e({ name: "BorderBox2", props: Ho(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: a2, refreshLayoutSize: l2, domSize: n2 } = Po();
  return o2({ refreshLayoutSize: l2 }), () => {
    const { color: o3, backgroundColor: l3 } = e2, { width: i2, height: r2 } = n2, s2 = Qo(Jo, o3);
    return g(Vo, { class: Uo.getClassNameForBind("border-box-2"), ref: a2 }, { default: () => [g(ea, { width: i2, height: r2 }, { default: () => [g("polygon", { fill: l3, points: `7, 7 ${i2 - 7}, 7 ${i2 - 7}, ${r2 - 7} 7, ${r2 - 7}` }, null), g("polyline", { stroke: s2[0], points: `2, 2 ${i2 - 2} ,2 ${i2 - 2}, ${r2 - 2} 2, ${r2 - 2} 2, 2` }, null), g("polyline", { stroke: s2[1], points: `6, 6 ${i2 - 6}, 6 ${i2 - 6}, ${r2 - 6} 6, ${r2 - 6} 6, 6` }, null), g("circle", { fill: s2[0], cx: "11", cy: "11", r: "1" }, null), g("circle", { fill: s2[0], cx: i2 - 11, cy: "11", r: "1" }, null), g("circle", { fill: s2[0], cx: i2 - 11, cy: r2 - 11, r: "1" }, null), g("circle", { fill: s2[0], cx: "11", cy: r2 - 11, r: "1" }, null)] }), g(Wo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
...
`("border-svg-container"), la = e({ name: "BorderBox3", props: Ho(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: a2, refreshLayoutSize: l2, domSize: n2 } = Po();
  return o2({ refreshLayoutSize: l2 }), () => {
    const { color: o3, backgroundColor: l3 } = e2, { width: i2, height: r2 } = n2, s2 = Qo(oa, o3);
    return g(Vo, { class: Uo.getClassNameForBind("border-box-3"), ref: a2 }, { default: () => [g(aa, { width: i2, height: r2 }, { default: () => [g("polygon", { fill: l3, points: `23, 23 ${i2 - 24}, 23 ${i2 - 24}, ${r2 - 24} 23, ${r2 - 24}` }, null), g("polyline", { class: "stroke-width-3", stroke: s2[0], points: `4, 4 ${i2 - 22} ,4 ${i2 - 22}, ${r2 - 22} 4, ${r2 - 22} 4, 4` }, null), g("polyline", { class: "stroke-width-1", stroke: s2[1], points: `10, 10 ${i2 - 16}, 10 ${i2 - 16}, ${r2 - 16} 10, ${r2 - 16} 10, 10` }, null), g("polyline", { class: "stroke-width-1", stroke: s2[1], points: `16, 16 ${i2 - 10}, 16 ${i2 - 10}, ${r2 - 10} 16, ${r2 - 10} 16, 16` }, null), g("polyline", { class: "stroke-width-1", stroke: s2[1], points: `22, 22 ${i2 - 4}, 22 ${i2 - 4}, ${r2 - 4} 22, ${r2 - 4} 22, 22` }, null)] }), g(Wo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
} }), na = ["#2e6099", "#7ce7fd"], ia = Uo.svg`
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0;
...
`("border-svg-container"), ra = e({ name: "BorderBox4", props: { ...Ho(), reverse: { type: Boolean, default: false } }, setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: a2, refreshLayoutSize: l2, domSize: n2 } = Po();
  return o2({ refreshLayoutSize: l2 }), () => {
    const { color: o3, backgroundColor: l3, reverse: i2 } = e2, { width: r2, height: s2 } = n2, u2 = Qo(na, o3);
    return g(Vo, { class: Uo.getClassNameForBind("border-box-4"), ref: a2 }, { default: () => [g(ia, { class: i2 ? "reverse" : "", width: r2, height: s2 }, { default: () => [g("polygon", { fill: l3, points: `${r2 - 15}, 22 170, 22 150, 7 40, 7 28, 21 32, 24
...
`("border-svg-container"), ca = e({ name: "BorderBox5", props: { ...Ho(), reverse: { type: Boolean, default: false } }, setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: a2, refreshLayoutSize: l2, domSize: n2 } = Po();
  return o2({ refreshLayoutSize: l2 }), () => {
    const { color: o3, backgroundColor: l3, reverse: i2 } = e2, { width: r2, height: s2 } = n2, u2 = Qo(sa, o3);
    return g(Vo, { class: Uo.getClassNameForBind("border-box-5"), ref: a2 }, { default: () => [g(ua, { class: i2 ? "reverse" : "", width: r2, height: s2 }, { default: () => [g("polygon", { fill: l3, points: `
...
`("border-svg-container"), fa = e({ name: "BorderBox6", props: Ho(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: a2, refreshLayoutSize: l2, domSize: n2 } = Po();
  return o2({ refreshLayoutSize: l2 }), () => {
    const { color: o3, backgroundColor: l3 } = e2, { width: i2, height: r2 } = n2, s2 = Qo(da, o3);
    return g(Vo, { class: Uo.getClassNameForBind("border-box-6"), ref: a2 }, { default: () => [g(pa, { width: i2, height: r2 }, { default: () => [g("polygon", { fill: l3, points: `
...
`("border-svg-container"), ba = e({ name: "BorderBox8", props: { ...Ho(), duration: { type: Number, default: 3 }, reverse: { type: Boolean, default: false } }, setup(e2, { slots: t2, expose: o2 }) {
  ...
  const i2 = ya();
  return () => {
    const { color: o3, backgroundColor: l3, duration: r2, reverse: s2 } = e2, { width: u2, height: c2 } = n2, d2 = Qo(va, o3), p2 = `border-box-8-path-${i2.id}`, f2 = `border-box-8-gradient-${i2.id}`, h2 = `border-box-8-mask-${i2.id}`, m2 = s2 ? `M 2.5, 2.5 L 2.5, ${c2 - 2.5} L ${u2 - 2.5}, ${c2 - 2.5} L ${u2 - 2.5}, 2.5 L 2.5, 2.5` : `M2.5, 2.5 L${u2 - 2.5}, 2.5 L${u2 - 2.5}, ${c2 - 2.5} L2.5, ${c2 - 2.5} L2.5, 2.5`;
    return g(Vo, { class: Uo.getClassNameForBind("border-box-8"), ref: a2 }, { default: () => [g(Ca, { width: u2, height: c2 }, { default: () => [g("defs", null, [g("path", { id: p2, d: m2, fill: "transparent" }, null), g("radialGradient", { id: f2, cx: "50%", cy: "50%", r: "50%" }, [g("stop", { offset: "0%", "stop-color": "#fff", "stop-opacity": "1" }, null), g("stop", { offset: "100%", "stop-color": "#fff", "stop-opacity": "0" }, null)]), g("mask", { id: h2 }, [g("circle", { cx: "0", cy: "0", r: "150", fill: `url(#${f2})` }, [g("animateMotion", { dur: `${r2}s`, path: m2, rotate: "auto", repeatCount: "indefinite" }, null)])])]), g("polygon", { fill: l3, points: `5, 5 ${u2 - 5}, 5 ${u2 - 5} ${c2 - 5} 5, ${c2 - 5}` }, null), g("use", { stroke: d2[0], "stroke-width": "1", "xlink:href": `#${p2}` }, null), g("use", { stroke: d2[1], "stroke-width": "3", "xlink:href": `#${p2}`, mask: `url(#${h2})` }, [g("animate", { attributeName: "stroke-dasharray", from: `0, ${length}`, to: `${length}, 0`, dur: `${r2}s`, repeatCount: "indefinite" }, null)])] }), g(Wo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
...
`("border-svg-container"), wa = e({ name: "BorderBox9", props: Ho(), setup(e2, { slots: t2, expose: o2 }) {
  ...
  const i2 = ya();
  return () => {
    const { color: o3, backgroundColor: l3 } = e2, { width: r2, height: s2 } = n2, u2 = Qo(Ma, o3), c2 = `border-box-9-gradient-${i2.id}`, d2 = `border-box-9-mask-${i2.id}`;
    return g(Vo, { class: Uo.getClassNameForBind("border-box-9"), ref: a2 }, { default: () => [g(ka, { width: r2, height: s2 }, { default: () => [g("defs", null, [g("linearGradient", { id: c2, x1: "0%", y1: "0%", x2: "100%", y2: "100%" }, [g("animate", { attributeName: "x1", values: "0%;100%;0%", dur: "10s", begin: "0s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "x2", values: "100%;0%;100%", dur: "10s", begin: "0s", repeatCount: "indefinite" }, null), g("stop", { offset: "0%", "stop-color": u2[0] }, [g("animate", { attributeName: "stop-color", values: `${u2[0]};${u2[1]};${u2[0]}`, dur: "10s", begin: "0s", repeatCount: "indefinite" }, null)]), g("stop", { offset: "100%", "stop-color": u2[1] }, [g("animate", { attributeName: "stop-color", values: `${u2[1]};${u2[0]};${u2[1]}`, dur: "10s", begin: "0s", repeatCount: "indefinite" }, null)])]), g("mask", { id: d2 }, [g("polyline", { stroke: "#fff", "stroke-width": "3", fill: "transparent", points: `8, ${0.4 * s2} 8, 3, ${0.4 * r2 + 7}, 3` }, null), g("polyline", { fill: "#fff", points: `
                ...
                ` }, null), g("rect", { x: "0", y: "0", width: r2, height: s2, fill: `url(#${c2})`, mask: `url(#${d2})` }, null)] }), g(Wo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
...
`("border-svg-container"), $a = e({ name: "BorderBox10", props: Ho(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: a2, refreshLayoutSize: l2, domSize: n2 } = Po();
  return o2({ refreshLayoutSize: l2 }), () => {
    const { width: o3, height: l3 } = n2, { backgroundColor: i2, color: r2 } = e2, s2 = Qo(xa, r2);
    return g(Vo, { class: Uo.getClassNameForBind("border-box-10"), ref: a2, style: { boxShadow: `inset 0 0 25px 3px ${s2[0]}` } }, { default: () => [g(_a, { width: o3, height: l3 }, { default: () => [g("polygon", { fill: i2, points: `
                  4, 0 ${o3 - 4}, 0 ${o3}, 4 ${o3}, ${l3 - 4} ${o3 - 4}, ${l3}
                  4, ${l3} 0, ${l3 - 4} 0, 4
                ` }, null)] }), Sa.map((e3) => g(_a, { width: "150px", height: "150px", key: e3, class: e3 }, { default: () => [g("polygon", { fill: s2[1], points: "40, 0 5, 0 0, 5 0, 16 3, 19 3, 7 7, 3 35, 3" }, null)] })), g(Wo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
} }), La = ["#2e6099", "#7ce7fd"], Da = Uo.svg`
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0;
...
`("border-svg-container"), Ia = e({ name: "BorderBox11", props: { ...Ho(), titleWidth: { type: Number, default: 250 }, title: { type: String, default: "" } }, setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: a2, refreshLayoutSize: l2, domSize: n2 } = Po();
  o2({ refreshLayoutSize: l2 });
  const i2 = ya();
  return () => {
    const { color: o3, backgroundColor: l3, titleWidth: r2, title: s2 } = e2, { width: u2, height: c2 } = n2, d2 = Qo(La, o3), p2 = `border-box-11-filterId-${i2}`;
    return g(Vo, { class: Uo.getClassNameForBind("border-box-11"), ref: a2 }, { default: () => [g(Da, { width: u2, height: c2 }, { default: () => [g("defs", null, [g("filter", { id: p2, height: "150%", width: "150%", x: "-25%", y: "-25%" }, [g("feMorphology", { operator: "dilate", radius: "2", in: "SourceAlpha", result: "thicken" }, null), g("feGaussianBlur", { in: "thicken", stdDeviation: "3", result: "blurred" }, null), g("feFlood", { "flood-color": d2[1], result: "glowColor" }, null), g("feComposite", { in: "glowColor", in2: "blurred", operator: "in", result: "softGlowColored" }, null), g("feMerge", null, [g("feMergeNode", { in: "softGlowColored" }, null), g("feMergeNode", { in: "SourceGraphic" }, null)])])]), g("polygon", { fill: l3, points: `
...
`("border-svg-container"), Ba = e({ name: "BorderBox12", props: Ho(), setup(e2, { slots: t2, expose: o2 }) {
  ...
  const i2 = ya();
  return () => {
    const { color: o3, backgroundColor: l3 } = e2, { width: r2, height: s2 } = n2, u2 = Qo(Ta, o3), c2 = `border-box-12-filterId-${i2}`;
...
`("border-svg-container"), Aa = e({ name: "BorderBox13", props: Ho(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: a2, refreshLayoutSize: l2, domSize: n2 } = Po();
  return o2({ refreshLayoutSize: l2 }), () => {
    const { color: o3, backgroundColor: l3 } = e2, { width: i2, height: r2 } = n2, s2 = Qo(Ra, o3);
    return g(Vo, { class: Uo.getClassNameForBind("border-box-13"), ref: a2 }, { default: () => [g(qa, { width: i2, height: r2 }, { default: () => [g("path", { fill: l3, stroke: s2[0], d: `
                  M 5 20 L 5 10 L 12 3  L 60 3 L 68 10
                  L ${i2 - 20} 10 L ${i2 - 5} 25
                  L ${i2 - 5} ${r2 - 5} L 20 ${r2 - 5}
                  L 5 ${r2 - 20} L 5 20
                ` }, null), g("path", { fill: "transparent", "stroke-width": "3", "stroke-linecap": "round", "stroke-dasharray": "10, 5", stroke: s2[0], d: "M 16 9 L 61 9" }, null), g("path", { fill: "transparent", stroke: s2[1], d: "M 5 20 L 5 10 L 12 3  L 60 3 L 68 10" }, null), g("path", { fill: "transparent", stroke: s2[1], d: `M ${i2 - 5} ${r2 - 30} L ${i2 - 5} ${r2 - 5} L ${i2 - 30} ${r2 - 5}` }, null)] }), g(Wo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
} }), Oa = ["#7ce7fd", "#2e6099"], ja = Uo.svg`
  position: absolute;
  top: -1px;
  left: -1px;
  width: calc(100% + 2px);
...
const fl = ["#2e6099", "#7ce7fd"], hl = 2.5, gl = function({ width: e2, height: t2, rowPoints: o2, rowCount: a2 }) {
...
}({ width: 200, height: 50, rowPoints: 20, rowCount: 4 }), ml = gl[39], yl = gl[37], vl = Uo.div`
  width: 100%;
  height: 100%;
...
`("decoration-1"), Cl = e({ name: "Decoration1", props: cl(), setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: a2, domSize: l2 } = Po();
  return t2({ refreshLayoutSize: a2 }), () => {
    const { color: t3 } = e2, { width: a3, height: n2 } = l2, i2 = Qo(fl, t3), r2 = { transform: `scale(${a3 / 200},${n2 / 50})` };
    return g(vl, { ref: o2 }, { default: () => [g("svg", { width: 200, height: 50, style: r2 }, [gl.map(([e3, t4], o3) => {
      const a4 = e3 - 1.25, l3 = t4 - 1.25;
      return Math.random() > 0.6 ? g("rect", { key: o3, x: a4, y: l3, width: hl, height: hl, fill: i2[0] }, [Math.random() > 0.6 && g("animate", { attributeName: "fill", values: `${i2[0]};transparent`, dur: "1s", begin: 2 * Math.random(), repeatCount: "indefinite" }, null)]) : null;
    }), g("rect", { fill: i2[1], x: ml[0] - hl, y: ml[1] - hl, width: 5, height: 5 }, [g("animate", { attributeName: "width", values: "0;5", dur: "2s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "height", values: "0;5", dur: "2s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "x", values: `${ml[0]};${ml[0] - hl}`, dur: "2s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "y", values: `${ml[1]};${ml[1] - hl}`, dur: "2s", repeatCount: "indefinite" }, null)]), g("rect", { fill: i2[1], x: yl[0] - hl, y: yl[1] - hl, width: 5, height: 5 }, [g("animate", { attributeName: "width", values: "0;40;0", dur: "2s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "x", values: `${yl[0]};${yl[0] - 40};${yl[0]}`, dur: "2s", repeatCount: "indefinite" }, null)])])] });
  };
} }), bl = ["#2e6099", "#7ce7fd"];
const Ml = Uo.div`
  display: flex;
...
`("decoration-3"), _l = e({ name: "Decoration3", props: cl(), setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: a2, domSize: l2 } = Po();
  return t2({ refreshLayoutSize: a2 }), () => {
    const { width: t3, height: a3 } = l2, { color: n2 } = e2, i2 = Qo(wl, n2);
    return g(Sl, { ref: o2 }, { default: () => [g("svg", { width: 300, height: 35, style: { transform: `scale(${t3 / 300},${a3 / 35})` } }, [xl.map(([e3, t4], o3) => {
...
} }), $l = ["width", "height"], Ll = ["stroke", "points"], Dl = ["stroke", "points"], Il = e({ name: "Decoration4", __name: "index", props: { ...cl(), ...dl(), ...pl(3) }, setup(e2) {
  ...
  return (e3, t3) => (s(), r("div", { class: "dv-decoration-4", ref_key: "decoration4Ref", ref: l2 }, [p("div", { class: c("container " + (e3.reverse ? "reverse" : "normal")), style: u(e3.reverse ? `width:${n2.value}px;height:5px;animation-duration:${e3.duration}s` : `width:5px;height:${i2.value}px;animation-duration:${e3.duration}s`) }, [(s(), r("svg", { width: e3.reverse ? n2.value : 5, height: e3.reverse ? 5 : i2.value }, [p("polyline", { stroke: d2.value[0], points: e3.reverse ? `0, 2.5 ${n2.value}, 2.5` : `2.5, 0 2.5, ${i2.value}` }, null, 8, Ll), p("polyline", { class: "bold-line", stroke: d2.value[1], "stroke-width": "3", "stroke-dasharray": "20, 80", "stroke-dashoffset": "-30", points: e3.reverse ? `0, 2.5 ${n2.value}, 2.5` : `2.5, 0 2.5, ${i2.value}` }, null, 8, Dl)], 8, $l))], 6)], 512));
} }), Tl = to(Il, [["__scopeId", "data-v-97e7e3ce"]]), Nl = ["#2e6099", "#7ce7fd"];
function Bl(e2) {
...
const Rl = Uo.div`
  width: 100%;
  height: 100%;
`("decoration-5"), ql = e({ name: "Decoration5", props: { ...cl(), ...pl(1.2) }, setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: a2, domSize: l2 } = Po();
  return t2({ refreshLayoutSize: a2 }), () => {
    const { width: t3, height: a3 } = l2, { color: n2, duration: i2 } = e2, r2 = Qo(Nl, n2), { line1Sum: s2, line2Sum: u2, line1Point: c2, line2Point: d2 } = function(e3, t4) {
...
`("decoration-6");
const { points: jl, heights: zl, minHeights: El, randoms: Fl } = function({ width: e2, height: t2, rowPoints: o2, rowCount: a2 }) {
...
}({ width: 300, height: 35, rowPoints: 40, rowCount: 1 }), Pl = e({ name: "Decoration6", props: cl(), setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: a2, domSize: l2 } = Po();
  return t2({ refreshLayoutSize: a2 }), () => {
    const { width: t3, height: a3 } = l2, { color: n2 } = e2, i2 = Qo(Al, n2), r2 = { transform: `scale(${t3 / 300},${a3 / 35})` };
    return g(Ol, { ref: o2 }, { default: () => [g("svg", { class: "svg-origin", width: t3, height: a3, style: r2 }, [jl.map(([e3, t4], o3) => g("rect", { key: `rect${o3}`, fill: i2[Math.random() > 0.5 ? 0 : 1], x: e3 - 3.5, y: t4 - zl[o3], width: 7, height: zl[o3] }, [g("animate", { attributeName: "y", values: `${t4 - El[o3] / 2};${t4 - zl[o3] / 2};${t4 - El[o3] / 2}`, dur: Fl[o3], keyTimes: "0;0.5;1", calcMode: "spline", keySplines: "0.42,0,0.58,1;0.42,0,0.58,1", begin: "0s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "height", values: `${El[o3]};${zl[o3]};${El[o3]}`, dur: Fl[o3], keyTimes: "0;0.5;1", calcMode: "spline", keySplines: "0.42,0,0.58,1;0.42,0,0.58,1", begin: "0s", repeatCount: "indefinite" }, null)]))])] });
  };
} }), Hl = Uo.div`
  display: flex;
  width: 100%;
  ...
  justify-content: center;
  align-items: center;
`("decoration-7"), Ql = ["#2e6099", "#7ce7fd"], Gl = e({ name: "Decoration7", props: cl(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: a2, refreshLayoutSize: l2 } = Po();
  return o2({ refreshLayoutSize: l2 }), () => {
    const { color: o3 } = e2, l3 = Qo(Ql, o3);
    return g(Hl, { ref: a2 }, { default: () => {
      var _a2;
...
const Vl = Uo.div`
  ...
  width: 100%;
  height: 100%;
`("decoration-8"), Wl = e({ name: "Decoration8", props: { ...cl(), ...dl() }, setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: a2, domSize: l2 } = Po();
  return t2({ refreshLayoutSize: a2 }), () => {
    const { color: t3, reverse: a3 } = e2, { width: n2, height: i2 } = l2, r2 = (e3) => a3 ? n2 - e3 : e3, s2 = Qo(Ul, t3);
    return g(Vl, { ref: o2 }, { default: () => [g("svg", { width: n2, height: i2 }, [g("polyline", { stroke: s2[0], "stroke-width": "2", fill: "transparent", points: `${r2(0)}, 0 ${r2(30)}, ${i2 / 2}` }, null), g("polyline", { stroke: s2[0], "stroke-width": "2", fill: "transparent", points: `${r2(20)}, 0 ${r2(50)}, ${i2 / 2} ${r2(n2)}, ${i2 / 2}` }, null), g("polyline", { stroke: s2[1], fill: "transparent", "stroke-width": "3", points: `${r2(0)}, ${i2 - 3}, ${r2(200)}, ${i2 - 3}` }, null)])] });
  };
} });
const Yl = ["#2e6099", "#7ce7fd"], Zl = Uo.div`
  position: relative;
  width: 100%;
  height: 100%;
  display: flex;
...
`("decoration-11"), on = Uo.div`
  ...
  align-items: center;
  justify-content: center;
`("decoration-content"), an = ["#2e6099", "#7ce7fd"], ln = e({ name: "Decoration11", props: cl(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: a2, refreshLayoutSize: l2, domSize: n2 } = Po();
  return o2({ refreshLayoutSize: l2 }), () => {
    const { width: o3, height: l3 } = n2, { color: i2 } = e2, r2 = Qo(an, i2);
    return g(tn, { ref: a2 }, { default: () => [g("svg", { width: o3, height: l3 }, [g("polygon", { fill: Ue(r2[1] || an[1], 10), stroke: r2[1], points: "20 10, 25 4, 55 4 60 10" }, null), g("polygon", { fill: Ue(r2[1] || an[1], 10), stroke: r2[1], points: `20 ${l3 - 10}, 25 ${l3 - 4}, 55 ${l3 - 4} 60 ${l3 - 10}` }, null), g("polygon", { fill: Ue(r2[1] || an[1], 10), stroke: r2[1], points: `${o3 - 20} 10, ${o3 - 25} 4, ${o3 - 55} 4 ${o3 - 60} 10` }, null), g("polygon", { fill: Ue(r2[1] || an[1], 10), stroke: r2[1], points: `${o3 - 20} ${l3 - 10}, ${o3 - 25} ${l3 - 4}, ${o3 - 55} ${l3 - 4} ${o3 - 60} ${l3 - 10}` }, null), g("polygon", { fill: Ue(r2[0] || an[0], 20), stroke: r2[0], points: `
        20 10, 5 ${l3 / 2} 20 ${l3 - 10}
        ${o3 - 20} ${l3 - 10} ${o3 - 5} ${l3 / 2} ${o3 - 20} 10
      ` }, null), g("polyline", { fill: "transparent", stroke: Ue(r2[0] || an[0], 70), points: `25 18, 15 ${l3 / 2} 25 ${l3 - 18}` }, null), g("polyline", { fill: "transparent", stroke: Ue(r2[0] || an[0], 70), points: `${o3 - 25} 18, ${o3 - 15} ${l3 / 2} ${o3 - 25} ${l3 - 18}` }, null)]), g(on, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
...
`("decoration-12"), rn = Uo.div`
  ...
  align-items: center;
  justify-content: center;
`("decoration-content"), sn = ["#2e6099", "#7ce7fd"], un = Math.PI / 3;
const cn = (e2, t2, o2, a2) => [e2 + Math.cos(a2) * o2, t2 + Math.sin(a2) * o2], dn = e({ name: "Decoration12", props: { ...cl(), scanDuration: { type: Number, default: 3 }, haloDuration: { type: Number, default: 2 } }, setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: a2, refreshLayoutSize: l2, domSize: n2 } = Po();
  o2({ refreshLayoutSize: l2 });
  const i2 = ya();
  return () => {
    const { width: o3, height: l3 } = n2, r2 = o3 / 2, s2 = l3 / 2, { color: u2, scanDuration: c2, haloDuration: d2 } = e2, p2 = `decoration-12-g-${i2.id}`, f2 = `decoration-12-gradient-${i2.id}`, h2 = Qo(sn, u2), m2 = ((e3, t3) => {
      const o4 = 100 / (t3 - 1);
      ...
      let s3 = cn(e3, t3, r3, n3);
      return Array.from({ length: a3 }).fill("").map((o5, a4) => {
        const l5 = cn(e3, t3, r3, n3 - (a4 + 1) * i3).map((e4) => e4.toFixed(5)), u3 = `M${s3.join(",")} A${r3}, ${r3} 0 0 0 ${l5.join(",")}`;
        return s3 = l5, u3;
      });
    })({ x: r2, y: s2, width: o3, segment: 30, sectorAngle: un }), v2 = (({ ringNum: e3, width: t3, ringWidth: o4 }) => {
      ...
      return Array.from({ length: 6 }).fill("").map((o5, n3) => {
        const i3 = a3 * (n3 + 1), r3 = i3 + Math.PI, s3 = cn(e3, t3, l4, i3), u3 = cn(e3, t3, l4, r3);
...
`("header-svg-container"), Dn = e({ name: "Header6", props: Ho(), setup(e2, { expose: t2 }) {
  ...
  }(a2, e4, o2) }, [C2.value.index && 0 === a2 ? (s(), r("span", { key: 0, class: "index", style: u(`background: ${C2.value.headerBGC};`) }, S(o2), 5)) : (s(), r(y, { key: 1 }, [x(S(o2), 1)], 64))], 44, In))), 128))], 4))), 128))], 4)) : f("", true)], 512));
} }), Nn = to(Tn, [["__scopeId", "data-v-4f0b446b"]]), Bn = ["onClick"], Rn = to(e({ __name: "MacButton", props: { size: { type: String, default: () => "default" }, disabled: { request: false, type: Boolean, default: false }, hidden: { request: false, type: Array, default: () => [] }, narrow: { request: false, type: Boolean, default: false } }, emits: ["close", "remove", "resize", "fullResize"], setup(e2, { emit: t2 }) {
  ...
  return (t3, o3) => (s(), r("div", { class: c(d(n2)) }, [(s(true), r(y, null, v(i2.value, (t4) => (s(), r("div", { key: t4.key, class: c(["btn", [t4.key, e2.disabled && "disabled", e2.size]]), onClick: k((e3) => {
    ...
    var o4;
  }, ["stop"]) }, [g(d(Be), { icon: t4.icon, size: "10", class: c(["icon-base", { hover: !e2.disabled }]) }, null, 8, ["icon", "class"])], 10, Bn))), 128))], 2));
} }), [["__scopeId", "data-v-5c20d434"]]), qn = e({ name: "ScreenCheckbox", __name: "index", props: { title: { type: String }, tooltip: { type: String } }, setup: (e2) => (t2, o2) => (s(), r("div", null, [g(d(W), D(I(t2.$attrs)), { default: M(() => [x(S(e2.title), 1)]), _: 1 }, 16), e2.tooltip ? (s(), h(d(G), { key: 0, title: e2.tooltip }, { default: M(() => [g(d(Be), { icon: "ant-design:exclamation-circle-outlined" })]), _: 1 }, 8, ["title"])) : f("", true)])) }), An = { key: 0, class: "prefix" }, On = { key: 3 }, jn = to(e({ name: "ScreenInput", __name: "index", props: { isNumber: { type: Boolean, default: true }, prefix: { type: String }, suffix: { type: String } }, emits: ["change"], setup(e2, { emit: o2 }) {
  t((e3) => ({ "236dc44e": u2.value }));
  const l2 = o2, { prefixCls: n2 } = xe("screen-input"), { token: i2 } = P.useToken(), u2 = a(() => i2.value.colorBorder);
  return (t2, o3) => (s(), r("div", { class: c(d(n2)) }, [e2.prefix ? (s(), r("div", An, S(e2.prefix), 1)) : f("", true), e2.isNumber ? (s(), h(d(Q), $({ key: 1, class: "input" }, t2.$attrs, { onChange: o3[0] || (o3[0] = (e3) => l2("change", e3)), bordered: false, controls: false }), null, 16)) : (s(), h(d(H), $({ key: 2, class: "input" }, t2.$attrs, { bordered: false, onChange: o3[1] || (o3[1] = (e3) => l2("change", e3)) }), null, 16)), e2.suffix ? (s(), r("div", On, S(e2.suffix), 1)) : f("", true)], 2));
} }), [["__scopeId", "data-v-00593fb6"]]), zn = ({ CtrlShiftKeysEnum: e2, CtrlKeysEnum: t2, ShiftKeysEnum: o2, KeysEnum: a2 }) => {
  const l2 = (e3, t3) => {
    if (!t3) return;
...
const Fn = to(e({ __name: "TextFontStyle", props: { bold: { type: Boolean, default: false }, italic: { type: Boolean, default: false }, strikethrough: { type: Boolean, default: false }, underline: { type: Boolean, default: false }, hide: { type: Array, default: () => [] } }, emits: ["fontStyleChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, i2 = n({ [ei.Bold]: { name: "加粗", icon: "carbon:text-bold", value: false }, [ei.Italic]: { name: "斜体", icon: "carbon:text-italic", value: false }, [ei.Underline]: { name: "下划线", icon: "carbon:text-underline", value: false }, [ei.Strikethrough]: { name: "删除线", icon: "carbon:text-strikethrough", value: false } }), u2 = (e3) => !o2.hide.includes(e3);
...
} }), [["__scopeId", "data-v-3b6dd2cf"]]), Pn = to(e({ __name: "TextHAlignStyle", props: { alignType: { type: String, default: void 0 } }, emits: ["alignChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, i2 = m();
  l(() => o2.alignType, (e3) => {
    i2.value = e3;
  }, { immediate: true });
  const { prefixCls: u2 } = xe("h-align-style"), p2 = n({ [Xn.Left]: { name: "水平居左", icon: "carbon:text-align-left", description: "文字水平居左" }, [Xn.Center]: { name: "水平居中", icon: "carbon:text-align-center", description: "文字水平居中" }, [Xn.Right]: { name: "水平居右", icon: "carbon:text-align-right", description: "文字水平居右" } });
  function f2(e3) {
...
} }), [["__scopeId", "data-v-63ee2427"]]), Hn = to(e({ __name: "TextVAlignStyle", props: { alignType: { type: String, default: void 0 } }, emits: ["alignChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, i2 = m();
  l(() => o2.alignType, (e3) => {
    i2.value = e3;
  }, { immediate: true });
  const { prefixCls: u2 } = xe("v-align-style"), p2 = n({ [Jn.Top]: { name: "垂直居上", icon: "carbon:align-vertical-top", description: "文字垂直居上" }, [Jn.Center]: { name: "垂直居中", icon: "carbon:align-vertical-center", description: "文字垂直居中" }, [Jn.Bottom]: { name: "垂直居下", icon: "carbon:align-vertical-bottom", description: "文字垂直居下" } });
  function f2(e3) {
    const t3 = e3.target.value;
    a2("alignChange", t3);
  }
  return (e3, t3) => (s(), r("div", { class: c(d(u2)) }, [g(d(Z), { value: i2.value, "onUpdate:value": t3[0] || (t3[0] = (e4) => i2.value = e4), onChange: f2 }, { default: M(() => [(s(true), r(y, null, v(Object.keys(p2), (e4) => (s(), h(d(G), { key: e4, placement: "top", title: p2[e4].description }, { default: M(() => [g(d(Y), { class: "radio-button", value: e4 }, { default: M(() => [g(d(Be), { icon: p2[e4].icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["value"])]), _: 2 }, 1032, ["title"]))), 128))]), _: 1 }, 8, ["value"])], 2));
} }), [["__scopeId", "data-v-a40ac773"]]), Qn = { class: "line" }, Gn = { class: "input" }, Un = { class: "line" }, Vn = { style: { flex: "1" } }, Wn = { key: 0, class: "line" }, Yn = e({ name: "TextStyle", __name: "index", props: { verticalAlign: { type: Boolean, default: false }, textStyle: { type: Object, default: () => {
  ...
  const n2 = e2, i2 = o2, { prefixCls: u2 } = xe("text-style"), { token: y2 } = P.useToken(), v2 = a(() => y2.value.colorBorder), C2 = m(12), b2 = m(Kn[0].value), M2 = m(), k2 = m();
  function w2(e3) {
    const t2 = x2(e3);
  ...
  function _2(e3, t2) {
    if (!e3) return;
    const o3 = t2 == null ? void 0 : t2.startsWith("linear-gradient"), a2 = Math.round((C2.value ?? 12) / 10), l2 = (e3 == null ? void 0 : e3.underline) && o3 ? { borderBottom: `${a2}px solid`, borderImage: `${t2} 1` } : (e3 == null ? void 0 : e3.underline) ? { borderBottom: `${a2}px solid`, borderColor: `${t2}` } : {}, n3 = e3[ei.Bold] ? { fontWeight: "bold" } : {}, r2 = e3[ei.Italic] ? { fontStyle: "italic" } : {};
    if (o3) {
  ...
  function L2(e3) {
    i2("hAlignChange", { value: e3, style: { justifyContent: e3 === Xn.Left ? "flex-start" : e3 === Xn.Center ? "center" : e3 === Xn.Right ? "flex-end" : "center" } });
  }
  function D2(e3) {
    i2("vAlignChange", { value: e3, style: { alignItems: e3 === Jn.Top ? "flex-start" : e3 === Jn.Center ? "center" : e3 === Jn.Bottom ? "flex-end" : "unset" } });
  }
  function I2(e3) {
  ...
  return l(() => n2.textStyle, (e3) => {
    var _a2, _b, _c2, _d2;
    e3 && (C2.value = ((_a2 = n2.textStyle) == null ? void 0 : _a2.fontSize) ?? 12, b2.value = ((_b = n2.textStyle) == null ? void 0 : _b.font) ?? Kn[0].value, M2.value = (_c2 = n2.textStyle) == null ? void 0 : _c2.textColor, k2.value = (_d2 = n2.textStyle) == null ? void 0 : _d2.fontStyle);
  }, { immediate: true, deep: true }), (t2, o3) => {
    var _a2, _b;
    return s(), r("div", { class: c(d(u2)) }, [p("div", Qn, [g(d(K), { style: { flex: "1" }, value: b2.value, "onUpdate:value": o3[0] || (o3[0] = (e3) => b2.value = e3), options: d(Kn), onChange: I2 }, null, 8, ["value", "options"]), p("div", Gn, [g(d(Q), { value: C2.value, "onUpdate:value": o3[1] || (o3[1] = (e3) => C2.value = e3), bordered: false, placeholder: "大小", controls: false, min: 6, maxlength: 4, onChange: T2 }, null, 8, ["value"]), o3[2] || (o3[2] = p("div", { class: "suffix" }, "px", -1))]), e2.hideAlign ? f("", true) : (s(), h(Pn, { key: 0, "align-type": (_a2 = e2.textStyle) == null ? void 0 : _a2.hAlignType, onAlignChange: L2 }, null, 8, ["align-type"]))]), p("div", Un, [p("div", Vn, [g(d(Eo), { type: e2.colorType, "direct-confirm": true, value: M2.value, onConfirmChange: w2, onInputChange: x2 }, null, 8, ["type", "value"])]), g(Fn, $({ hide: e2.hideFontStyle }, k2.value, { onFontStyleChange: S2 }), null, 16, ["hide"])]), e2.verticalAlign ? (s(), r("div", Wn, [g(Hn, { "align-type": (_b = e2.textStyle) == null ? void 0 : _b.vAlignType, onAlignChange: D2 }, null, 8, ["align-type"])])) : f("", true)], 2);
  };
} }), Zn = to(Yn, [["__scopeId", "data-v-c65c80c4"]]), Kn = [{ value: "微软雅黑", label: "微软雅黑" }, { value: "宋体", label: "宋体" }, { value: "黑体", label: "黑体" }, { value: "楷体", label: "楷体" }, { value: "仿宋", label: "仿宋" }, { value: "sans-serif", label: "sans-serif" }, { value: "Arial", label: "Arial" }, { value: "PingFangSC", label: "PingFangSC" }, { value: "monospace", label: "monospace" }, { value: "Courier New", label: "Courier New" }, { value: "lcd", label: "lcd" }];
var Xn = ((e2) => (e2.Left = "left", e2.Center = "center", e2.Right = "right", e2))(Xn || {}), Jn = ((e2) => (e2.Top = "top", e2.Center = "center", e2.Bottom = "bottom", e2))(Jn || {}), ei = ((e2) => (e2.Bold = "bold", e2.Italic = "italic", e2.Underline = "underline", e2.Strikethrough = "strikethrough", e2))(ei || {});
function ti(e2) {
  switch (e2) {
    case "NUMBER":
...
const Oi = (e2) => Je.get({ url: "/nocode/mfApi/headers", params: e2 });
function ji(e2) {
...
const Ir = async (e2) => {
...
}, Tr = (e2) => e2 && ((e2 == null ? void 0 : e2.aggregates) && e2.aggregates.length > 0 || e2.groups && e2.groups.length > 0 || e2.customColumns && e2.customColumns.length > 0), Nr = (e2, t2) => t2 === _r().getLevel && Tr(e2), Br = (e2, t2, o2) => {
  ...
  var _a2, _b, _c2, _d2;
  return ((_a2 = this.curComponent) == null ? void 0 : _a2.chart.type) === ls.MfCombine && ((_c2 = (_b = this.curComponent) == null ? void 0 : _b.chart.options) == null ? void 0 : _c2.selectIndex) >= 0 ? (_d2 = this.curComponent) == null ? void 0 : _d2.chart.options.components[this.curComponent.chart.options.selectIndex] : this.curComponent;
  ...
  return rp(this.componentList, e2);
}, async initCache(e2) {
  if (this.setInitComplete(false), e2) {
    const t2 = JSON.parse(e2);
    if (!t2) return;
    this.setComponentList(t2.componentList), this.setCanvasConfig(t2.canvasConfig), up(this.componentList).then((e3) => {
      Promise.all(e3).then(() => {
  ...
  e2.forEach((e3) => {
    cp(e3.chart), e3.chart.type === ls.MfCombine && e3.chart.options.components.forEach((e4) => {
      cp(e4.chart);
    });
  ...
  let l2;
  if (l2 = this.isResource ? await xr(this.getId) : await vr({ screenId: this.getId }, this.getShareToken), !l2 || 0 === l2.length) return this.componentList;
  ...
  return n2.clear(), this.setComponentList(i2), up(this.componentList, this.isResource).then((e3) => {
    Promise.all(e3).then(() => {
      this.setUndoRedoData("初始化"), this.setInitComplete(true);
    });
  }), this.componentList;
  ...
  this.componentList.forEach((e3) => {
    o2(e3), a2(e3), l2(e3), n2(e3), e3.chart.type === ls.MfCombine && e3.chart.options.components.forEach((e4) => {
...
} } }), Or = et("screen-layout", { state: () => ({ chartCollapsed: false, layerCollapsed: false, configCollapsed: false }), getters: { getChartCollapsed() {
...
const ts = { style: { value: "样式", show: true, payload: { icon: "carbon:color-palette", component: null } }, data: { value: "数据", show: true, payload: { icon: "carbon:data-structured", component: null } }, animation: { value: "动画", show: true, payload: { icon: "carbon:flow-modeler", component: T(lt(() => import("./index2.js"), { loading: true, size: "large" })) } }, advance: { value: "进阶", show: true, payload: { icon: "iconfont:icon-mfish-config", component: T(lt(() => import("./index3.js"), { loading: true, size: "large" })) } } }, os = (e2) => {
...
function ns() {
  ...
  async function t2(t3) {
    ...
    t3.type && Kd[t3.type].initData(t3, o2);
  }
...
const ss = (e2, t2) => {
  ...
  switch (e2) {
    ...
    case "mouseLeave":
      return "鼠标离开";
    default:
      return t2 ? ((_b = (_a2 = Kd[t2].customEvents) == null ? void 0 : _a2.find((t3) => t3.value === e2)) == null ? void 0 : _b.name) ?? "" : "";
  }
};
function us(e2, t2, o2) {
  const a2 = Ar(), n2 = (t3, o3) => {
    ((e3) => {
      var _a2;
  ...
  const f2 = (t3) => {
    ...
    const o3 = (() => {
      ...
      const o4 = (() => {
        ...
        for (const o5 of e2.jump.params) if (o5.type === Ur.CONSTANT) t5[o5.name] = o5.value;
          ...
          const e3 = sp(a2.getComponentList, o5.value);
          e3 && (t5[o5.name] = e3);
        }
        return t5;
      })();
      if (((_a3 = e2.jump) == null ? void 0 : _a3.pageType) === Pr.System) {
    ...
    switch ((_c2 = e2.jump) == null ? void 0 : _c2.type) {
      ...
      case Fr.NewTab:
        ...
        break;
      case Fr.Dialog:
        Xd.emit(Qr.SHOW_MODAL, { ...t3, href: o3, jump: e2.jump });
    }
    c2(t3, "page_jump");
  };
  function h2(e3) {
  ...
  function m2(t3) {
    setTimeout(() => {
      ...
      ((_a2 = e2.data.eventRefresh) == null ? void 0 : _a2.open) && ((_b = e2.data.eventRefresh) == null ? void 0 : _b.events) && (o3(e2).then((t4) => {
        var _a3;
        e2.type && ((_a3 = Kd[e2.type]) == null ? void 0 : _a3.initData(e2, t4));
      }), c2(t3, "refresh"));
    }, 10);
  }
  function y2(t3) {
    Xd.emit(Qr.EVENT_ANIMATION, { ...t3, chart: e2 }), c2(t3, "animation");
  }
  return l(() => e2 == null ? void 0 : e2.jump, (t3) => {
    !function(t4) {
      const o3 = "click" + e2.id;
      is.off(o3, f2), (t4 == null ? void 0 : t4.open) && is.on(o3, f2);
    }(t3);
...
const cs = e({ name: "MfButton", __name: "index", props: { chart: { type: Object, required: true }, chartContain: { type: Object, required: true } }, setup(e2) {
  const t2 = e2, { commonEvents: o2 } = us(t2.chart), l2 = a(() => t2.chartContain.dropInfo.width > t2.chartContain.dropInfo.height ? t2.chartContain.dropInfo.height / 2.2 + "px" : t2.chartContain.dropInfo.width / 3 + "px");
...
const ps = { type: ls.MfButton, component: cs, create: ds, config: (() => {
  const e2 = qe(ts);
...
const hs = { type: ls.MfCombine, component: lt(() => import("./index4.js"), { loading: true }), create: function(e2) {
  ...
  const o2 = e2, n2 = t2, { prefixCls: i2 } = xe("mf-tag"), g2 = a(() => os(o2.chart)), { emitEvent: m2, commonEvents: y2 } = us(o2.chart, function(e3) {
    n2("eventHandler", e3);
  }, ["titleChange"]);
  return l(() => {
    var _a2;
...
const vs = { type: ls.MfTag, component: ms, create: ys, config: (() => {
  const e2 = qe(ts);
...
}, customEvents: [{ name: "标签值改变", value: "titleChange" }] }, Cs = Object.freeze(Object.defineProperty({ __proto__: null, default: vs, mfTagCreate: ys }, Symbol.toStringTag, { value: "Module" })), bs = { ...vs, type: ls.MfDataTag, component: lt(() => import("./index5.js"), { loading: true }), config: (() => {
  const e2 = qe(ts);
...
function Ms() {
  function e2(e3) {
    var _a2;
    ((_a2 = e3 == null ? void 0 : e3.data) == null ? void 0 : _a2.dataSet) && (e3.data.dataSet.title = bs.defaultData.title);
  }
  function t2(e3) {
    var _a2;
    ((_a2 = e3 == null ? void 0 : e3.data) == null ? void 0 : _a2.dataSet) && (e3.data.dataSet.icon = bs.defaultData.icon);
  }
...
function ws() {
  const e2 = Ar(), { getDataTable: t2, setDataTable: o2 } = ns(), a2 = () => {
...
const Ss = { type: ls.MfDigits, component: lt(() => import("./index6.js"), { loading: true }), create: xs, config: (() => {
  const e2 = qe(ts);
...
const Ds = { type: ls.MfWheel, component: lt(() => import("./index7.js"), { loading: true }), create: Ls, config: (() => {
  ...
  const { setDynamicData: o2 } = Is("percentage");
  o2(e2, t2);
} };
function Is(e2) {
...
const Ts = Object.freeze(Object.defineProperty({ __proto__: null, default: Ds, mfWheelCreate: Ls, useWheelData: Is }, Symbol.toStringTag, { value: "Module" }));
function Ns(e2) {
...
const Bs = { ...Ds, component: lt(() => import("./index8.js"), { loading: true }), type: ls.MfTireMarks, create: Ns, config: (() => {
  const e2 = qe(ts);
...
const As = { type: ls.MfBorder1, component: lt(() => import("./index9.js"), { loading: true }), create: qs, config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfBorderConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Os = Object.freeze(Object.defineProperty({ __proto__: null, default: As, mfBorder1Create: qs }, Symbol.toStringTag, { value: "Module" })), js = { ...As, type: ls.MfBorder10, component: lt(() => import("./index10.js"), { loading: true }) }, zs = Object.freeze(Object.defineProperty({ __proto__: null, default: js }, Symbol.toStringTag, { value: "Module" }));
function Es(e2) {
...
const Fs = { type: ls.MfBorder11, component: lt(() => import("./index11.js"), { loading: true }), create: Es, config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfBorder11Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Ps = Object.freeze(Object.defineProperty({ __proto__: null, default: Fs, mfBorder11Create: Es }, Symbol.toStringTag, { value: "Module" })), Hs = { ...As, type: ls.MfBorder12, component: lt(() => import("./index12.js"), { loading: true }) }, Qs = Object.freeze(Object.defineProperty({ __proto__: null, default: Hs }, Symbol.toStringTag, { value: "Module" })), Gs = { ...As, type: ls.MfBorder13, component: lt(() => import("./index13.js"), { loading: true }) }, Us = Object.freeze(Object.defineProperty({ __proto__: null, default: Gs }, Symbol.toStringTag, { value: "Module" }));
function Vs(e2) {
  const t2 = As.create(e2);
  return t2.chartContain.border.radius = 0, t2;
}
const Ws = { ...As, type: ls.MfBorder14, component: lt(() => import("./index14.js"), { loading: true }), create: Vs }, Ys = Object.freeze(Object.defineProperty({ __proto__: null, default: Ws, mfBorder14Create: Vs }, Symbol.toStringTag, { value: "Module" })), Zs = { ...Ws, type: ls.MfBorder15, component: lt(() => import("./index15.js"), { loading: true }) }, Ks = Object.freeze(Object.defineProperty({ __proto__: null, default: Zs }, Symbol.toStringTag, { value: "Module" })), Xs = { ...Ws, type: ls.MfBorder16, component: lt(() => import("./index16.js"), { loading: true }) }, Js = Object.freeze(Object.defineProperty({ __proto__: null, default: Xs }, Symbol.toStringTag, { value: "Module" })), eu = { ...Ws, type: ls.MfBorder17, component: lt(() => import("./index17.js"), { loading: true }) }, tu = Object.freeze(Object.defineProperty({ __proto__: null, default: eu }, Symbol.toStringTag, { value: "Module" })), ou = { ...Ws, type: ls.MfBorder18, component: lt(() => import("./index18.js"), { loading: true }) }, au = Object.freeze(Object.defineProperty({ __proto__: null, default: ou }, Symbol.toStringTag, { value: "Module" })), lu = { ...Ws, type: ls.MfBorder19, component: lt(() => import("./index19.js"), { loading: true }) }, nu = Object.freeze(Object.defineProperty({ __proto__: null, default: lu }, Symbol.toStringTag, { value: "Module" })), iu = { ...As, type: ls.MfBorder2, component: lt(() => import("./index20.js"), { loading: true }) }, ru = Object.freeze(Object.defineProperty({ __proto__: null, default: iu }, Symbol.toStringTag, { value: "Module" })), su = { ...Ws, type: ls.MfBorder20, component: lt(() => import("./index21.js"), { loading: true }) }, uu = Object.freeze(Object.defineProperty({ __proto__: null, default: su }, Symbol.toStringTag, { value: "Module" })), cu = { ...Ws, type: ls.MfBorder21, component: lt(() => import("./index22.js"), { loading: true }) }, du = Object.freeze(Object.defineProperty({ __proto__: null, default: cu }, Symbol.toStringTag, { value: "Module" })), pu = { ...Ws, type: ls.MfBorder22, component: lt(() => import("./index23.js"), { loading: true }) }, fu = Object.freeze(Object.defineProperty({ __proto__: null, default: pu }, Symbol.toStringTag, { value: "Module" })), hu = { ...As, type: ls.MfBorder3, component: lt(() => import("./index24.js"), { loading: true }) }, gu = Object.freeze(Object.defineProperty({ __proto__: null, default: hu }, Symbol.toStringTag, { value: "Module" })), mu = { ...As, type: ls.MfBorder4, component: lt(() => import("./index25.js"), { loading: true }), config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfBorder4Config.js"), { loading: true, size: "large" })), e2;
})() }, yu = Object.freeze(Object.defineProperty({ __proto__: null, default: mu }, Symbol.toStringTag, { value: "Module" })), vu = { ...mu, type: ls.MfBorder5, component: lt(() => import("./index26.js"), { loading: true }) }, Cu = Object.freeze(Object.defineProperty({ __proto__: null, default: vu }, Symbol.toStringTag, { value: "Module" })), bu = { ...As, type: ls.MfBorder6, component: lt(() => import("./index27.js"), { loading: true }) }, Mu = Object.freeze(Object.defineProperty({ __proto__: null, default: bu }, Symbol.toStringTag, { value: "Module" })), ku = { ...As, type: ls.MfBorder7, component: lt(() => import("./index28.js"), { loading: true }) }, wu = Object.freeze(Object.defineProperty({ __proto__: null, default: ku }, Symbol.toStringTag, { value: "Module" }));
function xu(e2) {
...
const Su = { type: ls.MfBorder8, component: lt(() => import("./index29.js"), { loading: true }), create: xu, config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfBorder8Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, _u = Object.freeze(Object.defineProperty({ __proto__: null, default: Su, mfBorder8Create: xu }, Symbol.toStringTag, { value: "Module" })), $u = { ...As, type: ls.MfBorder9, component: lt(() => import("./index30.js"), { loading: true }) }, Lu = Object.freeze(Object.defineProperty({ __proto__: null, default: $u }, Symbol.toStringTag, { value: "Module" }));
function Du(e2) {
...
const Iu = { type: ls.MfDecoration1, component: lt(() => import("./index31.js"), { loading: true }), create: Du, config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Tu = Object.freeze(Object.defineProperty({ __proto__: null, default: Iu, mfDecoration1Create: Du }, Symbol.toStringTag, { value: "Module" }));
function Nu(e2) {
...
const Bu = { type: ls.MfDecoration10, component: lt(() => import("./index32.js"), { loading: true }), create: Nu, config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const Au = { type: ls.MfDecoration11, component: lt(() => import("./index33.js"), { loading: true }), create: qu, config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfDecoration7Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Ou = Object.freeze(Object.defineProperty({ __proto__: null, default: Au, mfDecoration11Create: qu }, Symbol.toStringTag, { value: "Module" }));
function ju(e2) {
...
const zu = { type: ls.MfDecoration12, component: lt(() => import("./index34.js"), { loading: true }), create: ju, config: (() => {
  const e2 = qe(ts);
...
const Pu = { type: ls.MfDecoration2, component: lt(() => import("./index35.js"), { loading: true }), create: Fu, config: (() => {
  const e2 = qe(ts);
...
const Gu = { type: ls.MfDecoration3, component: lt(() => import("./index36.js"), { loading: true }), create: Qu, config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const Wu = { type: ls.MfDecoration4, component: lt(() => import("./index37.js"), { loading: true }), create: Vu, config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfDecoration2Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const Ku = { type: ls.MfDecoration5, component: lt(() => import("./index38.js"), { loading: true }), create: Zu, config: (() => {
  const e2 = qe(ts);
...
const ec = { type: ls.MfDecoration6, component: lt(() => import("./index39.js"), { loading: true }), create: Ju, config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const ac = { type: ls.MfDecoration7, component: lt(() => import("./index40.js"), { loading: true }), create: oc, config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfDecoration7Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, lc = Object.freeze(Object.defineProperty({ __proto__: null, default: ac, mfDecoration7Create: oc }, Symbol.toStringTag, { value: "Module" }));
function nc(e2) {
...
const ic = { type: ls.MfDecoration8, component: lt(() => import("./index41.js"), { loading: true }), create: nc, config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfDecoration8Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, rc = Object.freeze(Object.defineProperty({ __proto__: null, default: ic, mfDecoration8Create: nc }, Symbol.toStringTag, { value: "Module" }));
function sc(e2) {
...
const uc = { type: ls.MfDecoration9, component: lt(() => import("./index42.js"), { loading: true }), create: sc, config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfDecoration5Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const pc = { type: ls.MfHeader1, create: dc, component: lt(() => import("./index43.js"), { loading: true }), config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const gc = { type: ls.MfHeader2, create: hc, component: lt(() => import("./index44.js"), { loading: true }), config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const vc = { type: ls.MfHeader3, create: yc, component: lt(() => import("./index45.js"), { loading: true }), config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const Mc = { type: ls.MfHeader4, create: bc, component: lt(() => import("./index46.js"), { loading: true }), config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const xc = { type: ls.MfHeader5, create: wc, component: lt(() => import("./index47.js"), { loading: true }), config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const $c = { type: ls.MfHeader6, create: _c, component: lt(() => import("./index48.js"), { loading: true }), config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(lt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Lc = Object.freeze(Object.defineProperty({ __proto__: null, default: $c, mfHeader6Create: _c }, Symbol.toStringTag, { value: "Module" })), Dc = e({ name: "MfDateTime", __name: "index", props: { chart: { type: Object, required: true }, chartContain: { type: Object, required: true } }, setup(e2) {
  const t2 = e2, o2 = m(t2.chart), a2 = () => {
    var _a2;
    ((_a2 = t2.chart.options) == null ? void 0 : _a2.format) ? o2.value.data.dataSet.title = st(ut(), t2.chart.options.format) : o2.value.data.dataSet.title = st();
  };
  return i(() => {
...
const Tc = { type: ls.MfDateTime, component: Dc, create: Ic, config: (() => {
  const e2 = qe(ts);
...
} }, Nc = Object.freeze(Object.defineProperty({ __proto__: null, default: Tc, mfDateTimeCreate: Ic }, Symbol.toStringTag, { value: "Module" }));
function Bc() {
  const e2 = (e3, t3) => {
    var _a2;
  ...
  function t2(t3) {
    var _a2;
    ((_a2 = t3 == null ? void 0 : t3.data) == null ? void 0 : _a2.dataSet) && (t3 == null ? void 0 : t3.type) && (t3.data.dataSet = qe(Kd[t3.type].defaultData), t3.options.series = e2(t3, Kd[t3.type].defaultSeries || []));
  }
  return { resetDefault: t2, setDynamicData: function(o2, a2) {
    ...
    if (o2) {
      if ((a2 == null ? void 0 : a2.list.length) > 0 && o2.data.fields && (((_b = (_a2 = o2.data.fields) == null ? void 0 : _a2.dimensions) == null ? void 0 : _b.length) > 0 || ((_d2 = (_c2 = o2.data.fields) == null ? void 0 : _c2.source) == null ? void 0 : _d2.length) > 0)) {
        const { createMessage: l2 } = _e(), { deleteFieldValue: n2 } = ws(), i2 = o2.data.fields.dimensions ?? [], r2 = o2.data.fields.source ?? [];
...
const Rc = { type: ls.MfBar, component: lt(() => import("./index49.js"), { loading: true, size: "large" }), create: function(e2) {
  ...
  var _a2, _b;
  return as((_b = (_a2 = e2 == null ? void 0 : e2.data) == null ? void 0 : _a2.dataSet) == null ? void 0 : _b.source[0]);
...
const Ac = { ...Rc, type: ls.MfBarHorizontal, create: function(e2) {
...
const jc = { ...Rc, type: ls.MfBarStack, create: function(e2) {
  const t2 = Rc.create(e2);
...
const Ec = { ...jc, type: ls.MfBarLine, defaultSeries: [{ type: "bar" }, { type: "line" }], create: function(e2) {
...
const Pc = { ...Rc, type: ls.MfBarPlusMinus, create: function(e2) {
  const t2 = Rc.create(e2);
...
const Qc = { ...Rc, type: ls.MfLine, create: function(e2) {
...
const Uc = { ...Qc, type: ls.MfLineArea, create: function(e2) {
...
const Wc = { ...jc, type: ls.MfLineAreaStack, create: function(e2) {
  const t2 = jc.create(e2);
...
const Zc = { ...Qc, type: ls.MfLineSmooth, create: function(e2) {
  const t2 = Qc.create(e2);
...
const Xc = { ...jc, type: ls.MfLineStack, create: function(e2) {
  const t2 = jc.create(e2);
...
const td = { type: ls.MfMapChunks, component: lt(() => import("./index50.js"), { loading: true, size: "large" }), create: function(e2) {
  ...
  return { resetDefault: e2, setDynamicData: function(t2, o2) {
    ...
    if (t2) {
      if ((o2 == null ? void 0 : o2.list.length) > 0 && t2.data.fields && ((_b = (_a2 = t2.data.fields) == null ? void 0 : _a2.name) == null ? void 0 : _b.length) > 0) {
        const { createMessage: a2 } = _e(), { deleteFieldValue: l2 } = ws(), n2 = t2.data.fields.name ?? [], i2 = t2.data.fields.value ?? [];
...
const ld = { type: ls.MfMapLine, component: lt(() => import("./index51.js"), { loading: true, size: "large" }), create: function(e2) {
  return e2.chart.data.dataSet = qe(ld.defaultData), e2.chart.data.headers = ld.defaultHeaders && ld.defaultHeaders(e2.chart), e2.chart.data.limit = 100, e2.chart.data.maxLimit = 1e3, e2.chart.options = { tooltip: { show: true }, geo: { map: "china", scale: true, zoom: 1.2, scaleLimit: { min: 0.5, max: 2 }, emphasis: { itemStyle: { color: "#3146B3", areaColor: "#3146B3" } }, itemStyle: { color: "#03133D", areaColor: "#03133D", borderColor: "#6699FF", shadowColor: "#1773C3", shadowBlur: 10, borderWidth: 1 }, label: { color: "#ffffff", emphasis: { color: "#ffffff" } } }, visualMap: { show: false, min: 0, max: 100, text: ["高", "低"], realtime: false, calculable: true, inRange: { color: qe(ed[0].color) } }, series: qe(ld.defaultSeries) }, e2.chartContain.dropInfo.width = 800, e2.chartContain.dropInfo.height = 650, e2;
}, config: (() => {
  const e2 = qe(ts);
  ...
  const { setDynamicData: o2 } = nd();
  o2(e2, t2);
} };
function nd() {
  function e2(e3) {
    e3.data.dataSet = qe(ld.defaultData);
  }
  return { resetDefault: e2, setDynamicData: function(t2, o2) {
    var _a2, _b, _c2, _d2;
    if (t2) {
      if ((o2 == null ? void 0 : o2.list.length) > 0 && t2.data.fields && (((_b = (_a2 = t2.data.fields) == null ? void 0 : _a2.start) == null ? void 0 : _b.length) > 0 || ((_d2 = (_c2 = t2.data.fields) == null ? void 0 : _c2.end) == null ? void 0 : _d2.length) > 0)) {
        const { createMessage: a2 } = _e(), { deleteFieldValue: l2 } = ws(), n2 = t2.data.fields.start ?? [], i2 = t2.data.fields.end ?? [], r2 = t2.data.fields.value ?? [];
        if (0 === n2.length || 0 === i2.length) return void e2(t2);
        const s2 = [];
...
const id = Object.freeze(Object.defineProperty({ __proto__: null, default: ld, useEchartsMapLineData: nd }, Symbol.toStringTag, { value: "Module" }));
const rd = { ...ld, type: ls.MfMapLine3D, component: lt(() => import("./index52.js"), { loading: true, size: "large" }), create: function(e2) {
  var _a2;
  const t2 = ld.create(e2);
  return (_a2 = t2.chart.options) == null ? true : delete _a2.geo, t2.chart.options = { ...t2.chart.options, geo3D: { map: "china", shading: "lambert", viewControl: { distance: 85, rotateSensitivity: 0, zoomSensitivity: 0 }, light: { main: { intensity: 1.2, shadow: true } }, itemStyle: { areaColor: "#03133D", color: "#03133D", borderColor: "#6699FF", shadowColor: "#1773C3", shadowBlur: 10, borderWidth: 1 }, emphasis: { itemStyle: { areaColor: "#3146B3", color: "#3146B3" } }, label: { distance: 0, color: "#ffffff", emphasis: { color: "#ffffff" } } }, series: qe(rd.defaultSeries) }, t2;
...
const ud = { ...td, type: ls.MfMapScatter, component: lt(() => import("./index53.js"), { loading: true, size: "large" }), create: function(e2) {
...
const dd = { ...Rc, type: ls.MfPie, create: function(e2) {
...
const fd = { ...dd, type: ls.MfPieCircular, create: function(e2) {
...
const gd = { ...dd, type: ls.MfPieHalf, create: function(e2) {
  const t2 = dd.create(e2);
...
const yd = { ...dd, type: ls.MfPieRose, create: function(e2) {
  const t2 = dd.create(e2);
...
const Cd = { component: lt(() => import("./index54.js"), { loading: true, size: "large" }), type: ls.MfRadar, create: function(e2) {
...
const kd = { ...Cd, type: ls.MfRadarCircle, create: function(e2) {
...
const xd = { ...Rc, type: ls.MfScatter, create: function(e2) {
...
})(), defaultData: { source: [["数据1", "数据2"], [10, 8.04], [8.07, 6.95], [13, 7.58], [9.05, 8.81], [11, 8.33], [14, 7.66], [13.4, 6.81], [10, 6.33], [14, 8.96], [12.5, 6.82], [9.15, 7.2], [11.5, 7.2], [3.03, 4.23], [12.2, 7.83], [2.02, 4.47], [1.05, 3.33], [4.05, 4.96], [6.03, 7.24], [12, 6.26], [12, 8.84], [7.08, 5.82], [5.02, 5.68]] }, defaultSeries: [{ type: "scatter" }] }, Sd = Object.freeze(Object.defineProperty({ __proto__: null, default: xd }, Symbol.toStringTag, { value: "Module" })), _d = e({ name: "MfPicture", __name: "index", props: { chart: { type: Object, required: true }, chartContain: { type: Object, required: true } }, setup(e2) {
  const t2 = e2, { commonEvents: o2 } = us(t2.chart), l2 = a(() => {
    var _a2;
    return ((_a2 = t2.chart.data.dataSet) == null ? void 0 : _a2.key) ? ct(dt(t2.chart.data.dataSet.key)) : ot;
  });
  return (t3, a2) => {
    var _a2;
...
function $d(e2) {
  return e2.chart.data.dataSet = qe(Ld.defaultData), e2.chart.data.headers = Ld.defaultHeaders && Ld.defaultHeaders(), e2.chart.data.limit = 1, e2.chart.data.maxLimit = 1, e2.chart.options.preview = false, e2.chartContain.dropInfo.width = 200, e2.chartContain.dropInfo.height = 200, e2;
}
const Ld = { type: ls.MfPicture, component: _d, create: $d, config: (() => {
  const e2 = qe(ts);
...
} }, Dd = Object.freeze(Object.defineProperty({ __proto__: null, default: Ld, mfPictureCreate: $d }, Symbol.toStringTag, { value: "Module" }));
function Id(e2) {
  return e2.chart.data.dataSet = qe(Td.defaultData), e2.chart.data.headers = Td.defaultHeaders && Td.defaultHeaders(e2.chart), e2.chart.data.limit = 50, e2.chart.data.maxLimit = 1e3, e2.chartContain.dropInfo.width = 600, e2.chartContain.dropInfo.height = 300, e2.chart.options = { indexHeader: "序号", showHeader: true, index: true }, e2;
}
const Td = { type: ls.MfScrollTable, component: lt(() => import("./index55.js"), { loading: true }), create: Id, config: (() => {
  const e2 = qe(ts);
...
const Bd = Object.freeze(Object.defineProperty({ __proto__: null, default: Td, mfScrollTableCreate: Id, useDataScrollTable: Nd }, Symbol.toStringTag, { value: "Module" }));
function Rd(e2) {
...
const qd = { type: ls.MfSegmented, component: lt(() => import("./index56.js"), { loading: true }), create: Rd, config: (() => {
  const e2 = qe(ts);
...
const Od = Object.freeze(Object.defineProperty({ __proto__: null, default: qd, mfSegmentedCreate: Rd, useSegmented: Ad }, Symbol.toStringTag, { value: "Module" }));
function jd(e2) {
  return e2.chart.data.dataSet = qe(zd.defaultData), e2.chartContain.border.show = true, e2.chart.data.headers = zd.defaultHeaders && zd.defaultHeaders(e2.chart), e2.chart.data.limit = 10, e2.chart.data.maxLimit = 1e3, e2.chartContain.dropInfo.width = 150, e2.chartContain.dropInfo.height = 33, e2;
}
const zd = { type: ls.MfSelect, component: lt(() => import("./index57.js"), { loading: true }), create: jd, config: (() => {
  const e2 = qe(ts);
...
const Fd = Object.freeze(Object.defineProperty({ __proto__: null, default: zd, mfSelectCreate: jd, useSelect: Ed }, Symbol.toStringTag, { value: "Module" }));
function Pd(e2) {
  return e2.chart.data.dataSet = qe(Qd.defaultData), e2.chart.data.headers = Qd.defaultHeaders && Qd.defaultHeaders(e2.chart), e2.chart.data.limit = void 0, e2.chart.data.maxLimit = Number.MAX_VALUE, e2.chart.data.pagination = { pageSize: 5 }, e2.chartContain.dropInfo.width = 600, e2.chartContain.dropInfo.height = 380, e2.chart.options = { indexHeader: "序号", columns: [{ ellipsis: true, align: "center", width: 120 }, { ellipsis: true, align: "center", width: 120 }, { ellipsis: true, align: "center", width: 120 }], tableInfo: { scroll: { x: true, y: 330 }, columns: qe(Hd) } }, e2;
}
const Hd = [{ title: "姓名", dataIndex: "name" }, { title: "年龄", dataIndex: "age" }, { title: "地址", dataIndex: "address" }], Qd = { type: ls.MfTable, component: lt(() => import("./index58.js"), { loading: true }), create: Pd, config: (() => {
  const e2 = qe(ts);
  ...
  var _a2;
  return ((_a2 = e2 == null ? void 0 : e2.data.dataSet) == null ? void 0 : _a2.length) > 0 ? as(Object.keys(e2 == null ? void 0 : e2.data.dataSet[0])) : as([]);
}, initData: (e2, t2) => {
...
function Gd() {
  function e2(e3) {
    e3.data.dataSet = qe(Qd.defaultData), e3.options.tableInfo.columns = qe(Hd), e3.data.pagination = { pageSize: e3.data.pagination.pageSize }, e3.options.index && e3.options.tableInfo.columns.unshift({ title: e3.options.indexHeader || "序号", width: 80, align: "center", ellipsis: true });
  }
  return { resetDefault: e2, setDynamicData: function(t2, o2) {
    var _a2;
    if (!t2) return;
    ...
    const { t: n2 } = $e(), { setDataTable: i2 } = ns();
...
}, Zd = Object.assign({ "./MfButton/mfButton.data.ts": fs, "./MfCombine/mfCombine.data.ts": gs, "./MfDataTag/mfDataTag.data.ts": ks, "./MfDataUi/MfDigits/mfDigits.data.ts": $s, "./MfDataUi/MfTireMarks/mfTireMarks.data.ts": Rs, "./MfDataUi/MfWheel/mfWheel.data.ts": Ts, "./MfDataV/MfBorder1/mfBorder1.data.ts": Os, "./MfDataV/MfBorder10/mfBorder10.data.ts": zs, "./MfDataV/MfBorder11/mfBorder11.data.ts": Ps, "./MfDataV/MfBorder12/mfBorder12.data.ts": Qs, "./MfDataV/MfBorder13/mfBorder13.data.ts": Us, "./MfDataV/MfBorder14/mfBorder14.data.ts": Ys, "./MfDataV/MfBorder15/mfBorder15.data.ts": Ks, "./MfDataV/MfBorder16/mfBorder16.data.ts": Js, "./MfDataV/MfBorder17/mfBorder17.data.ts": tu, "./MfDataV/MfBorder18/mfBorder18.data.ts": au, "./MfDataV/MfBorder19/mfBorder19.data.ts": nu, "./MfDataV/MfBorder2/mfBorder2.data.ts": ru, "./MfDataV/MfBorder20/mfBorder20.data.ts": uu, "./MfDataV/MfBorder21/mfBorder21.data.ts": du, "./MfDataV/MfBorder22/mfBorder22.data.ts": fu, "./MfDataV/MfBorder3/mfBorder3.data.ts": gu, "./MfDataV/MfBorder4/mfBorder4.data.ts": yu, "./MfDataV/MfBorder5/mfBorder5.data.ts": Cu, "./MfDataV/MfBorder6/mfBorder6.data.ts": Mu, "./MfDataV/MfBorder7/mfBorder7.data.ts": wu, "./MfDataV/MfBorder8/mfBorder8.data.ts": _u, "./MfDataV/MfBorder9/mfBorder9.data.ts": Lu, "./MfDataV/MfDecoration1/mfDecoration.data.ts": Tu, "./MfDataV/MfDecoration10/mfDecoration.data.ts": Ru, "./MfDataV/MfDecoration11/mfDecoration.data.ts": Ou, "./MfDataV/MfDecoration12/mfDecoration.data.ts": Eu, "./MfDataV/MfDecoration2/mfDecoration.data.ts": Hu, "./MfDataV/MfDecoration3/mfDecoration.data.ts": Uu, "./MfDataV/MfDecoration4/mfDecoration.data.ts": Yu, "./MfDataV/MfDecoration5/mfDecoration.data.ts": Xu, "./MfDataV/MfDecoration6/mfDecoration.data.ts": tc, "./MfDataV/MfDecoration7/mfDecoration.data.ts": lc, "./MfDataV/MfDecoration8/mfDecoration.data.ts": rc, "./MfDataV/MfDecoration9/mfDecoration.data.ts": cc, "./MfDataV/MfHeader1/mfHeader1.data.ts": fc, "./MfDataV/MfHeader2/mfHeader2.data.ts": mc, "./MfDataV/MfHeader3/mfHeader3.data.ts": Cc, "./MfDataV/MfHeader4/mfHeader4.data.ts": kc, "./MfDataV/MfHeader5/mfHeader5.data.ts": Sc, "./MfDataV/MfHeader6/mfHeader6.data.ts": Lc, "./MfDateTime/mfDateTime.data.ts": Nc, "./MfEcharts/MfBar/mfBar.data.ts": qc, "./MfEcharts/MfBarHorizontal/mfBarHorizontal.data.ts": Oc, "./MfEcharts/MfBarLine/mfBarLine.data.ts": Fc, "./MfEcharts/MfBarPlusMinus/mfBarPlusMinus.data.ts": Hc, "./MfEcharts/MfBarStack/mfBarStack.data.ts": zc, "./MfEcharts/MfLine/mfLine.data.ts": Gc, "./MfEcharts/MfLineArea/mfLineArea.data.ts": Vc, "./MfEcharts/MfLineAreaStack/mfLineAreaStack.data.ts": Yc, "./MfEcharts/MfLineSmooth/mfLineSmooth.data.ts": Kc, "./MfEcharts/MfLineStack/mfLineStack.data.ts": Jc, "./MfEcharts/MfMapChunks/mfMapChunks.data.ts": ad, "./MfEcharts/MfMapLine/mfMapLine.data.ts": id, "./MfEcharts/MfMapLine3D/mfMapLine3D.data.ts": sd, "./MfEcharts/MfMapScatter/mfMapScatter.data.ts": cd, "./MfEcharts/MfPie/mfPie.data.ts": pd, "./MfEcharts/MfPieCircular/mfPieCircular.data.ts": hd, "./MfEcharts/MfPieHalf/mfPieHalf.data.ts": md, "./MfEcharts/MfPieRose/mfPieRose.data.ts": vd, "./MfEcharts/MfRadar/mfRadar.data.ts": Md, "./MfEcharts/MfRadarCircle/mfRadarCircle.data.ts": wd, "./MfEcharts/MfScatter/mfScatter.data.ts": Sd, "./MfPicture/mfPicture.data.ts": Dd, "./MfScrollTable/mfScrollTable.data.ts": Bd, "./MfSegmented/mfSegmented.data.ts": Od, "./MfSelect/mfSelect.data.ts": Fd, "./MfTable/mfTable.data.ts": Ud, "./MfTag/mfTag.data.ts": Cs });
const Kd = { ...function() {
  const e2 = {};
  return Object.keys(Zd).forEach((t2) => {
    const o2 = Zd[t2].default;
    e2[o2.type] = o2;
  }), e2;
}() }, Xd = at();
function Jd(e2) {
...
function tp(e2, t2, o2) {
  ...
  const l2 = Ve();
  return e2.chartContain.dropInfo.x = t2, e2.chartContain.dropInfo.y = o2, a2.chart.name = op(a2.chart.type, a2.chart.name), a2.chart.id = l2, a2.chartContain.id = l2, a2.chartContain.dropInfo.x = t2, a2.chartContain.dropInfo.y = o2, a2.chartContain.dropInfo.zIndex = 0, a2;
}
function op(e2, t2) {
...
const ap = (e2) => {
  const t2 = ep();
  t2.chart.type = e2.type, t2.chart.name = op(e2.type, e2.name);
  const o2 = Kd[e2.type];
...
function lp(e2, t2 = []) {
  var _a2;
  let o2;
  return o2 = ((_a2 = e2.chartContain.border.color) == null ? void 0 : _a2.startsWith("linear-gradient")) ? { [Gr.borderImage]: `${e2.chartContain.border.color} 1` } : { [Gr.borderColor]: e2.chartContain.border.color }, np({ ...e2.chartContain.dropInfo, ...o2, [Gr.borderWidth]: e2.chartContain.border.show ? e2.chartContain.border.width : 0, [Gr.borderRadius]: e2.chartContain.border.radius, [Gr.background]: e2.chartContain.background, [Gr.opacity]: e2.chartContain.opacity, padding: e2.chartContain.padding }, t2);
}
function np(e2, t2 = []) {
  const o2 = /* @__PURE__ */ new Set([Gr.width, Gr.height, Gr.borderWidth, Gr.borderRadius]), a2 = new Set(t2), l2 = [];
  a2.has(Gr.x) || a2.has(Gr.y) || (l2.push(`translate(${e2.x}px,${e2.y}px)`), a2.add(Gr.x), a2.add(Gr.y)), a2.has(Gr.rotate) || (l2.push(`rotate(${e2.rotate}deg)`), a2.add(Gr.rotate));
  const n2 = {};
...
function ip(e2) {
  ...
  if (0 !== t2.rotate) {
    ...
    const a2 = Math.round(t2.height * Jr(t2.rotate) + t2.width * Xr(t2.rotate)), l2 = (a2 - t2.height) / 2;
...
async function up(e2, t2) {
  ...
  }, { getDataTable: a2 } = ns(), l2 = [], n2 = [], i2 = Ar(), r2 = (e3) => {
  ...
  for (const e3 of n2) e3.data.priority > u2 && (s2.length > 0 && (await Promise.all(s2), s2 = []), u2 = e3.data.priority), o2(e3), s2.push(a2(e3).then((t3) => {
    var _a2;
    e3.type && ((_a2 = Kd[e3.type]) == null ? void 0 : _a2.initData(e3, t3));
  }));
  return s2;
}
function cp(e2) {
...
function dp(e2, t2) {
  ...
  for (const e3 of o2) {
    if (cp(e3.chart), e3.chart.type === ls.MfCombine) for (const t3 of e3.chart.options.components) cp(t3.chart);
...
const hp = Ar(), gp = (e2) => e2 <= 0, mp = (e2, t2) => e2 >= t2.length - 1, yp = (e2, t2, o2) => {
  const a2 = e2[t2];
  e2[t2] = e2[o2], e2[o2] = a2;
}, vp = et("screen-shortcut", { state: () => ({ showMenu: false, copyData: null, alignType: Sp.GROUP }), getters: { getShowMenu() {
  ...
  var _a2, _b;
  ((_a2 = hp.getSelectArea) == null ? void 0 : _a2.components.length) > 0 ? this.copyData = qe((_b = hp.getSelectArea) == null ? void 0 : _b.components) : hp.getCurComponent && (this.copyData = qe(hp.getCurComponent));
}, pasteComponent() {
  if (this.copyData) {
    if (Ye(this.copyData)) this.copyData.forEach((e2) => {
      const t2 = tp(e2, e2.chartContain.dropInfo.x + 10, e2.chartContain.dropInfo.y + 10);
      t2 && hp.addComponent(t2, 0);
    });
    else {
      const e2 = this.copyData.chartContain.dropInfo.x + 10, t2 = this.copyData.chartContain.dropInfo.y + 10, o2 = tp(this.copyData, e2, t2);
      o2 && (hp.addComponent(o2, 0), hp.setCurComponent(o2, 0));
    }
    hp.setUndoRedoData("组件复制");
  }
}, moveComponent(e2, t2) {
  hp.getCurComponent && ("x" === e2 && (hp.getCurComponent.chartContain.dropInfo.x = hp.getCurComponent.chartContain.dropInfo.x + t2), "y" === e2 && (hp.getCurComponent.chartContain.dropInfo.y = hp.getCurComponent.chartContain.dropInfo.y + t2), t2 >= 10 && hp.setUndoRedoData("组件移动"));
}, upComponent() {
  gp(hp.getCurComponentIndex) || (yp(hp.getComponentList, hp.getCurComponentIndex, hp.getCurComponentIndex - 1), hp.setCurComponentIndex(hp.getCurComponentIndex - 1), hp.setUndoRedoData("组件上移一层"));
}, downComponent() {
  mp(hp.getCurComponentIndex, hp.getComponentList) || (yp(hp.getComponentList, hp.getCurComponentIndex, hp.getCurComponentIndex + 1), hp.setCurComponentIndex(hp.getCurComponentIndex + 1), hp.setUndoRedoData("组件下移一层"));
}, topComponent() {
  hp.getCurComponent && !gp(hp.getCurComponentIndex) && (hp.getComponentList.splice(hp.getCurComponentIndex, 1), hp.getComponentList.unshift(hp.getCurComponent), hp.setCurComponentIndex(0), hp.setUndoRedoData("组件置顶"));
}, bottomComponent() {
  hp.getCurComponent && !mp(hp.getCurComponentIndex, hp.getComponentList) && (hp.getComponentList.splice(hp.getCurComponentIndex, 1), hp.getComponentList.push(hp.getCurComponent), hp.setCurComponentIndex(hp.getComponentList.length - 1), hp.setUndoRedoData("组件置底"));
}, composeComponent() {
  if (hp.getSelectArea.components.length <= 1) return;
  const e2 = [];
  hp.getSelectArea.components.forEach((t2) => {
    var _a2;
    if (t2.chart.type === ls.MfCombine) {
      const o2 = { ...t2.chartContain.dropInfo }, a2 = t2.chart.options.components, l2 = (_a2 = hp.getScreenCanvas) == null ? void 0 : _a2.getBoundingClientRect();
      a2.forEach((e3) => {
        Mp(e3, l2, o2, hp.getScale);
      }), e2.push(...t2.chart.options.components);
    } else e2.push(t2);
  }), C(() => {
    const t2 = ap({ type: ls.MfCombine, name: "组合" });
    null !== t2 && (t2.chartContain.dropInfo = Object.assign(t2.chartContain.dropInfo, hp.getSelectArea.dropInfo), t2.chart.options.components = e2, bp(t2), hp.batchDeleteComponent(hp.getSelectArea.components), hp.addComponent(t2, 0), hp.cleanSelectArea(), hp.setCurComponent(t2, 0), hp.setUndoRedoData("组件组合"));
  });
}, decomposeComponent() {
  if (!hp.getCurComponent) return;
  if (hp.getCurComponent.chart.type !== ls.MfCombine) return;
  hp.getCurComponent.chartContain.show || (hp.getCurComponent.chartContain.show = true);
  const e2 = hp.getCurComponent.chart.options.components, t2 = [];
  for (const o2 of e2) o2.chartContain.show || (o2.chartContain.show = true, t2.push(o2));
  C(() => {
    const o2 = { ...hp.getCurComponent.chartContain.dropInfo };
    if (!hp.getScreenCanvas) return;
    const a2 = hp.getScreenCanvas.getBoundingClientRect(), l2 = hp.getCurComponentIndex;
    hp.deleteComponent(l2);
    for (let t3 = e2.length - 1; t3 >= 0; t3--) Mp(e2[t3], a2, o2, hp.getScale), hp.addComponent(e2[t3], l2), hp.getSelectArea.components.push(e2[t3]);
    t2.forEach((e3) => {
      e3.chartContain.show = false;
    }), wp(hp.getSelectArea.components), hp.setUndoRedoData("组件拆分");
  });
}, lockComponent() {
  ...
  var _a2, _b;
  ((_a2 = hp.getSelectArea) == null ? void 0 : _a2.components.length) > 0 && ((_b = hp.getSelectArea) == null ? void 0 : _b.components.forEach((t2) => {
    t2.chartContain.lock = e2;
  })), hp.getCurComponent && (hp.getCurComponent.chartContain.lock = e2), hp.setUndoRedoData(e2 ? "组件锁定" : "组件解锁");
}, hideComponent() {
  ...
  })), hp.getCurComponent && (hp.getCurComponent.chartContain.show = e2), hp.setUndoRedoData(e2 ? "组件显示" : "组件隐藏");
}, deleteComponent() {
  hp.deleteComponent(), hp.setUndoRedoData("组件删除");
}, selectAllComponent() {
  wp(hp.getComponentList);
}, screenSave() {
  Xd.emit(Qr.SCREEN_SAVE);
}, screenPreview() {
  Xd.emit(Qr.SCREEN_PREVIEW);
} } });
function Cp(e2) {
  return 100 * e2 + "%";
}
function bp(e2) {
  ...
  e2.chart.options.components.forEach((e3) => {
    e3.chartContain.groupStyle = lp(e3, [Gr.x, Gr.y]), e3.chartContain.groupStyle.left = Cp((e3.chartContain.dropInfo.x - t2.x) / t2.width), e3.chartContain.groupStyle.top = Cp((e3.chartContain.dropInfo.y - t2.y) / t2.height), e3.chartContain.groupStyle.width = Cp(e3.chartContain.dropInfo.width / t2.width), e3.chartContain.groupStyle.height = Cp(e3.chartContain.dropInfo.height / t2.height);
  });
}
function Mp(e2, t2, o2, a2) {
...
function kp(e2) {
  const t2 = Ar(), o2 = [], { x: a2, y: l2 } = e2;
  return t2.getComponentList.forEach((t3) => {
    const { x: n2, y: i2, width: r2, height: s2 } = ip(t3.chartContain.dropInfo);
...
function wp(e2) {
  ...
  e2.forEach((e3) => {
    const t3 = ip(e3.chartContain.dropInfo);
...
function xp(e2) {
  ...
  t2.cleanCurComponent(), t2.setSelectedComponents(e2), t2.getSelectArea.components.length > 1 && wp(t2.getSelectArea.components);
}
var Sp = ((e2) => (e2.GROUP = "Group", e2.CANVAS = "Canvas", e2))(Sp || {});
const _p = (e2, t2) => {
  function o2(o3) {
    ...
    }), wp(e2.getSelectArea.components), e2.setUndoRedoData("x" === o3 ? "横向分布" : "纵向分布");
  }
  function a2() {
  ...
  function n2(t3) {
    const o3 = a2();
    l2().forEach((e3) => t3(e3, o3)), wp(e2.getSelectArea.components), e2.setUndoRedoData("对齐");
  }
  function i2() {
  ...
  return (t3, o3) => (s(), r("div", { class: c([d(l2), d(i2).getShowData && d(i2).getShowDataLevel === d(n2) ? "active" : ""]), style: u(e2.highlight ? { border: `1px solid ${d(a2)}` } : "") }, [d(i2).getShowData && d(i2).getShowDataLevel === d(n2) ? (s(), r("div", { key: 0, class: "select", style: u({ backgroundColor: d(a2) }) }, [g(d(Be), { icon: "ant-design:check-outlined", color: "#FFFFFF", size: 14 })], 4)) : f("", true), void 0 !== e2.iconfont ? (s(), h(d(Be), { key: 1, color: d(a2), icon: `iconfont:${e2.iconfont}`, size: 14 }, null, 8, ["color", "icon"])) : f("", true), void 0 !== e2.icon ? (s(), h(d(Be), { key: 2, color: d(a2), icon: e2.icon, size: 14 }, null, 8, ["color", "icon"])) : f("", true), p("div", Lp, S(e2.title), 1), e2.allowDelete && !e2.queryMode ? (s(), h(d(J), { key: 3, type: "vertical" })) : f("", true), e2.queryMode ? f("", true) : (s(), h(d(G), { key: 4, title: "删除" }, { default: M(() => [e2.allowDelete ? (s(), h(d(ee), { key: 0, size: "small", type: "link", onClick: v2 }, { icon: M(() => [g(d(ft))]), _: 1 })) : f("", true)]), _: 1 })), p("div", { class: c(["config", e2.full ? "full" : ""]) }, [R(t3.$slots, "config", {}, void 0, true)], 2), g(d(G), { title: "执行" }, { default: M(() => [g(d(ee), { size: "small", type: "link", style: { margin: "6px" }, onMouseenter: o3[0] || (o3[0] = (e3) => y2.value = true), onMouseleave: o3[1] || (o3[1] = (e3) => y2.value = false), onClick: C2 }, { icon: M(() => [!d(i2).getShowData || d(i2).getShowDataLevel !== d(n2) || y2.value ? (s(), h(d(ht), { key: 0 })) : (s(), h(d(gt), { key: 1 }))]), _: 1 })]), _: 1 })], 6));
} }), [["__scopeId", "data-v-c5dcf0b5"]]), Ip = to(e({ __name: "SelectFields", props: { tableFields: { type: Object, require: true, default: void 0 }, fields: { type: Object, require: true, default: void 0 }, queryMode: { type: Boolean, default: false } }, emits: ["fieldChange"], setup(e2, { emit: t2 }) {
...
} }), [["__scopeId", "data-v-88afb51f"]]), Tp = to(e({ __name: "TableFields", props: { sqlQuery: { type: Object, require: true, default: void 0 }, configMitt: { type: Object, default: void 0 }, queryMode: { type: Boolean, default: false } }, emits: ["fieldChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, n2 = H, r2 = H.Group, { prefixCls: u2 } = xe("table-fields"), p2 = m([]), f2 = _r();
  function y2(e3) {
  ...
  return l(() => {
    ...
    e3 && (e3 === f2.getTableName ? (f2.addTableFieldsMap(e3, f2.getTableFields), p2.value = f2.getTableFields) : Ir(o2.sqlQuery).then((t3) => {
      f2.addTableFieldsMap(e3, t3), p2.value = t3;
    }));
  }, { immediate: true }), i(() => {
    var _a2, _b;
    ((_a2 = o2.sqlQuery) == null ? void 0 : _a2.sqlQuery) && ((_b = o2.sqlQuery) == null ? void 0 : _b.sourceTable) && Ir(o2.sqlQuery).then((e3) => {
  ...
  }), (t3, a3) => (s(), h(Dp, { iconfont: "icon-mfish-table", title: "数据源", "allow-delete": false, onExecute: y2, "query-mode": e2.queryMode }, { config: M(() => [g(d(r2), { class: c(d(u2)), compact: "" }, { default: M(() => {
    var _a2, _b;
    return [g(d(n2), { value: (_a2 = e2.sqlQuery) == null ? void 0 : _a2.sourceTable, disabled: "" }, null, 8, ["value"]), g(Ip, $(t3.$attrs, { "table-fields": p2.value, fields: (_b = o2.sqlQuery) == null ? void 0 : _b.fields, onFieldChange: v2, "query-mode": e2.queryMode }), null, 16, ["table-fields", "fields", "query-mode"])];
  }), _: 1 }, 8, ["class"])]), _: 1 }, 8, ["query-mode"]));
} }), [["__scopeId", "data-v-1d0129ce"]]), Np = async (e2, t2) => {
  var _a2, _b;
  const o2 = _r(), a2 = [];
  ...
  for (; ; ) return o2.has(t2) ? (t2.endsWith(`_${e2}`) && (t2 = t2.slice(0, Math.max(0, t2.length - `${e2}`.length - 1))), Bp(++e2, `${t2}_${e2}`, o2)) : t2;
}, Rp = (e2) => {
  var _a2, _b, _c2, _d2;
  ...
  e2 && e2.push(t2);
}, Ap = to(e({ __name: "ConfigButton", props: { level: { type: Number, default: 1 }, icon: { type: String, default: void 0 }, iconfont: { type: String, default: void 0 }, title: { type: String, default: "按钮" } }, setup(e2) {
  const t2 = e2, { prefixCls: o2 } = xe("config-button"), l2 = Se().getThemeColor, n2 = _r(), i2 = a(() => t2.level < n2.getLevel ? 12 : 14);
...
} }), [["__scopeId", "data-v-749209b7"]]), Op = { key: 0, class: "placeholder" }, jp = { class: "condition" }, zp = e({ __name: "TableJoins", props: { sqlQuery: { type: Object, require: true }, level: { type: Number, default: 1 }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["joinChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, n2 = t2, i2 = te.Item, C2 = H, { prefixCls: _2 } = xe("table-joins"), $2 = _r(), L2 = m([]), D2 = m([]), I2 = m([]), T2 = Se().getThemeColor, N2 = { left: "左联", inner: "内联", right: "右联", full: "全联" }, B2 = a(() => {
    var _a2;
    if (1 === $2.getSourceType || o2.queryMode) return false;
    if (o2.sqlQuery && ((_a2 = o2.sqlQuery) == null ? void 0 : _a2.joins)) {
      for (const e3 of o2.sqlQuery.joins) if (!Rp(e3)) return false;
    }
  ...
  function Q2(e3, t3) {
    ...
    const l2 = new Set(a2), n3 = Bp(0, t3, l2);
  ...
  function U2() {
    ...
    const e3 = async (e4) => {
      ...
      const t4 = await Np(e4, o2.sqlQuery);
  ...
  return (t3, a2) => {
    ...
    return s(), r("div", { class: c(d(_2)) }, [(s(true), r(y, null, v((_a2 = e2.sqlQuery) == null ? void 0 : _a2.joins, (t4, c2) => (s(), h(Dp, { iconfont: "icon-mfish-join", title: "关联", key: c2, "query-mode": e2.queryMode, onDeleteConfig: (e3) => function(e4) {
      ...
      return [0 === c2 ? (s(), h(d(C2), { key: 0, class: "left-table", value: (_a3 = e2.sqlQuery) == null ? void 0 : _a3.sourceTable, disabled: "" }, null, 8, ["value"])) : (s(), h(d(C2), { key: 1, class: "left-table", value: (_b = t4.condition) == null ? void 0 : _b.field.tableAlias, disabled: "" }, null, 8, ["value"])), g(d(V), { class: "condition", placement: "bottom", arrow: { pointAtCenter: true }, disabled: e2.queryMode }, { overlay: M(() => [g(d(te), { onClick: (e3) => function(e4, t5) {
        ...
        return [g(d(oe), { disabled: e2.queryMode, "show-search": "", "allow-clear": false, class: "input-select", "option-filter-prop": "label", value: [A2(c2) || ""], options: R2.value, onChange: (e3) => function(e4, t5) {
          ...
          Oi({ sourceId: _r().getSourceId, tableName: t5.table, sourceType: 0 }).then((e5) => {
          ...
          }), _: 2 }, 1032, ["title"])) : (s(), r("div", Op, "选择关联表"))];
        }), _: 2 }, 1032, ["disabled", "value", "options", "onChange"]), g(Ip, { "query-mode": e2.queryMode, "table-fields": (a3 = t4.table, a3 && $2.getTableFieldsMap.has(a3) ? $2.getTableFieldsMap.get(a3) : []), fields: t4.fields, onFieldChange: (e3) => function(e4, t5) {
          var _a4;
      ...
      }(o3, c2, t4) }, { displayRender: M(({ labels: e3 }) => [g(d(G), { title: j2(c2, e3) }, { default: M(() => [x(S(j2(c2, e3)), 1)]), _: 2 }, 1032, ["title"])]), _: 2 }, 1032, ["disabled", "options", "value", "placeholder", "onChange"]), p("div", jp, [g(d(Be), { icon: "iconfont:icon-mfish-equals", color: d(T2), size: 14 }, null, 8, ["color"])]), g(d(K), { disabled: e2.queryMode, "show-search": "", "allow-clear": false, class: "input-select", "option-filter-prop": "label", value: E2(c2), options: z2(c2), placeholder: `${t4.tableAlias || "关联表"}字段`, onSelect: (e3, o3) => function(e4, t5, o4) {
        o4.condition && (o4.condition.joinedField = e4.realValue, P2(t5));
      }(o3, c2, t4) }, null, 8, ["disabled", "value", "options", "placeholder", "onSelect"])];
    }), _: 2 }, 1032, ["query-mode", "onDeleteConfig", "onExecute"]))), 128)), B2.value ? (s(), h(Ap, { key: 0, class: "config-button", title: "关联", iconfont: "icon-mfish-join", level: 0, onClick: F2 })) : f("", true)], 2);
  };
} }), Ep = to(zp, [["__scopeId", "data-v-d960e99c"]]), Fp = e({ __name: "TableLimit", props: { sqlQuery: { type: Object, require: true }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["limitChange"], setup(e2, { emit: t2 }) {
  ...
  function c2(e3) {
    Br(o2.configMitt, { ...o2.sqlQuery, limit: n2.value }, e3);
  }
  return l(() => {
    var _a2;
    ...
    var _a2;
    return void 0 !== ((_a2 = e2.sqlQuery) == null ? void 0 : _a2.limit) ? (s(), h(Dp, { key: 0, "query-mode": e2.queryMode, icon: "ant-design:column-height-outlined", title: "行数", onDeleteConfig: u2, onExecute: c2 }, { config: M(() => [g(d(Q), { disabled: e2.queryMode, "default-value": n2.value, "addon-after": "行", step: "10", onChange: i2, onPressEnter: r2, onBlur: r2 }, null, 8, ["disabled", "default-value"])]), _: 1 }, 8, ["query-mode"])) : f("", true);
  };
} }), Pp = [{ field: "id", label: "唯一ID", component: "Input", show: false }, { field: "name", label: "参数名称", component: "Input", dynamicRules: () => [{ required: true, validator: (e2, t2) => /^[\u4E00-\u9FA5\w]*$/.test(t2) ? Promise.resolve() : Promise.reject("错误：参数格式不正确！字符只允许中文、字符、数字、下划线!"), trigger: "blur" }] }, { field: "required", label: "是否必须", component: "RadioButtonGroup", defaultValue: 1, componentProps: { options: [{ label: "是", value: 1 }, { label: "否", value: 0 }] }, required: true }, { field: "defaultValue", label: "默认值", component: "Input" }, { field: "remark", label: "参数描述", component: "InputTextArea" }], Hp = { name: "ApiParamsModal", components: { BasicModal: bt, BasicForm: wt }, emits: ["addSuccess", "updateSuccess", "register", "variableChange"], setup(e2, { emit: t2 }) {
  const o2 = m(true), [l2, { resetFields: n2, setFieldsValue: i2, validate: r2 }] = xt({ name: "model_form_item", labelWidth: 100, baseColProps: { span: 24 }, schemas: Pp, showActionButtonGroup: false, autoSubmitOnEnter: true }), s2 = m(), [u2, { setModalProps: c2, closeModal: p2 }] = Mt(async (e3) => {
...
const Qp = to(Hp, [["render", function(e2, t2, o2, a2, l2, n2) {
...
}]]), Gp = { key: 0 }, Up = e({ __name: "FilterVariable", props: { value: { type: String }, queryMode: { type: Boolean, default: false } }, emits: ["variableChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, n2 = K.Option, i2 = Se().getThemeColor, { prefixCls: C2 } = xe("filter-variable"), [b2, { openModal: w2 }] = kt(), _2 = _r(), $2 = m();
  l(() => o2.value, (e3) => {
    $2.value = e3;
  }, { immediate: true });
  ...
  }(o4), ["stop"]) }, null, 8, ["color", "onClick"])]))], 2)]), _: 2 }, 1032, ["label", "value"]))), 128))]), _: 1 }, 8, ["value", "disabled"]), g(Qp, { onRegister: d(b2), onAddSuccess: I2, onUpdateSuccess: T2, onVariableChange: B2 }, null, 8, ["onRegister"])], 64));
} }), Vp = to(Up, [["__scopeId", "data-v-68d91e73"]]), Wp = e({ __name: "TableField", props: { tableFields: { type: Object }, value: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["change"], setup(e2, { emit: t2 }) {
...
} }), Yp = e({ __name: "FilterValue", props: { fieldType: { type: String, default: "STRING" }, valueType: { type: String, default: "0" }, operator: { type: String, default: "" }, tableFields: { type: Array, default: () => [] }, queryMode: { type: Boolean, default: false } }, emits: ["typeChange", "variableChange", "fieldChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, n2 = H, i2 = ae.Group, u2 = ae.Button, p2 = le.ItemRest, { prefixCls: y2 } = xe("filter-value"), v2 = m("0"), C2 = _r();
  function b2() {
  ...
  const o2 = t2, a2 = le.Item, l2 = n({ field: void 0, operator: "", value: void 0 }), i2 = m(), r2 = m([]), u2 = n({ field: { dataType: "STRING" }, type: "1", valueType: "0", required: true }), c2 = m([]), p2 = m(true), y2 = m(), v2 = { STRING: [{ label: "是", value: "eq" }, { label: "不是", value: "ne" }, { label: "包含", value: "like" }, { label: "不包含", value: "notLike" }, { label: "以开始", value: "likeLeft" }, { label: "以结束", value: "likeRight" }, { label: "为空", value: "isNull" }, { label: "不为空", value: "isNotNull" }], NUMBER: [{ label: "等于", value: "eq" }, { label: "不等于", value: "ne" }, { label: "大于", value: "gt" }, { label: "大于等于", value: "ge" }, { label: "小于", value: "lt" }, { label: "小于等于", value: "le" }, { label: "包含", value: "like" }, { label: "不包含", value: "notLike" }, { label: "以开始", value: "likeLeft" }, { label: "以结束", value: "likeRight" }, { label: "为空", value: "isNull" }, { label: "不为空", value: "isNotNull" }], DATE: [{ label: "晚于", value: "gt" }, { label: "晚于等于", value: "ge" }, { label: "早于", value: "lt" }, { label: "早于等于", value: "le" }, { label: "为空", value: "isNull" }, { label: "不为空", value: "isNotNull" }] }, [C2, { setModalProps: b2, closeModal: k2 }] = Mt(async (e3) => {
    var _a2;
    if (b2({ confirmLoading: false, width: "600px" }), Np(void 0, e3.sqlQuery).then((e4) => {
      r2.value = e4;
    }), e3.isUpdate) return u2.field = e3.field, u2.valueType = e3.valueType, u2.required = e3.required, x2((_a2 = u2.field) == null ? void 0 : _a2.dataType), y2.value = e3.index, l2.field = [e3.field.tableAlias, e3.field.colName], l2.operator = e3.operator, e3.operator === oi.between ? l2.value = e3.value ? e3.value.split(",") : [] : l2.value = e3.value ?? "", e3.operator === oi.isNull || e3.operator === oi.isNotNull ? (p2.value = false, l2.value = "") : p2.value = true, void ("2" === e3.valueType && e3.value && (l2.value = JSON.parse(e3.value)));
  ...
  function S2(e3) {
    var _a2;
    e3 === oi.isNull || e3 === oi.isNotNull ? (p2.value = false, l2.value = "") : p2.value = true, "DATE" === ((_a2 = u2.field) == null ? void 0 : _a2.dataType) && (e3 === oi.between ? l2.value = l2.value ? `${l2.value}`.split(",") : [] : l2.value = l2.value ? `${l2.value}`.split(",")[0] : "");
  }
  async function _2() {
    var _a2, _b, _c2, _d2;
    try {
  ...
  return (t3, o3) => (s(), h(d(bt), $(t3.$attrs, { onRegister: d(C2), title: "设置过滤条件", onOk: _2 }), { default: M(() => [g(d(le), { ref_key: "formRef", ref: i2, model: l2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: M(() => {
    var _a2;
    return [g(d(a2), { label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: M(() => [g(Wp, { "query-mode": e2.queryMode, "table-fields": r2.value, value: u2.field, onChange: w2 }, null, 8, ["query-mode", "table-fields", "value"])]), _: 1 }), g(d(a2), { label: "条件", name: "operator", rules: [{ required: true, message: "请选择条件！" }] }, { default: M(() => [g(d(K), { disabled: e2.queryMode, "show-search": "", "allow-clear": false, class: "input-select", "option-filter-prop": "label", value: l2.operator, "onUpdate:value": o3[0] || (o3[0] = (e3) => l2.operator = e3), options: c2.value, placeholder: "选择条件", onSelect: S2 }, null, 8, ["disabled", "value", "options"])]), _: 1 }), p2.value ? (s(), h(d(a2), { key: 0, label: "值", name: "value", rules: [{ required: "STRING" !== ((_a2 = u2.field) == null ? void 0 : _a2.dataType), message: "请选择值！" }] }, { default: M(() => {
      var _a3;
      return [g(Zp, { "query-mode": e2.queryMode, placeholder: "输入值", value: l2.value, "onUpdate:value": o3[1] || (o3[1] = (e3) => l2.value = e3), "value-type": u2.valueType, "field-type": (_a3 = u2.field) == null ? void 0 : _a3.dataType, operator: l2.operator, "table-fields": r2.value, onTypeChange: L2, onVariableChange: D2, onFieldChange: I2 }, null, 8, ["query-mode", "value", "value-type", "field-type", "operator", "table-fields"])];
    }), _: 1 }, 8, ["rules"])) : f("", true)];
  }), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
} }), Xp = e({ __name: "TableFilter", props: { sqlQuery: { type: Object }, level: { type: Number, default: 1 }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["filterChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, n2 = t2, i2 = m([]), u2 = a(() => {
    var _a2;
    return void 0 === ((_a2 = o2.sqlQuery) == null ? void 0 : _a2.filters) && Nr(o2.sqlQuery, o2.level) && !o2.queryMode;
  });
  l(() => {
    var _a2;
  ...
  return (t3, o3) => {
    var _a2;
    return s(), r("div", null, [void 0 !== ((_a2 = e2.sqlQuery) == null ? void 0 : _a2.filters) ? (s(), h(Dp, { key: 0, "query-mode": e2.queryMode, icon: "ant-design:filter-outlined", title: "过滤", onDeleteConfig: b2, full: true, onExecute: D2 }, { config: M(() => [g(d(Ct), { "query-mode": e2.queryMode, items: i2.value, menus: p2.value, "add-title": "添加过滤条件", onAddBlock: x2, onEditBlock: S2, onCloseBlock: $2, onDragChange: L2 }, { tag: M(({ index: t4, element: o4 }) => [g(d(re), { disabled: e2.queryMode, style: { "margin-right": "8px" }, checked: o4 == null ? void 0 : o4.value, "checked-children": "且", "un-checked-children": "或", "checked-value": "and", "un-checked-value": "or", size: "small", onChange: (e3) => function(e4, t5) {
      var _a3;
      i2.value && ((_a3 = i2.value) == null ? void 0 : _a3.length) > t5 && (i2.value[t5].value = e4, setTimeout(() => {
        i2.value && n2("filterChange", [...i2.value]);
      }, 300));
    }(e3, t4) }, null, 8, ["disabled", "checked", "onChange"])]), _: 1 }, 8, ["query-mode", "items", "menus"])]), _: 1 }, 8, ["query-mode"])) : f("", true), u2.value ? (s(), h(Ap, { key: 1, class: "config-button", title: "过滤", icon: "ant-design:filter-outlined", level: 0, onClick: k(w2, ["prevent"]) })) : f("", true), g(Kp, { "query-mode": e2.queryMode, onRegister: d(v2), onSubmit: _2 }, null, 8, ["query-mode", "onRegister"])]);
  };
} }), Jp = e({ __name: "AggregateModal", props: { queryMode: { type: Boolean, default: false } }, emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = t2, a2 = le.Item, l2 = n({ field: void 0, aggFunc: "" }), i2 = m(), r2 = m([]), u2 = n({ field: { dataType: "STRING" } }), c2 = Object.keys(ai).map((e3) => ({ value: e3, label: ai[e3] })), p2 = m(true), y2 = m(), [v2, { setModalProps: C2, closeModal: b2 }] = Mt(async (e3) => {
    if (C2({ confirmLoading: false, width: "600px" }), Np(void 0, e3.sqlQuery).then((e4) => {
      var _a2, _b;
      ...
      r2.value = e4;
    }), e3.isUpdate) return l2.field = [e3.field.tableAlias, e3.field.colName], l2.aggFunc = e3.aggFunc, u2.field = e3.field, p2.value = ai[l2.aggFunc] !== ai.count, void (y2.value = e3.index);
  ...
  async function x2() {
    ...
    try {
      const e3 = await ((_a2 = i2.value) == null ? void 0 : _a2.validateFields());
      b2(), o2("submit", y2.value, { ...u2, name: ai[l2.aggFunc] + (ai[l2.aggFunc] === ai.count ? "" : `(${(_b = u2.field) == null ? void 0 : _b.colName})`), aggFunc: e3.aggFunc });
    } catch (e3) {
    }
  }
  return (t3, o3) => (s(), h(d(bt), $(t3.$attrs, { onRegister: d(v2), title: "选择聚合字段", onOk: x2 }), { default: M(() => [g(d(le), { ref_key: "formRef", ref: i2, model: l2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: M(() => [g(d(a2), { label: "聚合方式", name: "aggFunc", rules: [{ required: true, message: "请选择聚合方式！" }] }, { default: M(() => [g(d(K), { disabled: e2.queryMode, "show-search": "", "allow-clear": false, "option-filter-prop": "label", value: l2.aggFunc, "onUpdate:value": o3[0] || (o3[0] = (e3) => l2.aggFunc = e3), options: d(c2), placeholder: "选择聚合方式", onSelect: w2 }, null, 8, ["disabled", "value", "options"])]), _: 1 }), p2.value ? (s(), h(d(a2), { key: 0, label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: M(() => [g(Wp, { "query-mode": e2.queryMode, "table-fields": r2.value, value: u2.field, onChange: k2 }, null, 8, ["query-mode", "table-fields", "value"])]), _: 1 })) : f("", true)]), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
} }), ef = e({ __name: "GroupModal", props: { queryMode: { type: Boolean, default: false } }, emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = t2, a2 = le.Item, l2 = n({ field: void 0 }), i2 = n({ field: { dataType: "STRING" } }), r2 = m(), u2 = m([]), c2 = m(), [p2, { setModalProps: f2, closeModal: y2 }] = Mt(async (e3) => {
    if (f2({ confirmLoading: false, width: "600px" }), Np(void 0, e3.sqlQuery).then((e4) => {
      u2.value = e4;
  ...
  return (t3, o3) => (s(), h(d(bt), $(t3.$attrs, { onRegister: d(p2), title: "选择分组字段", onOk: C2 }), { default: M(() => [g(d(le), { ref_key: "formRef", ref: r2, model: l2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: M(() => [g(d(a2), { label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: M(() => [g(Wp, { "query-mode": e2.queryMode, "table-fields": u2.value, value: i2.field, onChange: v2 }, null, 8, ["query-mode", "table-fields", "value"])]), _: 1 })]), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
} }), tf = e({ __name: "TableAggregate", props: { sqlQuery: { type: Object }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["aggregateChange", "groupChange", "deleteAggregate"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, n2 = Se().getThemeColor, { prefixCls: i2 } = xe("table-aggregate"), u2 = m(), y2 = m(), [v2, { openModal: C2 }] = kt(), [b2, { openModal: k2 }] = kt();
  async function w2() {
    a2("deleteAggregate");
  }
  function x2() {
  ...
  return l(() => {
    ...
    var _a2;
    return s(), r("div", { class: c(d(i2)) }, [void 0 !== ((_a2 = e2.sqlQuery) == null ? void 0 : _a2.aggregates) ? (s(), h(Dp, { key: 0, "query-mode": e2.queryMode, iconfont: "icon-mfish-sum", title: "聚合", onDeleteConfig: w2, onExecute: N2, full: true }, { config: M(() => [g(d(Ct), { "query-mode": e2.queryMode, items: u2.value, "add-title": "添加聚合指标", onAddBlock: x2, onEditBlock: _2, onDragChange: $2 }, null, 8, ["query-mode", "items"]), g(d(Be), { class: "groupIcon", icon: "ant-design:group-outlined", color: d(n2), style: { "font-size": "14px" } }, null, 8, ["color"]), o3[0] || (o3[0] = p("div", { class: "group" }, "分组", -1)), g(d(Ct), { "query-mode": e2.queryMode, items: y2.value, "add-title": "添加分组指标", onAddBlock: L2, onEditBlock: I2, onDragChange: T2 }, null, 8, ["query-mode", "items"])]), _: 1 }, 8, ["query-mode"])) : f("", true), g(Jp, { "query-mode": e2.queryMode, onRegister: d(v2), onSubmit: S2 }, null, 8, ["query-mode", "onRegister"]), g(ef, { "query-mode": e2.queryMode, onRegister: d(b2), onSubmit: D2 }, null, 8, ["query-mode", "onRegister"])], 2);
  };
} }), of = to(tf, [["__scopeId", "data-v-a3fb541b"]]), af = "其他", lf = e({ __name: "OrderModal", emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = t2, a2 = le.Item, l2 = n({ field: void 0 }), i2 = n({ field: { dataType: "STRING" }, order: "ASC" }), r2 = m(), u2 = m([]), c2 = m(), p2 = _r(), [f2, { setModalProps: y2, closeModal: v2 }] = Mt(async (e3) => {
    if (y2({ confirmLoading: false, width: "600px" }), Tr(e3.sqlQuery) ? Ai({ sourceId: p2.getSourceId, sourceType: p2.getSourceType, sqlQuery: e3.sqlQuery }).then((e4) => {
      u2.value = [{ value: af, label: af, realValue: af, children: e4.map((e5) => ({ value: e5.colName, label: e5.colName + (e5.comment ? `[${e5.comment}]` : ""), realValue: { ...e5 } })) }];
    }) : u2.value = await Np(void 0, e3.sqlQuery), e3.isUpdate) return l2.field = [e3.field.tableAlias, e3.field.colName], i2.field = e3.field, void (c2.value = e3.index);
    l2.field = [], c2.value = void 0, i2.field = {};
  });
  function C2(e3) {
    e3.tableAlias && e3.colName && (l2.field = [e3.tableAlias, e3.colName], i2.field = e3);
  ...
  async function b2() {
    var _a2, _b;
    try {
      await ((_a2 = r2.value) == null ? void 0 : _a2.validateFields()), v2(), i2.field.tableAlias === af && (i2.field.tableAlias = ""), o2("submit", c2.value, { ...i2, name: (_b = i2.field) == null ? void 0 : _b.colName });
    } catch (e3) {
    }
  }
  return (e3, t3) => (s(), h(d(bt), $(e3.$attrs, { onRegister: d(f2), title: "选择排序字段", onOk: b2 }), { default: M(() => [g(d(le), { ref_key: "formRef", ref: r2, model: l2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: M(() => [g(d(a2), { label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: M(() => [g(Wp, { "table-fields": u2.value, value: i2.field, onChange: C2 }, null, 8, ["table-fields", "value"])]), _: 1 })]), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
} }), nf = e({ __name: "TableOrder", props: { sqlQuery: { type: Object, default: void 0 }, configMitt: { type: Object, default: void 0 }, queryMode: { type: Boolean, default: false } }, emits: ["orderChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, n2 = m([]), [i2, { openModal: u2 }] = kt();
  function c2() {
  ...
  function b2(e3) {
    Br(o2.configMitt, { ...o2.sqlQuery, orders: n2.value, limit: void 0 }, e3);
  }
  return l(() => {
    var _a2;
    ...
    var _a2;
    return s(), r("div", null, [void 0 !== ((_a2 = e2.sqlQuery) == null ? void 0 : _a2.orders) ? (s(), h(Dp, { key: 0, "query-mode": e2.queryMode, icon: "ant-design:sort-ascending-outlined", title: "排序", onDeleteConfig: v2, full: true, onExecute: b2 }, { config: M(() => [g(d(Ct), { "query-mode": e2.queryMode, items: n2.value, "add-title": "添加排序指标", onAddBlock: c2, onEditBlock: p2, onDragChange: y2 }, { tagIcon: M(({ element: e3 }) => [g(d(Be), { style: { "font-weight": "bold", "font-size": "20px" }, icon: "ASC" === e3.order ? "ant-design:sort-descending-outlined" : "ant-design:sort-ascending-outlined" }, null, 8, ["icon"])]), _: 1 }, 8, ["query-mode", "items"])]), _: 1 }, 8, ["query-mode"])) : f("", true), g(lf, { onRegister: d(i2), onSubmit: C2 }, null, 8, ["onRegister"])]);
  };
} }), rf = e({ __name: "FieldColModal", emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = t2, a2 = le.Item, l2 = n({ field: void 0 }), i2 = m(), r2 = m(), u2 = m([]), c2 = m(), [p2, { setModalProps: f2, closeModal: y2 }] = Mt(async (e3) => {
    if (f2({ confirmLoading: false, width: "600px" }), Np(void 0, e3.sqlQuery).then((e4) => {
      u2.value = e4;
    }), e3.isUpdate) {
  ...
  async function C2() {
    var _a2, _b;
    try {
      await ((_a2 = r2.value) == null ? void 0 : _a2.validateFields()), y2(), o2("submit", c2.value, { type: li.field, value: i2.value, name: (_b = i2.value) == null ? void 0 : _b.colName });
    } catch (e3) {
    }
  }
  return (e3, t3) => (s(), h(d(bt), $(e3.$attrs, { onRegister: d(p2), title: "选择字段", onOk: C2 }), { default: M(() => [g(d(le), { ref_key: "formRef", ref: r2, model: l2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: M(() => [g(d(a2), { label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: M(() => [g(Wp, { "table-fields": u2.value, value: i2.value, onChange: v2 }, null, 8, ["table-fields", "value"])]), _: 1 })]), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
} }), sf = ["onClick"], uf = ["onClick"], cf = e({ __name: "FormulaManagement", props: { isShow: { type: Boolean, default: false }, curKey: { type: String, default: "" } }, emits: ["select"], setup(e2, { emit: t2 }) {
  ...
  return N(async () => {
  ...
  }), (e3, t3) => (s(), h(d(_t), { "default-size": T2.value, min: 0.1, max: 0.5, class: c(d(k2)) }, { 1: M(() => [g(d(St), { title: "", toolbar: "", search: "", ref_key: "asyncTreeRef", ref: w2, "tree-wrapper-class-name": "h-[calc(100%-35px)] overflow-auto", "selected-keys": $2.value, "onUpdate:selectedKeys": t3[0] || (t3[0] = (e4) => $2.value = e4), "tree-data": B2.value || [], onSelect: O2 }, null, 8, ["selected-keys", "tree-data"])]), 2: M(() => [p("div", { class: c(`${d(k2)}-right h-full pt-2`) }, [g(d(se), { separator: ">", class: "breadcrumb" }, { default: M(() => [(s(true), r(y, null, v(R2.value, (e4, t4) => (s(), h(d(i2), { key: t4 }, { default: M(() => [g(d(Be), { icon: e4.icon }, null, 8, ["icon"]), p("a", { onClick: (t5) => j2(e4.key), class: "fw-bold text-decoration-none" }, S(e4.title), 9, sf)]), _: 2 }, 1024))), 128))]), _: 1 }), I2.value && "" === I2.value.parentId ? (s(), h(d(vt), { key: 0 }, { default: M(() => [g(d(ce), { class: "ml-6" }, { default: M(() => [(s(true), r(y, null, v(z2.value, (e4, t4) => (s(), h(d(de), { span: 22, key: t4, class: c(`${d(k2)}-card`) }, { default: M(() => {
    var _a2, _b;
    ...
    }), _: 2 }, 1032, ["title"])], 2)], 10, uf)];
  }), _: 2 }, 1032, ["class"]))), 128))]), _: 1 })]), _: 1 })) : f("", true), I2.value && I2.value.formulaInfo ? (s(), h(d(vt), { key: 1 }, { default: M(() => [g(d(ue), { class: "pt-3 pr-2", column: 1, bordered: true }, { default: M(() => [g(d(C2), { label: "描述" }, { default: M(() => {
    var _a2;
...
} }), df = to(cf, [["__scopeId", "data-v-6dc5ed8e"]]), pf = { key: 0, class: "content" }, ff = { key: 1, class: "content placeholder" }, hf = to(e({ __name: "FormulaSelect", props: { formulaKey: { type: String, default: "" }, queryMode: { type: Boolean, default: false } }, emits: ["formulaChange"], setup(e2, { emit: t2 }) {
  ...
  return l(() => o2.formulaKey, (e3) => {
    ...
    var _a2;
    return [g(df, { style: { height: "350px" }, "is-show": f2.value, "cur-key": (_a2 = k2.value) == null ? void 0 : _a2.key, onSelect: L2 }, null, 8, ["is-show", "cur-key"]), p("div", { class: c(`${d(u2)}-ok-button`) }, [g(d(ee), { class: "mr-2", onClick: _2 }, { default: M(() => o3[0] || (o3[0] = [x("清空")])), _: 1, __: [0] }), g(d(ee), { type: "primary", onClick: $2 }, { default: M(() => o3[1] || (o3[1] = [x("确定")])), _: 1, __: [1] })], 2)];
  }), _: 1 })]), _: 1 })]), default: M(() => [g(d(ee), { class: c(`${d(u2)}-drop-button`) }, { default: M(() => {
    var _a2, _b;
    return [((_a2 = k2.value) == null ? void 0 : _a2.cnName) ? (s(), r("span", pf, S((_b = k2.value) == null ? void 0 : _b.cnName), 1)) : (s(), r("span", ff, "选择公式")), g(d(Be), { size: 12, icon: f2.value ? "ant-design:up-outlined" : "ant-design:down-outlined", color: i2.value ? "rgba(255, 255, 255, 0.25)" : "rgba(0, 0, 0, 0.25)" }, null, 8, ["icon", "color"])];
  }), _: 1 }, 8, ["class"])]), _: 1 }, 8, ["disabled", "open"]));
} }), [["__scopeId", "data-v-4015d717"]]), gf = "displayName", mf = { config: { type: Object, default: () => ({ type: li.param, value: "" }) }, comType: { type: String, default: "string" }, paramType: { type: String, default: "string" }, paramValue: { type: String, default: "" }, showRadio: { type: Boolean, default: true }, sqlQuery: { type: Object }, index: { type: Number, default: 0 }, queryMode: { type: Boolean, default: false } }, yf = (e2) => {
  if (!e2) return { type: li.formula, value: null };
  const t2 = ((e2 == null ? void 0 : e2.targetParam) ? JSON.parse(e2.targetParam) : []).map((e3) => e3.paramType.startsWith("list") ? { type: li.param, value: [{ type: li.param, value: "" }] } : { type: li.param, value: "" });
  return { type: li.formula, value: { key: e2.key, cnName: e2.cnName, enName: e2.enName, targetObject: e2.targetObject, param: t2 } };
}, vf = e({ __name: "FormulaCompact", props: mf, emits: ["typeChange", "formulaSelect", "inputChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, { prefixCls: n2 } = xe("formula-compact"), i2 = ae.Group, u2 = ae.Button, y2 = m("string"), v2 = m("string"), C2 = m(), b2 = m(li.param), k2 = m(), w2 = m([]), x2 = m(), S2 = m(false), _2 = m([]), $2 = m();
  function L2(e3) {
    a2("formulaSelect", e3 || "");
  }
  function D2() {
  ...
  function I2(e3) {
    e3.tableAlias && e3.colName && (x2.value = e3, a2("inputChange", { ...e3, [gf]: "colName" }));
  }
  function T2(e3, t3) {
  ...
  return l(() => o2.config, (e3) => {
    var _a2;
    e3 && (b2.value = e3.type, e3.type === li.formula ? k2.value = (_a2 = e3.value) == null ? void 0 : _a2.key : C2.value = e3.value);
    ...
    if (e3 === li.param && "list" === y2.value) {
      ...
      S2.value = "fieldName" === t3, S2.value && o2.sqlQuery ? Np(void 0, o2.sqlQuery).then((e5) => {
        ...
        if (_2.value = [], e5 && e5.value) {
          ...
          e5.value.forEach((e6) => {
            const o3 = e6[t4];
            _2.value.push({ label: o3, value: o3, realValue: { ...e6, [gf]: t4 } });
          }), ((_a3 = o2.config) == null ? void 0 : _a3.value) && ($2.value = o2.config.value[o2.config.value[gf]]);
        }
      });
    }
  }, { immediate: true }), (e3, t3) => (s(), r("div", { class: c(d(n2)) }, [o2.showRadio ? (s(), h(d(i2), { key: 0, disabled: o2.queryMode, class: "radio-group", value: b2.value, "onUpdate:value": t3[0] || (t3[0] = (e4) => b2.value = e4), "button-style": "solid", onChange: N2 }, { default: M(() => ["number" === v2.value ? (s(), h(d(u2), { key: 0, value: d(li).param }, { default: M(() => [g(d(G), { placement: "left", title: "数字" }, { default: M(() => [g(d(Be), { icon: "ant-design:field-number-outlined" })]), _: 1 })]), _: 1 }, 8, ["value"])) : (s(), h(d(u2), { key: 1, value: d(li).param }, { default: M(() => [g(d(G), { placement: "left", title: "字符" }, { default: M(() => [g(d(Be), { icon: "ant-design:field-string-outlined" })]), _: 1 })]), _: 1 }, 8, ["value"])), g(d(u2), { value: d(li).formula }, { default: M(() => [g(d(G), { placement: "left", title: "公式" }, { default: M(() => [g(d(Be), { icon: "ant-design:function-outlined" })]), _: 1 })]), _: 1 }, 8, ["value"])]), _: 1 }, 8, ["disabled", "value"])) : f("", true), p("div", { class: c(o2.showRadio ? "formula-select" : "formula-select-show") }, [b2.value === d(li).param && "string" === y2.value ? (s(), h(d(H), { key: 0, disabled: o2.queryMode, value: C2.value, "onUpdate:value": t3[1] || (t3[1] = (e4) => C2.value = e4), class: "input-com", placeholder: "请输入字符常量", onChange: D2 }, null, 8, ["disabled", "value"])) : b2.value === d(li).param && "number" === y2.value ? (s(), h(d(Q), { key: 1, disabled: o2.queryMode, value: C2.value, "onUpdate:value": t3[2] || (t3[2] = (e4) => C2.value = e4), class: "input-com", placeholder: "请输入数字常量", onChange: D2 }, null, 8, ["disabled", "value"])) : b2.value === d(li).param && "list" === y2.value && S2.value ? (s(), h(Wp, { key: 2, "query-mode": o2.queryMode, class: "select-com", "table-fields": w2.value, value: x2.value, onChange: I2 }, null, 8, ["query-mode", "table-fields", "value"])) : b2.value !== d(li).param || "list" !== y2.value || S2.value ? (s(), h(hf, { key: 4, "query-mode": o2.queryMode, "formula-key": k2.value, onFormulaChange: L2 }, null, 8, ["query-mode", "formula-key"])) : (s(), h(d(K), { key: 3, disabled: o2.queryMode, class: "select-com", value: $2.value, "onUpdate:value": t3[3] || (t3[3] = (e4) => $2.value = e4), options: _2.value, placeholder: "请选择参数", onSelect: T2 }, null, 8, ["disabled", "value", "options"]))], 2)], 2));
} }), Cf = to(vf, [["__scopeId", "data-v-8048866c"]]), bf = { style: { "margin-top": "6px", display: "flex", "justify-content": "flex-end" } }, Mf = e({ __name: "FormulaAround", emits: ["submit"], setup(e2, { emit: t2 }) {
  ...
  return (e3, t3) => (s(), h(d(V), { trigger: ["click"], open: n2.value, placement: "bottom", arrow: { pointAtCenter: true }, onOpenChange: u2 }, { overlay: M(() => [g(d(te), null, { default: M(() => [g(d(te).Item, { disabled: "", style: { padding: "0", cursor: "default" } }, { default: M(() => [g(d(pe), { title: "上层公式设置", bordered: false, style: { width: "240px" } }, { default: M(() => [g(hf, { onFormulaChange: c2 }), g(d(K), { style: { width: "100%", "margin-top": "6px" }, placeholder: "选择作为哪个参数", class: "select-com", value: l2.value, "onUpdate:value": t3[0] || (t3[0] = (e4) => l2.value = e4), options: a2.value }, null, 8, ["value", "options"]), p("div", bf, [g(d(ee), { size: "small", onClick: f2 }, { default: M(() => t3[1] || (t3[1] = [x(" 取消")])), _: 1, __: [1] }), g(d(ee), { size: "small", type: "primary", style: { "margin-left": "6px" }, onClick: y2 }, { default: M(() => t3[2] || (t3[2] = [x(" 确定")])), _: 1, __: [2] })])]), _: 1 })]), _: 1 })]), _: 1 })]), default: M(() => [g(d(ee), { style: { "margin-top": "-6px" }, size: "small", type: "link" }, { icon: M(() => [g(d(G), { placement: "left", title: "添加外层公式，当前层作为公式参数" }, { default: M(() => [g(d(Be), { icon: "ant-design:node-collapse-outlined" })]), _: 1 })]), _: 1 })]), _: 1 }, 8, ["open"]));
} }), kf = { class: "formula" }, wf = { class: "title" }, xf = { key: 0, class: "add" }, Sf = e({ __name: "FormulaConfig", props: mf, emits: ["formulaChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, i2 = m(), u2 = m(), { prefixCls: C2 } = xe("formula-config"), b2 = _r(), k2 = m(), _2 = n({ type: li.param, value: "" }), $2 = m(0), L2 = (e3) => e3.startsWith("list"), D2 = (e3) => {
    var _a2, _b;
  ...
  function N2(e3) {
    T2(e3), k2.value = yf(e3), $2.value++, a2("formulaChange", k2.value);
  }
  function B2(e3) {
  ...
  return l(() => o2.config, (e3) => {
    e3 && (k2.value = e3, function() {
      var _a2, _b, _c2;
      if (((_a2 = k2.value) == null ? void 0 : _a2.type) === li.formula) {
    ...
    return s(), r("div", { class: c(d(C2)) }, [p("div", kf, [g(Cf, { "query-mode": o2.queryMode, class: "main", index: o2.index, "com-type": o2.comType, "param-type": o2.paramType, "param-value": o2.paramValue, config: k2.value, "sql-query": o2.sqlQuery, "show-radio": o2.showRadio, onInputChange: I2, onFormulaSelect: N2, onTypeChange: B2 }, null, 8, ["query-mode", "index", "com-type", "param-type", "param-value", "config", "sql-query", "show-radio"]), ((_a2 = k2.value) == null ? void 0 : _a2.type) !== d(li).formula || o2.queryMode ? f("", true) : (s(), h(Mf, { key: 0, onSubmit: R2 }))]), (s(true), r(y, null, v(i2.value, (e4, n2) => (s(), r("div", { key: `${$2.value}${n2}` }, [(s(true), r(y, null, v(D2(n2), (t4, i3) => {
      var _a3, _b, _c2, _d2, _e2, _f2, _g2, _h2, _i2, _j;
      return s(), r("div", { class: "param", key: i3 }, [g(d(Be), { class: "icon", icon: "ant-design:arrow-up-outlined" }), p("span", wf, [g(d(G), { placement: "left", title: u2.value ? u2.value[n2] : "" }, { default: M(() => [x(S(e4.name), 1)]), _: 2 }, 1032, ["title"])]), g(l2, { "query-mode": o2.queryMode, index: i3, "com-type": e4.comType, "param-type": e4.paramType, "param-value": e4.value, config: L2(e4.paramType) && ((_b = (_a3 = k2.value) == null ? void 0 : _a3.value) == null ? void 0 : _b.param) && ((_e2 = (_d2 = (_c2 = k2.value) == null ? void 0 : _c2.value) == null ? void 0 : _d2.param[n2]) == null ? void 0 : _e2.value) ? (_h2 = (_g2 = (_f2 = k2.value) == null ? void 0 : _f2.value) == null ? void 0 : _g2.param[n2]) == null ? void 0 : _h2.value[i3] : (_j = (_i2 = k2.value) == null ? void 0 : _i2.value) == null ? void 0 : _j.param[n2], "sql-query": o2.sqlQuery, onFormulaChange: (t5) => function(e5, t6, o3, l3) {
        var _a4;
        ((_a4 = k2.value) == null ? void 0 : _a4.type) === li.formula && k2.value.value && k2.value.value.param && (L2(o3) ? k2.value.value.param[t6].value ? k2.value.value.param[t6].value[l3] = e5 : k2.value.value.param[t6].value = [e5] : k2.value.value.param[t6] = e5), a2("formulaChange", k2.value);
        ...
        var _a4;
        ((_a4 = k2.value) == null ? void 0 : _a4.type) === li.formula && k2.value.value && k2.value.value.param && (k2.value.value.param[e6].value.splice(t5, 1), $2.value++, a2("formulaChange", k2.value));
      }(n2, i3) }, { icon: M(() => [g(d(Be), { icon: "ant-design:delete-outlined" })]), _: 2 }, 1032, ["onClick"])) : f("", true)]);
    }), 128)), L2(e4.paramType) ? (s(), r("div", xf, [g(d(ee), { type: "primary", onClick: (e5) => function(e6) {
...
} }), _f = to(Sf, [["__scopeId", "data-v-aad21227"]]), $f = e({ __name: "ParamsModal", emits: ["register", "submit"], setup(e2, { emit: t2 }) {
  const o2 = t2, [a2, { resetFields: l2, setFieldsValue: n2, validate: i2, resetSchema: r2 }] = xt({ name: "model_form_item", labelWidth: 180, baseColProps: { span: 24 }, showActionButtonGroup: false, autoSubmitOnEnter: true }), u2 = _r(), c2 = m(), [p2, { setModalProps: f2, closeModal: y2 }] = Mt(async (e3) => {
  ...
  const o2 = e2, a2 = t2, n2 = Se().getThemeColor, i2 = _r(), c2 = m(false);
  l(() => o2.open, (e3) => {
    c2.value = e3, e3 && p2();
  });
  const p2 = Te((e3) => {
  ...
  return (e3, t3) => (s(), h(d(fe), { title: "测试结果", placement: "bottom", open: c2.value, onClose: k2, height: 450 }, { default: M(() => [g(d(Lt), { onRegister: d(y2) }, { bodyCell: M(({ column: e4, record: t4 }) => [(e4 == null ? void 0 : e4.key) === d(Lr) ? (s(), r("div", { key: 0, style: u({ color: d(n2) }) }, S(t4[d(Lr)]), 5)) : f("", true)]), _: 1 }, 8, ["onRegister"])]), _: 1 }, 8, ["open"]));
} }), Df = e({ __name: "FormulaColModal", props: { queryMode: { type: Boolean, default: false } }, emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = t2, a2 = m(), l2 = m(), i2 = m(), u2 = n({ type: li.formula, value: null });
  let c2;
  const p2 = m(0), v2 = _r(), [C2, { openModal: b2 }] = kt(), k2 = m(), w2 = m(), S2 = m(false), _2 = (e3) => {
    ...
    return Array.isArray(e3.value) ? (e3.value.forEach((e4) => {
      ...
      t3 += `${_2(e4)},`;
    }), t3.endsWith(",") && (t3 = t3.slice(0, Math.max(0, t3.lastIndexOf(",")))), t3 += ")", t3) : (e3.type === li.param && (t3 += e3.value instanceof Object ? e3.value[e3.value[gf]] : e3.value), t3);
  }, [L2, { setModalProps: D2, closeModal: I2 }] = Mt(async (e3) => {
  ...
  function B2() {
    k2.value = { schema: c2.schema, sourceTable: c2.sourceTable, joins: c2.joins, sqlQuery: c2 == null ? void 0 : c2.sqlQuery, customColumns: [{ name: Lr, expressions: [{ type: li.formula, value: u2.value }] }] };
  ...
  function K2() {
    var _a2, _b, _c2, _d2;
    F2.value = { schema: (_a2 = o2.sqlQuery) == null ? void 0 : _a2.schema, sourceTable: (_b = o2.sqlQuery) == null ? void 0 : _b.sourceTable, joins: (_c2 = o2.sqlQuery) == null ? void 0 : _c2.joins, sqlQuery: (_d2 = o2.sqlQuery) == null ? void 0 : _d2.sqlQuery, customColumns: [{ name: Lr, expressions: f2.value }] };
  ...
  return (t3, a3) => {
    ...
    }(e4, t4) }, { icon: M(() => [g(d(Re), { icon: t4.icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["color", "onClick", "onDragstart"])]), _: 2 }, 1032, ["title"]))), 128))]), key: "0" }]), 1032, ["query-mode", "items"])]), _: 1 }, 8, ["onRegister"]), g(rf, { onRegister: d(I2), onSubmit: Y2 }, null, 8, ["onRegister"]), g(Df, { "query-mode": e2.queryMode, onRegister: d(N2), onSubmit: Z2 }, null, 8, ["query-mode", "onRegister"]), g(Lf, { "cur-query": F2.value, "cur-params": P2.value, open: H2.value, onClose: a3[0] || (a3[0] = () => H2.value = false) }, null, 8, ["cur-query", "cur-params", "open"])]), _: 1 }, 16, ["onRegister"]), g($f, { onRegister: d(z2), onSubmit: X2 }, null, 8, ["onRegister"])], 64);
  };
} }), Tf = to(If, [["__scopeId", "data-v-93a6f597"]]), Nf = e({ __name: "TableCustomCol", props: { sqlQuery: { type: Object }, level: { type: Number, default: 1 }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["customColChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, n2 = t2, i2 = m([]);
  function u2() {
    n2("customColChange");
  }
  const [c2, { openModal: p2 }] = kt(), y2 = a(() => {
    var _a2;
    return void 0 === ((_a2 = o2.sqlQuery) == null ? void 0 : _a2.customColumns) && Nr(o2.sqlQuery, o2.level) && !o2.queryMode;
  });
  function v2() {
  ...
  return l(() => {
    ...
    var _a2;
    return s(), r("div", null, [void 0 !== ((_a2 = e2.sqlQuery) == null ? void 0 : _a2.customColumns) ? (s(), h(Dp, { key: 0, "query-mode": e2.queryMode, icon: "ant-design:insert-row-right-outlined", title: "自定义列", onDeleteConfig: u2, onExecute: x2, full: true }, { config: M(() => [g(d(Ct), { "query-mode": e2.queryMode, items: i2.value, "add-title": "添加自定义列", onAddBlock: v2, onEditBlock: C2, onDragChange: b2 }, null, 8, ["query-mode", "items"])]), _: 1 }, 8, ["query-mode"])) : f("", true), y2.value ? (s(), h(Ap, { key: 1, class: "config-button", title: "自定义列", icon: "ant-design:insert-row-right-outlined", level: 0, onClick: k(w2, ["prevent"]) })) : f("", true), g(Tf, { "query-mode": e2.queryMode, onRegister: d(c2), "sql-query": e2.sqlQuery, onSubmit: S2 }, null, 8, ["query-mode", "onRegister", "sql-query"])]);
  };
} }), Bf = { class: "btn-bar" }, Rf = to(e({ __name: "ApiConfig", props: { configKey: { type: Number, default: 0, require: true }, sqlQuery: { type: Object, require: true, default: void 0 }, level: { type: Number, default: 1 }, configMitt: { type: Object, default: void 0 }, queryMode: { type: Boolean, default: false } }, emits: ["configChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, { sqlQuery: n2 } = A(o2), { prefixCls: i2 } = xe("api-config"), y2 = Se().getThemeColor, v2 = m(), C2 = m(), { focused: b2 } = Ne(v2), { focused: M2 } = Ne(C2), k2 = _r(), x2 = m(false), S2 = a(() => {
    var _a2;
    ...
    var _a2;
    return (void 0 === ((_a2 = o2.sqlQuery) == null ? void 0 : _a2.aggregates) || Nr(o2.sqlQuery, o2.level)) && !o2.queryMode;
  }), D2 = a(() => {
    var _a2;
  ...
  async function H2() {
    ...
    return e3.fields = await Ir(e3), e3;
  }
  async function Q2() {
    var _a2, _b;
    if (Nr(o2.sqlQuery, o2.level)) {
      const e3 = await H2();
      return e3.joins = [], qp(e3.joins), void l2("configChange", e3, true);
    }
    ((_a2 = n2 == null ? void 0 : n2.value) == null ? void 0 : _a2.joins) && qp((_b = n2 == null ? void 0 : n2.value) == null ? void 0 : _b.joins);
  }
  function G2() {
    W2(["filters"]);
  }
  ...
  function K2() {
    var _a2;
    (_a2 = o2.configMitt) == null ? void 0 : _a2.emit(Dr.QUERY_SQL, o2.sqlQuery), M2.value = false;
  }
  function X2() {
  ...
  return (t3, o3) => {
    ...
    return s(), r("div", { class: c([d(i2), e2.level < d(k2).getLevel ? "inner" : "", d(k2).getShowData && d(k2).getShowDataLevel === e2.level ? "active" : ""]) }, [d(k2).getShowData && d(k2).getShowDataLevel === e2.level ? (s(), r("div", { key: 0, class: "select", style: u({ backgroundColor: d(y2) }) }, [g(d(Be), { icon: "ant-design:check-outlined", color: "#FFFFFF", size: 12 })], 4)) : f("", true), void 0 !== ((_a2 = d(n2)) == null ? void 0 : _a2.sqlQuery) ? (s(), h(a2, { key: 1, "config-key": e2.configKey, "query-mode": e2.queryMode, "sql-query": d(n2).sqlQuery, level: e2.level - 1, "config-mitt": e2.configMitt, onConfigChange: F2 }, null, 8, ["config-key", "query-mode", "sql-query", "level", "config-mitt"])) : f("", true), (s(), h(Tp, { key: e2.configKey + d(k2).getFieldsChange, class: "config", "sql-query": d(n2), "query-mode": e2.queryMode, "config-mitt": e2.configMitt, onFieldChange: T2 }, null, 8, ["sql-query", "query-mode", "config-mitt"])), (s(), h(Ep, { level: e2.level, key: e2.configKey, class: "config", "sql-query": d(n2), "config-mitt": e2.configMitt, "query-mode": e2.queryMode, onJoinChange: N2 }, null, 8, ["level", "sql-query", "config-mitt", "query-mode"])), (s(), h(Xp, { "query-mode": e2.queryMode, level: e2.level, key: e2.configKey, class: "config", "sql-query": d(n2), "config-mitt": e2.configMitt, onFilterChange: B2 }, null, 8, ["query-mode", "level", "sql-query", "config-mitt"])), (s(), h(Nf, { "query-mode": e2.queryMode, level: e2.level, key: e2.configKey, class: "config", "sql-query": d(n2), "config-mitt": e2.configMitt, onCustomColChange: R2 }, null, 8, ["query-mode", "level", "sql-query", "config-mitt"])), (s(), h(of, { "query-mode": e2.queryMode, key: e2.configKey, class: "config", "sql-query": d(n2), "config-mitt": e2.configMitt, onAggregateChange: q2, onGroupChange: O2, onDeleteAggregate: j2 }, null, 8, ["query-mode", "sql-query", "config-mitt"])), (s(), h(nf, { "query-mode": e2.queryMode, key: e2.configKey, class: "config", "sql-query": d(n2), "config-mitt": e2.configMitt, onOrderChange: z2 }, null, 8, ["query-mode", "sql-query", "config-mitt"])), (s(), h(Fp, { "query-mode": e2.queryMode, key: e2.configKey, class: "config", "sql-query": d(n2), "config-mitt": e2.configMitt, onLimitChange: E2 }, null, 8, ["query-mode", "sql-query", "config-mitt"])), p("div", Bf, [S2.value ? (s(), h(Ap, { key: 0, class: "config-button", title: "关联", iconfont: "icon-mfish-join", level: e2.level, onClick: Q2 }, null, 8, ["level"])) : f("", true), _2.value ? (s(), h(Ap, { key: 1, class: "config-button", title: "过滤", icon: "ant-design:filter-outlined", level: e2.level, onClick: G2 }, null, 8, ["level"])) : f("", true), $2.value ? (s(), h(Ap, { key: 2, class: "config-button", title: "自定义列", icon: "ant-design:insert-row-right-outlined", level: e2.level, onClick: U2 }, null, 8, ["level"])) : f("", true), L2.value ? (s(), h(Ap, { key: 3, class: "config-button", title: "聚合", iconfont: "icon-mfish-sum", level: e2.level, onClick: V2 }, null, 8, ["level"])) : f("", true), D2.value ? (s(), h(Ap, { key: 4, class: "config-button", title: "排序", icon: "ant-design:sort-ascending-outlined", level: e2.level, onClick: Y2 }, null, 8, ["level"])) : f("", true), I2.value ? (s(), h(Ap, { key: 5, class: "config-button", title: "行数", icon: "ant-design:column-height-outlined", level: e2.level, onClick: Z2 }, null, 8, ["level"])) : f("", true), g(Ap, { class: "config-button", ref_key: "querySqlRef", ref: C2, style: u({ fontWeight: "bold", border: `1px dashed ${d(y2)}` }), title: "查看SQL", icon: "ant-design:console-sql-outlined", level: e2.level, onClick: K2 }, null, 8, ["style", "level"]), g(Ap, { class: "config-button", style: u({ fontWeight: "bold", border: `1px dashed ${d(y2)}` }), ref_key: "queryDataRef", ref: v2, title: "执行", onMouseenter: o3[0] || (o3[0] = (e3) => x2.value = true), onMouseleave: o3[1] || (o3[1] = (e3) => x2.value = false), icon: !d(k2).getShowData || d(k2).getShowDataLevel !== e2.level || x2.value ? "ant-design:caret-right-outlined" : "ant-design:check-outlined", level: e2.level, onClick: X2 }, null, 8, ["style", "icon", "level"])])], 2);
  };
} }), [["__scopeId", "data-v-32695b70"]]), qf = { key: 0 }, Af = { key: 1 }, Of = e({ __name: "SqlQueryModal", setup(e2) {
  const t2 = m(500), o2 = m(""), [a2, { setModalProps: l2 }] = Mt(async (e3) => {
  ...
  return (e3, l3) => {
    const p2 = w("AButton");
    return s(), h(d(bt), $(e3.$attrs, { onRegister: d(a2), title: "SQL查看", "show-ok-btn": false, "cancel-text": "关闭", onHeightChange: c2 }), { insertFooter: M(() => [g(p2, { onClick: l3[0] || (l3[0] = (e4) => d(n2)(o2.value)), color: d(i2) ? "success" : "primary" }, { default: M(() => [d(i2) ? (s(), r("span", Af, "已拷贝")) : (s(), r("span", qf, "拷贝"))]), _: 1 }, 8, ["color"])]), default: M(() => [g(d(Dt), { style: u({ height: `${t2.value}px` }), mode: d(It).JS, value: o2.value, "onUpdate:value": l3[1] || (l3[1] = (e4) => o2.value = e4), readonly: true }, null, 8, ["style", "mode", "value"])]), _: 1 }, 16, ["onRegister"]);
  };
} });
const jf = ["src"], zf = to(e({ name: "PreviewFrame", __name: "PreviewFrame", props: { frameSrc: Nt.string.def(""), frameWidth: Nt.number.def(400), frameHeight: Nt.number.def(300) }, emits: ["message"], setup(e2, { expose: t2, emit: o2 }) {
  ...
  } }), (t3, o3) => (s(), h(d(vt), null, { default: M(() => [p("iframe", { style: u(y2.value), src: e2.frameSrc, class: c(`${d(g2)}__main`), ref_key: "frameRef", ref: f2, onLoad: v2 }, null, 46, jf)]), _: 1 }));
} }), [["__scopeId", "data-v-1bb3fd25"]]);
const Ef = { class: "share-title" }, Ff = e({ __name: "ScreenPreview", props: { fixScale: { type: Number, default: 1 }, borderRadius: { type: String } }, setup(e2) {
  const t2 = e2, { prefixCls: l2 } = xe("screen-preview"), { token: C2 } = P.useToken(), b2 = a(() => C2.value.colorBorder), k2 = o("fitDomRef"), w2 = m([]), { getAntdLocale: x2 } = Tt(), $2 = Ar(), { antTheme: L2 } = Le(a(() => $2.getTheme)), D2 = m(false), I2 = m(""), T2 = m(window.innerWidth), N2 = m(window.innerHeight), B2 = m(), R2 = a(() => [...$2.getComponentList].reverse()), q2 = n({ width: 0, height: 0 }), A2 = a(() => ({ ...Jd($2.getCanvasConfig), width: $2.getCanvasConfig.width * q2.width * t2.fixScale + "px", height: $2.getCanvasConfig.height * q2.height * t2.fixScale + "px" })), E2 = (e3) => np({ ...e3.chartContain.dropInfo }), F2 = (e3) => {
    var _a2, _b;
  ...
  const { register: U2, unRegister: V2 } = function() {
    const { getDataTable: e3 } = ns(), t3 = [], o2 = Ar();
    return { register: async function() {
      const a2 = (o3) => {
        ...
        ((_a2 = o3.data.autoRefresh) == null ? void 0 : _a2.open) && o3.data.autoRefresh.interval && t3.push(setInterval(() => {
          e3(o3).then((e4) => {
            var _a3;
            o3.type && ((_a3 = Kd[o3.type]) == null ? void 0 : _a3.initData(o3, e4));
          });
    ...
    setTimeout(() => {
      $2.loadingScreen().then(() => {
        ...
        for (let e4 = 0; e4 < R2.value.length; e4++) {
          ...
          Xd.on(Qr.EVENT_ANIMATION, (o4) => {
            Yd(o4, t3, w2.value[e4]);
          });
          const o3 = (_a2 = t3.chart.animations) == null ? void 0 : _a2.filter((e5) => !e5.events || 0 === e5.events.length);
          !o3 || 0 === o3.length || w2.value.length <= e4 || (R2.value[e4].chartContain.show && R2.value[e4].chart.type !== ls.MfCombine && (R2.value[e4].chartContain.show = false, l3.set(e4, R2.value[e4])), setTimeout(() => {
            l3.has(e4) && (l3.get(e4).chartContain.show = true), Wd(w2.value[e4], o3).then();
          }, 600));
        }
      });
    }, 10), Xd.on(Qr.SHOW_MODAL, (e3) => {
      var _a2, _b, _c2, _d2, _e2, _f2;
  ...
  return (t3, o3) => (s(), r("div", { class: c(d(i2)) }, [p("div", { class: c(["group-title", [e2.allowCollapse ? "collapsed" : ""]]), onClick: y2 }, [p("div", Gf, [e2.allowCheck ? (s(), h(d(W), { key: 0, checked: l2.value, "onUpdate:checked": o3[0] || (o3[0] = (e3) => l2.value = e3), onClick: o3[1] || (o3[1] = k(() => {
  }, ["stop"])), onChange: v2 }, null, 8, ["checked"])) : f("", true), e2.tooltip ? (s(), h(d(G), { key: 1, title: e2.tooltip }, { default: M(() => [x(S(e2.title), 1)]), _: 1 }, 8, ["title"])) : (s(), r("span", Uf, S(e2.title), 1)), !e2.allowCheck && e2.allowCollapse || e2.allowCheck && e2.titleCheck ? (s(), h(d(Be), { key: 3, icon: `ant-design:${n2.value ? "up" : "down"}-outlined`, size: 12 }, null, 8, ["icon"])) : f("", true)]), p("div", { onClick: o3[2] || (o3[2] = k(() => {
  }, ["stop"])) }, [R(t3.$slots, "action", {}, void 0, true)]), e2.allowCopy ? (s(), r("div", Vf, [g(d(G), { placement: "top", title: `复制${e2.title}` }, { default: M(() => [g(d(Be), { "aria-hidden": "false", size: 12, icon: "iconfont:icon-mfish-copy", onClick: k(C2, ["stop"]) })]), _: 1 }, 8, ["title"]), g(d(G), { placement: "top", title: `粘贴${e2.title}` }, { default: M(() => [g(d(Be), { "aria-hidden": "false", size: 12, icon: "iconfont:icon-mfish-paste", onClick: k(b2, ["stop"]) })]), _: 1 }, 8, ["title"])])) : f("", true)], 2), g(d(Rt), { show: !e2.allowCheck && n2.value || e2.allowCheck && n2.value && e2.titleCheck }, { default: M(() => [p("div", Wf, [R(t3.$slots, "default", {}, void 0, true)])]), _: 3 }, 8, ["show"])], 2));
} }), Zf = to(Yf, [["__scopeId", "data-v-9aa90d73"]]), Kf = { class: "table-bordered" }, Xf = e({ __name: "GlobalParamsConfig", setup(e2) {
  ...
  return i(() => {
    ...
    const i2 = w("AInput");
    return s(), h(d(vt), null, { default: M(() => [p("div", { class: c(d(t2)) }, [n2[8] || (n2[8] = p("div", { class: "title" }, "大屏名称", -1)), g(i2, { value: d(o2).getCanvasConfig.screenName, "onUpdate:value": n2[0] || (n2[0] = (e4) => d(o2).getCanvasConfig.screenName = e4), "show-count": "", maxlength: 30 }, null, 8, ["value"]), n2[9] || (n2[9] = p("div", { class: "title" }, " 描述", -1)), g(d(Me), { value: d(o2).getCanvasConfig.screenDesc, "onUpdate:value": n2[1] || (n2[1] = (e4) => d(o2).getCanvasConfig.screenDesc = e4), "show-count": "", maxlength: 200 }, null, 8, ["value"]), n2[10] || (n2[10] = p("div", { class: "title" }, "大屏尺寸", -1)), g(Qf), p("div", Jf, [n2[5] || (n2[5] = x(" 主题 ")), g(d(Z), { size: "small", value: d(o2).getCanvasConfig.theme, "onUpdate:value": n2[2] || (n2[2] = (e4) => d(o2).getCanvasConfig.theme = e4) }, { default: M(() => [(s(), r(y, null, v(l2, (e4, t3) => g(d(Y), { key: t3, value: e4.value }, { default: M(() => [x(S(e4.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])]), n2[11] || (n2[11] = p("div", { class: "title" }, "背景颜色", -1)), g(d(Eo), { value: a2.value, onConfirmChange: f2, onInputChange: C2 }, null, 8, ["value"]), n2[12] || (n2[12] = p("div", { class: "title" }, "背景图片", -1)), g(d(Bt), { "file-keys": d(o2).getCanvasConfig.backgroundImage, accepts: ".jpg,.jpeg,.png,.svg", "button-text": "上传背景", "max-count": 1, "is-pic": true, onSuccess: b2, onRemove: k2 }, null, 8, ["file-keys"]), p("div", eh, [n2[6] || (n2[6] = x(" 水印 ")), p("div", null, [g(i2, { value: d(o2).getCanvasConfig.watermark, "onUpdate:value": n2[3] || (n2[3] = (e4) => d(o2).getCanvasConfig.watermark = e4), placeholder: "清空无水印", "show-count": "", maxlength: 50 }, null, 8, ["value"])])]), p("div", th, [n2[7] || (n2[7] = x(" 适配方式 ")), p("div", null, [g(d(Z), { value: d(o2).getCanvasConfig.fitType, "onUpdate:value": n2[4] || (n2[4] = (e4) => d(o2).getCanvasConfig.fitType = e4) }, { default: M(() => [(s(true), r(y, null, v(Object.keys(u2), (e4) => (s(), h(d(G), { key: e4, placement: "bottomRight", title: u2[e4].description }, { default: M(() => [g(d(Y), { class: c(`${d(t2)}-radio-button`), value: e4 }, { default: M(() => [g(d(Be), { icon: u2[e4].icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["class", "value"])]), _: 2 }, 1032, ["title"]))), 128))]), _: 1 }, 8, ["value"])])]), g(Xf)], 2)]), _: 1 });
  };
} }), ah = to(oh, [["__scopeId", "data-v-c7f8401a"]]), lh = { class: "header" }, nh = e({ name: "FrameConfig", __name: "index", props: { collapsed: Nt.bool.def(false) }, setup(e2, { expose: t2 }) {
  const o2 = e2, { prefixCls: n2 } = xe("frame-config"), i2 = a(() => [n2, { collapsed: o2.collapsed }]), u2 = m(), y2 = m(), v2 = m(), C2 = Ar(), b2 = m();
  function k2(e3) {
    if (e3) {
      const t3 = Kd[e3.chart.type].config;
      u2.value = Object.keys(t3).filter((e4) => t3[e4].show).map((e4) => t3[e4]);
    } else u2.value = [{ value: "画布配置", payload: { icon: "carbon:gui-management", component: T(ah) } }];
  ...
  return l([() => C2.getCurComponent, () => {
    ...
    b2.value = e3;
  } }), (e3, t3) => (s(), r("div", { class: c(i2.value) }, [p("div", lh, [g(d(U), { value: y2.value, options: u2.value, onChange: w2, block: "" }, { label: M(({ value: e4, payload: t4 }) => [t4.icon ? (s(), h(d(Be), { key: 0, icon: t4.icon }, null, 8, ["icon"])) : f("", true), x(" " + S(e4), 1)]), _: 1 }, 8, ["value", "options"])]), (s(), h(j(v2.value), { "select-data": b2.value }, { "data-select": M(() => [R(e3.$slots, "data-select", { curSelect: b2.value })]), _: 3 }, 8, ["select-data"]))], 2));
} }), ih = { class: "action" }, rh = { class: "ac-int" }, sh = e({ __name: "CanvasRulerLine", props: { lineValue: { type: Number, default: 0 }, lineList: { type: Array, default: () => [] } }, setup(e2) {
  const t2 = e2, { lineList: o2 } = t2, a2 = Ar(), { prefixCls: l2 } = xe("canvas-ruler-line"), n2 = Se().getThemeColor;
  return (e3, t3) => (s(), r("div", { class: c(d(l2)) }, [(s(true), r(y, null, v(d(o2), (e4, t4) => (s(), r("div", { class: c(["line-item", { x: "x" === e4.position, y: "y" === e4.position }]), style: u({ left: "x" === e4.position ? `${Math.round(e4.offset * d(a2).getScale)}px` : 0, top: "y" === e4.position ? `${Math.round(e4.offset * d(a2).getScale)}px` : 0 }), key: `${e4}${t4}` }, [p("div", ih, [g(d(Be), { class: "ac-close", icon: "ant-design:close-outline", color: d(n2), onClick: (a3) => function(e5, t5) {
    o2.splice(t5, 1);
  }(e4.position, t4) }, null, 8, ["color", "onClick"]), p("span", rh, S(e4.value), 1)])], 6))), 128))], 2));
} }), uh = to(sh, [["__scopeId", "data-v-91bb6b29"]]), ch = { id: "horn", class: "horn" }, dh = ["id", "width", "height"], ph = { class: "indicator-value" }, fh = ["id", "height", "width"], hh = { class: "indicator-value" }, gh = e({ __name: "CanvasRuler", props: { rulerXLeft: { type: Number, default: 0 }, rulerYTop: { type: Number, default: 0 }, rulerX: { type: Number, default: 5e3 }, rulerY: { type: Number, default: 3e3 }, drift: { type: Number, default: 0 }, rulerHeight: { type: Number, default: 28 }, rulerWidth: { type: Number, default: 38 } }, setup(e2) {
  const t2 = e2, n2 = Ar(), { prefixCls: i2 } = xe("canvas-ruler"), f2 = m(0), y2 = m(true), v2 = T({}), b2 = T({}), k2 = a(() => `${t2.rulerXLeft}px`), w2 = a(() => `${t2.rulerYTop}px`), x2 = o("rulerXRef"), _2 = o("rulerYRef"), $2 = a(() => Se().getDarkMode.value === Ge.DARK ? "#999" : "#666");
  ...
  return (t3, o2) => (s(), r("div", { class: c(d(i2)) }, [p("div", ch, [g(d(G), { title: (y2.value ? "隐藏" : "显示") + "辅助线" }, { default: M(() => [y2.value ? (s(), h(d(Be), { key: 0, class: "icon", icon: "ant-design:eye-outlined", onClick: Q2 })) : (s(), h(d(Be), { key: 1, class: "icon", icon: "ant-design:eye-invisible-outlined", onClick: Q2 }))]), _: 1 }, 8, ["title"])]), p("div", { class: "ruler rulerX", style: u({ width: `${L2.value}px`, left: k2.value }) }, [p("canvas", { ref_key: "rulerXRef", ref: x2, id: `${d(i2)}-x`, width: L2.value, height: e2.rulerHeight, onMousemove: I2, onMouseleave: N2, onClick: B2 }, null, 40, dh), p("div", { class: "indicator x", style: u(v2.value) }, [p("div", ph, S(f2.value), 1)], 4), O(g(uh, { "line-value": f2.value, "line-list": d(n2).getGuideLine.lineListY }, null, 8, ["line-value", "line-list"]), [[z, y2.value]])], 4), p("div", { class: "ruler rulerY", style: u({ height: `${D2.value}px`, top: w2.value }) }, [p("canvas", { ref_key: "rulerYRef", ref: _2, id: `${d(i2)}-y`, height: D2.value, width: e2.rulerWidth, onMousemove: R2, onMouseleave: q2, onClick: A2 }, null, 40, fh), p("div", { class: "indicator y", style: u(b2.value) }, [p("div", hh, S(f2.value), 1)], 4), O(g(uh, { "line-value": f2.value, "line-list": d(n2).getGuideLine.lineListX }, null, 8, ["line-value", "line-list"]), [[z, y2.value]])], 4)], 2));
} }), mh = to(gh, [["__scopeId", "data-v-eeb86e63"]]), yh = e({ __name: "CanvasBackground", props: { drift: { type: Number, default: 0 }, width: { type: Number, default: 9e3 }, height: { type: Number, default: 6e3 }, ruler: { type: Object, default: () => ({ height: 28, width: 38 }) } }, setup(e2) {
  const t2 = e2, o2 = Ar(), l2 = vp(), n2 = a(() => t2.width * o2.getScale + "px"), i2 = a(() => t2.height * o2.getScale + "px"), { prefixCls: p2 } = xe("canvas-background");
  function f2(e3) {
...
} }), vh = to(yh, [["__scopeId", "data-v-2efcd248"]]), Ch = { class: "scale-add-reduce" }, bh = { class: "scale-lock" }, Mh = e({ __name: "CanvasScale", props: { scale: { type: Number, default: 100 }, minScale: { type: Number, default: 20 }, maxScale: { type: Number, default: 500 } }, emits: ["addScale", "reduceScale", "changeScale", "autoScale"], setup(e2, { emit: t2 }) {
  ...
  return (t3, o3) => (s(), r("div", { class: c(d(l2)) }, [p("div", Ch, [g(d(Be), { class: "scale-icon", title: "放大", size: 18, icon: "ant-design:plus-outlined", onClick: i2 }), g(d(Q), { size: "small", bordered: false, value: e2.scale, max: e2.maxScale, min: e2.minScale, step: 5, controls: false, formatter: (e3) => `${Math.round(100 * e3)}`, onChange: u2 }, null, 8, ["value", "max", "min", "formatter"]), o3[2] || (o3[2] = p("div", { class: "scale-sign" }, "%", -1)), g(d(Be), { class: "scale-icon", title: "缩小", size: 18, icon: "ant-design:minus-outlined", onClick: n2 })]), p("div", bh, [g(d(G), { title: a2.value ? "锁定自动比例" : "解锁自动比例", placement: "right" }, { default: M(() => [a2.value ? (s(), h(d(Be), { key: 0, icon: "ant-design:unlock-outlined", onClick: o3[0] || (o3[0] = (e3) => f2(false)) })) : (s(), h(d(Be), { key: 1, icon: "ant-design:lock-outlined", onClick: o3[1] || (o3[1] = (e3) => f2(true)) }))]), _: 1 }, 8, ["title"])])], 2));
} }), kh = e({ __name: "ShortcutViewModal", setup(e2) {
...
} }), wh = to(e({ __name: "CanvasOperator", setup(e2) {
  const { prefixCls: t2 } = xe("canvas-operator"), [o2, { openModal: a2 }] = kt();
  function l2() {
    a2(true, {});
  }
  return (e3, a3) => (s(), r(y, null, [p("div", { class: c(d(t2)) }, [g(d(G), { title: "快捷方式", placement: "right" }, { default: M(() => [g(d(Be), { icon: "carbon:table-shortcut", onClick: l2 })]), _: 1 })], 2), g(kh, { onRegister: d(o2) }, null, 8, ["onRegister"])], 64));
} }), [["__scopeId", "data-v-2148ffa6"]]), xh = { lt: function(e2, t2, o2, a2, l2, n2) {
...
}, t: Sh, rt: function(e2, t2, o2, a2, l2, n2) {
  const { symmetricPoint: i2 } = l2;
...
}, r: _h, rb: function(e2, t2, o2, a2, l2, n2) {
  const { symmetricPoint: i2 } = l2;
  ...
  c2 > 10 && d2 > 10 && (e2.width = Math.round(c2 / n2), e2.height = Math.round(d2 / n2), e2.x = Math.round(s2.x / n2), e2.y = Math.round(s2.y / n2));
}, b: Sh, lb: function(e2, t2, o2, a2, l2, n2) {
  const { symmetricPoint: i2 } = l2;
...
function Sh(e2, t2, o2, a2, l2, n2) {
  const { symmetricPoint: i2, curPoint: r2 } = l2, s2 = Zr(t2, r2, -e2.rotate), u2 = Zr({ x: r2.x, y: s2.y }, r2, e2.rotate), c2 = Math.hypot(u2.x - i2.x, u2.y - i2.y), d2 = u2.x - (u2.x - i2.x) / 2, p2 = u2.y + (i2.y - u2.y) / 2;
  let f2 = e2.width;
...
function _h(e2, t2, o2, a2, l2, n2) {
  const { symmetricPoint: i2, curPoint: r2 } = l2, s2 = Zr(t2, r2, -e2.rotate), u2 = Zr({ x: s2.x, y: r2.y }, r2, e2.rotate), c2 = Math.hypot(u2.x - i2.x, u2.y - i2.y), d2 = u2.x - (u2.x - i2.x) / 2, p2 = u2.y + (i2.y - u2.y) / 2;
  let f2 = e2.height;
...
const $h = ["onMousedown"], Lh = { key: 2, class: "cover-layer-out" }, Dh = { key: 0, class: "cover-hover" }, Ih = e({ name: "ChartContain", __name: "index", props: { comOption: { require: true, type: Object, default: () => ({ chart: {}, chartContain: {} }) }, index: { require: true, type: Number, default: 0 } }, setup(e2) {
  ...
  }), N2 = a(() => np({ ...l2.comOption.chartContain.dropInfo })), B2 = a(() => {
    const e3 = lp(l2.comOption);
  ...
  async function E2(e3) {
    if (D2.setShowMenu(false), e3.ctrlKey || e3.metaKey) return void xp(l2.comOption);
    ...
    const n3 = setInterval(() => {
      ...
      d(S2) ? L2.setUndoRedoData("组件移动") : L2.cleanSelectArea(), S2.value = false, clearInterval(n3), t2 && wp(L2.getSelectArea.components), Xd.emit(Qr.UN_MOVE), document.removeEventListener("mousemove", i2), document.removeEventListener("mouseup", r2), $2.value = F2(l2.comOption);
    };
    document.addEventListener("mousemove", i2), document.addEventListener("mouseup", r2);
  }
  function F2(e3) {
    if (!e3) return;
    const { pointCursor: t2, initAngle: o2, points: a2 } = x2, l3 = es(e3.chartContain.dropInfo.rotate), n3 = {};
    let i2 = -1;
    return a2.forEach((e4) => {
      const a3 = es(o2[e4] + l3), r2 = t2.length;
      for (; ; ) {
        i2 = (i2 + 1) % r2;
        const o3 = t2[i2];
  ...
  function U2(e3, t2) {
    ...
    let u2 = true;
    const c2 = function() {
      if (l2.comOption.chart.type !== ls.MfCombine) return false;
      for (const e4 of l2.comOption.chart.options.components) if (![0, 90, 180, 360].includes(es(e4.chartContain.dropInfo.rotate))) return true;
      return false;
    }(), p2 = He((t3) => {
      ...
      !function(e4, t4, o3, a3, l4, n4, i4) {
        xh[e4](t4, o3, a3, l4, n4, i4);
      }(e3, o2, l3, i3, c2, { center: a2, curPoint: r2, symmetricPoint: s2 }, L2.getScale), j2(o2), Xd.emit(Qr.MOVE, false);
    }, 2), f2 = () => {
      d(S2) && L2.setUndoRedoData("组件大小调整"), S2.value = false, Xd.emit(Qr.UN_MOVE), document.removeEventListener("mousemove", p2), document.removeEventListener("mouseup", f2);
    };
  ...
  return i(() => {
    l2.comOption && ($2.value = F2(l2.comOption)), Xd.on(Qr.MOVE, () => {
      l2.comOption && L2.getCurComponent && l2.comOption.chart.id !== L2.getCurComponent.chart.id && !d(_2) && (_2.value = true);
    }), Xd.on(Qr.UN_MOVE, () => {
      _2.value = false;
    }), Xd.on(Qr.PLAY_ANIMATION, () => {
      var _a2, _b;
      l2.comOption.chart.id === ((_a2 = L2.getCurComponent) == null ? void 0 : _a2.chart.id) && void 0 === ((_b = l2.comOption.chart.options) == null ? void 0 : _b.selectIndex) && Wd(M2.value, l2.comOption.chart.animations).then(() => {
        Xd.emit(Qr.PLAY_ANIMATION_COMPLETE);
      });
    }), Xd.on(Qr.EVENT_ANIMATION, (e3) => {
      M2.value && Yd(e3, l2.comOption, M2.value);
    }), Xd.on(Qr.STOP_ANIMATION, () => {
      var _a2;
  ...
  function l2(e3, { x: o3, y: a3, bottom: l3, right: n2, halfWidth: i2, halfHeight: r2 }) {
    ...
    return { y: [{ isNear: u2(e3.y, a3), isAdsorb: f2(e3.y, a3), lineNode: d2[Nh].node, line: Nh, dragShift: a3, lineShift: a3 }, { isNear: u2(e3.bottom, a3), isAdsorb: f2(e3.bottom, a3), lineNode: d2[Nh].node, line: Nh, dragShift: a3 - e3.height, lineShift: a3 }, { isNear: u2(e3.y + c2, a3 + r2), isAdsorb: f2(e3.y + c2, a3 + r2), lineNode: d2[Bh].node, line: Bh, dragShift: a3 + r2 - c2, lineShift: a3 + r2 }, { isNear: u2(e3.y, l3), isAdsorb: f2(e3.y, l3), lineNode: d2[Rh].node, line: Rh, dragShift: l3, lineShift: l3 }, { isNear: u2(e3.bottom, l3), isAdsorb: f2(e3.bottom, l3), lineNode: d2[Rh].node, line: Rh, dragShift: l3 - e3.height, lineShift: l3 }], x: [{ isNear: u2(e3.x, o3), isAdsorb: f2(e3.x, o3), lineNode: d2[qh].node, line: qh, dragShift: o3, lineShift: o3 }, { isNear: u2(e3.right, o3), isAdsorb: f2(e3.right, o3), lineNode: d2[qh].node, line: qh, dragShift: o3 - e3.width, lineShift: o3 }, { isNear: u2(e3.x + s2, o3 + i2), isAdsorb: f2(e3.x + s2, o3 + i2), lineNode: d2[Ah].node, line: Ah, dragShift: o3 + i2 - s2, lineShift: o3 + i2 }, { isNear: u2(e3.x, n2), isAdsorb: f2(e3.x, n2), lineNode: d2[Oh].node, line: Oh, dragShift: n2, lineShift: n2 }, { isNear: u2(e3.right, n2), isAdsorb: f2(e3.right, n2), lineNode: d2[Oh].node, line: Oh, dragShift: n2 - e3.width, lineShift: n2 }] };
  }
  function u2(e3, o3) {
    ...
    Xd.on(Qr.MOVE, (e3) => {
      !async function(e4) {
        ...
        e4 ? o2.getSelectArea.components.forEach((e5) => {
          a3.push({ com: e5, style: ip(e5.chartContain.dropInfo) });
        }) : a3.push({ com: o2.getCurComponent, style: ip(o2.getCurComponent.chartContain.dropInfo) });
        g2().then(), a3.forEach((a4) => {
          !function(e5, a5) {
            ...
            n2(l2(e5.style, { x: o2.getCanvasConfig.width / 2, y: o2.getCanvasConfig.height / 2, bottom: 0, right: 0, halfWidth: 0, halfHeight: 0 })), n2(l2(e5.style, { x: 0, y: 0, bottom: o2.getCanvasConfig.height, right: o2.getCanvasConfig.width, halfWidth: 0, halfHeight: 0 })), o2.getGuideLine.lineListX.forEach((t3) => {
              ...
              const i2 = ip(t3.chartContain.dropInfo), { x: r2, y: s2, bottom: u3, right: c2 } = i2, d2 = i2.width / 2, p2 = i2.height / 2;
  ...
  }), (e3, o3) => (s(), r("div", { class: c(d(a2)) }, [(s(true), r(y, null, v(Object.keys(t2.lineStatus), (e4) => O((s(), r("div", { key: e4, ref_for: true, ref: (o4) => t2.lineStatus[e4].node = o4, class: c(["line", e4.includes("横") ? "xLine" : "yLine"]) }, [p("div", jh, S(t2.lineStatus[e4].pos), 1)], 2)), [[z, t2.lineStatus[e4].show || false]])), 128))], 2));
} }), Eh = to(zh, [["__scopeId", "data-v-88d9d34f"]]), Fh = e({ name: "ChartMultiSelect", __name: "index", props: { selectArea: { type: Object, default: () => {
} } }, setup(e2) {
...
} }), Ph = to(Fh, [["__scopeId", "data-v-e9844525"]]), Hh = e({ name: "ScreenCanvas", __name: "index", setup(e2) {
  const { prefixCls: t2 } = xe("screen-canvas"), l2 = Ar(), p2 = vp(), m2 = o("screenCanvasRef"), { getAntdLocale: C2 } = Tt(), { antTheme: b2 } = Le(a(() => l2.getTheme)), w2 = a(() => [...l2.getComponentList].reverse()), x2 = n({ canvasX: 0, canvasY: 0, area: { show: false, x: 0, y: 0, width: 0, height: 0 }, comMoving: false, isUp: false }), S2 = a(() => ({ ...Jd(l2.getCanvasConfig), transform: `scale(${l2.getScale})` })), _2 = (e3) => {
    var _a2, _b;
    if (((_b = (_a2 = e3.chart) == null ? void 0 : _a2.events) == null ? void 0 : _b.emits) && e3.chart.events.emits.length > 0) {
      for (const t3 of e3.chart.events.emits) if (t3 === rs.CHART_CLICK || t3 === rs.CHART_DBLCLICK) return "allow-pointer";
    }
  ...
  i(() => {
    l2.setScreenCanvas(m2.value ?? null), Xd.on(Qr.MOVE, () => {
      x2.comMoving || (x2.comMoving = true);
    }), Xd.on(Qr.UN_MOVE, () => {
      x2.comMoving = false;
    }), Xd.on(Qr.CREATE_CHART, (e3) => {
      L2(e3, 0, 0);
    });
  });
  const $2 = (e3) => {
    ...
    const t3 = (_a2 = e3.dataTransfer) == null ? void 0 : _a2.getData(jr);
  ...
  return (e3, o2) => (s(), r("div", { ref_key: "screenCanvasRef", ref: m2, class: c(d(t2)), onDrop: $2, onDragstart: o2[0] || (o2[0] = k(() => {
    ...
    var _a2;
    return s(), h(Th, { key: ((_a2 = e4.chart) == null ? void 0 : _a2.id) + d(l2).getKey, index: w2.value.length - t3 - 1, "com-option": e4, class: c(_2(e4)) }, { default: M(() => {
      var _a3;
      return [(s(), h(j(e4.chart.type && d(Kd)[e4.chart.type].component), { class: c(["component", { move: x2.comMoving && e4.chart.id !== ((_a3 = d(l2).getCurComponent) == null ? void 0 : _a3.chart.id) }]), id: `com${e4.chart.id}`, chart: e4.chart, "chart-contain": e4.chartContain }, null, 8, ["class", "id", "chart", "chart-contain"]))];
    }), _: 2 }, 1032, ["index", "com-option", "class"]);
  }), 128))]), _: 1 }, 8, ["locale", "theme"]), g(Ph, { "select-area": x2.area }, null, 8, ["select-area"]), g(Eh)], 38));
} }), Qh = to(Hh, [["__scopeId", "data-v-9395352a"]]), Gh = 0.2, Uh = e({ name: "FrameCanvas", __name: "index", props: { width: { type: Number, default: 5e3 }, height: { type: Number, default: 3e3 } }, setup(e2) {
  const t2 = m(true), { prefixCls: a2 } = xe("frame-canvas"), n2 = m(0), u2 = m(0), f2 = m(1e3), h2 = m(1), y2 = Ar(), v2 = o("frameCanvasRef"), C2 = o("dropContentRef");
  let b2 = [0, 0], w2 = [0, 0];
  ...
  const x2 = He(() => {
    t2.value && (!function() {
      if (d(t2) && v2.value) {
        ...
        h2.value = l2 > a3 ? Number.parseFloat((o2 * a3 / y2.getCanvasConfig.width).toFixed(2)) : Number.parseFloat((t3 / a3 / y2.getCanvasConfig.height).toFixed(2)), d(h2) > 5 && (h2.value = 5), d(h2) < Gh && (h2.value = Gh);
      }
      y2.setScale(d(h2));
    }(), I2());
  }, 30);
  ...
  const $2 = He((e3) => {
    ...
    h2.value = "add" === e3 ? Math.min(5, Number.parseFloat((t3 + 0.05).toFixed(2))) : Math.max(Gh, Number.parseFloat((t3 - 0.05).toFixed(2))), I2(), y2.setScale(h2.value);
  }, 100), L2 = He((e3) => {
  ...
  return (o2, l2) => (s(), r("div", { class: c(d(a2)), ref_key: "frameCanvasRef", ref: v2 }, [g(mh, { "ruler-x-left": n2.value, "ruler-y-top": u2.value, drift: f2.value, "ruler-x": e2.width, "ruler-y": e2.height }, null, 8, ["ruler-x-left", "ruler-y-top", "drift", "ruler-x", "ruler-y"]), p("div", { ref_key: "dropContentRef", ref: C2, class: "drop-content", onScroll: S2 }, [g(vh, { width: e2.width, height: e2.height, drift: f2.value }, { default: M(() => [g(Qh, { draggable: "true", onDragstart: k(T2, ["prevent", "stop"]) })]), _: 1 }, 8, ["width", "height", "drift"])], 544), g(wh), g(Mh, { scale: h2.value, "min-scale": 20, "max-scale": 500, onAddScale: l2[0] || (l2[0] = (e3) => d($2)("add")), onReduceScale: l2[1] || (l2[1] = (e3) => d($2)("reduce")), onChangeScale: d(L2), onAutoScale: l2[2] || (l2[2] = (e3) => t2.value = e3) }, null, 8, ["scale", "min-scale", "max-scale", "onChangeScale"])], 2));
} }), Vh = to(Uh, [["__scopeId", "data-v-de9ae999"]]), Wh = { key: 0, class: "header" }, Yh = { class: "title" }, Zh = { class: "content" }, Kh = to(e({ name: "FrameBox", __name: "index", props: { showHeader: { type: Boolean, default: true }, icon: { type: String, default: "" }, iconSize: { type: Number, default: 14 }, title: { type: String, default: "" }, radioData: { type: Array, default: () => [] }, span: { type: Number, default: 8 }, chart: { type: Object } }, emits: ["radioChange", "titleClick"], setup(e2, { emit: t2 }) {
  ...
  return (t3, a3) => (s(), r("div", { class: c(d(l2)) }, [e2.showHeader ? (s(), r("div", Wh, [p("div", { class: "icon-title", onClick: C2 }, [e2.icon ? (s(), h(d(Be), { key: 0, class: "title", icon: e2.icon, size: e2.iconSize }, null, 8, ["icon", "size"])) : f("", true), p("div", Yh, S(e2.title), 1)]), g(d(Z), { class: "radio-group", size: "small", value: n2.value, "onUpdate:value": a3[0] || (a3[0] = (e3) => n2.value = e3), onChange: u2 }, { default: M(() => [(s(true), r(y, null, v(o2.radioData, (e3) => (s(), h(d(G), { key: e3.value, title: e3.tooltip }, { default: M(() => [g(d(Y), { class: "radio-button", value: e3.value }, { default: M(() => [g(d(Be), { icon: e3.icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["value"])]), _: 2 }, 1032, ["title"]))), 128))]), _: 1 }, 8, ["value"])])) : f("", true), p("div", Zh, [(s(), h(j(e2.chart))), R(t3.$slots, "default", {}, void 0, true)])], 2));
} }), [["__scopeId", "data-v-8929fb33"]]), Xh = { class: "item-content" }, Jh = ["src"], eg = { class: "title", style: { flex: "1" } }, tg = { class: "iconContain" }, og = e({ __name: "LayerItem", props: { parentItem: { type: Object }, item: { type: Object, required: true }, showEye: { type: Boolean, default: true }, showLock: { type: Boolean, default: true }, index: { type: Number }, expand: { type: Boolean, default: false }, externalSelect: { type: Boolean, default: false }, isSelect: { type: Boolean, default: false } }, emits: ["expand", "select", "enter", "leave"], setup(e2, { emit: o2 }) {
  t((e3) => ({ "56d1bd00": C2.value }));
  const l2 = e2, n2 = o2, { prefixCls: i2 } = xe("layer-item"), u2 = Ar(), g2 = Or(), y2 = a(() => u2.getChartImg(l2.item.chart.type)), { token: v2 } = P.useToken(), C2 = a(() => v2.value.colorInfoBg), b2 = Se().getThemeColor, M2 = a(() => {
  ...
  return (t2, o3) => {
    var _a2;
    return s(), r("div", { class: c(M2.value), onMouseenter: w2, onMouseleave: x2, onMousedown: $2 }, [p("div", Xh, [e2.item.chart.type === d(ls).MfCombine ? (s(), r("div", { key: 0, onClick: _2 }, [l2.expand ? (s(), h(d(mt), { key: 0, class: "group", "two-tone-color": d(b2) }, null, 8, ["two-tone-color"])) : (s(), h(d(yt), { key: 1, class: "group", "two-tone-color": d(b2) }, null, 8, ["two-tone-color"]))])) : (s(), r("img", { key: 1, class: "img", alt: "组件", src: y2.value }, null, 8, Jh)), p("span", eg, S((_a2 = e2.item) == null ? void 0 : _a2.chart.name), 1), p("div", tg, [!e2.showEye || d(g2).getLayerCollapsed || !k2.value && e2.item.chartContain.show ? f("", true) : (s(), h(d(Be), { key: 0, class: "icon", icon: e2.item.chartContain.show ? "ant-design:eye-outlined" : "ant-design:eye-invisible-outlined", onClick: o3[0] || (o3[0] = () => e2.item.chartContain.show = !e2.item.chartContain.show) }, null, 8, ["icon"])), e2.showLock && !d(g2).getLayerCollapsed && (k2.value || e2.item.chartContain.lock) ? (s(), h(d(Be), { key: 1, class: "icon", icon: e2.item.chartContain.lock ? "ant-design:lock-outlined" : "ant-design:unlock-outlined", onClick: o3[1] || (o3[1] = () => e2.item.chartContain.lock = !e2.item.chartContain.lock) }, null, 8, ["icon"])) : f("", true)])])], 34);
  };
} }), ag = to(og, [["__scopeId", "data-v-925f45da"]]), lg = e({ __name: "LayerGroup", props: { item: { type: Object, required: true }, expand: { type: Boolean, default: false }, showEye: { type: Boolean, default: true }, showLock: { type: Boolean, default: true }, showChildEye: { type: Boolean, default: true }, showChildLock: { type: Boolean, default: true }, externalSelect: { type: Boolean, default: false }, isSelect: { type: Boolean, default: false }, childSelect: { type: String, default: "" } }, emits: ["parentClick", "childClick"], setup(e2, { emit: t2 }) {
  const o2 = e2, n2 = t2, { prefixCls: i2 } = xe("layer-group"), u2 = Ar(), p2 = Or(), f2 = a(() => ({ "child-item": true, collapsed: p2.getLayerCollapsed })), C2 = m(o2.expand);
  function b2() {
    var _a2;
  ...
  return l(() => o2.expand, (e3) => C2.value = e3), (t3, o3) => (s(), r("div", { class: c(d(i2)), onMouseenter: b2, onMouseleave: k2 }, [g(ag, { item: e2.item, onExpand: x2, expand: C2.value, "show-eye": e2.showEye, "show-lock": e2.showLock, "external-select": e2.externalSelect, "is-select": e2.isSelect, onClick: S2 }, null, 8, ["item", "expand", "show-eye", "show-lock", "external-select", "is-select"]), g(d(Rt), { show: C2.value, class: c(f2.value) }, { default: M(() => [(s(true), r(y, null, v(e2.item.chart.options.components, (t4, o4) => (s(), h(ag, { key: t4.chart.id, "parent-item": e2.item, item: t4, index: o4, "external-select": e2.externalSelect, "is-select": e2.childSelect === t4.chart.id, "show-eye": e2.showChildEye, "show-lock": e2.showChildLock, onSelect: (t5) => function(e3, t6) {
...
} }), ng = to(lg, [["__scopeId", "data-v-b118e01c"]]), ig = ["onDrop"], rg = e({ name: "FrameLayer", __name: "index", props: { collapsed: Nt.bool.def(false) }, setup(e2) {
  ...
  i(() => {
    ...
    Yi({ types: e3, pageNum: 1, pageSize: 1e4 }).then((e4) => {
      ...
      e4 && ((_a2 = e4.list) == null ? void 0 : _a2.length) > 0 && e4.list.forEach((e5) => {
        f2.hasChartImg(e5.type) || pt(dt(e5 == null ? void 0 : e5.picKey), { errorMessageMode: "none" }).then((t3) => {
  ...
  function b2(e3, t3) {
    var _a2;
    e3.stopPropagation();
    const o3 = (_a2 = e3.dataTransfer) == null ? void 0 : _a2.getData(jr);
    if (o3) {
  ...
  function k2(e3, t3, o3) {
    !o3.ctrlKey && !o3.metaKey || 0 !== o3.button ? 0 === o3.button && (f2.cleanSelectArea(), f2.setCurComponent(e3, t3)) : xp(e3);
  }
  function w2() {
  ...
  return (e3, t3) => (s(), h(Kh, { class: c(l2.value), title: d(y2).getLayerCollapsed ? "" : "图层", icon: "iconfont:icon-mfish-layer", "icon-size": d(y2).getLayerCollapsed ? 16 : 12, "radio-data": n2, onTitleClick: C2, onDrop: t3[1] || (t3[1] = (e4) => b2(e4, r2.value.length)), onRadioChange: x2 }, { default: M(() => [0 === r2.value.length ? (s(), h(d(ke), { key: 0, "image-style": d(y2).getLayerCollapsed ? { height: "20px" } : {}, description: "暂无图层", image: d(ot) }, null, 8, ["image-style", "image"])) : (s(), h(d(vt), { key: 1 }, { default: M(() => [g(d(qt), { "item-key": "id", modelValue: r2.value, "onUpdate:modelValue": t3[0] || (t3[0] = (e4) => r2.value = e4), animation: "300", "ghost-class": "ghost", onChange: v2 }, { item: M(({ index: e4, element: t4 }) => [p("div", { onDrop: (t5) => b2(t5, e4), style: { "margin-top": "4px" } }, [t4.chart.type !== d(ls).MfCombine ? (s(), h(ag, { key: 0, item: t4, onMousedown: (o3) => k2(t4, e4, o3), onEnter: (e5) => {
    return o3 = t4, void f2.setCurHoverComponent(o3 == null ? void 0 : o3.chart.id);
    var o3;
  }, onLeave: w2 }, null, 8, ["item", "onMousedown", "onEnter"])) : (s(), h(ng, { key: 1, item: t4, expand: u2.value, "show-child-lock": false, onMousedown: (o3) => k2(t4, e4, o3) }, null, 8, ["item", "expand", "onMousedown"]))], 40, ig)]), _: 1 }, 8, ["modelValue"])]), _: 1 }))]), _: 1 }, 8, ["class", "title", "icon-size"]));
} }), sg = to(rg, [["__scopeId", "data-v-3b66e5f3"]]), ug = { class: "menu-item-hide-title" }, cg = { class: "title" }, dg = to(e({ __name: "ChartMenus", props: { itemHeight: { type: Number }, width: { type: Number, default: 68 }, collapsed: { type: Boolean, default: false }, horizontal: { type: Boolean, default: false }, hideTitle: { type: Boolean, default: false }, backgroundColor: { type: Object, default: () => ({ light: "transparent", dark: "transparent" }) }, menus: { type: Array, default: () => [] } }, emits: ["menuClick", "menuChange"], setup(e2, { emit: o2 }) {
  ...
  return (t2, o3) => (s(), r("div", { class: c(d(f2)) }, [g(d(te), { class: c({ collapsed: e2.collapsed }), "selected-keys": C2.value, "onUpdate:selectedKeys": o3[0] || (o3[0] = (e3) => C2.value = e3), onClick: _2 }, { default: M(() => [g(d(vt), null, { default: M(() => [(s(true), r(y, null, v(e2.menus, (t3) => (s(), h(d(we), { id: t3.name, key: t3.value, style: u({ height: `${e2.itemHeight}px` }) }, { default: M(() => [e2.hideTitle ? (s(), h(d(G), { key: 0, title: t3.name, placement: "right" }, { default: M(() => [p("div", ug, [g(d(Be), { style: u({ lineHeight: `${e2.itemHeight}px` }), icon: t3.icon }, null, 8, ["style", "icon"])])]), _: 2 }, 1032, ["title"])) : (s(), r("div", { key: 1, class: c(e2.horizontal ? "menu-item-horizontal" : "menu-item-vertical") }, [g(d(Be), { icon: t3.icon }, null, 8, ["icon"]), p("div", cg, S(t3.name), 1)], 2))]), _: 2 }, 1032, ["id", "style"]))), 128))]), _: 1 })]), _: 1 }, 8, ["class", "selected-keys"])], 2));
} }), [["__scopeId", "data-v-dea86191"]]), pg = ["onDragstart", "onDblclick"], fg = { class: "box-header" }, hg = { class: "box-header-text" }, gg = { class: "box-content" }, mg = ["src"], yg = e({ __name: "ChartItems", props: { charts: { type: Array, default: () => [] }, mode: { type: String, default: "single" } }, setup(e2) {
  const t2 = e2, { prefixCls: o2 } = xe("chart-items"), a2 = Ar();
  return l(() => t2.charts, (e3) => {
    e3.forEach((e4) => {
      const t3 = e4 == null ? void 0 : e4.type;
      t3 && (e4 == null ? void 0 : e4.picKey) && !a2.hasChartImg(t3) && pt(dt(e4 == null ? void 0 : e4.picKey), { errorMessageMode: "none" }).then((e5) => {
        a2.setChartImg(t3, e5);
      });
    });
  }, { immediate: true }), (t3, l2) => (s(), h(d(vt), { class: c(d(o2)) }, { default: M(() => [p("div", { class: c(["items", "single" === e2.mode ? e2.mode : [e2.mode, "miniAnimation"]]) }, [(s(true), r(y, null, v(e2.charts, (t4) => {
    return s(), r("div", { draggable: "true", key: t4.type, class: "item-box", onDragstart: (e3) => function(e4, t5) {
      var _a2, _b, _c2;
      const o4 = ap(t5);
      if (!o4) return;
      const a3 = e4.currentTarget;
      "img" === e4.target.className ? (_a2 = e4.dataTransfer) == null ? void 0 : _a2.setDragImage(a3, e4.offsetX + 15, e4.offsetY + 32) : (_b = e4.dataTransfer) == null ? void 0 : _b.setDragImage(a3, e4.offsetX, e4.offsetY), (_c2 = e4.dataTransfer) == null ? void 0 : _c2.setData(jr, JSON.stringify(o4));
    }(e3, t4), onDblclick: (e3) => function(e4) {
      const t5 = ap(e4);
      t5 && Xd.emit(Qr.CREATE_CHART, t5);
    }(t4) }, [p("div", fg, [g(d(Rn), { disabled: true, size: "single" === e2.mode ? "small" : "mini" }, null, 8, ["size"]), p("span", hg, S(t4.name), 1)]), p("div", gg, [p("img", { class: "img", alt: "组件图片", src: (o3 = t4.type, a2.getChartImg(o3)) }, null, 8, mg)])], 40, pg);
    var o3;
  }), 128))], 2)]), _: 1 }, 8, ["class"]));
} }), vg = to(yg, [["__scopeId", "data-v-74651cba"]]), Cg = e({ name: "FrameChart", __name: "index", props: { collapsed: Nt.bool.def(false) }, setup(e2) {
  const t2 = e2, o2 = Or(), l2 = m(), n2 = m(), r2 = m(""), u2 = m(/* @__PURE__ */ new Map()), f2 = a(() => n2.value && n2.value.length > 0 ? n2.value.map((e3) => ({ name: e3.categoryName, icon: e3.icon, value: e3.id, children: e3.children })) : []), y2 = a(() => {
    var _a2;
    if (l2.value) {
  ...
  return (t3, o3) => (s(), h(Kh, { title: "组件", icon: "iconfont:icon-mfish-chart", "icon-size": 12, "radio-data": b2, onRadioChange: w2, class: c(k2.value), onTitleClick: S2 }, { default: M(() => [p("div", { class: c(`${d(v2)}-content`) }, [g(dg, { menus: f2.value, "item-height": 58, "background-color": { light: "#f0f2f5", dark: "#232324" }, onMenuClick: x2, onMenuChange: _2 }, null, 8, ["menus"]), p("div", { class: c(["charts", { collapsed: e2.collapsed }]) }, [g(dg, { menus: y2.value, collapsed: e2.collapsed, "hide-title": true, "background-color": { light: "#f8f8f9", dark: "#1e1e1f" }, horizontal: true, "item-height": 28, width: 40, onMenuChange: $2 }, null, 8, ["menus", "collapsed"]), g(vg, { mode: C2.value, charts: u2.value.get(r2.value) }, null, 8, ["mode", "charts"])], 2)], 2)]), _: 1 }, 8, ["class"]));
} }), bg = to(Cg, [["__scopeId", "data-v-3b8e6093"]]), Mg = ["onClick"], kg = { class: "name" }, wg = { class: "short-cut" }, xg = e({ __name: "SubMenu", props: { subData: { type: Array, default: () => [] } }, setup(e2, { expose: t2 }) {
  const { prefixCls: a2 } = xe("frame-shortcut"), l2 = m(false), n2 = m(0), i2 = o("subMenuRef"), C2 = Se().getThemeColor;
  return t2({ show: function(e3) {
    l2.value = true;
  }, hidden: function() {
    l2.value = false;
  } }), (t3, o2) => (s(), h(F, { name: "shortcut" }, { default: M(() => [O(p("div", { ref_key: "subMenuRef", ref: i2, class: c(d(a2)), style: u({ top: `${n2.value}px`, left: "160px" }) }, [(s(true), r(y, null, v(e2.subData, (e3) => (s(), r(y, { key: e3.name }, [p("div", { class: "menu-item", onClick: e3.action }, [g(d(Be), { icon: e3.icon, color: d(C2) }, null, 8, ["icon", "color"]), p("span", kg, S(e3.name), 1), p("span", wg, S(e3.shortcut), 1)], 8, Mg), e3.divider ? (s(), r("div", { key: 0, class: c(`${d(a2)}__divider`) }, null, 2)) : f("", true)], 64))), 128))], 6), [[z, l2.value]])]), _: 1 }));
} }), Sg = to(xg, [["__scopeId", "data-v-f4307b07"]]), _g = { class: "short-cut" }, $g = { class: "short-cut" }, Lg = { class: "short-cut" }, Dg = ["onClick"], Ig = { class: "name" }, Tg = { class: "short-cut" }, Ng = e({ name: "FrameShortcut", __name: "index", props: { menuTop: { type: Number, default: 0 }, menuLeft: { type: Number, default: 0 }, isUp: { type: Boolean, default: false } }, setup(e2, { expose: t2 }) {
  const l2 = e2, i2 = a(() => ({ top: `${l2.menuTop}px`, left: `${l2.menuLeft}px` })), m2 = Se().getThemeColor, { prefixCls: b2 } = xe("frame-shortcut"), w2 = vp(), x2 = Ar(), _2 = o("frameShortcutRef"), $2 = o("canvasAlignMenuRef"), L2 = o("selectAlignMenuRef"), D2 = o("fitMenuRef"), { NoneShortcutKeyEnum: I2 } = $p(x2, w2);
  ...
  const T2 = a(() => x2.getSelectArea.components.length > 1), N2 = n([{ icon: "iconfont:icon-mfish-copy", name: "复制", shortcut: "CTRL+C", action: w2.copyComponent, show: a(() => x2.getCurComponent || x2.getSelectArea.components.length > 0) }, { icon: "iconfont:icon-mfish-paste", name: "粘贴", shortcut: "CTRL+V", action: w2.pasteComponent, show: a(() => w2.getCopyData), divider: true }, { icon: "iconfont:icon-mfish-up-level", name: "上移一层", shortcut: "SHIFT+↑", action: w2.upComponent, show: a(() => x2.getCurComponent && !d(T2)) }, { icon: "iconfont:icon-mfish-down-level", name: "下移一层", shortcut: "SHIFT+↓", action: w2.downComponent, show: a(() => x2.getCurComponent && !d(T2)) }, { icon: "iconfont:icon-mfish-up-level", name: "置顶", shortcut: "CTRL+SHIFT+↑", action: w2.topComponent, show: a(() => x2.getCurComponent && !d(T2)) }, { icon: "iconfont:icon-mfish-bottom-level", name: "置底", shortcut: "CTRL+SHIFT+↓", action: w2.bottomComponent, show: a(() => x2.getCurComponent && !d(T2)), divider: true }, { icon: "iconfont:icon-mfish-combine", name: "组合", shortcut: "CTRL+G", action: w2.composeComponent, show: a(() => x2.getSelectArea.components.length > 1) }, { icon: "iconfont:icon-mfish-un-combine", name: "拆分", shortcut: "CTRL+SHIFT+G", action: w2.decomposeComponent, show: a(() => {
    var _a2;
    return ((_a2 = x2.getCurComponent) == null ? void 0 : _a2.chart.type) === ls.MfCombine && !d(T2);
  ...
  function q2() {
    var _a2;
    z2(Sp.CANVAS), (_a2 = $2.value) == null ? void 0 : _a2.show(l2.isUp);
  }
  function A2() {
    var _a2;
  ...
  function O2() {
    var _a2;
    z2(Sp.GROUP), (_a2 = L2.value) == null ? void 0 : _a2.show(l2.isUp);
  }
  function j2() {
    var _a2;
  ...
  function z2(e3) {
    w2.setAlignType(e3), 0 === x2.getSelectArea.components.length && x2.getCurComponent && w2.setAlignType(Sp.CANVAS);
  }
  function E2() {
    var _a2;
  ...
  }, ["stop"])) }, [g(d(Be), { icon: "iconfont:icon-mfish-left-align", color: d(m2) }, null, 8, ["color"]), t3[4] || (t3[4] = p("span", { class: "name" }, "画布对齐", -1)), p("span", _g, [g(d(Be), { icon: "ant-design:right-outlined" })]), g(Sg, { ref_key: "canvasAlignMenuRef", ref: $2, "sub-data": B2 }, null, 8, ["sub-data"])], 32)) : f("", true), d(x2).getSelectArea.components.length > 1 ? (s(), r("div", { key: 1, class: "menu-item", onMouseenter: O2, onMouseleave: j2, onMouseup: t3[1] || (t3[1] = k(() => {
  }, ["stop"])) }, [g(d(Be), { icon: "iconfont:icon-mfish-left-align", color: d(m2) }, null, 8, ["color"]), t3[5] || (t3[5] = p("span", { class: "name" }, "选中对齐", -1)), p("span", $g, [g(d(Be), { icon: "ant-design:right-outlined" })]), g(Sg, { ref_key: "selectAlignMenuRef", ref: L2, "sub-data": B2 }, null, 8, ["sub-data"])], 32)) : f("", true), d(x2).getCurComponent ? (s(), r("div", { key: 2, class: "menu-item", onMouseenter: E2, onMouseleave: P2, onMouseup: t3[2] || (t3[2] = k(() => {
  }, ["stop"])) }, [g(d(Be), { icon: "carbon:fit-to-screen", color: d(m2) }, null, 8, ["color"]), t3[6] || (t3[6] = p("span", { class: "name" }, "撑满", -1)), p("span", Lg, [g(d(Be), { icon: "ant-design:right-outlined" })]), g(Sg, { ref_key: "fitMenuRef", ref: D2, "sub-data": R2 }, null, 8, ["sub-data"])], 32)) : f("", true), d(x2).getCurComponent || d(x2).getSelectArea.components.length > 1 ? (s(), r("div", { key: 3, class: c(`${d(b2)}__divider`) }, null, 2)) : f("", true), (s(true), r(y, null, v(N2, (e4) => (s(), r(y, { key: e4.name }, [e4.show ? (s(), r("div", { key: 0, class: "menu-item", onClick: (t4) => {
    return o2 = e4.action, w2.setShowMenu(false), void C(() => {
      o2();
    });
    var o2;
  } }, [g(d(Be), { icon: e4.icon, color: d(m2) }, null, 8, ["icon", "color"]), p("span", Ig, S(e4.name), 1), p("span", Tg, S(e4.shortcut), 1)], 8, Dg)) : f("", true), e4.show && e4.divider ? (s(), r("div", { key: 1, class: c(`${d(b2)}__divider`) }, null, 2)) : f("", true)], 64))), 128))], 38)) : f("", true)]), _: 1 }));
} }), Bg = to(Ng, [["__scopeId", "data-v-2dcb7415"]]);
export {
  fa as $,
  Ka as A,
  Xo as B,
