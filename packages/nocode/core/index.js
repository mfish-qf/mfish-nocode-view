...
import { cloneDeep as qe, debounce as Ae, once as Oe, isElement as je, merge as ze, uniqueId as Ee, sum as Pe, random as Fe, throttle as He, omit as Qe } from "lodash-es";
...
import { Button as at } from "@mfish/core/components/Button";
...
import { DeleteOutlined as pt, CaretRightOutlined as ft, CheckOutlined as ht, FolderOpenTwoTone as gt, FolderTwoTone as yt } from "@ant-design/icons-vue";
import { ScrollContainer as mt } from "@mfish/core/components/Container";
import { DraggableInput as vt } from "@mfish/core/components/Draggable";
import { BasicModal as Ct, useModalInner as bt, useModal as kt } from "@mfish/core/components/Modal";
import { BasicForm as Mt, useForm as wt } from "@mfish/core/components/Form";
...
import { CodeEditor as Lt, MODE as It } from "@mfish/core/components/CodeEditor";
import { useLocale as Dt } from "@mfish/core/i18n/UseLocale";
...
class Kt {
  ...
  fromString(e2) {
    ...
    if (e2.includes("hsl")) {
      ...
      if (4 === o2.length ? this._alpha = 100 * Number.parseFloat(o2[3].toString()) : 3 === o2.length && (this._alpha = 100), o2.length >= 3) {
        const { h: e3, s: l2, v: n2 } = Yt(o2[0], o2[1], o2[2]);
        t2(e3, l2, n2);
      }
    } else if (e2.includes("#")) {
      ...
      let l2, n2, a2;
      3 === o2.length ? (l2 = Wt(o2[0] + o2[0]), n2 = Wt(o2[1] + o2[1]), a2 = Wt(o2[2] + o2[2])) : 6 !== o2.length && 8 !== o2.length || (l2 = Wt(o2.slice(0, 2)), n2 = Wt(o2.slice(2, 4)), a2 = Wt(o2.slice(4, 6))), 8 === o2.length ? this._alpha = Wt(o2.slice(6)) / 255 * 100 : 3 !== o2.length && 6 !== o2.length || (this._alpha = 100);
      const { h: i2, s: r2, v: s2 } = Yt(l2, n2, a2);
      t2(i2, r2, s2);
    }
  }
  compare(e2) {
  ...
  doOnChange() {
    ...
    if (this.enableAlpha) switch (n2) {
      ...
      case "hsv":
        ...
        break;
      case "hex":
        this.value = `${Ut(Zt(e2, t2, o2))}${Gt(255 * l2 / 100)}`;
        break;
      default: {
...
function Jt(e2, t2) {
  const o2 = function(e3) {
    ...
    var _a2;
    document.removeEventListener("mousemove", o2), document.removeEventListener("mouseup", l2), document.removeEventListener("touchmove", o2), document.removeEventListener("touchend", l2), document.onselectstart = null, document.ondragstart = null, Xt = false, (_a2 = t2.end) == null ? void 0 : _a2.call(t2, e3);
  }, n2 = function(e3) {
    var _a2;
    Xt || (e3.preventDefault(), document.onselectstart = () => false, document.ondragstart = () => false, document.addEventListener("mousemove", o2), document.addEventListener("mouseup", l2), document.addEventListener("touchmove", o2), document.addEventListener("touchend", l2), Xt = true, (_a2 = t2.start) == null ? void 0 : _a2.call(t2, e3));
  };
...
const eo = (e2, t2) => {
  ...
  const y2 = e2, m2 = t2, v2 = a({ left: 0, top: 0, hue: 0 }), C2 = o("barRef"), b2 = o("thumbRef"), k2 = o("colorHueSliderRef"), { prefixCls: M2 } = xe("hue-slider"), { isSupported: w2, open: x2, sRGBHex: S2 } = Ie(), _2 = l(() => y2.color.get("hue"));
  function $2() {
  ...
  return i(() => {
    ...
    D2();
  }), (e3, t3) => (s(), r("div", { class: c(d(M2)) }, [d(w2) ? (s(), h(d(Be), { key: 0, class: "icon", icon: "ion:eyedrop-outline", onClick: $2 })) : f("", true), p("div", { class: "bar-contain", ref_key: "colorHueSliderRef", ref: k2 }, [p("div", { class: "bar", onClick: L2, ref_key: "barRef", ref: C2 }, null, 512), p("div", { class: "thumb", ref_key: "thumbRef", ref: b2, style: u({ left: `${v2.left}px`, top: `${v2.top}px` }) }, [g(d(Be), { class: "thumb__icon", icon: "ant-design:caret-up-outlined" })], 4)], 512)], 2));
} }), [["__scopeId", "data-v-b2d0e443"]]), lo = { class: "background" }, no = { class: "color-text" }, ao = { class: "color-input" }, io = { class: "color-input-percentage" }, ro = { class: "color-input-percentage" }, so = { class: "color-input-percentage" }, uo = { class: "color-input-percentage a" }, co = eo(e({ __name: "ColorText", props: { color: { type: Object, required: true } }, setup(e2) {
  t((e3) => ({ "09aca737": v2.value }));
  const o2 = e2, i2 = y(""), f2 = a({ r: 0, g: 0, b: 0, a: 100 }), { prefixCls: h2 } = xe("color-text"), { token: m2 } = F.useToken(), v2 = l(() => m2.value.colorBorder), C2 = l(() => `rgba(${f2.r}, ${f2.g}, ${f2.b}, ${f2.a / 100})`);
  function b2() {
  ...
  }), (e3, t2) => (s(), r("div", { class: c(d(h2)) }, [p("div", lo, [p("div", { class: "background-color", style: u({ backgroundColor: C2.value }) }, null, 4)]), p("div", no, [p("div", ao, [g(d(H), { size: "small", value: i2.value, "onUpdate:value": t2[0] || (t2[0] = (e4) => i2.value = e4), onPressEnter: k2, onBlur: k2, maxlength: 7 }, null, 8, ["value"])])]), p("div", io, [t2[5] || (t2[5] = p("div", { class: "prefix" }, "R", -1)), g(d(Q), { size: "small", value: f2.r, "onUpdate:value": t2[1] || (t2[1] = (e4) => f2.r = e4), bordered: false, controls: false, onPressEnter: M2, onBlur: M2, step: 1, min: 0, max: 255, maxlength: 3 }, null, 8, ["value"])]), p("div", ro, [t2[6] || (t2[6] = p("div", { class: "prefix" }, "G", -1)), g(d(Q), { size: "small", bordered: false, value: f2.g, "onUpdate:value": t2[2] || (t2[2] = (e4) => f2.g = e4), controls: false, onPressEnter: M2, onBlur: M2, step: 1, min: 0, max: 255, maxlength: 3 }, null, 8, ["value"])]), p("div", so, [t2[7] || (t2[7] = p("div", { class: "prefix" }, "B", -1)), g(d(Q), { size: "small", bordered: false, value: f2.b, "onUpdate:value": t2[3] || (t2[3] = (e4) => f2.b = e4), controls: false, onPressEnter: M2, onBlur: M2, step: 1, min: 0, max: 255, maxlength: 3 }, null, 8, ["value"])]), p("div", uo, [t2[8] || (t2[8] = p("div", { class: "prefix" }, "A", -1)), g(d(Q), { size: "small", bordered: false, value: f2.a, "onUpdate:value": t2[4] || (t2[4] = (e4) => f2.a = e4), controls: false, onPressEnter: b2, onChange: b2, step: 1, min: 0, max: 100, maxlength: 3 }, null, 8, ["value"]), t2[9] || (t2[9] = p("div", null, "%", -1))])], 2));
  ...
  const o2 = e2, a2 = y(jt), i2 = y([]), { prefixCls: f2 } = xe("color-recently"), { token: h2 } = F.useToken(), g2 = l(() => h2.value.colorBorder);
  function C2(e3, t2) {
    return e3.map((e4) => {
      const o3 = new Kt();
  ...
  }, { immediate: true }), (e3, t2) => (s(), r("div", { class: c(d(f2)) }, [t2[0] || (t2[0] = p("div", { class: "last-time-text" }, "最近使用", -1)), p("div", po, [(s(true), r(m, null, v(i2.value, (e4, t3) => (s(), r("div", { class: c(["color-selector", { selected: e4.selected }]), key: t3, onClick: (e5) => function(e6) {
    o2.color.fromString(a2.value[e6]);
  }(t3) }, [p("div", { class: "default", style: u({ "background-color": e4.value }) }, null, 4)], 10, fo))), 128))])], 2));
} }), go = eo(ho, [["__scopeId", "data-v-98ec7ef1"]]), yo = { class: "colors" }, mo = ["onClick"], vo = e({ __name: "GradientColorRecently", props: { color: { type: String, default: "" }, isShow: { type: Boolean, default: false } }, emits: ["selectColor"], setup(e2, { emit: o2 }) {
  t((e3) => ({ "7fb04f44": C2.value }));
  const a2 = e2, i2 = o2, f2 = y([]), { prefixCls: h2 } = xe("color-recently"), { token: g2 } = F.useToken(), C2 = l(() => g2.value.colorBorder), b2 = y();
  ...
  }, { immediate: true }), (e3, t2) => (s(), r("div", { class: c(d(h2)) }, [t2[0] || (t2[0] = p("div", { class: "last-time-text" }, "最近使用", -1)), p("div", yo, [(s(true), r(m, null, v(f2.value, (e4, t3) => (s(), r("div", { class: c(["color-selector", { selected: b2.value === t3 }]), key: t3, onClick: (o3) => function(e5, t4) {
    b2.value = e5;
    const o4 = Pt(t4);
    i2("selectColor", o4);
  }(t3, e4) }, [p("div", { class: "default", style: u({ background: e4 }) }, null, 4)], 10, mo))), 128))])], 2));
} }), Co = eo(vo, [["__scopeId", "data-v-be7486eb"]]), bo = { class: "hue-slider" }, ko = ["onMousedown", "onDblclick"], Mo = { class: "color-input-percentage" }, wo = e({ __name: "GradientColor", props: { isShow: { type: Boolean, default: false }, colors: { type: Object, default: () => ({ deg: 45, colors: [{ rgba: "rgba(255, 255, 0, 1)", rgbaLength: "0%" }, { rgba: "rgba(0, 0, 255, 0.9)", rgbaLength: "100%" }] }) } }, emits: ["colorChange", "startEyeDropper", "endEyeDropper"], setup(e2, { emit: a2 }) {
  t((e3) => ({ 40133406: T2.value }));
  const i2 = e2, f2 = a2, h2 = y(new Kt({ enableAlpha: true, format: "rgba" }));
  const w2 = y(0), x2 = y([]), S2 = y(45), _2 = y(), $2 = o("barRef"), L2 = y([]), { prefixCls: I2 } = xe("gradient-color"), { token: D2 } = F.useToken(), T2 = l(() => D2.value.colorBorder), N2 = l(() => _2.value ? { background: _2.value } : {});
  function B2(e3) {
  ...
  }, { deep: true }), (t2, o2) => (s(), r("div", null, [p("div", { class: c(d(I2)) }, [p("div", bo, [g(d(G), { title: "点击增加新颜色", placement: "left" }, { default: k(() => [p("div", { class: "bar", ref_key: "barRef", ref: $2, onClick: M(q2, ["stop", "prevent"]), style: u(N2.value) }, null, 4)]), _: 1 }), (s(true), r(m, null, v(x2.value, (e3, t3) => (s(), r("div", { class: "thumb", ref_for: true, ref: (e4) => function(e5, t4) {
    L2.value[t4] = e5;
  ...
  }(t3), style: u({ left: e3.rgbaLength }) }, [g(d(Be), { title: "双击取消", class: c(["thumb__icon", w2.value === t3 ? "selected" : ""]), icon: "ant-design:caret-up-outlined" }, null, 8, ["class"])], 44, ko))), 128))]), p("div", Mo, [o2[3] || (o2[3] = p("div", { class: "prefix" }, "D", -1)), g(d(Q), { value: S2.value, "onUpdate:value": o2[0] || (o2[0] = (e3) => S2.value = e3), bordered: false, controls: false, max: 360, min: -360, step: 1, onChange: A2, maxlength: 4 }, null, 8, ["value"]), o2[4] || (o2[4] = p("div", { class: "suffix" }, "°", -1))])], 2), g(to, { style: { "margin-top": "4px" }, color: h2.value, height: 118, "is-show": e2.isShow }, null, 8, ["color", "is-show"]), g(oo, { style: { "margin-top": "8px" }, color: h2.value, onStartEyeDropper: o2[1] || (o2[1] = () => f2("startEyeDropper")), onEndEyeDropper: o2[2] || (o2[2] = (e3) => f2("endEyeDropper", e3)) }, null, 8, ["color"]), g(co, { style: { "margin-top": "15px" }, color: h2.value }, null, 8, ["color"]), g(Co, { style: { "margin-top": "8px" }, color: _2.value, "is-show": e2.isShow, onSelectColor: B2 }, null, 8, ["color", "is-show"])]));
} }), xo = eo(wo, [["__scopeId", "data-v-cf05475f"]]), So = { class: "header" }, _o = { key: 0, class: "content" }, $o = { key: 1, class: "content" }, Lo = { class: "confirm" }, Io = { key: 0 }, Do = { key: 1 }, To = e({ __name: "PickerDropdown", props: { type: { type: Number, default: 3 }, selectType: { type: Number, default: 1 }, color: { type: Object, required: true }, colors: { type: Object, default: () => ({ deg: 45, colors: [{ rgba: "rgba(255, 255, 0, 1)", rgbaLength: "0%" }, { rgba: "rgba(0, 0, 255, 0.9)", rgbaLength: "100%" }] }) }, isShow: { type: Boolean, default: false }, hideConfirm: { type: Boolean, default: false }, hideCancel: { type: Boolean, default: false } }, emits: ["changeGradientColor", "pickColor", "restColor", "selectTypeChange", "startEyeDropper", "endEyeDropper"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, { copy: a2, copied: u2 } = De({ legacy: true }), m2 = y([{ value: 1, payload: "纯色" }, { value: 2, payload: "渐变色" }]), v2 = y(), C2 = y(o2.selectType);
  function b2(e3) {
  ...
  return (t3, l3) => {
    const n2 = w("AButton");
    return s(), r("div", { class: c(d(M2)) }, [p("div", So, [g(d(U), { value: C2.value, options: m2.value, onChange: b2, block: "" }, { label: k(({ payload: e3 }) => [x(S(e3), 1)]), _: 1 }, 8, ["value", "options"])]), 1 !== C2.value || 1 !== e2.type && 3 !== e2.type ? f("", true) : (s(), r("div", _o, [g(to, { style: { "margin-top": "4px" }, color: e2.color, "is-show": e2.isShow }, null, 8, ["color", "is-show"]), g(oo, { style: { "margin-top": "8px" }, color: e2.color, onEndEyeDropper: T2, onStartEyeDropper: D2 }, null, 8, ["color"]), g(co, { style: { "margin-top": "15px" }, color: e2.color }, null, 8, ["color"]), g(go, { style: { "margin-top": "8px" }, color: e2.color, "is-show": e2.isShow }, null, 8, ["color", "is-show"])])), 2 !== C2.value || 2 !== e2.type && 3 !== e2.type ? f("", true) : (s(), r("div", $o, [g(xo, { onColorChange: d(L2), colors: e2.colors, "is-show": e2.isShow, onStartEyeDropper: D2, onEndEyeDropper: T2 }, null, 8, ["onColorChange", "colors", "is-show"])])), p("div", Lo, [o2.hideCancel ? f("", true) : (s(), h(n2, { key: 0, onClick: $2 }, { default: k(() => l3[0] || (l3[0] = [x("取消")])), _: 1, __: [0] })), g(n2, { onClick: I2, color: d(u2) ? "warning" : "primary" }, { default: k(() => [d(u2) ? (s(), r("span", Do, "!已拷贝")) : (s(), r("span", Io, "拷贝"))]), _: 1 }, 8, ["color"]), o2.hideConfirm ? f("", true) : (s(), h(n2, { key: 1, onClick: _2, color: "success" }, { default: k(() => l3[1] || (l3[1] = [x("确定")])), _: 1, __: [1] }))])], 2);
  };
  ...
  const a2 = e2, i2 = o2, { prefixCls: m2 } = xe("color-picker"), v2 = y(1), b2 = Se().getDarkMode, w2 = y(false), x2 = y(new Kt({ value: d(b2) === Ge.DARK ? "#000000" : "#FFFFFF", enableAlpha: a2.showAlpha, format: "rgba" })), S2 = y({ deg: 120, colors: [{ rgba: "rgba(243, 231, 233, 1)", rgbaLength: "0%" }, { rgba: "rgba(227,238,255,1)", rgbaLength: "100%" }] }), _2 = y(""), $2 = y(100), { token: L2 } = F.useToken(), I2 = l(() => L2.value.colorBorder), D2 = y(), T2 = y(), N2 = l(() => ({ background: d(D2), height: "100%" }));
  n(() => a2.value, () => {
    A2();
  }, { immediate: true }), n(x2, (e3) => {
  ...
  return (t2, o3) => (s(), h(d(V), { trigger: ["click"], open: R2.value, onOpenChange: q2, placement: "bottom", arrow: { pointAtCenter: true } }, { overlay: k(() => [g(To, { color: x2.value, colors: S2.value, type: e2.type, "select-type": v2.value, "is-show": R2.value, "hide-cancel": e2.hideCancel, "hide-confirm": e2.hideConfirm, onPickColor: U2, onRestColor: W2, onChangeGradientColor: G2, onSelectTypeChange: Z2, onMouseleave: o3[0] || (o3[0] = (e3) => !K2.value && q2(false)), onStartEyeDropper: X2, onEndEyeDropper: J2 }, null, 8, ["color", "colors", "type", "select-type", "is-show", "hide-cancel", "hide-confirm"])]), default: k(() => [p("div", { class: c(d(m2)), onMouseenter: o3[5] || (o3[5] = () => w2.value = true), onMouseleave: o3[6] || (o3[6] = () => w2.value = false) }, [2 === v2.value ? (s(), r("div", No, [p("div", Bo, [p("div", { style: u(N2.value) }, null, 4)]), w2.value ? (s(), h(d(Be), { key: 0, onClick: M(ee2, ["stop"]), size: "14", class: "close-icon", icon: "ant-design:close-circle-filled" })) : f("", true)])) : (s(), r("div", Ro, [p("div", qo, [p("div", Ao, [p("div", { style: u(N2.value) }, null, 4)]), p("div", { class: "color-input", title: e2.title, onClick: o3[2] || (o3[2] = M(() => {
  }, ["stop"])) }, [g(d(H), { placeholder: e2.placeholder, value: _2.value, "onUpdate:value": o3[1] || (o3[1] = (e3) => _2.value = e3), onBlur: E2, onPressEnter: E2, bordered: false, maxlength: 7 }, null, 8, ["placeholder", "value"]), w2.value && _2.value ? (s(), h(d(Be), { key: 0, onClick: M(ee2, ["stop"]), size: "14", class: "close-icon", icon: "ant-design:close-circle-filled" })) : f("", true)], 8, Oo)]), e2.showAlpha ? (s(), r("div", { key: 0, class: "color-input-percentage", onClick: o3[4] || (o3[4] = M(() => {
  }, ["stop"])) }, [g(d(Q), { class: "percent-input", bordered: false, value: $2.value, "onUpdate:value": o3[3] || (o3[3] = (e3) => $2.value = e3), min: 0, max: 100, step: 1, controls: false, onBlur: P2, onPressEnter: P2, maxlength: 3 }, { prefix: k(() => o3[7] || (o3[7] = [p("div", { class: "prefix" }, "A", -1)])), _: 1 }, 8, ["value"]), o3[8] || (o3[8] = p("div", { style: { "user-select": "none" } }, "%", -1))])) : f("", true)]))], 34)]), _: 1 }, 8, ["open"]));
...
function Po() {
  const e2 = y(), t2 = [], o2 = a({ width: 0, height: 0 }), l2 = () => {
    !function(e3, t3) {
      ...
      e3 ? o3 && l3 || Eo.warn("Component width or height is 0px, rendering abnormality may occur!") : Eo.warn("Failed to get dom node, component rendering may be abnormal!"), t3.width = o3, t3.height = l3;
    }(e2.value, o2);
  }, n2 = Ae(l2, 100), r2 = Oe((t3) => {
...
`("border"), Ko = e({ name: "BorderBox1", props: Fo(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = Po();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { color: o3, backgroundColor: n3 } = e2, { width: i2, height: r2 } = a2, s2 = Ho(Wo, o3);
    return g(Uo, { class: Go.getClassNameForBind("border-box-1"), ref: l2 }, { default: () => [g(Zo, { width: i2, height: r2 }, { default: () => [g("polygon", { fill: n3, points: `10, 27 10, ${r2 - 27} 13, ${r2 - 24} 13, ${r2 - 21} 24, ${r2 - 11} 38, ${r2 - 11}
...
`("border-svg-container"), el = e({ name: "BorderBox2", props: Fo(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = Po();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { color: o3, backgroundColor: n3 } = e2, { width: i2, height: r2 } = a2, s2 = Ho(Xo, o3);
    return g(Uo, { class: Go.getClassNameForBind("border-box-2"), ref: l2 }, { default: () => [g(Jo, { width: i2, height: r2 }, { default: () => [g("polygon", { fill: n3, points: `7, 7 ${i2 - 7}, 7 ${i2 - 7}, ${r2 - 7} 7, ${r2 - 7}` }, null), g("polyline", { stroke: s2[0], points: `2, 2 ${i2 - 2} ,2 ${i2 - 2}, ${r2 - 2} 2, ${r2 - 2} 2, 2` }, null), g("polyline", { stroke: s2[1], points: `6, 6 ${i2 - 6}, 6 ${i2 - 6}, ${r2 - 6} 6, ${r2 - 6} 6, 6` }, null), g("circle", { fill: s2[0], cx: "11", cy: "11", r: "1" }, null), g("circle", { fill: s2[0], cx: i2 - 11, cy: "11", r: "1" }, null), g("circle", { fill: s2[0], cx: i2 - 11, cy: r2 - 11, r: "1" }, null), g("circle", { fill: s2[0], cx: "11", cy: r2 - 11, r: "1" }, null)] }), g(Vo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
} }), tl = ["#2e6099", "#7ce7fd"], ol = Go.svg`
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0;
...
`("border-svg-container"), ll = e({ name: "BorderBox3", props: Fo(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = Po();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { color: o3, backgroundColor: n3 } = e2, { width: i2, height: r2 } = a2, s2 = Ho(tl, o3);
    return g(Uo, { class: Go.getClassNameForBind("border-box-3"), ref: l2 }, { default: () => [g(ol, { width: i2, height: r2 }, { default: () => [g("polygon", { fill: n3, points: `23, 23 ${i2 - 24}, 23 ${i2 - 24}, ${r2 - 24} 23, ${r2 - 24}` }, null), g("polyline", { class: "stroke-width-3", stroke: s2[0], points: `4, 4 ${i2 - 22} ,4 ${i2 - 22}, ${r2 - 22} 4, ${r2 - 22} 4, 4` }, null), g("polyline", { class: "stroke-width-1", stroke: s2[1], points: `10, 10 ${i2 - 16}, 10 ${i2 - 16}, ${r2 - 16} 10, ${r2 - 16} 10, 10` }, null), g("polyline", { class: "stroke-width-1", stroke: s2[1], points: `16, 16 ${i2 - 10}, 16 ${i2 - 10}, ${r2 - 10} 16, ${r2 - 10} 16, 16` }, null), g("polyline", { class: "stroke-width-1", stroke: s2[1], points: `22, 22 ${i2 - 4}, 22 ${i2 - 4}, ${r2 - 4} 22, ${r2 - 4} 22, 22` }, null)] }), g(Vo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
} }), nl = ["#2e6099", "#7ce7fd"], al = Go.svg`
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0;
...
`("border-svg-container"), il = e({ name: "BorderBox4", props: { ...Fo(), reverse: { type: Boolean, default: false } }, setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = Po();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { color: o3, backgroundColor: n3, reverse: i2 } = e2, { width: r2, height: s2 } = a2, u2 = Ho(nl, o3);
    return g(Uo, { class: Go.getClassNameForBind("border-box-4"), ref: l2 }, { default: () => [g(al, { class: i2 ? "reverse" : "", width: r2, height: s2 }, { default: () => [g("polygon", { fill: n3, points: `${r2 - 15}, 22 170, 22 150, 7 40, 7 28, 21 32, 24
...
`("border-svg-container"), ul = e({ name: "BorderBox5", props: { ...Fo(), reverse: { type: Boolean, default: false } }, setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = Po();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { color: o3, backgroundColor: n3, reverse: i2 } = e2, { width: r2, height: s2 } = a2, u2 = Ho(rl, o3);
    return g(Uo, { class: Go.getClassNameForBind("border-box-5"), ref: l2 }, { default: () => [g(sl, { class: i2 ? "reverse" : "", width: r2, height: s2 }, { default: () => [g("polygon", { fill: n3, points: `
...
`("border-svg-container"), pl = e({ name: "BorderBox6", props: Fo(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = Po();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { color: o3, backgroundColor: n3 } = e2, { width: i2, height: r2 } = a2, s2 = Ho(cl, o3);
    return g(Uo, { class: Go.getClassNameForBind("border-box-6"), ref: l2 }, { default: () => [g(dl, { width: i2, height: r2 }, { default: () => [g("polygon", { fill: n3, points: `
...
`("border-svg-container"), gl = e({ name: "BorderBox7", props: Fo(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = Po();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { color: o3, backgroundColor: n3 } = e2, { width: i2, height: r2 } = a2, s2 = Ho(fl, o3);
    return g(Uo, { class: Go.getClassNameForBind("border-box-7"), ref: l2, style: { boxShadow: `inset 0 0 40px ${s2[0]}`, border: `1px solid ${s2[0]}`, backgroundColor: n3 } }, { default: () => [g(hl, { width: i2, height: r2 }, { default: () => [g("polyline", { class: "stroke-width2", stroke: s2[0], points: "0, 25 0, 0 25, 0" }, null), g("polyline", { class: "stroke-width2", stroke: s2[0], points: `${i2 - 25}, 0 ${i2}, 0 ${i2}, 25` }, null), g("polyline", { class: "stroke-width2", stroke: s2[0], points: `${i2 - 25}, ${r2} ${i2}, ${r2} ${i2}, ${r2 - 25}` }, null), g("polyline", { class: "stroke-width2", stroke: s2[0], points: `0, ${r2 - 25} 0, ${r2} 25, ${r2}` }, null), g("polyline", { class: "stroke-width5", stroke: s2[1], points: "0, 10 0, 0 10, 0" }, null), g("polyline", { class: "stroke-width5", stroke: s2[1], points: `${i2 - 10}, 0 ${i2}, 0 ${i2}, 10` }, null), g("polyline", { class: "stroke-width5", stroke: s2[1], points: `${i2 - 10}, ${r2} ${i2}, ${r2} ${i2}, ${r2 - 10}` }, null), g("polyline", { class: "stroke-width5", stroke: s2[1], points: `0, ${r2 - 10} 0, ${r2} 10, ${r2}` }, null)] }), g(Vo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
...
function yl() {
  return L(a({ id: Ee("datav_uuid") }));
}
const ml = ["#2e6099", "#7ce7fd"], vl = Go.svg`
  position: absolute;
  width: 100%;
  height: 100%;
  left: 0;
  top: 0;
`("border-svg-container"), Cl = e({ name: "BorderBox8", props: { ...Fo(), duration: { type: Number, default: 3 }, reverse: { type: Boolean, default: false } }, setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = Po();
  o2({ refreshLayoutSize: n2 });
  const i2 = yl();
  return () => {
    const { color: o3, backgroundColor: n3, duration: r2, reverse: s2 } = e2, { width: u2, height: c2 } = a2, d2 = Ho(ml, o3), p2 = `border-box-8-path-${i2.id}`, f2 = `border-box-8-gradient-${i2.id}`, h2 = `border-box-8-mask-${i2.id}`, y2 = s2 ? `M 2.5, 2.5 L 2.5, ${c2 - 2.5} L ${u2 - 2.5}, ${c2 - 2.5} L ${u2 - 2.5}, 2.5 L 2.5, 2.5` : `M2.5, 2.5 L${u2 - 2.5}, 2.5 L${u2 - 2.5}, ${c2 - 2.5} L2.5, ${c2 - 2.5} L2.5, 2.5`;
    return g(Uo, { class: Go.getClassNameForBind("border-box-8"), ref: l2 }, { default: () => [g(vl, { width: u2, height: c2 }, { default: () => [g("defs", null, [g("path", { id: p2, d: y2, fill: "transparent" }, null), g("radialGradient", { id: f2, cx: "50%", cy: "50%", r: "50%" }, [g("stop", { offset: "0%", "stop-color": "#fff", "stop-opacity": "1" }, null), g("stop", { offset: "100%", "stop-color": "#fff", "stop-opacity": "0" }, null)]), g("mask", { id: h2 }, [g("circle", { cx: "0", cy: "0", r: "150", fill: `url(#${f2})` }, [g("animateMotion", { dur: `${r2}s`, path: y2, rotate: "auto", repeatCount: "indefinite" }, null)])])]), g("polygon", { fill: n3, points: `5, 5 ${u2 - 5}, 5 ${u2 - 5} ${c2 - 5} 5, ${c2 - 5}` }, null), g("use", { stroke: d2[0], "stroke-width": "1", "xlink:href": `#${p2}` }, null), g("use", { stroke: d2[1], "stroke-width": "3", "xlink:href": `#${p2}`, mask: `url(#${h2})` }, [g("animate", { attributeName: "stroke-dasharray", from: `0, ${length}`, to: `${length}, 0`, dur: `${r2}s`, repeatCount: "indefinite" }, null)])] }), g(Vo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
} }), bl = ["#2e6099", "#7ce7fd"], kl = Go.svg`
  position: absolute;
  width: 100%;
  height: 100%;
  left: 0;
  top: 0;
`("border-svg-container"), Ml = e({ name: "BorderBox9", props: Fo(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = Po();
  o2({ refreshLayoutSize: n2 });
  const i2 = yl();
  return () => {
    const { color: o3, backgroundColor: n3 } = e2, { width: r2, height: s2 } = a2, u2 = Ho(bl, o3), c2 = `border-box-9-gradient-${i2.id}`, d2 = `border-box-9-mask-${i2.id}`;
    return g(Uo, { class: Go.getClassNameForBind("border-box-9"), ref: l2 }, { default: () => [g(kl, { width: r2, height: s2 }, { default: () => [g("defs", null, [g("linearGradient", { id: c2, x1: "0%", y1: "0%", x2: "100%", y2: "100%" }, [g("animate", { attributeName: "x1", values: "0%;100%;0%", dur: "10s", begin: "0s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "x2", values: "100%;0%;100%", dur: "10s", begin: "0s", repeatCount: "indefinite" }, null), g("stop", { offset: "0%", "stop-color": u2[0] }, [g("animate", { attributeName: "stop-color", values: `${u2[0]};${u2[1]};${u2[0]}`, dur: "10s", begin: "0s", repeatCount: "indefinite" }, null)]), g("stop", { offset: "100%", "stop-color": u2[1] }, [g("animate", { attributeName: "stop-color", values: `${u2[1]};${u2[0]};${u2[1]}`, dur: "10s", begin: "0s", repeatCount: "indefinite" }, null)])]), g("mask", { id: d2 }, [g("polyline", { stroke: "#fff", "stroke-width": "3", fill: "transparent", points: `8, ${0.4 * s2} 8, 3, ${0.4 * r2 + 7}, 3` }, null), g("polyline", { fill: "#fff", points: `
...
} }), wl = ["#2e6099", "#7ce7fd"], xl = ["left-top", "right-top", "left-bottom", "right-bottom"], Sl = Go.svg`
  position: absolute;
  display: block;
...
`("border-svg-container"), _l = e({ name: "BorderBox10", props: Fo(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = Po();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { width: o3, height: n3 } = a2, { backgroundColor: i2, color: r2 } = e2, s2 = Ho(wl, r2);
    return g(Uo, { class: Go.getClassNameForBind("border-box-10"), ref: l2, style: { boxShadow: `inset 0 0 25px 3px ${s2[0]}` } }, { default: () => [g(Sl, { width: o3, height: n3 }, { default: () => [g("polygon", { fill: i2, points: `
                  4, 0 ${o3 - 4}, 0 ${o3}, 4 ${o3}, ${n3 - 4} ${o3 - 4}, ${n3}
                  4, ${n3} 0, ${n3 - 4} 0, 4
                ` }, null)] }), xl.map((e3) => g(Sl, { width: "150px", height: "150px", key: e3, class: e3 }, { default: () => [g("polygon", { fill: s2[1], points: "40, 0 5, 0 0, 5 0, 16 3, 19 3, 7 7, 3 35, 3" }, null)] })), g(Vo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
} }), $l = ["#2e6099", "#7ce7fd"], Ll = Go.svg`
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0;
...
`("border-svg-container"), Il = e({ name: "BorderBox11", props: { ...Fo(), titleWidth: { type: Number, default: 250 }, title: { type: String, default: "" } }, setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = Po();
  o2({ refreshLayoutSize: n2 });
  const i2 = yl();
  return () => {
    const { color: o3, backgroundColor: n3, titleWidth: r2, title: s2 } = e2, { width: u2, height: c2 } = a2, d2 = Ho($l, o3), p2 = `border-box-11-filterId-${i2}`;
    return g(Uo, { class: Go.getClassNameForBind("border-box-11"), ref: l2 }, { default: () => [g(Ll, { width: u2, height: c2 }, { default: () => [g("defs", null, [g("filter", { id: p2, height: "150%", width: "150%", x: "-25%", y: "-25%" }, [g("feMorphology", { operator: "dilate", radius: "2", in: "SourceAlpha", result: "thicken" }, null), g("feGaussianBlur", { in: "thicken", stdDeviation: "3", result: "blurred" }, null), g("feFlood", { "flood-color": d2[1], result: "glowColor" }, null), g("feComposite", { in: "glowColor", in2: "blurred", operator: "in", result: "softGlowColored" }, null), g("feMerge", null, [g("feMergeNode", { in: "softGlowColored" }, null), g("feMergeNode", { in: "SourceGraphic" }, null)])])]), g("polygon", { fill: n3, points: `
                ...
                ` }, null), g("polygon", { stroke: d2[0], fill: Ue(d2[1] || $l[1], 30), filter: `url(#${p2})`, points: `
...
} }), Dl = ["#2e6099", "#7ce7fd"], Tl = Go.svg`
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0;
  left: 0;
`("border-svg-container"), Nl = e({ name: "BorderBox12", props: Fo(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = Po();
  o2({ refreshLayoutSize: n2 });
  const i2 = yl();
  return () => {
    const { color: o3, backgroundColor: n3 } = e2, { width: r2, height: s2 } = a2, u2 = Ho(Dl, o3), c2 = `border-box-12-filterId-${i2}`;
    return g(Uo, { class: Go.getClassNameForBind("border-box-12"), ref: l2 }, { default: () => [g(Tl, { width: r2, height: s2 }, { default: () => [g("defs", null, [g("filter", { id: c2, height: "150%", width: "150%", x: "-25%", y: "-25%" }, [g("feMorphology", { operator: "dilate", radius: "1", in: "SourceAlpha", result: "thicken" }, null), g("feGaussianBlur", { in: "thicken", stdDeviation: "2", result: "blurred" }, null), g("feFlood", { "flood-color": Ue(u2[1] || Dl[1], 70), result: "glowColor" }, [g("animate", { attributeName: "flood-color", values: `
                        ${Ue(u2[1] || Dl[1], 70)};
                        ${Ue(u2[1] || Dl[1], 30)};
                        ${Ue(u2[1] || Dl[1], 70)};
...
} }), Bl = ["#2e6099", "#7ce7fd"], Rl = Go.svg`
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0;
  left: 0;
`("border-svg-container"), ql = e({ name: "BorderBox13", props: Fo(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = Po();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { color: o3, backgroundColor: n3 } = e2, { width: i2, height: r2 } = a2, s2 = Ho(Bl, o3);
    return g(Uo, { class: Go.getClassNameForBind("border-box-13"), ref: l2 }, { default: () => [g(Rl, { width: i2, height: r2 }, { default: () => [g("path", { fill: n3, stroke: s2[0], d: `
...
const fn = ["#2e6099", "#7ce7fd"], hn = 2.5, gn = function({ width: e2, height: t2, rowPoints: o2, rowCount: l2 }) {
...
}({ width: 200, height: 50, rowPoints: 20, rowCount: 4 }), yn = gn[39], mn = gn[37], vn = Go.div`
  width: 100%;
  height: 100%;
...
`("decoration-1"), Cn = e({ name: "Decoration1", props: cn(), setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: l2, domSize: n2 } = Po();
  return t2({ refreshLayoutSize: l2 }), () => {
    const { color: t3 } = e2, { width: l3, height: a2 } = n2, i2 = Ho(fn, t3), r2 = { transform: `scale(${l3 / 200},${a2 / 50})` };
    return g(vn, { ref: o2 }, { default: () => [g("svg", { width: 200, height: 50, style: r2 }, [gn.map(([e3, t4], o3) => {
      const l4 = e3 - 1.25, n3 = t4 - 1.25;
      return Math.random() > 0.6 ? g("rect", { key: o3, x: l4, y: n3, width: hn, height: hn, fill: i2[0] }, [Math.random() > 0.6 && g("animate", { attributeName: "fill", values: `${i2[0]};transparent`, dur: "1s", begin: 2 * Math.random(), repeatCount: "indefinite" }, null)]) : null;
    }), g("rect", { fill: i2[1], x: yn[0] - hn, y: yn[1] - hn, width: 5, height: 5 }, [g("animate", { attributeName: "width", values: "0;5", dur: "2s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "height", values: "0;5", dur: "2s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "x", values: `${yn[0]};${yn[0] - hn}`, dur: "2s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "y", values: `${yn[1]};${yn[1] - hn}`, dur: "2s", repeatCount: "indefinite" }, null)]), g("rect", { fill: i2[1], x: mn[0] - hn, y: mn[1] - hn, width: 5, height: 5 }, [g("animate", { attributeName: "width", values: "0;40;0", dur: "2s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "x", values: `${mn[0]};${mn[0] - 40};${mn[0]}`, dur: "2s", repeatCount: "indefinite" }, null)])])] });
  };
} }), bn = ["#2e6099", "#7ce7fd"];
const kn = Go.div`
  display: flex;
  ...
  align-items: center;
`("decoration-2"), Mn = e({ name: "Decoration2", props: { ...cn(), ...dn(), ...pn(6) }, setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: l2, domSize: n2 } = Po();
  return t2({ refreshLayoutSize: l2 }), () => {
    const { width: t3, height: l3 } = n2, { color: a2, reverse: i2, duration: r2 } = e2, s2 = Ho(bn, a2), { x: u2, y: c2, width: d2, height: p2 } = function(e3, t4, o3) {
...
const wn = ["#7ce7fd", "transparent"], xn = function({ width: e2, height: t2, rowPoints: o2, rowCount: l2 }) {
  const n2 = e2 / (o2 + 1), a2 = t2 / (l2 + 1);
  return Array.from({ length: l2 }).fill(0).flatMap((e3, t3) => Array.from({ length: o2 }).fill(0).map((e4, o3) => [n2 * (o3 + 1), a2 * (t3 + 1)]));
}({ width: 300, height: 35, rowPoints: 25, rowCount: 2 }), Sn = Go.div`
  width: 100%;
  height: 100%;
...
`("decoration-3"), _n = e({ name: "Decoration3", props: cn(), setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: l2, domSize: n2 } = Po();
  return t2({ refreshLayoutSize: l2 }), () => {
    const { width: t3, height: l3 } = n2, { color: a2 } = e2, i2 = Ho(wn, a2);
    return g(Sn, { ref: o2 }, { default: () => [g("svg", { width: 300, height: 35, style: { transform: `scale(${t3 / 300},${l3 / 35})` } }, [xn.map(([e3, t4], o3) => {
...
} }), $n = ["width", "height"], Ln = ["stroke", "points"], In = ["stroke", "points"], Dn = e({ name: "Decoration4", __name: "index", props: { ...cn(), ...dn(), ...pn(3) }, setup(e2) {
  ...
  return (e3, t3) => (s(), r("div", { class: "dv-decoration-4", ref_key: "decoration4Ref", ref: n2 }, [p("div", { class: c("container " + (e3.reverse ? "reverse" : "normal")), style: u(e3.reverse ? `width:${a2.value}px;height:5px;animation-duration:${e3.duration}s` : `width:5px;height:${i2.value}px;animation-duration:${e3.duration}s`) }, [(s(), r("svg", { width: e3.reverse ? a2.value : 5, height: e3.reverse ? 5 : i2.value }, [p("polyline", { stroke: d2.value[0], points: e3.reverse ? `0, 2.5 ${a2.value}, 2.5` : `2.5, 0 2.5, ${i2.value}` }, null, 8, Ln), p("polyline", { class: "bold-line", stroke: d2.value[1], "stroke-width": "3", "stroke-dasharray": "20, 80", "stroke-dashoffset": "-30", points: e3.reverse ? `0, 2.5 ${a2.value}, 2.5` : `2.5, 0 2.5, ${i2.value}` }, null, 8, In)], 8, $n))], 6)], 512));
} }), Tn = eo(Dn, [["__scopeId", "data-v-97e7e3ce"]]), Nn = ["#2e6099", "#7ce7fd"];
function Bn(e2) {
...
const Rn = Go.div`
  width: 100%;
  height: 100%;
`("decoration-5"), qn = e({ name: "Decoration5", props: { ...cn(), ...pn(1.2) }, setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: l2, domSize: n2 } = Po();
  return t2({ refreshLayoutSize: l2 }), () => {
    const { width: t3, height: l3 } = n2, { color: a2, duration: i2 } = e2, r2 = Ho(Nn, a2), { line1Sum: s2, line2Sum: u2, line1Point: c2, line2Point: d2 } = function(e3, t4) {
...
`("decoration-6");
const { points: jn, heights: zn, minHeights: En, randoms: Pn } = function({ width: e2, height: t2, rowPoints: o2, rowCount: l2 }) {
...
}({ width: 300, height: 35, rowPoints: 40, rowCount: 1 }), Fn = e({ name: "Decoration6", props: cn(), setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: l2, domSize: n2 } = Po();
  return t2({ refreshLayoutSize: l2 }), () => {
    const { width: t3, height: l3 } = n2, { color: a2 } = e2, i2 = Ho(An, a2), r2 = { transform: `scale(${t3 / 300},${l3 / 35})` };
    return g(On, { ref: o2 }, { default: () => [g("svg", { class: "svg-origin", width: t3, height: l3, style: r2 }, [jn.map(([e3, t4], o3) => g("rect", { key: `rect${o3}`, fill: i2[Math.random() > 0.5 ? 0 : 1], x: e3 - 3.5, y: t4 - zn[o3], width: 7, height: zn[o3] }, [g("animate", { attributeName: "y", values: `${t4 - En[o3] / 2};${t4 - zn[o3] / 2};${t4 - En[o3] / 2}`, dur: Pn[o3], keyTimes: "0;0.5;1", calcMode: "spline", keySplines: "0.42,0,0.58,1;0.42,0,0.58,1", begin: "0s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "height", values: `${En[o3]};${zn[o3]};${En[o3]}`, dur: Pn[o3], keyTimes: "0;0.5;1", calcMode: "spline", keySplines: "0.42,0,0.58,1;0.42,0,0.58,1", begin: "0s", repeatCount: "indefinite" }, null)]))])] });
  };
} }), Hn = Go.div`
  display: flex;
  width: 100%;
  ...
  justify-content: center;
  align-items: center;
`("decoration-7"), Qn = ["#2e6099", "#7ce7fd"], Gn = e({ name: "Decoration7", props: cn(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2 } = Po();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { color: o3 } = e2, n3 = Ho(Qn, o3);
    return g(Hn, { ref: l2 }, { default: () => {
      var _a2;
...
const Vn = Go.div`
  ...
  width: 100%;
  height: 100%;
`("decoration-8"), Wn = e({ name: "Decoration8", props: { ...cn(), ...dn() }, setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: l2, domSize: n2 } = Po();
  return t2({ refreshLayoutSize: l2 }), () => {
    const { color: t3, reverse: l3 } = e2, { width: a2, height: i2 } = n2, r2 = (e3) => l3 ? a2 - e3 : e3, s2 = Ho(Un, t3);
    return g(Vn, { ref: o2 }, { default: () => [g("svg", { width: a2, height: i2 }, [g("polyline", { stroke: s2[0], "stroke-width": "2", fill: "transparent", points: `${r2(0)}, 0 ${r2(30)}, ${i2 / 2}` }, null), g("polyline", { stroke: s2[0], "stroke-width": "2", fill: "transparent", points: `${r2(20)}, 0 ${r2(50)}, ${i2 / 2} ${r2(a2)}, ${i2 / 2}` }, null), g("polyline", { stroke: s2[1], fill: "transparent", "stroke-width": "3", points: `${r2(0)}, ${i2 - 3}, ${r2(200)}, ${i2 - 3}` }, null)])] });
  };
} });
const Yn = ["#2e6099", "#7ce7fd"], Zn = Go.div`
  position: relative;
  width: 100%;
  height: 100%;
  display: flex;
...
`("decoration-11"), oa = Go.div`
  ...
  align-items: center;
  justify-content: center;
`("decoration-content"), la = ["#2e6099", "#7ce7fd"], na = e({ name: "Decoration11", props: cn(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = Po();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { width: o3, height: n3 } = a2, { color: i2 } = e2, r2 = Ho(la, i2);
    return g(ta, { ref: l2 }, { default: () => [g("svg", { width: o3, height: n3 }, [g("polygon", { fill: Ue(r2[1] || la[1], 10), stroke: r2[1], points: "20 10, 25 4, 55 4 60 10" }, null), g("polygon", { fill: Ue(r2[1] || la[1], 10), stroke: r2[1], points: `20 ${n3 - 10}, 25 ${n3 - 4}, 55 ${n3 - 4} 60 ${n3 - 10}` }, null), g("polygon", { fill: Ue(r2[1] || la[1], 10), stroke: r2[1], points: `${o3 - 20} 10, ${o3 - 25} 4, ${o3 - 55} 4 ${o3 - 60} 10` }, null), g("polygon", { fill: Ue(r2[1] || la[1], 10), stroke: r2[1], points: `${o3 - 20} ${n3 - 10}, ${o3 - 25} ${n3 - 4}, ${o3 - 55} ${n3 - 4} ${o3 - 60} ${n3 - 10}` }, null), g("polygon", { fill: Ue(r2[0] || la[0], 20), stroke: r2[0], points: `
        20 10, 5 ${n3 / 2} 20 ${n3 - 10}
        ${o3 - 20} ${n3 - 10} ${o3 - 5} ${n3 / 2} ${o3 - 20} 10
      ` }, null), g("polyline", { fill: "transparent", stroke: Ue(r2[0] || la[0], 70), points: `25 18, 15 ${n3 / 2} 25 ${n3 - 18}` }, null), g("polyline", { fill: "transparent", stroke: Ue(r2[0] || la[0], 70), points: `${o3 - 25} 18, ${o3 - 15} ${n3 / 2} ${o3 - 25} ${n3 - 18}` }, null)]), g(oa, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
...
`("decoration-12"), ia = Go.div`
  ...
  align-items: center;
  justify-content: center;
`("decoration-content"), ra = ["#2e6099", "#7ce7fd"], sa = Math.PI / 3;
const ua = (e2, t2, o2, l2) => [e2 + Math.cos(l2) * o2, t2 + Math.sin(l2) * o2], ca = e({ name: "Decoration12", props: { ...cn(), scanDuration: { type: Number, default: 3 }, haloDuration: { type: Number, default: 2 } }, setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = Po();
  o2({ refreshLayoutSize: n2 });
  const i2 = yl();
  return () => {
    const { width: o3, height: n3 } = a2, r2 = o3 / 2, s2 = n3 / 2, { color: u2, scanDuration: c2, haloDuration: d2 } = e2, p2 = `decoration-12-g-${i2.id}`, f2 = `decoration-12-gradient-${i2.id}`, h2 = Ho(ra, u2), y2 = ((e3, t3) => {
      const o4 = 100 / (t3 - 1);
      ...
      let s3 = ua(e3, t3, r3, a3);
      return Array.from({ length: l3 }).fill("").map((o5, l4) => {
        const n5 = ua(e3, t3, r3, a3 - (l4 + 1) * i3).map((e4) => e4.toFixed(5)), u3 = `M${s3.join(",")} A${r3}, ${r3} 0 0 0 ${n5.join(",")}`;
        return s3 = n5, u3;
      });
    })({ x: r2, y: s2, width: o3, segment: 30, sectorAngle: sa }), v2 = (({ ringNum: e3, width: t3, ringWidth: o4 }) => {
      ...
      return Array.from({ length: 6 }).fill("").map((o5, a3) => {
        const i3 = l3 * (a3 + 1), r3 = i3 + Math.PI, s3 = ua(e3, t3, n4, i3), u3 = ua(e3, t3, n4, r3);
...
`("header-svg-container"), La = e({ name: "Header6", props: Fo(), setup(e2, { expose: t2 }) {
  ...
  return n(() => c2.config, () => {
    ...
    e3 === Ge.DARK ? (C2.value.headerBGC === z2 && (C2.value.headerBGC = A2), C2.value.oddRowBGC === E2 && (C2.value.oddRowBGC = O2), C2.value.evenRowBGC === P2 && (C2.value.evenRowBGC = j2)) : (C2.value.headerBGC === A2 && (C2.value.headerBGC = z2), C2.value.oddRowBGC === O2 && (C2.value.oddRowBGC = E2), C2.value.evenRowBGC === j2 && (C2.value.evenRowBGC = P2));
  }, { immediate: true }), i(() => {
    var _a2, _b;
    q2.value = ((_a2 = p2.value) == null ? void 0 : _a2.clientWidth) || 0, R2.value = ((_b = p2.value) == null ? void 0 : _b.clientHeight) || 0, Q2(), window.addEventListener("resize", F2);
  }), _(() => {
    ...
    C2.value = { ...C2.value, data: [...e3] }, B2 = true, T2 = t3, D2 || K2(true);
      ...
      ${h2.value ? "" : "border-top-left-radius: 8px;border-top-right-radius: 8px;"}`) }, [(s(true), r(m, null, v(M2.value, (e4, t4) => (s(), r("div", { class: "row-item", key: `${e4.toString()}${e4.scroll}`, style: u(`
        ...
        `) }, [(s(true), r(m, null, v(e4.ceils, (o2, l2) => (s(), r("div", { class: "ceil", key: `${o2}${t4}${l2}`, style: u(`width: ${w2.value[l2]}px; text-align: ${I2.value[l2]}`), onClick: (t5) => Z2("rowClick", l2, e4, o2), onMouseenter: (t5) => function(e5, t6, o3) {
  ...
  }(l2, e4, o2) }, [C2.value.index && 0 === l2 ? (s(), r("span", { key: 0, class: "index", style: u(`background: ${C2.value.headerBGC};`) }, S(o2), 5)) : (s(), r(m, { key: 1 }, [x(S(o2), 1)], 64))], 44, Ia))), 128))], 4))), 128))], 4)) : f("", true)], 512));
} }), Ta = eo(Da, [["__scopeId", "data-v-4f0b446b"]]), Na = ["onClick"], Ba = eo(e({ __name: "MacButton", props: { size: { type: String, default: () => "default" }, disabled: { request: false, type: Boolean, default: false }, hidden: { request: false, type: Array, default: () => [] }, narrow: { request: false, type: Boolean, default: false } }, emits: ["close", "remove", "resize", "fullResize"], setup(e2, { emit: t2 }) {
  ...
  return (t3, o3) => (s(), r("div", { class: c(d(a2)) }, [(s(true), r(m, null, v(i2.value, (t4) => (s(), r("div", { key: t4.key, class: c(["btn", [t4.key, e2.disabled && "disabled", e2.size]]), onClick: M((e3) => {
    ...
    var o4;
  }, ["stop"]) }, [g(d(Be), { icon: t4.icon, size: "10", class: c(["icon-base", { hover: !e2.disabled }]) }, null, 8, ["icon", "class"])], 10, Na))), 128))], 2));
} }), [["__scopeId", "data-v-5c20d434"]]), Ra = e({ name: "ScreenCheckbox", __name: "index", props: { title: { type: String }, tooltip: { type: String } }, setup: (e2) => (t2, o2) => (s(), r("div", null, [g(d(W), I(D(t2.$attrs)), { default: k(() => [x(S(e2.title), 1)]), _: 1 }, 16), e2.tooltip ? (s(), h(d(G), { key: 0, title: e2.tooltip }, { default: k(() => [g(d(Be), { icon: "ant-design:exclamation-circle-outlined" })]), _: 1 }, 8, ["title"])) : f("", true)])) }), qa = { key: 0, class: "prefix" }, Aa = { key: 3 }, Oa = eo(e({ name: "ScreenInput", __name: "index", props: { isNumber: { type: Boolean, default: true }, prefix: { type: String }, suffix: { type: String } }, emits: ["change"], setup(e2, { emit: o2 }) {
  t((e3) => ({ cd77f8d8: u2.value }));
  const n2 = o2, { prefixCls: a2 } = xe("screen-input"), { token: i2 } = F.useToken(), u2 = l(() => i2.value.colorBorder);
  return (t2, o3) => (s(), r("div", { class: c(d(a2)) }, [e2.prefix ? (s(), r("div", qa, S(e2.prefix), 1)) : f("", true), e2.isNumber ? (s(), h(d(Q), $({ key: 1, class: "input" }, t2.$attrs, { onChange: o3[0] || (o3[0] = (e3) => n2("change", e3)), bordered: false, controls: false }), null, 16)) : (s(), h(d(H), $({ key: 2, class: "input" }, t2.$attrs, { bordered: false, onChange: o3[1] || (o3[1] = (e3) => n2("change", e3)) }), null, 16)), e2.suffix ? (s(), r("div", Aa, S(e2.suffix), 1)) : f("", true)], 2));
} }), [["__scopeId", "data-v-107119ae"]]), ja = ({ CtrlShiftKeysEnum: e2, CtrlKeysEnum: t2, ShiftKeysEnum: o2, KeysEnum: l2 }) => {
  const n2 = (e3, t3) => {
    if (!t3) return;
...
const Ea = eo(e({ __name: "TextFontStyle", props: { bold: { type: Boolean, default: false }, italic: { type: Boolean, default: false }, strikethrough: { type: Boolean, default: false }, underline: { type: Boolean, default: false }, hide: { type: Array, default: () => [] } }, emits: ["fontStyleChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, i2 = a({ [Ja.Bold]: { name: "加粗", icon: "carbon:text-bold", value: false }, [Ja.Italic]: { name: "斜体", icon: "carbon:text-italic", value: false }, [Ja.Underline]: { name: "下划线", icon: "carbon:text-underline", value: false }, [Ja.Strikethrough]: { name: "删除线", icon: "carbon:text-strikethrough", value: false } }), u2 = (e3) => !o2.hide.includes(e3);
  ...
  return (e3, t3) => (s(), r("div", { class: c(d(p2)) }, [(s(true), r(m, null, v(Object.keys(i2), (e4) => (s(), r(m, { key: e4 }, [u2(e4) ? (s(), h(d(G), { key: 0, placement: "bottom", title: `${i2[e4].value ? "关闭" : "打开"}${i2[e4].name}` }, { default: k(() => [g(d(Y), { class: "radio-button", checked: i2[e4].value, onMousedown: (t4) => function(e5) {
    if (e5) {
      i2[e5].value = !i2[e5].value, i2[e5].value && (e5 === Ja.Underline && (i2[Ja.Strikethrough].value = false), e5 === Ja.Strikethrough && (i2[Ja.Underline].value = false));
      const t5 = {};
      Object.keys(i2).forEach((e6) => {
        t5[e6] = i2[e6].value;
      }), l2("fontStyleChange", t5);
    }
  }(e4) }, { default: k(() => [g(d(Be), { icon: i2[e4].icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["checked", "onMousedown"])]), _: 2 }, 1032, ["title"])) : f("", true)], 64))), 128))], 2));
} }), [["__scopeId", "data-v-3b6dd2cf"]]), Pa = eo(e({ __name: "TextHAlignStyle", props: { alignType: { type: String, default: void 0 } }, emits: ["alignChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, i2 = y();
  n(() => o2.alignType, (e3) => {
    i2.value = e3;
  }, { immediate: true });
  const { prefixCls: u2 } = xe("h-align-style"), p2 = a({ [Ka.Left]: { name: "水平居左", icon: "carbon:text-align-left", description: "文字水平居左" }, [Ka.Center]: { name: "水平居中", icon: "carbon:text-align-center", description: "文字水平居中" }, [Ka.Right]: { name: "水平居右", icon: "carbon:text-align-right", description: "文字水平居右" } });
  function f2(e3) {
    const t3 = e3.target.value;
    l2("alignChange", t3);
  }
  return (e3, t3) => (s(), r("div", { class: c(d(u2)) }, [g(d(Z), { value: i2.value, "onUpdate:value": t3[0] || (t3[0] = (e4) => i2.value = e4), onChange: f2 }, { default: k(() => [(s(true), r(m, null, v(Object.keys(p2), (e4) => (s(), h(d(G), { key: e4, placement: "top", title: p2[e4].description }, { default: k(() => [g(d(Y), { class: "radio-button", value: e4 }, { default: k(() => [g(d(Be), { icon: p2[e4].icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["value"])]), _: 2 }, 1032, ["title"]))), 128))]), _: 1 }, 8, ["value"])], 2));
} }), [["__scopeId", "data-v-63ee2427"]]), Fa = eo(e({ __name: "TextVAlignStyle", props: { alignType: { type: String, default: void 0 } }, emits: ["alignChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, i2 = y();
  n(() => o2.alignType, (e3) => {
    i2.value = e3;
  }, { immediate: true });
  const { prefixCls: u2 } = xe("v-align-style"), p2 = a({ [Xa.Top]: { name: "垂直居上", icon: "carbon:align-vertical-top", description: "文字垂直居上" }, [Xa.Center]: { name: "垂直居中", icon: "carbon:align-vertical-center", description: "文字垂直居中" }, [Xa.Bottom]: { name: "垂直居下", icon: "carbon:align-vertical-bottom", description: "文字垂直居下" } });
  function f2(e3) {
    const t3 = e3.target.value;
    l2("alignChange", t3);
  }
  return (e3, t3) => (s(), r("div", { class: c(d(u2)) }, [g(d(Z), { value: i2.value, "onUpdate:value": t3[0] || (t3[0] = (e4) => i2.value = e4), onChange: f2 }, { default: k(() => [(s(true), r(m, null, v(Object.keys(p2), (e4) => (s(), h(d(G), { key: e4, placement: "top", title: p2[e4].description }, { default: k(() => [g(d(Y), { class: "radio-button", value: e4 }, { default: k(() => [g(d(Be), { icon: p2[e4].icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["value"])]), _: 2 }, 1032, ["title"]))), 128))]), _: 1 }, 8, ["value"])], 2));
} }), [["__scopeId", "data-v-a40ac773"]]), Ha = { class: "line" }, Qa = { class: "input" }, Ga = { class: "line" }, Ua = { style: { flex: "1" } }, Va = { key: 0, class: "line" }, Wa = e({ name: "TextStyle", __name: "index", props: { verticalAlign: { type: Boolean, default: false }, textStyle: { type: Object, default: () => {
  ...
  const a2 = e2, i2 = o2, { prefixCls: u2 } = xe("text-style"), { token: m2 } = F.useToken(), v2 = l(() => m2.value.colorBorder), C2 = y(12), b2 = y(Za[0].value), k2 = y(), M2 = y();
  function w2(e3) {
    const t2 = x2(e3);
  ...
  function _2(e3, t2) {
    if (!e3) return;
    const o3 = t2 == null ? void 0 : t2.startsWith("linear-gradient"), l2 = Math.round((C2.value ?? 12) / 10), n2 = (e3 == null ? void 0 : e3.underline) && o3 ? { borderBottom: `${l2}px solid`, borderImage: `${t2} 1` } : (e3 == null ? void 0 : e3.underline) ? { borderBottom: `${l2}px solid`, borderColor: `${t2}` } : {}, a3 = e3[Ja.Bold] ? { fontWeight: "bold" } : {}, r2 = e3[Ja.Italic] ? { fontStyle: "italic" } : {};
    if (o3) {
      const e4 = t2 == null ? void 0 : t2.match(new RegExp("(?<=linear-gradient.*?)(rgba\\(.*?\\))", "g"));
      e4 && e4.length > 0 && (t2 = e4[0]);
    }
    const s2 = e3[Ja.Strikethrough] ? { textDecoration: "line-through", textDecorationColor: t2 } : {};
    i2("fontStyleChange", { value: e3, style: { ...a3, ...r2, ...n2, ...s2 } });
  }
  function L2(e3) {
    i2("hAlignChange", { value: e3, style: { justifyContent: e3 === Ka.Left ? "flex-start" : e3 === Ka.Center ? "center" : e3 === Ka.Right ? "flex-end" : "center" } });
  }
  function I2(e3) {
    i2("vAlignChange", { value: e3, style: { alignItems: e3 === Xa.Top ? "flex-start" : e3 === Xa.Center ? "center" : e3 === Xa.Bottom ? "flex-end" : "unset" } });
  }
  function D2(e3) {
  ...
  return n(() => a2.textStyle, (e3) => {
    var _a2, _b, _c2, _d2;
    e3 && (C2.value = ((_a2 = a2.textStyle) == null ? void 0 : _a2.fontSize) ?? 12, b2.value = ((_b = a2.textStyle) == null ? void 0 : _b.font) ?? Za[0].value, k2.value = (_c2 = a2.textStyle) == null ? void 0 : _c2.textColor, M2.value = (_d2 = a2.textStyle) == null ? void 0 : _d2.fontStyle);
  }, { immediate: true, deep: true }), (t2, o3) => {
    var _a2, _b;
    return s(), r("div", { class: c(d(u2)) }, [p("div", Ha, [g(d(K), { style: { flex: "1" }, value: b2.value, "onUpdate:value": o3[0] || (o3[0] = (e3) => b2.value = e3), options: d(Za), onChange: D2 }, null, 8, ["value", "options"]), p("div", Qa, [g(d(Q), { value: C2.value, "onUpdate:value": o3[1] || (o3[1] = (e3) => C2.value = e3), bordered: false, placeholder: "大小", controls: false, min: 6, maxlength: 4, onChange: T2 }, null, 8, ["value"]), o3[2] || (o3[2] = p("div", { class: "suffix" }, "px", -1))]), e2.hideAlign ? f("", true) : (s(), h(Pa, { key: 0, "align-type": (_a2 = e2.textStyle) == null ? void 0 : _a2.hAlignType, onAlignChange: L2 }, null, 8, ["align-type"]))]), p("div", Ga, [p("div", Ua, [g(d(zo), { type: e2.colorType, "direct-confirm": true, value: k2.value, onConfirmChange: w2, onInputChange: x2 }, null, 8, ["type", "value"])]), g(Ea, $({ hide: e2.hideFontStyle }, M2.value, { onFontStyleChange: S2 }), null, 16, ["hide"])]), e2.verticalAlign ? (s(), r("div", Va, [g(Fa, { "align-type": (_b = e2.textStyle) == null ? void 0 : _b.vAlignType, onAlignChange: I2 }, null, 8, ["align-type"])])) : f("", true)], 2);
  };
} }), Ya = eo(Wa, [["__scopeId", "data-v-c65c80c4"]]), Za = [{ value: "微软雅黑", label: "微软雅黑" }, { value: "宋体", label: "宋体" }, { value: "黑体", label: "黑体" }, { value: "楷体", label: "楷体" }, { value: "仿宋", label: "仿宋" }, { value: "sans-serif", label: "sans-serif" }, { value: "Arial", label: "Arial" }, { value: "PingFangSC", label: "PingFangSC" }, { value: "monospace", label: "monospace" }, { value: "Courier New", label: "Courier New" }, { value: "lcd", label: "lcd" }];
var Ka = ((e2) => (e2.Left = "left", e2.Center = "center", e2.Right = "right", e2))(Ka || {}), Xa = ((e2) => (e2.Top = "top", e2.Center = "center", e2.Bottom = "bottom", e2))(Xa || {}), Ja = ((e2) => (e2.Bold = "bold", e2.Italic = "italic", e2.Underline = "underline", e2.Strikethrough = "strikethrough", e2))(Ja || {});
function ei(e2) {
  switch (e2) {
    case "NUMBER":
...
const yi = (e2) => Je.get({ url: "/nocode/formulaInfo/tree", params: e2 }), mi = (e2) => Je.get({ url: `/nocode/formulaParam/${e2}` }), vi = (e2) => Je.get({ url: "/nocode/formulaInfo", params: e2 });
function Ci(e2) {
...
const Ir = async (e2) => {
  ...
  const o2 = { sourceId: t2.getSourceId, sourceType: t2.getSourceType, sqlQuery: e2.sqlQuery }, l2 = await qi(o2);
  return l2 && l2.forEach((t3) => t3.tableAlias = e2.sourceTable), l2;
}, Dr = (e2) => e2 && ((e2 == null ? void 0 : e2.aggregates) && e2.aggregates.length > 0 || e2.groups && e2.groups.length > 0 || e2.customColumns && e2.customColumns.length > 0), Tr = (e2, t2) => t2 === Sr().getLevel && Dr(e2), Nr = (e2, t2, o2) => {
  ...
  return tp(this.componentList, e2);
}, async initCache(e2) {
  if (this.setInitComplete(false), e2) {
    const t2 = JSON.parse(e2);
    if (!t2) return;
    this.setComponentList(t2.componentList), this.setCanvasConfig(t2.canvasConfig), lp(this.componentList).then((e3) => {
      Promise.all(e3).then(() => {
  ...
  e2.forEach((e3) => {
    np(e3.chart), e3.chart.type === ls.MfCombine && e3.chart.options.components.forEach((e4) => {
      np(e4.chart);
    });
  ...
  let t2;
  if (this.setInitComplete(false), t2 = this.isResource ? await Cr(this.getId) : await Fi(this.getId, this.getShareToken), !t2) {
  ...
  let n2;
  if (n2 = this.isResource ? await wr(this.getId) : await mr({ screenId: this.getId }, this.getShareToken), !n2 || 0 === n2.length) return this.componentList;
  ...
  return a2.clear(), this.setComponentList(i2), lp(this.componentList, this.isResource).then((e3) => {
    Promise.all(e3).then(() => {
      this.setUndoRedoData("初始化"), this.setInitComplete(true);
    });
  }), this.componentList;
  ...
  this.componentList.forEach((e3) => {
    o2(e3), l2(e3), n2(e3), a2(e3), e3.chart.type === ls.MfCombine && e3.chart.options.components.forEach((e4) => {
...
var zr = ((e2) => (e2.All = "all", e2.Chart = "chart", e2.Layer = "layer", e2.Config = "config", e2))(zr || {}), Er = ((e2) => (e2.CurPage = "当前页", e2.NewTab = "新标签", e2.Dialog = "弹出窗", e2))(Er || {}), Pr = ((e2) => (e2.System = "系统页面", e2.External = "外部页面", e2))(Pr || {}), Fr = ((e2) => (e2.FIT_ORIGINAL = "fit_original", e2.FIT_WIDTH = "fit_width", e2.FIT_WIDTH_SCALE = "fit_width_scale", e2.FIT_HEIGHT = "fit_height", e2.FIT_HEIGHT_SCALE = "fit_height_scale", e2.FIT_BOX = "fit_box", e2))(Fr || {});
...
const es = { style: { value: "样式", show: true, payload: { icon: "carbon:color-palette", component: null } }, data: { value: "数据", show: true, payload: { icon: "carbon:data-structured", component: null } }, animation: { value: "动画", show: true, payload: { icon: "carbon:flow-modeler", component: T(nt(() => import("./index2.js"), { loading: true, size: "large" })) } }, advance: { value: "进阶", show: true, payload: { icon: "iconfont:icon-mfish-config", component: T(nt(() => import("./index3.js"), { loading: true, size: "large" })) } } }, ts = (e2) => {
...
function ns() {
  const e2 = async (e3, t3) => {
    ...
    let l2, n2 = {};
    return n2 = t3 ? { ...n2, ...t3 } : ((_a2 = e3 == null ? void 0 : e3.data) == null ? void 0 : _a2.pagination) ? { pageNum: e3.data.pagination.current || 1, pageSize: e3.data.pagination.pageSize } : { pageNum: 1, pageSize: e3.data.limit }, l2 = e3.isResource ? await fr(`${o2.getId},${e3.data.id}`, n2, e3.data.paramsValue) : await ji(e3.data.id, n2, { ...e3.data.paramsValue, _shareToken: o2.getShareToken }), e3.data.headers = l2.headers, e3.data.result = l2.table.list, l2.table;
  };
  async function t2(t3) {
    ...
    t3.type && Gd[t3.type].initData(t3, o2);
  }
...
const rs = (e2, t2) => {
  ...
  switch (e2) {
    ...
    case "mouseLeave":
      return "鼠标离开";
    default:
      return t2 ? ((_b = (_a2 = Gd[t2].customEvents) == null ? void 0 : _a2.find((t3) => t3.value === e2)) == null ? void 0 : _b.name) ?? "" : "";
  }
};
function ss(e2, t2, o2) {
  const l2 = qr(), a2 = (t3, o3) => {
    ((e3) => {
      var _a2;
  ...
  N(() => {
    ...
    setTimeout(async () => {
      for (; !l2.getInitComplete; ) await rt(200);
      setTimeout(() => {
        a2("mounted", {});
      }, 100);
    }, 10);
  ...
  const r2 = { mouseenter: (e3) => {
    ...
    if (o3) {
      ...
      for (const e3 of Object.keys(o3)) o3[e3].type === Gr.EVENT && Ye(o3[e3].value) && o3[e3].value.forEach((o4) => {
        t3.eventId === p2(o4) && (l3[e3] = d2(t3, o4));
      });
  ...
  n(() => e2.data.params, (e3, t3) => {
    !function(e4, t4) {
      ...
      for (const t5 of Object.keys(e4)) Ye(e4[t5].value) && e4[t5].value.forEach((e5) => {
        const t6 = p2(e5);
        o3.has(t6) || (o3.add(t6), as.on(t6, u2));
      });
    }(e3, t3);
  }, { immediate: true, deep: true });
  const f2 = (t3) => {
    ...
    const o3 = (() => {
      ...
      const o4 = (() => {
        ...
        for (const o5 of e2.jump.params) if (o5.type === Gr.CONSTANT) t5[o5.name] = o5.value;
          ...
          const e3 = op(l2.getComponentList, o5.value);
          e3 && (t5[o5.name] = e3);
        }
        return t5;
      })();
      if (((_a3 = e2.jump) == null ? void 0 : _a3.pageType) === Pr.System) {
        t4 = it.resolve({ name: "ScreenPreview", params: { id: (_b2 = e2.jump) == null ? void 0 : _b2.page.value }, query: { shareToken: l2.getShareToken, isResource: (_c3 = l2.getIsResource) == null ? void 0 : _c3.toString(), ...o4 } }).href;
    ...
    switch ((_c2 = e2.jump) == null ? void 0 : _c2.type) {
      ...
      case Er.NewTab:
        ...
        break;
      case Er.Dialog:
        Ud.emit(Hr.SHOW_MODAL, { ...t3, href: o3, jump: e2.jump });
    }
    c2(t3, "page_jump");
  };
  function h2(e3) {
    if (e3) for (const t3 of e3) as.off(p2(t3.event), g2);
  }
  function g2(t3) {
    var _a2, _b;
  ...
  function y2(t3) {
    setTimeout(() => {
      ...
      ((_a2 = e2.data.eventRefresh) == null ? void 0 : _a2.open) && ((_b = e2.data.eventRefresh) == null ? void 0 : _b.events) && (o3(e2).then((t4) => {
        var _a3;
        e2.type && ((_a3 = Gd[e2.type]) == null ? void 0 : _a3.initData(e2, t4));
      }), c2(t3, "refresh"));
    }, 10);
  }
  function m2(t3) {
    Ud.emit(Hr.EVENT_ANIMATION, { ...t3, chart: e2 }), c2(t3, "animation");
  }
  return n(() => e2 == null ? void 0 : e2.jump, (t3) => {
    !function(t4) {
      const o3 = "click" + e2.id;
      as.off(o3, f2), (t4 == null ? void 0 : t4.open) && as.on(o3, f2);
    }(t3);
    ...
    !function(e4, t4) {
      ...
      for (const t5 of e4) {
        ...
        o3.has(e5) || (o3.add(e5), as.on(e5, g2));
      }
    }(e3, t3);
  }, { immediate: true, deep: true }), n(() => {
    var _a2, _b;
    ...
    !function(e4, t4) {
      if (function(e5) {
        if (!e5) return;
        for (const t5 of e5) as.off(p2(t5), y2);
      }(t4), !e4) return;
      const o3 = /* @__PURE__ */ new Set();
      for (const t5 of e4) {
        const e5 = p2(t5);
    ...
    !function(e4, t4) {
      if (function(e5) {
        if (!e5) return;
        for (const t5 of e5) if (t5.events) for (const e6 of t5.events) as.off(p2(e6), m2);
      }(t4), !e4) return;
      const o3 = /* @__PURE__ */ new Set();
      for (const t5 of e4) if (t5.events) for (const e5 of t5.events) {
        const t6 = p2(e5);
        o3.has(t6) || (o3.add(t6), as.on(t6, m2));
      }
    }(e3, t3);
...
const us = e({ name: "MfButton", __name: "index", props: { chart: { type: Object, required: true }, chartContain: { type: Object, required: true } }, setup(e2) {
  const t2 = e2, { commonEvents: o2 } = ss(t2.chart), n2 = l(() => t2.chartContain.dropInfo.width > t2.chartContain.dropInfo.height ? t2.chartContain.dropInfo.height / 2.2 + "px" : t2.chartContain.dropInfo.width / 3 + "px");
  return (t3, l2) => (s(), h(d(at), $({ style: { color: e2.chart.options.iconColor, background: e2.chart.options.buttonColor, fontSize: n2.value } }, B(d(o2)), { type: e2.chart.options.type, ghost: e2.chart.options.ghost, shape: e2.chart.options.shape }), { icon: k(() => {
    var _a2, _b;
    return [((_a2 = e2.chart.data.dataSet) == null ? void 0 : _a2.icon) ? (s(), h(d(Be), { key: 0, size: n2.value, icon: (_b = e2.chart.data.dataSet) == null ? void 0 : _b.icon, color: e2.chart.options.iconColor }, null, 8, ["size", "icon", "color"])) : f("", true)];
  }), default: k(() => {
    var _a2;
...
const ds = { type: ls.MfButton, component: us, create: cs, config: (() => {
  const e2 = qe(es);
...
const fs = { type: ls.MfCombine, component: nt(() => import("./index4.js"), { loading: true }), create: function(e2) {
  ...
  const o2 = e2, a2 = t2, { prefixCls: i2 } = xe("mf-tag"), g2 = l(() => ts(o2.chart)), { emitEvent: y2, commonEvents: m2 } = ss(o2.chart, function(e3) {
    a2("eventHandler", e3);
  }, ["titleChange"]);
  return n(() => {
    var _a2;
    ...
    return s(), r("div", $({ class: d(i2), style: { ...(_b = (_a2 = e2.chart.options) == null ? void 0 : _a2.hAlign) == null ? void 0 : _b.style } }, B(d(m2), true)), [p("div", { class: "title", style: u({ overflow: e2.chart.options.hide ? "hidden" : "", ...(_d2 = (_c2 = e2.chart.options) == null ? void 0 : _c2.vAlign) == null ? void 0 : _d2.style }) }, [((_e2 = e2.chart.data.dataSet) == null ? void 0 : _e2.icon) ? (s(), h(d(Be), { key: 0, size: g2.value.fontSize, icon: (_f2 = e2.chart.data.dataSet) == null ? void 0 : _f2.icon, color: e2.chart.options.iconColor }, null, 8, ["size", "icon", "color"])) : f("", true), p("span", { class: c({ hide: e2.chart.options.hide }), style: u(g2.value) }, S((_g2 = e2.chart.data.dataSet) == null ? void 0 : _g2.title), 7)], 4)], 16);
  };
} }), [["__scopeId", "data-v-540aeb6f"]]);
function ys(e2) {
  return e2.chart.data.dataSet = qe(ms.defaultData), e2.chart.data.headers = ms.defaultHeaders && ms.defaultHeaders(), e2.chart.data.limit = 1, e2.chart.data.maxLimit = 1, e2.chart.options.bordered = true, e2.chartContain.dropInfo.width = 80, e2.chartContain.dropInfo.height = 34, e2;
}
const ms = { type: ls.MfTag, component: gs, create: ys, config: (() => {
  const e2 = qe(es);
...
}, customEvents: [{ name: "标签值改变", value: "titleChange" }] }, vs = Object.freeze(Object.defineProperty({ __proto__: null, default: ms, mfTagCreate: ys }, Symbol.toStringTag, { value: "Module" })), Cs = { ...ms, type: ls.MfDataTag, component: nt(() => import("./index5.js"), { loading: true }), config: (() => {
  const e2 = qe(es);
...
function bs() {
  ...
  return { clearTitle: e2, clearIcon: t2, setDynamicData: function(o2, l2) {
    var _a2, _b, _c2;
    if (o2) {
      if (o2.data.dataSet || (o2.data.dataSet = {}), ((_a2 = l2 == null ? void 0 : l2.list) == null ? void 0 : _a2.length) > 0) {
        ...
        return void (a2 && a2.length > 0 && a2[0].colName ? o2.data.dataSet.icon = l2.list[0][a2[0].colName] : t2(o2));
      }
      e2(o2), t2(o2);
    }
  } };
}
const ks = Object.freeze(Object.defineProperty({ __proto__: null, default: Cs, useDataTag: bs }, Symbol.toStringTag, { value: "Module" }));
function Ms() {
  const e2 = qr(), { getDataTable: t2, setDataTable: o2 } = ns(), l2 = () => {
  ...
  return { setFields: (t3, o3) => {
    ...
    e2.getCurConfigComponent.chart.data.fields && (delete e2.getCurConfigComponent.chart.data.fields[t3], l2());
  }, deleteFieldValue: (t3, o3) => {
    var _a2, _b;
    const l3 = (_b = (_a2 = e2.getCurConfigComponent.chart.data) == null ? void 0 : _a2.fields[t3]) == null ? void 0 : _b.findIndex((e3) => e3.colName === o3);
    l3 >= 0 && e2.getCurConfigComponent.chart.data.fields[t3].splice(l3, 1);
  }, getDataTable: async (o3) => await t2(e2.getCurConfigComponent.chart, o3), setDataTable: l2 };
}
function ws(e2) {
...
const xs = { type: ls.MfDigits, component: nt(() => import("./index6.js"), { loading: true }), create: ws, config: (() => {
  const e2 = qe(es);
...
function Ss() {
  const { createMessage: e2 } = _e(), { deleteFields: t2 } = Ms();
  function o2(e3) {
...
const Ls = { type: ls.MfWheel, component: nt(() => import("./index7.js"), { loading: true }), create: $s, config: (() => {
  const e2 = qe(es);
...
function Is(e2) {
  const { createMessage: t2 } = _e(), { deleteFields: o2 } = Ms();
  function l2(e3) {
  ...
  return { resetDefault: l2, setDynamicData: function(n2, a2) {
    var _a2;
    if (n2) {
      if (((_a2 = a2 == null ? void 0 : a2.list) == null ? void 0 : _a2.length) > 0 && n2.data.fields) {
...
const Ds = Object.freeze(Object.defineProperty({ __proto__: null, default: Ls, mfWheelCreate: $s, useWheelData: Is }, Symbol.toStringTag, { value: "Module" }));
function Ts(e2) {
...
const Ns = { ...Ls, component: nt(() => import("./index8.js"), { loading: true }), type: ls.MfTireMarks, create: Ts, config: (() => {
  const e2 = qe(es);
...
const qs = { type: ls.MfBorder1, component: nt(() => import("./index9.js"), { loading: true }), create: Rs, config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfBorderConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, As = Object.freeze(Object.defineProperty({ __proto__: null, default: qs, mfBorder1Create: Rs }, Symbol.toStringTag, { value: "Module" })), Os = { ...qs, type: ls.MfBorder10, component: nt(() => import("./index10.js"), { loading: true }) }, js = Object.freeze(Object.defineProperty({ __proto__: null, default: Os }, Symbol.toStringTag, { value: "Module" }));
function zs(e2) {
...
const Es = { type: ls.MfBorder11, component: nt(() => import("./index11.js"), { loading: true }), create: zs, config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfBorder11Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Ps = Object.freeze(Object.defineProperty({ __proto__: null, default: Es, mfBorder11Create: zs }, Symbol.toStringTag, { value: "Module" })), Fs = { ...qs, type: ls.MfBorder12, component: nt(() => import("./index12.js"), { loading: true }) }, Hs = Object.freeze(Object.defineProperty({ __proto__: null, default: Fs }, Symbol.toStringTag, { value: "Module" })), Qs = { ...qs, type: ls.MfBorder13, component: nt(() => import("./index13.js"), { loading: true }) }, Gs = Object.freeze(Object.defineProperty({ __proto__: null, default: Qs }, Symbol.toStringTag, { value: "Module" }));
function Us(e2) {
  const t2 = qs.create(e2);
  return t2.chartContain.border.radius = 0, t2;
}
const Vs = { ...qs, type: ls.MfBorder14, component: nt(() => import("./index14.js"), { loading: true }), create: Us }, Ws = Object.freeze(Object.defineProperty({ __proto__: null, default: Vs, mfBorder14Create: Us }, Symbol.toStringTag, { value: "Module" })), Ys = { ...Vs, type: ls.MfBorder15, component: nt(() => import("./index15.js"), { loading: true }) }, Zs = Object.freeze(Object.defineProperty({ __proto__: null, default: Ys }, Symbol.toStringTag, { value: "Module" })), Ks = { ...Vs, type: ls.MfBorder16, component: nt(() => import("./index16.js"), { loading: true }) }, Xs = Object.freeze(Object.defineProperty({ __proto__: null, default: Ks }, Symbol.toStringTag, { value: "Module" })), Js = { ...Vs, type: ls.MfBorder17, component: nt(() => import("./index17.js"), { loading: true }) }, eu = Object.freeze(Object.defineProperty({ __proto__: null, default: Js }, Symbol.toStringTag, { value: "Module" })), tu = { ...Vs, type: ls.MfBorder18, component: nt(() => import("./index18.js"), { loading: true }) }, ou = Object.freeze(Object.defineProperty({ __proto__: null, default: tu }, Symbol.toStringTag, { value: "Module" })), lu = { ...Vs, type: ls.MfBorder19, component: nt(() => import("./index19.js"), { loading: true }) }, nu = Object.freeze(Object.defineProperty({ __proto__: null, default: lu }, Symbol.toStringTag, { value: "Module" })), au = { ...qs, type: ls.MfBorder2, component: nt(() => import("./index20.js"), { loading: true }) }, iu = Object.freeze(Object.defineProperty({ __proto__: null, default: au }, Symbol.toStringTag, { value: "Module" })), ru = { ...Vs, type: ls.MfBorder20, component: nt(() => import("./index21.js"), { loading: true }) }, su = Object.freeze(Object.defineProperty({ __proto__: null, default: ru }, Symbol.toStringTag, { value: "Module" })), uu = { ...Vs, type: ls.MfBorder21, component: nt(() => import("./index22.js"), { loading: true }) }, cu = Object.freeze(Object.defineProperty({ __proto__: null, default: uu }, Symbol.toStringTag, { value: "Module" })), du = { ...Vs, type: ls.MfBorder22, component: nt(() => import("./index23.js"), { loading: true }) }, pu = Object.freeze(Object.defineProperty({ __proto__: null, default: du }, Symbol.toStringTag, { value: "Module" })), fu = { ...qs, type: ls.MfBorder3, component: nt(() => import("./index24.js"), { loading: true }) }, hu = Object.freeze(Object.defineProperty({ __proto__: null, default: fu }, Symbol.toStringTag, { value: "Module" })), gu = { ...qs, type: ls.MfBorder4, component: nt(() => import("./index25.js"), { loading: true }), config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfBorder4Config.js"), { loading: true, size: "large" })), e2;
})() }, yu = Object.freeze(Object.defineProperty({ __proto__: null, default: gu }, Symbol.toStringTag, { value: "Module" })), mu = { ...gu, type: ls.MfBorder5, component: nt(() => import("./index26.js"), { loading: true }) }, vu = Object.freeze(Object.defineProperty({ __proto__: null, default: mu }, Symbol.toStringTag, { value: "Module" })), Cu = { ...qs, type: ls.MfBorder6, component: nt(() => import("./index27.js"), { loading: true }) }, bu = Object.freeze(Object.defineProperty({ __proto__: null, default: Cu }, Symbol.toStringTag, { value: "Module" })), ku = { ...qs, type: ls.MfBorder7, component: nt(() => import("./index28.js"), { loading: true }) }, Mu = Object.freeze(Object.defineProperty({ __proto__: null, default: ku }, Symbol.toStringTag, { value: "Module" }));
function wu(e2) {
...
const xu = { type: ls.MfBorder8, component: nt(() => import("./index29.js"), { loading: true }), create: wu, config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfBorder8Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Su = Object.freeze(Object.defineProperty({ __proto__: null, default: xu, mfBorder8Create: wu }, Symbol.toStringTag, { value: "Module" })), _u = { ...qs, type: ls.MfBorder9, component: nt(() => import("./index30.js"), { loading: true }) }, $u = Object.freeze(Object.defineProperty({ __proto__: null, default: _u }, Symbol.toStringTag, { value: "Module" }));
function Lu(e2) {
...
const Iu = { type: ls.MfDecoration1, component: nt(() => import("./index31.js"), { loading: true }), create: Lu, config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Du = Object.freeze(Object.defineProperty({ __proto__: null, default: Iu, mfDecoration1Create: Lu }, Symbol.toStringTag, { value: "Module" }));
function Tu(e2) {
...
const Nu = { type: ls.MfDecoration10, component: nt(() => import("./index32.js"), { loading: true }), create: Tu, config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const qu = { type: ls.MfDecoration11, component: nt(() => import("./index33.js"), { loading: true }), create: Ru, config: (() => {
  const e2 = qe(es);
...
const ju = { type: ls.MfDecoration12, component: nt(() => import("./index34.js"), { loading: true }), create: Ou, config: (() => {
  const e2 = qe(es);
...
const Pu = { type: ls.MfDecoration2, component: nt(() => import("./index35.js"), { loading: true }), create: Eu, config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecoration2Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Fu = Object.freeze(Object.defineProperty({ __proto__: null, default: Pu, mfDecoration2Create: Eu }, Symbol.toStringTag, { value: "Module" }));
function Hu(e2) {
...
const Qu = { type: ls.MfDecoration3, component: nt(() => import("./index36.js"), { loading: true }), create: Hu, config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const Vu = { type: ls.MfDecoration4, component: nt(() => import("./index37.js"), { loading: true }), create: Uu, config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecoration2Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const Zu = { type: ls.MfDecoration5, component: nt(() => import("./index38.js"), { loading: true }), create: Yu, config: (() => {
  const e2 = qe(es);
...
const Ju = { type: ls.MfDecoration6, component: nt(() => import("./index39.js"), { loading: true }), create: Xu, config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const oc = { type: ls.MfDecoration7, component: nt(() => import("./index40.js"), { loading: true }), create: tc, config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecoration7Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, lc = Object.freeze(Object.defineProperty({ __proto__: null, default: oc, mfDecoration7Create: tc }, Symbol.toStringTag, { value: "Module" }));
function nc(e2) {
...
const ac = { type: ls.MfDecoration8, component: nt(() => import("./index41.js"), { loading: true }), create: nc, config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecoration8Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, ic = Object.freeze(Object.defineProperty({ __proto__: null, default: ac, mfDecoration8Create: nc }, Symbol.toStringTag, { value: "Module" }));
function rc(e2) {
...
const sc = { type: ls.MfDecoration9, component: nt(() => import("./index42.js"), { loading: true }), create: rc, config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecoration5Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const dc = { type: ls.MfHeader1, create: cc, component: nt(() => import("./index43.js"), { loading: true }), config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const hc = { type: ls.MfHeader2, create: fc, component: nt(() => import("./index44.js"), { loading: true }), config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const mc = { type: ls.MfHeader3, create: yc, component: nt(() => import("./index45.js"), { loading: true }), config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, vc = Object.freeze(Object.defineProperty({ __proto__: null, default: mc, mfHeader3Create: yc }, Symbol.toStringTag, { value: "Module" }));
function Cc(e2) {
...
const bc = { type: ls.MfHeader4, create: Cc, component: nt(() => import("./index46.js"), { loading: true }), config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, kc = Object.freeze(Object.defineProperty({ __proto__: null, default: bc, mfHeader4Create: Cc }, Symbol.toStringTag, { value: "Module" }));
function Mc(e2) {
  return e2.chartContain.dropInfo.width = 1920, e2.chartContain.dropInfo.height = 75, e2.chart.options.mainColor = "#0077CF", e2.chart.options.secondColor = "#0042A2", e2;
}
const wc = { type: ls.MfHeader5, create: Mc, component: nt(() => import("./index47.js"), { loading: true }), config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, xc = Object.freeze(Object.defineProperty({ __proto__: null, default: wc, mfHeader5Create: Mc }, Symbol.toStringTag, { value: "Module" }));
function Sc(e2) {
...
const _c = { type: ls.MfHeader6, create: Sc, component: nt(() => import("./index48.js"), { loading: true }), config: (() => {
  const e2 = qe(es);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
  ...
  }), (t3, l3) => (s(), h(gs, { "chart-contain": e2.chartContain, chart: o2.value }, null, 8, ["chart-contain", "chart"]));
} });
function Ic(e2) {
  return e2.chart.data.dataSet = qe(Dc.defaultData), e2.chart.data.headers = Dc.defaultHeaders && Dc.defaultHeaders(), e2.chart.data.limit = 1, e2.chart.data.maxLimit = 1, e2.chartContain.dropInfo.width = 190, e2.chartContain.dropInfo.height = 34, e2;
}
const Dc = { type: ls.MfDateTime, component: Lc, create: Ic, config: (() => {
  const e2 = qe(es);
...
} }, Tc = Object.freeze(Object.defineProperty({ __proto__: null, default: Dc, mfDateTimeCreate: Ic }, Symbol.toStringTag, { value: "Module" }));
function Nc() {
  const e2 = (e3, t3) => {
    var _a2;
  ...
  function t2(t3) {
    var _a2;
    ((_a2 = t3 == null ? void 0 : t3.data) == null ? void 0 : _a2.dataSet) && (t3 == null ? void 0 : t3.type) && (t3.data.dataSet = qe(Gd[t3.type].defaultData), t3.options.series = e2(t3, Gd[t3.type].defaultSeries || []));
  }
  return { resetDefault: t2, setDynamicData: function(o2, l2) {
    ...
    if (o2) {
      if ((l2 == null ? void 0 : l2.list.length) > 0 && o2.data.fields && (((_b = (_a2 = o2.data.fields) == null ? void 0 : _a2.dimensions) == null ? void 0 : _b.length) > 0 || ((_d2 = (_c2 = o2.data.fields) == null ? void 0 : _c2.source) == null ? void 0 : _d2.length) > 0)) {
        const { createMessage: n2 } = _e(), { deleteFieldValue: a2 } = Ms(), i2 = o2.data.fields.dimensions ?? [], r2 = o2.data.fields.source ?? [];
...
const Bc = { type: ls.MfBar, component: nt(() => import("./index49.js"), { loading: true, size: "large" }), create: function(e2) {
...
const qc = { ...Bc, type: ls.MfBarHorizontal, create: function(e2) {
...
const Oc = { ...Bc, type: ls.MfBarStack, create: function(e2) {
  const t2 = Bc.create(e2);
...
const zc = { ...Oc, type: ls.MfBarLine, defaultSeries: [{ type: "bar" }, { type: "line" }], create: function(e2) {
...
const Pc = { ...Bc, type: ls.MfBarPlusMinus, create: function(e2) {
  const t2 = Bc.create(e2);
...
}, defaultData: { source: [["维度", "数据"], ["ten", -0.07], ["nine", -0.09], ["eight", 0.2], ["seven", -0.44], ["six", -0.23], ["five", 0.08], ["four", -0.17], ["three", 0.47], ["two", -0.36], ["one", 0.18]] } }, Fc = Object.freeze(Object.defineProperty({ __proto__: null, default: Pc }, Symbol.toStringTag, { value: "Module" }));
const Hc = { ...Bc, type: ls.MfLine, create: function(e2) {
...
const Gc = { ...Hc, type: ls.MfLineArea, create: function(e2) {
...
const Vc = { ...Oc, type: ls.MfLineAreaStack, create: function(e2) {
  const t2 = Oc.create(e2);
...
const Yc = { ...Hc, type: ls.MfLineSmooth, create: function(e2) {
  const t2 = Hc.create(e2);
...
const Kc = { ...Oc, type: ls.MfLineStack, create: function(e2) {
  const t2 = Oc.create(e2);
...
const ed = { type: ls.MfMapLine, component: nt(() => import("./index50.js"), { loading: true, size: "large" }), create: function(e2) {
  return e2.chart.data.dataSet = qe(ed.defaultData), e2.chart.data.headers = ed.defaultHeaders && ed.defaultHeaders(e2.chart), e2.chart.data.limit = 100, e2.chart.data.maxLimit = 1e3, e2.chart.options = { tooltip: { show: true }, geo: { map: "china", scale: true, zoom: 1.2, scaleLimit: { min: 0.5, max: 2 }, emphasis: { itemStyle: { color: "#3146B3" } }, itemStyle: { color: "#03133D", borderColor: "#6699FF", shadowColor: "#1773C3", shadowBlur: 10, borderWidth: 1 }, label: { color: "#ffffff", emphasis: { color: "#ffffff" } } }, visualMap: { show: false, min: 0, max: 100, text: ["高", "低"], realtime: false, calculable: true, inRange: { color: qe(Jc[0].color) } }, series: qe(ed.defaultSeries) }, e2.chartContain.dropInfo.width = 800, e2.chartContain.dropInfo.height = 650, e2;
}, config: (() => {
  const e2 = qe(es);
  return e2.style.payload.component = T(nt(() => import("./MfMapConfig.js"), { loading: true, size: "large" })), e2.data.payload.component = T(nt(() => import("./MfMapLineDataConfig.js"), { loading: true, size: "large" })), e2;
  ...
  return { resetDefault: e2, setDynamicData: function(t2, o2) {
    ...
    if (t2) {
      if ((o2 == null ? void 0 : o2.list.length) > 0 && t2.data.fields && (((_b = (_a2 = t2.data.fields) == null ? void 0 : _a2.start) == null ? void 0 : _b.length) > 0 || ((_d2 = (_c2 = t2.data.fields) == null ? void 0 : _c2.end) == null ? void 0 : _d2.length) > 0)) {
        const { createMessage: l2 } = _e(), { deleteFieldValue: n2 } = Ms(), a2 = t2.data.fields.start ?? [], i2 = t2.data.fields.end ?? [], r2 = t2.data.fields.value ?? [];
...
const od = Object.freeze(Object.defineProperty({ __proto__: null, default: ed, useEchartsMapLineData: td }, Symbol.toStringTag, { value: "Module" }));
const ld = { ...ed, type: ls.MfMapLine3D, component: nt(() => import("./index51.js"), { loading: true, size: "large" }), create: function(e2) {
  var _a2;
  const t2 = ed.create(e2);
  return (_a2 = t2.chart.options) == null ? true : delete _a2.geo, t2.chart.options = { ...t2.chart.options, geo3D: { map: "china", shading: "lambert", viewControl: { distance: 85, rotateSensitivity: 0, zoomSensitivity: 0 }, light: { main: { intensity: 1.2, shadow: true } }, itemStyle: { color: "#03133D", borderColor: "#6699FF", shadowColor: "#1773C3", shadowBlur: 10, borderWidth: 1 }, emphasis: { itemStyle: { color: "#3146B3" } }, label: { distance: 0, color: "#ffffff", emphasis: { color: "#ffffff" } } }, series: qe(ld.defaultSeries) }, t2;
}, defaultSeries: [{ name: "飞线图", type: "lines3D", coordinateSystem: "geo3D", effect: { show: true, trailWidth: 2, trailLength: 0.8, trailOpacity: 0.8, trailColor: "#fff" }, lineStyle: { width: 1, curveness: 0.2 } }, { name: "城市", type: "scatter3D", coordinateSystem: "geo3D", rippleEffect: { brushType: "stroke" }, label: { show: true, position: "right", formatter: "{b}" } }] }, nd = Object.freeze(Object.defineProperty({ __proto__: null, default: ld }, Symbol.toStringTag, { value: "Module" }));
const ad = { ...Bc, type: ls.MfPie, create: function(e2) {
  return e2.chart.data.dataSet = qe(ad.defaultData), e2.chart.data.headers = ad.defaultHeaders && ad.defaultHeaders(e2.chart), e2.chart.data.limit = 100, e2.chart.data.maxLimit = 1e3, e2.chartContain.dropInfo.width = 400, e2.chartContain.dropInfo.height = 400, e2.chart.options = { tooltip: { trigger: "item" }, series: qe(ad.defaultSeries) }, e2;
}, config: (() => {
  const e2 = qe(es);
...
})(), defaultSeries: [{ type: "pie", radius: ["0%", "65%"] }] }, id = Object.freeze(Object.defineProperty({ __proto__: null, default: ad }, Symbol.toStringTag, { value: "Module" }));
const rd = { ...ad, type: ls.MfPieCircular, create: function(e2) {
  const t2 = ad.create(e2);
  return t2.chart.options.series = qe(rd.defaultSeries), t2;
}, defaultSeries: [{ type: "pie", radius: ["30%", "65%"] }] }, sd = Object.freeze(Object.defineProperty({ __proto__: null, default: rd }, Symbol.toStringTag, { value: "Module" }));
const ud = { ...ad, type: ls.MfPieHalf, create: function(e2) {
  const t2 = ad.create(e2);
  return t2.chart.options.series = qe(ud.defaultSeries), t2;
}, defaultSeries: [{ type: "pie", center: ["50%", "70%"], radius: ["30%", "65%"], startAngle: 180, endAngle: 360 }] }, cd = Object.freeze(Object.defineProperty({ __proto__: null, default: ud }, Symbol.toStringTag, { value: "Module" }));
const dd = { ...ad, type: ls.MfPieRose, create: function(e2) {
  const t2 = ad.create(e2);
  return t2.chart.options.series = qe(dd.defaultSeries), t2;
}, defaultSeries: [{ type: "pie", roseType: "area", radius: ["10%", "65%"], itemStyle: { borderRadius: 8 } }] }, pd = Object.freeze(Object.defineProperty({ __proto__: null, default: dd }, Symbol.toStringTag, { value: "Module" }));
const fd = { component: nt(() => import("./index52.js"), { loading: true, size: "large" }), type: ls.MfRadar, create: function(e2) {
  return e2.chart.data.dataSet = qe(fd.defaultData), e2.chart.data.headers = fd.defaultHeaders && fd.defaultHeaders(), e2.chart.data.limit = 5, e2.chart.data.maxLimit = 20, e2.chartContain.dropInfo.width = 400, e2.chartContain.dropInfo.height = 400, e2.chart.options = { series: qe(fd.defaultSeries) }, e2;
}, config: (() => {
  const e2 = qe(es);
  ...
  const { setDynamicData: o2 } = hd();
  o2(e2, t2);
} };
function hd() {
  const { createMessage: e2 } = _e(), { deleteFieldValue: t2 } = Ms();
  function o2(e3) {
    e3.data.dataSet = qe(fd.defaultData);
  }
  return { resetDefault: o2, setDynamicData: function(l2, n2) {
    var _a2, _b, _c2, _d2, _e2, _f2, _g2;
    if (l2) if (n2 && 0 !== n2.list.length && l2.data.fields) if (((_b = (_a2 = l2.data.fields) == null ? void 0 : _a2.dimensions) == null ? void 0 : _b.length) > 0 || ((_d2 = (_c2 = l2.data.fields) == null ? void 0 : _c2.source) == null ? void 0 : _d2.length) > 0) {
      if (((_f2 = (_e2 = l2.data.fields) == null ? void 0 : _e2.source) == null ? void 0 : _f2.length) > 0) {
        ...
        for (const a2 of n2.list) {
          ...
          let i2 = "";
          ((_g2 = l2.data.fields.dimensions) == null ? void 0 : _g2.length) > 0 && (i2 = a2[l2.data.fields.dimensions[0].colName]), o3.push({ name: i2, value: n3 });
        }
...
const gd = Object.freeze(Object.defineProperty({ __proto__: null, default: fd, useRadarData: hd }, Symbol.toStringTag, { value: "Module" }));
const yd = { ...fd, type: ls.MfRadarCircle, create: function(e2) {
  const t2 = fd.create(e2);
  return t2.chart.options = { ...t2.chart.options, radar: { shape: "circle" } }, e2;
} }, md = Object.freeze(Object.defineProperty({ __proto__: null, default: yd }, Symbol.toStringTag, { value: "Module" }));
const vd = { ...Bc, type: ls.MfScatter, create: function(e2) {
  return e2.chart.data.dataSet = qe(vd.defaultData), e2.chart.data.headers = vd.defaultHeaders && vd.defaultHeaders(e2.chart), e2.chart.data.limit = 100, e2.chart.data.maxLimit = 1e3, e2.chartContain.dropInfo.width = 400, e2.chartContain.dropInfo.height = 300, e2.chart.options = { grid: { left: "10%", right: "10%", top: "10%", bottom: "10%" }, xAxis: { show: true }, yAxis: { show: true }, series: qe(vd.defaultSeries) }, e2;
}, config: (() => {
  const e2 = qe(es);
...
})(), defaultData: { source: [["数据1", "数据2"], [10, 8.04], [8.07, 6.95], [13, 7.58], [9.05, 8.81], [11, 8.33], [14, 7.66], [13.4, 6.81], [10, 6.33], [14, 8.96], [12.5, 6.82], [9.15, 7.2], [11.5, 7.2], [3.03, 4.23], [12.2, 7.83], [2.02, 4.47], [1.05, 3.33], [4.05, 4.96], [6.03, 7.24], [12, 6.26], [12, 8.84], [7.08, 5.82], [5.02, 5.68]] }, defaultSeries: [{ type: "scatter" }] }, Cd = Object.freeze(Object.defineProperty({ __proto__: null, default: vd }, Symbol.toStringTag, { value: "Module" })), bd = e({ name: "MfPicture", __name: "index", props: { chart: { type: Object, required: true }, chartContain: { type: Object, required: true } }, setup(e2) {
  ...
  return (t3, l2) => {
    var _a2;
    return s(), h(d(X), $({ src: n2.value, alt: ((_a2 = e2.chart.data.dataSet) == null ? void 0 : _a2.alt) || "图片" }, e2.chart.options, { width: e2.chartContain.dropInfo.width - 2, height: e2.chartContain.dropInfo.height - 2, fallback: d(ot) }, B(d(o2))), null, 16, ["src", "alt", "width", "height", "fallback"]);
  };
} });
function kd(e2) {
  return e2.chart.data.dataSet = qe(Md.defaultData), e2.chart.data.headers = Md.defaultHeaders && Md.defaultHeaders(), e2.chart.data.limit = 1, e2.chart.data.maxLimit = 1, e2.chart.options.preview = false, e2.chartContain.dropInfo.width = 200, e2.chartContain.dropInfo.height = 200, e2;
}
const Md = { type: ls.MfPicture, component: bd, create: kd, config: (() => {
  const e2 = qe(es);
...
} }, wd = Object.freeze(Object.defineProperty({ __proto__: null, default: Md, mfPictureCreate: kd }, Symbol.toStringTag, { value: "Module" }));
function xd(e2) {
  return e2.chart.data.dataSet = qe(Sd.defaultData), e2.chart.data.headers = Sd.defaultHeaders && Sd.defaultHeaders(e2.chart), e2.chart.data.limit = 50, e2.chart.data.maxLimit = 1e3, e2.chartContain.dropInfo.width = 600, e2.chartContain.dropInfo.height = 300, e2.chart.options = { indexHeader: "序号", showHeader: true, index: true }, e2;
}
const Sd = { type: ls.MfScrollTable, component: nt(() => import("./index53.js"), { loading: true }), create: xd, config: (() => {
  const e2 = qe(es);
  ...
  const { setDynamicData: o2 } = _d();
  o2(e2, t2);
}, customEvents: [{ name: "行点击", value: "rowClick" }] };
function _d() {
  function e2(e3) {
    e3.data.dataSet = qe(Sd.defaultData);
  }
  return { resetDefault: e2, setDynamicData: function(t2, o2) {
    var _a2, _b;
    if (!t2) return;
...
const $d = Object.freeze(Object.defineProperty({ __proto__: null, default: Sd, mfScrollTableCreate: xd, useDataScrollTable: _d }, Symbol.toStringTag, { value: "Module" }));
function Ld(e2) {
  return e2.chart.data.dataSet = qe(Id.defaultData), e2.chart.data.headers = Id.defaultHeaders && Id.defaultHeaders(e2.chart), e2.chart.data.limit = 10, e2.chart.data.maxLimit = 1e3, e2.chartContain.dropInfo.width = 600, e2.chartContain.dropInfo.height = 50, e2;
}
const Id = { type: ls.MfSegmented, component: nt(() => import("./index54.js"), { loading: true }), create: Ld, config: (() => {
  const e2 = qe(es);
...
const Td = Object.freeze(Object.defineProperty({ __proto__: null, default: Id, mfSegmentedCreate: Ld, useSegmented: Dd }, Symbol.toStringTag, { value: "Module" }));
function Nd(e2) {
  return e2.chart.data.dataSet = qe(Bd.defaultData), e2.chartContain.border.show = true, e2.chart.data.headers = Bd.defaultHeaders && Bd.defaultHeaders(e2.chart), e2.chart.data.limit = 10, e2.chart.data.maxLimit = 1e3, e2.chartContain.dropInfo.width = 150, e2.chartContain.dropInfo.height = 33, e2;
}
const Bd = { type: ls.MfSelect, component: nt(() => import("./index55.js"), { loading: true }), create: Nd, config: (() => {
  const e2 = qe(es);
...
function Rd() {
  function e2(e3) {
    e3.data.dataSet = qe(Bd.defaultData);
  }
  return { resetDefault: e2, setDynamicData: function(t2, o2) {
    var _a2, _b, _c2;
    if (t2) {
      if (((_a2 = o2 == null ? void 0 : o2.list) == null ? void 0 : _a2.length) > 0) {
        t2.data.dataSet = [];
        for (const e3 of o2.list) {
          const o3 = { label: "", value: "" }, l2 = (_b = t2.data.fields) == null ? void 0 : _b.label;
          l2 && l2.length > 0 && l2[0].colName && (o3.label = e3[l2[0].colName]);
          const n2 = (_c2 = t2.data.fields) == null ? void 0 : _c2.value;
...
const qd = Object.freeze(Object.defineProperty({ __proto__: null, default: Bd, mfSelectCreate: Nd, useSelect: Rd }, Symbol.toStringTag, { value: "Module" }));
function Ad(e2) {
...
const Od = [{ title: "姓名", dataIndex: "name" }, { title: "年龄", dataIndex: "age" }, { title: "地址", dataIndex: "address" }], jd = { type: ls.MfTable, component: nt(() => import("./index56.js"), { loading: true }), create: Ad, config: (() => {
  const e2 = qe(es);
...
function zd() {
  function e2(e3) {
    e3.data.dataSet = qe(jd.defaultData), e3.options.tableInfo.columns = qe(Od), e3.data.pagination = { pageSize: e3.data.pagination.pageSize }, e3.options.index && e3.options.tableInfo.columns.unshift({ title: e3.options.indexHeader || "序号", width: 80, align: "center", ellipsis: true });
  }
  return { resetDefault: e2, setDynamicData: function(t2, o2) {
    var _a2;
    if (!t2) return;
...
}, Qd = Object.assign({ "./MfButton/mfButton.data.ts": ps, "./MfCombine/mfCombine.data.ts": hs, "./MfDataTag/mfDataTag.data.ts": ks, "./MfDataUi/MfDigits/mfDigits.data.ts": _s, "./MfDataUi/MfTireMarks/mfTireMarks.data.ts": Bs, "./MfDataUi/MfWheel/mfWheel.data.ts": Ds, "./MfDataV/MfBorder1/mfBorder1.data.ts": As, "./MfDataV/MfBorder10/mfBorder10.data.ts": js, "./MfDataV/MfBorder11/mfBorder11.data.ts": Ps, "./MfDataV/MfBorder12/mfBorder12.data.ts": Hs, "./MfDataV/MfBorder13/mfBorder13.data.ts": Gs, "./MfDataV/MfBorder14/mfBorder14.data.ts": Ws, "./MfDataV/MfBorder15/mfBorder15.data.ts": Zs, "./MfDataV/MfBorder16/mfBorder16.data.ts": Xs, "./MfDataV/MfBorder17/mfBorder17.data.ts": eu, "./MfDataV/MfBorder18/mfBorder18.data.ts": ou, "./MfDataV/MfBorder19/mfBorder19.data.ts": nu, "./MfDataV/MfBorder2/mfBorder2.data.ts": iu, "./MfDataV/MfBorder20/mfBorder20.data.ts": su, "./MfDataV/MfBorder21/mfBorder21.data.ts": cu, "./MfDataV/MfBorder22/mfBorder22.data.ts": pu, "./MfDataV/MfBorder3/mfBorder3.data.ts": hu, "./MfDataV/MfBorder4/mfBorder4.data.ts": yu, "./MfDataV/MfBorder5/mfBorder5.data.ts": vu, "./MfDataV/MfBorder6/mfBorder6.data.ts": bu, "./MfDataV/MfBorder7/mfBorder7.data.ts": Mu, "./MfDataV/MfBorder8/mfBorder8.data.ts": Su, "./MfDataV/MfBorder9/mfBorder9.data.ts": $u, "./MfDataV/MfDecoration1/mfDecoration.data.ts": Du, "./MfDataV/MfDecoration10/mfDecoration.data.ts": Bu, "./MfDataV/MfDecoration11/mfDecoration.data.ts": Au, "./MfDataV/MfDecoration12/mfDecoration.data.ts": zu, "./MfDataV/MfDecoration2/mfDecoration.data.ts": Fu, "./MfDataV/MfDecoration3/mfDecoration.data.ts": Gu, "./MfDataV/MfDecoration4/mfDecoration.data.ts": Wu, "./MfDataV/MfDecoration5/mfDecoration.data.ts": Ku, "./MfDataV/MfDecoration6/mfDecoration.data.ts": ec, "./MfDataV/MfDecoration7/mfDecoration.data.ts": lc, "./MfDataV/MfDecoration8/mfDecoration.data.ts": ic, "./MfDataV/MfDecoration9/mfDecoration.data.ts": uc, "./MfDataV/MfHeader1/mfHeader1.data.ts": pc, "./MfDataV/MfHeader2/mfHeader2.data.ts": gc, "./MfDataV/MfHeader3/mfHeader3.data.ts": vc, "./MfDataV/MfHeader4/mfHeader4.data.ts": kc, "./MfDataV/MfHeader5/mfHeader5.data.ts": xc, "./MfDataV/MfHeader6/mfHeader6.data.ts": $c, "./MfDateTime/mfDateTime.data.ts": Tc, "./MfEcharts/MfBar/mfBar.data.ts": Rc, "./MfEcharts/MfBarHorizontal/mfBarHorizontal.data.ts": Ac, "./MfEcharts/MfBarLine/mfBarLine.data.ts": Ec, "./MfEcharts/MfBarPlusMinus/mfBarPlusMinus.data.ts": Fc, "./MfEcharts/MfBarStack/mfBarStack.data.ts": jc, "./MfEcharts/MfLine/mfLine.data.ts": Qc, "./MfEcharts/MfLineArea/mfLineArea.data.ts": Uc, "./MfEcharts/MfLineAreaStack/mfLineAreaStack.data.ts": Wc, "./MfEcharts/MfLineSmooth/mfLineSmooth.data.ts": Zc, "./MfEcharts/MfLineStack/mfLineStack.data.ts": Xc, "./MfEcharts/MfMapLine/mfMapLine.data.ts": od, "./MfEcharts/MfMapLine3D/mfMapLine3D.data.ts": nd, "./MfEcharts/MfPie/mfPie.data.ts": id, "./MfEcharts/MfPieCircular/mfPieCircular.data.ts": sd, "./MfEcharts/MfPieHalf/mfPieHalf.data.ts": cd, "./MfEcharts/MfPieRose/mfPieRose.data.ts": pd, "./MfEcharts/MfRadar/mfRadar.data.ts": gd, "./MfEcharts/MfRadarCircle/mfRadarCircle.data.ts": md, "./MfEcharts/MfScatter/mfScatter.data.ts": Cd, "./MfPicture/mfPicture.data.ts": wd, "./MfScrollTable/mfScrollTable.data.ts": $d, "./MfSegmented/mfSegmented.data.ts": Td, "./MfSelect/mfSelect.data.ts": qd, "./MfTable/mfTable.data.ts": Ed, "./MfTag/mfTag.data.ts": vs });
const Gd = { ...function() {
  const e2 = {};
  return Object.keys(Qd).forEach((t2) => {
    const o2 = Qd[t2].default;
    e2[o2.type] = o2;
  }), e2;
}() }, Ud = lt();
function Vd(e2) {
...
function Yd(e2, t2, o2) {
  const l2 = qe(e2);
  if (!l2.chart.type) return;
  l2.chart.type === ls.MfCombine && l2.chart.options.components.forEach((e3) => {
    const t3 = Ve();
    e3.chart.id = t3, e3.chartContain.id = t3;
  });
  const n2 = Ve();
  return e2.chartContain.dropInfo.x = t2, e2.chartContain.dropInfo.y = o2, l2.chart.name = Zd(l2.chart.type, l2.chart.name), l2.chart.id = n2, l2.chartContain.id = n2, l2.chartContain.dropInfo.x = t2, l2.chartContain.dropInfo.y = o2, l2.chartContain.dropInfo.zIndex = 0, l2;
}
function Zd(e2, t2) {
...
const Kd = (e2) => {
  const t2 = Wd();
  t2.chart.type = e2.type, t2.chart.name = Zd(e2.type, e2.name);
  const o2 = Gd[e2.type];
...
function Xd(e2, t2 = []) {
  var _a2;
  let o2;
  return o2 = ((_a2 = e2.chartContain.border.color) == null ? void 0 : _a2.startsWith("linear-gradient")) ? { [Qr.borderImage]: `${e2.chartContain.border.color} 1` } : { [Qr.borderColor]: e2.chartContain.border.color }, Jd({ ...e2.chartContain.dropInfo, ...o2, [Qr.borderWidth]: e2.chartContain.border.show ? e2.chartContain.border.width : 0, [Qr.borderRadius]: e2.chartContain.border.radius, [Qr.background]: e2.chartContain.background, [Qr.opacity]: e2.chartContain.opacity, padding: e2.chartContain.padding }, t2);
}
function Jd(e2, t2 = []) {
  const o2 = /* @__PURE__ */ new Set([Qr.width, Qr.height, Qr.borderWidth, Qr.borderRadius]), l2 = new Set(t2), n2 = [];
  l2.has(Qr.x) || l2.has(Qr.y) || (n2.push(`translate(${e2.x}px,${e2.y}px)`), l2.add(Qr.x), l2.add(Qr.y)), l2.has(Qr.rotate) || (n2.push(`rotate(${e2.rotate}deg)`), l2.add(Qr.rotate));
  const a2 = {};
...
function ep(e2) {
  ...
  if (0 !== t2.rotate) {
    ...
    const l2 = Math.round(t2.height * Xr(t2.rotate) + t2.width * Kr(t2.rotate)), n2 = (l2 - t2.height) / 2;
...
function op(e2, t2) {
  const o2 = tp(e2, t2.id);
  if (!o2) return;
  const l2 = 0 === o2.chart.data.type ? o2.chart.data.dataSet : o2.chart.data.result;
  return Ye(l2) ? l2[0][t2.param] : l2 ? l2[t2.param] : void 0;
}
async function lp(e2, t2) {
  const o2 = (t3) => {
    if (!t3) return;
  ...
  }, { getDataTable: l2 } = ns(), n2 = [], a2 = [], i2 = qr(), r2 = (e3) => {
    if (0 === e3.chart.data.type ? n2.push(e3.chart) : a2.push(e3.chart), e3.chart.name) {
      const t3 = e3.chart.name.lastIndexOf("_");
      if (t3 > 0) {
        const o3 = e3.chart.name.slice(0, Math.max(0, t3)), l3 = Number(e3.chart.name.slice(Math.max(0, t3 + 1)));
        if (i2.getChartNameLabel.has(o3)) {
          return void (l3 > Number(i2.getChartNameLabel.get(o3)) && i2.getChartNameLabel.set(o3, Number(l3)));
        }
        i2.getChartNameLabel.set(o3, Number(l3));
      }
    }
  };
  ...
  let s2 = [], u2 = 0;
  for (const e3 of a2) e3.data.priority > u2 && (s2.length > 0 && (await Promise.all(s2), s2 = []), u2 = e3.data.priority), o2(e3), s2.push(l2(e3).then((t3) => {
    var _a2;
    e3.type && ((_a2 = Gd[e3.type]) == null ? void 0 : _a2.initData(e3, t3));
  }));
  return s2;
}
function np(e2) {
...
function ap(e2, t2) {
  ...
  for (const e3 of o2) {
    if (np(e3.chart), e3.chart.type === ls.MfCombine) for (const t3 of e3.chart.options.components) np(t3.chart);
...
const sp = qr(), up = (e2) => e2 <= 0, cp = (e2, t2) => e2 >= t2.length - 1, dp = (e2, t2, o2) => {
  const l2 = e2[t2];
  e2[t2] = e2[o2], e2[o2] = l2;
}, pp = et("screen-shortcut", { state: () => ({ showMenu: false, copyData: null, alignType: Cp.GROUP }), getters: { getShowMenu() {
  ...
  var _a2, _b;
  ((_a2 = sp.getSelectArea) == null ? void 0 : _a2.components.length) > 0 ? this.copyData = qe((_b = sp.getSelectArea) == null ? void 0 : _b.components) : sp.getCurComponent && (this.copyData = qe(sp.getCurComponent));
}, pasteComponent() {
  if (this.copyData) {
    if (Ye(this.copyData)) this.copyData.forEach((e2) => {
      const t2 = Yd(e2, e2.chartContain.dropInfo.x + 10, e2.chartContain.dropInfo.y + 10);
      t2 && sp.addComponent(t2, 0);
    });
    else {
      const e2 = this.copyData.chartContain.dropInfo.x + 10, t2 = this.copyData.chartContain.dropInfo.y + 10, o2 = Yd(this.copyData, e2, t2);
      o2 && (sp.addComponent(o2, 0), sp.setCurComponent(o2, 0));
    }
    sp.setUndoRedoData("组件复制");
  }
}, moveComponent(e2, t2) {
  sp.getCurComponent && ("x" === e2 && (sp.getCurComponent.chartContain.dropInfo.x = sp.getCurComponent.chartContain.dropInfo.x + t2), "y" === e2 && (sp.getCurComponent.chartContain.dropInfo.y = sp.getCurComponent.chartContain.dropInfo.y + t2), t2 >= 10 && sp.setUndoRedoData("组件移动"));
}, upComponent() {
  up(sp.getCurComponentIndex) || (dp(sp.getComponentList, sp.getCurComponentIndex, sp.getCurComponentIndex - 1), sp.setCurComponentIndex(sp.getCurComponentIndex - 1), sp.setUndoRedoData("组件上移一层"));
}, downComponent() {
  cp(sp.getCurComponentIndex, sp.getComponentList) || (dp(sp.getComponentList, sp.getCurComponentIndex, sp.getCurComponentIndex + 1), sp.setCurComponentIndex(sp.getCurComponentIndex + 1), sp.setUndoRedoData("组件下移一层"));
}, topComponent() {
  sp.getCurComponent && !up(sp.getCurComponentIndex) && (sp.getComponentList.splice(sp.getCurComponentIndex, 1), sp.getComponentList.unshift(sp.getCurComponent), sp.setCurComponentIndex(0), sp.setUndoRedoData("组件置顶"));
}, bottomComponent() {
  sp.getCurComponent && !cp(sp.getCurComponentIndex, sp.getComponentList) && (sp.getComponentList.splice(sp.getCurComponentIndex, 1), sp.getComponentList.push(sp.getCurComponent), sp.setCurComponentIndex(sp.getComponentList.length - 1), sp.setUndoRedoData("组件置底"));
}, composeComponent() {
  if (sp.getSelectArea.components.length <= 1) return;
  const e2 = [];
  sp.getSelectArea.components.forEach((t2) => {
    var _a2;
    if (t2.chart.type === ls.MfCombine) {
      const o2 = { ...t2.chartContain.dropInfo }, l2 = t2.chart.options.components, n2 = (_a2 = sp.getScreenCanvas) == null ? void 0 : _a2.getBoundingClientRect();
      l2.forEach((e3) => {
        gp(e3, n2, o2, sp.getScale);
      }), e2.push(...t2.chart.options.components);
    } else e2.push(t2);
  }), C(() => {
    const t2 = Kd({ type: ls.MfCombine, name: "组合" });
    null !== t2 && (t2.chartContain.dropInfo = Object.assign(t2.chartContain.dropInfo, sp.getSelectArea.dropInfo), t2.chart.options.components = e2, hp(t2), sp.batchDeleteComponent(sp.getSelectArea.components), sp.addComponent(t2, 0), sp.cleanSelectArea(), sp.setCurComponent(t2, 0), sp.setUndoRedoData("组件组合"));
  });
}, decomposeComponent() {
  if (!sp.getCurComponent) return;
  if (sp.getCurComponent.chart.type !== ls.MfCombine) return;
  sp.getCurComponent.chartContain.show || (sp.getCurComponent.chartContain.show = true);
  const e2 = sp.getCurComponent.chart.options.components, t2 = [];
  for (const o2 of e2) o2.chartContain.show || (o2.chartContain.show = true, t2.push(o2));
  C(() => {
    const o2 = { ...sp.getCurComponent.chartContain.dropInfo };
    if (!sp.getScreenCanvas) return;
    const l2 = sp.getScreenCanvas.getBoundingClientRect(), n2 = sp.getCurComponentIndex;
    sp.deleteComponent(n2);
    for (let t3 = e2.length - 1; t3 >= 0; t3--) gp(e2[t3], l2, o2, sp.getScale), sp.addComponent(e2[t3], n2), sp.getSelectArea.components.push(e2[t3]);
    t2.forEach((e3) => {
      e3.chartContain.show = false;
    }), mp(sp.getSelectArea.components), sp.setUndoRedoData("组件拆分");
  });
}, lockComponent() {
  ...
  var _a2, _b;
  ((_a2 = sp.getSelectArea) == null ? void 0 : _a2.components.length) > 0 && ((_b = sp.getSelectArea) == null ? void 0 : _b.components.forEach((t2) => {
    t2.chartContain.lock = e2;
  })), sp.getCurComponent && (sp.getCurComponent.chartContain.lock = e2), sp.setUndoRedoData(e2 ? "组件锁定" : "组件解锁");
}, hideComponent() {
  ...
  })), sp.getCurComponent && (sp.getCurComponent.chartContain.show = e2), sp.setUndoRedoData(e2 ? "组件显示" : "组件隐藏");
}, deleteComponent() {
  sp.deleteComponent(), sp.setUndoRedoData("组件删除");
}, selectAllComponent() {
  mp(sp.getComponentList);
}, screenSave() {
  Ud.emit(Hr.SCREEN_SAVE);
}, screenPreview() {
  Ud.emit(Hr.SCREEN_PREVIEW);
} } });
function fp(e2) {
  return 100 * e2 + "%";
}
function hp(e2) {
  ...
  e2.chart.options.components.forEach((e3) => {
    e3.chartContain.groupStyle = Xd(e3, [Qr.x, Qr.y]), e3.chartContain.groupStyle.left = fp((e3.chartContain.dropInfo.x - t2.x) / t2.width), e3.chartContain.groupStyle.top = fp((e3.chartContain.dropInfo.y - t2.y) / t2.height), e3.chartContain.groupStyle.width = fp(e3.chartContain.dropInfo.width / t2.width), e3.chartContain.groupStyle.height = fp(e3.chartContain.dropInfo.height / t2.height);
  });
}
function gp(e2, t2, o2, l2) {
...
function yp(e2) {
  const t2 = qr(), o2 = [], { x: l2, y: n2 } = e2;
  return t2.getComponentList.forEach((t3) => {
    const { x: a2, y: i2, width: r2, height: s2 } = ep(t3.chartContain.dropInfo);
...
function mp(e2) {
  ...
  e2.forEach((e3) => {
    const t3 = ep(e3.chartContain.dropInfo);
...
function vp(e2) {
  ...
  t2.cleanCurComponent(), t2.setSelectedComponents(e2), t2.getSelectArea.components.length > 1 && mp(t2.getSelectArea.components);
}
var Cp = ((e2) => (e2.GROUP = "Group", e2.CANVAS = "Canvas", e2))(Cp || {});
const bp = (e2, t2) => {
  function o2(o3) {
    ...
    }), mp(e2.getSelectArea.components), e2.setUndoRedoData("x" === o3 ? "横向分布" : "纵向分布");
  }
  function l2() {
  ...
  function a2(t3) {
    const o3 = l2();
    n2().forEach((e3) => t3(e3, o3)), mp(e2.getSelectArea.components), e2.setUndoRedoData("对齐");
  }
  function i2() {
  ...
  return (t3, o3) => (s(), r("div", { class: c([d(n2), d(i2).getShowData && d(i2).getShowDataLevel === d(a2) ? "active" : ""]), style: u(e2.highlight ? { border: `1px solid ${d(l2)}` } : "") }, [d(i2).getShowData && d(i2).getShowDataLevel === d(a2) ? (s(), r("div", { key: 0, class: "select", style: u({ backgroundColor: d(l2) }) }, [g(d(Be), { icon: "ant-design:check-outlined", color: "#FFFFFF", size: 14 })], 4)) : f("", true), void 0 !== e2.iconfont ? (s(), h(d(Be), { key: 1, color: d(l2), icon: `iconfont:${e2.iconfont}`, size: 14 }, null, 8, ["color", "icon"])) : f("", true), void 0 !== e2.icon ? (s(), h(d(Be), { key: 2, color: d(l2), icon: e2.icon, size: 14 }, null, 8, ["color", "icon"])) : f("", true), p("div", Mp, S(e2.title), 1), e2.allowDelete && !e2.queryMode ? (s(), h(d(J), { key: 3, type: "vertical" })) : f("", true), e2.queryMode ? f("", true) : (s(), h(d(G), { key: 4, title: "删除" }, { default: k(() => [e2.allowDelete ? (s(), h(d(ee), { key: 0, size: "small", type: "link", onClick: v2 }, { icon: k(() => [g(d(pt))]), _: 1 })) : f("", true)]), _: 1 })), p("div", { class: c(["config", e2.full ? "full" : ""]) }, [R(t3.$slots, "config", {}, void 0, true)], 2), g(d(G), { title: "执行" }, { default: k(() => [g(d(ee), { size: "small", type: "link", style: { margin: "6px" }, onMouseenter: o3[0] || (o3[0] = (e3) => m2.value = true), onMouseleave: o3[1] || (o3[1] = (e3) => m2.value = false), onClick: C2 }, { icon: k(() => [!d(i2).getShowData || d(i2).getShowDataLevel !== d(a2) || m2.value ? (s(), h(d(ft), { key: 0 })) : (s(), h(d(ht), { key: 1 }))]), _: 1 })]), _: 1 })], 6));
} }), [["__scopeId", "data-v-c5dcf0b5"]]), xp = eo(e({ __name: "SelectFields", props: { tableFields: { type: Object, require: true, default: void 0 }, fields: { type: Object, require: true, default: void 0 }, queryMode: { type: Boolean, default: false } }, emits: ["fieldChange"], setup(e2, { emit: t2 }) {
  ...
  return n(() => {
    ...
    ((_a2 = o2.sqlQuery) == null ? void 0 : _a2.sqlQuery) && ((_b = o2.sqlQuery) == null ? void 0 : _b.sourceTable) && Ir(o2.sqlQuery).then((e3) => {
      ...
      if ((_a3 = o2.sqlQuery) == null ? void 0 : _a3.sourceTable) {
        ...
        (t3 == null ? void 0 : t3.length) !== ((_g2 = (_f2 = o2.sqlQuery) == null ? void 0 : _f2.fields) == null ? void 0 : _g2.length) && l2("fieldChange", t3);
      }
    });
  }), (t3, l3) => (s(), h(wp, { iconfont: "icon-mfish-table", title: "数据源", "allow-delete": false, onExecute: m2, "query-mode": e2.queryMode }, { config: k(() => [g(d(r2), { class: c(d(u2)), compact: "" }, { default: k(() => {
    var _a2, _b;
    return [g(d(a2), { value: (_a2 = e2.sqlQuery) == null ? void 0 : _a2.sourceTable, disabled: "" }, null, 8, ["value"]), g(xp, $(t3.$attrs, { "table-fields": p2.value, fields: (_b = o2.sqlQuery) == null ? void 0 : _b.fields, onFieldChange: v2, "query-mode": e2.queryMode }), null, 16, ["table-fields", "fields", "query-mode"])];
  }), _: 1 }, 8, ["class"])]), _: 1 }, 8, ["query-mode"]));
} }), [["__scopeId", "data-v-1d0129ce"]]), _p = async (e2, t2) => {
  var _a2, _b;
  const o2 = Sr(), l2 = [];
  ...
  for (; ; ) return o2.has(t2) ? (t2.endsWith(`_${e2}`) && (t2 = t2.slice(0, Math.max(0, t2.length - `${e2}`.length - 1))), $p(++e2, `${t2}_${e2}`, o2)) : t2;
}, Lp = (e2) => {
  var _a2, _b, _c2, _d2;
  ...
  e2 && e2.push(t2);
}, Dp = eo(e({ __name: "ConfigButton", props: { level: { type: Number, default: 1 }, icon: { type: String, default: void 0 }, iconfont: { type: String, default: void 0 }, title: { type: String, default: "按钮" } }, setup(e2) {
  const t2 = e2, { prefixCls: o2 } = xe("config-button"), n2 = Se().getThemeColor, a2 = Sr(), i2 = l(() => t2.level < a2.getLevel ? 12 : 14);
  return (t3, l2) => (s(), h(d(ee), $(t3.$attrs, { size: "small", shape: "round", class: d(o2), style: { "--hover-color--": d(n2) }, type: "link" }), { icon: k(() => [e2.iconfont ? (s(), h(d(Be), { key: 0, icon: `iconfont:${e2.iconfont}`, style: { "margin-right": "8px" }, size: i2.value }, null, 8, ["icon", "size"])) : (s(), h(d(Be), { key: 1, icon: e2.icon, size: i2.value }, null, 8, ["icon", "size"]))]), default: k(() => [p("span", { class: c(e2.level < d(a2).getLevel ? "show-title" : ""), style: u({ fontSize: `${i2.value}px` }) }, S(e2.title), 7)]), _: 1 }, 16, ["class", "style"]));
} }), [["__scopeId", "data-v-749209b7"]]), Tp = { key: 0, class: "placeholder" }, Np = { class: "condition" }, Bp = e({ __name: "TableJoins", props: { sqlQuery: { type: Object, require: true }, level: { type: Number, default: 1 }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["joinChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, i2 = te.Item, C2 = H, { prefixCls: _2 } = xe("table-joins"), $2 = Sr(), L2 = y([]), I2 = y([]), D2 = y([]), T2 = Se().getThemeColor, N2 = { left: "左联", inner: "内联", right: "右联", full: "全联" }, B2 = l(() => {
    var _a2;
    if (1 === $2.getSourceType || o2.queryMode) return false;
    if (o2.sqlQuery && ((_a2 = o2.sqlQuery) == null ? void 0 : _a2.joins)) {
      for (const e3 of o2.sqlQuery.joins) if (!Lp(e3)) return false;
    }
  ...
  function Q2(e3, t3) {
    ...
    const n2 = new Set(l2), a3 = $p(0, t3, n2);
  ...
  function U2() {
    ...
    const e3 = async (e4) => {
      ...
      const t4 = await _p(e4, o2.sqlQuery);
      ...
      if (t4) {
        if (t4.table) {
          ...
          return void (o3 && (D2 == null ? void 0 : D2.value.splice(e4, 1, o3)));
        }
        D2 == null ? void 0 : D2.value.splice(e4, 1, []);
      }
    };
  ...
  return (t3, l2) => {
    ...
    return s(), r("div", { class: c(d(_2)) }, [(s(true), r(m, null, v((_a2 = e2.sqlQuery) == null ? void 0 : _a2.joins, (t4, c2) => (s(), h(wp, { iconfont: "icon-mfish-join", title: "关联", key: c2, "query-mode": e2.queryMode, onDeleteConfig: (e3) => function(e4) {
      ...
      return [0 === c2 ? (s(), h(d(C2), { key: 0, class: "left-table", value: (_a3 = e2.sqlQuery) == null ? void 0 : _a3.sourceTable, disabled: "" }, null, 8, ["value"])) : (s(), h(d(C2), { key: 1, class: "left-table", value: (_b = t4.condition) == null ? void 0 : _b.field.tableAlias, disabled: "" }, null, 8, ["value"])), g(d(V), { class: "condition", placement: "bottom", arrow: { pointAtCenter: true }, disabled: e2.queryMode }, { overlay: k(() => [g(d(te), { onClick: (e3) => function(e4, t5) {
        t5.type = e4.key;
      }(e3, t4), "selected-keys": [t4.type] }, { default: k(() => [(s(true), r(m, null, v(Object.keys(N2), (e3) => (s(), h(d(i2), { key: e3 }, { default: k(() => [p("div", null, [x(S(N2[e3]) + " ", 1), g(d(Be), { icon: `iconfont:icon-mfish-${e3}-join`, color: d(T2), size: 14 }, null, 8, ["icon", "color"])])]), _: 2 }, 1024))), 128))]), _: 2 }, 1032, ["onClick", "selected-keys"])]), default: k(() => [p("a", { onClick: l2[0] || (l2[0] = M(() => {
      }, ["prevent"])) }, [x(S(N2[t4.type]) + " ", 1), g(d(Be), { icon: `iconfont:icon-mfish-${t4.type}-join`, color: d(T2), size: 14 }, null, 8, ["icon", "color"])])]), _: 2 }, 1032, ["disabled"]), g(n2, { class: "right-table", compact: "" }, { default: k(() => {
        return [g(d(oe), { disabled: e2.queryMode, "show-search": "", "allow-clear": false, class: "input-select", "option-filter-prop": "label", value: [A2(c2) || ""], options: R2.value, onChange: (e3) => function(e4, t5) {
          ...
          }), _: 2 }, 1032, ["title"])) : (s(), r("div", Tp, "选择关联表"))];
        }), _: 2 }, 1032, ["disabled", "value", "options", "onChange"]), g(xp, { "query-mode": e2.queryMode, "table-fields": (l3 = t4.table, l3 && $2.getTableFieldsMap.has(l3) ? $2.getTableFieldsMap.get(l3) : []), fields: t4.fields, onFieldChange: (e3) => function(e4, t5) {
          var _a4;
          ((_a4 = o2.sqlQuery) == null ? void 0 : _a4.joins) && o2.sqlQuery.joins.length > 0 && (L2.value[t5].fields = e4), F2(t5);
      ...
      }(o3, c2, t4) }, { displayRender: k(({ labels: e3 }) => [g(d(G), { title: j2(c2, e3) }, { default: k(() => [x(S(j2(c2, e3)), 1)]), _: 2 }, 1032, ["title"])]), _: 2 }, 1032, ["disabled", "options", "value", "placeholder", "onChange"]), p("div", Np, [g(d(Be), { icon: "iconfont:icon-mfish-equals", color: d(T2), size: 14 }, null, 8, ["color"])]), g(d(K), { disabled: e2.queryMode, "show-search": "", "allow-clear": false, class: "input-select", "option-filter-prop": "label", value: E2(c2), options: z2(c2), placeholder: `${t4.tableAlias || "关联表"}字段`, onSelect: (e3, o3) => function(e4, t5, o4) {
        o4.condition && (o4.condition.joinedField = e4.realValue, F2(t5));
      }(o3, c2, t4) }, null, 8, ["disabled", "value", "options", "placeholder", "onSelect"])];
    }), _: 2 }, 1032, ["query-mode", "onDeleteConfig", "onExecute"]))), 128)), B2.value ? (s(), h(Dp, { key: 0, class: "config-button", title: "关联", iconfont: "icon-mfish-join", level: 0, onClick: P2 })) : f("", true)], 2);
  };
} }), Rp = eo(Bp, [["__scopeId", "data-v-d960e99c"]]), qp = e({ __name: "TableLimit", props: { sqlQuery: { type: Object, require: true }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["limitChange"], setup(e2, { emit: t2 }) {
  ...
  function c2(e3) {
    Nr(o2.configMitt, { ...o2.sqlQuery, limit: a2.value }, e3);
  }
  return n(() => {
    var _a2;
    ...
    var _a2;
    return void 0 !== ((_a2 = e2.sqlQuery) == null ? void 0 : _a2.limit) ? (s(), h(wp, { key: 0, "query-mode": e2.queryMode, icon: "ant-design:column-height-outlined", title: "行数", onDeleteConfig: u2, onExecute: c2 }, { config: k(() => [g(d(Q), { disabled: e2.queryMode, "default-value": a2.value, "addon-after": "行", step: "10", onChange: i2, onPressEnter: r2, onBlur: r2 }, null, 8, ["disabled", "default-value"])]), _: 1 }, 8, ["query-mode"])) : f("", true);
  };
} }), Ap = [{ field: "id", label: "唯一ID", component: "Input", show: false }, { field: "name", label: "参数名称", component: "Input", dynamicRules: () => [{ required: true, validator: (e2, t2) => /^[\u4E00-\u9FA5\w]*$/.test(t2) ? Promise.resolve() : Promise.reject("错误：参数格式不正确！字符只允许中文、字符、数字、下划线!"), trigger: "blur" }] }, { field: "required", label: "是否必须", component: "RadioButtonGroup", defaultValue: 1, componentProps: { options: [{ label: "是", value: 1 }, { label: "否", value: 0 }] }, required: true }, { field: "defaultValue", label: "默认值", component: "Input" }, { field: "remark", label: "参数描述", component: "InputTextArea" }], Op = { name: "ApiParamsModal", components: { BasicModal: Ct, BasicForm: Mt }, emits: ["addSuccess", "updateSuccess", "register", "variableChange"], setup(e2, { emit: t2 }) {
  const o2 = y(true), [n2, { resetFields: a2, setFieldsValue: i2, validate: r2 }] = wt({ name: "model_form_item", labelWidth: 100, baseColProps: { span: 24 }, schemas: Ap, showActionButtonGroup: false, autoSubmitOnEnter: true }), s2 = y(), [u2, { setModalProps: c2, closeModal: p2 }] = bt(async (e3) => {
    a2().then(), c2({ confirmLoading: false, width: "600px" }), o2.value = !!(e3 == null ? void 0 : e3.isUpdate), d(o2) && (s2.value = e3.index, i2({ ...e3.param }).then());
  }), f2 = Sr(), h2 = l(() => d(o2) ? "编辑参数" : "新增参数"), { createMessage: g2 } = _e();
...
const jp = eo(Op, [["render", function(e2, t2, o2, l2, n2, a2) {
...
}]]), zp = { key: 0 }, Ep = e({ __name: "FilterVariable", props: { value: { type: String }, queryMode: { type: Boolean, default: false } }, emits: ["variableChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, a2 = K.Option, i2 = Se().getThemeColor, { prefixCls: C2 } = xe("filter-variable"), [b2, { openModal: w2 }] = kt(), _2 = Sr(), $2 = y();
  n(() => o2.value, (e3) => {
    $2.value = e3;
  }, { immediate: true });
  ...
  return (t3, o3) => (s(), r(m, null, [g(d(K), { value: $2.value, "onUpdate:value": o3[0] || (o3[0] = (e3) => $2.value = e3), onChange: N2, disabled: e2.queryMode }, { dropdownRender: k(({ menuNode: e3 }) => [g(L2, { vnodes: e3 }, null, 8, ["vnodes"]), g(d(J), { style: { margin: "4px 0" } }), p("div", { style: { padding: "4px 8px", cursor: "pointer" }, onClick: I2 }, [g(d(Be), { icon: "ant-design:plus-outlined", color: d(i2) }, null, 8, ["color"]), p("span", { style: u(`color:${d(i2)};margin-left:6px`) }, "增加变量参数", 4)])]), default: k(() => [(s(true), r(m, null, v(d(_2).getVariables, (t4, o4) => (s(), h(d(a2), { label: t4.name, value: t4.name, key: o4 }, { default: k(() => [p("div", { class: c(`${d(C2)}-select-option`) }, [x(S(t4.name) + " ", 1), p("div", null, S(t4.remark), 1), e2.queryMode ? f("", true) : (s(), r("div", zp, [g(d(Be), { icon: "ant-design:edit-outlined", color: d(i2), onClick: M((e3) => function(e4, t5) {
    w2(true, { index: e4, param: t5, isUpdate: true });
  }(o4, t4), ["stop"]) }, null, 8, ["color", "onClick"]), g(d(J), { type: "vertical" }), g(d(Be), { icon: "ant-design:delete-outlined", color: d(i2), onClick: M((e3) => function(e4) {
    _2.getVariables.splice(e4, 1), _2.getVariables.some((e5) => e5.name === $2.value) || ($2.value = "");
  }(o4), ["stop"]) }, null, 8, ["color", "onClick"])]))], 2)]), _: 2 }, 1032, ["label", "value"]))), 128))]), _: 1 }, 8, ["value", "disabled"]), g(jp, { onRegister: d(b2), onAddSuccess: D2, onUpdateSuccess: T2, onVariableChange: B2 }, null, 8, ["onRegister"])], 64));
} }), Pp = eo(Ep, [["__scopeId", "data-v-68d91e73"]]), Fp = e({ __name: "TableField", props: { tableFields: { type: Object }, value: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["change"], setup(e2, { emit: t2 }) {
  ...
  }(t4)) }, { displayRender: k(({ labels: e3 }) => [g(d(G), { title: `${e3[0]} / ${e3[1]}` }, { default: k(() => [g(d(Be), { icon: u2.value, color: d(r2) }, null, 8, ["icon", "color"]), x(" " + S(`${e3[0]} / ${e3[1]}`), 1)]), _: 2 }, 1032, ["title"])]), _: 1 }, 8, ["disabled", "options", "value"]));
} }), Hp = e({ __name: "FilterValue", props: { fieldType: { type: String, default: "STRING" }, valueType: { type: String, default: "0" }, operator: { type: String, default: "" }, tableFields: { type: Array, default: () => [] }, queryMode: { type: Boolean, default: false } }, emits: ["typeChange", "variableChange", "fieldChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, a2 = H, i2 = le.Group, u2 = le.Button, p2 = ne.ItemRest, { prefixCls: m2 } = xe("filter-value"), v2 = y("0"), C2 = Sr();
  function b2() {
  ...
  function S2(e3) {
    var _a2;
    e3 === ti.isNull || e3 === ti.isNotNull ? (p2.value = false, n2.value = "") : p2.value = true, "DATE" === ((_a2 = u2.field) == null ? void 0 : _a2.dataType) && (e3 === ti.between ? n2.value = n2.value ? `${n2.value}`.split(",") : [] : n2.value = n2.value ? `${n2.value}`.split(",")[0] : "");
  }
  async function _2() {
    var _a2, _b, _c2, _d2;
    try {
  ...
  return (t3, o3) => (s(), h(d(Ct), $(t3.$attrs, { onRegister: d(C2), title: "设置过滤条件", onOk: _2 }), { default: k(() => [g(d(ne), { ref_key: "formRef", ref: i2, model: n2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: k(() => {
    var _a2;
    return [g(d(l2), { label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: k(() => [g(Fp, { "query-mode": e2.queryMode, "table-fields": r2.value, value: u2.field, onChange: w2 }, null, 8, ["query-mode", "table-fields", "value"])]), _: 1 }), g(d(l2), { label: "条件", name: "operator", rules: [{ required: true, message: "请选择条件！" }] }, { default: k(() => [g(d(K), { disabled: e2.queryMode, "show-search": "", "allow-clear": false, class: "input-select", "option-filter-prop": "label", value: n2.operator, "onUpdate:value": o3[0] || (o3[0] = (e3) => n2.operator = e3), options: c2.value, placeholder: "选择条件", onSelect: S2 }, null, 8, ["disabled", "value", "options"])]), _: 1 }), p2.value ? (s(), h(d(l2), { key: 0, label: "值", name: "value", rules: [{ required: "STRING" !== ((_a2 = u2.field) == null ? void 0 : _a2.dataType), message: "请选择值！" }] }, { default: k(() => {
      var _a3;
      return [g(Qp, { "query-mode": e2.queryMode, placeholder: "输入值", value: n2.value, "onUpdate:value": o3[1] || (o3[1] = (e3) => n2.value = e3), "value-type": u2.valueType, "field-type": (_a3 = u2.field) == null ? void 0 : _a3.dataType, operator: n2.operator, "table-fields": r2.value, onTypeChange: L2, onVariableChange: I2, onFieldChange: D2 }, null, 8, ["query-mode", "value", "value-type", "field-type", "operator", "table-fields"])];
    }), _: 1 }, 8, ["rules"])) : f("", true)];
  }), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
} }), Up = e({ __name: "TableFilter", props: { sqlQuery: { type: Object }, level: { type: Number, default: 1 }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["filterChange"], setup(e2, { emit: t2 }) {
  ...
  const c2 = Se().getThemeColor, p2 = y([{ name: "添加", icon: "icon-mfish-left-bracket", color: c2, value: { type: "0", name: "(", value: "(" } }, { name: "添加", icon: "icon-mfish-right-bracket", color: c2, value: { type: "0", name: ")", value: ")" } }]), m2 = { type: "0", slot: true, hideClose: true, value: "and" }, [v2, { openModal: C2 }] = kt();
  function b2() {
    a2("filterChange");
  }
  function w2() {
  ...
  return (t3, o3) => {
    var _a2;
    return s(), r("div", null, [void 0 !== ((_a2 = e2.sqlQuery) == null ? void 0 : _a2.filters) ? (s(), h(wp, { key: 0, "query-mode": e2.queryMode, icon: "ant-design:filter-outlined", title: "过滤", onDeleteConfig: b2, full: true, onExecute: I2 }, { config: k(() => [g(d(vt), { "query-mode": e2.queryMode, items: i2.value, menus: p2.value, "add-title": "添加过滤条件", onAddBlock: x2, onEditBlock: S2, onCloseBlock: $2, onDragChange: L2 }, { tag: k(({ index: t4, element: o4 }) => [g(d(re), { disabled: e2.queryMode, style: { "margin-right": "8px" }, checked: o4 == null ? void 0 : o4.value, "checked-children": "且", "un-checked-children": "或", "checked-value": "and", "un-checked-value": "or", size: "small", onChange: (e3) => function(e4, t5) {
      var _a3;
      i2.value && ((_a3 = i2.value) == null ? void 0 : _a3.length) > t5 && (i2.value[t5].value = e4, setTimeout(() => {
        i2.value && a2("filterChange", [...i2.value]);
      }, 300));
    }(e3, t4) }, null, 8, ["disabled", "checked", "onChange"])]), _: 1 }, 8, ["query-mode", "items", "menus"])]), _: 1 }, 8, ["query-mode"])) : f("", true), u2.value ? (s(), h(Dp, { key: 1, class: "config-button", title: "过滤", icon: "ant-design:filter-outlined", level: 0, onClick: M(w2, ["prevent"]) })) : f("", true), g(Gp, { "query-mode": e2.queryMode, onRegister: d(v2), onSubmit: _2 }, null, 8, ["query-mode", "onRegister"])]);
  };
} }), Vp = e({ __name: "AggregateModal", props: { queryMode: { type: Boolean, default: false } }, emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = t2, l2 = ne.Item, n2 = a({ field: void 0, aggFunc: "" }), i2 = y(), r2 = y([]), u2 = a({ field: { dataType: "STRING" } }), c2 = Object.keys(oi).map((e3) => ({ value: e3, label: oi[e3] })), p2 = y(true), m2 = y(), [v2, { setModalProps: C2, closeModal: b2 }] = bt(async (e3) => {
    if (C2({ confirmLoading: false, width: "600px" }), _p(void 0, e3.sqlQuery).then((e4) => {
      var _a2, _b;
      ...
      r2.value = e4;
    }), e3.isUpdate) return n2.field = [e3.field.tableAlias, e3.field.colName], n2.aggFunc = e3.aggFunc, u2.field = e3.field, p2.value = oi[n2.aggFunc] !== oi.count, void (m2.value = e3.index);
  ...
  async function x2() {
    ...
    try {
      const e3 = await ((_a2 = i2.value) == null ? void 0 : _a2.validateFields());
      b2(), o2("submit", m2.value, { ...u2, name: oi[n2.aggFunc] + (oi[n2.aggFunc] === oi.count ? "" : `(${(_b = u2.field) == null ? void 0 : _b.colName})`), aggFunc: e3.aggFunc });
    } catch (e3) {
    }
  }
  return (t3, o3) => (s(), h(d(Ct), $(t3.$attrs, { onRegister: d(v2), title: "选择聚合字段", onOk: x2 }), { default: k(() => [g(d(ne), { ref_key: "formRef", ref: i2, model: n2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: k(() => [g(d(l2), { label: "聚合方式", name: "aggFunc", rules: [{ required: true, message: "请选择聚合方式！" }] }, { default: k(() => [g(d(K), { disabled: e2.queryMode, "show-search": "", "allow-clear": false, "option-filter-prop": "label", value: n2.aggFunc, "onUpdate:value": o3[0] || (o3[0] = (e3) => n2.aggFunc = e3), options: d(c2), placeholder: "选择聚合方式", onSelect: w2 }, null, 8, ["disabled", "value", "options"])]), _: 1 }), p2.value ? (s(), h(d(l2), { key: 0, label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: k(() => [g(Fp, { "query-mode": e2.queryMode, "table-fields": r2.value, value: u2.field, onChange: M2 }, null, 8, ["query-mode", "table-fields", "value"])]), _: 1 })) : f("", true)]), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
} }), Wp = e({ __name: "GroupModal", props: { queryMode: { type: Boolean, default: false } }, emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = t2, l2 = ne.Item, n2 = a({ field: void 0 }), i2 = a({ field: { dataType: "STRING" } }), r2 = y(), u2 = y([]), c2 = y(), [p2, { setModalProps: f2, closeModal: m2 }] = bt(async (e3) => {
    if (f2({ confirmLoading: false, width: "600px" }), _p(void 0, e3.sqlQuery).then((e4) => {
      u2.value = e4;
  ...
  return (t3, o3) => (s(), h(d(Ct), $(t3.$attrs, { onRegister: d(p2), title: "选择分组字段", onOk: C2 }), { default: k(() => [g(d(ne), { ref_key: "formRef", ref: r2, model: n2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: k(() => [g(d(l2), { label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: k(() => [g(Fp, { "query-mode": e2.queryMode, "table-fields": u2.value, value: i2.field, onChange: v2 }, null, 8, ["query-mode", "table-fields", "value"])]), _: 1 })]), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
} }), Yp = e({ __name: "TableAggregate", props: { sqlQuery: { type: Object }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["aggregateChange", "groupChange", "deleteAggregate"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, a2 = Se().getThemeColor, { prefixCls: i2 } = xe("table-aggregate"), u2 = y(), m2 = y(), [v2, { openModal: C2 }] = kt(), [b2, { openModal: M2 }] = kt();
  async function w2() {
    l2("deleteAggregate");
  }
  function x2() {
  ...
  function N2(e3) {
    Nr(o2.configMitt, { ...o2.sqlQuery, aggregates: u2.value, groups: m2.value, orders: [], limit: void 0 }, e3);
  }
  return n(() => {
    var _a2;
    ...
    var _a2;
    return s(), r("div", { class: c(d(i2)) }, [void 0 !== ((_a2 = e2.sqlQuery) == null ? void 0 : _a2.aggregates) ? (s(), h(wp, { key: 0, "query-mode": e2.queryMode, iconfont: "icon-mfish-sum", title: "聚合", onDeleteConfig: w2, onExecute: N2, full: true }, { config: k(() => [g(d(vt), { "query-mode": e2.queryMode, items: u2.value, "add-title": "添加聚合指标", onAddBlock: x2, onEditBlock: _2, onDragChange: $2 }, null, 8, ["query-mode", "items"]), g(d(Be), { class: "groupIcon", icon: "ant-design:group-outlined", color: d(a2), style: { "font-size": "14px" } }, null, 8, ["color"]), o3[0] || (o3[0] = p("div", { class: "group" }, "分组", -1)), g(d(vt), { "query-mode": e2.queryMode, items: m2.value, "add-title": "添加分组指标", onAddBlock: L2, onEditBlock: D2, onDragChange: T2 }, null, 8, ["query-mode", "items"])]), _: 1 }, 8, ["query-mode"])) : f("", true), g(Vp, { "query-mode": e2.queryMode, onRegister: d(v2), onSubmit: S2 }, null, 8, ["query-mode", "onRegister"]), g(Wp, { "query-mode": e2.queryMode, onRegister: d(b2), onSubmit: I2 }, null, 8, ["query-mode", "onRegister"])], 2);
  };
} }), Zp = eo(Yp, [["__scopeId", "data-v-a3fb541b"]]), Kp = "其他", Xp = e({ __name: "OrderModal", emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = t2, l2 = ne.Item, n2 = a({ field: void 0 }), i2 = a({ field: { dataType: "STRING" }, order: "ASC" }), r2 = y(), u2 = y([]), c2 = y(), p2 = Sr(), [f2, { setModalProps: m2, closeModal: v2 }] = bt(async (e3) => {
    if (m2({ confirmLoading: false, width: "600px" }), Dr(e3.sqlQuery) ? qi({ sourceId: p2.getSourceId, sourceType: p2.getSourceType, sqlQuery: e3.sqlQuery }).then((e4) => {
      u2.value = [{ value: Kp, label: Kp, realValue: Kp, children: e4.map((e5) => ({ value: e5.colName, label: e5.colName + (e5.comment ? `[${e5.comment}]` : ""), realValue: { ...e5 } })) }];
    }) : u2.value = await _p(void 0, e3.sqlQuery), e3.isUpdate) return n2.field = [e3.field.tableAlias, e3.field.colName], i2.field = e3.field, void (c2.value = e3.index);
    n2.field = [], c2.value = void 0, i2.field = {};
  });
  function C2(e3) {
    e3.tableAlias && e3.colName && (n2.field = [e3.tableAlias, e3.colName], i2.field = e3);
  ...
  async function b2() {
    var _a2, _b;
    try {
      await ((_a2 = r2.value) == null ? void 0 : _a2.validateFields()), v2(), i2.field.tableAlias === Kp && (i2.field.tableAlias = ""), o2("submit", c2.value, { ...i2, name: (_b = i2.field) == null ? void 0 : _b.colName });
    } catch (e3) {
    }
  }
  return (e3, t3) => (s(), h(d(Ct), $(e3.$attrs, { onRegister: d(f2), title: "选择排序字段", onOk: b2 }), { default: k(() => [g(d(ne), { ref_key: "formRef", ref: r2, model: n2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: k(() => [g(d(l2), { label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: k(() => [g(Fp, { "table-fields": u2.value, value: i2.field, onChange: C2 }, null, 8, ["table-fields", "value"])]), _: 1 })]), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
  ...
  const o2 = e2, l2 = t2, a2 = y([]), [i2, { openModal: u2 }] = kt();
  function c2() {
  ...
  function b2(e3) {
    Nr(o2.configMitt, { ...o2.sqlQuery, orders: a2.value, limit: void 0 }, e3);
  }
  return n(() => {
    var _a2;
    ...
    var _a2;
    return s(), r("div", null, [void 0 !== ((_a2 = e2.sqlQuery) == null ? void 0 : _a2.orders) ? (s(), h(wp, { key: 0, "query-mode": e2.queryMode, icon: "ant-design:sort-ascending-outlined", title: "排序", onDeleteConfig: v2, full: true, onExecute: b2 }, { config: k(() => [g(d(vt), { "query-mode": e2.queryMode, items: a2.value, "add-title": "添加排序指标", onAddBlock: c2, onEditBlock: p2, onDragChange: m2 }, { tagIcon: k(({ element: e3 }) => [g(d(Be), { style: { "font-weight": "bold", "font-size": "20px" }, icon: "ASC" === e3.order ? "ant-design:sort-descending-outlined" : "ant-design:sort-ascending-outlined" }, null, 8, ["icon"])]), _: 1 }, 8, ["query-mode", "items"])]), _: 1 }, 8, ["query-mode"])) : f("", true), g(Xp, { onRegister: d(i2), onSubmit: C2 }, null, 8, ["onRegister"])]);
  };
} }), ef = e({ __name: "FieldColModal", emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = t2, l2 = ne.Item, n2 = a({ field: void 0 }), i2 = y(), r2 = y(), u2 = y([]), c2 = y(), [p2, { setModalProps: f2, closeModal: m2 }] = bt(async (e3) => {
    if (f2({ confirmLoading: false, width: "600px" }), _p(void 0, e3.sqlQuery).then((e4) => {
      u2.value = e4;
    }), e3.isUpdate) {
  ...
  async function C2() {
    var _a2, _b;
    try {
      await ((_a2 = r2.value) == null ? void 0 : _a2.validateFields()), m2(), o2("submit", c2.value, { type: li.field, value: i2.value, name: (_b = i2.value) == null ? void 0 : _b.colName });
    } catch (e3) {
    }
  }
  return (e3, t3) => (s(), h(d(Ct), $(e3.$attrs, { onRegister: d(p2), title: "选择字段", onOk: C2 }), { default: k(() => [g(d(ne), { ref_key: "formRef", ref: r2, model: n2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: k(() => [g(d(l2), { label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: k(() => [g(Fp, { "table-fields": u2.value, value: i2.value, onChange: v2 }, null, 8, ["table-fields", "value"])]), _: 1 })]), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
} }), tf = ["onClick"], of = ["onClick"], lf = e({ __name: "FormulaManagement", props: { isShow: { type: Boolean, default: false }, curKey: { type: String, default: "" } }, emits: ["select"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, i2 = se.Item, C2 = ue.Item, b2 = y([]), { prefixCls: M2 } = xe("formula-management"), w2 = y(null), _2 = Se().getThemeColor, $2 = y([]), L2 = y(false), I2 = y([]), D2 = y(), T2 = y(0.4), B2 = y([]), R2 = y(), q2 = l(() => {
    var _a2, _b;
  ...
  return N(async () => {
    ...
    }), _: 2 }, 1032, ["title"])], 2)], 10, of)];
  }), _: 2 }, 1032, ["class"]))), 128))]), _: 1 })]), _: 1 })) : f("", true), D2.value && D2.value.formulaInfo ? (s(), h(d(mt), { key: 1 }, { default: k(() => [g(d(ue), { class: "pt-3 pr-2", column: 1, bordered: true }, { default: k(() => [g(d(C2), { label: "描述" }, { default: k(() => {
    var _a2;
...
} }), nf = eo(lf, [["__scopeId", "data-v-6dc5ed8e"]]), af = { key: 0, class: "content" }, rf = { key: 1, class: "content placeholder" }, sf = eo(e({ __name: "FormulaSelect", props: { formulaKey: { type: String, default: "" }, queryMode: { type: Boolean, default: false } }, emits: ["formulaChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, i2 = l(() => Se().getDarkMode.value === Ge.DARK), { prefixCls: u2 } = xe("select-formula"), f2 = y(false);
  let m2;
  const { createMessage: v2 } = _e(), C2 = Sr(), M2 = y(), w2 = (e3) => {
    f2.value = e3;
  };
  function _2() {
  ...
  return n(() => o2.formulaKey, (e3) => {
    ...
    var _a2;
    return [g(nf, { style: { height: "350px" }, "is-show": f2.value, "cur-key": (_a2 = M2.value) == null ? void 0 : _a2.key, onSelect: L2 }, null, 8, ["is-show", "cur-key"]), p("div", { class: c(`${d(u2)}-ok-button`) }, [g(d(ee), { class: "mr-2", onClick: _2 }, { default: k(() => o3[0] || (o3[0] = [x("清空")])), _: 1, __: [0] }), g(d(ee), { type: "primary", onClick: $2 }, { default: k(() => o3[1] || (o3[1] = [x("确定")])), _: 1, __: [1] })], 2)];
  }), _: 1 })]), _: 1 })]), default: k(() => [g(d(ee), { class: c(`${d(u2)}-drop-button`) }, { default: k(() => {
    var _a2, _b;
    return [((_a2 = M2.value) == null ? void 0 : _a2.cnName) ? (s(), r("span", af, S((_b = M2.value) == null ? void 0 : _b.cnName), 1)) : (s(), r("span", rf, "选择公式")), g(d(Be), { size: 12, icon: f2.value ? "ant-design:up-outlined" : "ant-design:down-outlined", color: i2.value ? "rgba(255, 255, 255, 0.25)" : "rgba(0, 0, 0, 0.25)" }, null, 8, ["icon", "color"])];
  }), _: 1 }, 8, ["class"])]), _: 1 }, 8, ["disabled", "open"]));
} }), [["__scopeId", "data-v-4015d717"]]), uf = "displayName", cf = { config: { type: Object, default: () => ({ type: li.param, value: "" }) }, comType: { type: String, default: "string" }, paramType: { type: String, default: "string" }, paramValue: { type: String, default: "" }, showRadio: { type: Boolean, default: true }, sqlQuery: { type: Object }, index: { type: Number, default: 0 }, queryMode: { type: Boolean, default: false } }, df = (e2) => {
...
}, pf = e({ __name: "FormulaCompact", props: cf, emits: ["typeChange", "formulaSelect", "inputChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, { prefixCls: a2 } = xe("formula-compact"), i2 = le.Group, u2 = le.Button, m2 = y("string"), v2 = y("string"), C2 = y(), b2 = y(li.param), M2 = y(), w2 = y([]), x2 = y(), S2 = y(false), _2 = y([]), $2 = y();
  function L2(e3) {
    l2("formulaSelect", e3 || "");
  }
  function I2() {
  ...
  function D2(e3) {
    e3.tableAlias && e3.colName && (x2.value = e3, l2("inputChange", { ...e3, [uf]: "colName" }));
  }
  function T2(e3, t3) {
  ...
  return n(() => o2.config, (e3) => {
    var _a2;
    e3 && (b2.value = e3.type, e3.type === li.formula ? M2.value = (_a2 = e3.value) == null ? void 0 : _a2.key : C2.value = e3.value);
    ...
    var _a2;
    if (e3 === li.param && "list" === m2.value) {
      const e4 = /@\{(?<value>.*?)\}/u, t3 = (_a2 = o2.paramValue) == null ? void 0 : _a2.replace(e4, "$<value>");
      S2.value = "fieldName" === t3, S2.value && o2.sqlQuery ? _p(void 0, o2.sqlQuery).then((e5) => {
        ...
        if (_2.value = [], e5 && e5.value) {
          ...
          e5.value.forEach((e6) => {
            const o3 = e6[t4];
            _2.value.push({ label: o3, value: o3, realValue: { ...e6, [uf]: t4 } });
          }), ((_a3 = o2.config) == null ? void 0 : _a3.value) && ($2.value = o2.config.value[o2.config.value[uf]]);
        }
      });
    }
  }, { immediate: true }), (e3, t3) => (s(), r("div", { class: c(d(a2)) }, [o2.showRadio ? (s(), h(d(i2), { key: 0, disabled: o2.queryMode, class: "radio-group", value: b2.value, "onUpdate:value": t3[0] || (t3[0] = (e4) => b2.value = e4), "button-style": "solid", onChange: N2 }, { default: k(() => ["number" === v2.value ? (s(), h(d(u2), { key: 0, value: d(li).param }, { default: k(() => [g(d(G), { placement: "left", title: "数字" }, { default: k(() => [g(d(Be), { icon: "ant-design:field-number-outlined" })]), _: 1 })]), _: 1 }, 8, ["value"])) : (s(), h(d(u2), { key: 1, value: d(li).param }, { default: k(() => [g(d(G), { placement: "left", title: "字符" }, { default: k(() => [g(d(Be), { icon: "ant-design:field-string-outlined" })]), _: 1 })]), _: 1 }, 8, ["value"])), g(d(u2), { value: d(li).formula }, { default: k(() => [g(d(G), { placement: "left", title: "公式" }, { default: k(() => [g(d(Be), { icon: "ant-design:function-outlined" })]), _: 1 })]), _: 1 }, 8, ["value"])]), _: 1 }, 8, ["disabled", "value"])) : f("", true), p("div", { class: c(o2.showRadio ? "formula-select" : "formula-select-show") }, [b2.value === d(li).param && "string" === m2.value ? (s(), h(d(H), { key: 0, disabled: o2.queryMode, value: C2.value, "onUpdate:value": t3[1] || (t3[1] = (e4) => C2.value = e4), class: "input-com", placeholder: "请输入字符常量", onChange: I2 }, null, 8, ["disabled", "value"])) : b2.value === d(li).param && "number" === m2.value ? (s(), h(d(Q), { key: 1, disabled: o2.queryMode, value: C2.value, "onUpdate:value": t3[2] || (t3[2] = (e4) => C2.value = e4), class: "input-com", placeholder: "请输入数字常量", onChange: I2 }, null, 8, ["disabled", "value"])) : b2.value === d(li).param && "list" === m2.value && S2.value ? (s(), h(Fp, { key: 2, "query-mode": o2.queryMode, class: "select-com", "table-fields": w2.value, value: x2.value, onChange: D2 }, null, 8, ["query-mode", "table-fields", "value"])) : b2.value !== d(li).param || "list" !== m2.value || S2.value ? (s(), h(sf, { key: 4, "query-mode": o2.queryMode, "formula-key": M2.value, onFormulaChange: L2 }, null, 8, ["query-mode", "formula-key"])) : (s(), h(d(K), { key: 3, disabled: o2.queryMode, class: "select-com", value: $2.value, "onUpdate:value": t3[3] || (t3[3] = (e4) => $2.value = e4), options: _2.value, placeholder: "请选择参数", onSelect: T2 }, null, 8, ["disabled", "value", "options"]))], 2)], 2));
} }), ff = eo(pf, [["__scopeId", "data-v-8048866c"]]), hf = { style: { "margin-top": "6px", display: "flex", "justify-content": "flex-end" } }, gf = e({ __name: "FormulaAround", emits: ["submit"], setup(e2, { emit: t2 }) {
  ...
  return (e3, t3) => (s(), h(d(V), { trigger: ["click"], open: a2.value, placement: "bottom", arrow: { pointAtCenter: true }, onOpenChange: u2 }, { overlay: k(() => [g(d(te), null, { default: k(() => [g(d(te).Item, { disabled: "", style: { padding: "0", cursor: "default" } }, { default: k(() => [g(d(pe), { title: "上层公式设置", bordered: false, style: { width: "240px" } }, { default: k(() => [g(sf, { onFormulaChange: c2 }), g(d(K), { style: { width: "100%", "margin-top": "6px" }, placeholder: "选择作为哪个参数", class: "select-com", value: n2.value, "onUpdate:value": t3[0] || (t3[0] = (e4) => n2.value = e4), options: l2.value }, null, 8, ["value", "options"]), p("div", hf, [g(d(ee), { size: "small", onClick: f2 }, { default: k(() => t3[1] || (t3[1] = [x(" 取消")])), _: 1, __: [1] }), g(d(ee), { size: "small", type: "primary", style: { "margin-left": "6px" }, onClick: m2 }, { default: k(() => t3[2] || (t3[2] = [x(" 确定")])), _: 1, __: [2] })])]), _: 1 })]), _: 1 })]), _: 1 })]), default: k(() => [g(d(ee), { style: { "margin-top": "-6px" }, size: "small", type: "link" }, { icon: k(() => [g(d(G), { placement: "left", title: "添加外层公式，当前层作为公式参数" }, { default: k(() => [g(d(Be), { icon: "ant-design:node-collapse-outlined" })]), _: 1 })]), _: 1 })]), _: 1 }, 8, ["open"]));
} }), yf = { class: "formula" }, mf = { class: "title" }, vf = { key: 0, class: "add" }, Cf = e({ __name: "FormulaConfig", props: cf, emits: ["formulaChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, i2 = y(), u2 = y(), { prefixCls: C2 } = xe("formula-config"), b2 = Sr(), M2 = y(), _2 = a({ type: li.param, value: "" }), $2 = y(0), L2 = (e3) => e3.startsWith("list"), I2 = (e3) => {
    var _a2, _b;
  ...
  function N2(e3) {
    T2(e3), M2.value = df(e3), $2.value++, l2("formulaChange", M2.value);
  }
  function B2(e3) {
  ...
  return n(() => o2.config, (e3) => {
    e3 && (M2.value = e3, function() {
      var _a2, _b, _c2;
      if (((_a2 = M2.value) == null ? void 0 : _a2.type) === li.formula) {
    ...
    return s(), r("div", { class: c(d(C2)) }, [p("div", yf, [g(ff, { "query-mode": o2.queryMode, class: "main", index: o2.index, "com-type": o2.comType, "param-type": o2.paramType, "param-value": o2.paramValue, config: M2.value, "sql-query": o2.sqlQuery, "show-radio": o2.showRadio, onInputChange: D2, onFormulaSelect: N2, onTypeChange: B2 }, null, 8, ["query-mode", "index", "com-type", "param-type", "param-value", "config", "sql-query", "show-radio"]), ((_a2 = M2.value) == null ? void 0 : _a2.type) !== d(li).formula || o2.queryMode ? f("", true) : (s(), h(gf, { key: 0, onSubmit: R2 }))]), (s(true), r(m, null, v(i2.value, (e4, a2) => (s(), r("div", { key: `${$2.value}${a2}` }, [(s(true), r(m, null, v(I2(a2), (t4, i3) => {
      var _a3, _b, _c2, _d2, _e2, _f2, _g2, _h2, _i2, _j;
      return s(), r("div", { class: "param", key: i3 }, [g(d(Be), { class: "icon", icon: "ant-design:arrow-up-outlined" }), p("span", mf, [g(d(G), { placement: "left", title: u2.value ? u2.value[a2] : "" }, { default: k(() => [x(S(e4.name), 1)]), _: 2 }, 1032, ["title"])]), g(n2, { "query-mode": o2.queryMode, index: i3, "com-type": e4.comType, "param-type": e4.paramType, "param-value": e4.value, config: L2(e4.paramType) && ((_b = (_a3 = M2.value) == null ? void 0 : _a3.value) == null ? void 0 : _b.param) && ((_e2 = (_d2 = (_c2 = M2.value) == null ? void 0 : _c2.value) == null ? void 0 : _d2.param[a2]) == null ? void 0 : _e2.value) ? (_h2 = (_g2 = (_f2 = M2.value) == null ? void 0 : _f2.value) == null ? void 0 : _g2.param[a2]) == null ? void 0 : _h2.value[i3] : (_j = (_i2 = M2.value) == null ? void 0 : _i2.value) == null ? void 0 : _j.param[a2], "sql-query": o2.sqlQuery, onFormulaChange: (t5) => function(e5, t6, o3, n3) {
        var _a4;
        ((_a4 = M2.value) == null ? void 0 : _a4.type) === li.formula && M2.value.value && M2.value.value.param && (L2(o3) ? M2.value.value.param[t6].value ? M2.value.value.param[t6].value[n3] = e5 : M2.value.value.param[t6].value = [e5] : M2.value.value.param[t6] = e5), l2("formulaChange", M2.value);
        ...
        var _a4;
        ((_a4 = M2.value) == null ? void 0 : _a4.type) === li.formula && M2.value.value && M2.value.value.param && (M2.value.value.param[e6].value.splice(t5, 1), $2.value++, l2("formulaChange", M2.value));
      }(a2, i3) }, { icon: k(() => [g(d(Be), { icon: "ant-design:delete-outlined" })]), _: 2 }, 1032, ["onClick"])) : f("", true)]);
    }), 128)), L2(e4.paramType) ? (s(), r("div", vf, [g(d(ee), { type: "primary", onClick: (e5) => function(e6) {
      M2.value && (M2.value.value.param[e6].value ? M2.value.value.param[e6].value.push({ type: li.param, value: "" }) : M2.value.value.param[e6].value = [{ type: li.param, value: "" }]);
    }(a2) }, { default: k(() => t3[0] || (t3[0] = [x("增加参数")])), _: 2, __: [0] }, 1032, ["onClick"])])) : f("", true)]))), 128))], 2);
  };
} }), bf = eo(Cf, [["__scopeId", "data-v-aad21227"]]), kf = e({ __name: "ParamsModal", emits: ["register", "submit"], setup(e2, { emit: t2 }) {
  const o2 = t2, [l2, { resetFields: n2, setFieldsValue: a2, validate: i2, resetSchema: r2 }] = wt({ name: "model_form_item", labelWidth: 180, baseColProps: { span: 24 }, showActionButtonGroup: false, autoSubmitOnEnter: true }), u2 = Sr(), c2 = y(), [p2, { setModalProps: f2, closeModal: m2 }] = bt(async (e3) => {
  ...
  return (e3, t3) => (s(), h(d(Ct), $(e3.$attrs, { onRegister: d(p2), title: "输入参数值", onOk: v2 }), { default: k(() => [g(d(Mt), { onRegister: d(l2), onSubmit: v2 }, null, 8, ["onRegister"])]), _: 1 }, 16, ["onRegister"]));
} }), Mf = e({ __name: "FormulaTest", props: { open: { type: Boolean, default: false }, curQuery: { type: Object }, curParams: { type: Object } }, emits: ["close"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, a2 = Se().getThemeColor, i2 = Sr(), c2 = y(false);
  n(() => o2.open, (e3) => {
    c2.value = e3, e3 && p2();
  });
  const p2 = Te((e3) => {
    let t3 = 1, l3 = 10;
    e3 && (t3 = e3.current, l3 = e3.pageSize), Ri({ sourceId: i2.getSourceId, sourceType: i2.getSourceType, sqlQuery: o2.curQuery || {}, params: o2.curParams }, { pageNum: t3, pageSize: l3 }).then((e4) => {
  ...
  }, 200), [m2, { setColumns: v2, setTableData: C2, setPagination: b2 }] = _t({ bordered: true, showIndexColumn: false, isCanResizeParent: true, canResize: true, onChange: p2 }), M2 = () => {
    c2.value = false, l2("close", true);
  };
  return (e3, t3) => (s(), h(d(fe), { title: "测试结果", placement: "bottom", open: c2.value, onClose: M2, height: 450 }, { default: k(() => [g(d($t), { onRegister: d(m2) }, { bodyCell: k(({ column: e4, record: t4 }) => [(e4 == null ? void 0 : e4.key) === d($r) ? (s(), r("div", { key: 0, style: u({ color: d(a2) }) }, S(t4[d($r)]), 5)) : f("", true)]), _: 1 }, 8, ["onRegister"])]), _: 1 }, 8, ["open"]));
} }), wf = e({ __name: "FormulaColModal", props: { queryMode: { type: Boolean, default: false } }, emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = t2, l2 = y(), n2 = y(), i2 = y(), u2 = a({ type: li.formula, value: null });
  let c2;
  const p2 = y(0), v2 = Sr(), [C2, { openModal: b2 }] = kt(), M2 = y(), w2 = y(), S2 = y(false), _2 = (e3) => {
    let t3 = "";
    return Array.isArray(e3.value) ? (e3.value.forEach((e4) => {
      ...
      t3 += `${_2(e4)},`;
    }), t3.endsWith(",") && (t3 = t3.slice(0, Math.max(0, t3.lastIndexOf(",")))), t3 += ")", t3) : (e3.type === li.param && (t3 += e3.value instanceof Object ? e3.value[e3.value[uf]] : e3.value), t3);
  }, [L2, { setModalProps: I2, closeModal: D2 }] = bt(async (e3) => {
  ...
  }), [z2, { openModal: E2 }] = kt(), P2 = y(), F2 = y(), H2 = y(false);
  async function Q2() {
    try {
      const e3 = await I2();
  ...
  function U2(e3, t3, l3) {
    t3.type !== li.operator ? (l3(false, t3), B2(true, { index: e3, sqlQuery: { ...o2.sqlQuery }, isUpdate: false })) : l3(true, t3);
  }
  function V2() {
  ...
  function K2() {
    var _a2, _b, _c2, _d2;
    P2.value = { schema: (_a2 = o2.sqlQuery) == null ? void 0 : _a2.schema, sourceTable: (_b = o2.sqlQuery) == null ? void 0 : _b.sourceTable, joins: (_c2 = o2.sqlQuery) == null ? void 0 : _c2.joins, sqlQuery: (_d2 = o2.sqlQuery) == null ? void 0 : _d2.sqlQuery, customColumns: [{ name: $r, expressions: f2.value }] };
    const e3 = Br(P2.value || {});
  ...
  return (t3, l3) => {
    const n3 = w("AButton");
    return s(), r(m, null, [g(d(Ct), $(t3.$attrs, { onRegister: d(A2), title: "自定义列配置", onOk: Q2 }), { centerFooter: k(() => [g(n3, { onClick: K2, type: "primary", danger: "" }, { default: k(() => l3[1] || (l3[1] = [x("测试")])), _: 1, __: [1] })]), default: k(() => [g(d(Mt), { onRegister: d(S2), onSubmit: Q2 }, { customCol: k(() => [g(d(vt), { "query-mode": e2.queryMode, "add-title": "添加字段", items: f2.value, onBlockBuild: U2, onAddBlock: V2, onEditBlock: W2 }, q({ tag: k(({ element: e3 }) => [p("div", { class: c(`${d(u2)}-slot-tag`) }, [g(d(Re), { icon: C2[e3.name].icon, color: d(i2) }, null, 8, ["icon", "color"])], 2)]), _: 2 }, [e2.queryMode ? void 0 : { name: "headerBar", fn: k(({ headerCallBack: e3 }) => [(s(true), r(m, null, v(C2, (t4, l4) => (s(), h(d(G), { key: l4, title: t4.name }, { default: k(() => [g(d(ge), { style: { cursor: "pointer" }, color: t4.color, draggable: "true", onClick: (l5) => function(e4, t5) {
    ...
    }(e4, t4) }, { icon: k(() => [g(d(Re), { icon: t4.icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["color", "onClick", "onDragstart"])]), _: 2 }, 1032, ["title"]))), 128))]), key: "0" }]), 1032, ["query-mode", "items"])]), _: 1 }, 8, ["onRegister"]), g(ef, { onRegister: d(D2), onSubmit: Y2 }, null, 8, ["onRegister"]), g(wf, { "query-mode": e2.queryMode, onRegister: d(N2), onSubmit: Z2 }, null, 8, ["query-mode", "onRegister"]), g(Mf, { "cur-query": P2.value, "cur-params": F2.value, open: H2.value, onClose: l3[0] || (l3[0] = () => H2.value = false) }, null, 8, ["cur-query", "cur-params", "open"])]), _: 1 }, 16, ["onRegister"]), g(kf, { onRegister: d(z2), onSubmit: X2 }, null, 8, ["onRegister"])], 64);
  };
} }), Sf = eo(xf, [["__scopeId", "data-v-93a6f597"]]), _f = e({ __name: "TableCustomCol", props: { sqlQuery: { type: Object }, level: { type: Number, default: 1 }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["customColChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, i2 = y([]);
  function u2() {
    a2("customColChange");
  }
  const [c2, { openModal: p2 }] = kt(), m2 = l(() => {
    var _a2;
  ...
  return n(() => {
    ...
    var _a2;
    return s(), r("div", null, [void 0 !== ((_a2 = e2.sqlQuery) == null ? void 0 : _a2.customColumns) ? (s(), h(wp, { key: 0, "query-mode": e2.queryMode, icon: "ant-design:insert-row-right-outlined", title: "自定义列", onDeleteConfig: u2, onExecute: x2, full: true }, { config: k(() => [g(d(vt), { "query-mode": e2.queryMode, items: i2.value, "add-title": "添加自定义列", onAddBlock: v2, onEditBlock: C2, onDragChange: b2 }, null, 8, ["query-mode", "items"])]), _: 1 }, 8, ["query-mode"])) : f("", true), m2.value ? (s(), h(Dp, { key: 1, class: "config-button", title: "自定义列", icon: "ant-design:insert-row-right-outlined", level: 0, onClick: M(w2, ["prevent"]) })) : f("", true), g(Sf, { "query-mode": e2.queryMode, onRegister: d(c2), "sql-query": e2.sqlQuery, onSubmit: S2 }, null, 8, ["query-mode", "onRegister", "sql-query"])]);
  };
} }), $f = { class: "btn-bar" }, Lf = eo(e({ __name: "ApiConfig", props: { configKey: { type: Number, default: 0, require: true }, sqlQuery: { type: Object, require: true, default: void 0 }, level: { type: Number, default: 1 }, configMitt: { type: Object, default: void 0 }, queryMode: { type: Boolean, default: false } }, emits: ["configChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, n2 = t2, { sqlQuery: a2 } = A(o2), { prefixCls: i2 } = xe("api-config"), m2 = Se().getThemeColor, v2 = y(), C2 = y(), { focused: b2 } = Ne(v2), { focused: k2 } = Ne(C2), M2 = Sr(), x2 = y(false), S2 = l(() => {
    var _a2;
  ...
  function N2(e3) {
    ...
    F2(t3) || (n2("configChange", t3), M2.setFieldsChange(o2.level));
  }
  function B2(e3) {
  ...
  function j2() {
    ...
    F2(e3) || (n2("configChange", e3), M2.setFieldsChange(o2.level));
  }
  function z2(e3) {
  ...
  async function Q2() {
    ...
    if (Tr(o2.sqlQuery, o2.level)) {
      const e3 = await H2();
      return e3.joins = [], Ip(e3.joins), void n2("configChange", e3, true);
    }
    ((_a2 = a2 == null ? void 0 : a2.value) == null ? void 0 : _a2.joins) && Ip((_b = a2 == null ? void 0 : a2.value) == null ? void 0 : _b.joins);
  }
  function G2() {
    W2(["filters"]);
  }
  ...
  async function W2(e3) {
    ...
    if (Tr(o2.sqlQuery, o2.level)) return t3 = await H2(), void l2(t3, true);
  ...
  function K2() {
    var _a2;
    (_a2 = o2.configMitt) == null ? void 0 : _a2.emit(Lr.QUERY_SQL, o2.sqlQuery), k2.value = false;
  }
  function X2() {
  ...
  return (t3, o3) => {
    ...
    return s(), r("div", { class: c([d(i2), e2.level < d(M2).getLevel ? "inner" : "", d(M2).getShowData && d(M2).getShowDataLevel === e2.level ? "active" : ""]) }, [d(M2).getShowData && d(M2).getShowDataLevel === e2.level ? (s(), r("div", { key: 0, class: "select", style: u({ backgroundColor: d(m2) }) }, [g(d(Be), { icon: "ant-design:check-outlined", color: "#FFFFFF", size: 12 })], 4)) : f("", true), void 0 !== ((_a2 = d(a2)) == null ? void 0 : _a2.sqlQuery) ? (s(), h(l2, { key: 1, "config-key": e2.configKey, "query-mode": e2.queryMode, "sql-query": d(a2).sqlQuery, level: e2.level - 1, "config-mitt": e2.configMitt, onConfigChange: P2 }, null, 8, ["config-key", "query-mode", "sql-query", "level", "config-mitt"])) : f("", true), (s(), h(Sp, { key: e2.configKey + d(M2).getFieldsChange, class: "config", "sql-query": d(a2), "query-mode": e2.queryMode, "config-mitt": e2.configMitt, onFieldChange: T2 }, null, 8, ["sql-query", "query-mode", "config-mitt"])), (s(), h(Rp, { level: e2.level, key: e2.configKey, class: "config", "sql-query": d(a2), "config-mitt": e2.configMitt, "query-mode": e2.queryMode, onJoinChange: N2 }, null, 8, ["level", "sql-query", "config-mitt", "query-mode"])), (s(), h(Up, { "query-mode": e2.queryMode, level: e2.level, key: e2.configKey, class: "config", "sql-query": d(a2), "config-mitt": e2.configMitt, onFilterChange: B2 }, null, 8, ["query-mode", "level", "sql-query", "config-mitt"])), (s(), h(_f, { "query-mode": e2.queryMode, level: e2.level, key: e2.configKey, class: "config", "sql-query": d(a2), "config-mitt": e2.configMitt, onCustomColChange: R2 }, null, 8, ["query-mode", "level", "sql-query", "config-mitt"])), (s(), h(Zp, { "query-mode": e2.queryMode, key: e2.configKey, class: "config", "sql-query": d(a2), "config-mitt": e2.configMitt, onAggregateChange: q2, onGroupChange: O2, onDeleteAggregate: j2 }, null, 8, ["query-mode", "sql-query", "config-mitt"])), (s(), h(Jp, { "query-mode": e2.queryMode, key: e2.configKey, class: "config", "sql-query": d(a2), "config-mitt": e2.configMitt, onOrderChange: z2 }, null, 8, ["query-mode", "sql-query", "config-mitt"])), (s(), h(qp, { "query-mode": e2.queryMode, key: e2.configKey, class: "config", "sql-query": d(a2), "config-mitt": e2.configMitt, onLimitChange: E2 }, null, 8, ["query-mode", "sql-query", "config-mitt"])), p("div", $f, [S2.value ? (s(), h(Dp, { key: 0, class: "config-button", title: "关联", iconfont: "icon-mfish-join", level: e2.level, onClick: Q2 }, null, 8, ["level"])) : f("", true), _2.value ? (s(), h(Dp, { key: 1, class: "config-button", title: "过滤", icon: "ant-design:filter-outlined", level: e2.level, onClick: G2 }, null, 8, ["level"])) : f("", true), $2.value ? (s(), h(Dp, { key: 2, class: "config-button", title: "自定义列", icon: "ant-design:insert-row-right-outlined", level: e2.level, onClick: U2 }, null, 8, ["level"])) : f("", true), L2.value ? (s(), h(Dp, { key: 3, class: "config-button", title: "聚合", iconfont: "icon-mfish-sum", level: e2.level, onClick: V2 }, null, 8, ["level"])) : f("", true), I2.value ? (s(), h(Dp, { key: 4, class: "config-button", title: "排序", icon: "ant-design:sort-ascending-outlined", level: e2.level, onClick: Y2 }, null, 8, ["level"])) : f("", true), D2.value ? (s(), h(Dp, { key: 5, class: "config-button", title: "行数", icon: "ant-design:column-height-outlined", level: e2.level, onClick: Z2 }, null, 8, ["level"])) : f("", true), g(Dp, { class: "config-button", ref_key: "querySqlRef", ref: C2, style: u({ fontWeight: "bold", border: `1px dashed ${d(m2)}` }), title: "查看SQL", icon: "ant-design:console-sql-outlined", level: e2.level, onClick: K2 }, null, 8, ["style", "level"]), g(Dp, { class: "config-button", style: u({ fontWeight: "bold", border: `1px dashed ${d(m2)}` }), ref_key: "queryDataRef", ref: v2, title: "执行", onMouseenter: o3[0] || (o3[0] = (e3) => x2.value = true), onMouseleave: o3[1] || (o3[1] = (e3) => x2.value = false), icon: !d(M2).getShowData || d(M2).getShowDataLevel !== e2.level || x2.value ? "ant-design:caret-right-outlined" : "ant-design:check-outlined", level: e2.level, onClick: X2 }, null, 8, ["style", "icon", "level"])])], 2);
  };
} }), [["__scopeId", "data-v-32695b70"]]), If = { key: 0 }, Df = { key: 1 }, Tf = e({ __name: "SqlQueryModal", setup(e2) {
  const t2 = y(500), o2 = y(""), [l2, { setModalProps: n2 }] = bt(async (e3) => {
    n2({ width: "800px" }), o2.value = e3;
  }), { copy: a2, copied: i2 } = De({ legacy: true });
  function c2(e3) {
    t2.value = e3;
  }
  return (e3, n3) => {
    const p2 = w("AButton");
    return s(), h(d(Ct), $(e3.$attrs, { onRegister: d(l2), title: "SQL查看", "show-ok-btn": false, "cancel-text": "关闭", onHeightChange: c2 }), { insertFooter: k(() => [g(p2, { onClick: n3[0] || (n3[0] = (e4) => d(a2)(o2.value)), color: d(i2) ? "success" : "primary" }, { default: k(() => [d(i2) ? (s(), r("span", Df, "已拷贝")) : (s(), r("span", If, "拷贝"))]), _: 1 }, 8, ["color"])]), default: k(() => [g(d(Lt), { style: u({ height: `${t2.value}px` }), mode: d(It).JS, value: o2.value, "onUpdate:value": n3[1] || (n3[1] = (e4) => o2.value = e4), readonly: true }, null, 8, ["style", "mode", "value"])]), _: 1 }, 16, ["onRegister"]);
  };
} });
const Nf = ["src"], Bf = eo(e({ name: "PreviewFrame", __name: "PreviewFrame", props: { frameSrc: Tt.string.def(""), frameWidth: Tt.number.def(400), frameHeight: Tt.number.def(300) }, emits: ["message"], setup(e2, { expose: t2, emit: o2 }) {
  ...
  } }), (t3, o3) => (s(), h(d(mt), null, { default: k(() => [p("iframe", { style: u(m2.value), src: e2.frameSrc, class: c(`${d(g2)}__main`), ref_key: "frameRef", ref: f2, onLoad: v2 }, null, 46, Nf)]), _: 1 }));
} }), [["__scopeId", "data-v-1bb3fd25"]]);
const Rf = { class: "share-title" }, qf = e({ __name: "ScreenPreview", props: { fixScale: { type: Number, default: 1 }, borderRadius: { type: String } }, setup(e2) {
  const t2 = e2, { prefixCls: n2 } = xe("screen-preview"), { token: C2 } = F.useToken(), b2 = l(() => C2.value.colorBorder), M2 = o("fitDomRef"), w2 = y([]), { getAntdLocale: x2 } = Dt(), $2 = qr(), { antTheme: L2 } = Le(l(() => $2.getTheme)), I2 = y(false), D2 = y(""), T2 = y(window.innerWidth), N2 = y(window.innerHeight), B2 = y(), R2 = l(() => [...$2.getComponentList].reverse()), q2 = a({ width: 0, height: 0 }), A2 = l(() => ({ ...Vd($2.getCanvasConfig), width: $2.getCanvasConfig.width * q2.width * t2.fixScale + "px", height: $2.getCanvasConfig.height * q2.height * t2.fixScale + "px" })), E2 = (e3) => Jd({ ...e3.chartContain.dropInfo }), P2 = (e3) => {
    var _a2, _b;
  ...
  const { register: U2, unRegister: V2 } = function() {
    const { getDataTable: e3 } = ns(), t3 = [], o2 = qr();
    return { register: async function() {
      const l2 = (o3) => {
        ...
        ((_a2 = o3.data.autoRefresh) == null ? void 0 : _a2.open) && o3.data.autoRefresh.interval && t3.push(setInterval(() => {
          e3(o3).then((e4) => {
            var _a3;
            o3.type && ((_a3 = Gd[o3.type]) == null ? void 0 : _a3.initData(o3, e4));
          });
        }, 60 * o3.data.autoRefresh.interval * 1e3));
      };
      t3.length = 0;
      for (const e4 of o2.getComponentList) if (l2(e4.chart), e4.chart.type === ls.MfCombine) for (const t4 of e4.chart.options.components) l2(t4.chart);
    }, unRegister: function() {
    ...
    setTimeout(() => {
      $2.loadingScreen().then(() => {
        ...
        for (let e4 = 0; e4 < R2.value.length; e4++) {
          ...
          Ud.on(Hr.EVENT_ANIMATION, (o4) => {
            Hd(o4, t3, w2.value[e4]);
          });
          ...
          !o3 || 0 === o3.length || w2.value.length <= e4 || (R2.value[e4].chartContain.show && R2.value[e4].chart.type !== ls.MfCombine && (R2.value[e4].chartContain.show = false, n3.set(e4, R2.value[e4])), setTimeout(() => {
            n3.has(e4) && (n3.get(e4).chartContain.show = true), Fd(w2.value[e4], o3).then();
          }, 600));
        }
      });
    }, 10), Ud.on(Hr.SHOW_MODAL, (e3) => {
      var _a2, _b, _c2, _d2, _e2, _f2;
  ...
  return (t3, o3) => (s(), r("div", { class: c(d(i2)) }, [p("div", { class: c(["title", [e2.allowCollapse ? "collapsed" : ""]]), onClick: m2 }, [p("div", zf, [e2.allowCheck ? (s(), h(d(W), { key: 0, checked: n2.value, "onUpdate:checked": o3[0] || (o3[0] = (e3) => n2.value = e3), onClick: o3[1] || (o3[1] = M(() => {
  }, ["stop"])), onChange: v2 }, null, 8, ["checked"])) : f("", true), e2.tooltip ? (s(), h(d(G), { key: 1, title: e2.tooltip }, { default: k(() => [x(S(e2.title), 1)]), _: 1 }, 8, ["title"])) : (s(), r("span", Ef, S(e2.title), 1)), !e2.allowCheck && e2.allowCollapse || e2.allowCheck && e2.titleCheck ? (s(), h(d(Be), { key: 3, icon: `ant-design:${a2.value ? "up" : "down"}-outlined`, size: 12 }, null, 8, ["icon"])) : f("", true)]), e2.allowCopy ? (s(), r("div", Pf, [g(d(G), { placement: "top", title: `复制${e2.title}` }, { default: k(() => [g(d(Be), { "aria-hidden": "false", size: 12, icon: "iconfont:icon-mfish-copy", onClick: M(C2, ["stop"]) })]), _: 1 }, 8, ["title"]), g(d(G), { placement: "top", title: `粘贴${e2.title}` }, { default: k(() => [g(d(Be), { "aria-hidden": "false", size: 12, icon: "iconfont:icon-mfish-paste", onClick: M(b2, ["stop"]) })]), _: 1 }, 8, ["title"])])) : f("", true)], 2), g(d(Bt), { show: !e2.allowCheck && a2.value || e2.allowCheck && a2.value && e2.titleCheck }, { default: k(() => [p("div", Ff, [R(t3.$slots, "default", {}, void 0, true)])]), _: 3 }, 8, ["show"])], 2));
} }), Qf = eo(Hf, [["__scopeId", "data-v-505219ba"]]), Gf = { class: "table-bordered" }, Uf = e({ __name: "GlobalParamsConfig", setup(e2) {
  const { prefixCls: t2 } = xe("global-params-config"), o2 = qr(), l2 = [{ title: "参数名", dataIndex: "name", align: "center" }, { title: "默认值", dataIndex: "defaultValue", align: "center" }];
  return (e3, n2) => (s(), r("div", { class: c(d(t2)) }, [g(Qf, { title: "全局变量", tooltip: "用于大屏全局接收外部参数" }, { default: k(() => {
    var _a2;
    return [p("div", Gf, [g(d(be), { size: "small", columns: l2, "data-source": (_a2 = d(o2).getCanvasConfig) == null ? void 0 : _a2.globalParams, bordered: "", pagination: false }, null, 8, ["data-source"])])];
  }), _: 1 })], 2));
} }), Vf = { class: "title" }, Wf = { class: "title" }, Yf = { class: "title" }, Zf = e({ __name: "CanvasConfig", setup(e2) {
  const { prefixCls: t2 } = xe("canvas-config"), o2 = qr(), l2 = y(), n2 = [{ title: "深色", value: Ge.DARK }, { title: "浅色", value: Ge.LIGHT }, { title: "跟随平台", value: Ge.SYSTEM }], u2 = a({ [Fr.FIT_BOX]: { name: "全屏铺满", icon: "carbon:fit-to-screen", description: "全屏铺满（设备与配置大屏比例不同时会变形）" }, [Fr.FIT_ORIGINAL]: { name: "原始比例", icon: "carbon:center-to-fit", description: "原始比例（保持配置大屏比例，不填充空白处）" }, [Fr.FIT_WIDTH_SCALE]: { name: "横向适配", icon: "carbon:fit-to-width", description: "横向适配-保持纵横比（横向铺满，允许纵向滚动，保持原有画布比例）" }, [Fr.FIT_HEIGHT_SCALE]: { name: "纵向适配", icon: "carbon:fit-to-height", description: "纵向适配-保持纵横比（纵向铺满，允许横向滚动，保持原有画布比例）" }, [Fr.FIT_WIDTH]: { name: "横向适配", icon: "carbon:fit-to-width", description: "横向适配（横向铺满，允许纵向滚动，会变形）" }, [Fr.FIT_HEIGHT]: { name: "纵向适配", icon: "carbon:fit-to-height", description: "纵向适配（纵向铺满，允许横向滚动，会变形）" } });
  function f2(e3) {
    C2(e3), l2.value = e3;
  }
  function C2(e3) {
  ...
  return i(() => {
    ...
    const i2 = w("AInput");
    return s(), h(d(mt), null, { default: k(() => [p("div", { class: c(d(t2)) }, [a2[8] || (a2[8] = p("div", { class: "title" }, "大屏名称", -1)), g(i2, { value: d(o2).getCanvasConfig.screenName, "onUpdate:value": a2[0] || (a2[0] = (e4) => d(o2).getCanvasConfig.screenName = e4), "show-count": "", maxlength: 30 }, null, 8, ["value"]), a2[9] || (a2[9] = p("div", { class: "title" }, " 描述", -1)), g(d(ke), { value: d(o2).getCanvasConfig.screenDesc, "onUpdate:value": a2[1] || (a2[1] = (e4) => d(o2).getCanvasConfig.screenDesc = e4), "show-count": "", maxlength: 200 }, null, 8, ["value"]), a2[10] || (a2[10] = p("div", { class: "title" }, "大屏尺寸", -1)), g(jf), p("div", Vf, [a2[5] || (a2[5] = x(" 主题 ")), g(d(Z), { size: "small", value: d(o2).getCanvasConfig.theme, "onUpdate:value": a2[2] || (a2[2] = (e4) => d(o2).getCanvasConfig.theme = e4) }, { default: k(() => [(s(), r(m, null, v(n2, (e4, t3) => g(d(Y), { key: t3, value: e4.value }, { default: k(() => [x(S(e4.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])]), a2[11] || (a2[11] = p("div", { class: "title" }, "背景颜色", -1)), g(d(zo), { value: l2.value, onConfirmChange: f2, onInputChange: C2 }, null, 8, ["value"]), a2[12] || (a2[12] = p("div", { class: "title" }, "背景图片", -1)), g(d(Nt), { "file-keys": d(o2).getCanvasConfig.backgroundImage, accepts: ".jpg,.jpeg,.png,.svg", "button-text": "上传背景", "max-count": 1, "is-pic": true, onSuccess: b2, onRemove: M2 }, null, 8, ["file-keys"]), p("div", Wf, [a2[6] || (a2[6] = x(" 水印 ")), p("div", null, [g(i2, { value: d(o2).getCanvasConfig.watermark, "onUpdate:value": a2[3] || (a2[3] = (e4) => d(o2).getCanvasConfig.watermark = e4), placeholder: "清空无水印", "show-count": "", maxlength: 50 }, null, 8, ["value"])])]), p("div", Yf, [a2[7] || (a2[7] = x(" 适配方式 ")), p("div", null, [g(d(Z), { value: d(o2).getCanvasConfig.fitType, "onUpdate:value": a2[4] || (a2[4] = (e4) => d(o2).getCanvasConfig.fitType = e4) }, { default: k(() => [(s(true), r(m, null, v(Object.keys(u2), (e4) => (s(), h(d(G), { key: e4, placement: "bottomRight", title: u2[e4].description }, { default: k(() => [g(d(Y), { class: c(`${d(t2)}-radio-button`), value: e4 }, { default: k(() => [g(d(Be), { icon: u2[e4].icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["class", "value"])]), _: 2 }, 1032, ["title"]))), 128))]), _: 1 }, 8, ["value"])])]), g(Uf)], 2)]), _: 1 });
  };
} }), Kf = eo(Zf, [["__scopeId", "data-v-c7f8401a"]]), Xf = { class: "header" }, Jf = e({ name: "FrameConfig", __name: "index", props: { collapsed: Tt.bool.def(false) }, setup(e2, { expose: t2 }) {
  const o2 = e2, { prefixCls: a2 } = xe("frame-config"), i2 = l(() => [a2, { collapsed: o2.collapsed }]), u2 = y(), m2 = y(), v2 = y(), C2 = qr(), b2 = y();
  function M2(e3) {
    if (e3) {
      const t3 = Gd[e3.chart.type].config;
      u2.value = Object.keys(t3).filter((e4) => t3[e4].show).map((e4) => t3[e4]);
    } else u2.value = [{ value: "画布配置", payload: { icon: "carbon:gui-management", component: T(Kf) } }];
    m2.value = u2.value[0].value, u2.value[0].payload.component ? v2.value = E(u2.value[0].payload.component) : v2.value = null;
  }
  function w2(e3) {
    var _a2;
    m2.value = e3;
  ...
  return n([() => C2.getCurComponent, () => {
    ...
    b2.value = e3;
  } }), (e3, t3) => (s(), r("div", { class: c(i2.value) }, [p("div", Xf, [g(d(U), { value: m2.value, options: u2.value, onChange: w2, block: "" }, { label: k(({ value: e4, payload: t4 }) => [t4.icon ? (s(), h(d(Be), { key: 0, icon: t4.icon }, null, 8, ["icon"])) : f("", true), x(" " + S(e4), 1)]), _: 1 }, 8, ["value", "options"])]), (s(), h(j(v2.value), { "select-data": b2.value }, { "data-select": k(() => [R(e3.$slots, "data-select", { curSelect: b2.value })]), _: 3 }, 8, ["select-data"]))], 2));
} }), eh = { class: "action" }, th = { class: "ac-int" }, oh = e({ __name: "CanvasRulerLine", props: { lineValue: { type: Number, default: 0 }, lineList: { type: Array, default: () => [] } }, setup(e2) {
  const t2 = e2, { lineList: o2 } = t2, l2 = qr(), { prefixCls: n2 } = xe("canvas-ruler-line"), a2 = Se().getThemeColor;
  return (e3, t3) => (s(), r("div", { class: c(d(n2)) }, [(s(true), r(m, null, v(d(o2), (e4, t4) => (s(), r("div", { class: c(["line-item", { x: "x" === e4.position, y: "y" === e4.position }]), style: u({ left: "x" === e4.position ? `${Math.round(e4.offset * d(l2).getScale)}px` : 0, top: "y" === e4.position ? `${Math.round(e4.offset * d(l2).getScale)}px` : 0 }), key: `${e4}${t4}` }, [p("div", eh, [g(d(Be), { class: "ac-close", icon: "ant-design:close-outline", color: d(a2), onClick: (l3) => function(e5, t5) {
    o2.splice(t5, 1);
  }(e4.position, t4) }, null, 8, ["color", "onClick"]), p("span", th, S(e4.value), 1)])], 6))), 128))], 2));
} }), lh = eo(oh, [["__scopeId", "data-v-91bb6b29"]]), nh = { id: "horn", class: "horn" }, ah = ["id", "width", "height"], ih = { class: "indicator-value" }, rh = ["id", "height", "width"], sh = { class: "indicator-value" }, uh = e({ __name: "CanvasRuler", props: { rulerXLeft: { type: Number, default: 0 }, rulerYTop: { type: Number, default: 0 }, rulerX: { type: Number, default: 5e3 }, rulerY: { type: Number, default: 3e3 }, drift: { type: Number, default: 0 }, rulerHeight: { type: Number, default: 28 }, rulerWidth: { type: Number, default: 38 } }, setup(e2) {
  const t2 = e2, a2 = qr(), { prefixCls: i2 } = xe("canvas-ruler"), f2 = y(0), m2 = y(true), v2 = T({}), b2 = T({}), M2 = l(() => `${t2.rulerXLeft}px`), w2 = l(() => `${t2.rulerYTop}px`), x2 = o("rulerXRef"), _2 = o("rulerYRef"), $2 = l(() => Se().getDarkMode.value === Ge.DARK ? "#999" : "#666");
  n(() => Se().getDarkMode.value, (e3, t3) => {
    e3 !== t3 && C(() => {
      j2();
    });
  }), n([() => a2.getScale, () => t2.rulerX, () => t2.rulerY], ([e3, t3, o2], [l2, n2, a3]) => {
    l2 ? (e3 !== l2 && C(() => j2()), t3 !== n2 && C(() => F2()), o2 !== a3 && C(() => H2())) : C(() => j2());
  }, { immediate: true });
  ...
  return (t3, o2) => (s(), r("div", { class: c(d(i2)) }, [p("div", nh, [g(d(G), { title: (m2.value ? "隐藏" : "显示") + "辅助线" }, { default: k(() => [m2.value ? (s(), h(d(Be), { key: 0, class: "icon", icon: "ant-design:eye-outlined", onClick: Q2 })) : (s(), h(d(Be), { key: 1, class: "icon", icon: "ant-design:eye-invisible-outlined", onClick: Q2 }))]), _: 1 }, 8, ["title"])]), p("div", { class: "ruler rulerX", style: u({ width: `${L2.value}px`, left: M2.value }) }, [p("canvas", { ref_key: "rulerXRef", ref: x2, id: `${d(i2)}-x`, width: L2.value, height: e2.rulerHeight, onMousemove: D2, onMouseleave: N2, onClick: B2 }, null, 40, ah), p("div", { class: "indicator x", style: u(v2.value) }, [p("div", ih, S(f2.value), 1)], 4), O(g(lh, { "line-value": f2.value, "line-list": d(a2).getGuideLine.lineListY }, null, 8, ["line-value", "line-list"]), [[z, m2.value]])], 4), p("div", { class: "ruler rulerY", style: u({ height: `${I2.value}px`, top: w2.value }) }, [p("canvas", { ref_key: "rulerYRef", ref: _2, id: `${d(i2)}-y`, height: I2.value, width: e2.rulerWidth, onMousemove: R2, onMouseleave: q2, onClick: A2 }, null, 40, rh), p("div", { class: "indicator y", style: u(b2.value) }, [p("div", sh, S(f2.value), 1)], 4), O(g(lh, { "line-value": f2.value, "line-list": d(a2).getGuideLine.lineListX }, null, 8, ["line-value", "line-list"]), [[z, m2.value]])], 4)], 2));
} }), ch = eo(uh, [["__scopeId", "data-v-eeb86e63"]]), dh = e({ __name: "CanvasBackground", props: { drift: { type: Number, default: 0 }, width: { type: Number, default: 9e3 }, height: { type: Number, default: 6e3 }, ruler: { type: Object, default: () => ({ height: 28, width: 38 }) } }, setup(e2) {
  const t2 = e2, o2 = qr(), n2 = pp(), a2 = l(() => t2.width * o2.getScale + "px"), i2 = l(() => t2.height * o2.getScale + "px"), { prefixCls: p2 } = xe("canvas-background");
  function f2(e3) {
...
} }), ph = eo(dh, [["__scopeId", "data-v-2efcd248"]]), fh = { class: "scale-add-reduce" }, hh = { class: "scale-lock" }, gh = e({ __name: "CanvasScale", props: { scale: { type: Number, default: 100 }, minScale: { type: Number, default: 20 }, maxScale: { type: Number, default: 500 } }, emits: ["addScale", "reduceScale", "changeScale", "autoScale"], setup(e2, { emit: t2 }) {
  ...
  return (t3, o3) => (s(), r("div", { class: c(d(n2)) }, [p("div", fh, [g(d(Be), { class: "scale-icon", title: "放大", size: 18, icon: "ant-design:plus-outlined", onClick: i2 }), g(d(Q), { size: "small", bordered: false, value: e2.scale, max: e2.maxScale, min: e2.minScale, step: 5, controls: false, formatter: (e3) => `${Math.round(100 * e3)}`, onChange: u2 }, null, 8, ["value", "max", "min", "formatter"]), o3[2] || (o3[2] = p("div", { class: "scale-sign" }, "%", -1)), g(d(Be), { class: "scale-icon", title: "缩小", size: 18, icon: "ant-design:minus-outlined", onClick: a2 })]), p("div", hh, [g(d(G), { title: l2.value ? "锁定自动比例" : "解锁自动比例", placement: "right" }, { default: k(() => [l2.value ? (s(), h(d(Be), { key: 0, icon: "ant-design:unlock-outlined", onClick: o3[0] || (o3[0] = (e3) => f2(false)) })) : (s(), h(d(Be), { key: 1, icon: "ant-design:lock-outlined", onClick: o3[1] || (o3[1] = (e3) => f2(true)) }))]), _: 1 }, 8, ["title"])])], 2));
} }), yh = e({ __name: "ShortcutViewModal", setup(e2) {
  const [t2, { setModalProps: o2 }] = bt(async () => {
    o2({ confirmLoading: false, width: "800px", cancelText: "关闭", showOkBtn: false });
  }), [l2] = _t({ columns: [{ title: "功能", dataIndex: "label", width: 120 }, { title: "Win快捷键", dataIndex: "win", width: 120 }, { title: "Mac快捷键", dataIndex: "mac", width: 120 }], dataSource: [{ label: "拖拽 / 放大缩小画布", win: "CTRL + 🖱️拖动 / 滚动", mac: "⌘ + 🖱️拖动 / 滚动", macSource: true }, { label: "向 上/右/下/左 移动", win: "CTRL + ↑ / → / ↓ / ←", mac: "⌘ + ↑" }, { label: "锁定/解锁", win: "CTRL + L / CTRL + SHIFT+ L", mac: "⌘ + L / ⌘ + ⇧ + L" }, { label: "隐藏/显示", win: "CTRL + H / CTRL + SHIFT + H", mac: "⌘ + H / ⌘ + ⇧ + H" }, { label: "组合/拆分", win: "CTRL + G / CTRL + SHIFT + G", mac: "⌘ + G / ⌘ + SHIFT + G" }, { label: "后退/前进", win: "CTRL + Z / CTRL + SHIFT + Z", mac: "⌘ + Z / ⌘ + ⇧ + Z" }, { label: "复制/粘贴", win: "CTRL + C / V", mac: "⌘ + C / V" }, { label: "多选", win: "拖动🖱️框选 / CTRL + 🖱️点击", mac: "拖动🖱️框选 / ⌘ + 🖱️点击" }, { label: "保存", win: "CTRL + S", mac: "⌘ + S" }, { label: "预览", win: "CTRL + P", mac: "⌘ + P" }, { label: "全选", win: "CTRL + A", mac: "⌘ + A" }, { label: "删除", win: "Delete", mac: "Delete" }], bordered: true, showIndexColumn: false, pagination: false, canResize: false, size: "small" });
  return (e3, o3) => (s(), h(d(Ct), { onRegister: d(t2), title: "快捷操作" }, { default: k(() => [g(d($t), { onRegister: d(l2) }, null, 8, ["onRegister"])]), _: 1 }, 8, ["onRegister"]));
} }), mh = eo(e({ __name: "CanvasOperator", setup(e2) {
  const { prefixCls: t2 } = xe("canvas-operator"), [o2, { openModal: l2 }] = kt();
  function n2() {
    l2(true, {});
  }
  return (e3, l3) => (s(), r(m, null, [p("div", { class: c(d(t2)) }, [g(d(G), { title: "快捷方式", placement: "right" }, { default: k(() => [g(d(Be), { icon: "carbon:table-shortcut", onClick: n2 })]), _: 1 })], 2), g(yh, { onRegister: d(o2) }, null, 8, ["onRegister"])], 64));
} }), [["__scopeId", "data-v-2148ffa6"]]), vh = { lt: function(e2, t2, o2, l2, n2, a2) {
...
}, t: Ch, rt: function(e2, t2, o2, l2, n2, a2) {
  const { symmetricPoint: i2 } = n2;
...
}, r: bh, rb: function(e2, t2, o2, l2, n2, a2) {
  const { symmetricPoint: i2 } = n2;
  ...
  c2 > 10 && d2 > 10 && (e2.width = Math.round(c2 / a2), e2.height = Math.round(d2 / a2), e2.x = Math.round(s2.x / a2), e2.y = Math.round(s2.y / a2));
}, b: Ch, lb: function(e2, t2, o2, l2, n2, a2) {
  const { symmetricPoint: i2 } = n2;
...
function Ch(e2, t2, o2, l2, n2, a2) {
  const { symmetricPoint: i2, curPoint: r2 } = n2, s2 = Yr(t2, r2, -e2.rotate), u2 = Yr({ x: r2.x, y: s2.y }, r2, e2.rotate), c2 = Math.hypot(u2.x - i2.x, u2.y - i2.y), d2 = u2.x - (u2.x - i2.x) / 2, p2 = u2.y + (i2.y - u2.y) / 2;
  let f2 = e2.width;
...
function bh(e2, t2, o2, l2, n2, a2) {
  const { symmetricPoint: i2, curPoint: r2 } = n2, s2 = Yr(t2, r2, -e2.rotate), u2 = Yr({ x: s2.x, y: r2.y }, r2, e2.rotate), c2 = Math.hypot(u2.x - i2.x, u2.y - i2.y), d2 = u2.x - (u2.x - i2.x) / 2, p2 = u2.y + (i2.y - u2.y) / 2;
  let f2 = e2.height;
...
const kh = ["onMousedown"], Mh = { key: 2, class: "cover-layer-out" }, wh = { key: 0, class: "cover-hover" }, xh = e({ name: "ChartContain", __name: "index", props: { comOption: { require: true, type: Object, default: () => ({ chart: {}, chartContain: {} }) }, index: { require: true, type: Number, default: 0 } }, setup(e2) {
  t((e3) => ({ "15d86f1b": g2.value }));
  const n2 = e2, { token: a2 } = F.useToken(), g2 = l(() => a2.value.colorInfoBg), C2 = l(() => a2.value.colorBorder), b2 = o("chartContainRef"), k2 = o("chartItemRef"), { prefixCls: w2 } = xe("chart-contain"), x2 = { points: ["lt", "t", "rt", "r", "rb", "b", "lb", "l"], initAngle: { lt: 0, t: 45, rt: 90, r: 135, rb: 180, b: 225, lb: 270, l: 315 }, pointCursor: [{ start: 338, end: 23, cursor: "nw" }, { start: 23, end: 68, cursor: "n" }, { start: 68, end: 113, cursor: "ne" }, { start: 113, end: 158, cursor: "e" }, { start: 158, end: 203, cursor: "se" }, { start: 203, end: 248, cursor: "s" }, { start: 248, end: 293, cursor: "sw" }, { start: 293, end: 338, cursor: "w" }] }, S2 = y(false), _2 = y(false), $2 = y({}), L2 = qr(), I2 = pp(), D2 = l(() => [w2, { active: q2.value || A2.value }]), T2 = l(() => {
    var _a2, _b, _c2, _d2;
  ...
  async function E2(e3) {
    if (I2.setShowMenu(false), e3.ctrlKey || e3.metaKey) return void vp(n2.comOption);
    ...
    const a3 = setInterval(() => {
      ...
      d(S2) ? L2.setUndoRedoData("组件移动") : L2.cleanSelectArea(), S2.value = false, clearInterval(a3), t2 && mp(L2.getSelectArea.components), Ud.emit(Hr.UN_MOVE), document.removeEventListener("mousemove", i2), document.removeEventListener("mouseup", r2), $2.value = P2(n2.comOption);
    };
    document.addEventListener("mousemove", i2), document.addEventListener("mouseup", r2);
  }
  function P2(e3) {
    if (!e3) return;
    const { pointCursor: t2, initAngle: o2, points: l2 } = x2, n3 = Jr(e3.chartContain.dropInfo.rotate), a3 = {};
    let i2 = -1;
    return l2.forEach((e4) => {
      const l3 = Jr(o2[e4] + n3), r2 = t2.length;
      for (; ; ) {
        i2 = (i2 + 1) % r2;
        const o3 = t2[i2];
  ...
  function U2(e3, t2) {
    ...
    const c2 = function() {
      ...
      for (const e4 of n2.comOption.chart.options.components) if (![0, 90, 180, 360].includes(Jr(e4.chartContain.dropInfo.rotate))) return true;
      return false;
    }(), p2 = He((t3) => {
      ...
      !function(e4, t4, o3, l3, n4, a4, i4) {
        vh[e4](t4, o3, l3, n4, a4, i4);
      }(e3, o2, n3, i3, c2, { center: l2, curPoint: r2, symmetricPoint: s2 }, L2.getScale), j2(o2), Ud.emit(Hr.MOVE, false);
    }, 2), f2 = () => {
      d(S2) && L2.setUndoRedoData("组件大小调整"), S2.value = false, Ud.emit(Hr.UN_MOVE), document.removeEventListener("mousemove", p2), document.removeEventListener("mouseup", f2);
    };
  ...
  return i(() => {
    n2.comOption && ($2.value = P2(n2.comOption)), Ud.on(Hr.MOVE, () => {
      n2.comOption && L2.getCurComponent && n2.comOption.chart.id !== L2.getCurComponent.chart.id && !d(_2) && (_2.value = true);
    }), Ud.on(Hr.UN_MOVE, () => {
      _2.value = false;
    }), Ud.on(Hr.PLAY_ANIMATION, () => {
      var _a2, _b;
      n2.comOption.chart.id === ((_a2 = L2.getCurComponent) == null ? void 0 : _a2.chart.id) && void 0 === ((_b = n2.comOption.chart.options) == null ? void 0 : _b.selectIndex) && Fd(k2.value, n2.comOption.chart.animations).then(() => {
        Ud.emit(Hr.PLAY_ANIMATION_COMPLETE);
      });
    }), Ud.on(Hr.EVENT_ANIMATION, (e3) => {
      k2.value && Hd(e3, n2.comOption, k2.value);
    }), Ud.on(Hr.STOP_ANIMATION, () => {
      var _a2;
    ...
    var _a2, _b, _c2, _d2, _e2, _f2, _g2;
    return s(), r("div", { ref_key: "chartContainRef", ref: b2, class: c(D2.value), style: u(N2.value), onMousedown: M(E2, ["stop"]), onMouseenter: M(H2, ["prevent", "stop"]), onMouseleave: M(Q2, ["prevent"]) }, [(s(true), r(m, null, v(q2.value && !e2.comOption.chartContain.lock && e2.comOption.chartContain.show ? x2.points : [], (e3) => (s(), r("div", { key: e3, class: "contain-point", style: u(G2(e3)), onMousedown: M((t3) => U2(e3, t3), ["stop", "prevent"]) }, null, 44, kh))), 128)), O(p("div", { ref_key: "chartItemRef", ref: k2, class: "chart-item", style: u(B2.value) }, [R(t2.$slots, "default", {}, void 0, true)], 4), [[z, void 0 === ((_b = (_a2 = e2.comOption.chart) == null ? void 0 : _a2.showHide) == null ? void 0 : _b.show) && ((_c2 = e2.comOption.chartContain) == null ? void 0 : _c2.show) || void 0 !== ((_e2 = (_d2 = e2.comOption.chart) == null ? void 0 : _d2.showHide) == null ? void 0 : _e2.show) && ((_g2 = (_f2 = e2.comOption.chart) == null ? void 0 : _f2.showHide) == null ? void 0 : _g2.show)]]), q2.value && !e2.comOption.chartContain.lock && e2.comOption.chartContain.show ? (s(), h(d(Be), { key: 0, class: "icon-rotate", icon: "ant-design:sync-outlined", size: "20", onMousedown: M(V2, ["prevent", "stop"]) })) : f("", true), e2.comOption.chartContain.lock && e2.comOption.chartContain.show ? (s(), h(d(Be), { key: 1, class: "icon-lock", icon: "ant-design:lock-outlined" })) : f("", true), q2.value || A2.value || T2.value ? (s(), r("div", Mh, [T2.value ? (s(), r("div", wh)) : f("", true)])) : f("", true)], 38);
  };
} }), Sh = eo(xh, [["__scopeId", "data-v-2f19c653"]]), _h = "横上", $h = "横中", Lh = "横下", Ih = "纵左", Dh = "纵中", Th = "纵右", Nh = { class: "pos" }, Bh = e({ name: "ChartNearLine", __name: "index", setup(e2) {
  const t2 = a({ adsorb: 10, near: 2, lineStatus: { [_h]: { show: false, pos: 0, node: null }, [$h]: { show: false, pos: 0, node: null }, [Lh]: { show: false, pos: 0, node: null }, [Ih]: { show: false, pos: 0, node: null }, [Dh]: { show: false, pos: 0, node: null }, [Th]: { show: false, pos: 0, node: null } } }), o2 = qr(), { prefixCls: l2 } = xe("near-line");
  function n2(e3, { x: o3, y: l3, bottom: n3, right: a2, halfWidth: i2, halfHeight: r2 }) {
    ...
    return { y: [{ isNear: u2(e3.y, l3), isAdsorb: f2(e3.y, l3), lineNode: d2[_h].node, line: _h, dragShift: l3, lineShift: l3 }, { isNear: u2(e3.bottom, l3), isAdsorb: f2(e3.bottom, l3), lineNode: d2[_h].node, line: _h, dragShift: l3 - e3.height, lineShift: l3 }, { isNear: u2(e3.y + c2, l3 + r2), isAdsorb: f2(e3.y + c2, l3 + r2), lineNode: d2[$h].node, line: $h, dragShift: l3 + r2 - c2, lineShift: l3 + r2 }, { isNear: u2(e3.y, n3), isAdsorb: f2(e3.y, n3), lineNode: d2[Lh].node, line: Lh, dragShift: n3, lineShift: n3 }, { isNear: u2(e3.bottom, n3), isAdsorb: f2(e3.bottom, n3), lineNode: d2[Lh].node, line: Lh, dragShift: n3 - e3.height, lineShift: n3 }], x: [{ isNear: u2(e3.x, o3), isAdsorb: f2(e3.x, o3), lineNode: d2[Ih].node, line: Ih, dragShift: o3, lineShift: o3 }, { isNear: u2(e3.right, o3), isAdsorb: f2(e3.right, o3), lineNode: d2[Ih].node, line: Ih, dragShift: o3 - e3.width, lineShift: o3 }, { isNear: u2(e3.x + s2, o3 + i2), isAdsorb: f2(e3.x + s2, o3 + i2), lineNode: d2[Dh].node, line: Dh, dragShift: o3 + i2 - s2, lineShift: o3 + i2 }, { isNear: u2(e3.x, a2), isAdsorb: f2(e3.x, a2), lineNode: d2[Th].node, line: Th, dragShift: a2, lineShift: a2 }, { isNear: u2(e3.right, a2), isAdsorb: f2(e3.right, a2), lineNode: d2[Th].node, line: Th, dragShift: a2 - e3.width, lineShift: a2 }] };
  }
  function u2(e3, o3) {
    ...
    Ud.on(Hr.MOVE, (e3) => {
      !async function(e4) {
        ...
        e4 ? o2.getSelectArea.components.forEach((e5) => {
          l3.push({ com: e5, style: ep(e5.chartContain.dropInfo) });
        }) : l3.push({ com: o2.getCurComponent, style: ep(o2.getCurComponent.chartContain.dropInfo) });
        g2().then(), l3.forEach((l4) => {
          !function(e5, l5) {
            ...
            a2(n2(e5.style, { x: o2.getCanvasConfig.width / 2, y: o2.getCanvasConfig.height / 2, bottom: 0, right: 0, halfWidth: 0, halfHeight: 0 })), a2(n2(e5.style, { x: 0, y: 0, bottom: o2.getCanvasConfig.height, right: o2.getCanvasConfig.width, halfWidth: 0, halfHeight: 0 })), o2.getGuideLine.lineListX.forEach((t3) => {
              ...
              const i2 = ep(t3.chartContain.dropInfo), { x: r2, y: s2, bottom: u3, right: c2 } = i2, d2 = i2.width / 2, p2 = i2.height / 2;
  ...
  }), (e3, o3) => (s(), r("div", { class: c(d(l2)) }, [(s(true), r(m, null, v(Object.keys(t2.lineStatus), (e4) => O((s(), r("div", { key: e4, ref_for: true, ref: (o4) => t2.lineStatus[e4].node = o4, class: c(["line", e4.includes("横") ? "xLine" : "yLine"]) }, [p("div", Nh, S(t2.lineStatus[e4].pos), 1)], 2)), [[z, t2.lineStatus[e4].show || false]])), 128))], 2));
} }), Rh = eo(Bh, [["__scopeId", "data-v-88d9d34f"]]), qh = e({ name: "ChartMultiSelect", __name: "index", props: { selectArea: { type: Object, default: () => {
} } }, setup(e2) {
...
} }), Ah = eo(qh, [["__scopeId", "data-v-e9844525"]]), Oh = e({ name: "ScreenCanvas", __name: "index", setup(e2) {
  const { prefixCls: t2 } = xe("screen-canvas"), n2 = qr(), p2 = pp(), y2 = o("screenCanvasRef"), { getAntdLocale: C2 } = Dt(), { antTheme: b2 } = Le(l(() => n2.getTheme)), w2 = l(() => [...n2.getComponentList].reverse()), x2 = a({ canvasX: 0, canvasY: 0, area: { show: false, x: 0, y: 0, width: 0, height: 0 }, comMoving: false, isUp: false }), S2 = l(() => ({ ...Vd(n2.getCanvasConfig), transform: `scale(${n2.getScale})` })), _2 = (e3) => {
    var _a2, _b;
    if (((_b = (_a2 = e3.chart) == null ? void 0 : _a2.events) == null ? void 0 : _b.emits) && e3.chart.events.emits.length > 0) {
      for (const t3 of e3.chart.events.emits) if (t3 === is.CHART_CLICK || t3 === is.CHART_DBLCLICK) return "allow-pointer";
    }
  ...
  i(() => {
    n2.setScreenCanvas(y2.value ?? null), Ud.on(Hr.MOVE, () => {
      x2.comMoving || (x2.comMoving = true);
    }), Ud.on(Hr.UN_MOVE, () => {
      x2.comMoving = false;
    }), Ud.on(Hr.CREATE_CHART, (e3) => {
      L2(e3, 0, 0);
    });
  });
  const $2 = (e3) => {
  ...
  return (e3, o2) => (s(), r("div", { ref_key: "screenCanvasRef", ref: y2, class: c(d(t2)), onDrop: $2, onDragstart: o2[0] || (o2[0] = M(() => {
    ...
    var _a2;
    return s(), h(Sh, { key: ((_a2 = e4.chart) == null ? void 0 : _a2.id) + d(n2).getKey, index: w2.value.length - t3 - 1, "com-option": e4, class: c(_2(e4)) }, { default: k(() => {
      var _a3;
      return [(s(), h(j(e4.chart.type && d(Gd)[e4.chart.type].component), { class: c(["component", { move: x2.comMoving && e4.chart.id !== ((_a3 = d(n2).getCurComponent) == null ? void 0 : _a3.chart.id) }]), id: `com${e4.chart.id}`, chart: e4.chart, "chart-contain": e4.chartContain }, null, 8, ["class", "id", "chart", "chart-contain"]))];
    }), _: 2 }, 1032, ["index", "com-option", "class"]);
  }), 128))]), _: 1 }, 8, ["locale", "theme"]), g(Ah, { "select-area": x2.area }, null, 8, ["select-area"]), g(Rh)], 38));
} }), jh = eo(Oh, [["__scopeId", "data-v-9395352a"]]), zh = 0.2, Eh = e({ name: "FrameCanvas", __name: "index", props: { width: { type: Number, default: 5e3 }, height: { type: Number, default: 3e3 } }, setup(e2) {
  const t2 = y(true), { prefixCls: l2 } = xe("frame-canvas"), a2 = y(0), u2 = y(0), f2 = y(1e3), h2 = y(1), m2 = qr(), v2 = o("frameCanvasRef"), C2 = o("dropContentRef");
  let b2 = [0, 0], w2 = [0, 0];
  ...
  const x2 = He(() => {
    t2.value && (!function() {
      if (d(t2) && v2.value) {
        ...
        h2.value = n2 > l3 ? Number.parseFloat((o2 * l3 / m2.getCanvasConfig.width).toFixed(2)) : Number.parseFloat((t3 / l3 / m2.getCanvasConfig.height).toFixed(2)), d(h2) > 5 && (h2.value = 5), d(h2) < zh && (h2.value = zh);
      }
      m2.setScale(d(h2));
    }(), D2());
  }, 30);
  ...
  const $2 = He((e3) => {
    ...
    h2.value = "add" === e3 ? Math.min(5, Number.parseFloat((t3 + 0.05).toFixed(2))) : Math.max(zh, Number.parseFloat((t3 - 0.05).toFixed(2))), D2(), m2.setScale(h2.value);
  }, 100), L2 = He((e3) => {
  ...
  function T2(e3) {
    if (null === C2.value) return;
    const t3 = e3.pageX, o2 = e3.pageY, l3 = He((e4) => {
  ...
  return (o2, n2) => (s(), r("div", { class: c(d(l2)), ref_key: "frameCanvasRef", ref: v2 }, [g(ch, { "ruler-x-left": a2.value, "ruler-y-top": u2.value, drift: f2.value, "ruler-x": e2.width, "ruler-y": e2.height }, null, 8, ["ruler-x-left", "ruler-y-top", "drift", "ruler-x", "ruler-y"]), p("div", { ref_key: "dropContentRef", ref: C2, class: "drop-content", onScroll: S2 }, [g(ph, { width: e2.width, height: e2.height, drift: f2.value }, { default: k(() => [g(jh, { draggable: "true", onDragstart: M(T2, ["prevent", "stop"]) })]), _: 1 }, 8, ["width", "height", "drift"])], 544), g(mh), g(gh, { scale: h2.value, "min-scale": 20, "max-scale": 500, onAddScale: n2[0] || (n2[0] = (e3) => d($2)("add")), onReduceScale: n2[1] || (n2[1] = (e3) => d($2)("reduce")), onChangeScale: d(L2), onAutoScale: n2[2] || (n2[2] = (e3) => t2.value = e3) }, null, 8, ["scale", "min-scale", "max-scale", "onChangeScale"])], 2));
} }), Ph = eo(Eh, [["__scopeId", "data-v-de9ae999"]]), Fh = { key: 0, class: "header" }, Hh = { class: "title" }, Qh = { class: "content" }, Gh = eo(e({ name: "FrameBox", __name: "index", props: { showHeader: { type: Boolean, default: true }, icon: { type: String, default: "" }, iconSize: { type: Number, default: 14 }, title: { type: String, default: "" }, radioData: { type: Array, default: () => [] }, span: { type: Number, default: 8 }, chart: { type: Object } }, emits: ["radioChange", "titleClick"], setup(e2, { emit: t2 }) {
  ...
  return (t2, o3) => {
    var _a2;
    return s(), r("div", { class: c(k2.value), onMouseenter: w2, onMouseleave: x2, onMousedown: $2 }, [p("div", Uh, [e2.item.chart.type === d(ls).MfCombine ? (s(), r("div", { key: 0, onClick: _2 }, [n2.expand ? (s(), h(d(gt), { key: 0, class: "group", "two-tone-color": d(b2) }, null, 8, ["two-tone-color"])) : (s(), h(d(yt), { key: 1, class: "group", "two-tone-color": d(b2) }, null, 8, ["two-tone-color"]))])) : (s(), r("img", { key: 1, class: "img", alt: "组件", src: m2.value }, null, 8, Vh)), p("span", Wh, S((_a2 = e2.item) == null ? void 0 : _a2.chart.name), 1), p("div", Yh, [!e2.showEye || d(g2).getLayerCollapsed || !M2.value && e2.item.chartContain.show ? f("", true) : (s(), h(d(Be), { key: 0, class: "icon", icon: e2.item.chartContain.show ? "ant-design:eye-outlined" : "ant-design:eye-invisible-outlined", onClick: o3[0] || (o3[0] = () => e2.item.chartContain.show = !e2.item.chartContain.show) }, null, 8, ["icon"])), e2.showLock && !d(g2).getLayerCollapsed && (M2.value || e2.item.chartContain.lock) ? (s(), h(d(Be), { key: 1, class: "icon", icon: e2.item.chartContain.lock ? "ant-design:lock-outlined" : "ant-design:unlock-outlined", onClick: o3[1] || (o3[1] = () => e2.item.chartContain.lock = !e2.item.chartContain.lock) }, null, 8, ["icon"])) : f("", true)])])], 34);
  };
} }), Kh = eo(Zh, [["__scopeId", "data-v-925f45da"]]), Xh = e({ __name: "LayerGroup", props: { item: { type: Object, required: true }, expand: { type: Boolean, default: false }, showEye: { type: Boolean, default: true }, showLock: { type: Boolean, default: true }, showChildEye: { type: Boolean, default: true }, showChildLock: { type: Boolean, default: true }, externalSelect: { type: Boolean, default: false }, isSelect: { type: Boolean, default: false }, childSelect: { type: String, default: "" } }, emits: ["parentClick", "childClick"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, { prefixCls: i2 } = xe("layer-group"), u2 = qr(), p2 = Ar(), f2 = l(() => ({ "child-item": true, collapsed: p2.getLayerCollapsed })), C2 = y(o2.expand);
  function b2() {
    var _a2;
  ...
  return n(() => o2.expand, (e3) => C2.value = e3), (t3, o3) => (s(), r("div", { class: c(d(i2)), onMouseenter: b2, onMouseleave: M2 }, [g(Kh, { item: e2.item, onExpand: x2, expand: C2.value, "show-eye": e2.showEye, "show-lock": e2.showLock, "external-select": e2.externalSelect, "is-select": e2.isSelect, onClick: S2 }, null, 8, ["item", "expand", "show-eye", "show-lock", "external-select", "is-select"]), g(d(Bt), { show: C2.value, class: c(f2.value) }, { default: k(() => [(s(true), r(m, null, v(e2.item.chart.options.components, (t4, o4) => (s(), h(Kh, { key: t4.chart.id, "parent-item": e2.item, item: t4, index: o4, "external-select": e2.externalSelect, "is-select": e2.childSelect === t4.chart.id, "show-eye": e2.showChildEye, "show-lock": e2.showChildLock, onSelect: (t5) => function(e3, t6) {
...
} }), Jh = eo(Xh, [["__scopeId", "data-v-b118e01c"]]), eg = ["onDrop"], tg = e({ name: "FrameLayer", __name: "index", props: { collapsed: Tt.bool.def(false) }, setup(e2) {
  ...
  const u2 = y(false), f2 = qr(), m2 = Ar(), v2 = (e3) => {
  ...
  function M2(e3, t3, o3) {
    !o3.ctrlKey && !o3.metaKey || 0 !== o3.button ? 0 === o3.button && (f2.cleanSelectArea(), f2.setCurComponent(e3, t3)) : vp(e3);
  }
  function w2() {
  ...
  return (e3, t3) => (s(), h(Gh, { class: c(n2.value), title: d(m2).getLayerCollapsed ? "" : "图层", icon: "iconfont:icon-mfish-layer", "icon-size": d(m2).getLayerCollapsed ? 16 : 12, "radio-data": a2, onTitleClick: C2, onDrop: t3[1] || (t3[1] = (e4) => b2(e4, r2.value.length)), onRadioChange: x2 }, { default: k(() => [0 === r2.value.length ? (s(), h(d(Me), { key: 0, "image-style": d(m2).getLayerCollapsed ? { height: "20px" } : {}, description: "暂无图层", image: d(ot) }, null, 8, ["image-style", "image"])) : (s(), h(d(mt), { key: 1 }, { default: k(() => [g(d(Rt), { "item-key": "id", modelValue: r2.value, "onUpdate:modelValue": t3[0] || (t3[0] = (e4) => r2.value = e4), animation: "300", "ghost-class": "ghost", onChange: v2 }, { item: k(({ index: e4, element: t4 }) => [p("div", { onDrop: (t5) => b2(t5, e4), style: { "margin-top": "4px" } }, [t4.chart.type !== d(ls).MfCombine ? (s(), h(Kh, { key: 0, item: t4, onMousedown: (o3) => M2(t4, e4, o3), onEnter: (e5) => {
    return o3 = t4, void f2.setCurHoverComponent(o3 == null ? void 0 : o3.chart.id);
    var o3;
  }, onLeave: w2 }, null, 8, ["item", "onMousedown", "onEnter"])) : (s(), h(Jh, { key: 1, item: t4, expand: u2.value, "show-child-lock": false, onMousedown: (o3) => M2(t4, e4, o3) }, null, 8, ["item", "expand", "onMousedown"]))], 40, eg)]), _: 1 }, 8, ["modelValue"])]), _: 1 }))]), _: 1 }, 8, ["class", "title", "icon-size"]));
} }), og = eo(tg, [["__scopeId", "data-v-3b66e5f3"]]), lg = { class: "menu-item-hide-title" }, ng = { class: "title" }, ag = eo(e({ __name: "ChartMenus", props: { itemHeight: { type: Number }, width: { type: Number, default: 68 }, collapsed: { type: Boolean, default: false }, horizontal: { type: Boolean, default: false }, hideTitle: { type: Boolean, default: false }, backgroundColor: { type: Object, default: () => ({ light: "transparent", dark: "transparent" }) }, menus: { type: Array, default: () => [] } }, emits: ["menuClick", "menuChange"], setup(e2, { emit: o2 }) {
  ...
  return (t2, o3) => (s(), r("div", { class: c(d(f2)) }, [g(d(te), { class: c({ collapsed: e2.collapsed }), "selected-keys": C2.value, "onUpdate:selectedKeys": o3[0] || (o3[0] = (e3) => C2.value = e3), onClick: _2 }, { default: k(() => [g(d(mt), null, { default: k(() => [(s(true), r(m, null, v(e2.menus, (t3) => (s(), h(d(we), { id: t3.name, key: t3.value, style: u({ height: `${e2.itemHeight}px` }) }, { default: k(() => [e2.hideTitle ? (s(), h(d(G), { key: 0, title: t3.name, placement: "right" }, { default: k(() => [p("div", lg, [g(d(Be), { style: u({ lineHeight: `${e2.itemHeight}px` }), icon: t3.icon }, null, 8, ["style", "icon"])])]), _: 2 }, 1032, ["title"])) : (s(), r("div", { key: 1, class: c(e2.horizontal ? "menu-item-horizontal" : "menu-item-vertical") }, [g(d(Be), { icon: t3.icon }, null, 8, ["icon"]), p("div", ng, S(t3.name), 1)], 2))]), _: 2 }, 1032, ["id", "style"]))), 128))]), _: 1 })]), _: 1 }, 8, ["class", "selected-keys"])], 2));
} }), [["__scopeId", "data-v-dea86191"]]), ig = ["onDragstart", "onDblclick"], rg = { class: "box-header" }, sg = { class: "box-header-text" }, ug = { class: "box-content" }, cg = ["src"], dg = e({ __name: "ChartItems", props: { charts: { type: Array, default: () => [] }, mode: { type: String, default: "single" } }, setup(e2) {
  const t2 = e2, { prefixCls: o2 } = xe("chart-items"), l2 = qr();
  return n(() => t2.charts, (e3) => {
    e3.forEach((e4) => {
      const t3 = e4 == null ? void 0 : e4.type;
      t3 && (e4 == null ? void 0 : e4.picKey) && !l2.hasChartImg(t3) && dt(ct(e4 == null ? void 0 : e4.picKey), { errorMessageMode: "none" }).then((e5) => {
        l2.setChartImg(t3, e5);
      });
    });
  }, { immediate: true }), (t3, n2) => (s(), h(d(mt), { class: c(d(o2)) }, { default: k(() => [p("div", { class: c(["items", "single" === e2.mode ? e2.mode : [e2.mode, "miniAnimation"]]) }, [(s(true), r(m, null, v(e2.charts, (t4) => {
    return s(), r("div", { draggable: "true", key: t4.type, class: "item-box", onDragstart: (e3) => function(e4, t5) {
      var _a2, _b, _c2;
      const o4 = Kd(t5);
      if (!o4) return;
      const l3 = e4.currentTarget;
      "img" === e4.target.className ? (_a2 = e4.dataTransfer) == null ? void 0 : _a2.setDragImage(l3, e4.offsetX + 15, e4.offsetY + 32) : (_b = e4.dataTransfer) == null ? void 0 : _b.setDragImage(l3, e4.offsetX, e4.offsetY), (_c2 = e4.dataTransfer) == null ? void 0 : _c2.setData(Or, JSON.stringify(o4));
    }(e3, t4), onDblclick: (e3) => function(e4) {
      const t5 = Kd(e4);
      t5 && Ud.emit(Hr.CREATE_CHART, t5);
    }(t4) }, [p("div", rg, [g(d(Ba), { disabled: true, size: "single" === e2.mode ? "small" : "mini" }, null, 8, ["size"]), p("span", sg, S(t4.name), 1)]), p("div", ug, [p("img", { class: "img", alt: "组件图片", src: (o3 = t4.type, l2.getChartImg(o3)) }, null, 8, cg)])], 40, ig);
    var o3;
  }), 128))], 2)]), _: 1 }, 8, ["class"]));
} }), pg = eo(dg, [["__scopeId", "data-v-74651cba"]]), fg = e({ name: "FrameChart", __name: "index", props: { collapsed: Tt.bool.def(false) }, setup(e2) {
  const t2 = e2, o2 = Ar(), n2 = y(), a2 = y(), r2 = y(""), u2 = y(/* @__PURE__ */ new Map()), f2 = l(() => a2.value && a2.value.length > 0 ? a2.value.map((e3) => ({ name: e3.categoryName, icon: e3.icon, value: e3.id, children: e3.children })) : []), m2 = l(() => {
    var _a2;
    if (n2.value) {
  ...
  function $2(e3, t3) {
    let o3;
    o3 = "所有" === t3 ? m2.value.find((t4) => t4.value === e3).parentId : e3, r2.value = o3, u2.value.has(o3) || Wi({ category: o3, pageNum: 1, pageSize: 1e3 }).then((e4) => {
      u2.value.set(o3, e4.list);
    });
  }
  return (t3, o3) => (s(), h(Gh, { title: "组件", icon: "iconfont:icon-mfish-chart", "icon-size": 12, "radio-data": b2, onRadioChange: w2, class: c(M2.value), onTitleClick: S2 }, { default: k(() => [p("div", { class: c(`${d(v2)}-content`) }, [g(ag, { menus: f2.value, "item-height": 58, "background-color": { light: "#f0f2f5", dark: "#232324" }, onMenuClick: x2, onMenuChange: _2 }, null, 8, ["menus"]), p("div", { class: c(["charts", { collapsed: e2.collapsed }]) }, [g(ag, { menus: m2.value, collapsed: e2.collapsed, "hide-title": true, "background-color": { light: "#f8f8f9", dark: "#1e1e1f" }, horizontal: true, "item-height": 28, width: 40, onMenuChange: $2 }, null, 8, ["menus", "collapsed"]), g(pg, { mode: C2.value, charts: u2.value.get(r2.value) }, null, 8, ["mode", "charts"])], 2)], 2)]), _: 1 }, 8, ["class"]));
} }), hg = eo(fg, [["__scopeId", "data-v-3b8e6093"]]), gg = ["onClick"], yg = { class: "name" }, mg = { class: "short-cut" }, vg = e({ __name: "SubMenu", props: { subData: { type: Array, default: () => [] } }, setup(e2, { expose: t2 }) {
  const { prefixCls: l2 } = xe("frame-shortcut"), n2 = y(false), a2 = y(0), i2 = o("subMenuRef"), C2 = Se().getThemeColor;
  return t2({ show: function(e3) {
    n2.value = true;
  }, hidden: function() {
    n2.value = false;
  } }), (t3, o2) => (s(), h(P, { name: "shortcut" }, { default: k(() => [O(p("div", { ref_key: "subMenuRef", ref: i2, class: c(d(l2)), style: u({ top: `${a2.value}px`, left: "160px" }) }, [(s(true), r(m, null, v(e2.subData, (e3) => (s(), r(m, { key: e3.name }, [p("div", { class: "menu-item", onClick: e3.action }, [g(d(Be), { icon: e3.icon, color: d(C2) }, null, 8, ["icon", "color"]), p("span", yg, S(e3.name), 1), p("span", mg, S(e3.shortcut), 1)], 8, gg), e3.divider ? (s(), r("div", { key: 0, class: c(`${d(l2)}__divider`) }, null, 2)) : f("", true)], 64))), 128))], 6), [[z, n2.value]])]), _: 1 }));
} }), Cg = eo(vg, [["__scopeId", "data-v-f4307b07"]]), bg = { class: "short-cut" }, kg = { class: "short-cut" }, Mg = { class: "short-cut" }, wg = ["onClick"], xg = { class: "name" }, Sg = { class: "short-cut" }, _g = e({ name: "FrameShortcut", __name: "index", props: { menuTop: { type: Number, default: 0 }, menuLeft: { type: Number, default: 0 }, isUp: { type: Boolean, default: false } }, setup(e2, { expose: t2 }) {
  const n2 = e2, i2 = l(() => ({ top: `${n2.menuTop}px`, left: `${n2.menuLeft}px` })), y2 = Se().getThemeColor, { prefixCls: b2 } = xe("frame-shortcut"), w2 = pp(), x2 = qr(), _2 = o("frameShortcutRef"), $2 = o("canvasAlignMenuRef"), L2 = o("selectAlignMenuRef"), I2 = o("fitMenuRef"), { NoneShortcutKeyEnum: D2 } = kp(x2, w2);
  ...
  function q2() {
    var _a2;
    z2(Cp.CANVAS), (_a2 = $2.value) == null ? void 0 : _a2.show(n2.isUp);
  }
  function A2() {
    var _a2;
  ...
  function O2() {
    var _a2;
    z2(Cp.GROUP), (_a2 = L2.value) == null ? void 0 : _a2.show(n2.isUp);
  }
  function j2() {
    var _a2;
  ...
  function z2(e3) {
    w2.setAlignType(e3), 0 === x2.getSelectArea.components.length && x2.getCurComponent && w2.setAlignType(Cp.CANVAS);
  }
  function E2() {
    var _a2;
  ...
  return (e3, t3) => (s(), h(P, { name: "shortcut" }, { default: k(() => [d(w2).getShowMenu ? (s(), r("div", { key: "shortcutMenu", ref_key: "frameShortcutRef", ref: _2, class: c(d(b2)), style: u(i2.value), onMousedown: t3[3] || (t3[3] = M(() => {
  }, ["stop"])) }, [d(x2).getCurComponent || d(x2).getSelectArea.components.length > 1 ? (s(), r("div", { key: 0, class: "menu-item", onMouseenter: q2, onMouseleave: A2, onMouseup: t3[0] || (t3[0] = M(() => {
  }, ["stop"])) }, [g(d(Be), { icon: "iconfont:icon-mfish-left-align", color: d(y2) }, null, 8, ["color"]), t3[4] || (t3[4] = p("span", { class: "name" }, "画布对齐", -1)), p("span", bg, [g(d(Be), { icon: "ant-design:right-outlined" })]), g(Cg, { ref_key: "canvasAlignMenuRef", ref: $2, "sub-data": B2 }, null, 8, ["sub-data"])], 32)) : f("", true), d(x2).getSelectArea.components.length > 1 ? (s(), r("div", { key: 1, class: "menu-item", onMouseenter: O2, onMouseleave: j2, onMouseup: t3[1] || (t3[1] = M(() => {
  }, ["stop"])) }, [g(d(Be), { icon: "iconfont:icon-mfish-left-align", color: d(y2) }, null, 8, ["color"]), t3[5] || (t3[5] = p("span", { class: "name" }, "选中对齐", -1)), p("span", kg, [g(d(Be), { icon: "ant-design:right-outlined" })]), g(Cg, { ref_key: "selectAlignMenuRef", ref: L2, "sub-data": B2 }, null, 8, ["sub-data"])], 32)) : f("", true), d(x2).getCurComponent ? (s(), r("div", { key: 2, class: "menu-item", onMouseenter: E2, onMouseleave: F2, onMouseup: t3[2] || (t3[2] = M(() => {
  }, ["stop"])) }, [g(d(Be), { icon: "carbon:fit-to-screen", color: d(y2) }, null, 8, ["color"]), t3[6] || (t3[6] = p("span", { class: "name" }, "撑满", -1)), p("span", Mg, [g(d(Be), { icon: "ant-design:right-outlined" })]), g(Cg, { ref_key: "fitMenuRef", ref: I2, "sub-data": R2 }, null, 8, ["sub-data"])], 32)) : f("", true), d(x2).getCurComponent || d(x2).getSelectArea.components.length > 1 ? (s(), r("div", { key: 3, class: c(`${d(b2)}__divider`) }, null, 2)) : f("", true), (s(true), r(m, null, v(N2, (e4) => (s(), r(m, { key: e4.name }, [e4.show ? (s(), r("div", { key: 0, class: "menu-item", onClick: (t4) => {
    return o2 = e4.action, w2.setShowMenu(false), void C(() => {
      o2();
    });
    var o2;
  } }, [g(d(Be), { icon: e4.icon, color: d(y2) }, null, 8, ["icon", "color"]), p("span", xg, S(e4.name), 1), p("span", Sg, S(e4.shortcut), 1)], 8, wg)) : f("", true), e4.show && e4.divider ? (s(), r("div", { key: 1, class: c(`${d(b2)}__divider`) }, null, 2)) : f("", true)], 64))), 128))], 38)) : f("", true)]), _: 1 }));
} }), $g = eo(_g, [["__scopeId", "data-v-2dcb7415"]]);
export {
  pl as $,
  Zl as A,
  Ko as B,
