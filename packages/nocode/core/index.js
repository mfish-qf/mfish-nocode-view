...
import { sleep as nt } from "@mfish/core/utils/Utils";
import { formatToDateTime as at } from "@mfish/core/utils/DateUtil";
import { imageUrl as it, getLocalFileUrl as rt, imageSrc as st } from "@mfish/core/utils/file/FileUtils";
import { DeleteOutlined as ut, CaretRightOutlined as ct, CheckOutlined as dt, FolderOpenTwoTone as pt, FolderTwoTone as ft } from "@ant-design/icons-vue";
import { ScrollContainer as ht } from "@mfish/core/components/Container";
import { DraggableInput as gt } from "@mfish/core/components/Draggable";
import { BasicModal as yt, useModalInner as mt, useModal as vt } from "@mfish/core/components/Modal";
import { BasicForm as Ct, useForm as bt } from "@mfish/core/components/Form";
import { BasicTree as Mt } from "@mfish/core/components/Tree";
import { Split as kt } from "@mfish/core/components/Split";
import { useTable as wt, BasicTable as xt } from "@mfish/core/components/Table";
import { CodeEditor as St, MODE as _t } from "@mfish/core/components/CodeEditor";
import { useLocale as $t } from "@mfish/core/i18n/UseLocale";
import { propTypes as Lt } from "@mfish/core/utils/PropTypes";
import { FileUp as It } from "@mfish/core/components/FileUpDown";
import Dt from "vuedraggable";
import { NCollapseTransition as Tt } from "naive-ui";
import { queryCategoryTreeByCode as Nt } from "@mfish/core/api";
const Bt = "color_recently_bi", Rt = "gradient_color_recently_bi", qt = ["rgba(255, 255, 255, 1)", "rgba(0, 0, 0, 1)", "rgba(35, 69, 231, 1)", "rgba(35, 231, 196, 1)", "rgba(65, 231, 35, 1)", "rgba(231, 35, 35, 1)"], At = ["linear-gradient(120deg, rgba(243,231,233,1) 0%, rgba(227,238,255,1) 100%)", "linear-gradient(45deg, rgba(161,140,209,1) 0%, rgba(251,194,235,1) 100%)", "linear-gradient(90deg, rgba(255,236,210,1) 0%, rgba(252,182,159,1) 100%)", "linear-gradient(180deg, rgba(204,32,142,1) 0%, rgba(103,19,210,1) 100%)", "linear-gradient(-225deg, rgba(35,21,87,1) 0%, rgba(68,16,122,1) 29%, rgba(255,19,97,1) 67%, rgba(255,248,0,1) 100%)", "linear-gradient(180deg, rgba(30,60,114,1) 0%, rgba(30,60,114,1) 1%, rgba(42,82,152,1) 100%)", "linear-gradient(-20deg, rgba(43,88,118,1) 0%, rgba(78,67,118,1) 100%)", "linear-gradient(45deg, rgba(58,181,176,1) 0%, rgba(61,153,190,1) 31%, rgba(86,49,122,1) 100%)", "linear-gradient(180deg, rgba(106,17,203,1) 0%, rgba(37,117,252,1) 100%)"];
function Ot(e2) {
...
}, Pt = { 10: "A", 11: "B", 12: "C", 13: "D", 14: "E", 15: "F" }, Et = (e2) => {
  e2 = Math.min(Math.round(e2), 255);
  const t2 = Math.floor(e2 / 16), o2 = e2 % 16;
  return `${Pt[t2] || t2}${Pt[o2] || o2}`;
}, Ht = function({ r: e2, g: t2, b: o2 }) {
  return Number.isNaN(+e2) || Number.isNaN(+t2) || Number.isNaN(+o2) ? "" : `#${Et(e2)}${Et(t2)}${Et(o2)}`;
}, Qt = { A: 10, B: 11, C: 12, D: 13, E: 14, F: 15 }, Gt = function(e2) {
  return 2 === e2.length ? 16 * (Qt[e2[0].toUpperCase()] || +e2[0]) + (Qt[e2[1].toUpperCase()] || +e2[1]) : Qt[e2[1].toUpperCase()] || +e2[1];
}, Ut = (e2, t2, o2) => {
  e2 = Ft(e2, 255), t2 = Ft(t2, 255), o2 = Ft(o2, 255);
...
}, Vt = function(e2, t2, o2) {
  e2 = 6 * Ft(e2, 360), t2 = Ft(t2, 100), o2 = Ft(o2, 100);
...
class Wt {
  ...
  toRgb() {
    return Vt(this._hue, this._saturation, this._value);
  }
  toHex() {
    const e2 = this.toRgb();
    return Ht(e2).slice(0, 7);
  }
  fromString(e2) {
    ...
    if (e2.includes("hsl")) {
      ...
      if (4 === o2.length ? this._alpha = 100 * Number.parseFloat(o2[3].toString()) : 3 === o2.length && (this._alpha = 100), o2.length >= 3) {
        const { h: e3, s: l2, v: n2 } = Ut(o2[0], o2[1], o2[2]);
        t2(e3, l2, n2);
      }
    } else if (e2.includes("#")) {
      ...
      let l2, n2, a2;
      3 === o2.length ? (l2 = Gt(o2[0] + o2[0]), n2 = Gt(o2[1] + o2[1]), a2 = Gt(o2[2] + o2[2])) : 6 !== o2.length && 8 !== o2.length || (l2 = Gt(o2.slice(0, 2)), n2 = Gt(o2.slice(2, 4)), a2 = Gt(o2.slice(4, 6))), 8 === o2.length ? this._alpha = Gt(o2.slice(6)) / 255 * 100 : 3 !== o2.length && 6 !== o2.length || (this._alpha = 100);
      const { h: i2, s: r2, v: s2 } = Ut(l2, n2, a2);
      t2(i2, r2, s2);
    }
  }
  compare(e2) {
  ...
  doOnChange() {
    ...
    if (this.enableAlpha) switch (n2) {
      ...
      case "hsv":
        ...
        break;
      case "hex":
        this.value = `${Ht(Vt(e2, t2, o2))}${Et(255 * l2 / 100)}`;
        break;
      default: {
        const { r: l3, g: n3, b: a2 } = Vt(e2, t2, o2);
...
function Yt(e2, t2) {
  const o2 = function(e3) {
    ...
    var _a2;
    document.removeEventListener("mousemove", o2), document.removeEventListener("mouseup", l2), document.removeEventListener("touchmove", o2), document.removeEventListener("touchend", l2), document.onselectstart = null, document.ondragstart = null, Zt = false, (_a2 = t2.end) == null ? void 0 : _a2.call(t2, e3);
  }, n2 = function(e3) {
    var _a2;
    Zt || (e3.preventDefault(), document.onselectstart = () => false, document.ondragstart = () => false, document.addEventListener("mousemove", o2), document.addEventListener("mouseup", l2), document.addEventListener("touchmove", o2), document.addEventListener("touchend", l2), Zt = true, (_a2 = t2.start) == null ? void 0 : _a2.call(t2, e3));
  };
...
const Kt = (e2, t2) => {
  ...
  return o2;
}, Xt = Kt(e({ __name: "ColorPanel", props: { color: { type: Object, required: true }, height: { type: Number, default: 150 }, isShow: { type: Boolean, default: false } }, setup(e2) {
...
} }), [["__scopeId", "data-v-696c5dfb"]]), Jt = Kt(e({ __name: "ColorHueSlider", props: { color: { type: Object, required: true }, vertical: { type: Boolean, default: false } }, emits: ["startEyeDropper", "endEyeDropper"], setup(e2, { emit: t2 }) {
...
} }), [["__scopeId", "data-v-b2d0e443"]]), eo = { class: "background" }, to = { class: "color-text" }, oo = { class: "color-input" }, lo = { class: "color-input-percentage" }, no = { class: "color-input-percentage" }, ao = { class: "color-input-percentage" }, io = { class: "color-input-percentage a" }, ro = Kt(e({ __name: "ColorText", props: { color: { type: Object, required: true } }, setup(e2) {
  ...
  }), (e3, t2) => (s(), r("div", { class: c(d(h2)) }, [p("div", eo, [p("div", { class: "background-color", style: u({ backgroundColor: C2.value }) }, null, 4)]), p("div", to, [p("div", oo, [g(d(H), { size: "small", value: i2.value, "onUpdate:value": t2[0] || (t2[0] = (e4) => i2.value = e4), onPressEnter: M2, onBlur: M2, maxlength: 7 }, null, 8, ["value"])])]), p("div", lo, [t2[5] || (t2[5] = p("div", { class: "prefix" }, "R", -1)), g(d(Q), { size: "small", value: f2.r, "onUpdate:value": t2[1] || (t2[1] = (e4) => f2.r = e4), bordered: false, controls: false, onPressEnter: k2, onBlur: k2, step: 1, min: 0, max: 255, maxlength: 3 }, null, 8, ["value"])]), p("div", no, [t2[6] || (t2[6] = p("div", { class: "prefix" }, "G", -1)), g(d(Q), { size: "small", bordered: false, value: f2.g, "onUpdate:value": t2[2] || (t2[2] = (e4) => f2.g = e4), controls: false, onPressEnter: k2, onBlur: k2, step: 1, min: 0, max: 255, maxlength: 3 }, null, 8, ["value"])]), p("div", ao, [t2[7] || (t2[7] = p("div", { class: "prefix" }, "B", -1)), g(d(Q), { size: "small", bordered: false, value: f2.b, "onUpdate:value": t2[3] || (t2[3] = (e4) => f2.b = e4), controls: false, onPressEnter: k2, onBlur: k2, step: 1, min: 0, max: 255, maxlength: 3 }, null, 8, ["value"])]), p("div", io, [t2[8] || (t2[8] = p("div", { class: "prefix" }, "A", -1)), g(d(Q), { size: "small", bordered: false, value: f2.a, "onUpdate:value": t2[4] || (t2[4] = (e4) => f2.a = e4), controls: false, onPressEnter: b2, onChange: b2, step: 1, min: 0, max: 100, maxlength: 3 }, null, 8, ["value"]), t2[9] || (t2[9] = p("div", null, "%", -1))])], 2));
} }), [["__scopeId", "data-v-2bab5fee"]]), so = { class: "colors" }, uo = ["onClick"], co = e({ __name: "ColorRecently", props: { color: { type: Object, required: true }, isShow: { type: Boolean, default: false } }, setup(e2) {
  t((e3) => ({ "8433eb3a": g2.value }));
  const o2 = e2, a2 = y(qt), i2 = y([]), { prefixCls: f2 } = we("color-recently"), { token: h2 } = E.useToken(), g2 = l(() => h2.value.colorBorder);
  function C2(e3, t2) {
    return e3.map((e4) => {
      const o3 = new Wt();
  ...
  }, { immediate: true }), (e3, t2) => (s(), r("div", { class: c(d(f2)) }, [t2[0] || (t2[0] = p("div", { class: "last-time-text" }, "最近使用", -1)), p("div", so, [(s(true), r(m, null, v(i2.value, (e4, t3) => (s(), r("div", { class: c(["color-selector", { selected: e4.selected }]), key: t3, onClick: (e5) => function(e6) {
    o2.color.fromString(a2.value[e6]);
  }(t3) }, [p("div", { class: "default", style: u({ "background-color": e4.value }) }, null, 4)], 10, uo))), 128))])], 2));
} }), po = Kt(co, [["__scopeId", "data-v-98ec7ef1"]]), fo = { class: "colors" }, ho = ["onClick"], go = e({ __name: "GradientColorRecently", props: { color: { type: String, default: "" }, isShow: { type: Boolean, default: false } }, emits: ["selectColor"], setup(e2, { emit: o2 }) {
  ...
  }, { immediate: true }), (e3, t2) => (s(), r("div", { class: c(d(h2)) }, [t2[0] || (t2[0] = p("div", { class: "last-time-text" }, "最近使用", -1)), p("div", fo, [(s(true), r(m, null, v(f2.value, (e4, t3) => (s(), r("div", { class: c(["color-selector", { selected: b2.value === t3 }]), key: t3, onClick: (o3) => function(e5, t4) {
    b2.value = e5;
    const o4 = jt(t4);
    i2("selectColor", o4);
  }(t3, e4) }, [p("div", { class: "default", style: u({ background: e4 }) }, null, 4)], 10, ho))), 128))])], 2));
} }), yo = Kt(go, [["__scopeId", "data-v-be7486eb"]]), mo = { class: "hue-slider" }, vo = ["onMousedown", "onDblclick"], Co = { class: "color-input-percentage" }, bo = e({ __name: "GradientColor", props: { isShow: { type: Boolean, default: false }, colors: { type: Object, default: () => ({ deg: 45, colors: [{ rgba: "rgba(255, 255, 0, 1)", rgbaLength: "0%" }, { rgba: "rgba(0, 0, 255, 0.9)", rgbaLength: "100%" }] }) } }, emits: ["colorChange", "startEyeDropper", "endEyeDropper"], setup(e2, { emit: a2 }) {
  t((e3) => ({ 40133406: T2.value }));
  const i2 = e2, f2 = a2, h2 = y(new Wt({ enableAlpha: true, format: "rgba" }));
  ...
  }, { deep: true }), (t2, o2) => (s(), r("div", null, [p("div", { class: c(d(I2)) }, [p("div", mo, [g(d(G), { title: "点击增加新颜色", placement: "left" }, { default: M(() => [p("div", { class: "bar", ref_key: "barRef", ref: $2, onClick: k(q2, ["stop", "prevent"]), style: u(N2.value) }, null, 4)]), _: 1 }), (s(true), r(m, null, v(x2.value, (e3, t3) => (s(), r("div", { class: "thumb", ref_for: true, ref: (e4) => function(e5, t4) {
    L2.value[t4] = e5;
  ...
  }(t3), style: u({ left: e3.rgbaLength }) }, [g(d(Te), { title: "双击取消", class: c(["thumb__icon", w2.value === t3 ? "selected" : ""]), icon: "ant-design:caret-up-outlined" }, null, 8, ["class"])], 44, vo))), 128))]), p("div", Co, [o2[3] || (o2[3] = p("div", { class: "prefix" }, "D", -1)), g(d(Q), { value: S2.value, "onUpdate:value": o2[0] || (o2[0] = (e3) => S2.value = e3), bordered: false, controls: false, max: 360, min: -360, step: 1, onChange: A2, maxlength: 4 }, null, 8, ["value"]), o2[4] || (o2[4] = p("div", { class: "suffix" }, "°", -1))])], 2), g(Xt, { style: { "margin-top": "4px" }, color: h2.value, height: 118, "is-show": e2.isShow }, null, 8, ["color", "is-show"]), g(Jt, { style: { "margin-top": "8px" }, color: h2.value, onStartEyeDropper: o2[1] || (o2[1] = () => f2("startEyeDropper")), onEndEyeDropper: o2[2] || (o2[2] = (e3) => f2("endEyeDropper", e3)) }, null, 8, ["color"]), g(ro, { style: { "margin-top": "15px" }, color: h2.value }, null, 8, ["color"]), g(yo, { style: { "margin-top": "8px" }, color: _2.value, "is-show": e2.isShow, onSelectColor: B2 }, null, 8, ["color", "is-show"])]));
} }), Mo = Kt(bo, [["__scopeId", "data-v-cf05475f"]]), ko = { class: "header" }, wo = { key: 0, class: "content" }, xo = { key: 1, class: "content" }, So = { class: "confirm" }, _o = { key: 0 }, $o = { key: 1 }, Lo = e({ __name: "PickerDropdown", props: { type: { type: Number, default: 3 }, selectType: { type: Number, default: 1 }, color: { type: Object, required: true }, colors: { type: Object, default: () => ({ deg: 45, colors: [{ rgba: "rgba(255, 255, 0, 1)", rgbaLength: "0%" }, { rgba: "rgba(0, 0, 255, 0.9)", rgbaLength: "100%" }] }) }, isShow: { type: Boolean, default: false }, hideConfirm: { type: Boolean, default: false }, hideCancel: { type: Boolean, default: false } }, emits: ["changeGradientColor", "pickColor", "restColor", "selectTypeChange", "startEyeDropper", "endEyeDropper"], setup(e2, { emit: t2 }) {
  ...
  return (t3, l3) => {
    const n2 = w("AButton");
    return s(), r("div", { class: c(d(k2)) }, [p("div", ko, [g(d(U), { value: C2.value, options: m2.value, onChange: b2, block: "" }, { label: M(({ payload: e3 }) => [x(S(e3), 1)]), _: 1 }, 8, ["value", "options"])]), 1 !== C2.value || 1 !== e2.type && 3 !== e2.type ? f("", true) : (s(), r("div", wo, [g(Xt, { style: { "margin-top": "4px" }, color: e2.color, "is-show": e2.isShow }, null, 8, ["color", "is-show"]), g(Jt, { style: { "margin-top": "8px" }, color: e2.color, onEndEyeDropper: T2, onStartEyeDropper: D2 }, null, 8, ["color"]), g(ro, { style: { "margin-top": "15px" }, color: e2.color }, null, 8, ["color"]), g(po, { style: { "margin-top": "8px" }, color: e2.color, "is-show": e2.isShow }, null, 8, ["color", "is-show"])])), 2 !== C2.value || 2 !== e2.type && 3 !== e2.type ? f("", true) : (s(), r("div", xo, [g(Mo, { onColorChange: d(L2), colors: e2.colors, "is-show": e2.isShow, onStartEyeDropper: D2, onEndEyeDropper: T2 }, null, 8, ["onColorChange", "colors", "is-show"])])), p("div", So, [o2.hideCancel ? f("", true) : (s(), h(n2, { key: 0, onClick: $2 }, { default: M(() => l3[0] || (l3[0] = [x("取消")])), _: 1 })), g(n2, { onClick: I2, color: d(u2) ? "warning" : "primary" }, { default: M(() => [d(u2) ? (s(), r("span", $o, "!已拷贝")) : (s(), r("span", _o, "拷贝"))]), _: 1 }, 8, ["color"]), o2.hideConfirm ? f("", true) : (s(), h(n2, { key: 1, onClick: _2, color: "success" }, { default: M(() => l3[1] || (l3[1] = [x("确定")])), _: 1 }))])], 2);
  };
} }), Io = { key: 0, class: "color-background-text" }, Do = { class: "color-background-show-box" }, To = { key: 1, style: { display: "flex" } }, No = { class: "color-text" }, Bo = { class: "color-show-box" }, Ro = ["title"], qo = e({ name: "MfishColorPicker", __name: "index", props: { value: String, showAlpha: { type: Boolean, default: true }, type: { type: Number, default: 3 }, isDelete: { type: Boolean, default: false }, placeholder: { type: String, default: "请输入颜色，格式#FFFFFF" }, title: { type: String, default: "清空则为无色" }, hideConfirm: { type: Boolean, default: false }, hideCancel: { type: Boolean, default: false } }, emits: ["inputChange", "confirmChange"], setup(e2, { emit: o2 }) {
  t((e3) => ({ "018cd00d": I2.value }));
  const a2 = e2, i2 = o2, { prefixCls: m2 } = we("color-picker"), v2 = y(1), b2 = xe().getDarkMode, w2 = y(false), x2 = y(new Wt({ value: d(b2) === He.DARK ? "#000000" : "#FFFFFF", enableAlpha: a2.showAlpha, format: "rgba" })), S2 = y({ deg: 120, colors: [{ rgba: "rgba(243, 231, 233, 1)", rgbaLength: "0%" }, { rgba: "rgba(227,238,255,1)", rgbaLength: "100%" }] }), _2 = y(""), $2 = y(100), { token: L2 } = E.useToken(), I2 = l(() => L2.value.colorBorder), D2 = y(), T2 = y(), N2 = l(() => ({ background: d(D2), height: "100%" }));
  n(() => a2.value, () => {
    A2();
  }, { immediate: true }), n(x2, (e3) => {
  ...
  function G2(e3) {
    e3.startsWith("linear-gradient(") ? (D2.value = e3, S2.value = jt(e3), i2("inputChange", e3)) : (e3.value.fromString(e3), _2.value = e3.value.toHex());
  }
  function U2(e3) {
    R2.value = false, 2 === v2.value ? (D2.value = e3, S2.value = jt(e3), Z2(e3), C(() => i2("confirmChange", d(D2), d(_2)))) : z2();
  }
  function W2() {
  ...
  function Z2(e3) {
    ...
    if (2 === v2.value) {
      return o3(localStorage.getItem(Rt), At, e3), t2 = t2.slice(0, 14), void localStorage.setItem(Rt, JSON.stringify(t2));
    }
    o3(localStorage.getItem(Bt), qt, e3), t2 = t2.slice(0, 20), localStorage.setItem(Bt, JSON.stringify(t2));
  }
  function Y2(e3) {
  ...
  return (t2, o3) => (s(), h(d(V), { trigger: ["click"], open: R2.value, onOpenChange: q2, placement: "bottom", arrow: { pointAtCenter: true } }, { overlay: M(() => [g(Lo, { color: x2.value, colors: S2.value, type: e2.type, "select-type": v2.value, "is-show": R2.value, "hide-cancel": e2.hideCancel, "hide-confirm": e2.hideConfirm, onPickColor: U2, onRestColor: W2, onChangeGradientColor: G2, onSelectTypeChange: Y2, onMouseleave: o3[0] || (o3[0] = (e3) => !K2.value && q2(false)), onStartEyeDropper: X2, onEndEyeDropper: J2 }, null, 8, ["color", "colors", "type", "select-type", "is-show", "hide-cancel", "hide-confirm"])]), default: M(() => [p("div", { class: c(d(m2)), onMouseenter: o3[5] || (o3[5] = () => w2.value = true), onMouseleave: o3[6] || (o3[6] = () => w2.value = false) }, [2 === v2.value ? (s(), r("div", Io, [p("div", Do, [p("div", { style: u(N2.value) }, null, 4)]), w2.value ? (s(), h(d(Te), { key: 0, onClick: k(ee2, ["stop"]), size: "14", class: "close-icon", icon: "ant-design:close-circle-filled" })) : f("", true)])) : (s(), r("div", To, [p("div", No, [p("div", Bo, [p("div", { style: u(N2.value) }, null, 4)]), p("div", { class: "color-input", title: e2.title, onClick: o3[2] || (o3[2] = k(() => {
  }, ["stop"])) }, [g(d(H), { placeholder: e2.placeholder, value: _2.value, "onUpdate:value": o3[1] || (o3[1] = (e3) => _2.value = e3), onBlur: F2, onPressEnter: F2, bordered: false, maxlength: 7 }, null, 8, ["placeholder", "value"]), w2.value && _2.value ? (s(), h(d(Te), { key: 0, onClick: k(ee2, ["stop"]), size: "14", class: "close-icon", icon: "ant-design:close-circle-filled" })) : f("", true)], 8, Ro)]), e2.showAlpha ? (s(), r("div", { key: 0, class: "color-input-percentage", onClick: o3[4] || (o3[4] = k(() => {
...
} }), Ao = Kt(qo, [["__scopeId", "data-v-be499b94"]]);
const Oo = { info(...e2) {
}, warn(...e2) {
}, error(...e2) {
} };
function jo() {
  const e2 = y(), t2 = [], o2 = a({ width: 0, height: 0 }), l2 = () => {
    !function(e3, t3) {
      ...
      e3 ? o3 && l3 || Oo.warn("Component width or height is 0px, rendering abnormality may occur!") : Oo.warn("Failed to get dom node, component rendering may be abnormal!"), t3.width = o3, t3.height = l3;
    }(e2.value, o2);
  }, n2 = Re(l2, 100), r2 = qe((t3) => {
    const o3 = function(e3) {
      return Ae(e3) ? e3 : Ae(e3.$el) ? e3.$el : null;
    }(t3);
    o3 ? e2.value = o3 : Oo.error("Bind Component Dom Ref Failed!");
  });
  return i(() => {
    l2();
...
Eo.setClassNamePrefix;
const Ho = Eo.div`
  position: relative;
  width: 100%;
  height: 100%;
`("border-box"), Qo = Eo.div`
  position: relative;
  width: 100%;
  height: 100%;
`("border-box-content"), Go = ["#2e6099", "#7ce7fd"], Uo = ["left-top", "right-top", "left-bottom", "right-bottom"], Vo = Eo.svg`
  position: absolute;
  display: block;
...
`("border"), Wo = e({ name: "BorderBox1", props: zo(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = jo();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { color: o3, backgroundColor: n3 } = e2, { width: i2, height: r2 } = a2, s2 = Fo(Go, o3);
    return g(Ho, { class: Eo.getClassNameForBind("border-box-1"), ref: l2 }, { default: () => [g(Vo, { width: i2, height: r2 }, { default: () => [g("polygon", { fill: n3, points: `10, 27 10, ${r2 - 27} 13, ${r2 - 24} 13, ${r2 - 21} 24, ${r2 - 11} 38, ${r2 - 11}
...
`("border-svg-container"), Ko = e({ name: "BorderBox2", props: zo(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = jo();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { color: o3, backgroundColor: n3 } = e2, { width: i2, height: r2 } = a2, s2 = Fo(Zo, o3);
    return g(Ho, { class: Eo.getClassNameForBind("border-box-2"), ref: l2 }, { default: () => [g(Yo, { width: i2, height: r2 }, { default: () => [g("polygon", { fill: n3, points: `7, 7 ${i2 - 7}, 7 ${i2 - 7}, ${r2 - 7} 7, ${r2 - 7}` }, null), g("polyline", { stroke: s2[0], points: `2, 2 ${i2 - 2} ,2 ${i2 - 2}, ${r2 - 2} 2, ${r2 - 2} 2, 2` }, null), g("polyline", { stroke: s2[1], points: `6, 6 ${i2 - 6}, 6 ${i2 - 6}, ${r2 - 6} 6, ${r2 - 6} 6, 6` }, null), g("circle", { fill: s2[0], cx: "11", cy: "11", r: "1" }, null), g("circle", { fill: s2[0], cx: i2 - 11, cy: "11", r: "1" }, null), g("circle", { fill: s2[0], cx: i2 - 11, cy: r2 - 11, r: "1" }, null), g("circle", { fill: s2[0], cx: "11", cy: r2 - 11, r: "1" }, null)] }), g(Qo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
} }), Xo = ["#2e6099", "#7ce7fd"], Jo = Eo.svg`
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0;
...
`("border-svg-container"), el = e({ name: "BorderBox3", props: zo(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = jo();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { color: o3, backgroundColor: n3 } = e2, { width: i2, height: r2 } = a2, s2 = Fo(Xo, o3);
    return g(Ho, { class: Eo.getClassNameForBind("border-box-3"), ref: l2 }, { default: () => [g(Jo, { width: i2, height: r2 }, { default: () => [g("polygon", { fill: n3, points: `23, 23 ${i2 - 24}, 23 ${i2 - 24}, ${r2 - 24} 23, ${r2 - 24}` }, null), g("polyline", { class: "stroke-width-3", stroke: s2[0], points: `4, 4 ${i2 - 22} ,4 ${i2 - 22}, ${r2 - 22} 4, ${r2 - 22} 4, 4` }, null), g("polyline", { class: "stroke-width-1", stroke: s2[1], points: `10, 10 ${i2 - 16}, 10 ${i2 - 16}, ${r2 - 16} 10, ${r2 - 16} 10, 10` }, null), g("polyline", { class: "stroke-width-1", stroke: s2[1], points: `16, 16 ${i2 - 10}, 16 ${i2 - 10}, ${r2 - 10} 16, ${r2 - 10} 16, 16` }, null), g("polyline", { class: "stroke-width-1", stroke: s2[1], points: `22, 22 ${i2 - 4}, 22 ${i2 - 4}, ${r2 - 4} 22, ${r2 - 4} 22, 22` }, null)] }), g(Qo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
} }), tl = ["#2e6099", "#7ce7fd"], ol = Eo.svg`
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0;
...
`("border-svg-container"), il = e({ name: "BorderBox5", props: { ...zo(), reverse: { type: Boolean, default: false } }, setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = jo();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { color: o3, backgroundColor: n3, reverse: i2 } = e2, { width: r2, height: s2 } = a2, u2 = Fo(nl, o3);
    return g(Ho, { class: Eo.getClassNameForBind("border-box-5"), ref: l2 }, { default: () => [g(al, { class: i2 ? "reverse" : "", width: r2, height: s2 }, { default: () => [g("polygon", { fill: n3, points: `
...
`("border-svg-container"), ul = e({ name: "BorderBox6", props: zo(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = jo();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { color: o3, backgroundColor: n3 } = e2, { width: i2, height: r2 } = a2, s2 = Fo(rl, o3);
    return g(Ho, { class: Eo.getClassNameForBind("border-box-6"), ref: l2 }, { default: () => [g(sl, { width: i2, height: r2 }, { default: () => [g("polygon", { fill: n3, points: `
              9, 7 ${i2 - 9}, 7 ${i2 - 9}, ${r2 - 7} 9, ${r2 - 7}` }, null), g("circle", { fill: s2[1], cx: "5", cy: "5", r: "2" }, null), g("circle", { fill: s2[1], cx: i2 - 5, cy: "5", r: "2" }, null), g("circle", { fill: s2[1], cx: i2 - 5, cy: r2 - 5, r: "2" }, null), g("circle", { fill: s2[1], cx: "5", cy: r2 - 5, r: "2" }, null), g("polyline", { stroke: s2[0], points: `10, 4 ${i2 - 10}, 4` }, null), g("polyline", { stroke: s2[0], points: `10, ${r2 - 4} ${i2 - 10}, ${r2 - 4}` }, null), g("polyline", { stroke: s2[0], points: "5, 70 5, " + (r2 - 70) }, null), g("polyline", { stroke: s2[0], points: `${i2 - 5}, 70 ${i2 - 5}, ${r2 - 70}` }, null), g("polyline", { stroke: s2[0], points: "3, 10, 3, 50" }, null), g("polyline", { stroke: s2[0], points: "7, 30 7, 80" }, null), g("polyline", { stroke: s2[0], points: `${i2 - 3}, 10 ${i2 - 3}, 50` }, null), g("polyline", { stroke: s2[0], points: `${i2 - 7}, 30 ${i2 - 7}, 80` }, null), g("polyline", { stroke: s2[0], points: `3, ${r2 - 10} 3, ${r2 - 50}` }, null), g("polyline", { stroke: s2[0], points: `7, ${r2 - 30} 7, ${r2 - 80}` }, null), g("polyline", { stroke: s2[0], points: `${i2 - 3}, ${r2 - 10} ${i2 - 3}, ${r2 - 50}` }, null), g("polyline", { stroke: s2[0], points: `${i2 - 7}, ${r2 - 30} ${i2 - 7}, ${r2 - 80}` }, null)] }), g(Qo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
} }), cl = ["#2e6099", "#7ce7fd"], dl = Eo.svg`
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
`("border-svg-container"), pl = e({ name: "BorderBox7", props: zo(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = jo();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { color: o3, backgroundColor: n3 } = e2, { width: i2, height: r2 } = a2, s2 = Fo(cl, o3);
    return g(Ho, { class: Eo.getClassNameForBind("border-box-7"), ref: l2, style: { boxShadow: `inset 0 0 40px ${s2[0]}`, border: `1px solid ${s2[0]}`, backgroundColor: n3 } }, { default: () => [g(dl, { width: i2, height: r2 }, { default: () => [g("polyline", { class: "stroke-width2", stroke: s2[0], points: "0, 25 0, 0 25, 0" }, null), g("polyline", { class: "stroke-width2", stroke: s2[0], points: `${i2 - 25}, 0 ${i2}, 0 ${i2}, 25` }, null), g("polyline", { class: "stroke-width2", stroke: s2[0], points: `${i2 - 25}, ${r2} ${i2}, ${r2} ${i2}, ${r2 - 25}` }, null), g("polyline", { class: "stroke-width2", stroke: s2[0], points: `0, ${r2 - 25} 0, ${r2} 25, ${r2}` }, null), g("polyline", { class: "stroke-width5", stroke: s2[1], points: "0, 10 0, 0 10, 0" }, null), g("polyline", { class: "stroke-width5", stroke: s2[1], points: `${i2 - 10}, 0 ${i2}, 0 ${i2}, 10` }, null), g("polyline", { class: "stroke-width5", stroke: s2[1], points: `${i2 - 10}, ${r2} ${i2}, ${r2} ${i2}, ${r2 - 10}` }, null), g("polyline", { class: "stroke-width5", stroke: s2[1], points: `0, ${r2 - 10} 0, ${r2} 10, ${r2}` }, null)] }), g(Qo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
...
const hl = ["#2e6099", "#7ce7fd"], gl = Eo.svg`
  position: absolute;
  width: 100%;
  height: 100%;
  left: 0;
  top: 0;
`("border-svg-container"), yl = e({ name: "BorderBox8", props: { ...zo(), duration: { type: Number, default: 3 }, reverse: { type: Boolean, default: false } }, setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = jo();
  o2({ refreshLayoutSize: n2 });
  const i2 = fl();
  return () => {
    const { color: o3, backgroundColor: n3, duration: r2, reverse: s2 } = e2, { width: u2, height: c2 } = a2, d2 = Fo(hl, o3), p2 = `border-box-8-path-${i2.id}`, f2 = `border-box-8-gradient-${i2.id}`, h2 = `border-box-8-mask-${i2.id}`, y2 = s2 ? `M 2.5, 2.5 L 2.5, ${c2 - 2.5} L ${u2 - 2.5}, ${c2 - 2.5} L ${u2 - 2.5}, 2.5 L 2.5, 2.5` : `M2.5, 2.5 L${u2 - 2.5}, 2.5 L${u2 - 2.5}, ${c2 - 2.5} L2.5, ${c2 - 2.5} L2.5, 2.5`;
    return g(Ho, { class: Eo.getClassNameForBind("border-box-8"), ref: l2 }, { default: () => [g(gl, { width: u2, height: c2 }, { default: () => [g("defs", null, [g("path", { id: p2, d: y2, fill: "transparent" }, null), g("radialGradient", { id: f2, cx: "50%", cy: "50%", r: "50%" }, [g("stop", { offset: "0%", "stop-color": "#fff", "stop-opacity": "1" }, null), g("stop", { offset: "100%", "stop-color": "#fff", "stop-opacity": "0" }, null)]), g("mask", { id: h2 }, [g("circle", { cx: "0", cy: "0", r: "150", fill: `url(#${f2})` }, [g("animateMotion", { dur: `${r2}s`, path: y2, rotate: "auto", repeatCount: "indefinite" }, null)])])]), g("polygon", { fill: n3, points: `5, 5 ${u2 - 5}, 5 ${u2 - 5} ${c2 - 5} 5, ${c2 - 5}` }, null), g("use", { stroke: d2[0], "stroke-width": "1", "xlink:href": `#${p2}` }, null), g("use", { stroke: d2[1], "stroke-width": "3", "xlink:href": `#${p2}`, mask: `url(#${h2})` }, [g("animate", { attributeName: "stroke-dasharray", from: `0, ${length}`, to: `${length}, 0`, dur: `${r2}s`, repeatCount: "indefinite" }, null)])] }), g(Qo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
} }), ml = ["#2e6099", "#7ce7fd"], vl = Eo.svg`
  position: absolute;
  width: 100%;
  height: 100%;
  left: 0;
  top: 0;
`("border-svg-container"), Cl = e({ name: "BorderBox9", props: zo(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = jo();
  o2({ refreshLayoutSize: n2 });
  const i2 = fl();
  return () => {
    const { color: o3, backgroundColor: n3 } = e2, { width: r2, height: s2 } = a2, u2 = Fo(ml, o3), c2 = `border-box-9-gradient-${i2.id}`, d2 = `border-box-9-mask-${i2.id}`;
    return g(Ho, { class: Eo.getClassNameForBind("border-box-9"), ref: l2 }, { default: () => [g(vl, { width: r2, height: s2 }, { default: () => [g("defs", null, [g("linearGradient", { id: c2, x1: "0%", y1: "0%", x2: "100%", y2: "100%" }, [g("animate", { attributeName: "x1", values: "0%;100%;0%", dur: "10s", begin: "0s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "x2", values: "100%;0%;100%", dur: "10s", begin: "0s", repeatCount: "indefinite" }, null), g("stop", { offset: "0%", "stop-color": u2[0] }, [g("animate", { attributeName: "stop-color", values: `${u2[0]};${u2[1]};${u2[0]}`, dur: "10s", begin: "0s", repeatCount: "indefinite" }, null)]), g("stop", { offset: "100%", "stop-color": u2[1] }, [g("animate", { attributeName: "stop-color", values: `${u2[1]};${u2[0]};${u2[1]}`, dur: "10s", begin: "0s", repeatCount: "indefinite" }, null)])]), g("mask", { id: d2 }, [g("polyline", { stroke: "#fff", "stroke-width": "3", fill: "transparent", points: `8, ${0.4 * s2} 8, 3, ${0.4 * r2 + 7}, 3` }, null), g("polyline", { fill: "#fff", points: `
                ...
                ` }, null), g("rect", { x: "0", y: "0", width: r2, height: s2, fill: `url(#${c2})`, mask: `url(#${d2})` }, null)] }), g(Qo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
} }), bl = ["#2e6099", "#7ce7fd"], Ml = ["left-top", "right-top", "left-bottom", "right-bottom"], kl = Eo.svg`
  position: absolute;
  display: block;
...
`("border-svg-container"), wl = e({ name: "BorderBox10", props: zo(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = jo();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { width: o3, height: n3 } = a2, { backgroundColor: i2, color: r2 } = e2, s2 = Fo(bl, r2);
    return g(Ho, { class: Eo.getClassNameForBind("border-box-10"), ref: l2, style: { boxShadow: `inset 0 0 25px 3px ${s2[0]}` } }, { default: () => [g(kl, { width: o3, height: n3 }, { default: () => [g("polygon", { fill: i2, points: `
                  4, 0 ${o3 - 4}, 0 ${o3}, 4 ${o3}, ${n3 - 4} ${o3 - 4}, ${n3}
                  4, ${n3} 0, ${n3 - 4} 0, 4
                ` }, null)] }), Ml.map((e3) => g(kl, { width: "150px", height: "150px", key: e3, class: e3 }, { default: () => [g("polygon", { fill: s2[1], points: "40, 0 5, 0 0, 5 0, 16 3, 19 3, 7 7, 3 35, 3" }, null)] })), g(Qo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
} }), xl = ["#2e6099", "#7ce7fd"], Sl = Eo.svg`
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0;
...
`("border-svg-container"), _l = e({ name: "BorderBox11", props: { ...zo(), titleWidth: { type: Number, default: 250 }, title: { type: String, default: "" } }, setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = jo();
  o2({ refreshLayoutSize: n2 });
  const i2 = fl();
  return () => {
    const { color: o3, backgroundColor: n3, titleWidth: r2, title: s2 } = e2, { width: u2, height: c2 } = a2, d2 = Fo(xl, o3), p2 = `border-box-11-filterId-${i2}`;
    return g(Ho, { class: Eo.getClassNameForBind("border-box-11"), ref: l2 }, { default: () => [g(Sl, { width: u2, height: c2 }, { default: () => [g("defs", null, [g("filter", { id: p2, height: "150%", width: "150%", x: "-25%", y: "-25%" }, [g("feMorphology", { operator: "dilate", radius: "2", in: "SourceAlpha", result: "thicken" }, null), g("feGaussianBlur", { in: "thicken", stdDeviation: "3", result: "blurred" }, null), g("feFlood", { "flood-color": d2[1], result: "glowColor" }, null), g("feComposite", { in: "glowColor", in2: "blurred", operator: "in", result: "softGlowColored" }, null), g("feMerge", null, [g("feMergeNode", { in: "softGlowColored" }, null), g("feMergeNode", { in: "SourceGraphic" }, null)])])]), g("polygon", { fill: n3, points: `
                ...
                ` }, null), g("polygon", { stroke: d2[0], fill: Qe(d2[1] || xl[1], 30), filter: `url(#${p2})`, points: `
                ...
                ` }, null)] }), g(Qo, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
} }), $l = ["#2e6099", "#7ce7fd"], Ll = Eo.svg`
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0;
  left: 0;
`("border-svg-container"), Il = e({ name: "BorderBox12", props: zo(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = jo();
  o2({ refreshLayoutSize: n2 });
  const i2 = fl();
  return () => {
    const { color: o3, backgroundColor: n3 } = e2, { width: r2, height: s2 } = a2, u2 = Fo($l, o3), c2 = `border-box-12-filterId-${i2}`;
    return g(Ho, { class: Eo.getClassNameForBind("border-box-12"), ref: l2 }, { default: () => [g(Ll, { width: r2, height: s2 }, { default: () => [g("defs", null, [g("filter", { id: c2, height: "150%", width: "150%", x: "-25%", y: "-25%" }, [g("feMorphology", { operator: "dilate", radius: "1", in: "SourceAlpha", result: "thicken" }, null), g("feGaussianBlur", { in: "thicken", stdDeviation: "2", result: "blurred" }, null), g("feFlood", { "flood-color": Qe(u2[1] || $l[1], 70), result: "glowColor" }, [g("animate", { attributeName: "flood-color", values: `
                        ${Qe(u2[1] || $l[1], 70)};
                        ${Qe(u2[1] || $l[1], 30)};
                        ${Qe(u2[1] || $l[1], 70)};
...
const cn = ["#2e6099", "#7ce7fd"], dn = 2.5, pn = function({ width: e2, height: t2, rowPoints: o2, rowCount: l2 }) {
...
}({ width: 200, height: 50, rowPoints: 20, rowCount: 4 }), fn = pn[39], hn = pn[37], gn = Eo.div`
  width: 100%;
  height: 100%;
...
`("decoration-1"), yn = e({ name: "Decoration1", props: rn(), setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: l2, domSize: n2 } = jo();
  return t2({ refreshLayoutSize: l2 }), () => {
    const { color: t3 } = e2, { width: l3, height: a2 } = n2, i2 = Fo(cn, t3), r2 = { transform: `scale(${l3 / 200},${a2 / 50})` };
    return g(gn, { ref: o2 }, { default: () => [g("svg", { width: 200, height: 50, style: r2 }, [pn.map(([e3, t4], o3) => {
      const l4 = e3 - 1.25, n3 = t4 - 1.25;
      return Math.random() > 0.6 ? g("rect", { key: o3, x: l4, y: n3, width: dn, height: dn, fill: i2[0] }, [Math.random() > 0.6 && g("animate", { attributeName: "fill", values: `${i2[0]};transparent`, dur: "1s", begin: 2 * Math.random(), repeatCount: "indefinite" }, null)]) : null;
    }), g("rect", { fill: i2[1], x: fn[0] - dn, y: fn[1] - dn, width: 5, height: 5 }, [g("animate", { attributeName: "width", values: "0;5", dur: "2s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "height", values: "0;5", dur: "2s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "x", values: `${fn[0]};${fn[0] - dn}`, dur: "2s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "y", values: `${fn[1]};${fn[1] - dn}`, dur: "2s", repeatCount: "indefinite" }, null)]), g("rect", { fill: i2[1], x: hn[0] - dn, y: hn[1] - dn, width: 5, height: 5 }, [g("animate", { attributeName: "width", values: "0;40;0", dur: "2s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "x", values: `${hn[0]};${hn[0] - 40};${hn[0]}`, dur: "2s", repeatCount: "indefinite" }, null)])])] });
  };
} }), mn = ["#2e6099", "#7ce7fd"];
const vn = Eo.div`
  display: flex;
...
`("decoration-3"), wn = e({ name: "Decoration3", props: rn(), setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: l2, domSize: n2 } = jo();
  return t2({ refreshLayoutSize: l2 }), () => {
    const { width: t3, height: l3 } = n2, { color: a2 } = e2, i2 = Fo(bn, a2);
    return g(kn, { ref: o2 }, { default: () => [g("svg", { width: 300, height: 35, style: { transform: `scale(${t3 / 300},${l3 / 35})` } }, [Mn.map(([e3, t4], o3) => {
...
} }), xn = ["width", "height"], Sn = ["stroke", "points"], _n = ["stroke", "points"], $n = e({ name: "Decoration4", __name: "index", props: { ...rn(), ...sn(), ...un(3) }, setup(e2) {
  ...
  return (e3, t3) => (s(), r("div", { class: "dv-decoration-4", ref_key: "decoration4Ref", ref: n2 }, [p("div", { class: c("container " + (e3.reverse ? "reverse" : "normal")), style: u(e3.reverse ? `width:${a2.value}px;height:5px;animation-duration:${e3.duration}s` : `width:5px;height:${i2.value}px;animation-duration:${e3.duration}s`) }, [(s(), r("svg", { width: e3.reverse ? a2.value : 5, height: e3.reverse ? 5 : i2.value }, [p("polyline", { stroke: d2.value[0], points: e3.reverse ? `0, 2.5 ${a2.value}, 2.5` : `2.5, 0 2.5, ${i2.value}` }, null, 8, Sn), p("polyline", { class: "bold-line", stroke: d2.value[1], "stroke-width": "3", "stroke-dasharray": "20, 80", "stroke-dashoffset": "-30", points: e3.reverse ? `0, 2.5 ${a2.value}, 2.5` : `2.5, 0 2.5, ${i2.value}` }, null, 8, _n)], 8, xn))], 6)], 512));
} }), Ln = Kt($n, [["__scopeId", "data-v-97e7e3ce"]]), In = ["#2e6099", "#7ce7fd"];
function Dn(e2) {
...
const Tn = Eo.div`
  width: 100%;
  height: 100%;
`("decoration-5"), Nn = e({ name: "Decoration5", props: { ...rn(), ...un(1.2) }, setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: l2, domSize: n2 } = jo();
  return t2({ refreshLayoutSize: l2 }), () => {
    const { width: t3, height: l3 } = n2, { color: a2, duration: i2 } = e2, r2 = Fo(In, a2), { line1Sum: s2, line2Sum: u2, line1Point: c2, line2Point: d2 } = function(e3, t4) {
...
`("decoration-6");
const { points: qn, heights: An, minHeights: On, randoms: jn } = function({ width: e2, height: t2, rowPoints: o2, rowCount: l2 }) {
...
}({ width: 300, height: 35, rowPoints: 40, rowCount: 1 }), zn = e({ name: "Decoration6", props: rn(), setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: l2, domSize: n2 } = jo();
  return t2({ refreshLayoutSize: l2 }), () => {
    const { width: t3, height: l3 } = n2, { color: a2 } = e2, i2 = Fo(Bn, a2), r2 = { transform: `scale(${t3 / 300},${l3 / 35})` };
    return g(Rn, { ref: o2 }, { default: () => [g("svg", { class: "svg-origin", width: t3, height: l3, style: r2 }, [qn.map(([e3, t4], o3) => g("rect", { key: `rect${o3}`, fill: i2[Math.random() > 0.5 ? 0 : 1], x: e3 - 3.5, y: t4 - An[o3], width: 7, height: An[o3] }, [g("animate", { attributeName: "y", values: `${t4 - On[o3] / 2};${t4 - An[o3] / 2};${t4 - On[o3] / 2}`, dur: jn[o3], keyTimes: "0;0.5;1", calcMode: "spline", keySplines: "0.42,0,0.58,1;0.42,0,0.58,1", begin: "0s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "height", values: `${On[o3]};${An[o3]};${On[o3]}`, dur: jn[o3], keyTimes: "0;0.5;1", calcMode: "spline", keySplines: "0.42,0,0.58,1;0.42,0,0.58,1", begin: "0s", repeatCount: "indefinite" }, null)]))])] });
  };
} }), Fn = Eo.div`
  display: flex;
  width: 100%;
  ...
  justify-content: center;
  align-items: center;
`("decoration-7"), Pn = ["#2e6099", "#7ce7fd"], En = e({ name: "Decoration7", props: rn(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2 } = jo();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { color: o3 } = e2, n3 = Fo(Pn, o3);
    return g(Fn, { ref: l2 }, { default: () => {
      var _a2;
...
const Qn = Eo.div`
  ...
  width: 100%;
  height: 100%;
`("decoration-8"), Gn = e({ name: "Decoration8", props: { ...rn(), ...sn() }, setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: l2, domSize: n2 } = jo();
  return t2({ refreshLayoutSize: l2 }), () => {
    const { color: t3, reverse: l3 } = e2, { width: a2, height: i2 } = n2, r2 = (e3) => l3 ? a2 - e3 : e3, s2 = Fo(Hn, t3);
    return g(Qn, { ref: o2 }, { default: () => [g("svg", { width: a2, height: i2 }, [g("polyline", { stroke: s2[0], "stroke-width": "2", fill: "transparent", points: `${r2(0)}, 0 ${r2(30)}, ${i2 / 2}` }, null), g("polyline", { stroke: s2[0], "stroke-width": "2", fill: "transparent", points: `${r2(20)}, 0 ${r2(50)}, ${i2 / 2} ${r2(a2)}, ${i2 / 2}` }, null), g("polyline", { stroke: s2[1], fill: "transparent", "stroke-width": "3", points: `${r2(0)}, ${i2 - 3}, ${r2(200)}, ${i2 - 3}` }, null)])] });
  };
} });
const Un = ["#2e6099", "#7ce7fd"], Vn = Eo.div`
  position: relative;
  width: 100%;
  height: 100%;
  display: flex;
...
`("decoration-9"), Wn = e({ name: "Decoration9", props: { ...rn(), ...un(3) }, setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = jo();
  o2({ refreshLayoutSize: n2 });
  const i2 = `decoration-9-polygon-${fl().id}`;
  return () => {
    const { width: o3, height: n3 } = a2, { color: r2, duration: s2 } = e2, u2 = Fo(Un, r2), c2 = { transform: `scale(${o3 / 100},${n3 / 100})` };
    return g(Vn, { ref: l2 }, { default: () => {
      var _a2;
      return [g("svg", { class: "svg-origin", width: 100, height: 100, style: c2 }, [g("defs", null, [g("polygon", { id: i2, points: "15, 46.5, 21, 47.5, 21, 52.5, 15, 53.5" }, null)]), g("circle", { cx: "50", cy: "50", r: "45", fill: "transparent", stroke: u2[1], "stroke-width": "10", "stroke-dasharray": "80, 100, 30, 100" }, [g("animateTransform", { attributeName: "transform", type: "rotate", values: "0 50 50;360 50 50", dur: `${s2}s`, repeatCount: "indefinite" }, null)]), g("circle", { cx: "50", cy: "50", r: "45", fill: "transparent", stroke: u2[0], "stroke-width": "6", "stroke-dasharray": "50, 66, 100, 66" }, [g("animateTransform", { attributeName: "transform", type: "rotate", values: "0 50 50;-360 50 50", dur: `${s2}s`, repeatCount: "indefinite" }, null)]), g("circle", { cx: "50", cy: "50", r: "38", fill: "transparent", stroke: Qe(u2[1] || Un[1], 30), "stroke-width": "1", "stroke-dasharray": "5, 1" }, null), Array.from({ length: 20 }).fill(0).map((e3, t3) => g("use", { key: t3, "xlink:href": `#${i2}`, stroke: u2[1], fill: Math.random() > 0.4 ? "transparent" : u2[0] }, [g("animateTransform", { attributeName: "transform", type: "rotate", values: "0 50 50;360 50 50", dur: `${s2}s`, begin: t3 * s2 / 20 + "s", repeatCount: "indefinite" }, null)])), g("circle", { cx: "50", cy: "50", r: "26", fill: "transparent", stroke: Qe(u2[1] || Un[1], 30), "stroke-width": "1", "stroke-dasharray": "5, 1" }, null)]), (_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } });
  };
} }), Zn = Eo.div`
  width: 100%;
  height: 100%;
  display: flex;
`("decoration-10"), Yn = ["#2e6099", "#7ce7fd"], Kn = e({ name: "Decoration10", props: rn(), setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: l2, domSize: n2 } = jo();
  t2({ refreshLayoutSize: l2 });
  const a2 = fl(), i2 = `d10ani${a2.id}1`, r2 = `d10ani${a2.id}2`, s2 = `d10ani${a2.id}3`, u2 = `d10ani${a2.id}4`, c2 = `d10ani${a2.id}5`, d2 = `d10ani${a2.id}6`, p2 = `d10ani${a2.id}7`;
  return () => {
    const { width: t3, height: l3 } = n2, { color: a3 } = e2, f2 = Fo(Yn, a3);
...
`("decoration-11"), Jn = Eo.div`
  ...
  align-items: center;
  justify-content: center;
`("decoration-content"), ea = ["#2e6099", "#7ce7fd"], ta = e({ name: "Decoration11", props: rn(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = jo();
  return o2({ refreshLayoutSize: n2 }), () => {
    const { width: o3, height: n3 } = a2, { color: i2 } = e2, r2 = Fo(ea, i2);
    return g(Xn, { ref: l2 }, { default: () => [g("svg", { width: o3, height: n3 }, [g("polygon", { fill: Qe(r2[1] || ea[1], 10), stroke: r2[1], points: "20 10, 25 4, 55 4 60 10" }, null), g("polygon", { fill: Qe(r2[1] || ea[1], 10), stroke: r2[1], points: `20 ${n3 - 10}, 25 ${n3 - 4}, 55 ${n3 - 4} 60 ${n3 - 10}` }, null), g("polygon", { fill: Qe(r2[1] || ea[1], 10), stroke: r2[1], points: `${o3 - 20} 10, ${o3 - 25} 4, ${o3 - 55} 4 ${o3 - 60} 10` }, null), g("polygon", { fill: Qe(r2[1] || ea[1], 10), stroke: r2[1], points: `${o3 - 20} ${n3 - 10}, ${o3 - 25} ${n3 - 4}, ${o3 - 55} ${n3 - 4} ${o3 - 60} ${n3 - 10}` }, null), g("polygon", { fill: Qe(r2[0] || ea[0], 20), stroke: r2[0], points: `
        20 10, 5 ${n3 / 2} 20 ${n3 - 10}
        ${o3 - 20} ${n3 - 10} ${o3 - 5} ${n3 / 2} ${o3 - 20} 10
      ` }, null), g("polyline", { fill: "transparent", stroke: Qe(r2[0] || ea[0], 70), points: `25 18, 15 ${n3 / 2} 25 ${n3 - 18}` }, null), g("polyline", { fill: "transparent", stroke: Qe(r2[0] || ea[0], 70), points: `${o3 - 25} 18, ${o3 - 15} ${n3 / 2} ${o3 - 25} ${n3 - 18}` }, null)]), g(Jn, null, { default: () => {
      var _a2;
      return [(_a2 = t2.default) == null ? void 0 : _a2.call(t2)];
    } })] });
  };
...
`("decoration-12"), la = Eo.div`
  ...
  align-items: center;
  justify-content: center;
`("decoration-content"), na = ["#2e6099", "#7ce7fd"], aa = Math.PI / 3;
const ia = (e2, t2, o2, l2) => [e2 + Math.cos(l2) * o2, t2 + Math.sin(l2) * o2], ra = e({ name: "Decoration12", props: { ...rn(), scanDuration: { type: Number, default: 3 }, haloDuration: { type: Number, default: 2 } }, setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: l2, refreshLayoutSize: n2, domSize: a2 } = jo();
  o2({ refreshLayoutSize: n2 });
  const i2 = fl();
  return () => {
    const { width: o3, height: n3 } = a2, r2 = o3 / 2, s2 = n3 / 2, { color: u2, scanDuration: c2, haloDuration: d2 } = e2, p2 = `decoration-12-g-${i2.id}`, f2 = `decoration-12-gradient-${i2.id}`, h2 = Fo(na, u2), y2 = ((e3, t3) => {
      const o4 = 100 / (t3 - 1);
      ...
      let s3 = ia(e3, t3, r3, a3);
      return Array.from({ length: l3 }).fill("").map((o5, l4) => {
        const n5 = ia(e3, t3, r3, a3 - (l4 + 1) * i3).map((e4) => e4.toFixed(5)), u3 = `M${s3.join(",")} A${r3}, ${r3} 0 0 0 ${n5.join(",")}`;
        return s3 = n5, u3;
      });
      ...
      return Array.from({ length: 6 }).fill("").map((o5, a3) => {
        const i3 = l3 * (a3 + 1), r3 = i3 + Math.PI, s3 = ia(e3, t3, n4, i3), u3 = ia(e3, t3, n4, r3);
...
`("header-svg-container"), Sa = e({ name: "Header6", props: zo(), setup(e2, { expose: t2 }) {
  ...
  }(l2, e4, o2) }, [C2.value.index && 0 === l2 ? (s(), r("span", { key: 0, class: "index", style: u(`background: ${C2.value.headerBGC};`) }, S(o2), 5)) : (s(), r(m, { key: 1 }, [x(S(o2), 1)], 64))], 44, _a))), 128))], 4))), 128))], 4)) : f("", true)], 512));
} }), La = Kt($a, [["__scopeId", "data-v-ccb14245"]]), Ia = ["onClick"], Da = Kt(e({ __name: "MacButton", props: { size: { type: String, default: () => "default" }, disabled: { request: false, type: Boolean, default: false }, hidden: { request: false, type: Array, default: () => [] }, narrow: { request: false, type: Boolean, default: false } }, emits: ["close", "remove", "resize", "fullResize"], setup(e2, { emit: t2 }) {
  ...
  return (t3, o3) => (s(), r("div", { class: c(d(a2)) }, [(s(true), r(m, null, v(i2.value, (t4) => (s(), r("div", { key: t4.key, class: c(["btn", [t4.key, e2.disabled && "disabled", e2.size]]), onClick: k((e3) => {
    ...
    var o4;
  }, ["stop"]) }, [g(d(Te), { icon: t4.icon, size: "10", class: c(["icon-base", { hover: !e2.disabled }]) }, null, 8, ["icon", "class"])], 10, Ia))), 128))], 2));
} }), [["__scopeId", "data-v-5c20d434"]]), Ta = e({ name: "ScreenCheckbox", __name: "index", props: { title: { type: String }, tooltip: { type: String } }, setup: (e2) => (t2, o2) => (s(), r("div", null, [g(d(W), I(D(t2.$attrs)), { default: M(() => [x(S(e2.title), 1)]), _: 1 }, 16), e2.tooltip ? (s(), h(d(G), { key: 0, title: e2.tooltip }, { default: M(() => [g(d(Te), { icon: "ant-design:exclamation-circle-outlined" })]), _: 1 }, 8, ["title"])) : f("", true)])) }), Na = { key: 0, class: "prefix" }, Ba = { key: 3 }, Ra = Kt(e({ name: "ScreenInput", __name: "index", props: { isNumber: { type: Boolean, default: true }, prefix: { type: String }, suffix: { type: String } }, emits: ["change"], setup(e2, { emit: o2 }) {
  t((e3) => ({ cd77f8d8: u2.value }));
  const n2 = o2, { prefixCls: a2 } = we("screen-input"), { token: i2 } = E.useToken(), u2 = l(() => i2.value.colorBorder);
  return (t2, o3) => (s(), r("div", { class: c(d(a2)) }, [e2.prefix ? (s(), r("div", Na, S(e2.prefix), 1)) : f("", true), e2.isNumber ? (s(), h(d(Q), $({ key: 1, class: "input" }, t2.$attrs, { onChange: o3[0] || (o3[0] = (e3) => n2("change", e3)), bordered: false, controls: false }), null, 16)) : (s(), h(d(H), $({ key: 2, class: "input" }, t2.$attrs, { bordered: false, onChange: o3[1] || (o3[1] = (e3) => n2("change", e3)) }), null, 16)), e2.suffix ? (s(), r("div", Ba, S(e2.suffix), 1)) : f("", true)], 2));
...
const Oa = Kt(e({ __name: "TextFontStyle", props: { bold: { type: Boolean, default: false }, italic: { type: Boolean, default: false }, strikethrough: { type: Boolean, default: false }, underline: { type: Boolean, default: false }, hide: { type: Array, default: () => [] } }, emits: ["fontStyleChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, i2 = a({ [Ya.Bold]: { name: "加粗", icon: "carbon:text-bold", value: false }, [Ya.Italic]: { name: "斜体", icon: "carbon:text-italic", value: false }, [Ya.Underline]: { name: "下划线", icon: "carbon:text-underline", value: false }, [Ya.Strikethrough]: { name: "删除线", icon: "carbon:text-strikethrough", value: false } }), u2 = (e3) => !o2.hide.includes(e3);
  ...
  return (e3, t3) => (s(), r("div", { class: c(d(p2)) }, [(s(true), r(m, null, v(Object.keys(i2), (e4) => (s(), r(m, { key: e4 }, [u2(e4) ? (s(), h(d(G), { key: 0, placement: "bottom", title: `${i2[e4].value ? "关闭" : "打开"}${i2[e4].name}` }, { default: M(() => [g(d(Z), { class: "radio-button", checked: i2[e4].value, onMousedown: (t4) => function(e5) {
    if (e5) {
      i2[e5].value = !i2[e5].value, i2[e5].value && (e5 === Ya.Underline && (i2[Ya.Strikethrough].value = false), e5 === Ya.Strikethrough && (i2[Ya.Underline].value = false));
      const t5 = {};
...
} }), [["__scopeId", "data-v-3b6dd2cf"]]), ja = Kt(e({ __name: "TextHAlignStyle", props: { alignType: { type: String, default: void 0 } }, emits: ["alignChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, i2 = y();
  n(() => o2.alignType, (e3) => {
    i2.value = e3;
  }, { immediate: true });
  const { prefixCls: u2 } = we("h-align-style"), p2 = a({ [Wa.Left]: { name: "水平居左", icon: "carbon:text-align-left", description: "文字水平居左" }, [Wa.Center]: { name: "水平居中", icon: "carbon:text-align-center", description: "文字水平居中" }, [Wa.Right]: { name: "水平居右", icon: "carbon:text-align-right", description: "文字水平居右" } });
  function f2(e3) {
...
} }), [["__scopeId", "data-v-63ee2427"]]), za = Kt(e({ __name: "TextVAlignStyle", props: { alignType: { type: String, default: void 0 } }, emits: ["alignChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, i2 = y();
  n(() => o2.alignType, (e3) => {
    i2.value = e3;
  }, { immediate: true });
  const { prefixCls: u2 } = we("v-align-style"), p2 = a({ [Za.Top]: { name: "垂直居上", icon: "carbon:align-vertical-top", description: "文字垂直居上" }, [Za.Center]: { name: "垂直居中", icon: "carbon:align-vertical-center", description: "文字垂直居中" }, [Za.Bottom]: { name: "垂直居下", icon: "carbon:align-vertical-bottom", description: "文字垂直居下" } });
  function f2(e3) {
    const t3 = e3.target.value;
    l2("alignChange", t3);
  }
  return (e3, t3) => (s(), r("div", { class: c(d(u2)) }, [g(d(Y), { value: i2.value, "onUpdate:value": t3[0] || (t3[0] = (e4) => i2.value = e4), onChange: f2 }, { default: M(() => [(s(true), r(m, null, v(Object.keys(p2), (e4) => (s(), h(d(G), { key: e4, placement: "top", title: p2[e4].description }, { default: M(() => [g(d(Z), { class: "radio-button", value: e4 }, { default: M(() => [g(d(Te), { icon: p2[e4].icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["value"])]), _: 2 }, 1032, ["title"]))), 128))]), _: 1 }, 8, ["value"])], 2));
} }), [["__scopeId", "data-v-a40ac773"]]), Fa = { class: "line" }, Pa = { class: "input" }, Ea = { class: "line" }, Ha = { style: { flex: "1" } }, Qa = { key: 0, class: "line" }, Ga = e({ name: "TextStyle", __name: "index", props: { verticalAlign: { type: Boolean, default: false }, textStyle: { type: Object, default: () => {
  ...
  const a2 = e2, i2 = o2, { prefixCls: u2 } = we("text-style"), { token: m2 } = E.useToken(), v2 = l(() => m2.value.colorBorder), C2 = y(12), b2 = y(Va[0].value), M2 = y(), k2 = y();
  function w2(e3) {
    const t2 = x2(e3);
  ...
  function _2(e3, t2) {
    if (!e3) return;
    const o3 = t2 == null ? void 0 : t2.startsWith("linear-gradient"), l2 = Math.round((C2.value ?? 12) / 10), n2 = (e3 == null ? void 0 : e3.underline) && o3 ? { borderBottom: `${l2}px solid`, borderImage: `${t2} 1` } : (e3 == null ? void 0 : e3.underline) ? { borderBottom: `${l2}px solid`, borderColor: `${t2}` } : {}, a3 = e3[Ya.Bold] ? { fontWeight: "bold" } : {}, r2 = e3[Ya.Italic] ? { fontStyle: "italic" } : {};
    if (o3) {
      const e4 = t2 == null ? void 0 : t2.match(new RegExp("(?<=linear-gradient.*?)(rgba\\(.*?\\))", "g"));
      e4 && e4.length > 0 && (t2 = e4[0]);
    }
    const s2 = e3[Ya.Strikethrough] ? { textDecoration: "line-through", textDecorationColor: t2 } : {};
    i2("fontStyleChange", { value: e3, style: { ...a3, ...r2, ...n2, ...s2 } });
  }
  function L2(e3) {
    i2("hAlignChange", { value: e3, style: { justifyContent: e3 === Wa.Left ? "flex-start" : e3 === Wa.Center ? "center" : e3 === Wa.Right ? "flex-end" : "center" } });
  }
  function I2(e3) {
    i2("vAlignChange", { value: e3, style: { alignItems: e3 === Za.Top ? "flex-start" : e3 === Za.Center ? "center" : e3 === Za.Bottom ? "flex-end" : "unset" } });
  }
  function D2(e3) {
  ...
  return n(() => a2.textStyle, (e3) => {
    var _a2, _b, _c2, _d2;
    e3 && (C2.value = ((_a2 = a2.textStyle) == null ? void 0 : _a2.fontSize) ?? 12, b2.value = ((_b = a2.textStyle) == null ? void 0 : _b.font) ?? Va[0].value, M2.value = (_c2 = a2.textStyle) == null ? void 0 : _c2.textColor, k2.value = (_d2 = a2.textStyle) == null ? void 0 : _d2.fontStyle);
  }, { immediate: true, deep: true }), (t2, o3) => {
    var _a2, _b;
    return s(), r("div", { class: c(d(u2)) }, [p("div", Fa, [g(d(K), { style: { flex: "1" }, value: b2.value, "onUpdate:value": o3[0] || (o3[0] = (e3) => b2.value = e3), options: d(Va), onChange: D2 }, null, 8, ["value", "options"]), p("div", Pa, [g(d(Q), { value: C2.value, "onUpdate:value": o3[1] || (o3[1] = (e3) => C2.value = e3), bordered: false, placeholder: "大小", controls: false, min: 6, maxlength: 4, onChange: T2 }, null, 8, ["value"]), o3[2] || (o3[2] = p("div", { class: "suffix" }, "px", -1))]), e2.hideAlign ? f("", true) : (s(), h(ja, { key: 0, "align-type": (_a2 = e2.textStyle) == null ? void 0 : _a2.hAlignType, onAlignChange: L2 }, null, 8, ["align-type"]))]), p("div", Ea, [p("div", Ha, [g(d(Ao), { type: e2.colorType, "direct-confirm": true, value: M2.value, onConfirmChange: w2, onInputChange: x2 }, null, 8, ["type", "value"])]), g(Oa, $({ hide: e2.hideFontStyle }, k2.value, { onFontStyleChange: S2 }), null, 16, ["hide"])]), e2.verticalAlign ? (s(), r("div", Qa, [g(za, { "align-type": (_b = e2.textStyle) == null ? void 0 : _b.vAlignType, onAlignChange: I2 }, null, 8, ["align-type"])])) : f("", true)], 2);
  };
} }), Ua = Kt(Ga, [["__scopeId", "data-v-c65c80c4"]]), Va = [{ value: "微软雅黑", label: "微软雅黑" }, { value: "宋体", label: "宋体" }, { value: "黑体", label: "黑体" }, { value: "楷体", label: "楷体" }, { value: "仿宋", label: "仿宋" }, { value: "sans-serif", label: "sans-serif" }, { value: "Arial", label: "Arial" }, { value: "PingFangSC", label: "PingFangSC" }, { value: "monospace", label: "monospace" }, { value: "Courier New", label: "Courier New" }, { value: "lcd", label: "lcd" }];
var Wa = ((e2) => (e2.Left = "left", e2.Center = "center", e2.Right = "right", e2))(Wa || {}), Za = ((e2) => (e2.Top = "top", e2.Center = "center", e2.Bottom = "bottom", e2))(Za || {}), Ya = ((e2) => (e2.Bold = "bold", e2.Italic = "italic", e2.Underline = "underline", e2.Strikethrough = "strikethrough", e2))(Ya || {});
function Ka(e2) {
  switch (e2) {
    case "NUMBER":
...
var Xa = ((e2) => (e2.error = "error", e2.eq = "=", e2.ne = "!=", e2.gt = ">", e2.ge = ">=", e2.lt = "<", e2.le = "<=", e2.between = "between", e2.isNull = "isNull", e2.isNotNull = "isNotNull", e2.like = "like", e2.notLike = "notLike", e2.likeLeft = "likeLeft", e2.likeRight = "likeRight", e2))(Xa || {}), Ja = ((e2) => (e2.count = "计数", e2.sum = "求和", e2.avg = "平均", e2.max = "最大", e2.min = "最小", e2))(Ja || {}), ei = ((e2) => (e2.formula = "formula", e2.operator = "operator", e2.field = "field", e2.param = "param", e2))(ei || {});
const ti = (e2) => Ke.get({ url: "/nocode/apiFolder/tree", params: e2 }), oi = (e2) => Ke.get({ url: "/nocode/apiFolder", params: e2 });
function li(e2) {
...
const si = (e2) => Ke.get({ url: "/nocode/apiParams", params: e2 });
function ui(e2) {
...
const fi = (e2) => Ke.get({ url: "/nocode/formulaInfo/tree", params: e2 }), hi = (e2) => Ke.get({ url: `/nocode/formulaParam/${e2}` }), gi = (e2) => Ke.get({ url: "/nocode/formulaInfo", params: e2 });
function yi(e2) {
...
const ki = () => "/nocode/mfApi/api", wi = (e2) => Ke.get({ url: "/nocode/mfApi", params: e2 });
function xi(e2) {
...
const Bi = (e2) => Ke.get({ url: "/nocode/mfApi/headers", params: e2 });
function Ri(e2) {
...
const ji = (e2) => Ke.get({ url: "/nocode/mfScreen", params: e2 });
function zi(e2, t2) {
...
const Gi = (e2) => Ke.get({ url: "/nocode/screenCharts", params: e2 });
function Ui(e2) {
...
const Xi = (e2) => Ke.get({ url: "/nocode/screenFolder/tree", params: e2 }), Ji = (e2) => Ke.get({ url: "/nocode/screenFolder", params: e2 });
function er(e2) {
...
const ar = (e2) => Ke.get({ url: "/nocode/screenResourceApi", params: e2 });
function ir(e2) {
...
const gr = (e2) => Ke.get({ url: "/nocode/screenResource", params: e2 });
function yr(e2) {
...
const Mr = (e2, t2, o2) => ({ CtrlKeysEnum: { s: Re(() => o2(), 150), z: Re(() => e2(), 150) }, CtrlShiftKeysEnum: { z: Re(() => t2(), 150) } }), kr = Xe("custom-api", { state: () => ({ sourceId: "", sourceType: 0, tableName: "", tableFields: [], tableList: [], tableFieldsMap: /* @__PURE__ */ new Map(), variables: [], level: 1, fieldsChange: 1, showData: false, showDataLevel: "", formulaMap: /* @__PURE__ */ new Map() }), getters: { getSourceId() {
  ...
  return t2 ? (this.tableFields = await Bi({ sourceId: e2, tableName: t2, sourceType: this.sourceType }), this.tableFields) : [];
}, setTableList(e2) {
  ...
  (await gi({ pageNum: 1, pageSize: 1e4 })).list.forEach((e2) => {
    const t2 = `${e2.categoryId},${e2.id}`;
    this.formulaMap.set(t2, { ...e2, key: t2 });
  });
}, getFormula(e2) {
  return this.formulaMap.get(e2);
} } }), wr = "__API_SAVE__", xr = "公式结果";
var Sr = ((e2) => (e2.QUERY_SQL = "api_config:query_sql", e2.QUERY_DATA = "api_config:query_data", e2))(Sr || {});
const _r = async (e2) => {
  const t2 = kr();
  if (!(e2 == null ? void 0 : e2.sqlQuery)) return [];
  const o2 = { sourceId: t2.getSourceId, sourceType: t2.getSourceType, sqlQuery: e2.sqlQuery }, l2 = await Ni(o2);
  return l2 && l2.forEach((t3) => t3.tableAlias = e2.sourceTable), l2;
}, $r = (e2) => e2 && ((e2 == null ? void 0 : e2.aggregates) && e2.aggregates.length > 0 || e2.groups && e2.groups.length > 0 || e2.customColumns && e2.customColumns.length > 0), Lr = (e2, t2) => t2 === kr().getLevel && $r(e2), Ir = (e2, t2, o2) => {
  ...
  var _a2, _b, _c2, _d2;
  return ((_a2 = this.curComponent) == null ? void 0 : _a2.chart.type) === es.MfCombine && ((_c2 = (_b = this.curComponent) == null ? void 0 : _b.chart.options) == null ? void 0 : _c2.selectIndex) >= 0 ? (_d2 = this.curComponent) == null ? void 0 : _d2.chart.options.components[this.curComponent.chart.options.selectIndex] : this.curComponent;
  ...
  return zd(this.componentList, e2);
}, async initCache(e2) {
  if (this.setInitComplete(false), e2) {
    const t2 = JSON.parse(e2);
    if (!t2) return;
    this.setComponentList(t2.componentList), this.setCanvasConfig(t2.canvasConfig), Fd(this.componentList).then((e3) => {
      Promise.all(e3).then(() => {
  ...
  e2.forEach((e3) => {
    Pd(e3.chart), e3.chart.type === es.MfCombine && e3.chart.options.components.forEach((e4) => {
      Pd(e4.chart);
    });
  ...
  let t2;
  if (this.setInitComplete(false), t2 = this.isResource ? await yr(this.getId) : await zi(this.getId, this.getShareToken), !t2) {
  ...
  let n2;
  if (n2 = this.isResource ? await br(this.getId) : await hr({ screenId: this.getId }, this.getShareToken), !n2 || 0 === n2.length) return this.componentList;
  ...
  return a2.clear(), this.setComponentList(i2), Fd(this.componentList, this.isResource).then((e3) => {
    Promise.all(e3).then(() => {
      this.setUndoRedoData("初始化"), this.setInitComplete(true);
    });
  }), this.componentList;
  ...
  this.canvasConfig.screenName = `${this.canvasConfig.screenName}_副本`, this.componentList.forEach((e3) => {
    t2(e3), e3.chart.type === es.MfCombine && e3.chart.options.components.forEach((e4) => {
      t2(e4);
    });
  });
  const o2 = (t3) => {
...
} } }), Br = Xe("screen-layout", { state: () => ({ chartCollapsed: false, layerCollapsed: false, configCollapsed: false }), getters: { getChartCollapsed() {
...
} } }), Rr = "menu_chart_drag", qr = "field_data_drag";
var Ar = ((e2) => (e2.All = "all", e2.Chart = "chart", e2.Layer = "layer", e2.Config = "config", e2))(Ar || {}), Or = ((e2) => (e2.CurPage = "当前页", e2.NewTab = "新标签", e2.Dialog = "弹出窗", e2))(Or || {}), jr = ((e2) => (e2.System = "系统页面", e2.External = "外部页面", e2))(jr || {}), zr = ((e2) => (e2.FIT_ORIGINAL = "fit_original", e2.FIT_WIDTH = "fit_width", e2.FIT_WIDTH_SCALE = "fit_width_scale", e2.FIT_HEIGHT = "fit_height", e2.FIT_HEIGHT_SCALE = "fit_height_scale", e2.FIT_BOX = "fit_box", e2))(zr || {});
const Fr = { CREATE_CHART: "create_chart", CHART_CHANGE: "chart_change", MOVE: "chart_move", UN_MOVE: "chart_un_move", PLAY_ANIMATION: "play_animation", STOP_ANIMATION: "stop_animation", PLAY_ANIMATION_COMPLETE: "play_animation_complete", DATA_RENAME: "data_rename", SCREEN_SAVE: "screen_save", SCREEN_PREVIEW: "screen_preview", SHOW_MODAL: "show_modal" }, Pr = { x: "x", y: "y", z: "z", width: "width", height: "height", borderWidth: "borderWidth", borderRadius: "borderRadius", borderColor: "borderColor", borderImage: "borderImage", background: "background", rotate: "rotate", opacity: "opacity", padding: "padding" };
var Er = ((e2) => (e2[e2.CONSTANT = 0] = "CONSTANT", e2[e2.VARIABLE = 1] = "VARIABLE", e2[e2.EVENT = 2] = "EVENT", e2))(Er || {});
const Hr = { id: "", name: "", data: { type: 0, dataSet: void 0, limit: 100, maxLimit: 9999, priority: 0 }, events: { emits: [], on: [] }, options: {} }, Qr = { id: null, opacity: 1, animations: [], lock: false, show: true, dropInfo: { x: 0, y: 0, zIndex: 0, width: 300, height: 300, rotate: 0, proportion: 1 }, groupStyle: {}, border: { show: false, color: void 0, width: 1, radius: 6 }, background: "", padding: "1px" };
function Gr(e2) {
  return e2 * Math.PI / 180;
}
function Ur(e2, t2, o2) {
  return { x: (e2.x - t2.x) * Math.cos(Gr(o2)) - (e2.y - t2.y) * Math.sin(Gr(o2)) + t2.x, y: (e2.x - t2.x) * Math.sin(Gr(o2)) + (e2.y - t2.y) * Math.cos(Gr(o2)) + t2.y };
}
function Vr(e2, t2) {
  return { x: e2.x + (t2.x - e2.x) / 2, y: e2.y + (t2.y - e2.y) / 2 };
}
function Wr(e2) {
  return Math.abs(Math.sin(Gr(e2)));
}
function Zr(e2) {
  return Math.abs(Math.cos(Gr(e2)));
}
function Yr(e2) {
  return (e2 + 360) % 360;
}
const Kr = { style: { value: "样式", show: true, payload: { icon: "carbon:color-palette", component: null } }, data: { value: "数据", show: true, payload: { icon: "carbon:data-structured", component: null } }, animation: { value: "动画", show: true, payload: { icon: "carbon:flow-modeler", component: T(ot(() => import("./index2.js"), { loading: true, size: "large" })) } }, advance: { value: "进阶", show: true, payload: { icon: "iconfont:icon-mfish-config", component: T(ot(() => import("./index3.js"), { loading: true, size: "large" })) } } }, Xr = (e2) => {
...
})() }, os = Object.freeze(Object.defineProperty({ __proto__: null, default: ts }, Symbol.toStringTag, { value: "Module" }));
function ls() {
  const e2 = async (e3, t3) => {
    const o2 = Nr();
    if (!e3 || !e3.data.id) return;
    let l2, n2 = {};
    return n2 = t3 ? { ...n2, ...t3 } : { pageNum: 1, pageSize: e3.data.limit }, l2 = e3.isResource ? await cr(`${o2.getId},${e3.data.id}`, n2, e3.data.paramsValue) : await qi(e3.data.id, n2, { ...e3.data.paramsValue, _shareToken: o2.getShareToken }), e3.data.headers = l2.headers, e3.data.result = l2.table.list, l2.table;
  };
  async function t2(t3) {
    ...
    t3.type && Id[t3.type].initData(t3, o2);
  }
  return { setParamValue: function(e3, t3) {
    ...
    o2.type === is.PARAM_CHANGE && t2(e3);
  } };
}
const ns = tt();
var as = ((e2) => (e2.CHART_BEFORE_MOUNT = "before_mount", e2.CHART_MOUNTED = "mounted", e2.CHART_CLICK = "click", e2.CHART_DBLCLICK = "dblclick", e2.CHART_MOUSE_ENTER = "mouseenter", e2.CHART_MOUSE_LEAVE = "mouseLeave", e2))(as || {}), is = ((e2) => (e2.PARAM_CHANGE = "param_change", e2.PAGE_JUMP = "param_jump", e2))(is || {});
const rs = (e2, t2) => {
  var _a2, _b;
  switch (e2) {
    case "before_mount":
    ...
    case "mouseLeave":
      return "鼠标离开";
    default:
      return t2 ? ((_b = (_a2 = Id[t2].customEvents) == null ? void 0 : _a2.find((t3) => t3.value === e2)) == null ? void 0 : _b.name) ?? "" : "";
  }
};
function ss(e2, t2, o2) {
  const l2 = Nr(), a2 = (t3, o3) => {
    ((e3) => {
      var _a2;
      if (((_a2 = e3.events) == null ? void 0 : _a2.emits) && e3.events.emits.includes(t3)) {
        const l3 = t3 + e3.id;
        ns.emit(l3, { eventId: l3, e: o3, data: e3.data });
      }
    })(e2);
  };
  N(() => {
    ...
    setTimeout(async () => {
      for (; !l2.getInitComplete; ) await nt(200);
      setTimeout(() => {
        a2("mounted", {});
      }, 100);
    }, 10);
  ...
  n(() => e2.data.params, (e3, t3) => {
    !function(e4, t4) {
      ...
      for (const t5 of Object.keys(e4)) Ve(e4[t5].value) && e4[t5].value.forEach((e5) => {
        const t6 = p2(e5);
        o3.has(t6) || (o3.add(t6), ns.on(t6, c2));
      });
    }(e3, t3);
  }, { immediate: true, deep: true });
  const f2 = (t3) => {
    ...
    const o3 = (() => {
      var _a3, _b2, _c3, _d2;
      let t4;
      if (((_a3 = e2.jump) == null ? void 0 : _a3.pageType) === jr.System) {
  ...
  function h2(t3) {
    ...
    for (const l3 of e2.showHide.conditions) {
      if (t3.eventId !== p2(l3.event)) continue;
      const n2 = d2(t3, l3.event);
      switch (l3.condition) {
        case "eq":
          o3 = n2 === l3.value;
          break;
  ...
  function g2() {
    ...
    ((_a2 = e2.data.eventRefresh) == null ? void 0 : _a2.open) && ((_b = e2.data.eventRefresh) == null ? void 0 : _b.events) && t3(e2).then((t4) => {
      var _a3;
      e2.type && ((_a3 = Id[e2.type]) == null ? void 0 : _a3.initData(e2, t4));
    });
  }
...
const us = Kt(e({ name: "MfTag", __name: "index", props: { chart: { type: Object, required: true }, chartContain: { type: Object, required: true } }, emits: ["eventHandler"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, { prefixCls: i2 } = we("mf-tag"), g2 = l(() => Xr(o2.chart)), { emitEvent: y2, commonEvents: m2 } = ss(o2.chart, function(e3) {
    a2("eventHandler", e3);
  }, ["titleChange"]);
  return n(() => {
    var _a2;
    ...
    return s(), r("div", $({ class: d(i2), style: { ...(_b = (_a2 = e2.chart.options) == null ? void 0 : _a2.hAlign) == null ? void 0 : _b.style } }, B(d(m2), true)), [p("div", { class: "title", style: u({ overflow: e2.chart.options.hide ? "hidden" : "", ...(_d2 = (_c2 = e2.chart.options) == null ? void 0 : _c2.vAlign) == null ? void 0 : _d2.style }) }, [((_e2 = e2.chart.data.dataSet) == null ? void 0 : _e2.icon) ? (s(), h(d(Te), { key: 0, size: g2.value.fontSize, icon: (_f2 = e2.chart.data.dataSet) == null ? void 0 : _f2.icon, color: e2.chart.options.iconColor }, null, 8, ["size", "icon", "color"])) : f("", true), p("span", { class: c({ hide: e2.chart.options.hide }), style: u(g2.value) }, S((_g = e2.chart.data.dataSet) == null ? void 0 : _g.title), 7)], 4)], 16);
  };
} }), [["__scopeId", "data-v-540aeb6f"]]);
function cs(e2) {
  return e2.chart.data.dataSet = Be(ds.defaultData), e2.chart.data.headers = ds.defaultHeaders && ds.defaultHeaders(), e2.chart.data.limit = 1, e2.chart.data.maxLimit = 1, e2.chart.options.bordered = true, e2.chartContain.dropInfo.width = 80, e2.chartContain.dropInfo.height = 34, e2;
}
const ds = { type: es.MfTag, component: us, create: cs, config: (() => {
  const e2 = Be(Kr);
...
}, customEvents: [{ name: "标签值改变", value: "titleChange" }] }, ps = Object.freeze(Object.defineProperty({ __proto__: null, default: ds, mfTagCreate: cs }, Symbol.toStringTag, { value: "Module" })), fs = { ...ds, type: es.MfDataTag, component: ot(() => import("./index5.js"), { loading: true }), config: (() => {
  const e2 = Be(Kr);
...
function ys() {
  const e2 = Nr(), { getDataTable: t2, setDataTable: o2 } = ls();
...
function ms(e2) {
  return e2.chart.data.dataSet = Be(vs.defaultData), e2.chart.data.headers = vs.defaultHeaders && vs.defaultHeaders(), e2.chart.data.limit = 1, e2.chart.data.maxLimit = 1, e2.chartContain.dropInfo.width = 120, e2.chartContain.dropInfo.height = 60, e2.chart.options.backgroundColor = "transparent", e2;
}
const vs = { type: es.MfDigits, component: ot(() => import("./index6.js"), { loading: true }), create: ms, config: (() => {
  const e2 = Be(Kr);
...
function Cs() {
  const { createMessage: e2 } = Se(), { deleteFields: t2 } = ys();
  function o2(e3) {
...
function ws(e2) {
  const { createMessage: t2 } = Se(), { deleteFields: o2 } = ys();
  function l2(e3) {
    e3.data.dataSet = ks.defaultData;
  }
...
const Is = { type: es.MfBorder1, component: ot(() => import("./index9.js"), { loading: true }), create: Ls, config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfBorderConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Ds = Object.freeze(Object.defineProperty({ __proto__: null, default: Is, mfBorder1Create: Ls }, Symbol.toStringTag, { value: "Module" })), Ts = { ...Is, type: es.MfBorder10, component: ot(() => import("./index10.js"), { loading: true }) }, Ns = Object.freeze(Object.defineProperty({ __proto__: null, default: Ts }, Symbol.toStringTag, { value: "Module" }));
function Bs(e2) {
...
const Rs = { type: es.MfBorder11, component: ot(() => import("./index11.js"), { loading: true }), create: Bs, config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfBorder11Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, qs = Object.freeze(Object.defineProperty({ __proto__: null, default: Rs, mfBorder11Create: Bs }, Symbol.toStringTag, { value: "Module" })), As = { ...Is, type: es.MfBorder12, component: ot(() => import("./index12.js"), { loading: true }) }, Os = Object.freeze(Object.defineProperty({ __proto__: null, default: As }, Symbol.toStringTag, { value: "Module" })), js = { ...Is, type: es.MfBorder13, component: ot(() => import("./index13.js"), { loading: true }) }, zs = Object.freeze(Object.defineProperty({ __proto__: null, default: js }, Symbol.toStringTag, { value: "Module" }));
function Fs(e2) {
  const t2 = Is.create(e2);
  return t2.chartContain.border.radius = 0, t2;
}
const Ps = { ...Is, type: es.MfBorder14, component: ot(() => import("./index14.js"), { loading: true }), create: Fs }, Es = Object.freeze(Object.defineProperty({ __proto__: null, default: Ps, mfBorder14Create: Fs }, Symbol.toStringTag, { value: "Module" })), Hs = { ...Ps, type: es.MfBorder15, component: ot(() => import("./index15.js"), { loading: true }) }, Qs = Object.freeze(Object.defineProperty({ __proto__: null, default: Hs }, Symbol.toStringTag, { value: "Module" })), Gs = { ...Ps, type: es.MfBorder16, component: ot(() => import("./index16.js"), { loading: true }) }, Us = Object.freeze(Object.defineProperty({ __proto__: null, default: Gs }, Symbol.toStringTag, { value: "Module" })), Vs = { ...Ps, type: es.MfBorder17, component: ot(() => import("./index17.js"), { loading: true }) }, Ws = Object.freeze(Object.defineProperty({ __proto__: null, default: Vs }, Symbol.toStringTag, { value: "Module" })), Zs = { ...Ps, type: es.MfBorder18, component: ot(() => import("./index18.js"), { loading: true }) }, Ys = Object.freeze(Object.defineProperty({ __proto__: null, default: Zs }, Symbol.toStringTag, { value: "Module" })), Ks = { ...Ps, type: es.MfBorder19, component: ot(() => import("./index19.js"), { loading: true }) }, Xs = Object.freeze(Object.defineProperty({ __proto__: null, default: Ks }, Symbol.toStringTag, { value: "Module" })), Js = { ...Is, type: es.MfBorder2, component: ot(() => import("./index20.js"), { loading: true }) }, eu = Object.freeze(Object.defineProperty({ __proto__: null, default: Js }, Symbol.toStringTag, { value: "Module" })), tu = { ...Ps, type: es.MfBorder20, component: ot(() => import("./index21.js"), { loading: true }) }, ou = Object.freeze(Object.defineProperty({ __proto__: null, default: tu }, Symbol.toStringTag, { value: "Module" })), lu = { ...Ps, type: es.MfBorder21, component: ot(() => import("./index22.js"), { loading: true }) }, nu = Object.freeze(Object.defineProperty({ __proto__: null, default: lu }, Symbol.toStringTag, { value: "Module" })), au = { ...Ps, type: es.MfBorder22, component: ot(() => import("./index23.js"), { loading: true }) }, iu = Object.freeze(Object.defineProperty({ __proto__: null, default: au }, Symbol.toStringTag, { value: "Module" })), ru = { ...Is, type: es.MfBorder3, component: ot(() => import("./index24.js"), { loading: true }) }, su = Object.freeze(Object.defineProperty({ __proto__: null, default: ru }, Symbol.toStringTag, { value: "Module" })), uu = { ...Is, type: es.MfBorder4, component: ot(() => import("./index25.js"), { loading: true }), config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfBorder4Config.js"), { loading: true, size: "large" })), e2;
})() }, cu = Object.freeze(Object.defineProperty({ __proto__: null, default: uu }, Symbol.toStringTag, { value: "Module" })), du = { ...uu, type: es.MfBorder5, component: ot(() => import("./index26.js"), { loading: true }) }, pu = Object.freeze(Object.defineProperty({ __proto__: null, default: du }, Symbol.toStringTag, { value: "Module" })), fu = { ...Is, type: es.MfBorder6, component: ot(() => import("./index27.js"), { loading: true }) }, hu = Object.freeze(Object.defineProperty({ __proto__: null, default: fu }, Symbol.toStringTag, { value: "Module" })), gu = { ...Is, type: es.MfBorder7, component: ot(() => import("./index28.js"), { loading: true }) }, yu = Object.freeze(Object.defineProperty({ __proto__: null, default: gu }, Symbol.toStringTag, { value: "Module" }));
function mu(e2) {
...
const vu = { type: es.MfBorder8, component: ot(() => import("./index29.js"), { loading: true }), create: mu, config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfBorder8Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Cu = Object.freeze(Object.defineProperty({ __proto__: null, default: vu, mfBorder8Create: mu }, Symbol.toStringTag, { value: "Module" })), bu = { ...Is, type: es.MfBorder9, component: ot(() => import("./index30.js"), { loading: true }) }, Mu = Object.freeze(Object.defineProperty({ __proto__: null, default: bu }, Symbol.toStringTag, { value: "Module" }));
function ku(e2) {
...
const wu = { type: es.MfDecoration1, component: ot(() => import("./index31.js"), { loading: true }), create: ku, config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, xu = Object.freeze(Object.defineProperty({ __proto__: null, default: wu, mfDecoration1Create: ku }, Symbol.toStringTag, { value: "Module" }));
function Su(e2) {
...
const _u = { type: es.MfDecoration10, component: ot(() => import("./index32.js"), { loading: true }), create: Su, config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const Iu = { type: es.MfDecoration11, component: ot(() => import("./index33.js"), { loading: true }), create: Lu, config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfDecoration7Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Du = Object.freeze(Object.defineProperty({ __proto__: null, default: Iu, mfDecoration11Create: Lu }, Symbol.toStringTag, { value: "Module" }));
function Tu(e2) {
...
const Nu = { type: es.MfDecoration12, component: ot(() => import("./index34.js"), { loading: true }), create: Tu, config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfDecoration12Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Bu = Object.freeze(Object.defineProperty({ __proto__: null, default: Nu, mfDecoration12Create: Tu }, Symbol.toStringTag, { value: "Module" }));
function Ru(e2) {
...
const qu = { type: es.MfDecoration2, component: ot(() => import("./index35.js"), { loading: true }), create: Ru, config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfDecoration2Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Au = Object.freeze(Object.defineProperty({ __proto__: null, default: qu, mfDecoration2Create: Ru }, Symbol.toStringTag, { value: "Module" }));
function Ou(e2) {
...
const ju = { type: es.MfDecoration3, component: ot(() => import("./index36.js"), { loading: true }), create: Ou, config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const Pu = { type: es.MfDecoration4, component: ot(() => import("./index37.js"), { loading: true }), create: Fu, config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfDecoration2Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Eu = Object.freeze(Object.defineProperty({ __proto__: null, default: Pu, mfDecoration4Create: Fu }, Symbol.toStringTag, { value: "Module" }));
function Hu(e2) {
...
const Qu = { type: es.MfDecoration5, component: ot(() => import("./index38.js"), { loading: true }), create: Hu, config: (() => {
  const e2 = Be(Kr);
...
const Vu = { type: es.MfDecoration6, component: ot(() => import("./index39.js"), { loading: true }), create: Uu, config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const Yu = { type: es.MfDecoration7, component: ot(() => import("./index40.js"), { loading: true }), create: Zu, config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfDecoration7Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const Ju = { type: es.MfDecoration8, component: ot(() => import("./index41.js"), { loading: true }), create: Xu, config: (() => {
  const e2 = Be(Kr);
...
const oc = { type: es.MfDecoration9, component: ot(() => import("./index42.js"), { loading: true }), create: tc, config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfDecoration5Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const ac = { type: es.MfHeader1, create: nc, component: ot(() => import("./index43.js"), { loading: true }), config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const sc = { type: es.MfHeader2, create: rc, component: ot(() => import("./index44.js"), { loading: true }), config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const dc = { type: es.MfHeader3, create: cc, component: ot(() => import("./index45.js"), { loading: true }), config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const hc = { type: es.MfHeader4, create: fc, component: ot(() => import("./index46.js"), { loading: true }), config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const mc = { type: es.MfHeader5, create: yc, component: ot(() => import("./index47.js"), { loading: true }), config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
...
const bc = { type: es.MfHeader6, create: Cc, component: ot(() => import("./index48.js"), { loading: true }), config: (() => {
  const e2 = Be(Kr);
  return e2.data.show = false, e2.style.payload.component = T(ot(() => import("./MfDecorationConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Mc = Object.freeze(Object.defineProperty({ __proto__: null, default: bc, mfHeader6Create: Cc }, Symbol.toStringTag, { value: "Module" })), kc = e({ name: "MfDateTime", __name: "index", props: { chart: { type: Object, required: true }, chartContain: { type: Object, required: true } }, setup(e2) {
  const t2 = e2, o2 = y(t2.chart), l2 = () => {
    var _a2;
    ((_a2 = t2.chart.options) == null ? void 0 : _a2.format) ? o2.value.data.dataSet.title = at(/* @__PURE__ */ new Date(), t2.chart.options.format) : o2.value.data.dataSet.title = at();
  };
  return i(() => {
...
const xc = { type: es.MfDateTime, component: kc, create: wc, config: (() => {
  const e2 = Be(Kr);
...
function _c() {
  ...
  function t2(t3) {
    var _a2;
    ((_a2 = t3 == null ? void 0 : t3.data) == null ? void 0 : _a2.dataSet) && (t3 == null ? void 0 : t3.type) && (t3.data.dataSet = Be(Id[t3.type].defaultData), t3.options.series = e2(t3, Id[t3.type].defaultSeries || []));
  }
  return { resetDefault: t2, setDynamicData: function(o2, l2) {
    ...
    if (o2) {
      if ((l2 == null ? void 0 : l2.list.length) > 0 && o2.data.fields && (((_b = (_a2 = o2.data.fields) == null ? void 0 : _a2.dimensions) == null ? void 0 : _b.length) > 0 || ((_d2 = (_c2 = o2.data.fields) == null ? void 0 : _c2.source) == null ? void 0 : _d2.length) > 0)) {
        const { createMessage: n2 } = Se(), { deleteFieldValue: a2 } = ys(), i2 = o2.data.fields.dimensions ?? [], r2 = o2.data.fields.source ?? [];
...
const $c = { type: es.MfBar, component: ot(() => import("./index49.js"), { loading: true, size: "large" }), create: function(e2) {
  return e2.chart.data.dataSet = Be($c.defaultData), e2.chart.data.headers = $c.defaultHeaders && $c.defaultHeaders(e2.chart), e2.chart.data.limit = 100, e2.chart.data.maxLimit = 1e3, e2.chart.options = { grid: { left: "10%", right: "5%", top: "10%", bottom: "10%" }, xAxis: { show: true, type: "category" }, yAxis: { show: true }, series: Be($c.defaultSeries) }, e2.chartContain.dropInfo.width = 400, e2.chartContain.dropInfo.height = 300, e2;
}, config: (() => {
  const e2 = Be(Kr);
  ...
  var _a2, _b;
  return Jr((_b = (_a2 = e2 == null ? void 0 : e2.data) == null ? void 0 : _a2.dataSet) == null ? void 0 : _b.source[0]);
...
const Ic = { ...$c, type: es.MfBarHorizontal, create: function(e2) {
  const t2 = $c.create(e2);
  return t2.chart.options = { ...t2.chart.options, xAxis: { show: true }, yAxis: { show: true, type: "category" } }, t2;
} }, Dc = Object.freeze(Object.defineProperty({ __proto__: null, default: Ic }, Symbol.toStringTag, { value: "Module" }));
const Tc = { ...$c, type: es.MfBarStack, create: function(e2) {
  const t2 = $c.create(e2);
  return t2.chart.data.dataSet = Be(Tc.defaultData), t2.chart.data.headers = Tc.defaultHeaders && Tc.defaultHeaders(t2.chart), t2.chart.options.series = Be(Tc.defaultSeries), t2;
}, defaultSeries: [{ type: "bar", stack: "total" }, { type: "bar", stack: "total" }], defaultData: { source: [["日期", "数据1", "数据2"], ["Mon", 120, 80], ["Tue", 200, 132], ["Wed", 150, 90], ["Thu", 80, 180], ["Fri", 70, 110], ["Sat", 110, 130], ["Sun", 130, 90]] } }, Nc = Object.freeze(Object.defineProperty({ __proto__: null, default: Tc }, Symbol.toStringTag, { value: "Module" }));
const Bc = { ...Tc, type: es.MfBarLine, defaultSeries: [{ type: "bar" }, { type: "line" }], create: function(e2) {
  const t2 = Tc.create(e2);
...
const qc = { ...$c, type: es.MfBarPlusMinus, create: function(e2) {
  const t2 = $c.create(e2);
  return t2.chart.data.dataSet = Be(qc.defaultData), t2.chart.data.headers = qc.defaultHeaders && qc.defaultHeaders(t2.chart), t2.chart.options = { ...t2.chart.options, xAxis: { show: true, type: "value", position: "top", splitLine: { show: true, lineStyle: { type: "dashed" } } }, yAxis: { show: true, type: "category", axisLine: { show: false }, axisLabel: { show: false }, axisTick: { show: false } }, series: Be(qc.defaultSeries) }, t2;
}, defaultData: { source: [["维度", "数据"], ["ten", -0.07], ["nine", -0.09], ["eight", 0.2], ["seven", -0.44], ["six", -0.23], ["five", 0.08], ["four", -0.17], ["three", 0.47], ["two", -0.36], ["one", 0.18]] } }, Ac = Object.freeze(Object.defineProperty({ __proto__: null, default: qc }, Symbol.toStringTag, { value: "Module" }));
const Oc = { ...$c, type: es.MfLine, create: function(e2) {
  return e2.chart.data.dataSet = Be(Oc.defaultData), e2.chart.data.headers = Oc.defaultHeaders && Oc.defaultHeaders(e2.chart), e2.chart.data.limit = 100, e2.chart.data.maxLimit = 1e3, e2.chart.options = { grid: { left: "10%", right: "10%", top: "10%", bottom: "10%" }, xAxis: { show: true, type: "category" }, yAxis: { show: true }, series: Be(Oc.defaultSeries) }, e2.chartContain.dropInfo.width = 400, e2.chartContain.dropInfo.height = 300, e2;
}, defaultSeries: [{ type: "line" }] }, jc = Object.freeze(Object.defineProperty({ __proto__: null, default: Oc }, Symbol.toStringTag, { value: "Module" }));
const zc = { ...Oc, type: es.MfLineArea, create: function(e2) {
  const t2 = Oc.create(e2);
  return t2.chart.options.series = Be(zc.defaultSeries), t2;
...
const Pc = { ...Tc, type: es.MfLineAreaStack, create: function(e2) {
  const t2 = Tc.create(e2);
  return t2.chart.options.series = Be(Pc.defaultSeries), t2;
}, defaultSeries: [{ type: "line", areaStyle: {}, stack: "total" }, { type: "line", areaStyle: {}, stack: "total" }] }, Ec = Object.freeze(Object.defineProperty({ __proto__: null, default: Pc }, Symbol.toStringTag, { value: "Module" }));
const Hc = { ...Oc, type: es.MfLineSmooth, create: function(e2) {
  const t2 = Oc.create(e2);
...
const Gc = { ...Tc, type: es.MfLineStack, create: function(e2) {
  const t2 = Tc.create(e2);
...
const Wc = { type: es.MfMapLine, component: ot(() => import("./index50.js"), { loading: true, size: "large" }), create: function(e2) {
  return e2.chart.data.dataSet = Be(Wc.defaultData), e2.chart.data.headers = Wc.defaultHeaders && Wc.defaultHeaders(e2.chart), e2.chart.data.limit = 100, e2.chart.data.maxLimit = 1e3, e2.chart.options = { tooltip: { show: true }, geo: { map: "china", scale: true, zoom: 1.2, scaleLimit: { min: 0.5, max: 2 }, emphasis: { itemStyle: { color: "#3146B3" } }, itemStyle: { color: "#03133D", borderColor: "#6699FF", shadowColor: "#1773C3", shadowBlur: 10, borderWidth: 1 }, label: { color: "#ffffff", emphasis: { color: "#ffffff" } } }, visualMap: { show: false, min: 0, max: 100, text: ["高", "低"], realtime: false, calculable: true, inRange: { color: Be(Vc[0].color) } }, series: Be(Wc.defaultSeries) }, e2.chartContain.dropInfo.width = 800, e2.chartContain.dropInfo.height = 650, e2;
}, config: (() => {
  const e2 = Be(Kr);
...
function Zc() {
  ...
  return { resetDefault: e2, setDynamicData: function(t2, o2) {
    ...
    if (t2) if ((o2 == null ? void 0 : o2.list.length) > 0 && t2.data.fields && (((_b = (_a2 = t2.data.fields) == null ? void 0 : _a2.start) == null ? void 0 : _b.length) > 0 || ((_d2 = (_c2 = t2.data.fields) == null ? void 0 : _c2.end) == null ? void 0 : _d2.length) > 0)) {
      const { createMessage: l2 } = Se(), { deleteFieldValue: n2 } = ys(), a2 = t2.data.fields.start ?? [], i2 = t2.data.fields.end ?? [], r2 = t2.data.fields.value ?? [];
...
const Kc = { ...Wc, type: es.MfMapLine3D, component: ot(() => import("./index51.js"), { loading: true, size: "large" }), create: function(e2) {
  var _a2;
  const t2 = Wc.create(e2);
  return (_a2 = t2.chart.options) == null ? true : delete _a2.geo, t2.chart.options = { ...t2.chart.options, geo3D: { map: "china", shading: "lambert", viewControl: { distance: 85, rotateSensitivity: 0, zoomSensitivity: 0 }, light: { main: { intensity: 1.2, shadow: true } }, itemStyle: { color: "#03133D", borderColor: "#6699FF", shadowColor: "#1773C3", shadowBlur: 10, borderWidth: 1 }, emphasis: { itemStyle: { color: "#3146B3" } }, label: { distance: 0, color: "#ffffff", emphasis: { color: "#ffffff" } } }, series: Be(Kc.defaultSeries) }, t2;
...
const Jc = { ...$c, type: es.MfPie, create: function(e2) {
  return e2.chart.data.dataSet = Be(Jc.defaultData), e2.chart.data.headers = Jc.defaultHeaders && Jc.defaultHeaders(e2.chart), e2.chart.data.limit = 100, e2.chart.data.maxLimit = 1e3, e2.chartContain.dropInfo.width = 400, e2.chartContain.dropInfo.height = 400, e2.chart.options = { tooltip: { trigger: "item" }, series: Be(Jc.defaultSeries) }, e2;
}, config: (() => {
  const e2 = Be(Kr);
...
const td = { ...Jc, type: es.MfPieCircular, create: function(e2) {
  const t2 = Jc.create(e2);
  return t2.chart.options.series = Be(td.defaultSeries), t2;
...
const ld = { ...Jc, type: es.MfPieHalf, create: function(e2) {
  const t2 = Jc.create(e2);
  return t2.chart.options.series = Be(ld.defaultSeries), t2;
...
const ad = { ...Jc, type: es.MfPieRose, create: function(e2) {
  const t2 = Jc.create(e2);
  return t2.chart.options.series = Be(ad.defaultSeries), t2;
...
const rd = { component: ot(() => import("./index52.js"), { loading: true, size: "large" }), type: es.MfRadar, create: function(e2) {
  return e2.chart.data.dataSet = Be(rd.defaultData), e2.chart.data.headers = rd.defaultHeaders && rd.defaultHeaders(), e2.chart.data.limit = 5, e2.chart.data.maxLimit = 20, e2.chartContain.dropInfo.width = 400, e2.chartContain.dropInfo.height = 400, e2.chart.options = { series: Be(rd.defaultSeries) }, e2;
}, config: (() => {
  const e2 = Be(Kr);
...
function sd() {
  const { createMessage: e2 } = Se(), { deleteFieldValue: t2 } = ys();
  function o2(e3) {
    e3.data.dataSet = Be(rd.defaultData);
  }
  return { resetDefault: o2, setDynamicData: function(l2, n2) {
    var _a2, _b, _c2, _d2, _e2, _f2, _g;
...
const cd = { ...rd, type: es.MfRadarCircle, create: function(e2) {
...
const pd = { ...$c, type: es.MfScatter, create: function(e2) {
  return e2.chart.data.dataSet = Be(pd.defaultData), e2.chart.data.headers = pd.defaultHeaders && pd.defaultHeaders(e2.chart), e2.chart.data.limit = 100, e2.chart.data.maxLimit = 1e3, e2.chartContain.dropInfo.width = 400, e2.chartContain.dropInfo.height = 300, e2.chart.options = { grid: { left: "10%", right: "10%", top: "10%", bottom: "10%" }, xAxis: { show: true }, yAxis: { show: true }, series: Be(pd.defaultSeries) }, e2;
}, config: (() => {
  const e2 = Be(Kr);
  ...
  const t2 = e2, { commonEvents: o2 } = ss(t2.chart), n2 = l(() => {
    var _a2;
    return ((_a2 = t2.chart.data.dataSet) == null ? void 0 : _a2.key) ? it(rt(t2.chart.data.dataSet.key)) : et;
  });
  return (t3, l2) => {
    var _a2;
    return s(), h(d(X), $({ src: n2.value, alt: ((_a2 = e2.chart.data.dataSet) == null ? void 0 : _a2.alt) || "图片" }, e2.chart.options, { width: e2.chartContain.dropInfo.width - 2, height: e2.chartContain.dropInfo.height - 2, fallback: d(et) }, B(d(o2))), null, 16, ["src", "alt", "width", "height", "fallback"]);
  };
} });
function gd(e2) {
  return e2.chart.data.dataSet = Be(yd.defaultData), e2.chart.data.headers = yd.defaultHeaders && yd.defaultHeaders(), e2.chart.data.limit = 1, e2.chart.data.maxLimit = 1, e2.chart.options.preview = false, e2.chartContain.dropInfo.width = 200, e2.chartContain.dropInfo.height = 200, e2;
}
const yd = { type: es.MfPicture, component: hd, create: gd, config: (() => {
  const e2 = Be(Kr);
...
function vd(e2) {
  return e2.chart.data.dataSet = Be(Cd.defaultData), e2.chart.data.headers = Cd.defaultHeaders && Cd.defaultHeaders(e2.chart), e2.chart.data.limit = 50, e2.chart.data.maxLimit = 1e3, e2.chartContain.dropInfo.width = 600, e2.chartContain.dropInfo.height = 300, e2.chart.options = { indexHeader: "序号", showHeader: true, index: true }, e2;
}
const Cd = { type: es.MfScrollTable, component: ot(() => import("./index53.js"), { loading: true }), create: vd, config: (() => {
  const e2 = Be(Kr);
...
function bd() {
  function e2(e3) {
    var _a2;
    ((_a2 = e3 == null ? void 0 : e3.data) == null ? void 0 : _a2.dataSet) && (e3.data.dataSet = Be(Cd.defaultData));
  }
  return { resetDefault: e2, setDynamicData: function(t2, o2) {
    var _a2, _b;
    if (!t2) return;
...
const Md = Object.freeze(Object.defineProperty({ __proto__: null, default: Cd, mfScrollTableCreate: vd, useDataScrollTable: bd }, Symbol.toStringTag, { value: "Module" }));
function kd(e2) {
  return e2.chart.data.dataSet = Be(wd.defaultData), e2.chart.data.headers = wd.defaultHeaders && wd.defaultHeaders(e2.chart), e2.chart.data.limit = 10, e2.chart.data.maxLimit = 1e3, e2.chartContain.dropInfo.width = 600, e2.chartContain.dropInfo.height = 50, e2;
}
const wd = { type: es.MfSegmented, component: ot(() => import("./index54.js"), { loading: true }), create: kd, config: (() => {
  const e2 = Be(Kr);
...
function xd() {
  function e2(e3) {
    var _a2;
    ((_a2 = e3 == null ? void 0 : e3.data) == null ? void 0 : _a2.dataSet) && (e3.data.dataSet = Be(wd.defaultData));
  }
  return { resetDefault: e2, setDynamicData: function(t2, o2) {
    var _a2, _b, _c2, _d2;
    if (t2) {
...
}, Ld = Object.assign({ "./MfCombine/mfCombine.data.ts": os, "./MfDataTag/mfDataTag.data.ts": gs, "./MfDataUi/MfDigits/mfDigits.data.ts": bs, "./MfDataUi/MfTireMarks/mfTireMarks.data.ts": $s, "./MfDataUi/MfWheel/mfWheel.data.ts": xs, "./MfDataV/MfBorder1/mfBorder1.data.ts": Ds, "./MfDataV/MfBorder10/mfBorder10.data.ts": Ns, "./MfDataV/MfBorder11/mfBorder11.data.ts": qs, "./MfDataV/MfBorder12/mfBorder12.data.ts": Os, "./MfDataV/MfBorder13/mfBorder13.data.ts": zs, "./MfDataV/MfBorder14/mfBorder14.data.ts": Es, "./MfDataV/MfBorder15/mfBorder15.data.ts": Qs, "./MfDataV/MfBorder16/mfBorder16.data.ts": Us, "./MfDataV/MfBorder17/mfBorder17.data.ts": Ws, "./MfDataV/MfBorder18/mfBorder18.data.ts": Ys, "./MfDataV/MfBorder19/mfBorder19.data.ts": Xs, "./MfDataV/MfBorder2/mfBorder2.data.ts": eu, "./MfDataV/MfBorder20/mfBorder20.data.ts": ou, "./MfDataV/MfBorder21/mfBorder21.data.ts": nu, "./MfDataV/MfBorder22/mfBorder22.data.ts": iu, "./MfDataV/MfBorder3/mfBorder3.data.ts": su, "./MfDataV/MfBorder4/mfBorder4.data.ts": cu, "./MfDataV/MfBorder5/mfBorder5.data.ts": pu, "./MfDataV/MfBorder6/mfBorder6.data.ts": hu, "./MfDataV/MfBorder7/mfBorder7.data.ts": yu, "./MfDataV/MfBorder8/mfBorder8.data.ts": Cu, "./MfDataV/MfBorder9/mfBorder9.data.ts": Mu, "./MfDataV/MfDecoration1/mfDecoration.data.ts": xu, "./MfDataV/MfDecoration10/mfDecoration.data.ts": $u, "./MfDataV/MfDecoration11/mfDecoration.data.ts": Du, "./MfDataV/MfDecoration12/mfDecoration.data.ts": Bu, "./MfDataV/MfDecoration2/mfDecoration.data.ts": Au, "./MfDataV/MfDecoration3/mfDecoration.data.ts": zu, "./MfDataV/MfDecoration4/mfDecoration.data.ts": Eu, "./MfDataV/MfDecoration5/mfDecoration.data.ts": Gu, "./MfDataV/MfDecoration6/mfDecoration.data.ts": Wu, "./MfDataV/MfDecoration7/mfDecoration.data.ts": Ku, "./MfDataV/MfDecoration8/mfDecoration.data.ts": ec, "./MfDataV/MfDecoration9/mfDecoration.data.ts": lc, "./MfDataV/MfHeader1/mfHeader1.data.ts": ic, "./MfDataV/MfHeader2/mfHeader2.data.ts": uc, "./MfDataV/MfHeader3/mfHeader3.data.ts": pc, "./MfDataV/MfHeader4/mfHeader4.data.ts": gc, "./MfDataV/MfHeader5/mfHeader5.data.ts": vc, "./MfDataV/MfHeader6/mfHeader6.data.ts": Mc, "./MfDateTime/mfDateTime.data.ts": Sc, "./MfEcharts/MfBar/mfBar.data.ts": Lc, "./MfEcharts/MfBarHorizontal/mfBarHorizontal.data.ts": Dc, "./MfEcharts/MfBarLine/mfBarLine.data.ts": Rc, "./MfEcharts/MfBarPlusMinus/mfBarPlusMinus.data.ts": Ac, "./MfEcharts/MfBarStack/mfBarStack.data.ts": Nc, "./MfEcharts/MfLine/mfLine.data.ts": jc, "./MfEcharts/MfLineArea/mfLineArea.data.ts": Fc, "./MfEcharts/MfLineAreaStack/mfLineAreaStack.data.ts": Ec, "./MfEcharts/MfLineSmooth/mfLineSmooth.data.ts": Qc, "./MfEcharts/MfLineStack/mfLineStack.data.ts": Uc, "./MfEcharts/MfMapLine/mfMapLine.data.ts": Yc, "./MfEcharts/MfMapLine3D/mfMapLine3D.data.ts": Xc, "./MfEcharts/MfPie/mfPie.data.ts": ed, "./MfEcharts/MfPieCircular/mfPieCircular.data.ts": od, "./MfEcharts/MfPieHalf/mfPieHalf.data.ts": nd, "./MfEcharts/MfPieRose/mfPieRose.data.ts": id, "./MfEcharts/MfRadar/mfRadar.data.ts": ud, "./MfEcharts/MfRadarCircle/mfRadarCircle.data.ts": dd, "./MfEcharts/MfScatter/mfScatter.data.ts": fd, "./MfPicture/mfPicture.data.ts": md, "./MfScrollTable/mfScrollTable.data.ts": Md, "./MfSegmented/mfSegmented.data.ts": Sd, "./MfTag/mfTag.data.ts": ps });
const Id = { ...function() {
  const e2 = {};
  return Object.keys(Ld).forEach((t2) => {
    const o2 = Ld[t2].default;
    e2[o2.type] = o2;
  }), e2;
}() }, Dd = tt();
function Td(e2) {
  let t2, o2;
  return t2 = Nr().getTheme === He.DARK ? "#ffffff" : "#000000", o2 = e2.backgroundImage ? `url(${it(rt(e2.backgroundImage))}) 0% 0% / 100% 100% no-repeat` : e2.backgroundColor ?? "", { width: `${e2.width}px`, height: `${e2.height}px`, background: o2, color: t2 };
}
const Nd = () => {
  const e2 = Ge();
  return { chartContain: { ...Be(Qr), id: e2 }, chart: { ...Be(Hr), id: e2 } };
};
function Bd(e2, t2, o2) {
  const l2 = Be(e2);
  if (!l2.chart.type) return;
  l2.chart.type === es.MfCombine && l2.chart.options.components.forEach((e3) => {
    const t3 = Ge();
    e3.chart.id = t3, e3.chartContain.id = t3;
  });
  const n2 = Ge();
  return e2.chartContain.dropInfo.x = t2, e2.chartContain.dropInfo.y = o2, l2.chart.name = Rd(l2.chart.type, l2.chart.name), l2.chart.id = n2, l2.chartContain.id = n2, l2.chartContain.dropInfo.x = t2, l2.chartContain.dropInfo.y = o2, l2.chartContain.dropInfo.zIndex = 0, l2;
}
function Rd(e2, t2) {
  const o2 = Nr().getChartNameLabel;
  let l2 = t2 || e2;
...
const qd = (e2) => {
  const t2 = Nd();
  t2.chart.type = e2.type, t2.chart.name = Rd(e2.type, e2.name);
  const o2 = Id[e2.type];
...
function Ad(e2, t2 = []) {
  var _a2;
  let o2;
  return o2 = ((_a2 = e2.chartContain.border.color) == null ? void 0 : _a2.startsWith("linear-gradient")) ? { [Pr.borderImage]: `${e2.chartContain.border.color} 1` } : { [Pr.borderColor]: e2.chartContain.border.color }, Od({ ...e2.chartContain.dropInfo, ...o2, [Pr.borderWidth]: e2.chartContain.border.show ? e2.chartContain.border.width : 0, [Pr.borderRadius]: e2.chartContain.border.radius, [Pr.background]: e2.chartContain.background, [Pr.opacity]: e2.chartContain.opacity, padding: e2.chartContain.padding }, t2);
}
function Od(e2, t2 = []) {
...
function jd(e2) {
  const t2 = { ...e2 };
  if (0 !== t2.rotate) {
    const e3 = Math.round(t2.width * Zr(t2.rotate) + t2.height * Wr(t2.rotate)), o2 = (t2.width - e3) / 2;
    t2.x += Math.round(o2), t2.right = t2.x + e3;
    const l2 = Math.round(t2.height * Zr(t2.rotate) + t2.width * Wr(t2.rotate)), n2 = (l2 - t2.height) / 2;
...
async function Fd(e2, t2) {
  ...
  }, { getDataTable: l2 } = ls(), n2 = [], a2 = [], i2 = (e3) => {
    0 === e3.chart.data.type ? n2.push(e3.chart) : a2.push(e3.chart);
  };
  for (const o3 of e2) if (t2 && (o3.chart.isResource = true), i2(o3), o3.chart.type === es.MfCombine) for (const e3 of o3.chart.options.components) t2 && (e3.chart.isResource = true), i2(e3);
  ...
  for (const e3 of a2) e3.data.priority > s2 && (r2.length > 0 && (await Promise.all(r2), r2 = []), s2 = e3.data.priority), o2(e3), r2.push(l2(e3).then((t3) => {
    var _a2;
    e3.type && ((_a2 = Id[e3.type]) == null ? void 0 : _a2.initData(e3, t3));
  }));
  return r2;
}
function Pd(e2) {
...
function Ed(e2, t2) {
  ...
  for (const e3 of o2) {
    if (Pd(e3.chart), e3.chart.type === es.MfCombine) for (const t3 of e3.chart.options.components) Pd(t3.chart);
...
function Hd(e2) {
  if (!Nr().getIsResource) return;
  const t2 = (e3) => {
    delete e3.isResource, 0 === e3.data.type && (e3.data.id = "");
  };
  for (const o2 of e2) if (t2(o2.chart), o2.chart.type === es.MfCombine) for (const e3 of o2.chart.options.components) t2(e3.chart);
}
function Qd(e2) {
  return 0 === e2.data.type ? e2.data.dataSet : e2.data.result;
}
const Gd = Nr(), Ud = (e2) => e2 <= 0, Vd = (e2, t2) => e2 >= t2.length - 1, Wd = (e2, t2, o2) => {
  const l2 = e2[t2];
  e2[t2] = e2[o2], e2[o2] = l2;
}, Zd = Xe("screen-shortcut", { state: () => ({ showMenu: false, copyData: null, alignType: op.GROUP }), getters: { getShowMenu() {
  ...
  var _a2, _b;
  ((_a2 = Gd.getSelectArea) == null ? void 0 : _a2.components.length) > 0 ? this.copyData = Be((_b = Gd.getSelectArea) == null ? void 0 : _b.components) : Gd.getCurComponent && (this.copyData = Be(Gd.getCurComponent));
}, pasteComponent() {
  if (this.copyData) {
    if (Ve(this.copyData)) this.copyData.forEach((e2) => {
      const t2 = Bd(e2, e2.chartContain.dropInfo.x + 10, e2.chartContain.dropInfo.y + 10);
      t2 && Gd.addComponent(t2, 0);
    });
    else {
      const e2 = this.copyData.chartContain.dropInfo.x + 10, t2 = this.copyData.chartContain.dropInfo.y + 10, o2 = Bd(this.copyData, e2, t2);
      o2 && (Gd.addComponent(o2, 0), Gd.setCurComponent(o2, 0));
    }
    Gd.setUndoRedoData("组件复制");
  }
}, moveComponent(e2, t2) {
  Gd.getCurComponent && ("x" === e2 && (Gd.getCurComponent.chartContain.dropInfo.x = Gd.getCurComponent.chartContain.dropInfo.x + t2), "y" === e2 && (Gd.getCurComponent.chartContain.dropInfo.y = Gd.getCurComponent.chartContain.dropInfo.y + t2), t2 >= 10 && Gd.setUndoRedoData("组件移动"));
}, upComponent() {
  Ud(Gd.getCurComponentIndex) || (Wd(Gd.getComponentList, Gd.getCurComponentIndex, Gd.getCurComponentIndex - 1), Gd.setCurComponentIndex(Gd.getCurComponentIndex - 1), Gd.setUndoRedoData("组件上移一层"));
}, downComponent() {
  Vd(Gd.getCurComponentIndex, Gd.getComponentList) || (Wd(Gd.getComponentList, Gd.getCurComponentIndex, Gd.getCurComponentIndex + 1), Gd.setCurComponentIndex(Gd.getCurComponentIndex + 1), Gd.setUndoRedoData("组件下移一层"));
}, topComponent() {
  Gd.getCurComponent && !Ud(Gd.getCurComponentIndex) && (Gd.getComponentList.splice(Gd.getCurComponentIndex, 1), Gd.getComponentList.unshift(Gd.getCurComponent), Gd.setCurComponentIndex(0), Gd.setUndoRedoData("组件置顶"));
}, bottomComponent() {
  Gd.getCurComponent && !Vd(Gd.getCurComponentIndex, Gd.getComponentList) && (Gd.getComponentList.splice(Gd.getCurComponentIndex, 1), Gd.getComponentList.push(Gd.getCurComponent), Gd.setCurComponentIndex(Gd.getComponentList.length - 1), Gd.setUndoRedoData("组件置底"));
}, composeComponent() {
  if (Gd.getSelectArea.components.length <= 1) return;
  const e2 = [];
  Gd.getSelectArea.components.forEach((t2) => {
    var _a2;
    if (t2.chart.type === es.MfCombine) {
      const o2 = { ...t2.chartContain.dropInfo }, l2 = t2.chart.options.components, n2 = (_a2 = Gd.getScreenCanvas) == null ? void 0 : _a2.getBoundingClientRect();
      l2.forEach((e3) => {
        Xd(e3, n2, o2, Gd.getScale);
      }), e2.push(...t2.chart.options.components);
    } else e2.push(t2);
  }), C(() => {
    const t2 = qd({ type: es.MfCombine, name: "组合" });
    null !== t2 && (t2.chartContain.dropInfo = Object.assign(t2.chartContain.dropInfo, Gd.getSelectArea.dropInfo), t2.chart.options.components = e2, Kd(t2), Gd.batchDeleteComponent(Gd.getSelectArea.components), Gd.addComponent(t2, 0), Gd.cleanSelectArea(), Gd.setCurComponent(t2, 0), Gd.setUndoRedoData("组件组合"));
  });
}, decomposeComponent() {
  if (!Gd.getCurComponent) return;
  if (Gd.getCurComponent.chart.type !== es.MfCombine) return;
  Gd.getCurComponent.chartContain.show || (Gd.getCurComponent.chartContain.show = true);
  const e2 = Gd.getCurComponent.chart.options.components, t2 = [];
  for (const o2 of e2) o2.chartContain.show || (o2.chartContain.show = true, t2.push(o2));
  C(() => {
    const o2 = { ...Gd.getCurComponent.chartContain.dropInfo };
    if (!Gd.getScreenCanvas) return;
    const l2 = Gd.getScreenCanvas.getBoundingClientRect(), n2 = Gd.getCurComponentIndex;
    Gd.deleteComponent(n2);
    for (let t3 = e2.length - 1; t3 >= 0; t3--) Xd(e2[t3], l2, o2, Gd.getScale), Gd.addComponent(e2[t3], n2), Gd.getSelectArea.components.push(e2[t3]);
    t2.forEach((e3) => {
      e3.chartContain.show = false;
    }), ep(Gd.getSelectArea.components), Gd.setUndoRedoData("组件拆分");
  });
}, lockComponent() {
  ...
  var _a2, _b;
  ((_a2 = Gd.getSelectArea) == null ? void 0 : _a2.components.length) > 0 && ((_b = Gd.getSelectArea) == null ? void 0 : _b.components.forEach((t2) => {
    t2.chartContain.lock = e2;
  })), Gd.getCurComponent && (Gd.getCurComponent.chartContain.lock = e2), Gd.setUndoRedoData(e2 ? "组件锁定" : "组件解锁");
}, hideComponent() {
  ...
  })), Gd.getCurComponent && (Gd.getCurComponent.chartContain.show = e2), Gd.setUndoRedoData(e2 ? "组件显示" : "组件隐藏");
}, deleteComponent() {
  Gd.deleteComponent(), Gd.setUndoRedoData("组件删除");
}, selectAllComponent() {
  ep(Gd.getComponentList);
}, screenSave() {
  Dd.emit(Fr.SCREEN_SAVE);
}, screenPreview() {
  Dd.emit(Fr.SCREEN_PREVIEW);
} } });
function Yd(e2) {
  return 100 * e2 + "%";
}
function Kd(e2) {
  ...
  e2.chart.options.components.forEach((e3) => {
    e3.chartContain.groupStyle = Ad(e3, [Pr.x, Pr.y]), e3.chartContain.groupStyle.left = Yd((e3.chartContain.dropInfo.x - t2.x) / t2.width), e3.chartContain.groupStyle.top = Yd((e3.chartContain.dropInfo.y - t2.y) / t2.height), e3.chartContain.groupStyle.width = Yd(e3.chartContain.dropInfo.width / t2.width), e3.chartContain.groupStyle.height = Yd(e3.chartContain.dropInfo.height / t2.height);
  });
}
function Xd(e2, t2, o2, l2) {
  ...
  e2.chartContain.dropInfo.rotate = Yr(e2.chartContain.dropInfo.rotate + o2.rotate), e2.chartContain.dropInfo.width = Math.abs(Math.round(Number.parseFloat(e2.chartContain.groupStyle.width) / 100 * o2.width)), e2.chartContain.dropInfo.height = Math.abs(Math.round(Number.parseFloat(e2.chartContain.groupStyle.height) / 100 * o2.height)), e2.chartContain.dropInfo.x = Math.abs(Math.round((i2 - e2.chartContain.dropInfo.width * l2 / 2) / l2)), e2.chartContain.dropInfo.y = Math.abs(Math.round((r2 - e2.chartContain.dropInfo.height * l2 / 2) / l2)), e2.chartContain.groupStyle = {};
}
function Jd(e2) {
  const t2 = Nr(), o2 = [], { x: l2, y: n2 } = e2;
  return t2.getComponentList.forEach((t3) => {
    const { x: a2, y: i2, width: r2, height: s2 } = jd(t3.chartContain.dropInfo);
...
function ep(e2) {
  ...
  e2.forEach((e3) => {
    const t3 = jd(e3.chartContain.dropInfo);
...
function tp(e2) {
  ...
  t2.cleanCurComponent(), t2.setSelectedComponents(e2), t2.getSelectArea.components.length > 1 && ep(t2.getSelectArea.components);
}
var op = ((e2) => (e2.GROUP = "Group", e2.CANVAS = "Canvas", e2))(op || {});
const lp = (e2, t2) => {
  function o2(o3) {
    ...
    }), ep(e2.getSelectArea.components), e2.setUndoRedoData("x" === o3 ? "横向分布" : "纵向分布");
  }
  function l2() {
  ...
  function a2(t3) {
    const o3 = l2();
    n2().forEach((e3) => t3(e3, o3)), ep(e2.getSelectArea.components), e2.setUndoRedoData("对齐");
  }
  function i2() {
  ...
  return (t3, o3) => (s(), r("div", { class: c([d(n2), d(i2).getShowData && d(i2).getShowDataLevel === d(a2) ? "active" : ""]), style: u(e2.highlight ? { border: `1px solid ${d(l2)}` } : "") }, [d(i2).getShowData && d(i2).getShowDataLevel === d(a2) ? (s(), r("div", { key: 0, class: "select", style: u({ backgroundColor: d(l2) }) }, [g(d(Te), { icon: "ant-design:check-outlined", color: "#FFFFFF", size: 14 })], 4)) : f("", true), void 0 !== e2.iconfont ? (s(), h(d(Te), { key: 1, color: d(l2), icon: `iconfont:${e2.iconfont}`, size: 14 }, null, 8, ["color", "icon"])) : f("", true), void 0 !== e2.icon ? (s(), h(d(Te), { key: 2, color: d(l2), icon: e2.icon, size: 14 }, null, 8, ["color", "icon"])) : f("", true), p("div", ap, S(e2.title), 1), e2.allowDelete && !e2.queryMode ? (s(), h(d(J), { key: 3, type: "vertical" })) : f("", true), e2.queryMode ? f("", true) : (s(), h(d(G), { key: 4, title: "删除" }, { default: M(() => [e2.allowDelete ? (s(), h(d(ee), { key: 0, size: "small", type: "link", onClick: v2 }, { icon: M(() => [g(d(ut))]), _: 1 })) : f("", true)]), _: 1 })), p("div", { class: c(["config", e2.full ? "full" : ""]) }, [R(t3.$slots, "config", {}, void 0, true)], 2), g(d(G), { title: "执行" }, { default: M(() => [g(d(ee), { size: "small", type: "link", style: { margin: "6px" }, onMouseenter: o3[0] || (o3[0] = (e3) => m2.value = true), onMouseleave: o3[1] || (o3[1] = (e3) => m2.value = false), onClick: C2 }, { icon: M(() => [!d(i2).getShowData || d(i2).getShowDataLevel !== d(a2) || m2.value ? (s(), h(d(ct), { key: 0 })) : (s(), h(d(dt), { key: 1 }))]), _: 1 })]), _: 1 })], 6));
} }), [["__scopeId", "data-v-c5dcf0b5"]]), rp = Kt(e({ __name: "SelectFields", props: { tableFields: { type: Object, require: true, default: void 0 }, fields: { type: Object, require: true, default: void 0 }, queryMode: { type: Boolean, default: false } }, emits: ["fieldChange"], setup(e2, { emit: t2 }) {
  ...
  return n(() => {
    ...
    e3 && (e3 === f2.getTableName ? (f2.addTableFieldsMap(e3, f2.getTableFields), p2.value = f2.getTableFields) : _r(o2.sqlQuery).then((t3) => {
      f2.addTableFieldsMap(e3, t3), p2.value = t3;
    }));
  }, { immediate: true }), i(() => {
    var _a2, _b;
    ((_a2 = o2.sqlQuery) == null ? void 0 : _a2.sqlQuery) && ((_b = o2.sqlQuery) == null ? void 0 : _b.sourceTable) && _r(o2.sqlQuery).then((e3) => {
  ...
  }), (t3, l3) => (s(), h(ip, { iconfont: "icon-mfish-table", title: "数据源", "allow-delete": false, onExecute: m2, "query-mode": e2.queryMode }, { config: M(() => [g(d(r2), { class: c(d(u2)), compact: "" }, { default: M(() => {
    var _a2, _b;
    return [g(d(a2), { value: (_a2 = e2.sqlQuery) == null ? void 0 : _a2.sourceTable, disabled: "" }, null, 8, ["value"]), g(rp, $(t3.$attrs, { "table-fields": p2.value, fields: (_b = o2.sqlQuery) == null ? void 0 : _b.fields, onFieldChange: v2, "query-mode": e2.queryMode }), null, 16, ["table-fields", "fields", "query-mode"])];
  }), _: 1 }, 8, ["class"])]), _: 1 }, 8, ["query-mode"]));
} }), [["__scopeId", "data-v-5708821c"]]), up = async (e2, t2) => {
  var _a2, _b;
  const o2 = kr(), l2 = [];
  ...
  for (; ; ) return o2.has(t2) ? (t2.endsWith(`_${e2}`) && (t2 = t2.slice(0, Math.max(0, t2.length - `${e2}`.length - 1))), cp(++e2, `${t2}_${e2}`, o2)) : t2;
}, dp = (e2) => {
  var _a2, _b, _c2, _d2;
  ...
  e2 && e2.push(t2);
}, fp = Kt(e({ __name: "ConfigButton", props: { level: { type: Number, default: 1 }, icon: { type: String, default: void 0 }, iconfont: { type: String, default: void 0 }, title: { type: String, default: "按钮" } }, setup(e2) {
  const t2 = e2, { prefixCls: o2 } = we("config-button"), n2 = xe().getThemeColor, a2 = kr(), i2 = l(() => t2.level < a2.getLevel ? 12 : 14);
...
} }), [["__scopeId", "data-v-749209b7"]]), hp = { key: 0, class: "placeholder" }, gp = { class: "condition" }, yp = e({ __name: "TableJoins", props: { sqlQuery: { type: Object, require: true }, level: { type: Number, default: 1 }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["joinChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, i2 = te.Item, C2 = H, { prefixCls: _2 } = we("table-joins"), $2 = kr(), L2 = y([]), I2 = y([]), D2 = y([]), T2 = xe().getThemeColor, N2 = { left: "左联", inner: "内联", right: "右联", full: "全联" }, B2 = l(() => {
    var _a2;
    if (1 === $2.getSourceType || o2.queryMode) return false;
    if (o2.sqlQuery && ((_a2 = o2.sqlQuery) == null ? void 0 : _a2.joins)) {
      for (const e3 of o2.sqlQuery.joins) if (!dp(e3)) return false;
    }
    return Lr(o2.sqlQuery, o2.level);
  });
  n(() => {
    var _a2;
  ...
  function Q2(e3, t3) {
    ...
    const n2 = new Set(l2), a3 = cp(0, t3, n2);
  ...
  function U2() {
    ...
    const e3 = async (e4) => {
      ...
      const t4 = await up(e4, o2.sqlQuery);
  ...
  return (t3, l2) => {
    ...
    return s(), r("div", { class: c(d(_2)) }, [(s(true), r(m, null, v((_a2 = e2.sqlQuery) == null ? void 0 : _a2.joins, (t4, c2) => (s(), h(ip, { iconfont: "icon-mfish-join", title: "关联", key: c2, "query-mode": e2.queryMode, onDeleteConfig: (e3) => function(e4) {
      L2 == null ? void 0 : L2.value.splice(e4, 1), a2("joinChange", [...L2.value]);
    }(c2), onExecute: (e3) => function(e4, t5) {
      Ir(o2.configMitt, { ...o2.sqlQuery, joins: L2.value.slice(0, t5 + 1), aggregates: [], groups: [], customColumns: [], filters: [], orders: [], limit: void 0 }, e4);
    }(e3, c2) }, { config: M(() => {
      var _a3, _b, _c2;
      return [0 === c2 ? (s(), h(d(C2), { key: 0, class: "left-table", value: (_a3 = e2.sqlQuery) == null ? void 0 : _a3.sourceTable, disabled: "" }, null, 8, ["value"])) : (s(), h(d(C2), { key: 1, class: "left-table", value: (_b = t4.condition) == null ? void 0 : _b.field.tableAlias, disabled: "" }, null, 8, ["value"])), g(d(V), { class: "condition", placement: "bottom", arrow: { pointAtCenter: true }, disabled: e2.queryMode }, { overlay: M(() => [g(d(te), { onClick: (e3) => function(e4, t5) {
        ...
        return [g(d(oe), { disabled: e2.queryMode, "show-search": "", "allow-clear": false, class: "input-select", "option-filter-prop": "label", value: [A2(c2) || ""], options: R2.value, onChange: (e3) => function(e4, t5) {
          ...
          Bi({ sourceId: kr().getSourceId, tableName: t5.table, sourceType: 0 }).then((e5) => {
          ...
          }), _: 2 }, 1032, ["title"])) : (s(), r("div", hp, "选择关联表"))];
        }), _: 2 }, 1032, ["disabled", "value", "options", "onChange"]), g(rp, { "query-mode": e2.queryMode, "table-fields": (l3 = t4.table, l3 && $2.getTableFieldsMap.has(l3) ? $2.getTableFieldsMap.get(l3) : []), fields: t4.fields, onFieldChange: (e3) => function(e4, t5) {
          var _a4;
      ...
      }(o3, c2, t4) }, { displayRender: M(({ labels: e3 }) => [g(d(G), { title: j2(c2, e3) }, { default: M(() => [x(S(j2(c2, e3)), 1)]), _: 2 }, 1032, ["title"])]), _: 2 }, 1032, ["disabled", "options", "value", "placeholder", "onChange"]), p("div", gp, [g(d(Te), { icon: "iconfont:icon-mfish-equals", color: d(T2), size: 14 }, null, 8, ["color"])]), g(d(K), { disabled: e2.queryMode, "show-search": "", "allow-clear": false, class: "input-select", "option-filter-prop": "label", value: F2(c2), options: z2(c2), placeholder: `${t4.tableAlias || "关联表"}字段`, onSelect: (e3, o3) => function(e4, t5, o4) {
        o4.condition && (o4.condition.joinedField = e4.realValue, E2(t5));
      }(o3, c2, t4) }, null, 8, ["disabled", "value", "options", "placeholder", "onSelect"])];
    }), _: 2 }, 1032, ["query-mode", "onDeleteConfig", "onExecute"]))), 128)), B2.value ? (s(), h(fp, { key: 0, class: "config-button", title: "关联", iconfont: "icon-mfish-join", level: 0, onClick: P2 })) : f("", true)], 2);
  };
} }), mp = Kt(yp, [["__scopeId", "data-v-d960e99c"]]), vp = e({ __name: "TableLimit", props: { sqlQuery: { type: Object, require: true }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["limitChange"], setup(e2, { emit: t2 }) {
  ...
  function c2(e3) {
    Ir(o2.configMitt, { ...o2.sqlQuery, limit: a2.value }, e3);
  }
  return n(() => {
    var _a2;
    ...
    var _a2;
    return void 0 !== ((_a2 = e2.sqlQuery) == null ? void 0 : _a2.limit) ? (s(), h(ip, { key: 0, "query-mode": e2.queryMode, icon: "ant-design:column-height-outlined", title: "行数", onDeleteConfig: u2, onExecute: c2 }, { config: M(() => [g(d(Q), { disabled: e2.queryMode, "default-value": a2.value, "addon-after": "行", step: "10", onChange: i2, onPressEnter: r2, onBlur: r2 }, null, 8, ["disabled", "default-value"])]), _: 1 }, 8, ["query-mode"])) : f("", true);
  };
} }), Cp = [{ field: "id", label: "唯一ID", component: "Input", show: false }, { field: "name", label: "参数名称", component: "Input", dynamicRules: () => [{ required: true, validator: (e2, t2) => /^[a-z]\w*$/i.test(t2) ? Promise.resolve() : Promise.reject("错误：参数格式不正确！必须字符开头，不允许包含特殊字符!"), trigger: "blur" }] }, { field: "required", label: "是否必须", component: "RadioButtonGroup", defaultValue: 1, componentProps: { options: [{ label: "是", value: 1 }, { label: "否", value: 0 }] }, required: true }, { field: "defaultValue", label: "默认值", component: "Input" }, { field: "remark", label: "参数描述", component: "InputTextArea" }], bp = { name: "ApiParamsModal", components: { BasicModal: yt, BasicForm: Ct }, emits: ["addSuccess", "updateSuccess", "register", "variableChange"], setup(e2, { emit: t2 }) {
  const o2 = y(true), [n2, { resetFields: a2, setFieldsValue: i2, validate: r2 }] = bt({ name: "model_form_item", labelWidth: 100, baseColProps: { span: 24 }, schemas: Cp, showActionButtonGroup: false, autoSubmitOnEnter: true }), s2 = y(), [u2, { setModalProps: c2, closeModal: p2 }] = mt(async (e3) => {
    a2().then(), c2({ confirmLoading: false, width: "600px" }), o2.value = !!(e3 == null ? void 0 : e3.isUpdate), d(o2) && (s2.value = e3.index, i2({ ...e3.param }).then());
  }), f2 = kr(), h2 = l(() => d(o2) ? "编辑参数" : "新增参数"), { createMessage: g2 } = Se();
...
const Mp = Kt(bp, [["render", function(e2, t2, o2, l2, n2, a2) {
...
}]]), kp = { key: 0 }, wp = e({ __name: "FilterVariable", props: { value: { type: String }, queryMode: { type: Boolean, default: false } }, emits: ["variableChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, a2 = K.Option, i2 = xe().getThemeColor, { prefixCls: C2 } = we("filter-variable"), [b2, { openModal: w2 }] = vt(), _2 = kr(), $2 = y();
  n(() => o2.value, (e3) => {
    $2.value = e3;
  }, { immediate: true });
  ...
  }(o4), ["stop"]) }, null, 8, ["color", "onClick"])]))], 2)]), _: 2 }, 1032, ["label", "value"]))), 128))]), _: 1 }, 8, ["value", "disabled"]), g(Mp, { onRegister: d(b2), onAddSuccess: D2, onUpdateSuccess: T2, onVariableChange: B2 }, null, 8, ["onRegister"])], 64));
} }), xp = Kt(wp, [["__scopeId", "data-v-68d91e73"]]), Sp = e({ __name: "TableField", props: { tableFields: { type: Object }, value: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["change"], setup(e2, { emit: t2 }) {
...
} }), _p = e({ __name: "FilterValue", props: { fieldType: { type: String, default: "STRING" }, valueType: { type: String, default: "0" }, operator: { type: String, default: "" }, tableFields: { type: Array, default: () => [] }, queryMode: { type: Boolean, default: false } }, emits: ["typeChange", "variableChange", "fieldChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, a2 = H, i2 = le.Group, u2 = le.Button, p2 = ne.ItemRest, { prefixCls: m2 } = we("filter-value"), v2 = y("0"), C2 = kr();
  function b2() {
  ...
  function S2(e3) {
    var _a2;
    e3 === Xa.isNull || e3 === Xa.isNotNull ? (p2.value = false, n2.value = "") : p2.value = true, "DATE" === ((_a2 = u2.field) == null ? void 0 : _a2.dataType) && (e3 === Xa.between ? n2.value = n2.value ? `${n2.value}`.split(",") : [] : n2.value = n2.value ? `${n2.value}`.split(",")[0] : "");
  }
  async function _2() {
    var _a2, _b, _c2, _d2;
    try {
  ...
  return (t3, o3) => (s(), h(d(yt), $(t3.$attrs, { onRegister: d(C2), title: "设置过滤条件", onOk: _2 }), { default: M(() => [g(d(ne), { ref_key: "formRef", ref: i2, model: n2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: M(() => {
    var _a2;
    return [g(d(l2), { label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: M(() => [g(Sp, { "query-mode": e2.queryMode, "table-fields": r2.value, value: u2.field, onChange: w2 }, null, 8, ["query-mode", "table-fields", "value"])]), _: 1 }), g(d(l2), { label: "条件", name: "operator", rules: [{ required: true, message: "请选择条件！" }] }, { default: M(() => [g(d(K), { disabled: e2.queryMode, "show-search": "", "allow-clear": false, class: "input-select", "option-filter-prop": "label", value: n2.operator, "onUpdate:value": o3[0] || (o3[0] = (e3) => n2.operator = e3), options: c2.value, placeholder: "选择条件", onSelect: S2 }, null, 8, ["disabled", "value", "options"])]), _: 1 }), p2.value ? (s(), h(d(l2), { key: 0, label: "值", name: "value", rules: [{ required: "STRING" !== ((_a2 = u2.field) == null ? void 0 : _a2.dataType), message: "请选择值！" }] }, { default: M(() => {
      var _a3;
      return [g($p, { "query-mode": e2.queryMode, placeholder: "输入值", value: n2.value, "onUpdate:value": o3[1] || (o3[1] = (e3) => n2.value = e3), "value-type": u2.valueType, "field-type": (_a3 = u2.field) == null ? void 0 : _a3.dataType, operator: n2.operator, "table-fields": r2.value, onTypeChange: L2, onVariableChange: I2, onFieldChange: D2 }, null, 8, ["query-mode", "value", "value-type", "field-type", "operator", "table-fields"])];
    }), _: 1 }, 8, ["rules"])) : f("", true)];
  }), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
} }), Ip = e({ __name: "TableFilter", props: { sqlQuery: { type: Object }, level: { type: Number, default: 1 }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["filterChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, i2 = y([]), u2 = l(() => {
    var _a2;
    return void 0 === ((_a2 = o2.sqlQuery) == null ? void 0 : _a2.filters) && Lr(o2.sqlQuery, o2.level) && !o2.queryMode;
  });
  n(() => {
    var _a2;
  ...
  const c2 = xe().getThemeColor, p2 = y([{ name: "添加", icon: "icon-mfish-left-bracket", color: c2, value: { type: "0", name: "(", value: "(" } }, { name: "添加", icon: "icon-mfish-right-bracket", color: c2, value: { type: "0", name: ")", value: ")" } }]), m2 = { type: "0", slot: true, hideClose: true, value: "and" }, [v2, { openModal: C2 }] = vt();
  function b2() {
    a2("filterChange");
  }
  function w2() {
  ...
  function I2(e3) {
    Ir(o2.configMitt, { ...o2.sqlQuery, filters: i2.value, aggregates: [], groups: [], customColumns: [], orders: [], limit: void 0 }, e3);
  }
  return (t3, o3) => {
    var _a2;
    return s(), r("div", null, [void 0 !== ((_a2 = e2.sqlQuery) == null ? void 0 : _a2.filters) ? (s(), h(ip, { key: 0, "query-mode": e2.queryMode, icon: "ant-design:filter-outlined", title: "过滤", onDeleteConfig: b2, full: true, onExecute: I2 }, { config: M(() => [g(d(gt), { "query-mode": e2.queryMode, items: i2.value, menus: p2.value, "add-title": "添加过滤条件", onAddBlock: x2, onEditBlock: S2, onCloseBlock: $2, onDragChange: L2 }, { tag: M(({ index: t4, element: o4 }) => [g(d(re), { disabled: e2.queryMode, style: { "margin-right": "8px" }, checked: o4 == null ? void 0 : o4.value, "checked-children": "且", "un-checked-children": "或", "checked-value": "and", "un-checked-value": "or", size: "small", onChange: (e3) => function(e4, t5) {
      var _a3;
      i2.value && ((_a3 = i2.value) == null ? void 0 : _a3.length) > t5 && (i2.value[t5].value = e4, setTimeout(() => {
        i2.value && a2("filterChange", [...i2.value]);
      }, 300));
    }(e3, t4) }, null, 8, ["disabled", "checked", "onChange"])]), _: 1 }, 8, ["query-mode", "items", "menus"])]), _: 1 }, 8, ["query-mode"])) : f("", true), u2.value ? (s(), h(fp, { key: 1, class: "config-button", title: "过滤", icon: "ant-design:filter-outlined", level: 0, onClick: k(w2, ["prevent"]) })) : f("", true), g(Lp, { "query-mode": e2.queryMode, onRegister: d(v2), onSubmit: _2 }, null, 8, ["query-mode", "onRegister"])]);
  };
} }), Dp = e({ __name: "AggregateModal", props: { queryMode: { type: Boolean, default: false } }, emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = t2, l2 = ne.Item, n2 = a({ field: void 0, aggFunc: "" }), i2 = y(), r2 = y([]), u2 = a({ field: { dataType: "STRING" } }), c2 = Object.keys(Ja).map((e3) => ({ value: e3, label: Ja[e3] })), p2 = y(true), m2 = y(), [v2, { setModalProps: C2, closeModal: b2 }] = mt(async (e3) => {
    if (C2({ confirmLoading: false, width: "600px" }), up(void 0, e3.sqlQuery).then((e4) => {
      var _a2, _b;
      ...
      r2.value = e4;
    }), e3.isUpdate) return n2.field = [e3.field.tableAlias, e3.field.colName], n2.aggFunc = e3.aggFunc, u2.field = e3.field, p2.value = Ja[n2.aggFunc] !== Ja.count, void (m2.value = e3.index);
  ...
  function w2(e3) {
    p2.value = Ja[e3] !== Ja.count;
  }
  async function x2() {
    var _a2, _b;
    try {
      const e3 = await ((_a2 = i2.value) == null ? void 0 : _a2.validateFields());
      b2(), o2("submit", m2.value, { ...u2, name: Ja[n2.aggFunc] + (Ja[n2.aggFunc] === Ja.count ? "" : `(${(_b = u2.field) == null ? void 0 : _b.colName})`), aggFunc: e3.aggFunc });
    } catch (e3) {
    }
  }
  return (t3, o3) => (s(), h(d(yt), $(t3.$attrs, { onRegister: d(v2), title: "选择聚合字段", onOk: x2 }), { default: M(() => [g(d(ne), { ref_key: "formRef", ref: i2, model: n2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: M(() => [g(d(l2), { label: "聚合方式", name: "aggFunc", rules: [{ required: true, message: "请选择聚合方式！" }] }, { default: M(() => [g(d(K), { disabled: e2.queryMode, "show-search": "", "allow-clear": false, "option-filter-prop": "label", value: n2.aggFunc, "onUpdate:value": o3[0] || (o3[0] = (e3) => n2.aggFunc = e3), options: d(c2), placeholder: "选择聚合方式", onSelect: w2 }, null, 8, ["disabled", "value", "options"])]), _: 1 }), p2.value ? (s(), h(d(l2), { key: 0, label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: M(() => [g(Sp, { "query-mode": e2.queryMode, "table-fields": r2.value, value: u2.field, onChange: k2 }, null, 8, ["query-mode", "table-fields", "value"])]), _: 1 })) : f("", true)]), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
} }), Tp = e({ __name: "GroupModal", props: { queryMode: { type: Boolean, default: false } }, emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = t2, l2 = ne.Item, n2 = a({ field: void 0 }), i2 = a({ field: { dataType: "STRING" } }), r2 = y(), u2 = y([]), c2 = y(), [p2, { setModalProps: f2, closeModal: m2 }] = mt(async (e3) => {
    if (f2({ confirmLoading: false, width: "600px" }), up(void 0, e3.sqlQuery).then((e4) => {
      u2.value = e4;
  ...
  return (t3, o3) => (s(), h(d(yt), $(t3.$attrs, { onRegister: d(p2), title: "选择分组字段", onOk: C2 }), { default: M(() => [g(d(ne), { ref_key: "formRef", ref: r2, model: n2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: M(() => [g(d(l2), { label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: M(() => [g(Sp, { "query-mode": e2.queryMode, "table-fields": u2.value, value: i2.field, onChange: v2 }, null, 8, ["query-mode", "table-fields", "value"])]), _: 1 })]), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
} }), Np = e({ __name: "TableAggregate", props: { sqlQuery: { type: Object }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["aggregateChange", "groupChange", "deleteAggregate"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, a2 = xe().getThemeColor, { prefixCls: i2 } = we("table-aggregate"), u2 = y(), m2 = y(), [v2, { openModal: C2 }] = vt(), [b2, { openModal: k2 }] = vt();
  async function w2() {
    l2("deleteAggregate");
  }
  function x2() {
  ...
  function N2(e3) {
    Ir(o2.configMitt, { ...o2.sqlQuery, aggregates: u2.value, groups: m2.value, orders: [], limit: void 0 }, e3);
  }
  return n(() => {
    var _a2;
    ...
    var _a2;
    return s(), r("div", { class: c(d(i2)) }, [void 0 !== ((_a2 = e2.sqlQuery) == null ? void 0 : _a2.aggregates) ? (s(), h(ip, { key: 0, "query-mode": e2.queryMode, iconfont: "icon-mfish-sum", title: "聚合", onDeleteConfig: w2, onExecute: N2, full: true }, { config: M(() => [g(d(gt), { "query-mode": e2.queryMode, items: u2.value, "add-title": "添加聚合指标", onAddBlock: x2, onEditBlock: _2, onDragChange: $2 }, null, 8, ["query-mode", "items"]), g(d(Te), { class: "groupIcon", icon: "ant-design:group-outlined", color: d(a2), style: { "font-size": "14px" } }, null, 8, ["color"]), o3[0] || (o3[0] = p("div", { class: "group" }, "分组", -1)), g(d(gt), { "query-mode": e2.queryMode, items: m2.value, "add-title": "添加分组指标", onAddBlock: L2, onEditBlock: D2, onDragChange: T2 }, null, 8, ["query-mode", "items"])]), _: 1 }, 8, ["query-mode"])) : f("", true), g(Dp, { "query-mode": e2.queryMode, onRegister: d(v2), onSubmit: S2 }, null, 8, ["query-mode", "onRegister"]), g(Tp, { "query-mode": e2.queryMode, onRegister: d(b2), onSubmit: I2 }, null, 8, ["query-mode", "onRegister"])], 2);
  };
} }), Bp = Kt(Np, [["__scopeId", "data-v-a3fb541b"]]), Rp = "其他", qp = e({ __name: "OrderModal", emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = t2, l2 = ne.Item, n2 = a({ field: void 0 }), i2 = a({ field: { dataType: "STRING" }, order: "ASC" }), r2 = y(), u2 = y([]), c2 = y(), p2 = kr(), [f2, { setModalProps: m2, closeModal: v2 }] = mt(async (e3) => {
    if (m2({ confirmLoading: false, width: "600px" }), $r(e3.sqlQuery) ? Ni({ sourceId: p2.getSourceId, sourceType: p2.getSourceType, sqlQuery: e3.sqlQuery }).then((e4) => {
      u2.value = [{ value: Rp, label: Rp, realValue: Rp, children: e4.map((e5) => ({ value: e5.colName, label: e5.colName + (e5.comment ? `[${e5.comment}]` : ""), realValue: { ...e5 } })) }];
    }) : u2.value = await up(void 0, e3.sqlQuery), e3.isUpdate) return n2.field = [e3.field.tableAlias, e3.field.colName], i2.field = e3.field, void (c2.value = e3.index);
    n2.field = [], c2.value = void 0, i2.field = {};
  });
  function C2(e3) {
    e3.tableAlias && e3.colName && (n2.field = [e3.tableAlias, e3.colName], i2.field = e3);
  ...
  async function b2() {
    var _a2, _b;
    try {
      await ((_a2 = r2.value) == null ? void 0 : _a2.validateFields()), v2(), i2.field.tableAlias === Rp && (i2.field.tableAlias = ""), o2("submit", c2.value, { ...i2, name: (_b = i2.field) == null ? void 0 : _b.colName });
    } catch (e3) {
    }
  }
  return (e3, t3) => (s(), h(d(yt), $(e3.$attrs, { onRegister: d(f2), title: "选择排序字段", onOk: b2 }), { default: M(() => [g(d(ne), { ref_key: "formRef", ref: r2, model: n2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: M(() => [g(d(l2), { label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: M(() => [g(Sp, { "table-fields": u2.value, value: i2.field, onChange: C2 }, null, 8, ["table-fields", "value"])]), _: 1 })]), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
} }), Ap = e({ __name: "TableOrder", props: { sqlQuery: { type: Object, default: void 0 }, configMitt: { type: Object, default: void 0 }, queryMode: { type: Boolean, default: false } }, emits: ["orderChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, a2 = y([]), [i2, { openModal: u2 }] = vt();
  function c2() {
  ...
  function b2(e3) {
    Ir(o2.configMitt, { ...o2.sqlQuery, orders: a2.value, limit: void 0 }, e3);
  }
  return n(() => {
    var _a2;
    ...
    var _a2;
    return s(), r("div", null, [void 0 !== ((_a2 = e2.sqlQuery) == null ? void 0 : _a2.orders) ? (s(), h(ip, { key: 0, "query-mode": e2.queryMode, icon: "ant-design:sort-ascending-outlined", title: "排序", onDeleteConfig: v2, full: true, onExecute: b2 }, { config: M(() => [g(d(gt), { "query-mode": e2.queryMode, items: a2.value, "add-title": "添加排序指标", onAddBlock: c2, onEditBlock: p2, onDragChange: m2 }, { tagIcon: M(({ element: e3 }) => [g(d(Te), { style: { "font-weight": "bold", "font-size": "20px" }, icon: "ASC" === e3.order ? "ant-design:sort-descending-outlined" : "ant-design:sort-ascending-outlined" }, null, 8, ["icon"])]), _: 1 }, 8, ["query-mode", "items"])]), _: 1 }, 8, ["query-mode"])) : f("", true), g(qp, { onRegister: d(i2), onSubmit: C2 }, null, 8, ["onRegister"])]);
  };
} }), Op = e({ __name: "FieldColModal", emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = t2, l2 = ne.Item, n2 = a({ field: void 0 }), i2 = y(), r2 = y(), u2 = y([]), c2 = y(), [p2, { setModalProps: f2, closeModal: m2 }] = mt(async (e3) => {
    if (f2({ confirmLoading: false, width: "600px" }), up(void 0, e3.sqlQuery).then((e4) => {
      u2.value = e4;
    }), e3.isUpdate) {
  ...
  async function C2() {
    var _a2, _b;
    try {
      await ((_a2 = r2.value) == null ? void 0 : _a2.validateFields()), m2(), o2("submit", c2.value, { type: ei.field, value: i2.value, name: (_b = i2.value) == null ? void 0 : _b.colName });
    } catch (e3) {
    }
  }
  return (e3, t3) => (s(), h(d(yt), $(e3.$attrs, { onRegister: d(p2), title: "选择字段", onOk: C2 }), { default: M(() => [g(d(ne), { ref_key: "formRef", ref: r2, model: n2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: M(() => [g(d(l2), { label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: M(() => [g(Sp, { "table-fields": u2.value, value: i2.value, onChange: v2 }, null, 8, ["table-fields", "value"])]), _: 1 })]), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
} }), jp = ["onClick"], zp = ["onClick"], Fp = e({ __name: "FormulaManagement", props: { isShow: { type: Boolean, default: false }, curKey: { type: String, default: "" } }, emits: ["select"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, i2 = se.Item, C2 = ue.Item, b2 = y([]), { prefixCls: k2 } = we("formula-management"), w2 = y(null), _2 = xe().getThemeColor, $2 = y([]), L2 = y(false), I2 = y([]), D2 = y(), T2 = y(0.4), B2 = y([]), R2 = y(), q2 = l(() => {
    var _a2, _b;
  ...
  function A2(e3, t3) {
    const o3 = [];
    t3 ? o3.push({ icon: t3.icon, title: t3.name, key: t3.key }) : b2.value = e3 ? e3.children : [], e3 && o3.push({ icon: e3.icon, title: e3.name, key: e3.key }), R2.value = o3, D2.value = e3, a2("select", e3);
  }
  function O2(e3, t3) {
    var _a2, _b;
  ...
  return N(async () => {
  ...
  }), (e3, t3) => (s(), h(d(kt), { "default-size": T2.value, min: 0.1, max: 0.5, class: c(d(k2)) }, { 1: M(() => [g(d(Mt), { title: "", toolbar: "", search: "", ref_key: "asyncTreeRef", ref: w2, "tree-wrapper-class-name": "h-[calc(100%-35px)] overflow-auto", "selected-keys": $2.value, "onUpdate:selectedKeys": t3[0] || (t3[0] = (e4) => $2.value = e4), "tree-data": B2.value || [], onSelect: O2 }, null, 8, ["selected-keys", "tree-data"])]), 2: M(() => [p("div", { class: c(`${d(k2)}-right h-full pt-2`) }, [g(d(se), { separator: ">", class: "breadcrumb" }, { default: M(() => [(s(true), r(m, null, v(R2.value, (e4, t4) => (s(), h(d(i2), { key: t4 }, { default: M(() => [g(d(Te), { icon: e4.icon }, null, 8, ["icon"]), p("a", { onClick: (t5) => j2(e4.key), class: "fw-bold text-decoration-none" }, S(e4.title), 9, jp)]), _: 2 }, 1024))), 128))]), _: 1 }), D2.value && "" === D2.value.parentId ? (s(), h(d(ht), { key: 0 }, { default: M(() => [g(d(ce), { class: "ml-6" }, { default: M(() => [(s(true), r(m, null, v(z2.value, (e4, t4) => (s(), h(d(de), { span: 22, key: t4, class: c(`${d(k2)}-card`) }, { default: M(() => {
    var _a2, _b;
    ...
    }), _: 2 }, 1032, ["title"])], 2)], 10, zp)];
  }), _: 2 }, 1032, ["class"]))), 128))]), _: 1 })]), _: 1 })) : f("", true), D2.value && D2.value.formulaInfo ? (s(), h(d(ht), { key: 1 }, { default: M(() => [g(d(ue), { class: "pt-3 pr-2", column: 1, bordered: true }, { default: M(() => [g(d(C2), { label: "描述" }, { default: M(() => {
    var _a2;
...
} }), Pp = Kt(Fp, [["__scopeId", "data-v-6dc5ed8e"]]), Ep = { key: 0, class: "content" }, Hp = { key: 1, class: "content placeholder" }, Qp = Kt(e({ __name: "FormulaSelect", props: { formulaKey: { type: String, default: "" }, queryMode: { type: Boolean, default: false } }, emits: ["formulaChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, i2 = l(() => xe().getDarkMode.value === He.DARK), { prefixCls: u2 } = we("select-formula"), f2 = y(false);
  let m2;
  const { createMessage: v2 } = Se(), C2 = kr(), k2 = y(), w2 = (e3) => {
    f2.value = e3;
  };
  function _2() {
  ...
  return n(() => o2.formulaKey, (e3) => {
    ...
    var _a2;
    return [g(Pp, { style: { height: "350px" }, "is-show": f2.value, "cur-key": (_a2 = k2.value) == null ? void 0 : _a2.key, onSelect: L2 }, null, 8, ["is-show", "cur-key"]), p("div", { class: c(`${d(u2)}-ok-button`) }, [g(d(ee), { class: "mr-2", onClick: _2 }, { default: M(() => o3[0] || (o3[0] = [x("清空")])), _: 1 }), g(d(ee), { type: "primary", onClick: $2 }, { default: M(() => o3[1] || (o3[1] = [x("确定")])), _: 1 })], 2)];
  }), _: 1 })]), _: 1 })]), default: M(() => [g(d(ee), { class: c(`${d(u2)}-drop-button`) }, { default: M(() => {
    var _a2, _b;
    return [((_a2 = k2.value) == null ? void 0 : _a2.cnName) ? (s(), r("span", Ep, S((_b = k2.value) == null ? void 0 : _b.cnName), 1)) : (s(), r("span", Hp, "选择公式")), g(d(Te), { size: 12, icon: f2.value ? "ant-design:up-outlined" : "ant-design:down-outlined", color: i2.value ? "rgba(255, 255, 255, 0.25)" : "rgba(0, 0, 0, 0.25)" }, null, 8, ["icon", "color"])];
  }), _: 1 }, 8, ["class"])]), _: 1 }, 8, ["disabled", "open"]));
} }), [["__scopeId", "data-v-4015d717"]]), Gp = "displayName", Up = { config: { type: Object, default: () => ({ type: ei.param, value: "" }) }, comType: { type: String, default: "string" }, paramType: { type: String, default: "string" }, paramValue: { type: String, default: "" }, showRadio: { type: Boolean, default: true }, sqlQuery: { type: Object }, index: { type: Number, default: 0 }, queryMode: { type: Boolean, default: false } }, Vp = (e2) => {
  if (!e2) return { type: ei.formula, value: null };
  const t2 = ((e2 == null ? void 0 : e2.targetParam) ? JSON.parse(e2.targetParam) : []).map((e3) => e3.paramType.startsWith("list") ? { type: ei.param, value: [{ type: ei.param, value: "" }] } : { type: ei.param, value: "" });
  return { type: ei.formula, value: { key: e2.key, cnName: e2.cnName, enName: e2.enName, targetObject: e2.targetObject, param: t2 } };
}, Wp = e({ __name: "FormulaCompact", props: Up, emits: ["typeChange", "formulaSelect", "inputChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, { prefixCls: a2 } = we("formula-compact"), i2 = le.Group, u2 = le.Button, m2 = y("string"), v2 = y("string"), C2 = y(), b2 = y(ei.param), k2 = y(), w2 = y([]), x2 = y(), S2 = y(false), _2 = y([]), $2 = y();
  function L2(e3) {
    l2("formulaSelect", e3 || "");
  }
  function I2() {
  ...
  function D2(e3) {
    e3.tableAlias && e3.colName && (x2.value = e3, l2("inputChange", { ...e3, [Gp]: "colName" }));
  }
  function T2(e3, t3) {
  ...
  return n(() => o2.config, (e3) => {
    var _a2;
    e3 && (b2.value = e3.type, e3.type === ei.formula ? k2.value = (_a2 = e3.value) == null ? void 0 : _a2.key : C2.value = e3.value);
    ...
    var _a2;
    if (e3 === ei.param && "list" === m2.value) {
      const e4 = /@\{(?<value>.*?)\}/u, t3 = (_a2 = o2.paramValue) == null ? void 0 : _a2.replace(e4, "$<value>");
      S2.value = "fieldName" === t3, S2.value && o2.sqlQuery ? up(void 0, o2.sqlQuery).then((e5) => {
        ...
        if (_2.value = [], e5 && e5.value) {
          ...
          e5.value.forEach((e6) => {
            const o3 = e6[t4];
            _2.value.push({ label: o3, value: o3, realValue: { ...e6, [Gp]: t4 } });
          }), ((_a3 = o2.config) == null ? void 0 : _a3.value) && ($2.value = o2.config.value[o2.config.value[Gp]]);
        }
      });
    }
  }, { immediate: true }), (e3, t3) => (s(), r("div", { class: c(d(a2)) }, [o2.showRadio ? (s(), h(d(i2), { key: 0, disabled: o2.queryMode, class: "radio-group", value: b2.value, "onUpdate:value": t3[0] || (t3[0] = (e4) => b2.value = e4), "button-style": "solid", onChange: N2 }, { default: M(() => ["number" === v2.value ? (s(), h(d(u2), { key: 0, value: d(ei).param }, { default: M(() => [g(d(G), { placement: "left", title: "数字" }, { default: M(() => [g(d(Te), { icon: "ant-design:field-number-outlined" })]), _: 1 })]), _: 1 }, 8, ["value"])) : (s(), h(d(u2), { key: 1, value: d(ei).param }, { default: M(() => [g(d(G), { placement: "left", title: "字符" }, { default: M(() => [g(d(Te), { icon: "ant-design:field-string-outlined" })]), _: 1 })]), _: 1 }, 8, ["value"])), g(d(u2), { value: d(ei).formula }, { default: M(() => [g(d(G), { placement: "left", title: "公式" }, { default: M(() => [g(d(Te), { icon: "ant-design:function-outlined" })]), _: 1 })]), _: 1 }, 8, ["value"])]), _: 1 }, 8, ["disabled", "value"])) : f("", true), p("div", { class: c(o2.showRadio ? "formula-select" : "formula-select-show") }, [b2.value === d(ei).param && "string" === m2.value ? (s(), h(d(H), { key: 0, disabled: o2.queryMode, value: C2.value, "onUpdate:value": t3[1] || (t3[1] = (e4) => C2.value = e4), class: "input-com", placeholder: "请输入字符常量", onChange: I2 }, null, 8, ["disabled", "value"])) : b2.value === d(ei).param && "number" === m2.value ? (s(), h(d(Q), { key: 1, disabled: o2.queryMode, value: C2.value, "onUpdate:value": t3[2] || (t3[2] = (e4) => C2.value = e4), class: "input-com", placeholder: "请输入数字常量", onChange: I2 }, null, 8, ["disabled", "value"])) : b2.value === d(ei).param && "list" === m2.value && S2.value ? (s(), h(Sp, { key: 2, "query-mode": o2.queryMode, class: "select-com", "table-fields": w2.value, value: x2.value, onChange: D2 }, null, 8, ["query-mode", "table-fields", "value"])) : b2.value !== d(ei).param || "list" !== m2.value || S2.value ? (s(), h(Qp, { key: 4, "query-mode": o2.queryMode, "formula-key": k2.value, onFormulaChange: L2 }, null, 8, ["query-mode", "formula-key"])) : (s(), h(d(K), { key: 3, disabled: o2.queryMode, class: "select-com", value: $2.value, "onUpdate:value": t3[3] || (t3[3] = (e4) => $2.value = e4), options: _2.value, placeholder: "请选择参数", onSelect: T2 }, null, 8, ["disabled", "value", "options"]))], 2)], 2));
} }), Zp = Kt(Wp, [["__scopeId", "data-v-8048866c"]]), Yp = { style: { "margin-top": "6px", display: "flex", "justify-content": "flex-end" } }, Kp = e({ __name: "FormulaAround", emits: ["submit"], setup(e2, { emit: t2 }) {
  ...
  return (e3, t3) => (s(), h(d(V), { trigger: ["click"], open: a2.value, placement: "bottom", arrow: { pointAtCenter: true }, onOpenChange: u2 }, { overlay: M(() => [g(d(te), null, { default: M(() => [g(d(te).Item, { disabled: "", style: { padding: "0", cursor: "default" } }, { default: M(() => [g(d(pe), { title: "上层公式设置", bordered: false, style: { width: "240px" } }, { default: M(() => [g(Qp, { onFormulaChange: c2 }), g(d(K), { style: { width: "100%", "margin-top": "6px" }, placeholder: "选择作为哪个参数", class: "select-com", value: n2.value, "onUpdate:value": t3[0] || (t3[0] = (e4) => n2.value = e4), options: l2.value }, null, 8, ["value", "options"]), p("div", Yp, [g(d(ee), { size: "small", onClick: f2 }, { default: M(() => t3[1] || (t3[1] = [x(" 取消")])), _: 1 }), g(d(ee), { size: "small", type: "primary", style: { "margin-left": "6px" }, onClick: m2 }, { default: M(() => t3[2] || (t3[2] = [x(" 确定")])), _: 1 })])]), _: 1 })]), _: 1 })]), _: 1 })]), default: M(() => [g(d(ee), { style: { "margin-top": "-6px" }, size: "small", type: "link" }, { icon: M(() => [g(d(G), { placement: "left", title: "添加外层公式，当前层作为公式参数" }, { default: M(() => [g(d(Te), { icon: "ant-design:node-collapse-outlined" })]), _: 1 })]), _: 1 })]), _: 1 }, 8, ["open"]));
} }), Xp = { class: "formula" }, Jp = { class: "title" }, ef = { key: 0, class: "add" }, tf = e({ __name: "FormulaConfig", props: Up, emits: ["formulaChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, i2 = y(), u2 = y(), { prefixCls: C2 } = we("formula-config"), b2 = kr(), k2 = y(), _2 = a({ type: ei.param, value: "" }), $2 = y(0), L2 = (e3) => e3.startsWith("list"), I2 = (e3) => {
    var _a2, _b;
  ...
  function N2(e3) {
    T2(e3), k2.value = Vp(e3), $2.value++, l2("formulaChange", k2.value);
  }
  function B2(e3) {
  ...
  return n(() => o2.config, (e3) => {
    e3 && (k2.value = e3, function() {
      var _a2, _b, _c2;
      if (((_a2 = k2.value) == null ? void 0 : _a2.type) === ei.formula) {
    ...
    return s(), r("div", { class: c(d(C2)) }, [p("div", Xp, [g(Zp, { "query-mode": o2.queryMode, class: "main", index: o2.index, "com-type": o2.comType, "param-type": o2.paramType, "param-value": o2.paramValue, config: k2.value, "sql-query": o2.sqlQuery, "show-radio": o2.showRadio, onInputChange: D2, onFormulaSelect: N2, onTypeChange: B2 }, null, 8, ["query-mode", "index", "com-type", "param-type", "param-value", "config", "sql-query", "show-radio"]), ((_a2 = k2.value) == null ? void 0 : _a2.type) !== d(ei).formula || o2.queryMode ? f("", true) : (s(), h(Kp, { key: 0, onSubmit: R2 }))]), (s(true), r(m, null, v(i2.value, (e4, a2) => (s(), r("div", { key: `${$2.value}${a2}` }, [(s(true), r(m, null, v(I2(a2), (t4, i3) => {
      var _a3, _b, _c2, _d2, _e2, _f2, _g, _h2, _i2, _j;
      return s(), r("div", { class: "param", key: i3 }, [g(d(Te), { class: "icon", icon: "ant-design:arrow-up-outlined" }), p("span", Jp, [g(d(G), { placement: "left", title: u2.value ? u2.value[a2] : "" }, { default: M(() => [x(S(e4.name), 1)]), _: 2 }, 1032, ["title"])]), g(n2, { "query-mode": o2.queryMode, index: i3, "com-type": e4.comType, "param-type": e4.paramType, "param-value": e4.value, config: L2(e4.paramType) && ((_b = (_a3 = k2.value) == null ? void 0 : _a3.value) == null ? void 0 : _b.param) && ((_e2 = (_d2 = (_c2 = k2.value) == null ? void 0 : _c2.value) == null ? void 0 : _d2.param[a2]) == null ? void 0 : _e2.value) ? (_h2 = (_g = (_f2 = k2.value) == null ? void 0 : _f2.value) == null ? void 0 : _g.param[a2]) == null ? void 0 : _h2.value[i3] : (_j = (_i2 = k2.value) == null ? void 0 : _i2.value) == null ? void 0 : _j.param[a2], "sql-query": o2.sqlQuery, onFormulaChange: (t5) => function(e5, t6, o3, n3) {
        var _a4;
        ((_a4 = k2.value) == null ? void 0 : _a4.type) === ei.formula && k2.value.value && k2.value.value.param && (L2(o3) ? k2.value.value.param[t6].value ? k2.value.value.param[t6].value[n3] = e5 : k2.value.value.param[t6].value = [e5] : k2.value.value.param[t6] = e5), l2("formulaChange", k2.value);
        ...
        var _a4;
        ((_a4 = k2.value) == null ? void 0 : _a4.type) === ei.formula && k2.value.value && k2.value.value.param && (k2.value.value.param[e6].value.splice(t5, 1), $2.value++, l2("formulaChange", k2.value));
      }(a2, i3) }, { icon: M(() => [g(d(Te), { icon: "ant-design:delete-outlined" })]), _: 2 }, 1032, ["onClick"])) : f("", true)]);
    }), 128)), L2(e4.paramType) ? (s(), r("div", ef, [g(d(ee), { type: "primary", onClick: (e5) => function(e6) {
      k2.value && (k2.value.value.param[e6].value ? k2.value.value.param[e6].value.push({ type: ei.param, value: "" }) : k2.value.value.param[e6].value = [{ type: ei.param, value: "" }]);
    }(a2) }, { default: M(() => t3[0] || (t3[0] = [x("增加参数")])), _: 2 }, 1032, ["onClick"])])) : f("", true)]))), 128))], 2);
  };
} }), of = Kt(tf, [["__scopeId", "data-v-aad21227"]]), lf = e({ __name: "ParamsModal", emits: ["register", "submit"], setup(e2, { emit: t2 }) {
  const o2 = t2, [l2, { resetFields: n2, setFieldsValue: a2, validate: i2, resetSchema: r2 }] = bt({ name: "model_form_item", labelWidth: 180, baseColProps: { span: 24 }, showActionButtonGroup: false, autoSubmitOnEnter: true }), u2 = kr(), c2 = y(), [p2, { setModalProps: f2, closeModal: m2 }] = mt(async (e3) => {
  ...
  return (e3, t3) => (s(), h(d(yt), $(e3.$attrs, { onRegister: d(p2), title: "输入参数值", onOk: v2 }), { default: M(() => [g(d(Ct), { onRegister: d(l2), onSubmit: v2 }, null, 8, ["onRegister"])]), _: 1 }, 16, ["onRegister"]));
} }), nf = e({ __name: "FormulaTest", props: { open: { type: Boolean, default: false }, curQuery: { type: Object }, curParams: { type: Object } }, emits: ["close"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, a2 = xe().getThemeColor, i2 = kr(), c2 = y(false);
  n(() => o2.open, (e3) => {
    c2.value = e3, e3 && p2();
  });
  const p2 = Ie((e3) => {
    let t3 = 1, l3 = 10;
    e3 && (t3 = e3.current, l3 = e3.pageSize), Ti({ sourceId: i2.getSourceId, sourceType: i2.getSourceType, sqlQuery: o2.curQuery || {}, params: o2.curParams }, { pageNum: t3, pageSize: l3 }).then((e4) => {
  ...
  }, 200), [m2, { setColumns: v2, setTableData: C2, setPagination: b2 }] = wt({ bordered: true, showIndexColumn: false, isCanResizeParent: true, canResize: true, onChange: p2 }), k2 = () => {
    c2.value = false, l2("close", true);
  };
  return (e3, t3) => (s(), h(d(fe), { title: "测试结果", placement: "bottom", open: c2.value, onClose: k2, height: 450 }, { default: M(() => [g(d(xt), { onRegister: d(m2) }, { bodyCell: M(({ column: e4, record: t4 }) => [(e4 == null ? void 0 : e4.key) === d(xr) ? (s(), r("div", { key: 0, style: u({ color: d(a2) }) }, S(t4[d(xr)]), 5)) : f("", true)]), _: 1 }, 8, ["onRegister"])]), _: 1 }, 8, ["open"]));
} }), af = e({ __name: "FormulaColModal", props: { queryMode: { type: Boolean, default: false } }, emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = t2, l2 = y(), n2 = y(), i2 = y(), u2 = a({ type: ei.formula, value: null });
  let c2;
  const p2 = y(0), v2 = kr(), [C2, { openModal: b2 }] = vt(), k2 = y(), w2 = y(), S2 = y(false), _2 = (e3) => {
    let t3 = "";
    return Array.isArray(e3.value) ? (e3.value.forEach((e4) => {
      t3 += `${_2(e4)},`;
    }), t3.endsWith(",") ? t3 = t3.slice(0, Math.max(0, t3.lastIndexOf(","))) : t3) : e3.type === ei.formula && e3.value ? (t3 = `${e3.value.cnName}(`, e3.value.param.forEach((e4) => {
      t3 += `${_2(e4)},`;
    }), t3.endsWith(",") && (t3 = t3.slice(0, Math.max(0, t3.lastIndexOf(",")))), t3 += ")", t3) : (e3.type === ei.param && (t3 += e3.value instanceof Object ? e3.value[e3.value[Gp]] : e3.value), t3);
  }, [L2, { setModalProps: I2, closeModal: D2 }] = mt(async (e3) => {
  ...
  function B2() {
    k2.value = { schema: c2.schema, sourceTable: c2.sourceTable, joins: c2.joins, sqlQuery: c2 == null ? void 0 : c2.sqlQuery, customColumns: [{ name: xr, expressions: [{ type: ei.formula, value: u2.value }] }] };
    const e3 = Dr(k2.value || {});
    e3 && e3.size > 0 ? b2(true, { params: e3, level: 1 }) : R2({});
  }
  function R2(e3) {
    w2.value = e3, S2.value = true;
  }
  return (t3, o3) => (s(), r(m, null, [g(d(yt), $(t3.$attrs, { onRegister: d(L2), title: "公式配置", onOk: T2 }), { centerFooter: M(() => [g(d(ee), { onClick: B2, type: "primary", danger: "" }, { default: M(() => o3[1] || (o3[1] = [x("测试")])), _: 1 })]), default: M(() => [i2.value ? (s(), h(d(he), { key: 0, class: "mb-2", message: i2.value, type: "info", "show-icon": "" }, { icon: M(() => [g(d(Te), { icon: "ant-design:function-outlined" })]), _: 1 }, 8, ["message"])) : f("", true), (s(), h(of, { "query-mode": e2.queryMode, key: p2.value, "sql-query": d(c2), "show-radio": false, config: u2, onFormulaChange: N2 }, null, 8, ["query-mode", "sql-query", "config"])), g(nf, { "cur-query": k2.value, "cur-params": w2.value, open: S2.value, onClose: o3[0] || (o3[0] = () => S2.value = false) }, null, 8, ["cur-query", "cur-params", "open"])]), _: 1 }, 16, ["onRegister"]), g(lf, { onRegister: d(C2), onSubmit: R2 }, null, 8, ["onRegister"])], 64));
} }), rf = e({ __name: "CustomColModal", props: { sqlQuery: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, n2 = y(true), i2 = xe().getThemeColor, { prefixCls: u2 } = we("col-modal"), f2 = y([]), C2 = a({ formula: { key: "formula", name: "公式", icon: "icon-mfish-sum", color: "#cd201f" }, add: { key: "add", name: "加号", icon: "icon-mfish-add", color: i2 }, subtract: { key: "subtract", name: "减号", icon: "icon-mfish-subtract", color: i2, slot: true }, multiply: { key: "multiply", name: "乘号", icon: "icon-mfish-multiply", color: i2, slot: true }, divide: { key: "divide", name: "除号", icon: "icon-mfish-divide", color: i2, slot: true }, leftBracket: { key: "leftBracket", name: "左括号", icon: "icon-mfish-left-bracket", color: i2, slot: true }, rightBracket: { key: "rightBracket", name: "右括号", icon: "icon-mfish-right-bracket", color: i2, slot: true } }), b2 = a({ formula: { type: ei.formula, value: "" }, add: { type: ei.operator, name: "add", value: "+", slot: true }, subtract: { type: ei.operator, name: "subtract", value: "-", slot: true }, multiply: { type: ei.operator, name: "multiply", value: "*", slot: true }, divide: { type: ei.operator, name: "divide", value: "/", slot: true }, leftBracket: { type: ei.operator, name: "leftBracket", value: "(", slot: true }, rightBracket: { type: ei.operator, name: "rightBracket", value: ")", slot: true } }), k2 = [{ field: "customCol", label: "自定义列", component: "Input", slot: "customCol" }, { field: "name", label: "名称", component: "Input", componentProps: { disabled: o2.queryMode, placeholder: "请输入名称", maxlength: 30, showCount: true }, required: true }], [S2, { resetFields: _2, setFieldsValue: L2, validate: I2 }] = bt({ name: "model_form_item", labelWidth: 100, baseColProps: { span: 24 }, schemas: k2, showActionButtonGroup: false, autoSubmitOnEnter: true }), [D2, { openModal: T2 }] = vt(), [N2, { openModal: B2 }] = vt(), R2 = y();
  const [A2, { setModalProps: O2, closeModal: j2 }] = mt(async (e3) => {
  ...
  }), [z2, { openModal: F2 }] = vt(), P2 = y(), E2 = y(), H2 = y(false);
  async function Q2() {
    try {
      const e3 = await I2();
  ...
  function U2(e3, t3, l3) {
    t3.type !== ei.operator ? (l3(false, t3), B2(true, { index: e3, sqlQuery: { ...o2.sqlQuery }, isUpdate: false })) : l3(true, t3);
  }
  function V2() {
    T2(true, { sqlQuery: { ...o2.sqlQuery }, isUpdate: false });
  }
  function W2(e3, t3) {
    t3.type === ei.field && T2(true, { index: e3, field: t3, sqlQuery: { ...o2.sqlQuery }, isUpdate: true }), t3.type === ei.formula && B2(true, { index: e3, formulaConfig: t3, sqlQuery: { ...o2.sqlQuery }, isUpdate: true });
  }
  function Z2(e3, t3) {
  ...
  function K2() {
    var _a2, _b, _c2, _d2;
    P2.value = { schema: (_a2 = o2.sqlQuery) == null ? void 0 : _a2.schema, sourceTable: (_b = o2.sqlQuery) == null ? void 0 : _b.sourceTable, joins: (_c2 = o2.sqlQuery) == null ? void 0 : _c2.joins, sqlQuery: (_d2 = o2.sqlQuery) == null ? void 0 : _d2.sqlQuery, customColumns: [{ name: xr, expressions: f2.value }] };
    const e3 = Dr(P2.value || {});
  ...
  return (t3, l3) => {
    const n3 = w("AButton");
    return s(), r(m, null, [g(d(yt), $(t3.$attrs, { onRegister: d(A2), title: "自定义列配置", onOk: Q2 }), { centerFooter: M(() => [g(n3, { onClick: K2, type: "primary", danger: "" }, { default: M(() => l3[1] || (l3[1] = [x("测试")])), _: 1 })]), default: M(() => [g(d(Ct), { onRegister: d(S2), onSubmit: Q2 }, { customCol: M(() => [g(d(gt), { "query-mode": e2.queryMode, "add-title": "添加字段", items: f2.value, onBlockBuild: U2, onAddBlock: V2, onEditBlock: W2 }, q({ tag: M(({ element: e3 }) => [p("div", { class: c(`${d(u2)}-slot-tag`) }, [g(d(Ne), { icon: C2[e3.name].icon, color: d(i2) }, null, 8, ["icon", "color"])], 2)]), _: 2 }, [e2.queryMode ? void 0 : { name: "headerBar", fn: M(({ headerCallBack: e3 }) => [(s(true), r(m, null, v(C2, (t4, l4) => (s(), h(d(G), { key: l4, title: t4.name }, { default: M(() => [g(d(ge), { style: { cursor: "pointer" }, color: t4.color, draggable: "true", onClick: (l5) => function(e4, t5) {
      t5.type !== ei.operator ? B2(true, { index: void 0, sqlQuery: o2.sqlQuery, isUpdate: false }) : e4(t5);
    }(e3, b2[t4.key]), onDragstart: (e4) => function(e5, t5) {
      e5.dataTransfer.setData("Text", JSON.stringify(b2[t5.key])), e5.stopPropagation();
    }(e4, t4) }, { icon: M(() => [g(d(Ne), { icon: t4.icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["color", "onClick", "onDragstart"])]), _: 2 }, 1032, ["title"]))), 128))]), key: "0" }]), 1032, ["query-mode", "items"])]), _: 1 }, 8, ["onRegister"]), g(Op, { onRegister: d(D2), onSubmit: Z2 }, null, 8, ["onRegister"]), g(af, { "query-mode": e2.queryMode, onRegister: d(N2), onSubmit: Y2 }, null, 8, ["query-mode", "onRegister"]), g(nf, { "cur-query": P2.value, "cur-params": E2.value, open: H2.value, onClose: l3[0] || (l3[0] = () => H2.value = false) }, null, 8, ["cur-query", "cur-params", "open"])]), _: 1 }, 16, ["onRegister"]), g(lf, { onRegister: d(z2), onSubmit: X2 }, null, 8, ["onRegister"])], 64);
  };
} }), sf = Kt(rf, [["__scopeId", "data-v-93a6f597"]]), uf = e({ __name: "TableCustomCol", props: { sqlQuery: { type: Object }, level: { type: Number, default: 1 }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["customColChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, i2 = y([]);
  function u2() {
    a2("customColChange");
  }
  const [c2, { openModal: p2 }] = vt(), m2 = l(() => {
    var _a2;
    return void 0 === ((_a2 = o2.sqlQuery) == null ? void 0 : _a2.customColumns) && Lr(o2.sqlQuery, o2.level) && !o2.queryMode;
  });
  function v2() {
  ...
  function x2(e3) {
    Ir(o2.configMitt, { ...o2.sqlQuery, customColumns: i2.value, aggregates: [], groups: [], orders: [], limit: void 0 }, e3);
  }
  function S2(e3, t3) {
  ...
  return n(() => {
    ...
    var _a2;
    return s(), r("div", null, [void 0 !== ((_a2 = e2.sqlQuery) == null ? void 0 : _a2.customColumns) ? (s(), h(ip, { key: 0, "query-mode": e2.queryMode, icon: "ant-design:insert-row-right-outlined", title: "自定义列", onDeleteConfig: u2, onExecute: x2, full: true }, { config: M(() => [g(d(gt), { "query-mode": e2.queryMode, items: i2.value, "add-title": "添加自定义列", onAddBlock: v2, onEditBlock: C2, onDragChange: b2 }, null, 8, ["query-mode", "items"])]), _: 1 }, 8, ["query-mode"])) : f("", true), m2.value ? (s(), h(fp, { key: 1, class: "config-button", title: "自定义列", icon: "ant-design:insert-row-right-outlined", level: 0, onClick: k(w2, ["prevent"]) })) : f("", true), g(sf, { "query-mode": e2.queryMode, onRegister: d(c2), "sql-query": e2.sqlQuery, onSubmit: S2 }, null, 8, ["query-mode", "onRegister", "sql-query"])]);
  };
} }), cf = { class: "btn-bar" }, df = Kt(e({ __name: "ApiConfig", props: { configKey: { type: Number, default: 0, require: true }, sqlQuery: { type: Object, require: true, default: void 0 }, level: { type: Number, default: 1 }, configMitt: { type: Object, default: void 0 }, queryMode: { type: Boolean, default: false } }, emits: ["configChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, n2 = t2, { sqlQuery: a2 } = A(o2), { prefixCls: i2 } = we("api-config"), m2 = xe().getThemeColor, v2 = y(), C2 = y(), { focused: b2 } = De(v2), { focused: M2 } = De(C2), k2 = kr(), x2 = y(false), S2 = l(() => {
    var _a2;
    ...
    var _a2;
    return (void 0 === ((_a2 = o2.sqlQuery) == null ? void 0 : _a2.aggregates) || Lr(o2.sqlQuery, o2.level)) && !o2.queryMode;
  }), I2 = l(() => {
    var _a2;
  ...
  async function H2() {
    ...
    return e3.fields = await _r(e3), e3;
  }
  async function Q2() {
    var _a2, _b;
    if (Lr(o2.sqlQuery, o2.level)) {
      const e3 = await H2();
      return e3.joins = [], pp(e3.joins), void n2("configChange", e3, true);
    }
    ((_a2 = a2 == null ? void 0 : a2.value) == null ? void 0 : _a2.joins) && pp((_b = a2 == null ? void 0 : a2.value) == null ? void 0 : _b.joins);
  }
  function G2() {
    W2(["filters"]);
  }
  ...
  async function W2(e3) {
    ...
    if (Lr(o2.sqlQuery, o2.level)) return t3 = await H2(), void l2(t3, true);
  ...
  function K2() {
    var _a2;
    (_a2 = o2.configMitt) == null ? void 0 : _a2.emit(Sr.QUERY_SQL, o2.sqlQuery), M2.value = false;
  }
  function X2() {
    Ir(o2.configMitt, o2.sqlQuery, o2.level), b2.value = false;
  }
  return (t3, o3) => {
    var _a2;
    const l2 = w("ApiConfig", true);
    return s(), r("div", { class: c([d(i2), e2.level < d(k2).getLevel ? "inner" : "", d(k2).getShowData && d(k2).getShowDataLevel === e2.level ? "active" : ""]) }, [d(k2).getShowData && d(k2).getShowDataLevel === e2.level ? (s(), r("div", { key: 0, class: "select", style: u({ backgroundColor: d(m2) }) }, [g(d(Te), { icon: "ant-design:check-outlined", color: "#FFFFFF", size: 12 })], 4)) : f("", true), void 0 !== ((_a2 = d(a2)) == null ? void 0 : _a2.sqlQuery) ? (s(), h(l2, { key: 1, "config-key": e2.configKey, "query-mode": e2.queryMode, "sql-query": d(a2).sqlQuery, level: e2.level - 1, "config-mitt": e2.configMitt, onConfigChange: P2 }, null, 8, ["config-key", "query-mode", "sql-query", "level", "config-mitt"])) : f("", true), (s(), h(sp, { key: e2.configKey + d(k2).getFieldsChange, class: "config", "sql-query": d(a2), "query-mode": e2.queryMode, "config-mitt": e2.configMitt, onFieldChange: T2 }, null, 8, ["sql-query", "query-mode", "config-mitt"])), (s(), h(mp, { level: e2.level, key: e2.configKey, class: "config", "sql-query": d(a2), "config-mitt": e2.configMitt, "query-mode": e2.queryMode, onJoinChange: N2 }, null, 8, ["level", "sql-query", "config-mitt", "query-mode"])), (s(), h(Ip, { "query-mode": e2.queryMode, level: e2.level, key: e2.configKey, class: "config", "sql-query": d(a2), "config-mitt": e2.configMitt, onFilterChange: B2 }, null, 8, ["query-mode", "level", "sql-query", "config-mitt"])), (s(), h(uf, { "query-mode": e2.queryMode, level: e2.level, key: e2.configKey, class: "config", "sql-query": d(a2), "config-mitt": e2.configMitt, onCustomColChange: R2 }, null, 8, ["query-mode", "level", "sql-query", "config-mitt"])), (s(), h(Bp, { "query-mode": e2.queryMode, key: e2.configKey, class: "config", "sql-query": d(a2), "config-mitt": e2.configMitt, onAggregateChange: q2, onGroupChange: O2, onDeleteAggregate: j2 }, null, 8, ["query-mode", "sql-query", "config-mitt"])), (s(), h(Ap, { "query-mode": e2.queryMode, key: e2.configKey, class: "config", "sql-query": d(a2), "config-mitt": e2.configMitt, onOrderChange: z2 }, null, 8, ["query-mode", "sql-query", "config-mitt"])), (s(), h(vp, { "query-mode": e2.queryMode, key: e2.configKey, class: "config", "sql-query": d(a2), "config-mitt": e2.configMitt, onLimitChange: F2 }, null, 8, ["query-mode", "sql-query", "config-mitt"])), p("div", cf, [S2.value ? (s(), h(fp, { key: 0, class: "config-button", title: "关联", iconfont: "icon-mfish-join", level: e2.level, onClick: Q2 }, null, 8, ["level"])) : f("", true), _2.value ? (s(), h(fp, { key: 1, class: "config-button", title: "过滤", icon: "ant-design:filter-outlined", level: e2.level, onClick: G2 }, null, 8, ["level"])) : f("", true), $2.value ? (s(), h(fp, { key: 2, class: "config-button", title: "自定义列", icon: "ant-design:insert-row-right-outlined", level: e2.level, onClick: U2 }, null, 8, ["level"])) : f("", true), L2.value ? (s(), h(fp, { key: 3, class: "config-button", title: "聚合", iconfont: "icon-mfish-sum", level: e2.level, onClick: V2 }, null, 8, ["level"])) : f("", true), I2.value ? (s(), h(fp, { key: 4, class: "config-button", title: "排序", icon: "ant-design:sort-ascending-outlined", level: e2.level, onClick: Z2 }, null, 8, ["level"])) : f("", true), D2.value ? (s(), h(fp, { key: 5, class: "config-button", title: "行数", icon: "ant-design:column-height-outlined", level: e2.level, onClick: Y2 }, null, 8, ["level"])) : f("", true), g(fp, { class: "config-button", ref_key: "querySqlRef", ref: C2, style: u({ fontWeight: "bold", border: `1px dashed ${d(m2)}` }), title: "查看SQL", icon: "ant-design:console-sql-outlined", level: e2.level, onClick: K2 }, null, 8, ["style", "level"]), g(fp, { class: "config-button", style: u({ fontWeight: "bold", border: `1px dashed ${d(m2)}` }), ref_key: "queryDataRef", ref: v2, title: "执行", onMouseenter: o3[0] || (o3[0] = (e3) => x2.value = true), onMouseleave: o3[1] || (o3[1] = (e3) => x2.value = false), icon: !d(k2).getShowData || d(k2).getShowDataLevel !== e2.level || x2.value ? "ant-design:caret-right-outlined" : "ant-design:check-outlined", level: e2.level, onClick: X2 }, null, 8, ["style", "icon", "level"])])], 2);
  };
} }), [["__scopeId", "data-v-32695b70"]]), pf = { key: 0 }, ff = { key: 1 }, hf = e({ __name: "SqlQueryModal", setup(e2) {
  const t2 = y(500), o2 = y(""), [l2, { setModalProps: n2 }] = mt(async (e3) => {
  ...
  return (e3, n3) => {
    const p2 = w("AButton");
    return s(), h(d(yt), $(e3.$attrs, { onRegister: d(l2), title: "SQL查看", "show-ok-btn": false, "cancel-text": "关闭", onHeightChange: c2 }), { insertFooter: M(() => [g(p2, { onClick: n3[0] || (n3[0] = (e4) => d(a2)(o2.value)), color: d(i2) ? "success" : "primary" }, { default: M(() => [d(i2) ? (s(), r("span", ff, "已拷贝")) : (s(), r("span", pf, "拷贝"))]), _: 1 }, 8, ["color"])]), default: M(() => [g(d(St), { style: u({ height: `${t2.value}px` }), mode: d(_t).JS, value: o2.value, "onUpdate:value": n3[1] || (n3[1] = (e4) => o2.value = e4), readonly: true }, null, 8, ["style", "mode", "value"])]), _: 1 }, 16, ["onRegister"]);
  };
} });
const gf = ["src"], yf = Kt(e({ name: "PreviewFrame", __name: "PreviewFrame", props: { frameSrc: Lt.string.def(""), frameWidth: Lt.number.def(400), frameHeight: Lt.number.def(300) }, emits: ["message"], setup(e2, { expose: t2, emit: o2 }) {
  ...
  } }), (t3, o3) => (s(), h(d(ht), null, { default: M(() => [p("iframe", { style: u(m2.value), src: e2.frameSrc, class: c(`${d(g2)}__main`), ref_key: "frameRef", ref: f2, onLoad: v2 }, null, 46, gf)]), _: 1 }));
} }), [["__scopeId", "data-v-1bb3fd25"]]);
const mf = { class: "share-title" }, vf = e({ __name: "ScreenPreview", props: { fixScale: { type: Number, default: 1 }, borderRadius: { type: String } }, setup(e2) {
  const t2 = e2, { prefixCls: n2 } = we("screen-preview"), { token: C2 } = E.useToken(), b2 = l(() => C2.value.colorBorder), k2 = o("fitDomRef"), w2 = y([]), { getAntdLocale: x2 } = $t(), $2 = Nr(), { antTheme: L2 } = _e(l(() => $2.getTheme)), I2 = y(false), D2 = y(""), T2 = y(window.innerWidth), N2 = y(window.innerHeight), B2 = y(), R2 = l(() => [...$2.getComponentList].reverse()), q2 = a({ width: 0, height: 0 }), A2 = l(() => ({ ...Td($2.getCanvasConfig), width: $2.getCanvasConfig.width * q2.width * t2.fixScale + "px", height: $2.getCanvasConfig.height * q2.height * t2.fixScale + "px" })), F2 = (e3) => Od({ ...e3.chartContain.dropInfo }), P2 = (e3) => {
    var _a2, _b;
    if (((_b = (_a2 = e3.chart) == null ? void 0 : _a2.events) == null ? void 0 : _b.emits) && e3.chart.events.emits.length > 0) {
      for (const t3 of e3.chart.events.emits) if (t3 === as.CHART_CLICK || t3 === as.CHART_DBLCLICK) return "allow-pointer";
    }
  }, H2 = (e3) => {
    const t3 = Ad(e3);
  ...
  const { register: U2, unRegister: V2 } = function() {
    const { getDataTable: e3 } = ls(), t3 = [], o2 = Nr();
    return { register: async function() {
      const l2 = (o3) => {
        ...
        ((_a2 = o3.data.autoRefresh) == null ? void 0 : _a2.open) && o3.data.autoRefresh.interval && t3.push(setInterval(() => {
          e3(o3).then((e4) => {
            var _a3;
            o3.type && ((_a3 = Id[o3.type]) == null ? void 0 : _a3.initData(o3, e4));
          });
        }, 60 * o3.data.autoRefresh.interval * 1e3));
      };
      t3.length = 0;
      for (const e4 of o2.getComponentList) if (l2(e4.chart), e4.chart.type === es.MfCombine) for (const t4 of e4.chart.options.components) l2(t4.chart);
    }, unRegister: function() {
  ...
  return i(() => {
    setTimeout(() => {
      $2.loadingScreen().then(() => {
        ...
        for (let e4 = 0; e4 < R2.value.length; e4++) {
          ...
          !t3.chartContain.animations || 0 === t3.chartContain.animations.length || w2.value.length <= e4 || (R2.value[e4].chartContain.show && R2.value[e4].chart.type !== es.MfCombine && (R2.value[e4].chartContain.show = false, n3.set(e4, R2.value[e4])), setTimeout(() => {
            n3.has(e4) && (n3.get(e4).chartContain.show = true), $d(w2.value[e4], t3.chartContain.animations).then();
          }, 600));
        }
      });
    }, 10), Dd.on(Fr.SHOW_MODAL, (e3) => {
      var _a2, _b, _c2, _d2, _e2, _f2;
    ...
    G2 && G2();
  }), (t3, o2) => (s(), h(d(ye), { locale: d(x2), theme: d(L2) }, { default: M(() => [g(d(ht), { class: c(d(n2)), style: u({ borderRadius: e2.borderRadius }) }, { default: M(() => [p("div", { class: "screen-wrap", style: u(A2.value) }, [p("div", { class: "screen-canvas", ref_key: "fitDomRef", ref: k2 }, [d($2).getCanvasConfig.watermark ? (s(), h(d(me), { key: 0, content: d($2).getCanvasConfig.watermark, style: u({ position: "absolute", width: `${d($2).getCanvasConfig.width}px`, height: `${d($2).getCanvasConfig.height}px` }) }, null, 8, ["content", "style"])) : f("", true), (s(true), r(m, null, v(R2.value, (e3, t4) => {
    var _a2, _b, _c2, _d2, _e2, _f2, _g;
    return O((s(), r("div", { class: c(["chart-contain", P2(e3)]), style: u(F2(e3)), key: e3 == null ? void 0 : e3.chart.id }, [p("div", { ref_for: true, ref: (e4) => function(e5, t5) {
      w2.value[t5] = e5;
    }(e4, t4), style: u(H2(e3)) }, [(s(), h(j((e3 == null ? void 0 : e3.chart) && e3.chart.type && d(Id)[e3.chart.type].component), { class: "component", id: `com${e3 == null ? void 0 : e3.chart.id}`, chart: e3 == null ? void 0 : e3.chart, "chart-contain": e3 == null ? void 0 : e3.chartContain }, null, 8, ["id", "chart", "chart-contain"]))], 4)], 6)), [[z, void 0 === ((_b = (_a2 = e3.chart) == null ? void 0 : _a2.showHide) == null ? void 0 : _b.show) && ((_c2 = e3.chartContain) == null ? void 0 : _c2.show) || void 0 !== ((_e2 = (_d2 = e3.chart) == null ? void 0 : _d2.showHide) == null ? void 0 : _e2.show) && ((_g = (_f2 = e3.chart) == null ? void 0 : _f2.showHide) == null ? void 0 : _g.show)]]);
  }), 128))], 512)], 4)]), _: 1 }, 8, ["class", "style"]), g(d(ve), { open: I2.value, "onUpdate:open": o2[0] || (o2[0] = (e3) => I2.value = e3), "get-container": Q2, width: T2.value + 48, footer: null, mask: true, centered: true }, { title: M(() => [p("div", mf, S(B2.value), 1)]), default: M(() => [g(yf, { "frame-src": D2.value, "frame-width": T2.value, "frame-height": N2.value }, null, 8, ["frame-src", "frame-width", "frame-height"])]), _: 1 }, 8, ["open", "width"])]), _: 1 }, 8, ["locale", "theme"]));
} }), Cf = Kt(vf, [["__scopeId", "data-v-356e41a5"]]), bf = e({ __name: "ScreenSizeConfig", setup(e2) {
  const t2 = y("1k"), o2 = y([{ value: "720", label: "1280*720" }, { value: "1k", label: "1920*1080" }, { value: "2k", label: "2048*1152" }, { value: "4k", label: "4096*2160" }, { value: "自定义", label: "自定义" }]), l2 = Nr(), a2 = (e3) => {
    var _a2;
...
} }), Mf = Kt(bf, [["__scopeId", "data-v-148656f7"]]), kf = e({ __name: "ParamsConfig", setup: (e2) => (e3, t2) => (s(), h(d(be), { description: "暂未开发", image: d(be).PRESENTED_IMAGE_SIMPLE }, null, 8, ["image"])) }), wf = { class: "title" }, xf = { class: "title" }, Sf = { class: "title" }, _f = e({ __name: "CanvasConfig", setup(e2) {
  const { prefixCls: t2 } = we("canvas-config"), o2 = Nr(), l2 = y(), n2 = [{ title: "深色", value: He.DARK }, { title: "浅色", value: He.LIGHT }, { title: "跟随平台", value: He.SYSTEM }], u2 = a({ [zr.FIT_BOX]: { name: "全屏铺满", icon: "carbon:fit-to-screen", description: "全屏铺满（设备与配置大屏比例不同时会变形）" }, [zr.FIT_ORIGINAL]: { name: "原始比例", icon: "carbon:center-to-fit", description: "原始比例（保持配置大屏比例，不填充空白处）" }, [zr.FIT_WIDTH_SCALE]: { name: "横向适配", icon: "carbon:fit-to-width", description: "横向适配-保持纵横比（横向铺满，允许纵向滚动，保持原有画布比例）" }, [zr.FIT_HEIGHT_SCALE]: { name: "纵向适配", icon: "carbon:fit-to-height", description: "纵向适配-保持纵横比（纵向铺满，允许横向滚动，保持原有画布比例）" }, [zr.FIT_WIDTH]: { name: "横向适配", icon: "carbon:fit-to-width", description: "横向适配（横向铺满，允许纵向滚动，会变形）" }, [zr.FIT_HEIGHT]: { name: "纵向适配", icon: "carbon:fit-to-height", description: "纵向适配（纵向铺满，允许横向滚动，会变形）" } });
  function f2(e3) {
    C2(e3), l2.value = e3;
  }
  function C2(e3) {
  ...
  return i(() => {
    ...
    const i2 = w("AInput");
    return s(), h(d(ht), null, { default: M(() => [p("div", { class: c(d(t2)) }, [a2[8] || (a2[8] = p("div", { class: "title" }, "大屏名称", -1)), g(i2, { value: d(o2).getCanvasConfig.screenName, "onUpdate:value": a2[0] || (a2[0] = (e4) => d(o2).getCanvasConfig.screenName = e4), "show-count": "", maxlength: 30 }, null, 8, ["value"]), a2[9] || (a2[9] = p("div", { class: "title" }, "大屏尺寸", -1)), g(Mf), p("div", wf, [a2[5] || (a2[5] = x(" 主题 ")), g(d(Y), { size: "small", value: d(o2).getCanvasConfig.theme, "onUpdate:value": a2[1] || (a2[1] = (e4) => d(o2).getCanvasConfig.theme = e4) }, { default: M(() => [(s(), r(m, null, v(n2, (e4, t3) => g(d(Z), { key: t3, value: e4.value }, { default: M(() => [x(S(e4.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])]), a2[10] || (a2[10] = p("div", { class: "title" }, "背景颜色", -1)), g(d(Ao), { value: l2.value, onConfirmChange: f2, onInputChange: C2 }, null, 8, ["value"]), a2[11] || (a2[11] = p("div", { class: "title" }, "背景图片", -1)), g(d(It), { "file-keys": d(o2).getCanvasConfig.backgroundImage, accepts: ".jpg,.jpeg,.png,.svg", "button-text": "上传背景", "max-count": 1, "is-pic": true, onSuccess: b2, onRemove: k2 }, null, 8, ["file-keys"]), p("div", xf, [a2[6] || (a2[6] = x(" 水印 ")), p("div", null, [g(i2, { value: d(o2).getCanvasConfig.watermark, "onUpdate:value": a2[2] || (a2[2] = (e4) => d(o2).getCanvasConfig.watermark = e4), placeholder: "清空无水印", "show-count": "", maxlength: 50 }, null, 8, ["value"])])]), p("div", Sf, [a2[7] || (a2[7] = x(" 适配方式 ")), p("div", null, [g(d(Y), { value: d(o2).getCanvasConfig.fitType, "onUpdate:value": a2[3] || (a2[3] = (e4) => d(o2).getCanvasConfig.fitType = e4) }, { default: M(() => [(s(true), r(m, null, v(Object.keys(u2), (e4) => (s(), h(d(G), { key: e4, placement: "bottomRight", title: u2[e4].description }, { default: M(() => [g(d(Z), { class: c(`${d(t2)}-radio-button`), value: e4 }, { default: M(() => [g(d(Te), { icon: u2[e4].icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["class", "value"])]), _: 2 }, 1032, ["title"]))), 128))]), _: 1 }, 8, ["value"])])]), a2[12] || (a2[12] = p("div", { class: "title" }, "全局参数", -1)), g(kf), a2[13] || (a2[13] = p("div", { class: "title" }, " 描述", -1)), g(d(Me), { value: d(o2).getCanvasConfig.screenDesc, "onUpdate:value": a2[4] || (a2[4] = (e4) => d(o2).getCanvasConfig.screenDesc = e4), "show-count": "", maxlength: 200 }, null, 8, ["value"])], 2)]), _: 1 });
  };
} }), $f = Kt(_f, [["__scopeId", "data-v-b101a035"]]), Lf = { class: "header" }, If = e({ name: "FrameConfig", __name: "index", props: { collapsed: Lt.bool.def(false) }, setup(e2, { expose: t2 }) {
  const o2 = e2, { prefixCls: a2 } = we("frame-config"), i2 = l(() => [a2, { collapsed: o2.collapsed }]), u2 = y(), m2 = y(), v2 = y(), C2 = Nr(), b2 = y();
  function k2(e3) {
    if (e3) {
      const t3 = Id[e3.chart.type].config;
      u2.value = Object.keys(t3).filter((e4) => t3[e4].show).map((e4) => t3[e4]);
    } else u2.value = [{ value: "画布配置", payload: { icon: "carbon:gui-management", component: T($f) } }];
  ...
  return n([() => C2.getCurComponent, () => {
    ...
    b2.value = e3;
  } }), (e3, t3) => (s(), r("div", { class: c(i2.value) }, [p("div", Lf, [g(d(U), { value: m2.value, options: u2.value, onChange: w2, block: "" }, { label: M(({ value: e4, payload: t4 }) => [t4.icon ? (s(), h(d(Te), { key: 0, icon: t4.icon }, null, 8, ["icon"])) : f("", true), x(" " + S(e4), 1)]), _: 1 }, 8, ["value", "options"])]), (s(), h(j(v2.value), { "select-data": b2.value }, { "data-select": M(() => [R(e3.$slots, "data-select", { curSelect: b2.value })]), _: 3 }, 8, ["select-data"]))], 2));
} }), Df = { class: "action" }, Tf = { class: "ac-int" }, Nf = e({ __name: "CanvasRulerLine", props: { lineValue: { type: Number, default: 0 }, lineList: { type: Array, default: () => [] } }, setup(e2) {
  const t2 = e2, { lineList: o2 } = t2, l2 = Nr(), { prefixCls: n2 } = we("canvas-ruler-line"), a2 = xe().getThemeColor;
  return (e3, t3) => (s(), r("div", { class: c(d(n2)) }, [(s(true), r(m, null, v(d(o2), (e4, t4) => (s(), r("div", { class: c(["line-item", { x: "x" === e4.position, y: "y" === e4.position }]), style: u({ left: "x" === e4.position ? `${Math.round(e4.offset * d(l2).getScale)}px` : 0, top: "y" === e4.position ? `${Math.round(e4.offset * d(l2).getScale)}px` : 0 }), key: `${e4}${t4}` }, [p("div", Df, [g(d(Te), { class: "ac-close", icon: "ant-design:close-outline", color: d(a2), onClick: (l3) => function(e5, t5) {
    o2.splice(t5, 1);
  }(e4.position, t4) }, null, 8, ["color", "onClick"]), p("span", Tf, S(e4.value), 1)])], 6))), 128))], 2));
} }), Bf = Kt(Nf, [["__scopeId", "data-v-91bb6b29"]]), Rf = { id: "horn", class: "horn" }, qf = ["id", "width", "height"], Af = { class: "indicator-value" }, Of = ["id", "height", "width"], jf = { class: "indicator-value" }, zf = e({ __name: "CanvasRuler", props: { rulerXLeft: { type: Number, default: 0 }, rulerYTop: { type: Number, default: 0 }, rulerX: { type: Number, default: 5e3 }, rulerY: { type: Number, default: 3e3 }, drift: { type: Number, default: 0 }, rulerHeight: { type: Number, default: 28 }, rulerWidth: { type: Number, default: 38 } }, setup(e2) {
  const t2 = e2, a2 = Nr(), { prefixCls: i2 } = we("canvas-ruler"), f2 = y(0), m2 = y(true), v2 = T({}), b2 = T({}), k2 = l(() => `${t2.rulerXLeft}px`), w2 = l(() => `${t2.rulerYTop}px`), x2 = o("rulerXRef"), _2 = o("rulerYRef"), $2 = l(() => xe().getDarkMode.value === He.DARK ? "#999" : "#666");
  ...
  return (t3, o2) => (s(), r("div", { class: c(d(i2)) }, [p("div", Rf, [g(d(G), { title: (m2.value ? "隐藏" : "显示") + "辅助线" }, { default: M(() => [m2.value ? (s(), h(d(Te), { key: 0, class: "icon", icon: "ant-design:eye-outlined", onClick: Q2 })) : (s(), h(d(Te), { key: 1, class: "icon", icon: "ant-design:eye-invisible-outlined", onClick: Q2 }))]), _: 1 }, 8, ["title"])]), p("div", { class: "ruler rulerX", style: u({ width: `${L2.value}px`, left: k2.value }) }, [p("canvas", { ref_key: "rulerXRef", ref: x2, id: `${d(i2)}-x`, width: L2.value, height: e2.rulerHeight, onMousemove: D2, onMouseleave: N2, onClick: B2 }, null, 40, qf), p("div", { class: "indicator x", style: u(v2.value) }, [p("div", Af, S(f2.value), 1)], 4), O(g(Bf, { "line-value": f2.value, "line-list": d(a2).getGuideLine.lineListY }, null, 8, ["line-value", "line-list"]), [[z, m2.value]])], 4), p("div", { class: "ruler rulerY", style: u({ height: `${I2.value}px`, top: w2.value }) }, [p("canvas", { ref_key: "rulerYRef", ref: _2, id: `${d(i2)}-y`, height: I2.value, width: e2.rulerWidth, onMousemove: R2, onMouseleave: q2, onClick: A2 }, null, 40, Of), p("div", { class: "indicator y", style: u(b2.value) }, [p("div", jf, S(f2.value), 1)], 4), O(g(Bf, { "line-value": f2.value, "line-list": d(a2).getGuideLine.lineListX }, null, 8, ["line-value", "line-list"]), [[z, m2.value]])], 4)], 2));
} }), Ff = Kt(zf, [["__scopeId", "data-v-eeb86e63"]]), Pf = e({ __name: "CanvasBackground", props: { drift: { type: Number, default: 0 }, width: { type: Number, default: 9e3 }, height: { type: Number, default: 6e3 }, ruler: { type: Object, default: () => ({ height: 28, width: 38 }) } }, setup(e2) {
  const t2 = e2, o2 = Nr(), n2 = Zd(), a2 = l(() => t2.width * o2.getScale + "px"), i2 = l(() => t2.height * o2.getScale + "px"), { prefixCls: p2 } = we("canvas-background");
  function f2(e3) {
...
} }), Ef = Kt(Pf, [["__scopeId", "data-v-2efcd248"]]), Hf = { class: "scale-add-reduce" }, Qf = { class: "scale-lock" }, Gf = e({ __name: "CanvasScale", props: { scale: { type: Number, default: 100 }, minScale: { type: Number, default: 20 }, maxScale: { type: Number, default: 500 } }, emits: ["addScale", "reduceScale", "changeScale", "autoScale"], setup(e2, { emit: t2 }) {
  ...
  return (t3, o3) => (s(), r("div", { class: c(d(n2)) }, [p("div", Hf, [g(d(Te), { class: "scale-icon", title: "放大", size: 18, icon: "ant-design:plus-outlined", onClick: i2 }), g(d(Q), { size: "small", bordered: false, value: e2.scale, max: e2.maxScale, min: e2.minScale, step: 5, controls: false, formatter: (e3) => `${Math.round(100 * e3)}`, onChange: u2 }, null, 8, ["value", "max", "min", "formatter"]), o3[2] || (o3[2] = p("div", { class: "scale-sign" }, "%", -1)), g(d(Te), { class: "scale-icon", title: "缩小", size: 18, icon: "ant-design:minus-outlined", onClick: a2 })]), p("div", Qf, [g(d(G), { title: l2.value ? "锁定自动比例" : "解锁自动比例", placement: "right" }, { default: M(() => [l2.value ? (s(), h(d(Te), { key: 0, icon: "ant-design:unlock-outlined", onClick: o3[0] || (o3[0] = (e3) => f2(false)) })) : (s(), h(d(Te), { key: 1, icon: "ant-design:lock-outlined", onClick: o3[1] || (o3[1] = (e3) => f2(true)) }))]), _: 1 }, 8, ["title"])])], 2));
} }), Uf = e({ __name: "ShortcutViewModal", setup(e2) {
  const [t2, { setModalProps: o2 }] = mt(async () => {
    o2({ confirmLoading: false, width: "800px", cancelText: "关闭", showOkBtn: false });
  }), [l2] = wt({ columns: [{ title: "功能", dataIndex: "label", width: 120 }, { title: "Win快捷键", dataIndex: "win", width: 120 }, { title: "Mac快捷键", dataIndex: "mac", width: 120 }], dataSource: [{ label: "拖拽 / 放大缩小画布", win: "CTRL + 🖱️拖动 / 滚动", mac: "⌘ + 🖱️拖动 / 滚动", macSource: true }, { label: "向 上/右/下/左 移动", win: "CTRL + ↑ / → / ↓ / ←", mac: "⌘ + ↑" }, { label: "锁定/解锁", win: "CTRL + L / CTRL + SHIFT+ L", mac: "⌘ + L / ⌘ + ⇧ + L" }, { label: "隐藏/显示", win: "CTRL + H / CTRL + SHIFT + H", mac: "⌘ + H / ⌘ + ⇧ + H" }, { label: "组合/拆分", win: "CTRL + G / CTRL + SHIFT + G", mac: "⌘ + G / ⌘ + SHIFT + G" }, { label: "后退/前进", win: "CTRL + Z / CTRL + SHIFT + Z", mac: "⌘ + Z / ⌘ + ⇧ + Z" }, { label: "复制/粘贴", win: "CTRL + C / V", mac: "⌘ + C / V" }, { label: "多选", win: "拖动🖱️框选 / CTRL + 🖱️点击", mac: "拖动🖱️框选 / ⌘ + 🖱️点击" }, { label: "保存", win: "CTRL + S", mac: "⌘ + S" }, { label: "预览", win: "CTRL + P", mac: "⌘ + P" }, { label: "全选", win: "CTRL + A", mac: "⌘ + A" }, { label: "删除", win: "Delete", mac: "Delete" }], bordered: true, showIndexColumn: false, pagination: false, canResize: false });
  return (e3, o3) => (s(), h(d(yt), { onRegister: d(t2), title: "快捷操作" }, { default: M(() => [g(d(xt), { onRegister: d(l2) }, null, 8, ["onRegister"])]), _: 1 }, 8, ["onRegister"]));
} }), Vf = Kt(e({ __name: "CanvasOperator", setup(e2) {
  const { prefixCls: t2 } = we("canvas-operator"), [o2, { openModal: l2 }] = vt();
  function n2() {
    l2(true, {});
  }
  return (e3, l3) => (s(), r(m, null, [p("div", { class: c(d(t2)) }, [g(d(G), { title: "快捷方式", placement: "right" }, { default: M(() => [g(d(Te), { icon: "carbon:table-shortcut", onClick: n2 })]), _: 1 })], 2), g(Uf, { onRegister: d(o2) }, null, 8, ["onRegister"])], 64));
} }), [["__scopeId", "data-v-2148ffa6"]]), Wf = { lt: function(e2, t2, o2, l2, n2, a2) {
  const { symmetricPoint: i2 } = n2;
  let r2 = Vr(t2, i2), s2 = Ur(t2, r2, -e2.rotate), u2 = Ur(i2, r2, -e2.rotate), c2 = u2.x - s2.x, d2 = u2.y - s2.y;
  if (l2) {
    c2 / d2 > o2 ? (s2.x += Math.abs(c2 - d2 * o2), c2 = d2 * o2) : (s2.y += Math.abs(d2 - c2 / o2), d2 = c2 / o2);
    const t3 = Ur(s2, r2, e2.rotate);
    r2 = Vr(t3, i2), s2 = Ur(t3, r2, -e2.rotate), u2 = Ur(i2, r2, -e2.rotate), c2 = u2.x - s2.x, d2 = u2.y - s2.y;
  }
  c2 > 10 && d2 > 10 && (e2.width = Math.round(c2 / a2), e2.height = Math.round(d2 / a2), e2.x = Math.round(s2.x / a2), e2.y = Math.round(s2.y / a2));
}, t: Zf, rt: function(e2, t2, o2, l2, n2, a2) {
  const { symmetricPoint: i2 } = n2;
  let r2 = Vr(t2, i2), s2 = Ur(t2, r2, -e2.rotate), u2 = Ur(i2, r2, -e2.rotate), c2 = s2.x - u2.x, d2 = u2.y - s2.y;
  if (l2) {
    c2 / d2 > o2 ? (s2.x -= Math.abs(c2 - d2 * o2), c2 = d2 * o2) : (s2.y += Math.abs(d2 - c2 / o2), d2 = c2 / o2);
    const t3 = Ur(s2, r2, e2.rotate);
    r2 = Vr(t3, i2), s2 = Ur(t3, r2, -e2.rotate), u2 = Ur(i2, r2, -e2.rotate), c2 = s2.x - u2.x, d2 = u2.y - s2.y;
  }
  c2 > 10 && d2 > 10 && (e2.width = Math.round(c2 / a2), e2.height = Math.round(d2 / a2), e2.x = Math.round(u2.x / a2), e2.y = Math.round(s2.y / a2));
}, r: Yf, rb: function(e2, t2, o2, l2, n2, a2) {
  const { symmetricPoint: i2 } = n2;
  let r2 = Vr(t2, i2), s2 = Ur(i2, r2, -e2.rotate), u2 = Ur(t2, r2, -e2.rotate), c2 = u2.x - s2.x, d2 = u2.y - s2.y;
  if (l2) {
    c2 / d2 > o2 ? (u2.x -= Math.abs(c2 - d2 * o2), c2 = d2 * o2) : (u2.y -= Math.abs(d2 - c2 / o2), d2 = c2 / o2);
    const t3 = Ur(u2, r2, e2.rotate);
    r2 = Vr(t3, i2), s2 = Ur(i2, r2, -e2.rotate), u2 = Ur(t3, r2, -e2.rotate), c2 = u2.x - s2.x, d2 = u2.y - s2.y;
  }
  c2 > 10 && d2 > 10 && (e2.width = Math.round(c2 / a2), e2.height = Math.round(d2 / a2), e2.x = Math.round(s2.x / a2), e2.y = Math.round(s2.y / a2));
}, b: Zf, lb: function(e2, t2, o2, l2, n2, a2) {
  const { symmetricPoint: i2 } = n2;
  let r2 = Vr(t2, i2), s2 = Ur(i2, r2, -e2.rotate), u2 = Ur(t2, r2, -e2.rotate), c2 = s2.x - u2.x, d2 = u2.y - s2.y;
  if (l2) {
    c2 / d2 > o2 ? (u2.x += Math.abs(c2 - d2 * o2), c2 = d2 * o2) : (u2.y -= Math.abs(d2 - c2 / o2), d2 = c2 / o2);
    const t3 = Ur(u2, r2, e2.rotate);
    r2 = Vr(t3, i2), s2 = Ur(i2, r2, -e2.rotate), u2 = Ur(t3, r2, -e2.rotate), c2 = s2.x - u2.x, d2 = u2.y - s2.y;
  }
  c2 > 10 && d2 > 10 && (e2.width = Math.round(c2 / a2), e2.height = Math.round(d2 / a2), e2.x = Math.round(u2.x / a2), e2.y = Math.round(s2.y / a2));
}, l: Yf };
function Zf(e2, t2, o2, l2, n2, a2) {
  const { symmetricPoint: i2, curPoint: r2 } = n2, s2 = Ur(t2, r2, -e2.rotate), u2 = Ur({ x: r2.x, y: s2.y }, r2, e2.rotate), c2 = Math.hypot(u2.x - i2.x, u2.y - i2.y), d2 = u2.x - (u2.x - i2.x) / 2, p2 = u2.y + (i2.y - u2.y) / 2;
  let f2 = e2.width;
...
function Yf(e2, t2, o2, l2, n2, a2) {
  const { symmetricPoint: i2, curPoint: r2 } = n2, s2 = Ur(t2, r2, -e2.rotate), u2 = Ur({ x: s2.x, y: r2.y }, r2, e2.rotate), c2 = Math.hypot(u2.x - i2.x, u2.y - i2.y), d2 = u2.x - (u2.x - i2.x) / 2, p2 = u2.y + (i2.y - u2.y) / 2;
  let f2 = e2.height;
...
const Kf = ["onMousedown"], Xf = { key: 2, class: "cover-layer-out" }, Jf = { key: 0, class: "cover-hover" }, eh = e({ name: "ChartContain", __name: "index", props: { comOption: { require: true, type: Object, default: () => ({ chart: {}, chartContain: {} }) }, index: { require: true, type: Number, default: 0 } }, setup(e2) {
  t((e3) => ({ "4bd20fbb": g2.value }));
  const n2 = e2, { token: a2 } = E.useToken(), g2 = l(() => a2.value.colorInfoBg), C2 = l(() => a2.value.colorBorder), b2 = o("chartContainRef"), M2 = o("chartItemRef"), { prefixCls: w2 } = we("chart-contain"), x2 = { points: ["lt", "t", "rt", "r", "rb", "b", "lb", "l"], initAngle: { lt: 0, t: 45, rt: 90, r: 135, rb: 180, b: 225, lb: 270, l: 315 }, pointCursor: [{ start: 338, end: 23, cursor: "nw" }, { start: 23, end: 68, cursor: "n" }, { start: 68, end: 113, cursor: "ne" }, { start: 113, end: 158, cursor: "e" }, { start: 158, end: 203, cursor: "se" }, { start: 203, end: 248, cursor: "s" }, { start: 248, end: 293, cursor: "sw" }, { start: 293, end: 338, cursor: "w" }] }, S2 = y(false), _2 = y(false), $2 = y({}), L2 = Nr(), I2 = Zd(), D2 = l(() => [w2, { active: q2.value || A2.value }]), T2 = l(() => {
    var _a2, _b, _c2, _d2;
  ...
  }), N2 = l(() => Od({ ...n2.comOption.chartContain.dropInfo })), B2 = l(() => {
    const e3 = Ad(n2.comOption);
  ...
  async function F2(e3) {
    if (I2.setShowMenu(false), e3.ctrlKey || e3.metaKey) return void tp(n2.comOption);
    ...
    const a3 = setInterval(() => {
      ...
      d(S2) ? L2.setUndoRedoData("组件移动") : L2.cleanSelectArea(), S2.value = false, clearInterval(a3), t2 && ep(L2.getSelectArea.components), Dd.emit(Fr.UN_MOVE), document.removeEventListener("mousemove", i2), document.removeEventListener("mouseup", r2), $2.value = P2(n2.comOption);
    };
    document.addEventListener("mousemove", i2), document.addEventListener("mouseup", r2);
  }
  function P2(e3) {
    if (!e3) return;
    const { pointCursor: t2, initAngle: o2, points: l2 } = x2, n3 = Yr(e3.chartContain.dropInfo.rotate), a3 = {};
    let i2 = -1;
    return l2.forEach((e4) => {
      const l3 = Yr(o2[e4] + n3), r2 = t2.length;
      for (; ; ) {
        i2 = (i2 + 1) % r2;
        const o3 = t2[i2];
  ...
  function U2(e3, t2) {
    ...
    let u2 = true;
    const c2 = function() {
      if (n2.comOption.chart.type !== es.MfCombine) return false;
      for (const e4 of n2.comOption.chart.options.components) if (![0, 90, 180, 360].includes(Yr(e4.chartContain.dropInfo.rotate))) return true;
      return false;
    }(), p2 = Pe((t3) => {
      ...
      !function(e4, t4, o3, l3, n4, a4, i4) {
        Wf[e4](t4, o3, l3, n4, a4, i4);
      }(e3, o2, n3, i3, c2, { center: l2, curPoint: r2, symmetricPoint: s2 }, L2.getScale), j2(o2), Dd.emit(Fr.MOVE, false);
    }, 2), f2 = () => {
      d(S2) && L2.setUndoRedoData("组件大小调整"), S2.value = false, Dd.emit(Fr.UN_MOVE), document.removeEventListener("mousemove", p2), document.removeEventListener("mouseup", f2);
    };
  ...
  return i(() => {
    n2.comOption && ($2.value = P2(n2.comOption)), Dd.on(Fr.MOVE, () => {
      n2.comOption && L2.getCurComponent && n2.comOption.chart.id !== L2.getCurComponent.chart.id && !d(_2) && (_2.value = true);
    }), Dd.on(Fr.UN_MOVE, () => {
      _2.value = false;
    }), Dd.on(Fr.PLAY_ANIMATION, () => {
      var _a2, _b;
      n2.comOption.chart.id === ((_a2 = L2.getCurComponent) == null ? void 0 : _a2.chart.id) && void 0 === ((_b = n2.comOption.chart.options) == null ? void 0 : _b.selectIndex) && $d(M2.value, n2.comOption.chartContain.animations).then(() => {
        Dd.emit(Fr.PLAY_ANIMATION_COMPLETE);
      });
    }), Dd.on(Fr.STOP_ANIMATION, () => {
      var _a2;
    ...
    var _a2, _b, _c2, _d2, _e2, _f2, _g;
    return s(), r("div", { ref_key: "chartContainRef", ref: b2, class: c(D2.value), style: u(N2.value), onMousedown: k(F2, ["stop"]), onMouseenter: k(H2, ["prevent", "stop"]), onMouseleave: k(Q2, ["prevent"]) }, [(s(true), r(m, null, v(q2.value && !e2.comOption.chartContain.lock && e2.comOption.chartContain.show ? x2.points : [], (e3) => (s(), r("div", { key: e3, class: "contain-point", style: u(G2(e3)), onMousedown: k((t3) => U2(e3, t3), ["stop", "prevent"]) }, null, 44, Kf))), 128)), O(p("div", { ref_key: "chartItemRef", ref: M2, class: "chart-item", style: u(B2.value) }, [R(t2.$slots, "default", {}, void 0, true)], 4), [[z, void 0 === ((_b = (_a2 = e2.comOption.chart) == null ? void 0 : _a2.showHide) == null ? void 0 : _b.show) && ((_c2 = e2.comOption.chartContain) == null ? void 0 : _c2.show) || void 0 !== ((_e2 = (_d2 = e2.comOption.chart) == null ? void 0 : _d2.showHide) == null ? void 0 : _e2.show) && ((_g = (_f2 = e2.comOption.chart) == null ? void 0 : _f2.showHide) == null ? void 0 : _g.show)]]), q2.value && !e2.comOption.chartContain.lock && e2.comOption.chartContain.show ? (s(), h(d(Te), { key: 0, class: "icon-rotate", icon: "ant-design:sync-outlined", size: "20", onMousedown: k(V2, ["prevent", "stop"]) })) : f("", true), e2.comOption.chartContain.lock && e2.comOption.chartContain.show ? (s(), h(d(Te), { key: 1, class: "icon-lock", icon: "ant-design:lock-outlined" })) : f("", true), q2.value || A2.value || T2.value ? (s(), r("div", Xf, [T2.value ? (s(), r("div", Jf)) : f("", true)])) : f("", true)], 38);
  };
} }), th = Kt(eh, [["__scopeId", "data-v-c1fac52d"]]), oh = "横上", lh = "横中", nh = "横下", ah = "纵左", ih = "纵中", rh = "纵右", sh = { class: "pos" }, uh = e({ name: "ChartNearLine", __name: "index", setup(e2) {
  const t2 = a({ adsorb: 10, near: 2, lineStatus: { [oh]: { show: false, pos: 0, node: null }, [lh]: { show: false, pos: 0, node: null }, [nh]: { show: false, pos: 0, node: null }, [ah]: { show: false, pos: 0, node: null }, [ih]: { show: false, pos: 0, node: null }, [rh]: { show: false, pos: 0, node: null } } }), o2 = Nr(), { prefixCls: l2 } = we("near-line");
  function n2(e3, { x: o3, y: l3, bottom: n3, right: a2, halfWidth: i2, halfHeight: r2 }) {
    ...
    return { y: [{ isNear: u2(e3.y, l3), isAdsorb: f2(e3.y, l3), lineNode: d2[oh].node, line: oh, dragShift: l3, lineShift: l3 }, { isNear: u2(e3.bottom, l3), isAdsorb: f2(e3.bottom, l3), lineNode: d2[oh].node, line: oh, dragShift: l3 - e3.height, lineShift: l3 }, { isNear: u2(e3.y + c2, l3 + r2), isAdsorb: f2(e3.y + c2, l3 + r2), lineNode: d2[lh].node, line: lh, dragShift: l3 + r2 - c2, lineShift: l3 + r2 }, { isNear: u2(e3.y, n3), isAdsorb: f2(e3.y, n3), lineNode: d2[nh].node, line: nh, dragShift: n3, lineShift: n3 }, { isNear: u2(e3.bottom, n3), isAdsorb: f2(e3.bottom, n3), lineNode: d2[nh].node, line: nh, dragShift: n3 - e3.height, lineShift: n3 }], x: [{ isNear: u2(e3.x, o3), isAdsorb: f2(e3.x, o3), lineNode: d2[ah].node, line: ah, dragShift: o3, lineShift: o3 }, { isNear: u2(e3.right, o3), isAdsorb: f2(e3.right, o3), lineNode: d2[ah].node, line: ah, dragShift: o3 - e3.width, lineShift: o3 }, { isNear: u2(e3.x + s2, o3 + i2), isAdsorb: f2(e3.x + s2, o3 + i2), lineNode: d2[ih].node, line: ih, dragShift: o3 + i2 - s2, lineShift: o3 + i2 }, { isNear: u2(e3.x, a2), isAdsorb: f2(e3.x, a2), lineNode: d2[rh].node, line: rh, dragShift: a2, lineShift: a2 }, { isNear: u2(e3.right, a2), isAdsorb: f2(e3.right, a2), lineNode: d2[rh].node, line: rh, dragShift: a2 - e3.width, lineShift: a2 }] };
  }
  function u2(e3, o3) {
    ...
    Dd.on(Fr.MOVE, (e3) => {
      !async function(e4) {
        ...
        e4 ? o2.getSelectArea.components.forEach((e5) => {
          l3.push({ com: e5, style: jd(e5.chartContain.dropInfo) });
        }) : l3.push({ com: o2.getCurComponent, style: jd(o2.getCurComponent.chartContain.dropInfo) });
        g2().then(), l3.forEach((l4) => {
          !function(e5, l5) {
            ...
            a2(n2(e5.style, { x: o2.getCanvasConfig.width / 2, y: o2.getCanvasConfig.height / 2, bottom: 0, right: 0, halfWidth: 0, halfHeight: 0 })), a2(n2(e5.style, { x: 0, y: 0, bottom: o2.getCanvasConfig.height, right: o2.getCanvasConfig.width, halfWidth: 0, halfHeight: 0 })), o2.getGuideLine.lineListX.forEach((t3) => {
              ...
              const i2 = jd(t3.chartContain.dropInfo), { x: r2, y: s2, bottom: u3, right: c2 } = i2, d2 = i2.width / 2, p2 = i2.height / 2;
  ...
  }), (e3, o3) => (s(), r("div", { class: c(d(l2)) }, [(s(true), r(m, null, v(Object.keys(t2.lineStatus), (e4) => O((s(), r("div", { key: e4, ref_for: true, ref: (o4) => t2.lineStatus[e4].node = o4, class: c(["line", e4.includes("横") ? "xLine" : "yLine"]) }, [p("div", sh, S(t2.lineStatus[e4].pos), 1)], 2)), [[z, t2.lineStatus[e4].show || false]])), 128))], 2));
} }), ch = Kt(uh, [["__scopeId", "data-v-88d9d34f"]]), dh = e({ name: "ChartMultiSelect", __name: "index", props: { selectArea: { type: Object, default: () => {
} } }, setup(e2) {
  const t2 = Nr(), { prefixCls: o2 } = we("select-area");
...
} }), ph = Kt(dh, [["__scopeId", "data-v-e9844525"]]), fh = e({ name: "ScreenCanvas", __name: "index", setup(e2) {
  const { prefixCls: t2 } = we("screen-canvas"), n2 = Nr(), p2 = Zd(), y2 = o("screenCanvasRef"), { getAntdLocale: C2 } = $t(), { antTheme: b2 } = _e(l(() => n2.getTheme)), w2 = l(() => [...n2.getComponentList].reverse()), x2 = a({ canvasX: 0, canvasY: 0, area: { show: false, x: 0, y: 0, width: 0, height: 0 }, comMoving: false, isUp: false }), S2 = l(() => ({ ...Td(n2.getCanvasConfig), transform: `scale(${n2.getScale})` })), _2 = (e3) => {
    var _a2, _b;
    if (((_b = (_a2 = e3.chart) == null ? void 0 : _a2.events) == null ? void 0 : _b.emits) && e3.chart.events.emits.length > 0) {
      for (const t3 of e3.chart.events.emits) if (t3 === as.CHART_CLICK || t3 === as.CHART_DBLCLICK) return "allow-pointer";
    }
  ...
  i(() => {
    n2.setScreenCanvas(y2.value ?? null), Dd.on(Fr.MOVE, () => {
      x2.comMoving || (x2.comMoving = true);
    }), Dd.on(Fr.UN_MOVE, () => {
      x2.comMoving = false;
    }), Dd.on(Fr.CREATE_CHART, (e3) => {
      L2(e3, 0, 0);
    });
  });
  const $2 = (e3) => {
    ...
    const t3 = (_a2 = e3.dataTransfer) == null ? void 0 : _a2.getData(Rr);
  ...
  return (e3, o2) => (s(), r("div", { ref_key: "screenCanvasRef", ref: y2, class: c(d(t2)), onDrop: $2, onDragstart: o2[0] || (o2[0] = k(() => {
    ...
    var _a2;
    return s(), h(th, { key: ((_a2 = e4.chart) == null ? void 0 : _a2.id) + d(n2).getKey, index: w2.value.length - t3 - 1, "com-option": e4, class: c(_2(e4)) }, { default: M(() => {
      var _a3;
      return [(s(), h(j(e4.chart.type && d(Id)[e4.chart.type].component), { class: c(["component", { move: x2.comMoving && e4.chart.id !== ((_a3 = d(n2).getCurComponent) == null ? void 0 : _a3.chart.id) }]), id: `com${e4.chart.id}`, chart: e4.chart, "chart-contain": e4.chartContain }, null, 8, ["class", "id", "chart", "chart-contain"]))];
    }), _: 2 }, 1032, ["index", "com-option", "class"]);
  }), 128))]), _: 1 }, 8, ["locale", "theme"]), g(ph, { "select-area": x2.area }, null, 8, ["select-area"]), g(ch)], 38));
} }), hh = Kt(fh, [["__scopeId", "data-v-9395352a"]]), gh = 0.2, yh = e({ name: "FrameCanvas", __name: "index", props: { width: { type: Number, default: 5e3 }, height: { type: Number, default: 3e3 } }, setup(e2) {
  const t2 = y(true), { prefixCls: l2 } = we("frame-canvas"), a2 = y(0), u2 = y(0), f2 = y(1e3), h2 = y(1), m2 = Nr(), v2 = o("frameCanvasRef"), C2 = o("dropContentRef");
  let b2 = [0, 0], w2 = [0, 0];
  ...
  const x2 = Pe(() => {
    t2.value && (!function() {
      if (d(t2) && v2.value) {
        ...
        h2.value = n2 > l3 ? Number.parseFloat((o2 * l3 / m2.getCanvasConfig.width).toFixed(2)) : Number.parseFloat((t3 / l3 / m2.getCanvasConfig.height).toFixed(2)), d(h2) > 5 && (h2.value = 5), d(h2) < gh && (h2.value = gh);
      }
      m2.setScale(d(h2));
    }(), D2());
  }, 30);
  ...
  const $2 = Pe((e3) => {
    ...
    h2.value = "add" === e3 ? Math.min(5, Number.parseFloat((t3 + 0.05).toFixed(2))) : Math.max(gh, Number.parseFloat((t3 - 0.05).toFixed(2))), D2(), m2.setScale(h2.value);
  }, 100), L2 = Pe((e3) => {
  ...
  return (o2, n2) => (s(), r("div", { class: c(d(l2)), ref_key: "frameCanvasRef", ref: v2 }, [g(Ff, { "ruler-x-left": a2.value, "ruler-y-top": u2.value, drift: f2.value, "ruler-x": e2.width, "ruler-y": e2.height }, null, 8, ["ruler-x-left", "ruler-y-top", "drift", "ruler-x", "ruler-y"]), p("div", { ref_key: "dropContentRef", ref: C2, class: "drop-content", onScroll: S2 }, [g(Ef, { width: e2.width, height: e2.height, drift: f2.value }, { default: M(() => [g(hh, { draggable: "true", onDragstart: k(T2, ["prevent", "stop"]) })]), _: 1 }, 8, ["width", "height", "drift"])], 544), g(Vf), g(Gf, { scale: h2.value, "min-scale": 20, "max-scale": 500, onAddScale: n2[0] || (n2[0] = (e3) => d($2)("add")), onReduceScale: n2[1] || (n2[1] = (e3) => d($2)("reduce")), onChangeScale: d(L2), onAutoScale: n2[2] || (n2[2] = (e3) => t2.value = e3) }, null, 8, ["scale", "min-scale", "max-scale", "onChangeScale"])], 2));
} }), mh = Kt(yh, [["__scopeId", "data-v-de9ae999"]]), vh = { key: 0, class: "header" }, Ch = { class: "title" }, bh = { class: "content" }, Mh = Kt(e({ name: "FrameBox", __name: "index", props: { showHeader: { type: Boolean, default: true }, icon: { type: String, default: "" }, iconSize: { type: Number, default: 14 }, title: { type: String, default: "" }, radioData: { type: Array, default: () => [] }, span: { type: Number, default: 8 }, chart: { type: Object } }, emits: ["radioChange", "titleClick"], setup(e2, { emit: t2 }) {
  ...
  return (t3, l3) => (s(), r("div", { class: c(d(n2)) }, [e2.showHeader ? (s(), r("div", vh, [p("div", { class: "icon-title", onClick: C2 }, [e2.icon ? (s(), h(d(Te), { key: 0, class: "title", icon: e2.icon, size: e2.iconSize }, null, 8, ["icon", "size"])) : f("", true), p("div", Ch, S(e2.title), 1)]), g(d(Y), { class: "radio-group", size: "small", value: a2.value, "onUpdate:value": l3[0] || (l3[0] = (e3) => a2.value = e3), onChange: u2 }, { default: M(() => [(s(true), r(m, null, v(o2.radioData, (e3) => (s(), h(d(G), { key: e3.value, title: e3.tooltip }, { default: M(() => [g(d(Z), { class: "radio-button", value: e3.value }, { default: M(() => [g(d(Te), { icon: e3.icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["value"])]), _: 2 }, 1032, ["title"]))), 128))]), _: 1 }, 8, ["value"])])) : f("", true), p("div", bh, [(s(), h(j(e2.chart))), R(t3.$slots, "default", {}, void 0, true)])], 2));
} }), [["__scopeId", "data-v-8929fb33"]]), kh = { class: "item-content" }, wh = ["src"], xh = { class: "title", style: { flex: "1" } }, Sh = { class: "iconContain" }, _h = e({ __name: "LayerItem", props: { parentItem: { type: Object }, item: { type: Object, required: true }, showEye: { type: Boolean, default: true }, showLock: { type: Boolean, default: true }, index: { type: Number }, expand: { type: Boolean, default: false }, externalSelect: { type: Boolean, default: false }, isSelect: { type: Boolean, default: false } }, emits: ["expand", "select", "enter", "leave"], setup(e2, { emit: o2 }) {
  t((e3) => ({ "56d1bd00": C2.value }));
  const n2 = e2, a2 = o2, { prefixCls: i2 } = we("layer-item"), u2 = Nr(), g2 = Br(), m2 = l(() => u2.getChartImg(n2.item.chart.type)), { token: v2 } = E.useToken(), C2 = l(() => v2.value.colorInfoBg), b2 = xe().getThemeColor, M2 = l(() => {
  ...
  return (t2, o3) => {
    var _a2;
    return s(), r("div", { class: c(M2.value), onMouseenter: w2, onMouseleave: x2, onMousedown: $2 }, [p("div", kh, [e2.item.chart.type === d(es).MfCombine ? (s(), r("div", { key: 0, onClick: _2 }, [n2.expand ? (s(), h(d(pt), { key: 0, class: "group", "two-tone-color": d(b2) }, null, 8, ["two-tone-color"])) : (s(), h(d(ft), { key: 1, class: "group", "two-tone-color": d(b2) }, null, 8, ["two-tone-color"]))])) : (s(), r("img", { key: 1, class: "img", alt: "组件", src: m2.value }, null, 8, wh)), p("span", xh, S((_a2 = e2.item) == null ? void 0 : _a2.chart.name), 1), p("div", Sh, [!e2.showEye || d(g2).getLayerCollapsed || !k2.value && e2.item.chartContain.show ? f("", true) : (s(), h(d(Te), { key: 0, class: "icon", icon: e2.item.chartContain.show ? "ant-design:eye-outlined" : "ant-design:eye-invisible-outlined", onClick: o3[0] || (o3[0] = () => e2.item.chartContain.show = !e2.item.chartContain.show) }, null, 8, ["icon"])), e2.showLock && !d(g2).getLayerCollapsed && (k2.value || e2.item.chartContain.lock) ? (s(), h(d(Te), { key: 1, class: "icon", icon: e2.item.chartContain.lock ? "ant-design:lock-outlined" : "ant-design:unlock-outlined", onClick: o3[1] || (o3[1] = () => e2.item.chartContain.lock = !e2.item.chartContain.lock) }, null, 8, ["icon"])) : f("", true)])])], 34);
  };
} }), $h = Kt(_h, [["__scopeId", "data-v-925f45da"]]), Lh = e({ __name: "LayerGroup", props: { item: { type: Object, required: true }, expand: { type: Boolean, default: false }, showEye: { type: Boolean, default: true }, showLock: { type: Boolean, default: true }, showChildEye: { type: Boolean, default: true }, showChildLock: { type: Boolean, default: true }, externalSelect: { type: Boolean, default: false }, isSelect: { type: Boolean, default: false }, childSelect: { type: String, default: "" } }, emits: ["parentClick", "childClick"], setup(e2, { emit: t2 }) {
  const o2 = e2, a2 = t2, { prefixCls: i2 } = we("layer-group"), u2 = Nr(), p2 = Br(), f2 = l(() => ({ "child-item": true, collapsed: p2.getLayerCollapsed })), C2 = y(o2.expand);
  function b2() {
    var _a2;
  ...
  return n(() => o2.expand, (e3) => C2.value = e3), (t3, o3) => (s(), r("div", { class: c(d(i2)), onMouseenter: b2, onMouseleave: k2 }, [g($h, { item: e2.item, onExpand: x2, expand: C2.value, "show-eye": e2.showEye, "show-lock": e2.showLock, "external-select": e2.externalSelect, "is-select": e2.isSelect, onClick: S2 }, null, 8, ["item", "expand", "show-eye", "show-lock", "external-select", "is-select"]), g(d(Tt), { show: C2.value, class: c(f2.value) }, { default: M(() => [(s(true), r(m, null, v(e2.item.chart.options.components, (t4, o4) => (s(), h($h, { key: t4.chart.id, "parent-item": e2.item, item: t4, index: o4, "external-select": e2.externalSelect, "is-select": e2.childSelect === t4.chart.id, "show-eye": e2.showChildEye, "show-lock": e2.showChildLock, onSelect: (t5) => function(e3, t6) {
...
} }), Ih = Kt(Lh, [["__scopeId", "data-v-b118e01c"]]), Dh = ["onDrop"], Th = e({ name: "FrameLayer", __name: "index", props: { collapsed: Lt.bool.def(false) }, setup(e2) {
  ...
  i(() => {
    ...
    Gi({ types: e3, pageNum: 1, pageSize: 1e4 }).then((e4) => {
      var _a2;
      e4 && ((_a2 = e4.list) == null ? void 0 : _a2.length) > 0 && e4.list.forEach((e5) => {
        f2.hasChartImg(e5.type) || st(rt(e5 == null ? void 0 : e5.picKey), { errorMessageMode: "none" }).then((t3) => {
          f2.setChartImg(e5.type, t3);
        });
      });
    });
  });
  const u2 = y(false), f2 = Nr(), m2 = Br(), v2 = (e3) => {
  ...
  function b2(e3, t3) {
    var _a2;
    e3.stopPropagation();
    const o3 = (_a2 = e3.dataTransfer) == null ? void 0 : _a2.getData(Rr);
    if (o3) {
  ...
  function k2(e3, t3, o3) {
    !o3.ctrlKey && !o3.metaKey || 0 !== o3.button ? 0 === o3.button && (f2.cleanSelectArea(), f2.setCurComponent(e3, t3)) : tp(e3);
  }
  function w2() {
  ...
  return (e3, t3) => (s(), h(Mh, { class: c(n2.value), title: d(m2).getLayerCollapsed ? "" : "图层", icon: "iconfont:icon-mfish-layer", "icon-size": d(m2).getLayerCollapsed ? 16 : 12, "radio-data": a2, onTitleClick: C2, onDrop: t3[1] || (t3[1] = (e4) => b2(e4, r2.value.length)), onRadioChange: x2 }, { default: M(() => [0 === r2.value.length ? (s(), h(d(be), { key: 0, "image-style": d(m2).getLayerCollapsed ? { height: "20px" } : {}, description: "暂无图层", image: d(et) }, null, 8, ["image-style", "image"])) : (s(), h(d(ht), { key: 1 }, { default: M(() => [g(d(Dt), { "item-key": "id", modelValue: r2.value, "onUpdate:modelValue": t3[0] || (t3[0] = (e4) => r2.value = e4), animation: "300", "ghost-class": "ghost", onChange: v2 }, { item: M(({ index: e4, element: t4 }) => [p("div", { onDrop: (t5) => b2(t5, e4), style: { "margin-top": "4px" } }, [t4.chart.type !== d(es).MfCombine ? (s(), h($h, { key: 0, item: t4, onMousedown: (o3) => k2(t4, e4, o3), onEnter: (e5) => {
    return o3 = t4, void f2.setCurHoverComponent(o3 == null ? void 0 : o3.chart.id);
    var o3;
  }, onLeave: w2 }, null, 8, ["item", "onMousedown", "onEnter"])) : (s(), h(Ih, { key: 1, item: t4, expand: u2.value, "show-child-lock": false, onMousedown: (o3) => k2(t4, e4, o3) }, null, 8, ["item", "expand", "onMousedown"]))], 40, Dh)]), _: 1 }, 8, ["modelValue"])]), _: 1 }))]), _: 1 }, 8, ["class", "title", "icon-size"]));
} }), Nh = Kt(Th, [["__scopeId", "data-v-3b66e5f3"]]), Bh = { class: "menu-item-hide-title" }, Rh = { class: "title" }, qh = Kt(e({ __name: "ChartMenus", props: { itemHeight: { type: Number }, width: { type: Number, default: 68 }, collapsed: { type: Boolean, default: false }, horizontal: { type: Boolean, default: false }, hideTitle: { type: Boolean, default: false }, backgroundColor: { type: Object, default: () => ({ light: "transparent", dark: "transparent" }) }, menus: { type: Array, default: () => [] } }, emits: ["menuClick", "menuChange"], setup(e2, { emit: o2 }) {
  ...
  return (t2, o3) => (s(), r("div", { class: c(d(f2)) }, [g(d(te), { class: c({ collapsed: e2.collapsed }), "selected-keys": C2.value, "onUpdate:selectedKeys": o3[0] || (o3[0] = (e3) => C2.value = e3), onClick: _2 }, { default: M(() => [g(d(ht), null, { default: M(() => [(s(true), r(m, null, v(e2.menus, (t3) => (s(), h(d(ke), { id: t3.name, key: t3.value, style: u({ height: `${e2.itemHeight}px` }) }, { default: M(() => [e2.hideTitle ? (s(), h(d(G), { key: 0, title: t3.name, placement: "right" }, { default: M(() => [p("div", Bh, [g(d(Te), { style: u({ lineHeight: `${e2.itemHeight}px` }), icon: t3.icon }, null, 8, ["style", "icon"])])]), _: 2 }, 1032, ["title"])) : (s(), r("div", { key: 1, class: c(e2.horizontal ? "menu-item-horizontal" : "menu-item-vertical") }, [g(d(Te), { icon: t3.icon }, null, 8, ["icon"]), p("div", Rh, S(t3.name), 1)], 2))]), _: 2 }, 1032, ["id", "style"]))), 128))]), _: 1 })]), _: 1 }, 8, ["class", "selected-keys"])], 2));
} }), [["__scopeId", "data-v-dea86191"]]), Ah = ["onDragstart", "onDblclick"], Oh = { class: "box-header" }, jh = { class: "box-header-text" }, zh = { class: "box-content" }, Fh = ["src"], Ph = e({ __name: "ChartItems", props: { charts: { type: Array, default: () => [] }, mode: { type: String, default: "single" } }, setup(e2) {
  const t2 = e2, { prefixCls: o2 } = we("chart-items"), l2 = Nr();
  return n(() => t2.charts, (e3) => {
    e3.forEach((e4) => {
      const t3 = e4 == null ? void 0 : e4.type;
      t3 && (e4 == null ? void 0 : e4.picKey) && !l2.hasChartImg(t3) && st(rt(e4 == null ? void 0 : e4.picKey), { errorMessageMode: "none" }).then((e5) => {
        l2.setChartImg(t3, e5);
      });
    });
  }, { immediate: true }), (t3, n2) => (s(), h(d(ht), { class: c(d(o2)) }, { default: M(() => [p("div", { class: c(["items", "single" === e2.mode ? e2.mode : [e2.mode, "miniAnimation"]]) }, [(s(true), r(m, null, v(e2.charts, (t4) => {
    return s(), r("div", { draggable: "true", key: t4.type, class: "item-box", onDragstart: (e3) => function(e4, t5) {
      var _a2, _b, _c2;
      const o4 = qd(t5);
      if (!o4) return;
      const l3 = e4.currentTarget;
      "img" === e4.target.className ? (_a2 = e4.dataTransfer) == null ? void 0 : _a2.setDragImage(l3, e4.offsetX + 15, e4.offsetY + 32) : (_b = e4.dataTransfer) == null ? void 0 : _b.setDragImage(l3, e4.offsetX, e4.offsetY), (_c2 = e4.dataTransfer) == null ? void 0 : _c2.setData(Rr, JSON.stringify(o4));
    }(e3, t4), onDblclick: (e3) => function(e4) {
      const t5 = qd(e4);
      t5 && Dd.emit(Fr.CREATE_CHART, t5);
    }(t4) }, [p("div", Oh, [g(d(Da), { disabled: true, size: "single" === e2.mode ? "small" : "mini" }, null, 8, ["size"]), p("span", jh, S(t4.name), 1)]), p("div", zh, [p("img", { class: "img", alt: "组件图片", src: (o3 = t4.type, l2.getChartImg(o3)) }, null, 8, Fh)])], 40, Ah);
    var o3;
  }), 128))], 2)]), _: 1 }, 8, ["class"]));
} }), Eh = Kt(Ph, [["__scopeId", "data-v-74651cba"]]), Hh = e({ name: "FrameChart", __name: "index", props: { collapsed: Lt.bool.def(false) }, setup(e2) {
  const t2 = e2, o2 = Br(), n2 = y(), a2 = y(), r2 = y(""), u2 = y(/* @__PURE__ */ new Map()), f2 = l(() => a2.value && a2.value.length > 0 ? a2.value.map((e3) => ({ name: e3.categoryName, icon: e3.icon, value: e3.id, children: e3.children })) : []), m2 = l(() => {
    var _a2;
    if (n2.value) {
  ...
  i(() => {
    Nt("screen_charts_type", "down").then((e3) => {
  ...
  function $2(e3, t3) {
    let o3;
    o3 = "所有" === t3 ? m2.value.find((t4) => t4.value === e3).parentId : e3, r2.value = o3, u2.value.has(o3) || Gi({ category: o3, pageNum: 1, pageSize: 1e3 }).then((e4) => {
      u2.value.set(o3, e4.list);
    });
  }
  return (t3, o3) => (s(), h(Mh, { title: "组件", icon: "iconfont:icon-mfish-chart", "icon-size": 12, "radio-data": b2, onRadioChange: w2, class: c(k2.value), onTitleClick: S2 }, { default: M(() => [p("div", { class: c(`${d(v2)}-content`) }, [g(qh, { menus: f2.value, "item-height": 58, "background-color": { light: "#f0f2f5", dark: "#232324" }, onMenuClick: x2, onMenuChange: _2 }, null, 8, ["menus"]), p("div", { class: c(["charts", { collapsed: e2.collapsed }]) }, [g(qh, { menus: m2.value, collapsed: e2.collapsed, "hide-title": true, "background-color": { light: "#f8f8f9", dark: "#1e1e1f" }, horizontal: true, "item-height": 28, width: 40, onMenuChange: $2 }, null, 8, ["menus", "collapsed"]), g(Eh, { mode: C2.value, charts: u2.value.get(r2.value) }, null, 8, ["mode", "charts"])], 2)], 2)]), _: 1 }, 8, ["class"]));
} }), Qh = Kt(Hh, [["__scopeId", "data-v-3b8e6093"]]), Gh = ["onClick"], Uh = { class: "name" }, Vh = { class: "short-cut" }, Wh = e({ __name: "SubMenu", props: { subData: { type: Array, default: () => [] } }, setup(e2, { expose: t2 }) {
  const { prefixCls: l2 } = we("frame-shortcut"), n2 = y(false), a2 = y(0), i2 = o("subMenuRef"), C2 = xe().getThemeColor;
  return t2({ show: function(e3) {
    n2.value = true;
  }, hidden: function() {
    n2.value = false;
  } }), (t3, o2) => (s(), h(P, { name: "shortcut" }, { default: M(() => [O(p("div", { ref_key: "subMenuRef", ref: i2, class: c(d(l2)), style: u({ top: `${a2.value}px`, left: "160px" }) }, [(s(true), r(m, null, v(e2.subData, (e3) => (s(), r(m, { key: e3.name }, [p("div", { class: "menu-item", onClick: e3.action }, [g(d(Te), { icon: e3.icon, color: d(C2) }, null, 8, ["icon", "color"]), p("span", Uh, S(e3.name), 1), p("span", Vh, S(e3.shortcut), 1)], 8, Gh), e3.divider ? (s(), r("div", { key: 0, class: c(`${d(l2)}__divider`) }, null, 2)) : f("", true)], 64))), 128))], 6), [[z, n2.value]])]), _: 1 }));
} }), Zh = Kt(Wh, [["__scopeId", "data-v-f4307b07"]]), Yh = { class: "short-cut" }, Kh = { class: "short-cut" }, Xh = { class: "short-cut" }, Jh = ["onClick"], eg = { class: "name" }, tg = { class: "short-cut" }, og = e({ name: "FrameShortcut", __name: "index", props: { menuTop: { type: Number, default: 0 }, menuLeft: { type: Number, default: 0 }, isUp: { type: Boolean, default: false } }, setup(e2, { expose: t2 }) {
  const n2 = e2, i2 = l(() => ({ top: `${n2.menuTop}px`, left: `${n2.menuLeft}px` })), y2 = xe().getThemeColor, { prefixCls: b2 } = we("frame-shortcut"), w2 = Zd(), x2 = Nr(), _2 = o("frameShortcutRef"), $2 = o("canvasAlignMenuRef"), L2 = o("selectAlignMenuRef"), I2 = o("fitMenuRef"), { NoneShortcutKeyEnum: D2 } = np(x2, w2);
  ...
  const T2 = l(() => x2.getSelectArea.components.length > 1), N2 = a([{ icon: "iconfont:icon-mfish-copy", name: "复制", shortcut: "CTRL+C", action: w2.copyComponent, show: l(() => x2.getCurComponent || x2.getSelectArea.components.length > 0) }, { icon: "iconfont:icon-mfish-paste", name: "粘贴", shortcut: "CTRL+V", action: w2.pasteComponent, show: l(() => w2.getCopyData), divider: true }, { icon: "iconfont:icon-mfish-up-level", name: "上移一层", shortcut: "SHIFT+↑", action: w2.upComponent, show: l(() => x2.getCurComponent && !d(T2)) }, { icon: "iconfont:icon-mfish-down-level", name: "下移一层", shortcut: "SHIFT+↓", action: w2.downComponent, show: l(() => x2.getCurComponent && !d(T2)) }, { icon: "iconfont:icon-mfish-up-level", name: "置顶", shortcut: "CTRL+SHIFT+↑", action: w2.topComponent, show: l(() => x2.getCurComponent && !d(T2)) }, { icon: "iconfont:icon-mfish-bottom-level", name: "置底", shortcut: "CTRL+SHIFT+↓", action: w2.bottomComponent, show: l(() => x2.getCurComponent && !d(T2)), divider: true }, { icon: "iconfont:icon-mfish-combine", name: "组合", shortcut: "CTRL+G", action: w2.composeComponent, show: l(() => x2.getSelectArea.components.length > 1) }, { icon: "iconfont:icon-mfish-un-combine", name: "拆分", shortcut: "CTRL+SHIFT+G", action: w2.decomposeComponent, show: l(() => {
    var _a2;
    return ((_a2 = x2.getCurComponent) == null ? void 0 : _a2.chart.type) === es.MfCombine && !d(T2);
  ...
  function q2() {
    var _a2;
    z2(op.CANVAS), (_a2 = $2.value) == null ? void 0 : _a2.show(n2.isUp);
  }
  function A2() {
    var _a2;
  ...
  function O2() {
    var _a2;
    z2(op.GROUP), (_a2 = L2.value) == null ? void 0 : _a2.show(n2.isUp);
  }
  function j2() {
    var _a2;
  ...
  function z2(e3) {
    w2.setAlignType(e3), 0 === x2.getSelectArea.components.length && x2.getCurComponent && w2.setAlignType(op.CANVAS);
  }
  function F2() {
    var _a2;
  ...
  }, ["stop"])) }, [g(d(Te), { icon: "iconfont:icon-mfish-left-align", color: d(y2) }, null, 8, ["color"]), t3[4] || (t3[4] = p("span", { class: "name" }, "画布对齐", -1)), p("span", Yh, [g(d(Te), { icon: "ant-design:right-outlined" })]), g(Zh, { ref_key: "canvasAlignMenuRef", ref: $2, "sub-data": B2 }, null, 8, ["sub-data"])], 32)) : f("", true), d(x2).getSelectArea.components.length > 1 ? (s(), r("div", { key: 1, class: "menu-item", onMouseenter: O2, onMouseleave: j2, onMouseup: t3[1] || (t3[1] = k(() => {
  }, ["stop"])) }, [g(d(Te), { icon: "iconfont:icon-mfish-left-align", color: d(y2) }, null, 8, ["color"]), t3[5] || (t3[5] = p("span", { class: "name" }, "选中对齐", -1)), p("span", Kh, [g(d(Te), { icon: "ant-design:right-outlined" })]), g(Zh, { ref_key: "selectAlignMenuRef", ref: L2, "sub-data": B2 }, null, 8, ["sub-data"])], 32)) : f("", true), d(x2).getCurComponent ? (s(), r("div", { key: 2, class: "menu-item", onMouseenter: F2, onMouseleave: E2, onMouseup: t3[2] || (t3[2] = k(() => {
  }, ["stop"])) }, [g(d(Te), { icon: "carbon:fit-to-screen", color: d(y2) }, null, 8, ["color"]), t3[6] || (t3[6] = p("span", { class: "name" }, "撑满", -1)), p("span", Xh, [g(d(Te), { icon: "ant-design:right-outlined" })]), g(Zh, { ref_key: "fitMenuRef", ref: I2, "sub-data": R2 }, null, 8, ["sub-data"])], 32)) : f("", true), d(x2).getCurComponent || d(x2).getSelectArea.components.length > 1 ? (s(), r("div", { key: 3, class: c(`${d(b2)}__divider`) }, null, 2)) : f("", true), (s(true), r(m, null, v(N2, (e4) => (s(), r(m, { key: e4.name }, [e4.show ? (s(), r("div", { key: 0, class: "menu-item", onClick: (t4) => {
    return o2 = e4.action, w2.setShowMenu(false), void C(() => {
      o2();
    });
    var o2;
  } }, [g(d(Te), { icon: e4.icon, color: d(y2) }, null, 8, ["icon", "color"]), p("span", eg, S(e4.name), 1), p("span", tg, S(e4.shortcut), 1)], 8, Jh)) : f("", true), e4.show && e4.divider ? (s(), r("div", { key: 1, class: c(`${d(b2)}__divider`) }, null, 2)) : f("", true)], 64))), 128))], 38)) : f("", true)]), _: 1 }));
} }), lg = Kt(og, [["__scopeId", "data-v-2dcb7415"]]);
export {
  yl as $,
  Jl as A,
  Wo as B,
