...
import { cloneDeep as qe, debounce as Ae, once as je, isElement as Oe, merge as ze, uniqueId as Ee, sum as Pe, random as Fe, throttle as He, omit as Qe } from "lodash-es";
...
const to = (e2, t2) => {
  ...
  const o2 = e2, i2 = m(""), f2 = l({ r: 0, g: 0, b: 0, a: 100 }), { prefixCls: h2 } = xe("color-text"), { token: y2 } = F.useToken(), v2 = a(() => y2.value.colorBorder), C2 = a(() => `rgba(${f2.r}, ${f2.g}, ${f2.b}, ${f2.a / 100})`);
  function b2() {
  ...
  const o2 = e2, l2 = m(zt), i2 = m([]), { prefixCls: f2 } = xe("color-recently"), { token: h2 } = F.useToken(), g2 = a(() => h2.value.colorBorder);
  function C2(e3, t2) {
    return e3.map((e4) => {
      const o3 = new Xt();
  ...
  const l2 = e2, i2 = o2, f2 = m([]), { prefixCls: h2 } = xe("color-recently"), { token: g2 } = F.useToken(), C2 = a(() => g2.value.colorBorder), b2 = m();
  ...
  const w2 = m(0), x2 = m([]), S2 = m(45), _2 = m(), $2 = o("barRef"), L2 = m([]), { prefixCls: I2 } = xe("gradient-color"), { token: D2 } = F.useToken(), T2 = a(() => D2.value.colorBorder), N2 = a(() => _2.value ? { background: _2.value } : {});
  function B2(e3) {
  ...
  function G2(e3) {
    e3.startsWith("linear-gradient(") ? (D2.value = e3, S2.value = Ft(e3), i2("inputChange", e3)) : (e3.value.fromString(e3), _2.value = e3.value.toHex());
  }
  function U2(e3) {
    R2.value = false, 2 === v2.value ? (D2.value = e3, S2.value = Ft(e3), Y2(e3), C(() => i2("confirmChange", d(D2), d(_2)))) : z2();
  }
  function W2() {
    R2.value = false, j2(), C(() => i2("confirmChange", d(D2), d(_2)));
  }
  function Y2(e3) {
    let t2 = [];
    const o3 = (e4, o4, a2) => {
    ...
    if (2 === v2.value) {
      return o3(localStorage.getItem(Ot), Et, e3), t2 = t2.slice(0, 14), void localStorage.setItem(Ot, JSON.stringify(t2));
    }
    o3(localStorage.getItem(jt), zt, e3), t2 = t2.slice(0, 20), localStorage.setItem(jt, JSON.stringify(t2));
  }
  function Z2(e3) {
...
`("border"), Xo = e({ name: "BorderBox1", props: Ho(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: a2, refreshLayoutSize: n2, domSize: l2 } = Fo();
...
`("border-svg-container"), Ba = e({ name: "BorderBox12", props: Ho(), setup(e2, { slots: t2, expose: o2 }) {
  ...
  top: 0;
  left: 0;
`("border-svg-container"), Aa = e({ name: "BorderBox13", props: Ho(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: a2, refreshLayoutSize: n2, domSize: l2 } = Fo();
  return o2({ refreshLayoutSize: n2 }), () => {
...
const qn = Uo.div`
  width: 100%;
  height: 100%;
`("decoration-5"), An = e({ name: "Decoration5", props: { ...dn(), ...fn(1.2) }, setup(e2, { expose: t2 }) {
  const { autoBindRef: o2, refreshLayoutSize: a2, domSize: n2 } = Fo();
  return t2({ refreshLayoutSize: a2 }), () => {
    const { width: t3, height: a3 } = n2, { color: l2, duration: i2 } = e2, r2 = Qo(Bn, l2), { line1Sum: s2, line2Sum: u2, line1Point: c2, line2Point: d2 } = function(e3, t4) {
      ...
      return { line1Sum: Pe(Rn(o3)), line2Sum: Pe(Rn(a4)), line1Point: o3.map((e4) => e4.join(",")).join(" "), line2Point: a4.map((e4) => e4.join(",")).join(" ") };
    }(t3, a3);
...
const { points: zn, heights: En, minHeights: Pn, randoms: Fn } = function({ width: e2, height: t2, rowPoints: o2, rowCount: a2 }) {
  ...
  const { autoBindRef: o2, refreshLayoutSize: a2, domSize: n2 } = Fo();
  return t2({ refreshLayoutSize: a2 }), () => {
    const { width: t3, height: a3 } = n2, { color: l2 } = e2, i2 = Qo(jn, l2), r2 = { transform: `scale(${t3 / 300},${a3 / 35})` };
    return g(On, { ref: o2 }, { default: () => [g("svg", { class: "svg-origin", width: t3, height: a3, style: r2 }, [zn.map(([e3, t4], o3) => g("rect", { key: `rect${o3}`, fill: i2[Math.random() > 0.5 ? 0 : 1], x: e3 - 3.5, y: t4 - En[o3], width: 7, height: En[o3] }, [g("animate", { attributeName: "y", values: `${t4 - Pn[o3] / 2};${t4 - En[o3] / 2};${t4 - Pn[o3] / 2}`, dur: Fn[o3], keyTimes: "0;0.5;1", calcMode: "spline", keySplines: "0.42,0,0.58,1;0.42,0,0.58,1", begin: "0s", repeatCount: "indefinite" }, null), g("animate", { attributeName: "height", values: `${Pn[o3]};${En[o3]};${Pn[o3]}`, dur: Fn[o3], keyTimes: "0;0.5;1", calcMode: "spline", keySplines: "0.42,0,0.58,1;0.42,0,0.58,1", begin: "0s", repeatCount: "indefinite" }, null)]))])] });
  };
} }), Qn = Uo.div`
  display: flex;
  width: 100%;
...
`("decoration-7"), Gn = ["#2e6099", "#7ce7fd"], Un = e({ name: "Decoration7", props: dn(), setup(e2, { slots: t2, expose: o2 }) {
  const { autoBindRef: a2, refreshLayoutSize: n2 } = Fo();
  return o2({ refreshLayoutSize: n2 }), () => {
...
`("header-svg-container"), Il = e({ name: "Header6", props: Ho(), setup(e2, { expose: t2 }) {
  ...
  const R2 = m(0), q2 = m(0), A2 = "#303030", j2 = "#141414", O2 = "#1D1D1D", z2 = "#F0F0F0", E2 = "#FFFFFF", P2 = "#FAFAFA";
  function F2() {
  ...
  return n(() => c2.config, () => {
    ...
    e3 === Ge.DARK ? (C2.value.headerBGC === z2 && (C2.value.headerBGC = A2), C2.value.oddRowBGC === E2 && (C2.value.oddRowBGC = j2), C2.value.evenRowBGC === P2 && (C2.value.evenRowBGC = O2)) : (C2.value.headerBGC === A2 && (C2.value.headerBGC = z2), C2.value.oddRowBGC === j2 && (C2.value.oddRowBGC = E2), C2.value.evenRowBGC === O2 && (C2.value.evenRowBGC = P2));
  }, { immediate: true }), i(() => {
    q2.value = p2.value?.clientWidth || 0, R2.value = p2.value?.clientHeight || 0, Q2(), window.addEventListener("resize", F2);
  }), _(() => {
    H2(), window.removeEventListener("resize", F2);
  }), t2({ resize: F2, updateRows: function(e3, t3) {
...
const Pl = to(e({ __name: "TextFontStyle", props: { bold: { type: Boolean, default: false }, italic: { type: Boolean, default: false }, strikethrough: { type: Boolean, default: false }, underline: { type: Boolean, default: false }, hide: { type: Array, default: () => [] } }, emits: ["fontStyleChange"], setup(e2, { emit: t2 }) {
...
} }), [["__scopeId", "data-v-3b6dd2cf"]]), Fl = to(e({ __name: "TextHAlignStyle", props: { alignType: { type: String, default: void 0 } }, emits: ["alignChange"], setup(e2, { emit: t2 }) {
  ...
  const l2 = e2, i2 = o2, { prefixCls: u2 } = xe("text-style"), { token: y2 } = F.useToken(), v2 = a(() => y2.value.colorBorder), C2 = m(12), b2 = m(Kl[0].value), M2 = m(), k2 = m();
  function w2(e3) {
    const t2 = x2(e3);
  ...
  }, { immediate: true, deep: true }), (t2, o3) => (s(), r("div", { class: c(d(u2)) }, [p("div", Ql, [g(d(K), { style: { flex: "1" }, value: b2.value, "onUpdate:value": o3[0] || (o3[0] = (e3) => b2.value = e3), options: d(Kl), onChange: D2 }, null, 8, ["value", "options"]), p("div", Gl, [g(d(Q), { value: C2.value, "onUpdate:value": o3[1] || (o3[1] = (e3) => C2.value = e3), bordered: false, placeholder: "大小", controls: false, min: 6, maxlength: 4, onChange: T2 }, null, 8, ["value"]), o3[2] || (o3[2] = p("div", { class: "suffix" }, "px", -1))]), e2.hideAlign ? f("", true) : (s(), h(Fl, { key: 0, "align-type": e2.textStyle?.hAlignType, onAlignChange: L2 }, null, 8, ["align-type"]))]), p("div", Ul, [p("div", Vl, [g(d(Eo), { type: e2.colorType, "direct-confirm": true, value: M2.value, onConfirmChange: w2, onInputChange: x2 }, null, 8, ["type", "value"])]), g(Pl, $({ hide: e2.hideFontStyle }, k2.value, { onFontStyleChange: S2 }), null, 16, ["hide"])]), e2.verticalAlign ? (s(), r("div", Wl, [g(Hl, { "align-type": e2.textStyle?.vAlignType, onAlignChange: I2 }, null, 8, ["align-type"])])) : f("", true)], 2));
...
const ji = (e2) => Je.get({ url: "/nocode/mfApi/headers", params: e2 });
function Oi(e2) {
...
const Sr = (e2, t2, o2) => ({ CtrlKeysEnum: { s: Ae(() => o2(), 150), z: Ae(() => e2(), 150) }, CtrlShiftKeysEnum: { z: Ae(() => t2(), 150) } }), _r = et("custom-api", { state: () => ({ sourceId: "", sourceType: 0, tableName: "", tableFields: [], tableList: [], tableFieldsMap: /* @__PURE__ */ new Map(), variables: [], level: 1, fieldsChange: 1, showData: false, showDataLevel: "", formulaMap: /* @__PURE__ */ new Map() }), getters: { getSourceId() {
  ...
  return t2 ? (this.tableFields = await ji({ sourceId: e2, tableName: t2, sourceType: this.sourceType }), this.tableFields) : [];
}, setTableList(e2) {
...
const Dr = async (e2) => {
  ...
  if (this.setInitComplete(false), e2) {
    ...
    if (!t2) return;
    this.setComponentList(t2.componentList), this.setCanvasConfig(t2.canvasConfig), Cp(this.componentList).then((e3) => {
      Promise.all(e3).then(() => {
  ...
  e2.forEach((e3) => {
    bp(e3.chart), e3.chart.type === ns.MfCombine && e3.chart.options.components.forEach((e4) => {
      bp(e4.chart);
    });
  ...
  return l2.clear(), this.setComponentList(i2), Cp(this.componentList, this.isResource).then((e3) => {
    Promise.all(e3).then(() => {
      this.setUndoRedoData("初始化"), this.setInitComplete(true);
    });
  }), this.componentList;
...
} } }), jr = et("screen-layout", { state: () => ({ chartCollapsed: false, layerCollapsed: false, configCollapsed: false }), getters: { getChartCollapsed() {
...
} } }), Or = "menu_chart_drag", zr = "field_data_drag";
var Er = ((e2) => (e2.All = "all", e2.Chart = "chart", e2.Layer = "layer", e2.Config = "config", e2))(Er || {}), Pr = ((e2) => (e2.CurPage = "当前页", e2.NewTab = "新标签", e2.Dialog = "弹出窗", e2))(Pr || {}), Fr = ((e2) => (e2.System = "系统页面", e2.External = "外部页面", e2))(Fr || {}), Hr = ((e2) => (e2.FIT_ORIGINAL = "fit_original", e2.FIT_WIDTH = "fit_width", e2.FIT_WIDTH_SCALE = "fit_width_scale", e2.FIT_HEIGHT = "fit_height", e2.FIT_HEIGHT_SCALE = "fit_height_scale", e2.FIT_BOX = "fit_box", e2))(Hr || {});
...
function ls() {
  ...
  async function t2(t3) {
    ...
    t3.type && ip[t3.type].initData(t3, o2);
  }
...
const ss = (e2, t2) => {
  switch (e2) {
    ...
    case "mouseLeave":
      return "鼠标离开";
    default:
      return t2 ? ip[t2].customEvents?.find((t3) => t3.value === e2)?.name ?? "" : "";
  }
};
  ...
  const f2 = (t3) => {
    ...
    const o3 = (() => {
      ...
      const o4 = (() => {
        ...
        for (const o5 of e2.jump.params) if (o5.type === Ur.CONSTANT) t5[o5.name] = o5.value;
          ...
          const e3 = yp(a2.getComponentList, o5.value);
          e3 && (t5[o5.name] = e3);
        }
        return t5;
      })();
      if (e2.jump?.pageType === Fr.System) {
    ...
    switch (e2.jump?.type) {
      ...
      case Pr.NewTab:
        ...
        break;
      case Pr.Dialog:
        rp.emit(Qr.SHOW_MODAL, { ...t3, href: o3, jump: e2.jump });
    }
    c2(t3, "page_jump");
  };
  function h2(e3) {
  ...
  function m2(t3) {
    setTimeout(() => {
      ...
      e2.data.eventRefresh?.open && e2.data.eventRefresh?.events && (o3(e2).then((t4) => {
        e2.type && ip[e2.type]?.initData(e2, t4);
      }), c2(t3, "refresh"));
    }, 10);
  }
  function y2(t3) {
    rp.emit(Qr.EVENT_ANIMATION, { ...t3, chart: e2 }), c2(t3, "animation");
  }
  return n(() => e2?.jump, (t3) => {
    !function(t4) {
...
function ws() {
  const e2 = Ar(), { getDataTable: t2, setDataTable: o2 } = ls(), a2 = () => {
...
const As = { type: ns.MfBorder1, component: nt(() => import("./index9.js"), { loading: true }), create: qs, config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfBorderConfig.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, js = Object.freeze(Object.defineProperty({ __proto__: null, default: As, mfBorder1Create: qs }, Symbol.toStringTag, { value: "Module" })), Os = { ...As, type: ns.MfBorder10, component: nt(() => import("./index10.js"), { loading: true }) }, zs = Object.freeze(Object.defineProperty({ __proto__: null, default: Os }, Symbol.toStringTag, { value: "Module" }));
function Es(e2) {
...
} }, _u = Object.freeze(Object.defineProperty({ __proto__: null, default: Su, mfBorder8Create: xu }, Symbol.toStringTag, { value: "Module" })), $u = { ...As, type: ns.MfBorder9, component: nt(() => import("./index30.js"), { loading: true }) }, Lu = Object.freeze(Object.defineProperty({ __proto__: null, default: $u }, Symbol.toStringTag, { value: "Module" }));
function Iu(e2) {
...
const Au = { type: ns.MfDecoration11, component: nt(() => import("./index33.js"), { loading: true }), create: qu, config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecoration7Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, ju = Object.freeze(Object.defineProperty({ __proto__: null, default: Au, mfDecoration11Create: qu }, Symbol.toStringTag, { value: "Module" }));
function Ou(e2) {
...
const zu = { type: ns.MfDecoration12, component: nt(() => import("./index34.js"), { loading: true }), create: Ou, config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecoration12Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Eu = Object.freeze(Object.defineProperty({ __proto__: null, default: zu, mfDecoration12Create: Ou }, Symbol.toStringTag, { value: "Module" }));
function Pu(e2) {
...
const Fu = { type: ns.MfDecoration2, component: nt(() => import("./index35.js"), { loading: true }), create: Pu, config: (() => {
  const e2 = qe(ts);
  return e2.data.show = false, e2.style.payload.component = T(nt(() => import("./MfDecoration2Config.js"), { loading: true, size: "large" })), e2;
})(), initData: () => {
} }, Hu = Object.freeze(Object.defineProperty({ __proto__: null, default: Fu, mfDecoration2Create: Pu }, Symbol.toStringTag, { value: "Module" }));
function Qu(e2) {
...
function Bc() {
  const e2 = (e3, t3) => {
    ...
    for (let e4 = 0; e4 < t3.length; e4++) if (o2 && o2.length > e4) n2.push(o2[e4]);
      ...
      const t4 = ip[a2].defaultSeries;
      t4 ? t4.length > e4 ? n2.push(qe(t4[e4])) : n2.push(qe(t4[0])) : n2.push({});
    } else n2.push({});
    return n2;
  };
  function t2(t3) {
    t3?.data?.dataSet && t3?.type && (t3.data.dataSet = qe(ip[t3.type].defaultData), t3.options.series = e2(t3, ip[t3.type].defaultSeries || []));
  }
...
const Ac = { ...Rc, type: ns.MfBarHorizontal, create: function(e2) {
  const t2 = Rc.create(e2);
  return t2.chart.options = { ...t2.chart.options, xAxis: { show: true }, yAxis: { show: true, type: "category" } }, t2;
} }, jc = Object.freeze(Object.defineProperty({ __proto__: null, default: Ac }, Symbol.toStringTag, { value: "Module" }));
const Oc = { ...Rc, type: ns.MfBarStack, create: function(e2) {
  const t2 = Rc.create(e2);
...
}, defaultSeries: [{ type: "bar", stack: "total" }, { type: "bar", stack: "total" }], defaultData: { source: [["日期", "数据1", "数据2"], ["Mon", 120, 80], ["Tue", 200, 132], ["Wed", 150, 90], ["Thu", 80, 180], ["Fri", 70, 110], ["Sat", 110, 130], ["Sun", 130, 90]] } }, zc = Object.freeze(Object.defineProperty({ __proto__: null, default: Oc }, Symbol.toStringTag, { value: "Module" }));
const Ec = { ...Oc, type: ns.MfBarLine, defaultSeries: [{ type: "bar" }, { type: "line" }], create: function(e2) {
  const t2 = Oc.create(e2);
  return t2.chart.options.series = qe(Ec.defaultSeries), t2;
} }, Pc = Object.freeze(Object.defineProperty({ __proto__: null, default: Ec }, Symbol.toStringTag, { value: "Module" }));
const Fc = { ...Rc, type: ns.MfBarPlusMinus, create: function(e2) {
  const t2 = Rc.create(e2);
...
}, defaultData: { source: [["维度", "数据"], ["ten", -0.07], ["nine", -0.09], ["eight", 0.2], ["seven", -0.44], ["six", -0.23], ["five", 0.08], ["four", -0.17], ["three", 0.47], ["two", -0.36], ["one", 0.18]] } }, Hc = Object.freeze(Object.defineProperty({ __proto__: null, default: Fc }, Symbol.toStringTag, { value: "Module" }));
...
const Wc = { ...Oc, type: ns.MfLineAreaStack, create: function(e2) {
  const t2 = Oc.create(e2);
...
const Xc = { ...Oc, type: ns.MfLineStack, create: function(e2) {
  const t2 = Oc.create(e2);
...
const xd = { ...Rc, type: ns.MfScatter, create: function(e2) {
  ...
  const t2 = e2, { emitEvent: o2, commonEvents: a2 } = us(t2.chart, void 0, ["change", "pressEnter", "blur"]), l2 = m();
  function i2() {
    o2("change", d(l2));
  }
  function r2() {
...
function $d(e2) {
  return e2.chart.data.dataSet = qe(Ld.defaultData), e2.chart.data.headers = Ld.defaultHeaders && Ld.defaultHeaders(), e2.chart.data.defaultValue = "", e2.chart.data.limit = 1, e2.chart.data.maxLimit = 1, e2.chart.options.bordered = true, e2.chart.options.placeholder = "输入框", e2.chartContain.dropInfo.width = 200, e2.chartContain.dropInfo.height = 34, e2;
}
const Ld = { type: ns.MfInput, component: _d, create: $d, config: (() => {
  const e2 = qe(ts);
  return e2.style.payload.component = T(nt(() => import("./MfInputConfig.js"), { loading: true, size: "large" })), e2.data.payload.component = T(nt(() => import("./MfInputDataConfig.js"), { loading: true, size: "large" })), e2;
})(), defaultData: { value: "" }, defaultHeaders: () => qe({ value: { colName: "value", dataType: "string", rename: "值" } }), initData: (e2, t2) => {
  const { setDynamicData: o2 } = Id();
  o2(e2, t2);
}, customEvents: [{ name: "输入框值改变", value: "change" }, { name: "按下回车", value: "pressEnter" }, { name: "离开组件", value: "blur" }] };
function Id() {
  function e2(e3) {
    e3?.data?.dataSet && (e3.data.dataSet.value = bs.defaultData.value);
  }
...
const Dd = Object.freeze(Object.defineProperty({ __proto__: null, default: Ld, mfInputCreate: $d, useDataInput: Id }, Symbol.toStringTag, { value: "Module" })), Td = e({ name: "MfInputTextArea", __name: "index", props: { chart: { type: Object, required: true }, chartContain: { type: Object, required: true } }, setup(e2) {
  const t2 = e2, { emitEvent: o2, commonEvents: a2 } = us(t2.chart, void 0, ["change", "pressEnter", "blur"]), l2 = m();
  function i2() {
    o2("change", d(l2));
  }
...
const Bd = { ...Ld, type: ns.MfInputTextArea, component: Td, config: (() => {
  const e2 = qe(ts);
  return e2.style.payload.component = T(nt(() => import("./MfInputTextAreaConfig.js"), { loading: true, size: "large" })), e2.data.payload.component = T(nt(() => import("./MfInputDataConfig.js"), { loading: true, size: "large" })), e2;
})(), create: Nd }, Rd = Object.freeze(Object.defineProperty({ __proto__: null, default: Bd, mfInputTextAreaCreate: Nd }, Symbol.toStringTag, { value: "Module" })), qd = e({ name: "MfPicture", __name: "index", props: { chart: { type: Object, required: true }, chartContain: { type: Object, required: true } }, setup(e2) {
...
function Ad(e2) {
  return e2.chart.data.dataSet = qe(jd.defaultData), e2.chart.data.headers = jd.defaultHeaders && jd.defaultHeaders(), e2.chart.data.limit = 1, e2.chart.data.maxLimit = 1, e2.chart.options.preview = false, e2.chartContain.dropInfo.width = 200, e2.chartContain.dropInfo.height = 200, e2;
}
const jd = { type: ns.MfPicture, component: qd, create: Ad, config: (() => {
  const e2 = qe(ts);
...
} }, Od = Object.freeze(Object.defineProperty({ __proto__: null, default: jd, mfPictureCreate: Ad }, Symbol.toStringTag, { value: "Module" }));
function zd(e2) {
  return e2.chart.data.dataSet = qe(Ed.defaultData), e2.chart.data.headers = Ed.defaultHeaders && Ed.defaultHeaders(e2.chart), e2.chart.data.limit = 50, e2.chart.data.maxLimit = 1e3, e2.chartContain.dropInfo.width = 600, e2.chartContain.dropInfo.height = 300, e2.chart.options = { indexHeader: "序号", showHeader: true, index: true }, e2;
}
const Ed = { type: ns.MfScrollTable, component: nt(() => import("./index55.js"), { loading: true }), create: zd, config: (() => {
  const e2 = qe(ts);
...
const Fd = Object.freeze(Object.defineProperty({ __proto__: null, default: Ed, mfScrollTableCreate: zd, useDataScrollTable: Pd }, Symbol.toStringTag, { value: "Module" }));
function Hd(e2) {
  return e2.chart.data.dataSet = qe(Qd.defaultData), e2.chart.data.headers = Qd.defaultHeaders && Qd.defaultHeaders(e2.chart), e2.chart.data.limit = 10, e2.chart.data.maxLimit = 1e3, e2.chartContain.dropInfo.width = 600, e2.chartContain.dropInfo.height = 50, e2;
}
const Qd = { type: ns.MfSegmented, component: nt(() => import("./index56.js"), { loading: true }), create: Hd, config: (() => {
  const e2 = qe(ts);
...
const Ud = Object.freeze(Object.defineProperty({ __proto__: null, default: Qd, mfSegmentedCreate: Hd, useSegmented: Gd }, Symbol.toStringTag, { value: "Module" }));
function Vd(e2) {
  return e2.chart.data.dataSet = qe(Wd.defaultData), e2.chartContain.border.show = true, e2.chart.data.headers = Wd.defaultHeaders && Wd.defaultHeaders(e2.chart), e2.chart.data.defaultValue = "", e2.chart.data.limit = 10, e2.chart.data.maxLimit = 1e3, e2.chartContain.dropInfo.width = 150, e2.chartContain.dropInfo.height = 33, e2;
}
const Wd = { type: ns.MfSelect, component: nt(() => import("./index57.js"), { loading: true }), create: Vd, config: (() => {
  const e2 = qe(ts);
  return e2.style.payload.component = T(nt(() => import("./MfSelectConfig.js"), { loading: true, size: "large" })), e2.data.payload.component = T(nt(() => import("./MfSelectDataConfig.js"), { loading: true, size: "large" })), e2;
...
function Yd() {
  function e2(e3) {
    e3.data.dataSet = qe(Wd.defaultData);
  }
  return { resetDefault: e2, setDynamicData: function(t2, o2) {
    if (t2) {
      if (o2?.list?.length > 0) {
...
const Zd = Object.freeze(Object.defineProperty({ __proto__: null, default: Wd, mfSelectCreate: Vd, useSelect: Yd }, Symbol.toStringTag, { value: "Module" }));
function Kd(e2) {
  return e2.chart.data.dataSet = qe(Jd.defaultData), e2.chart.data.headers = Jd.defaultHeaders && Jd.defaultHeaders(e2.chart), e2.chart.data.limit = void 0, e2.chart.data.maxLimit = Number.MAX_VALUE, e2.chart.data.pagination = { pageSize: 5 }, e2.chartContain.dropInfo.width = 600, e2.chartContain.dropInfo.height = 380, e2.chart.options = { indexHeader: "序号", columns: [{ ellipsis: true, align: "center", width: 120 }, { ellipsis: true, align: "center", width: 120 }, { ellipsis: true, align: "center", width: 120 }], tableInfo: { scroll: { x: true, y: 330 }, columns: qe(Xd) } }, e2;
}
const Xd = [{ title: "姓名", dataIndex: "name" }, { title: "年龄", dataIndex: "age" }, { title: "地址", dataIndex: "address" }], Jd = { type: ns.MfTable, component: nt(() => import("./index58.js"), { loading: true }), create: Kd, config: (() => {
  const e2 = qe(ts);
...
function ep() {
  function e2(e3) {
    e3.data.dataSet = qe(Jd.defaultData), e3.options.tableInfo.columns = qe(Xd), e3.data.pagination = { pageSize: e3.data.pagination.pageSize }, e3.options.index && e3.options.tableInfo.columns.unshift({ title: e3.options.indexHeader || "序号", width: 80, align: "center", ellipsis: true });
  }
  return { resetDefault: e2, setDynamicData: function(t2, o2) {
    if (!t2) return;
    const a2 = t2.data.fields?.fieldName;
...
}, lp = Object.assign({ "./MfButton/mfButton.data.ts": fs, "./MfCombine/mfCombine.data.ts": gs, "./MfDataTag/mfDataTag.data.ts": ks, "./MfDataUi/MfDigits/mfDigits.data.ts": $s, "./MfDataUi/MfTireMarks/mfTireMarks.data.ts": Rs, "./MfDataUi/MfWheel/mfWheel.data.ts": Ts, "./MfDataV/MfBorder1/mfBorder1.data.ts": js, "./MfDataV/MfBorder10/mfBorder10.data.ts": zs, "./MfDataV/MfBorder11/mfBorder11.data.ts": Fs, "./MfDataV/MfBorder12/mfBorder12.data.ts": Qs, "./MfDataV/MfBorder13/mfBorder13.data.ts": Us, "./MfDataV/MfBorder14/mfBorder14.data.ts": Ys, "./MfDataV/MfBorder15/mfBorder15.data.ts": Ks, "./MfDataV/MfBorder16/mfBorder16.data.ts": Js, "./MfDataV/MfBorder17/mfBorder17.data.ts": tu, "./MfDataV/MfBorder18/mfBorder18.data.ts": au, "./MfDataV/MfBorder19/mfBorder19.data.ts": lu, "./MfDataV/MfBorder2/mfBorder2.data.ts": ru, "./MfDataV/MfBorder20/mfBorder20.data.ts": uu, "./MfDataV/MfBorder21/mfBorder21.data.ts": du, "./MfDataV/MfBorder22/mfBorder22.data.ts": fu, "./MfDataV/MfBorder3/mfBorder3.data.ts": gu, "./MfDataV/MfBorder4/mfBorder4.data.ts": yu, "./MfDataV/MfBorder5/mfBorder5.data.ts": Cu, "./MfDataV/MfBorder6/mfBorder6.data.ts": Mu, "./MfDataV/MfBorder7/mfBorder7.data.ts": wu, "./MfDataV/MfBorder8/mfBorder8.data.ts": _u, "./MfDataV/MfBorder9/mfBorder9.data.ts": Lu, "./MfDataV/MfDecoration1/mfDecoration.data.ts": Tu, "./MfDataV/MfDecoration10/mfDecoration.data.ts": Ru, "./MfDataV/MfDecoration11/mfDecoration.data.ts": ju, "./MfDataV/MfDecoration12/mfDecoration.data.ts": Eu, "./MfDataV/MfDecoration2/mfDecoration.data.ts": Hu, "./MfDataV/MfDecoration3/mfDecoration.data.ts": Uu, "./MfDataV/MfDecoration4/mfDecoration.data.ts": Yu, "./MfDataV/MfDecoration5/mfDecoration.data.ts": Xu, "./MfDataV/MfDecoration6/mfDecoration.data.ts": tc, "./MfDataV/MfDecoration7/mfDecoration.data.ts": nc, "./MfDataV/MfDecoration8/mfDecoration.data.ts": rc, "./MfDataV/MfDecoration9/mfDecoration.data.ts": cc, "./MfDataV/MfHeader1/mfHeader1.data.ts": fc, "./MfDataV/MfHeader2/mfHeader2.data.ts": mc, "./MfDataV/MfHeader3/mfHeader3.data.ts": Cc, "./MfDataV/MfHeader4/mfHeader4.data.ts": kc, "./MfDataV/MfHeader5/mfHeader5.data.ts": Sc, "./MfDataV/MfHeader6/mfHeader6.data.ts": Lc, "./MfDateTime/mfDateTime.data.ts": Nc, "./MfEcharts/MfBar/mfBar.data.ts": qc, "./MfEcharts/MfBarHorizontal/mfBarHorizontal.data.ts": jc, "./MfEcharts/MfBarLine/mfBarLine.data.ts": Pc, "./MfEcharts/MfBarPlusMinus/mfBarPlusMinus.data.ts": Hc, "./MfEcharts/MfBarStack/mfBarStack.data.ts": zc, "./MfEcharts/MfLine/mfLine.data.ts": Gc, "./MfEcharts/MfLineArea/mfLineArea.data.ts": Vc, "./MfEcharts/MfLineAreaStack/mfLineAreaStack.data.ts": Yc, "./MfEcharts/MfLineSmooth/mfLineSmooth.data.ts": Kc, "./MfEcharts/MfLineStack/mfLineStack.data.ts": Jc, "./MfEcharts/MfMapChunks/mfMapChunks.data.ts": ad, "./MfEcharts/MfMapLine/mfMapLine.data.ts": id, "./MfEcharts/MfMapLine3D/mfMapLine3D.data.ts": sd, "./MfEcharts/MfMapScatter/mfMapScatter.data.ts": cd, "./MfEcharts/MfPie/mfPie.data.ts": pd, "./MfEcharts/MfPieCircular/mfPieCircular.data.ts": hd, "./MfEcharts/MfPieHalf/mfPieHalf.data.ts": md, "./MfEcharts/MfPieRose/mfPieRose.data.ts": vd, "./MfEcharts/MfRadar/mfRadar.data.ts": Md, "./MfEcharts/MfRadarCircle/mfRadarCircle.data.ts": wd, "./MfEcharts/MfScatter/mfScatter.data.ts": Sd, "./MfInput/mfInput.data.ts": Dd, "./MfInputTextArea/mfInputTextArea.data.ts": Rd, "./MfPicture/mfPicture.data.ts": Od, "./MfScrollTable/mfScrollTable.data.ts": Fd, "./MfSegmented/mfSegmented.data.ts": Ud, "./MfSelect/mfSelect.data.ts": Zd, "./MfTable/mfTable.data.ts": tp, "./MfTag/mfTag.data.ts": Cs });
const ip = { ...function() {
  const e2 = {};
  return Object.keys(lp).forEach((t2) => {
    const o2 = lp[t2].default;
    e2[o2.type] = o2;
  }), e2;
}() }, rp = at();
function sp(e2) {
  let t2, o2;
  return t2 = Ar().getTheme === Ge.DARK ? "#ffffff" : "#000000", o2 = e2.backgroundImage ? `url(${ct(dt(e2.backgroundImage))}) 0% 0% / 100% 100% no-repeat` : e2.backgroundColor ?? "", { width: `${e2.width}px`, height: `${e2.height}px`, background: o2, color: t2 };
}
const up = () => {
  const e2 = Ve();
  return { chartContain: { ...qe(Wr), id: e2 }, chart: { ...qe(Vr), id: e2 } };
};
function cp(e2, t2, o2) {
  const a2 = qe(e2);
  ...
  const n2 = Ve();
  return e2.chartContain.dropInfo.x = t2, e2.chartContain.dropInfo.y = o2, a2.chart.name = dp(a2.chart.type, a2.chart.name), a2.chart.id = n2, a2.chartContain.id = n2, a2.chartContain.dropInfo.x = t2, a2.chartContain.dropInfo.y = o2, a2.chartContain.dropInfo.zIndex = 0, a2;
}
function dp(e2, t2) {
...
const pp = (e2) => {
  const t2 = up();
  t2.chart.type = e2.type, t2.chart.name = dp(e2.type, e2.name);
  const o2 = ip[e2.type];
...
function fp(e2, t2 = []) {
  let o2;
  return o2 = e2.chartContain.border.color?.startsWith("linear-gradient") ? { [Gr.borderImage]: `${e2.chartContain.border.color} 1` } : { [Gr.borderColor]: e2.chartContain.border.color }, hp({ ...e2.chartContain.dropInfo, ...o2, [Gr.borderWidth]: e2.chartContain.border.show ? e2.chartContain.border.width : 0, [Gr.borderRadius]: e2.chartContain.border.radius, [Gr.background]: e2.chartContain.background, [Gr.opacity]: e2.chartContain.opacity, padding: e2.chartContain.padding }, t2);
}
function hp(e2, t2 = []) {
...
function yp(e2, t2) {
  return vp(mp(e2, t2.id), t2);
}
function vp(e2, t2) {
  if (!e2) return;
  const o2 = 0 === e2.chart.data.type ? e2.chart.data.dataSet : e2.chart.data.result;
  return Ye(o2) ? o2[0][t2.param] : o2 ? o2[t2.param] : void 0;
}
async function Cp(e2, t2) {
  ...
  }, { getDataTable: a2 } = ls(), n2 = [], l2 = [], i2 = Ar(), r2 = (e3) => {
  ...
  for (const e3 of l2) e3.data.priority > u2 && (s2.length > 0 && (await Promise.all(s2), s2 = []), u2 = e3.data.priority), o2(e3), s2.push(a2(e3).then((t3) => {
    e3.type && ip[e3.type]?.initData(e3, t3);
  }));
  return s2;
}
function bp(e2) {
...
function Mp(e2, t2) {
  ...
  for (const e3 of o2) {
    if (bp(e3.chart), e3.chart.type === ns.MfCombine) for (const t3 of e3.chart.options.components) bp(t3.chart);
...
const xp = Ar(), Sp = (e2) => e2 <= 0, _p = (e2, t2) => e2 >= t2.length - 1, $p = (e2, t2, o2) => {
  const a2 = e2[t2];
  e2[t2] = e2[o2], e2[o2] = a2;
}, Lp = et("screen-shortcut", { state: () => ({ showMenu: false, copyData: null, alignType: qp.GROUP }), getters: { getShowMenu() {
  ...
  xp.getSelectArea?.components.length > 0 ? this.copyData = qe(xp.getSelectArea?.components) : xp.getCurComponent && (this.copyData = qe(xp.getCurComponent));
}, pasteComponent() {
  if (this.copyData) {
    if (Ye(this.copyData)) this.copyData.forEach((e2) => {
      const t2 = cp(e2, e2.chartContain.dropInfo.x + 10, e2.chartContain.dropInfo.y + 10);
      t2 && xp.addComponent(t2, 0);
    });
    else {
      const e2 = this.copyData.chartContain.dropInfo.x + 10, t2 = this.copyData.chartContain.dropInfo.y + 10, o2 = cp(this.copyData, e2, t2);
      o2 && (xp.addComponent(o2, 0), xp.setCurComponent(o2, 0));
    }
    xp.setUndoRedoData("组件复制");
  }
}, moveComponent(e2, t2) {
  xp.getCurComponent && ("x" === e2 && (xp.getCurComponent.chartContain.dropInfo.x = xp.getCurComponent.chartContain.dropInfo.x + t2), "y" === e2 && (xp.getCurComponent.chartContain.dropInfo.y = xp.getCurComponent.chartContain.dropInfo.y + t2), t2 >= 10 && xp.setUndoRedoData("组件移动"));
}, upComponent() {
  Sp(xp.getCurComponentIndex) || ($p(xp.getComponentList, xp.getCurComponentIndex, xp.getCurComponentIndex - 1), xp.setCurComponentIndex(xp.getCurComponentIndex - 1), xp.setUndoRedoData("组件上移一层"));
}, downComponent() {
  _p(xp.getCurComponentIndex, xp.getComponentList) || ($p(xp.getComponentList, xp.getCurComponentIndex, xp.getCurComponentIndex + 1), xp.setCurComponentIndex(xp.getCurComponentIndex + 1), xp.setUndoRedoData("组件下移一层"));
}, topComponent() {
  xp.getCurComponent && !Sp(xp.getCurComponentIndex) && (xp.getComponentList.splice(xp.getCurComponentIndex, 1), xp.getComponentList.unshift(xp.getCurComponent), xp.setCurComponentIndex(0), xp.setUndoRedoData("组件置顶"));
}, bottomComponent() {
  xp.getCurComponent && !_p(xp.getCurComponentIndex, xp.getComponentList) && (xp.getComponentList.splice(xp.getCurComponentIndex, 1), xp.getComponentList.push(xp.getCurComponent), xp.setCurComponentIndex(xp.getComponentList.length - 1), xp.setUndoRedoData("组件置底"));
}, composeComponent() {
  if (xp.getSelectArea.components.length <= 1) return;
  const e2 = [];
  xp.getSelectArea.components.forEach((t2) => {
    if (t2.chart.type === ns.MfCombine) {
      const o2 = { ...t2.chartContain.dropInfo }, a2 = t2.chart.options.components, n2 = xp.getScreenCanvas?.getBoundingClientRect();
      a2.forEach((e3) => {
        Tp(e3, n2, o2, xp.getScale);
      }), e2.push(...t2.chart.options.components);
    } else e2.push(t2);
  }), C(() => {
    const t2 = pp({ type: ns.MfCombine, name: "组合" });
    null !== t2 && (t2.chartContain.dropInfo = Object.assign(t2.chartContain.dropInfo, xp.getSelectArea.dropInfo), t2.chart.options.components = e2, Dp(t2), xp.batchDeleteComponent(xp.getSelectArea.components), xp.addComponent(t2, 0), xp.cleanSelectArea(), xp.setCurComponent(t2, 0), xp.setUndoRedoData("组件组合"));
  });
}, decomposeComponent() {
  if (!xp.getCurComponent) return;
  if (xp.getCurComponent.chart.type !== ns.MfCombine) return;
  xp.getCurComponent.chartContain.show || (xp.getCurComponent.chartContain.show = true);
  const e2 = xp.getCurComponent.chart.options.components, t2 = [];
  for (const o2 of e2) o2.chartContain.show || (o2.chartContain.show = true, t2.push(o2));
  C(() => {
    const o2 = { ...xp.getCurComponent.chartContain.dropInfo };
    if (!xp.getScreenCanvas) return;
    const a2 = xp.getScreenCanvas.getBoundingClientRect(), n2 = xp.getCurComponentIndex;
    xp.deleteComponent(n2);
    for (let t3 = e2.length - 1; t3 >= 0; t3--) Tp(e2[t3], a2, o2, xp.getScale), xp.addComponent(e2[t3], n2), xp.getSelectArea.components.push(e2[t3]);
    t2.forEach((e3) => {
      e3.chartContain.show = false;
    }), Bp(xp.getSelectArea.components), xp.setUndoRedoData("组件拆分");
  });
}, lockComponent() {
  ...
  xp.getSelectArea?.components.length > 0 && xp.getSelectArea?.components.forEach((t2) => {
    t2.chartContain.lock = e2;
  }), xp.getCurComponent && (xp.getCurComponent.chartContain.lock = e2), xp.setUndoRedoData(e2 ? "组件锁定" : "组件解锁");
}, hideComponent() {
  ...
  }), xp.getCurComponent && (xp.getCurComponent.chartContain.show = e2), xp.setUndoRedoData(e2 ? "组件显示" : "组件隐藏");
}, deleteComponent() {
  xp.deleteComponent(), xp.setUndoRedoData("组件删除");
}, selectAllComponent() {
  Bp(xp.getComponentList);
}, screenSave() {
  rp.emit(Qr.SCREEN_SAVE);
}, screenPreview() {
  rp.emit(Qr.SCREEN_PREVIEW);
} } });
function Ip(e2) {
  return 100 * e2 + "%";
}
function Dp(e2) {
  ...
  e2.chart.options.components.forEach((e3) => {
    e3.chartContain.groupStyle = fp(e3, [Gr.x, Gr.y]), e3.chartContain.groupStyle.left = Ip((e3.chartContain.dropInfo.x - t2.x) / t2.width), e3.chartContain.groupStyle.top = Ip((e3.chartContain.dropInfo.y - t2.y) / t2.height), e3.chartContain.groupStyle.width = Ip(e3.chartContain.dropInfo.width / t2.width), e3.chartContain.groupStyle.height = Ip(e3.chartContain.dropInfo.height / t2.height);
  });
}
function Tp(e2, t2, o2, a2) {
...
function Np(e2) {
  ...
  return t2.getComponentList.forEach((t3) => {
    const { x: l2, y: i2, width: r2, height: s2 } = gp(t3.chartContain.dropInfo);
...
function Bp(e2) {
  ...
  e2.forEach((e3) => {
    const t3 = gp(e3.chartContain.dropInfo);
...
function Rp(e2) {
  ...
  t2.cleanCurComponent(), t2.setSelectedComponents(e2), t2.getSelectArea.components.length > 1 && Bp(t2.getSelectArea.components);
}
var qp = ((e2) => (e2.GROUP = "Group", e2.CANVAS = "Canvas", e2))(qp || {});
const Ap = (e2, t2) => {
  function o2(o3) {
    ...
    }), Bp(e2.getSelectArea.components), e2.setUndoRedoData("x" === o3 ? "横向分布" : "纵向分布");
  }
  function a2() {
  ...
  function l2(t3) {
    const o3 = a2();
    n2().forEach((e3) => t3(e3, o3)), Bp(e2.getSelectArea.components), e2.setUndoRedoData("对齐");
  }
  function i2() {
  ...
  return (t3, o3) => (s(), r("div", { class: c([d(n2), d(i2).getShowData && d(i2).getShowDataLevel === d(l2) ? "active" : ""]), style: u(e2.highlight ? { border: `1px solid ${d(a2)}` } : "") }, [d(i2).getShowData && d(i2).getShowDataLevel === d(l2) ? (s(), r("div", { key: 0, class: "select", style: u({ backgroundColor: d(a2) }) }, [g(d(Be), { icon: "ant-design:check-outlined", color: "#FFFFFF", size: 14 })], 4)) : f("", true), void 0 !== e2.iconfont ? (s(), h(d(Be), { key: 1, color: d(a2), icon: `iconfont:${e2.iconfont}`, size: 14 }, null, 8, ["color", "icon"])) : f("", true), void 0 !== e2.icon ? (s(), h(d(Be), { key: 2, color: d(a2), icon: e2.icon, size: 14 }, null, 8, ["color", "icon"])) : f("", true), p("div", Op, S(e2.title), 1), e2.allowDelete && !e2.queryMode ? (s(), h(d(J), { key: 3, type: "vertical" })) : f("", true), e2.queryMode ? f("", true) : (s(), h(d(G), { key: 4, title: "删除" }, { default: M(() => [e2.allowDelete ? (s(), h(d(ee), { key: 0, size: "small", type: "link", onClick: v2 }, { icon: M(() => [g(d(ft))]), _: 1 })) : f("", true)]), _: 1 })), p("div", { class: c(["config", e2.full ? "full" : ""]) }, [R(t3.$slots, "config", {}, void 0, true)], 2), g(d(G), { title: "执行" }, { default: M(() => [g(d(ee), { size: "small", type: "link", style: { margin: "6px" }, onMouseenter: o3[0] || (o3[0] = (e3) => y2.value = true), onMouseleave: o3[1] || (o3[1] = (e3) => y2.value = false), onClick: C2 }, { icon: M(() => [!d(i2).getShowData || d(i2).getShowDataLevel !== d(l2) || y2.value ? (s(), h(d(ht), { key: 0 })) : (s(), h(d(gt), { key: 1 }))]), _: 1 })]), _: 1 })], 6));
} }), [["__scopeId", "data-v-c5dcf0b5"]]), Ep = to(e({ __name: "SelectFields", props: { tableFields: { type: Object, require: true, default: void 0 }, fields: { type: Object, require: true, default: void 0 }, queryMode: { type: Boolean, default: false } }, emits: ["fieldChange"], setup(e2, { emit: t2 }) {
...
} }), [["__scopeId", "data-v-88afb51f"]]), Pp = to(e({ __name: "TableFields", props: { sqlQuery: { type: Object, require: true, default: void 0 }, configMitt: { type: Object, default: void 0 }, queryMode: { type: Boolean, default: false } }, emits: ["fieldChange"], setup(e2, { emit: t2 }) {
  ...
  }), (t3, a3) => (s(), h(zp, { iconfont: "icon-mfish-table", title: "数据源", "allow-delete": false, onExecute: y2, "query-mode": e2.queryMode }, { config: M(() => [g(d(r2), { class: c(d(u2)), compact: "" }, { default: M(() => [g(d(l2), { value: e2.sqlQuery?.sourceTable, disabled: "" }, null, 8, ["value"]), g(Ep, $(t3.$attrs, { "table-fields": p2.value, fields: o2.sqlQuery?.fields, onFieldChange: v2, "query-mode": e2.queryMode }), null, 16, ["table-fields", "fields", "query-mode"])]), _: 1 }, 8, ["class"])]), _: 1 }, 8, ["query-mode"]));
} }), [["__scopeId", "data-v-1d0129ce"]]), Fp = async (e2, t2) => {
  const o2 = _r(), a2 = [];
  ...
  for (; ; ) return o2.has(t2) ? (t2.endsWith(`_${e2}`) && (t2 = t2.slice(0, Math.max(0, t2.length - `${e2}`.length - 1))), Hp(++e2, `${t2}_${e2}`, o2)) : t2;
}, Qp = (e2) => e2?.table && e2.condition?.field?.colName && e2.condition?.joinedField?.colName, Gp = (e2) => {
  const t2 = { fields: [], table: "", tableAlias: "", condition: { field: { tableAlias: "结果集" }, operation: "=", joinedField: {} }, type: "left" };
  e2 && e2.push(t2);
}, Up = to(e({ __name: "ConfigButton", props: { level: { type: Number, default: 1 }, icon: { type: String, default: void 0 }, iconfont: { type: String, default: void 0 }, title: { type: String, default: "按钮" } }, setup(e2) {
...
} }), [["__scopeId", "data-v-749209b7"]]), Vp = { key: 0, class: "placeholder" }, Wp = { class: "condition" }, Yp = e({ __name: "TableJoins", props: { sqlQuery: { type: Object, require: true }, level: { type: Number, default: 1 }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["joinChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, i2 = te.Item, C2 = H, { prefixCls: _2 } = xe("table-joins"), $2 = _r(), L2 = m([]), I2 = m([]), D2 = m([]), T2 = Se().getThemeColor, N2 = { left: "左联", inner: "内联", right: "右联", full: "全联" }, B2 = a(() => {
    ...
    if (o2.sqlQuery && o2.sqlQuery?.joins) {
      for (const e3 of o2.sqlQuery.joins) if (!Qp(e3)) return false;
    }
  ...
  return (t3, a2) => {
    ...
    return s(), r("div", { class: c(d(_2)) }, [(s(true), r(y, null, v(e2.sqlQuery?.joins, (t4, c2) => (s(), h(zp, { iconfont: "icon-mfish-join", title: "关联", key: c2, "query-mode": e2.queryMode, onDeleteConfig: (e3) => function(e4) {
      ...
      return [g(d(oe), { disabled: e2.queryMode, "show-search": "", "allow-clear": false, class: "input-select", "option-filter-prop": "label", value: [A2(c2) || ""], options: R2.value, onChange: (e3) => function(e4, t5) {
        ...
        ji({ sourceId: _r().getSourceId, tableName: t5.table, sourceType: 0 }).then((e5) => {
          $2.addTableFieldsMap(o3, e5), a4(e5);
        }).finally(() => U2());
      }(e3, t4) }, { displayRender: M(({ selectedOptions: e3 }) => [e3[0] ? (s(), h(d(G), { key: 1, title: e3[0]?.label }, { default: M(() => [x(S(Q2(c2, e3[0]?.value)), 1)]), _: 2 }, 1032, ["title"])) : (s(), r("div", Vp, "选择关联表"))]), _: 2 }, 1032, ["disabled", "value", "options", "onChange"]), g(Ep, { "query-mode": e2.queryMode, "table-fields": (a3 = t4.table, a3 && $2.getTableFieldsMap.has(a3) ? $2.getTableFieldsMap.get(a3) : []), fields: t4.fields, onFieldChange: (e3) => function(e4, t5) {
        o2.sqlQuery?.joins && o2.sqlQuery.joins.length > 0 && (L2.value[t5].fields = e4), F2(t5);
      }(e3, c2) }, null, 8, ["query-mode", "table-fields", "fields", "onFieldChange"])];
      var a3;
    }), _: 2 }, 1024), p("span", { class: "condition", style: u({ color: d(T2) }) }, "当", 4), g(d(oe), { disabled: e2.queryMode, "show-search": "", "allow-clear": false, class: "input-select", "option-filter-prop": "label", options: q2(c2), value: j2(c2), placeholder: `${e2.sqlQuery?.sourceTable}字段`, onChange: (e3, o3) => function(e4, t5, o4) {
      o4.condition && (o4.condition.field = e4[1].realValue, o4.condition.field.tableAlias = e4[0].value, F2(t5));
    }(o3, c2, t4) }, { displayRender: M(({ labels: e3 }) => [g(d(G), { title: O2(c2, e3) }, { default: M(() => [x(S(O2(c2, e3)), 1)]), _: 2 }, 1032, ["title"])]), _: 2 }, 1032, ["disabled", "options", "value", "placeholder", "onChange"]), p("div", Wp, [g(d(Be), { icon: "iconfont:icon-mfish-equals", color: d(T2), size: 14 }, null, 8, ["color"])]), g(d(K), { disabled: e2.queryMode, "show-search": "", "allow-clear": false, class: "input-select", "option-filter-prop": "label", value: E2(c2), options: z2(c2), placeholder: `${t4.tableAlias || "关联表"}字段`, onSelect: (e3, o3) => function(e4, t5, o4) {
      o4.condition && (o4.condition.joinedField = e4.realValue, F2(t5));
    }(o3, c2, t4) }, null, 8, ["disabled", "value", "options", "placeholder", "onSelect"])]), _: 2 }, 1032, ["query-mode", "onDeleteConfig", "onExecute"]))), 128)), B2.value ? (s(), h(Up, { key: 0, class: "config-button", title: "关联", iconfont: "icon-mfish-join", level: 0, onClick: P2 })) : f("", true)], 2);
  };
} }), Zp = to(Yp, [["__scopeId", "data-v-d960e99c"]]), Kp = e({ __name: "TableLimit", props: { sqlQuery: { type: Object, require: true }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["limitChange"], setup(e2, { emit: t2 }) {
  ...
  return n(() => o2.sqlQuery?.limit, (e3) => {
    e3 && (l2.value = e3);
  }, { immediate: true }), (t3, o3) => void 0 !== e2.sqlQuery?.limit ? (s(), h(zp, { key: 0, "query-mode": e2.queryMode, icon: "ant-design:column-height-outlined", title: "行数", onDeleteConfig: u2, onExecute: c2 }, { config: M(() => [g(d(Q), { disabled: e2.queryMode, "default-value": l2.value, "addon-after": "行", step: "10", onChange: i2, onPressEnter: r2, onBlur: r2 }, null, 8, ["disabled", "default-value"])]), _: 1 }, 8, ["query-mode"])) : f("", true);
} }), Xp = [{ field: "id", label: "唯一ID", component: "Input", show: false }, { field: "name", label: "参数名称", component: "Input", dynamicRules: () => [{ required: true, validator: (e2, t2) => /^[\u4E00-\u9FA5\w]*$/.test(t2) ? Promise.resolve() : Promise.reject("错误：参数格式不正确！字符只允许中文、字符、数字、下划线!"), trigger: "blur" }] }, { field: "required", label: "是否必须", component: "RadioButtonGroup", defaultValue: 1, componentProps: { options: [{ label: "是", value: 1 }, { label: "否", value: 0 }] }, required: true }, { field: "defaultValue", label: "默认值", component: "Input" }, { field: "remark", label: "参数描述", component: "InputTextArea" }], Jp = { name: "ApiParamsModal", components: { BasicModal: bt, BasicForm: wt }, emits: ["addSuccess", "updateSuccess", "register", "variableChange"], setup(e2, { emit: t2 }) {
  const o2 = m(true), [n2, { resetFields: l2, setFieldsValue: i2, validate: r2 }] = xt({ name: "model_form_item", labelWidth: 100, baseColProps: { span: 24 }, schemas: Xp, showActionButtonGroup: false, autoSubmitOnEnter: true }), s2 = m(), [u2, { setModalProps: c2, closeModal: p2 }] = Mt(async (e3) => {
...
const ef = to(Jp, [["render", function(e2, t2, o2, a2, n2, l2) {
...
}]]), tf = { key: 0 }, of = e({ __name: "FilterVariable", props: { value: { type: String }, queryMode: { type: Boolean, default: false } }, emits: ["variableChange"], setup(e2, { emit: t2 }) {
  ...
  }(o4), ["stop"]) }, null, 8, ["color", "onClick"])]))], 2)]), _: 2 }, 1032, ["label", "value"]))), 128))]), _: 1 }, 8, ["value", "disabled"]), g(ef, { onRegister: d(b2), onAddSuccess: D2, onUpdateSuccess: T2, onVariableChange: B2 }, null, 8, ["onRegister"])], 64));
} }), af = to(of, [["__scopeId", "data-v-68d91e73"]]), nf = e({ __name: "TableField", props: { tableFields: { type: Object }, value: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["change"], setup(e2, { emit: t2 }) {
...
} }), lf = e({ __name: "FilterValue", props: { fieldType: { type: String, default: "STRING" }, valueType: { type: String, default: "0" }, operator: { type: String, default: "" }, tableFields: { type: Array, default: () => [] }, queryMode: { type: Boolean, default: false } }, emits: ["typeChange", "variableChange", "fieldChange"], setup(e2, { emit: t2 }) {
  ...
  const o2 = t2, a2 = ne.Item, n2 = l({ field: void 0, operator: "", value: void 0 }), i2 = m(), r2 = m([]), u2 = l({ field: { dataType: "STRING" }, type: "1", valueType: "0", required: true }), c2 = m([]), p2 = m(true), y2 = m(), v2 = { STRING: [{ label: "是", value: "eq" }, { label: "不是", value: "ne" }, { label: "包含", value: "like" }, { label: "不包含", value: "notLike" }, { label: "以开始", value: "likeLeft" }, { label: "以结束", value: "likeRight" }, { label: "为空", value: "isNull" }, { label: "不为空", value: "isNotNull" }], NUMBER: [{ label: "等于", value: "eq" }, { label: "不等于", value: "ne" }, { label: "大于", value: "gt" }, { label: "大于等于", value: "ge" }, { label: "小于", value: "lt" }, { label: "小于等于", value: "le" }, { label: "包含", value: "like" }, { label: "不包含", value: "notLike" }, { label: "以开始", value: "likeLeft" }, { label: "以结束", value: "likeRight" }, { label: "为空", value: "isNull" }, { label: "不为空", value: "isNotNull" }], DATE: [{ label: "晚于", value: "gt" }, { label: "晚于等于", value: "ge" }, { label: "早于", value: "lt" }, { label: "早于等于", value: "le" }, { label: "为空", value: "isNull" }, { label: "不为空", value: "isNotNull" }] }, [C2, { setModalProps: b2, closeModal: k2 }] = Mt(async (e3) => {
    if (b2({ confirmLoading: false, width: "600px" }), Fp(void 0, e3.sqlQuery).then((e4) => {
      r2.value = e4;
  ...
  return (t3, o3) => (s(), r("div", null, [void 0 !== e2.sqlQuery?.filters ? (s(), h(zp, { key: 0, "query-mode": e2.queryMode, icon: "ant-design:filter-outlined", title: "过滤", onDeleteConfig: b2, full: true, onExecute: I2 }, { config: M(() => [g(d(Ct), { "query-mode": e2.queryMode, items: i2.value, menus: p2.value, "add-title": "添加过滤条件", onAddBlock: x2, onEditBlock: S2, onCloseBlock: $2, onDragChange: L2 }, { tag: M(({ index: t4, element: o4 }) => [g(d(re), { disabled: e2.queryMode, style: { "margin-right": "8px" }, checked: o4?.value, "checked-children": "且", "un-checked-children": "或", "checked-value": "and", "un-checked-value": "or", size: "small", onChange: (e3) => function(e4, t5) {
    i2.value && i2.value?.length > t5 && (i2.value[t5].value = e4, setTimeout(() => {
      i2.value && l2("filterChange", [...i2.value]);
    }, 300));
  }(e3, t4) }, null, 8, ["disabled", "checked", "onChange"])]), _: 1 }, 8, ["query-mode", "items", "menus"])]), _: 1 }, 8, ["query-mode"])) : f("", true), u2.value ? (s(), h(Up, { key: 1, class: "config-button", title: "过滤", icon: "ant-design:filter-outlined", level: 0, onClick: k(w2, ["prevent"]) })) : f("", true), g(sf, { "query-mode": e2.queryMode, onRegister: d(v2), onSubmit: _2 }, null, 8, ["query-mode", "onRegister"])]));
} }), cf = e({ __name: "AggregateModal", props: { queryMode: { type: Boolean, default: false } }, emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = t2, a2 = ne.Item, n2 = l({ field: void 0, aggFunc: "" }), i2 = m(), r2 = m([]), u2 = l({ field: { dataType: "STRING" } }), c2 = Object.keys(ai).map((e3) => ({ value: e3, label: ai[e3] })), p2 = m(true), y2 = m(), [v2, { setModalProps: C2, closeModal: b2 }] = Mt(async (e3) => {
    if (C2({ confirmLoading: false, width: "600px" }), Fp(void 0, e3.sqlQuery).then((e4) => {
  ...
  const o2 = t2, a2 = ne.Item, n2 = l({ field: void 0 }), i2 = l({ field: { dataType: "STRING" } }), r2 = m(), u2 = m([]), c2 = m(), [p2, { setModalProps: f2, closeModal: y2 }] = Mt(async (e3) => {
    if (f2({ confirmLoading: false, width: "600px" }), Fp(void 0, e3.sqlQuery).then((e4) => {
      u2.value = e4;
  ...
  return (t3, o3) => (s(), h(d(bt), $(t3.$attrs, { onRegister: d(p2), title: "选择分组字段", onOk: C2 }), { default: M(() => [g(d(ne), { ref_key: "formRef", ref: r2, model: n2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: M(() => [g(d(a2), { label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: M(() => [g(nf, { "query-mode": e2.queryMode, "table-fields": u2.value, value: i2.field, onChange: v2 }, null, 8, ["query-mode", "table-fields", "value"])]), _: 1 })]), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
} }), pf = e({ __name: "TableAggregate", props: { sqlQuery: { type: Object }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["aggregateChange", "groupChange", "deleteAggregate"], setup(e2, { emit: t2 }) {
  ...
  return n(() => o2.sqlQuery?.aggregates, (e3) => {
    ...
    y2.value = e3 ? [...e3] : [];
  }, { immediate: true }), (t3, o3) => (s(), r("div", { class: c(d(i2)) }, [void 0 !== e2.sqlQuery?.aggregates ? (s(), h(zp, { key: 0, "query-mode": e2.queryMode, iconfont: "icon-mfish-sum", title: "聚合", onDeleteConfig: w2, onExecute: N2, full: true }, { config: M(() => [g(d(Ct), { "query-mode": e2.queryMode, items: u2.value, "add-title": "添加聚合指标", onAddBlock: x2, onEditBlock: _2, onDragChange: $2 }, null, 8, ["query-mode", "items"]), g(d(Be), { class: "groupIcon", icon: "ant-design:group-outlined", color: d(l2), style: { "font-size": "14px" } }, null, 8, ["color"]), o3[0] || (o3[0] = p("div", { class: "group" }, "分组", -1)), g(d(Ct), { "query-mode": e2.queryMode, items: y2.value, "add-title": "添加分组指标", onAddBlock: L2, onEditBlock: D2, onDragChange: T2 }, null, 8, ["query-mode", "items"])]), _: 1 }, 8, ["query-mode"])) : f("", true), g(cf, { "query-mode": e2.queryMode, onRegister: d(v2), onSubmit: S2 }, null, 8, ["query-mode", "onRegister"]), g(df, { "query-mode": e2.queryMode, onRegister: d(b2), onSubmit: I2 }, null, 8, ["query-mode", "onRegister"])], 2));
} }), ff = to(pf, [["__scopeId", "data-v-a3fb541b"]]), hf = "其他", gf = e({ __name: "OrderModal", emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  const o2 = t2, a2 = ne.Item, n2 = l({ field: void 0 }), i2 = l({ field: { dataType: "STRING" }, order: "ASC" }), r2 = m(), u2 = m([]), c2 = m(), p2 = _r(), [f2, { setModalProps: y2, closeModal: v2 }] = Mt(async (e3) => {
    if (y2({ confirmLoading: false, width: "600px" }), Tr(e3.sqlQuery) ? Ai({ sourceId: p2.getSourceId, sourceType: p2.getSourceType, sqlQuery: e3.sqlQuery }).then((e4) => {
      u2.value = [{ value: hf, label: hf, realValue: hf, children: e4.map((e5) => ({ value: e5.colName, label: e5.colName + (e5.comment ? `[${e5.comment}]` : ""), realValue: { ...e5 } })) }];
    }) : u2.value = await Fp(void 0, e3.sqlQuery), e3.isUpdate) return n2.field = [e3.field.tableAlias, e3.field.colName], i2.field = e3.field, void (c2.value = e3.index);
    n2.field = [], c2.value = void 0, i2.field = {};
  });
  function C2(e3) {
    e3.tableAlias && e3.colName && (n2.field = [e3.tableAlias, e3.colName], i2.field = e3);
  ...
  async function b2() {
    try {
      await r2.value?.validateFields(), v2(), i2.field.tableAlias === hf && (i2.field.tableAlias = ""), o2("submit", c2.value, { ...i2, name: i2.field?.colName });
    } catch (e3) {
    }
  }
  return (e3, t3) => (s(), h(d(bt), $(e3.$attrs, { onRegister: d(f2), title: "选择排序字段", onOk: b2 }), { default: M(() => [g(d(ne), { ref_key: "formRef", ref: r2, model: n2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: M(() => [g(d(a2), { label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: M(() => [g(nf, { "table-fields": u2.value, value: i2.field, onChange: C2 }, null, 8, ["table-fields", "value"])]), _: 1 })]), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
  ...
  return (e3, t3) => (s(), h(d(bt), $(e3.$attrs, { onRegister: d(p2), title: "选择字段", onOk: C2 }), { default: M(() => [g(d(ne), { ref_key: "formRef", ref: r2, model: n2, "label-col": { span: 6 }, "wrapper-col": { span: 16 } }, { default: M(() => [g(d(a2), { label: "字段", name: "field", rules: [{ required: true, message: "请选择字段！" }] }, { default: M(() => [g(nf, { "table-fields": u2.value, value: i2.value, onChange: v2 }, null, 8, ["table-fields", "value"])]), _: 1 })]), _: 1 }, 8, ["model"])]), _: 1 }, 16, ["onRegister"]));
} }), vf = ["onClick"], Cf = ["onClick"], bf = e({ __name: "FormulaManagement", props: { isShow: { type: Boolean, default: false }, curKey: { type: String, default: "" } }, emits: ["select"], setup(e2, { emit: t2 }) {
  ...
  function j2(e3, t3) {
    A2(t3.node.dataRef, t3.node?.parent?.node);
  }
  function O2(e3) {
    if (!e3) return A2(), void ($2.value = []);
    $2.value = [e3];
    const t3 = e3.split(",");
    if (t3 && 2 === t3.length) return w2.value?.setExpandedKeys([t3[0]]), void A2(w2.value?.getSelectedNode(e3), w2.value?.getSelectedNode(t3[0]));
    A2(w2.value?.getSelectedNode(e3));
  }
  n(() => o2.isShow, (e3) => {
    e3 && setTimeout(() => {
      O2(o2.curKey);
  ...
  }), (e3, t3) => (s(), h(d(_t), { "default-size": T2.value, min: 0.1, max: 0.5, class: c(d(k2)) }, { 1: M(() => [g(d(St), { title: "", toolbar: "", search: "", ref_key: "asyncTreeRef", ref: w2, "tree-wrapper-class-name": "h-[calc(100%-35px)] overflow-auto", "selected-keys": $2.value, "onUpdate:selectedKeys": t3[0] || (t3[0] = (e4) => $2.value = e4), "tree-data": B2.value || [], onSelect: j2 }, null, 8, ["selected-keys", "tree-data"])]), 2: M(() => [p("div", { class: c(`${d(k2)}-right h-full pt-2`) }, [g(d(se), { separator: ">", class: "breadcrumb" }, { default: M(() => [(s(true), r(y, null, v(R2.value, (e4, t4) => (s(), h(d(i2), { key: t4 }, { default: M(() => [g(d(Be), { icon: e4.icon }, null, 8, ["icon"]), p("a", { onClick: (t5) => O2(e4.key), class: "fw-bold text-decoration-none" }, S(e4.title), 9, vf)]), _: 2 }, 1024))), 128))]), _: 1 }), D2.value && "" === D2.value.parentId ? (s(), h(d(vt), { key: 0 }, { default: M(() => [g(d(ce), { class: "ml-6" }, { default: M(() => [(s(true), r(y, null, v(z2.value, (e4, t4) => (s(), h(d(de), { span: 22, key: t4, class: c(`${d(k2)}-card`) }, { default: M(() => [p("div", { class: c(`${d(k2)}-card-item`), onClick: (t5) => O2(e4.key) }, [p("div", { class: c(`${d(k2)}-card-item-info`) }, [g(d(G), { title: e4.formulaInfo?.cnName }, { default: M(() => [p("span", { style: u(`color: ${d(_2)};font-weight: bold`) }, [g(d(Be), { icon: "ant-design:function-outlined", color: d(_2) }, null, 8, ["color"]), x(" " + S(e4.formulaInfo?.cnName) + " (" + S(e4.formulaInfo?.enName) + ") ", 1)], 4)]), _: 2 }, 1032, ["title"]), g(d(G), { title: e4.formulaInfo?.description }, { default: M(() => [p("span", null, S(e4.formulaInfo?.description), 1)]), _: 2 }, 1032, ["title"])], 2)], 10, Cf)]), _: 2 }, 1032, ["class"]))), 128))]), _: 1 })]), _: 1 })) : f("", true), D2.value && D2.value.formulaInfo ? (s(), h(d(vt), { key: 1 }, { default: M(() => [g(d(ue), { class: "pt-3 pr-2", column: 1, bordered: true }, { default: M(() => [g(d(C2), { label: "描述" }, { default: M(() => [x(S(q2.value?.description), 1)]), _: 1 }), g(d(C2), { label: "参数" }, { default: M(() => [(s(true), r(y, null, v(q2.value?.paramDesc, (e4, t4) => (s(), r("div", { key: t4 }, S(e4), 1))), 128))]), _: 1 }), g(d(C2), { label: "结果" }, { default: M(() => [x(S(q2.value?.returnDesc), 1)]), _: 1 })]), _: 1 })]), _: 1 })) : f("", true)], 2)]), _: 1 }, 8, ["default-size", "class"]));
} }), Mf = to(bf, [["__scopeId", "data-v-6dc5ed8e"]]), kf = { key: 0, class: "content" }, wf = { key: 1, class: "content placeholder" }, xf = to(e({ __name: "FormulaSelect", props: { formulaKey: { type: String, default: "" }, queryMode: { type: Boolean, default: false } }, emits: ["formulaChange"], setup(e2, { emit: t2 }) {
  ...
  }, { immediate: true }), (t3, o3) => (s(), h(d(V), { disabled: e2.queryMode, trigger: ["click"], open: f2.value, onOpenChange: w2, placement: "bottom", arrow: { pointAtCenter: true }, "overlay-style": { width: "500px" } }, { overlay: M(() => [g(d(te), null, { default: M(() => [g(d(te).Item, { disabled: "", style: { padding: "0", cursor: "default" } }, { default: M(() => [g(Mf, { style: { height: "350px" }, "is-show": f2.value, "cur-key": k2.value?.key, onSelect: L2 }, null, 8, ["is-show", "cur-key"]), p("div", { class: c(`${d(u2)}-ok-button`) }, [g(d(ee), { class: "mr-2", onClick: _2 }, { default: M(() => o3[0] || (o3[0] = [x("清空")])), _: 1, __: [0] }), g(d(ee), { type: "primary", onClick: $2 }, { default: M(() => o3[1] || (o3[1] = [x("确定")])), _: 1, __: [1] })], 2)]), _: 1 })]), _: 1 })]), default: M(() => [g(d(ee), { class: c(`${d(u2)}-drop-button`) }, { default: M(() => [k2.value?.cnName ? (s(), r("span", kf, S(k2.value?.cnName), 1)) : (s(), r("span", wf, "选择公式")), g(d(Be), { size: 12, icon: f2.value ? "ant-design:up-outlined" : "ant-design:down-outlined", color: i2.value ? "rgba(255, 255, 255, 0.25)" : "rgba(0, 0, 0, 0.25)" }, null, 8, ["icon", "color"])]), _: 1 }, 8, ["class"])]), _: 1 }, 8, ["disabled", "open"]));
} }), [["__scopeId", "data-v-4015d717"]]), Sf = "displayName", _f = { config: { type: Object, default: () => ({ type: ni.param, value: "" }) }, comType: { type: String, default: "string" }, paramType: { type: String, default: "string" }, paramValue: { type: String, default: "" }, showRadio: { type: Boolean, default: true }, sqlQuery: { type: Object }, index: { type: Number, default: 0 }, queryMode: { type: Boolean, default: false } }, $f = (e2) => {
...
}, Lf = e({ __name: "FormulaCompact", props: _f, emits: ["typeChange", "formulaSelect", "inputChange"], setup(e2, { emit: t2 }) {
  ...
  function D2(e3) {
    e3.tableAlias && e3.colName && (x2.value = e3, a2("inputChange", { ...e3, [Sf]: "colName" }));
  }
  function T2(e3, t3) {
  ...
  return n(() => o2.config, (e3) => {
    ...
    if (e3 === ni.param && "list" === y2.value) {
      ...
      S2.value = "fieldName" === t3, S2.value && o2.sqlQuery ? Fp(void 0, o2.sqlQuery).then((e5) => {
  ...
  return (e3, t3) => (s(), h(d(V), { trigger: ["click"], open: l2.value, placement: "bottom", arrow: { pointAtCenter: true }, onOpenChange: u2 }, { overlay: M(() => [g(d(te), null, { default: M(() => [g(d(te).Item, { disabled: "", style: { padding: "0", cursor: "default" } }, { default: M(() => [g(d(pe), { title: "上层公式设置", bordered: false, style: { width: "240px" } }, { default: M(() => [g(xf, { onFormulaChange: c2 }), g(d(K), { style: { width: "100%", "margin-top": "6px" }, placeholder: "选择作为哪个参数", class: "select-com", value: n2.value, "onUpdate:value": t3[0] || (t3[0] = (e4) => n2.value = e4), options: a2.value }, null, 8, ["value", "options"]), p("div", Df, [g(d(ee), { size: "small", onClick: f2 }, { default: M(() => t3[1] || (t3[1] = [x(" 取消")])), _: 1, __: [1] }), g(d(ee), { size: "small", type: "primary", style: { "margin-left": "6px" }, onClick: y2 }, { default: M(() => t3[2] || (t3[2] = [x(" 确定")])), _: 1, __: [2] })])]), _: 1 })]), _: 1 })]), _: 1 })]), default: M(() => [g(d(ee), { style: { "margin-top": "-6px" }, size: "small", type: "link" }, { icon: M(() => [g(d(G), { placement: "left", title: "添加外层公式，当前层作为公式参数" }, { default: M(() => [g(d(Be), { icon: "ant-design:node-collapse-outlined" })]), _: 1 })]), _: 1 })]), _: 1 }, 8, ["open"]));
} }), Nf = { class: "formula" }, Bf = { class: "title" }, Rf = { key: 0, class: "add" }, qf = e({ __name: "FormulaConfig", props: _f, emits: ["formulaChange"], setup(e2, { emit: t2 }) {
  ...
  function N2(e3) {
    T2(e3), k2.value = $f(e3), $2.value++, a2("formulaChange", k2.value);
  }
  function B2(e3) {
  ...
  return n(() => o2.config, (e3) => {
    ...
    return s(), r("div", { class: c(d(C2)) }, [p("div", Nf, [g(If, { "query-mode": o2.queryMode, class: "main", index: o2.index, "com-type": o2.comType, "param-type": o2.paramType, "param-value": o2.paramValue, config: k2.value, "sql-query": o2.sqlQuery, "show-radio": o2.showRadio, onInputChange: D2, onFormulaSelect: N2, onTypeChange: B2 }, null, 8, ["query-mode", "index", "com-type", "param-type", "param-value", "config", "sql-query", "show-radio"]), k2.value?.type !== d(ni).formula || o2.queryMode ? f("", true) : (s(), h(Tf, { key: 0, onSubmit: R2 }))]), (s(true), r(y, null, v(i2.value, (e4, l2) => (s(), r("div", { key: `${$2.value}${l2}` }, [(s(true), r(y, null, v(I2(l2), (t4, i3) => (s(), r("div", { class: "param", key: i3 }, [g(d(Be), { class: "icon", icon: "ant-design:arrow-up-outlined" }), p("span", Bf, [g(d(G), { placement: "left", title: u2.value ? u2.value[l2] : "" }, { default: M(() => [x(S(e4.name), 1)]), _: 2 }, 1032, ["title"])]), g(n2, { "query-mode": o2.queryMode, index: i3, "com-type": e4.comType, "param-type": e4.paramType, "param-value": e4.value, config: L2(e4.paramType) && k2.value?.value?.param && k2.value?.value?.param[l2]?.value ? k2.value?.value?.param[l2]?.value[i3] : k2.value?.value?.param[l2], "sql-query": o2.sqlQuery, onFormulaChange: (t5) => function(e5, t6, o3, n3) {
    ...
    }(l2, i3) }, { icon: M(() => [g(d(Be), { icon: "ant-design:delete-outlined" })]), _: 2 }, 1032, ["onClick"])) : f("", true)]))), 128)), L2(e4.paramType) ? (s(), r("div", Rf, [g(d(ee), { type: "primary", onClick: (e5) => function(e6) {
...
} }), Af = to(qf, [["__scopeId", "data-v-aad21227"]]), jf = e({ __name: "ParamsModal", emits: ["register", "submit"], setup(e2, { emit: t2 }) {
...
} }), Of = e({ __name: "FormulaTest", props: { open: { type: Boolean, default: false }, curQuery: { type: Object }, curParams: { type: Object } }, emits: ["close"], setup(e2, { emit: t2 }) {
...
} }), zf = e({ __name: "FormulaColModal", props: { queryMode: { type: Boolean, default: false } }, emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  ...
  const p2 = m(0), v2 = _r(), [C2, { openModal: b2 }] = kt(), k2 = m(), w2 = m(), S2 = m(false), _2 = (e3) => {
    ...
    return Array.isArray(e3.value) ? (e3.value.forEach((e4) => {
      ...
      t3 += `${_2(e4)},`;
    }), t3.endsWith(",") && (t3 = t3.slice(0, Math.max(0, t3.lastIndexOf(",")))), t3 += ")", t3) : (e3.type === ni.param && (t3 += e3.value instanceof Object ? e3.value[e3.value[Sf]] : e3.value), t3);
  ...
  return (t3, o3) => (s(), r(y, null, [g(d(bt), $(t3.$attrs, { onRegister: d(L2), title: "公式配置", onOk: T2 }), { centerFooter: M(() => [g(d(ee), { onClick: B2, type: "primary", danger: "" }, { default: M(() => o3[1] || (o3[1] = [x("测试")])), _: 1, __: [1] })]), default: M(() => [i2.value ? (s(), h(d(he), { key: 0, class: "mb-2", message: i2.value, type: "info", "show-icon": "" }, { icon: M(() => [g(d(Be), { icon: "ant-design:function-outlined" })]), _: 1 }, 8, ["message"])) : f("", true), (s(), h(Af, { "query-mode": e2.queryMode, key: p2.value, "sql-query": d(c2), "show-radio": false, config: u2, onFormulaChange: N2 }, null, 8, ["query-mode", "sql-query", "config"])), g(Of, { "cur-query": k2.value, "cur-params": w2.value, open: S2.value, onClose: o3[0] || (o3[0] = () => S2.value = false) }, null, 8, ["cur-query", "cur-params", "open"])]), _: 1 }, 16, ["onRegister"]), g(jf, { onRegister: d(C2), onSubmit: R2 }, null, 8, ["onRegister"])], 64));
} }), Ef = e({ __name: "CustomColModal", props: { sqlQuery: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["submit", "register"], setup(e2, { emit: t2 }) {
  ...
  const [A2, { setModalProps: j2, closeModal: O2 }] = Mt(async (e3) => {
    _2().then(), j2({ confirmLoading: false, width: "600px", maskClosable: false }), n2.value = !!e3?.isUpdate, d(n2) ? (R2.value = e3.index, L2({ ...e3.customCol }).then(), f2.value = JSON.parse(JSON.stringify(e3.customCol.expressions))) : (R2.value = void 0, f2.value = []);
  }), [z2, { openModal: E2 }] = kt(), P2 = m(), F2 = m(), H2 = m(false);
  async function Q2() {
    try {
      const e3 = await I2();
      a2("submit", R2.value, { name: e3.name, expressions: f2.value }), O2();
    } catch (e3) {
    }
  }
  ...
  function K2() {
    P2.value = { schema: o2.sqlQuery?.schema, sourceTable: o2.sqlQuery?.sourceTable, joins: o2.sqlQuery?.joins, sqlQuery: o2.sqlQuery?.sqlQuery, customColumns: [{ name: Lr, expressions: f2.value }] };
    const e3 = Rr(P2.value || {});
    e3 && e3.size > 0 ? E2(true, { params: e3, level: 1 }) : X2({});
  }
  function X2(e3) {
    F2.value = e3, H2.value = true;
  }
  return (t3, a3) => {
    const n3 = w("AButton");
    return s(), r(y, null, [g(d(bt), $(t3.$attrs, { onRegister: d(A2), title: "自定义列配置", onOk: Q2 }), { centerFooter: M(() => [g(n3, { onClick: K2, type: "primary", danger: "" }, { default: M(() => a3[1] || (a3[1] = [x("测试")])), _: 1, __: [1] })]), default: M(() => [g(d(wt), { onRegister: d(S2), onSubmit: Q2 }, { customCol: M(() => [g(d(Ct), { "query-mode": e2.queryMode, "add-title": "添加字段", items: f2.value, onBlockBuild: U2, onAddBlock: V2, onEditBlock: W2 }, q({ tag: M(({ element: e3 }) => [p("div", { class: c(`${d(u2)}-slot-tag`) }, [g(d(Re), { icon: C2[e3.name].icon, color: d(i2) }, null, 8, ["icon", "color"])], 2)]), _: 2 }, [e2.queryMode ? void 0 : { name: "headerBar", fn: M(({ headerCallBack: e3 }) => [(s(true), r(y, null, v(C2, (t4, a4) => (s(), h(d(G), { key: a4, title: t4.name }, { default: M(() => [g(d(ge), { style: { cursor: "pointer" }, color: t4.color, draggable: "true", onClick: (a5) => function(e4, t5) {
    ...
    }(e4, t4) }, { icon: M(() => [g(d(Re), { icon: t4.icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["color", "onClick", "onDragstart"])]), _: 2 }, 1032, ["title"]))), 128))]), key: "0" }]), 1032, ["query-mode", "items"])]), _: 1 }, 8, ["onRegister"]), g(yf, { onRegister: d(D2), onSubmit: Y2 }, null, 8, ["onRegister"]), g(zf, { "query-mode": e2.queryMode, onRegister: d(N2), onSubmit: Z2 }, null, 8, ["query-mode", "onRegister"]), g(Of, { "cur-query": P2.value, "cur-params": F2.value, open: H2.value, onClose: a3[0] || (a3[0] = () => H2.value = false) }, null, 8, ["cur-query", "cur-params", "open"])]), _: 1 }, 16, ["onRegister"]), g(jf, { onRegister: d(z2), onSubmit: X2 }, null, 8, ["onRegister"])], 64);
  };
} }), Pf = to(Ef, [["__scopeId", "data-v-93a6f597"]]), Ff = e({ __name: "TableCustomCol", props: { sqlQuery: { type: Object }, level: { type: Number, default: 1 }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["customColChange"], setup(e2, { emit: t2 }) {
  ...
  return n(() => o2.sqlQuery?.customColumns, (e3) => {
    i2.value = e3 ? [...e3] : [];
  }, { immediate: true }), (t3, o3) => (s(), r("div", null, [void 0 !== e2.sqlQuery?.customColumns ? (s(), h(zp, { key: 0, "query-mode": e2.queryMode, icon: "ant-design:insert-row-right-outlined", title: "自定义列", onDeleteConfig: u2, onExecute: x2, full: true }, { config: M(() => [g(d(Ct), { "query-mode": e2.queryMode, items: i2.value, "add-title": "添加自定义列", onAddBlock: v2, onEditBlock: C2, onDragChange: b2 }, null, 8, ["query-mode", "items"])]), _: 1 }, 8, ["query-mode"])) : f("", true), y2.value ? (s(), h(Up, { key: 1, class: "config-button", title: "自定义列", icon: "ant-design:insert-row-right-outlined", level: 0, onClick: k(w2, ["prevent"]) })) : f("", true), g(Pf, { "query-mode": e2.queryMode, onRegister: d(c2), "sql-query": e2.sqlQuery, onSubmit: S2 }, null, 8, ["query-mode", "onRegister", "sql-query"])]));
} }), Hf = { class: "btn-bar" }, Qf = to(e({ __name: "ApiConfig", props: { configKey: { type: Number, default: 0, require: true }, sqlQuery: { type: Object, require: true, default: void 0 }, level: { type: Number, default: 1 }, configMitt: { type: Object, default: void 0 }, queryMode: { type: Boolean, default: false } }, emits: ["configChange"], setup(e2, { emit: t2 }) {
  const o2 = e2, n2 = t2, { sqlQuery: l2 } = A(o2), { prefixCls: i2 } = xe("api-config"), y2 = Se().getThemeColor, v2 = m(), C2 = m(), { focused: b2 } = Ne(v2), { focused: M2 } = Ne(C2), k2 = _r(), x2 = m(false), S2 = a(() => {
  ...
  function N2(e3) {
    const t3 = { ...o2.sqlQuery, joins: e3 };
    F2(t3) || (n2("configChange", t3), k2.setFieldsChange(o2.level));
  }
  function B2(e3) {
    const t3 = { ...o2.sqlQuery, filters: e3 };
    F2(t3) || n2("configChange", t3);
  }
  function R2(e3) {
  ...
  function O2() {
    ...
    F2(e3) || (n2("configChange", e3), k2.setFieldsChange(o2.level));
  }
  function z2(e3) {
  ...
  async function Q2() {
    if (Nr(o2.sqlQuery, o2.level)) {
      const e3 = await H2();
      return e3.joins = [], Gp(e3.joins), void n2("configChange", e3, true);
    }
    l2?.value?.joins && Gp(l2?.value?.joins);
  }
  function G2() {
    W2(["filters"]);
  }
  ...
  return (t3, o3) => {
    ...
    return s(), r("div", { class: c([d(i2), e2.level < d(k2).getLevel ? "inner" : "", d(k2).getShowData && d(k2).getShowDataLevel === e2.level ? "active" : ""]) }, [d(k2).getShowData && d(k2).getShowDataLevel === e2.level ? (s(), r("div", { key: 0, class: "select", style: u({ backgroundColor: d(y2) }) }, [g(d(Be), { icon: "ant-design:check-outlined", color: "#FFFFFF", size: 12 })], 4)) : f("", true), void 0 !== d(l2)?.sqlQuery ? (s(), h(a2, { key: 1, "config-key": e2.configKey, "query-mode": e2.queryMode, "sql-query": d(l2).sqlQuery, level: e2.level - 1, "config-mitt": e2.configMitt, onConfigChange: P2 }, null, 8, ["config-key", "query-mode", "sql-query", "level", "config-mitt"])) : f("", true), (s(), h(Pp, { key: e2.configKey + d(k2).getFieldsChange, class: "config", "sql-query": d(l2), "query-mode": e2.queryMode, "config-mitt": e2.configMitt, onFieldChange: T2 }, null, 8, ["sql-query", "query-mode", "config-mitt"])), (s(), h(Zp, { level: e2.level, key: e2.configKey, class: "config", "sql-query": d(l2), "config-mitt": e2.configMitt, "query-mode": e2.queryMode, onJoinChange: N2 }, null, 8, ["level", "sql-query", "config-mitt", "query-mode"])), (s(), h(uf, { "query-mode": e2.queryMode, level: e2.level, key: e2.configKey, class: "config", "sql-query": d(l2), "config-mitt": e2.configMitt, onFilterChange: B2 }, null, 8, ["query-mode", "level", "sql-query", "config-mitt"])), (s(), h(Ff, { "query-mode": e2.queryMode, level: e2.level, key: e2.configKey, class: "config", "sql-query": d(l2), "config-mitt": e2.configMitt, onCustomColChange: R2 }, null, 8, ["query-mode", "level", "sql-query", "config-mitt"])), (s(), h(ff, { "query-mode": e2.queryMode, key: e2.configKey, class: "config", "sql-query": d(l2), "config-mitt": e2.configMitt, onAggregateChange: q2, onGroupChange: j2, onDeleteAggregate: O2 }, null, 8, ["query-mode", "sql-query", "config-mitt"])), (s(), h(mf, { "query-mode": e2.queryMode, key: e2.configKey, class: "config", "sql-query": d(l2), "config-mitt": e2.configMitt, onOrderChange: z2 }, null, 8, ["query-mode", "sql-query", "config-mitt"])), (s(), h(Kp, { "query-mode": e2.queryMode, key: e2.configKey, class: "config", "sql-query": d(l2), "config-mitt": e2.configMitt, onLimitChange: E2 }, null, 8, ["query-mode", "sql-query", "config-mitt"])), p("div", Hf, [S2.value ? (s(), h(Up, { key: 0, class: "config-button", title: "关联", iconfont: "icon-mfish-join", level: e2.level, onClick: Q2 }, null, 8, ["level"])) : f("", true), _2.value ? (s(), h(Up, { key: 1, class: "config-button", title: "过滤", icon: "ant-design:filter-outlined", level: e2.level, onClick: G2 }, null, 8, ["level"])) : f("", true), $2.value ? (s(), h(Up, { key: 2, class: "config-button", title: "自定义列", icon: "ant-design:insert-row-right-outlined", level: e2.level, onClick: U2 }, null, 8, ["level"])) : f("", true), L2.value ? (s(), h(Up, { key: 3, class: "config-button", title: "聚合", iconfont: "icon-mfish-sum", level: e2.level, onClick: V2 }, null, 8, ["level"])) : f("", true), I2.value ? (s(), h(Up, { key: 4, class: "config-button", title: "排序", icon: "ant-design:sort-ascending-outlined", level: e2.level, onClick: Y2 }, null, 8, ["level"])) : f("", true), D2.value ? (s(), h(Up, { key: 5, class: "config-button", title: "行数", icon: "ant-design:column-height-outlined", level: e2.level, onClick: Z2 }, null, 8, ["level"])) : f("", true), g(Up, { class: "config-button", ref_key: "querySqlRef", ref: C2, style: u({ fontWeight: "bold", border: `1px dashed ${d(y2)}` }), title: "查看SQL", icon: "ant-design:console-sql-outlined", level: e2.level, onClick: K2 }, null, 8, ["style", "level"]), g(Up, { class: "config-button", style: u({ fontWeight: "bold", border: `1px dashed ${d(y2)}` }), ref_key: "queryDataRef", ref: v2, title: "执行", onMouseenter: o3[0] || (o3[0] = (e3) => x2.value = true), onMouseleave: o3[1] || (o3[1] = (e3) => x2.value = false), icon: !d(k2).getShowData || d(k2).getShowDataLevel !== e2.level || x2.value ? "ant-design:caret-right-outlined" : "ant-design:check-outlined", level: e2.level, onClick: X2 }, null, 8, ["style", "icon", "level"])])], 2);
  };
} }), [["__scopeId", "data-v-32695b70"]]), Gf = { key: 0 }, Uf = { key: 1 }, Vf = e({ __name: "SqlQueryModal", setup(e2) {
  ...
  return (e3, n3) => {
    const p2 = w("AButton");
    return s(), h(d(bt), $(e3.$attrs, { onRegister: d(a2), title: "SQL查看", "show-ok-btn": false, "cancel-text": "关闭", onHeightChange: c2 }), { insertFooter: M(() => [g(p2, { onClick: n3[0] || (n3[0] = (e4) => d(l2)(o2.value)), color: d(i2) ? "success" : "primary" }, { default: M(() => [d(i2) ? (s(), r("span", Uf, "已拷贝")) : (s(), r("span", Gf, "拷贝"))]), _: 1 }, 8, ["color"])]), default: M(() => [g(d(It), { style: u({ height: `${t2.value}px` }), mode: d(Dt).JS, value: o2.value, "onUpdate:value": n3[1] || (n3[1] = (e4) => o2.value = e4), readonly: true }, null, 8, ["style", "mode", "value"])]), _: 1 }, 16, ["onRegister"]);
  };
} });
const Wf = ["src"], Yf = to(e({ name: "PreviewFrame", __name: "PreviewFrame", props: { frameSrc: Nt.string.def(""), frameWidth: Nt.number.def(400), frameHeight: Nt.number.def(300) }, emits: ["message"], setup(e2, { expose: t2, emit: o2 }) {
  ...
  } }), (t3, o3) => (s(), h(d(vt), null, { default: M(() => [p("iframe", { style: u(y2.value), src: e2.frameSrc, class: c(`${d(g2)}__main`), ref_key: "frameRef", ref: f2, onLoad: v2 }, null, 46, Wf)]), _: 1 }));
} }), [["__scopeId", "data-v-1bb3fd25"]]);
const Zf = { class: "share-title" }, Kf = e({ __name: "ScreenPreview", props: { fixScale: { type: Number, default: 1 }, borderRadius: { type: String } }, setup(e2) {
  const t2 = e2, { prefixCls: n2 } = xe("screen-preview"), { token: C2 } = F.useToken(), b2 = a(() => C2.value.colorBorder), k2 = o("fitDomRef"), w2 = m([]), { getAntdLocale: x2 } = Tt(), $2 = Ar(), { antTheme: L2 } = Le(a(() => $2.getTheme)), I2 = m(false), D2 = m(""), T2 = m(window.innerWidth), N2 = m(window.innerHeight), B2 = m(), R2 = a(() => [...$2.getComponentList].reverse()), q2 = l({ width: 0, height: 0 }), A2 = a(() => ({ ...sp($2.getCanvasConfig), width: $2.getCanvasConfig.width * q2.width * t2.fixScale + "px", height: $2.getCanvasConfig.height * q2.height * t2.fixScale + "px" })), E2 = (e3) => hp({ ...e3.chartContain.dropInfo }), P2 = (e3) => {
    ...
    setTimeout(() => {
      $2.loadingScreen().then(() => {
        ...
        for (let e4 = 0; e4 < R2.value.length; e4++) {
          ...
          rp.on(Qr.EVENT_ANIMATION, (o4) => {
            np(o4, t3, w2.value[e4]);
          });
          ...
          !o3 || 0 === o3.length || w2.value.length <= e4 || (R2.value[e4].chartContain.show && R2.value[e4].chart.type !== ns.MfCombine && (R2.value[e4].chartContain.show = false, n3.set(e4, R2.value[e4])), setTimeout(() => {
            n3.has(e4) && (n3.get(e4).chartContain.show = true), ap(w2.value[e4], o3).then();
          }, 600));
        }
      });
    }, 10), rp.on(Qr.SHOW_MODAL, (e3) => {
  ...
  return (t3, o3) => (s(), r("div", { class: c(d(i2)) }, [p("div", { class: c(["group-title", [e2.allowCollapse ? "collapsed" : ""]]), onClick: y2 }, [p("div", th, [e2.allowCheck ? (s(), h(d(W), { key: 0, checked: n2.value, "onUpdate:checked": o3[0] || (o3[0] = (e3) => n2.value = e3), onClick: o3[1] || (o3[1] = k(() => {
  }, ["stop"])), onChange: v2 }, null, 8, ["checked"])) : f("", true), e2.tooltip ? (s(), h(d(G), { key: 1, title: e2.tooltip }, { default: M(() => [x(S(e2.title), 1)]), _: 1 }, 8, ["title"])) : (s(), r("span", oh, S(e2.title), 1)), !e2.allowCheck && e2.allowCollapse || e2.allowCheck && e2.titleCheck ? (s(), h(d(Be), { key: 3, icon: `ant-design:${l2.value ? "up" : "down"}-outlined`, size: 12 }, null, 8, ["icon"])) : f("", true)]), p("div", { onClick: o3[2] || (o3[2] = k(() => {
  }, ["stop"])) }, [R(t3.$slots, "action", {}, void 0, true)]), e2.allowCopy ? (s(), r("div", ah, [g(d(G), { placement: "top", title: `复制${e2.title}` }, { default: M(() => [g(d(Be), { "aria-hidden": "false", size: 12, icon: "iconfont:icon-mfish-copy", onClick: k(C2, ["stop"]) })]), _: 1 }, 8, ["title"]), g(d(G), { placement: "top", title: `粘贴${e2.title}` }, { default: M(() => [g(d(Be), { "aria-hidden": "false", size: 12, icon: "iconfont:icon-mfish-paste", onClick: k(b2, ["stop"]) })]), _: 1 }, 8, ["title"])])) : f("", true)], 2), g(d(Rt), { show: !e2.allowCheck && l2.value || e2.allowCheck && l2.value && e2.titleCheck }, { default: M(() => [p("div", nh, [R(t3.$slots, "default", {}, void 0, true)])]), _: 3 }, 8, ["show"])], 2));
} }), ih = to(lh, [["__scopeId", "data-v-9aa90d73"]]), rh = { class: "table-bordered" }, sh = e({ __name: "GlobalParamsConfig", setup(e2) {
  const { prefixCls: t2 } = xe("global-params-config"), o2 = Ar(), a2 = [{ title: "参数名", dataIndex: "name", align: "center" }, { title: "默认值", dataIndex: "defaultValue", align: "center" }];
  return (e3, n2) => (s(), r("div", { class: c(d(t2)) }, [g(ih, { title: "全局变量", tooltip: "用于大屏全局接收外部参数" }, { default: M(() => [p("div", rh, [g(d(be), { size: "small", columns: a2, "data-source": d(o2).getCanvasConfig?.globalParams, bordered: "", pagination: false }, null, 8, ["data-source"])])]), _: 1 })], 2));
} }), uh = { class: "title" }, ch = { class: "title" }, dh = { class: "title" }, ph = e({ __name: "CanvasConfig", setup(e2) {
  const { prefixCls: t2 } = xe("canvas-config"), o2 = Ar(), a2 = m(), n2 = [{ title: "深色", value: Ge.DARK }, { title: "浅色", value: Ge.LIGHT }, { title: "跟随平台", value: Ge.SYSTEM }], u2 = l({ [Hr.FIT_BOX]: { name: "全屏铺满", icon: "carbon:fit-to-screen", description: "全屏铺满（设备与配置大屏比例不同时会变形）" }, [Hr.FIT_ORIGINAL]: { name: "原始比例", icon: "carbon:center-to-fit", description: "原始比例（保持配置大屏比例，不填充空白处）" }, [Hr.FIT_WIDTH_SCALE]: { name: "横向适配", icon: "carbon:fit-to-width", description: "横向适配-保持纵横比（横向铺满，允许纵向滚动，保持原有画布比例）" }, [Hr.FIT_HEIGHT_SCALE]: { name: "纵向适配", icon: "carbon:fit-to-height", description: "纵向适配-保持纵横比（纵向铺满，允许横向滚动，保持原有画布比例）" }, [Hr.FIT_WIDTH]: { name: "横向适配", icon: "carbon:fit-to-width", description: "横向适配（横向铺满，允许纵向滚动，会变形）" }, [Hr.FIT_HEIGHT]: { name: "纵向适配", icon: "carbon:fit-to-height", description: "纵向适配（纵向铺满，允许横向滚动，会变形）" } });
  function f2(e3) {
    C2(e3), a2.value = e3;
  }
  function C2(e3) {
  ...
  return i(() => {
    ...
    const i2 = w("AInput");
    return s(), h(d(vt), null, { default: M(() => [p("div", { class: c(d(t2)) }, [l2[8] || (l2[8] = p("div", { class: "title" }, "大屏名称", -1)), g(i2, { value: d(o2).getCanvasConfig.screenName, "onUpdate:value": l2[0] || (l2[0] = (e4) => d(o2).getCanvasConfig.screenName = e4), "show-count": "", maxlength: 30 }, null, 8, ["value"]), l2[9] || (l2[9] = p("div", { class: "title" }, " 描述", -1)), g(d(Me), { value: d(o2).getCanvasConfig.screenDesc, "onUpdate:value": l2[1] || (l2[1] = (e4) => d(o2).getCanvasConfig.screenDesc = e4), "show-count": "", maxlength: 200 }, null, 8, ["value"]), l2[10] || (l2[10] = p("div", { class: "title" }, "大屏尺寸", -1)), g(eh), p("div", uh, [l2[5] || (l2[5] = x(" 主题 ")), g(d(Z), { size: "small", value: d(o2).getCanvasConfig.theme, "onUpdate:value": l2[2] || (l2[2] = (e4) => d(o2).getCanvasConfig.theme = e4) }, { default: M(() => [(s(), r(y, null, v(n2, (e4, t3) => g(d(Y), { key: t3, value: e4.value }, { default: M(() => [x(S(e4.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])]), l2[11] || (l2[11] = p("div", { class: "title" }, "背景颜色", -1)), g(d(Eo), { value: a2.value, onConfirmChange: f2, onInputChange: C2 }, null, 8, ["value"]), l2[12] || (l2[12] = p("div", { class: "title" }, "背景图片", -1)), g(d(Bt), { "file-keys": d(o2).getCanvasConfig.backgroundImage, accepts: ".jpg,.jpeg,.png,.svg", "button-text": "上传背景", "max-count": 1, "is-pic": true, onSuccess: b2, onRemove: k2 }, null, 8, ["file-keys"]), p("div", ch, [l2[6] || (l2[6] = x(" 水印 ")), p("div", null, [g(i2, { value: d(o2).getCanvasConfig.watermark, "onUpdate:value": l2[3] || (l2[3] = (e4) => d(o2).getCanvasConfig.watermark = e4), placeholder: "清空无水印", "show-count": "", maxlength: 50 }, null, 8, ["value"])])]), p("div", dh, [l2[7] || (l2[7] = x(" 适配方式 ")), p("div", null, [g(d(Z), { value: d(o2).getCanvasConfig.fitType, "onUpdate:value": l2[4] || (l2[4] = (e4) => d(o2).getCanvasConfig.fitType = e4) }, { default: M(() => [(s(true), r(y, null, v(Object.keys(u2), (e4) => (s(), h(d(G), { key: e4, placement: "bottomRight", title: u2[e4].description }, { default: M(() => [g(d(Y), { class: c(`${d(t2)}-radio-button`), value: e4 }, { default: M(() => [g(d(Be), { icon: u2[e4].icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["class", "value"])]), _: 2 }, 1032, ["title"]))), 128))]), _: 1 }, 8, ["value"])])]), g(sh)], 2)]), _: 1 });
  };
} }), fh = to(ph, [["__scopeId", "data-v-c7f8401a"]]), hh = { class: "header" }, gh = e({ name: "FrameConfig", __name: "index", props: { collapsed: Nt.bool.def(false) }, setup(e2, { expose: t2 }) {
  const o2 = e2, { prefixCls: l2 } = xe("frame-config"), i2 = a(() => [l2, { collapsed: o2.collapsed }]), u2 = m(), y2 = m(), v2 = m(), C2 = Ar(), b2 = m();
  function k2(e3) {
    if (e3) {
      const t3 = ip[e3.chart.type].config;
      u2.value = Object.keys(t3).filter((e4) => t3[e4].show).map((e4) => t3[e4]);
    } else u2.value = [{ value: "画布配置", payload: { icon: "carbon:gui-management", component: T(fh) } }];
  ...
  return n([() => C2.getCurComponent, () => C2.getCurComponent?.chart?.options?.selectIndex], ([e3, t3]) => {
    ...
    b2.value = e3;
  } }), (e3, t3) => (s(), r("div", { class: c(i2.value) }, [p("div", hh, [g(d(U), { value: y2.value, options: u2.value, onChange: w2, block: "" }, { label: M(({ value: e4, payload: t4 }) => [t4.icon ? (s(), h(d(Be), { key: 0, icon: t4.icon }, null, 8, ["icon"])) : f("", true), x(" " + S(e4), 1)]), _: 1 }, 8, ["value", "options"])]), (s(), h(O(v2.value), { "select-data": b2.value }, { "data-select": M(() => [R(e3.$slots, "data-select", { curSelect: b2.value })]), _: 3 }, 8, ["select-data"]))], 2));
} }), mh = { class: "action" }, yh = { class: "ac-int" }, vh = e({ __name: "CanvasRulerLine", props: { lineValue: { type: Number, default: 0 }, lineList: { type: Array, default: () => [] } }, setup(e2) {
  const t2 = e2, { lineList: o2 } = t2, a2 = Ar(), { prefixCls: n2 } = xe("canvas-ruler-line"), l2 = Se().getThemeColor;
  return (e3, t3) => (s(), r("div", { class: c(d(n2)) }, [(s(true), r(y, null, v(d(o2), (e4, t4) => (s(), r("div", { class: c(["line-item", { x: "x" === e4.position, y: "y" === e4.position }]), style: u({ left: "x" === e4.position ? `${Math.round(e4.offset * d(a2).getScale)}px` : 0, top: "y" === e4.position ? `${Math.round(e4.offset * d(a2).getScale)}px` : 0 }), key: `${e4}${t4}` }, [p("div", mh, [g(d(Be), { class: "ac-close", icon: "ant-design:close-outline", color: d(l2), onClick: (a3) => function(e5, t5) {
    o2.splice(t5, 1);
  }(e4.position, t4) }, null, 8, ["color", "onClick"]), p("span", yh, S(e4.value), 1)])], 6))), 128))], 2));
} }), Ch = to(vh, [["__scopeId", "data-v-91bb6b29"]]), bh = { id: "horn", class: "horn" }, Mh = ["id", "width", "height"], kh = { class: "indicator-value" }, wh = ["id", "height", "width"], xh = { class: "indicator-value" }, Sh = e({ __name: "CanvasRuler", props: { rulerXLeft: { type: Number, default: 0 }, rulerYTop: { type: Number, default: 0 }, rulerX: { type: Number, default: 5e3 }, rulerY: { type: Number, default: 3e3 }, drift: { type: Number, default: 0 }, rulerHeight: { type: Number, default: 28 }, rulerWidth: { type: Number, default: 38 } }, setup(e2) {
  const t2 = e2, l2 = Ar(), { prefixCls: i2 } = xe("canvas-ruler"), f2 = m(0), y2 = m(true), v2 = T({}), b2 = T({}), k2 = a(() => `${t2.rulerXLeft}px`), w2 = a(() => `${t2.rulerYTop}px`), x2 = o("rulerXRef"), _2 = o("rulerYRef"), $2 = a(() => Se().getDarkMode.value === Ge.DARK ? "#999" : "#666");
  n(() => Se().getDarkMode.value, (e3, t3) => {
    e3 !== t3 && C(() => {
      O2();
    });
  }), n([() => l2.getScale, () => t2.rulerX, () => t2.rulerY], ([e3, t3, o2], [a2, n2, l3]) => {
    a2 ? (e3 !== a2 && C(() => O2()), t3 !== n2 && C(() => F2()), o2 !== l3 && C(() => H2())) : C(() => O2());
  }, { immediate: true });
  ...
  const E2 = (e3, t3, o2, a2, n2) => {
    P2(e3, t3, $2.value, l2.getScale, o2, a2, n2);
  }, P2 = (e3, t3, o2, a2, n2, l3, i3) => {
  ...
  return (t3, o2) => (s(), r("div", { class: c(d(i2)) }, [p("div", bh, [g(d(G), { title: (y2.value ? "隐藏" : "显示") + "辅助线" }, { default: M(() => [y2.value ? (s(), h(d(Be), { key: 0, class: "icon", icon: "ant-design:eye-outlined", onClick: Q2 })) : (s(), h(d(Be), { key: 1, class: "icon", icon: "ant-design:eye-invisible-outlined", onClick: Q2 }))]), _: 1 }, 8, ["title"])]), p("div", { class: "ruler rulerX", style: u({ width: `${L2.value}px`, left: k2.value }) }, [p("canvas", { ref_key: "rulerXRef", ref: x2, id: `${d(i2)}-x`, width: L2.value, height: e2.rulerHeight, onMousemove: D2, onMouseleave: N2, onClick: B2 }, null, 40, Mh), p("div", { class: "indicator x", style: u(v2.value) }, [p("div", kh, S(f2.value), 1)], 4), j(g(Ch, { "line-value": f2.value, "line-list": d(l2).getGuideLine.lineListY }, null, 8, ["line-value", "line-list"]), [[z, y2.value]])], 4), p("div", { class: "ruler rulerY", style: u({ height: `${I2.value}px`, top: w2.value }) }, [p("canvas", { ref_key: "rulerYRef", ref: _2, id: `${d(i2)}-y`, height: I2.value, width: e2.rulerWidth, onMousemove: R2, onMouseleave: q2, onClick: A2 }, null, 40, wh), p("div", { class: "indicator y", style: u(b2.value) }, [p("div", xh, S(f2.value), 1)], 4), j(g(Ch, { "line-value": f2.value, "line-list": d(l2).getGuideLine.lineListX }, null, 8, ["line-value", "line-list"]), [[z, y2.value]])], 4)], 2));
} }), _h = to(Sh, [["__scopeId", "data-v-eeb86e63"]]), $h = e({ __name: "CanvasBackground", props: { drift: { type: Number, default: 0 }, width: { type: Number, default: 9e3 }, height: { type: Number, default: 6e3 }, ruler: { type: Object, default: () => ({ height: 28, width: 38 }) } }, setup(e2) {
  const t2 = e2, o2 = Ar(), n2 = Lp(), l2 = a(() => t2.width * o2.getScale + "px"), i2 = a(() => t2.height * o2.getScale + "px"), { prefixCls: p2 } = xe("canvas-background");
  function f2(e3) {
...
} }), Lh = to($h, [["__scopeId", "data-v-2efcd248"]]), Ih = { class: "scale-add-reduce" }, Dh = { class: "scale-lock" }, Th = e({ __name: "CanvasScale", props: { scale: { type: Number, default: 100 }, minScale: { type: Number, default: 20 }, maxScale: { type: Number, default: 500 } }, emits: ["addScale", "reduceScale", "changeScale", "autoScale"], setup(e2, { emit: t2 }) {
  ...
  return (t3, o3) => (s(), r("div", { class: c(d(n2)) }, [p("div", Ih, [g(d(Be), { class: "scale-icon", title: "放大", size: 18, icon: "ant-design:plus-outlined", onClick: i2 }), g(d(Q), { size: "small", bordered: false, value: e2.scale, max: e2.maxScale, min: e2.minScale, step: 5, controls: false, formatter: (e3) => `${Math.round(100 * e3)}`, onChange: u2 }, null, 8, ["value", "max", "min", "formatter"]), o3[2] || (o3[2] = p("div", { class: "scale-sign" }, "%", -1)), g(d(Be), { class: "scale-icon", title: "缩小", size: 18, icon: "ant-design:minus-outlined", onClick: l2 })]), p("div", Dh, [g(d(G), { title: a2.value ? "锁定自动比例" : "解锁自动比例", placement: "right" }, { default: M(() => [a2.value ? (s(), h(d(Be), { key: 0, icon: "ant-design:unlock-outlined", onClick: o3[0] || (o3[0] = (e3) => f2(false)) })) : (s(), h(d(Be), { key: 1, icon: "ant-design:lock-outlined", onClick: o3[1] || (o3[1] = (e3) => f2(true)) }))]), _: 1 }, 8, ["title"])])], 2));
} }), Nh = e({ __name: "ShortcutViewModal", setup(e2) {
...
} }), Bh = to(e({ __name: "CanvasOperator", setup(e2) {
  const { prefixCls: t2 } = xe("canvas-operator"), [o2, { openModal: a2 }] = kt();
  function n2() {
    a2(true, {});
  }
  return (e3, a3) => (s(), r(y, null, [p("div", { class: c(d(t2)) }, [g(d(G), { title: "快捷方式", placement: "right" }, { default: M(() => [g(d(Be), { icon: "carbon:table-shortcut", onClick: n2 })]), _: 1 })], 2), g(Nh, { onRegister: d(o2) }, null, 8, ["onRegister"])], 64));
} }), [["__scopeId", "data-v-2148ffa6"]]), Rh = { lt: function(e2, t2, o2, a2, n2, l2) {
...
}, t: qh, rt: function(e2, t2, o2, a2, n2, l2) {
  const { symmetricPoint: i2 } = n2;
...
}, r: Ah, rb: function(e2, t2, o2, a2, n2, l2) {
  const { symmetricPoint: i2 } = n2;
  ...
  c2 > 10 && d2 > 10 && (e2.width = Math.round(c2 / l2), e2.height = Math.round(d2 / l2), e2.x = Math.round(s2.x / l2), e2.y = Math.round(s2.y / l2));
}, b: qh, lb: function(e2, t2, o2, a2, n2, l2) {
  const { symmetricPoint: i2 } = n2;
...
const jh = ["onMousedown"], Oh = { key: 2, class: "cover-layer-out" }, zh = { key: 0, class: "cover-hover" }, Eh = e({ name: "ChartContain", __name: "index", props: { comOption: { require: true, type: Object, default: () => ({ chart: {}, chartContain: {} }) }, index: { require: true, type: Number, default: 0 } }, setup(e2) {
  t((e3) => ({ "15d86f1b": g2.value }));
  const n2 = e2, { token: l2 } = F.useToken(), g2 = a(() => l2.value.colorInfoBg), C2 = a(() => l2.value.colorBorder), b2 = o("chartContainRef"), M2 = o("chartItemRef"), { prefixCls: w2 } = xe("chart-contain"), x2 = { points: ["lt", "t", "rt", "r", "rb", "b", "lb", "l"], initAngle: { lt: 0, t: 45, rt: 90, r: 135, rb: 180, b: 225, lb: 270, l: 315 }, pointCursor: [{ start: 338, end: 23, cursor: "nw" }, { start: 23, end: 68, cursor: "n" }, { start: 68, end: 113, cursor: "ne" }, { start: 113, end: 158, cursor: "e" }, { start: 158, end: 203, cursor: "se" }, { start: 203, end: 248, cursor: "s" }, { start: 248, end: 293, cursor: "sw" }, { start: 293, end: 338, cursor: "w" }] }, S2 = m(false), _2 = m(false), $2 = m({}), L2 = Ar(), I2 = Lp(), D2 = a(() => [w2, { active: q2.value || A2.value }]), T2 = a(() => !S2.value && !_2.value && n2.comOption.chart?.id === L2.getCurHoverComponentId || S2.value && L2.getCurComponent?.chart.id === n2.comOption?.chart?.id), N2 = a(() => hp({ ...n2.comOption.chartContain.dropInfo })), B2 = a(() => {
    const e3 = fp(n2.comOption);
    return e3.borderColor || (e3.borderColor = C2.value), Qe(e3, ["transform"]);
  }), q2 = a(() => L2.getCurComponent?.chart.id === n2.comOption?.chart.id), A2 = a(() => L2.getSelectArea.components.map((e3) => e3?.chart.id).includes(n2.comOption?.chart?.id));
  function O2(e3) {
  ...
  async function E2(e3) {
    if (I2.setShowMenu(false), e3.ctrlKey || e3.metaKey) return void Rp(n2.comOption);
    ...
    const l3 = setInterval(() => {
      ...
      d(S2) ? L2.setUndoRedoData("组件移动") : L2.cleanSelectArea(), S2.value = false, clearInterval(l3), t2 && Bp(L2.getSelectArea.components), rp.emit(Qr.UN_MOVE), document.removeEventListener("mousemove", i2), document.removeEventListener("mouseup", r2), $2.value = P2(n2.comOption);
    };
  ...
  function U2(e3, t2) {
    ...
    const c2 = function() {
      ...
      !function(e4, t4, o3, a3, n4, l4, i4) {
        Rh[e4](t4, o3, a3, n4, l4, i4);
      }(e3, o2, n3, i3, c2, { center: a2, curPoint: r2, symmetricPoint: s2 }, L2.getScale), O2(o2), rp.emit(Qr.MOVE, false);
    }, 2), f2 = () => {
      d(S2) && L2.setUndoRedoData("组件大小调整"), S2.value = false, rp.emit(Qr.UN_MOVE), document.removeEventListener("mousemove", p2), document.removeEventListener("mouseup", f2);
    };
  ...
  return i(() => {
    n2.comOption && ($2.value = P2(n2.comOption)), rp.on(Qr.MOVE, () => {
      n2.comOption && L2.getCurComponent && n2.comOption.chart.id !== L2.getCurComponent.chart.id && !d(_2) && (_2.value = true);
    }), rp.on(Qr.UN_MOVE, () => {
      _2.value = false;
    }), rp.on(Qr.PLAY_ANIMATION, () => {
      n2.comOption.chart.id === L2.getCurComponent?.chart.id && void 0 === n2.comOption.chart.options?.selectIndex && ap(M2.value, n2.comOption.chart.animations).then(() => {
        rp.emit(Qr.PLAY_ANIMATION_COMPLETE);
      });
    }), rp.on(Qr.EVENT_ANIMATION, (e3) => {
      M2.value && np(e3, n2.comOption, M2.value);
    }), rp.on(Qr.STOP_ANIMATION, () => {
  ...
  function n2(e3, { x: o3, y: a3, bottom: n3, right: l2, halfWidth: i2, halfHeight: r2 }) {
    ...
    return { y: [{ isNear: u2(e3.y, a3), isAdsorb: f2(e3.y, a3), lineNode: d2[Fh].node, line: Fh, dragShift: a3, lineShift: a3 }, { isNear: u2(e3.bottom, a3), isAdsorb: f2(e3.bottom, a3), lineNode: d2[Fh].node, line: Fh, dragShift: a3 - e3.height, lineShift: a3 }, { isNear: u2(e3.y + c2, a3 + r2), isAdsorb: f2(e3.y + c2, a3 + r2), lineNode: d2[Hh].node, line: Hh, dragShift: a3 + r2 - c2, lineShift: a3 + r2 }, { isNear: u2(e3.y, n3), isAdsorb: f2(e3.y, n3), lineNode: d2[Qh].node, line: Qh, dragShift: n3, lineShift: n3 }, { isNear: u2(e3.bottom, n3), isAdsorb: f2(e3.bottom, n3), lineNode: d2[Qh].node, line: Qh, dragShift: n3 - e3.height, lineShift: n3 }], x: [{ isNear: u2(e3.x, o3), isAdsorb: f2(e3.x, o3), lineNode: d2[Gh].node, line: Gh, dragShift: o3, lineShift: o3 }, { isNear: u2(e3.right, o3), isAdsorb: f2(e3.right, o3), lineNode: d2[Gh].node, line: Gh, dragShift: o3 - e3.width, lineShift: o3 }, { isNear: u2(e3.x + s2, o3 + i2), isAdsorb: f2(e3.x + s2, o3 + i2), lineNode: d2[Uh].node, line: Uh, dragShift: o3 + i2 - s2, lineShift: o3 + i2 }, { isNear: u2(e3.x, l2), isAdsorb: f2(e3.x, l2), lineNode: d2[Vh].node, line: Vh, dragShift: l2, lineShift: l2 }, { isNear: u2(e3.right, l2), isAdsorb: f2(e3.right, l2), lineNode: d2[Vh].node, line: Vh, dragShift: l2 - e3.width, lineShift: l2 }] };
  }
  function u2(e3, o3) {
    ...
    rp.on(Qr.MOVE, (e3) => {
      !async function(e4) {
        ...
        e4 ? o2.getSelectArea.components.forEach((e5) => {
          a3.push({ com: e5, style: gp(e5.chartContain.dropInfo) });
        }) : a3.push({ com: o2.getCurComponent, style: gp(o2.getCurComponent.chartContain.dropInfo) });
        g2().then(), a3.forEach((a4) => {
          !function(e5, a5) {
            ...
            l2(n2(e5.style, { x: o2.getCanvasConfig.width / 2, y: o2.getCanvasConfig.height / 2, bottom: 0, right: 0, halfWidth: 0, halfHeight: 0 })), l2(n2(e5.style, { x: 0, y: 0, bottom: o2.getCanvasConfig.height, right: o2.getCanvasConfig.width, halfWidth: 0, halfHeight: 0 })), o2.getGuideLine.lineListX.forEach((t3) => {
              ...
              const i2 = gp(t3.chartContain.dropInfo), { x: r2, y: s2, bottom: u3, right: c2 } = i2, d2 = i2.width / 2, p2 = i2.height / 2;
  ...
  }), (e3, o3) => (s(), r("div", { class: c(d(a2)) }, [(s(true), r(y, null, v(Object.keys(t2.lineStatus), (e4) => j((s(), r("div", { key: e4, ref_for: true, ref: (o4) => t2.lineStatus[e4].node = o4, class: c(["line", e4.includes("横") ? "xLine" : "yLine"]) }, [p("div", Wh, S(t2.lineStatus[e4].pos), 1)], 2)), [[z, t2.lineStatus[e4].show || false]])), 128))], 2));
} }), Zh = to(Yh, [["__scopeId", "data-v-88d9d34f"]]), Kh = e({ name: "ChartMultiSelect", __name: "index", props: { selectArea: { type: Object, default: () => {
} } }, setup(e2) {
  const t2 = Ar(), { prefixCls: o2 } = xe("select-area");
  return (a2, n2) => j((s(), r("div", { class: c(d(o2)), style: u({ transform: `translate(${e2.selectArea.x}px,${e2.selectArea.y}px)`, width: `${e2.selectArea.width}px`, height: `${e2.selectArea.height}px` }) }, n2[0] || (n2[0] = [p("div", { class: "select-area-bg" }, null, -1)]), 6)), [[z, d(t2).selectArea.show]]);
} }), Xh = to(Kh, [["__scopeId", "data-v-e9844525"]]), Jh = e({ name: "ScreenCanvas", __name: "index", setup(e2) {
  const { prefixCls: t2 } = xe("screen-canvas"), n2 = Ar(), p2 = Lp(), m2 = o("screenCanvasRef"), { getAntdLocale: C2 } = Tt(), { antTheme: b2 } = Le(a(() => n2.getTheme)), w2 = a(() => [...n2.getComponentList].reverse()), x2 = l({ canvasX: 0, canvasY: 0, area: { show: false, x: 0, y: 0, width: 0, height: 0 }, comMoving: false, isUp: false }), S2 = a(() => ({ ...sp(n2.getCanvasConfig), transform: `scale(${n2.getScale})` })), _2 = (e3) => {
    if (e3.chart?.events?.emits && e3.chart.events.emits.length > 0) {
      for (const t3 of e3.chart.events.emits) if (t3 === rs.CHART_CLICK || t3 === rs.CHART_DBLCLICK) return "allow-pointer";
    }
  };
  i(() => {
    n2.setScreenCanvas(m2.value ?? null), rp.on(Qr.MOVE, () => {
      x2.comMoving || (x2.comMoving = true);
    }), rp.on(Qr.UN_MOVE, () => {
      x2.comMoving = false;
    }), rp.on(Qr.CREATE_CHART, (e3) => {
      L2(e3, 0, 0);
    });
  });
  const $2 = (e3) => {
    p2.setShowMenu(false);
    const t3 = e3.dataTransfer?.getData(Or);
  ...
  }, ["prevent", "stop"])), onMousedown: I2, style: u(S2.value) }, [g(d(me), { locale: d(C2), theme: d(b2) }, { default: M(() => [d(n2).getCanvasConfig.watermark ? (s(), h(d(ye), { key: 0, content: d(n2).getCanvasConfig.watermark, style: u({ position: "absolute", width: `${d(n2).getCanvasConfig.width}px`, height: `${d(n2).getCanvasConfig.height}px` }) }, null, 8, ["content", "style"])) : f("", true), (s(true), r(y, null, v(w2.value, (e4, t3) => (s(), h(Ph, { key: e4.chart?.id + d(n2).getKey, index: w2.value.length - t3 - 1, "com-option": e4, class: c(_2(e4)) }, { default: M(() => [(s(), h(O(e4.chart.type && d(ip)[e4.chart.type].component), { class: c(["component", { move: x2.comMoving && e4.chart.id !== d(n2).getCurComponent?.chart.id }]), id: `com${e4.chart.id}`, chart: e4.chart, "chart-contain": e4.chartContain }, null, 8, ["class", "id", "chart", "chart-contain"]))]), _: 2 }, 1032, ["index", "com-option", "class"]))), 128))]), _: 1 }, 8, ["locale", "theme"]), g(Xh, { "select-area": x2.area }, null, 8, ["select-area"]), g(Zh)], 38));
} }), eg = to(Jh, [["__scopeId", "data-v-9395352a"]]), tg = 0.2, og = e({ name: "FrameCanvas", __name: "index", props: { width: { type: Number, default: 5e3 }, height: { type: Number, default: 3e3 } }, setup(e2) {
  const t2 = m(true), { prefixCls: a2 } = xe("frame-canvas"), l2 = m(0), u2 = m(0), f2 = m(1e3), h2 = m(1), y2 = Ar(), v2 = o("frameCanvasRef"), C2 = o("dropContentRef");
  let b2 = [0, 0], w2 = [0, 0];
  ...
  const x2 = He(() => {
    t2.value && (!function() {
      if (d(t2) && v2.value) {
        ...
        h2.value = n2 > a3 ? Number.parseFloat((o2 * a3 / y2.getCanvasConfig.width).toFixed(2)) : Number.parseFloat((t3 / a3 / y2.getCanvasConfig.height).toFixed(2)), d(h2) > 5 && (h2.value = 5), d(h2) < tg && (h2.value = tg);
      }
      y2.setScale(d(h2));
    }(), D2());
  }, 30);
  ...
  const $2 = He((e3) => {
    ...
    h2.value = "add" === e3 ? Math.min(5, Number.parseFloat((t3 + 0.05).toFixed(2))) : Math.max(tg, Number.parseFloat((t3 - 0.05).toFixed(2))), D2(), y2.setScale(h2.value);
  }, 100), L2 = He((e3) => {
  ...
  return (o2, n2) => (s(), r("div", { class: c(d(a2)), ref_key: "frameCanvasRef", ref: v2 }, [g(_h, { "ruler-x-left": l2.value, "ruler-y-top": u2.value, drift: f2.value, "ruler-x": e2.width, "ruler-y": e2.height }, null, 8, ["ruler-x-left", "ruler-y-top", "drift", "ruler-x", "ruler-y"]), p("div", { ref_key: "dropContentRef", ref: C2, class: "drop-content", onScroll: S2 }, [g(Lh, { width: e2.width, height: e2.height, drift: f2.value }, { default: M(() => [g(eg, { draggable: "true", onDragstart: k(T2, ["prevent", "stop"]) })]), _: 1 }, 8, ["width", "height", "drift"])], 544), g(Bh), g(Th, { scale: h2.value, "min-scale": 20, "max-scale": 500, onAddScale: n2[0] || (n2[0] = (e3) => d($2)("add")), onReduceScale: n2[1] || (n2[1] = (e3) => d($2)("reduce")), onChangeScale: d(L2), onAutoScale: n2[2] || (n2[2] = (e3) => t2.value = e3) }, null, 8, ["scale", "min-scale", "max-scale", "onChangeScale"])], 2));
} }), ag = to(og, [["__scopeId", "data-v-de9ae999"]]), ng = { key: 0, class: "header" }, lg = { class: "title" }, ig = { class: "content" }, rg = to(e({ name: "FrameBox", __name: "index", props: { showHeader: { type: Boolean, default: true }, icon: { type: String, default: "" }, iconSize: { type: Number, default: 14 }, title: { type: String, default: "" }, radioData: { type: Array, default: () => [] }, span: { type: Number, default: 8 }, chart: { type: Object } }, emits: ["radioChange", "titleClick"], setup(e2, { emit: t2 }) {
  ...
  return (t3, a3) => (s(), r("div", { class: c(d(n2)) }, [e2.showHeader ? (s(), r("div", ng, [p("div", { class: "icon-title", onClick: C2 }, [e2.icon ? (s(), h(d(Be), { key: 0, class: "title", icon: e2.icon, size: e2.iconSize }, null, 8, ["icon", "size"])) : f("", true), p("div", lg, S(e2.title), 1)]), g(d(Z), { class: "radio-group", size: "small", value: l2.value, "onUpdate:value": a3[0] || (a3[0] = (e3) => l2.value = e3), onChange: u2 }, { default: M(() => [(s(true), r(y, null, v(o2.radioData, (e3) => (s(), h(d(G), { key: e3.value, title: e3.tooltip }, { default: M(() => [g(d(Y), { class: "radio-button", value: e3.value }, { default: M(() => [g(d(Be), { icon: e3.icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["value"])]), _: 2 }, 1032, ["title"]))), 128))]), _: 1 }, 8, ["value"])])) : f("", true), p("div", ig, [(s(), h(O(e2.chart))), R(t3.$slots, "default", {}, void 0, true)])], 2));
} }), [["__scopeId", "data-v-8929fb33"]]), sg = { class: "item-content" }, ug = ["src"], cg = { class: "title", style: { flex: "1" } }, dg = { class: "iconContain" }, pg = e({ __name: "LayerItem", props: { parentItem: { type: Object }, item: { type: Object, required: true }, showEye: { type: Boolean, default: true }, showLock: { type: Boolean, default: true }, index: { type: Number }, expand: { type: Boolean, default: false }, externalSelect: { type: Boolean, default: false }, isSelect: { type: Boolean, default: false } }, emits: ["expand", "select", "enter", "leave"], setup(e2, { emit: o2 }) {
  t((e3) => ({ "56d1bd00": C2.value }));
  const n2 = e2, l2 = o2, { prefixCls: i2 } = xe("layer-item"), u2 = Ar(), g2 = jr(), y2 = a(() => u2.getChartImg(n2.item.chart.type)), { token: v2 } = F.useToken(), C2 = a(() => v2.value.colorInfoBg), b2 = Se().getThemeColor, M2 = a(() => [i2, { select: n2.externalSelect && n2.isSelect || !n2.externalSelect && (u2.getCurComponent?.chart.id === n2.item?.chart.id || u2.getSelectArea.components.map((e3) => e3.chart.id).includes(n2.item?.chart.id) || u2.getCurConfigComponent?.chart.id === n2.item?.chart.id), hover: u2.getCurHoverComponentId === n2.item?.chart.id || u2.getCurHoverComponentId === n2.parentItem?.chart.id && n2.parentItem?.chart?.options?.hoverId === n2.item?.chart.id }]), k2 = m(false);
  function w2() {
  ...
  return (t2, o3) => (s(), r("div", { class: c(M2.value), onMouseenter: w2, onMouseleave: x2, onMousedown: $2 }, [p("div", sg, [e2.item.chart.type === d(ns).MfCombine ? (s(), r("div", { key: 0, onClick: _2 }, [n2.expand ? (s(), h(d(mt), { key: 0, class: "group", "two-tone-color": d(b2) }, null, 8, ["two-tone-color"])) : (s(), h(d(yt), { key: 1, class: "group", "two-tone-color": d(b2) }, null, 8, ["two-tone-color"]))])) : (s(), r("img", { key: 1, class: "img", alt: "组件", src: y2.value }, null, 8, ug)), p("span", cg, S(e2.item?.chart.name), 1), p("div", dg, [!e2.showEye || d(g2).getLayerCollapsed || !k2.value && e2.item.chartContain.show ? f("", true) : (s(), h(d(Be), { key: 0, class: "icon", icon: e2.item.chartContain.show ? "ant-design:eye-outlined" : "ant-design:eye-invisible-outlined", onClick: o3[0] || (o3[0] = () => e2.item.chartContain.show = !e2.item.chartContain.show) }, null, 8, ["icon"])), e2.showLock && !d(g2).getLayerCollapsed && (k2.value || e2.item.chartContain.lock) ? (s(), h(d(Be), { key: 1, class: "icon", icon: e2.item.chartContain.lock ? "ant-design:lock-outlined" : "ant-design:unlock-outlined", onClick: o3[1] || (o3[1] = () => e2.item.chartContain.lock = !e2.item.chartContain.lock) }, null, 8, ["icon"])) : f("", true)])])], 34));
} }), fg = to(pg, [["__scopeId", "data-v-925f45da"]]), hg = e({ __name: "LayerGroup", props: { item: { type: Object, required: true }, expand: { type: Boolean, default: false }, showEye: { type: Boolean, default: true }, showLock: { type: Boolean, default: true }, showChildEye: { type: Boolean, default: true }, showChildLock: { type: Boolean, default: true }, externalSelect: { type: Boolean, default: false }, isSelect: { type: Boolean, default: false }, childSelect: { type: String, default: "" } }, emits: ["parentClick", "childClick"], setup(e2, { emit: t2 }) {
  const o2 = e2, l2 = t2, { prefixCls: i2 } = xe("layer-group"), u2 = Ar(), p2 = jr(), f2 = a(() => ({ "child-item": true, collapsed: p2.getLayerCollapsed })), C2 = m(o2.expand);
  function b2() {
  ...
  return n(() => o2.expand, (e3) => C2.value = e3), (t3, o3) => (s(), r("div", { class: c(d(i2)), onMouseenter: b2, onMouseleave: k2 }, [g(fg, { item: e2.item, onExpand: x2, expand: C2.value, "show-eye": e2.showEye, "show-lock": e2.showLock, "external-select": e2.externalSelect, "is-select": e2.isSelect, onClick: S2 }, null, 8, ["item", "expand", "show-eye", "show-lock", "external-select", "is-select"]), g(d(Rt), { show: C2.value, class: c(f2.value) }, { default: M(() => [(s(true), r(y, null, v(e2.item.chart.options.components, (t4, o4) => (s(), h(fg, { key: t4.chart.id, "parent-item": e2.item, item: t4, index: o4, "external-select": e2.externalSelect, "is-select": e2.childSelect === t4.chart.id, "show-eye": e2.showChildEye, "show-lock": e2.showChildLock, onSelect: (t5) => function(e3, t6) {
...
} }), gg = to(hg, [["__scopeId", "data-v-b118e01c"]]), mg = ["onDrop"], yg = e({ name: "FrameLayer", __name: "index", props: { collapsed: Nt.bool.def(false) }, setup(e2) {
  ...
  const u2 = m(false), f2 = Ar(), y2 = jr(), v2 = (e3) => {
  ...
  function b2(e3, t3) {
    e3.stopPropagation();
    const o3 = e3.dataTransfer?.getData(Or);
    if (o3) {
  ...
  function k2(e3, t3, o3) {
    !o3.ctrlKey && !o3.metaKey || 0 !== o3.button ? 0 === o3.button && (f2.cleanSelectArea(), f2.setCurComponent(e3, t3)) : Rp(e3);
  }
  function w2() {
  ...
  return (e3, t3) => (s(), h(rg, { class: c(n2.value), title: d(y2).getLayerCollapsed ? "" : "图层", icon: "iconfont:icon-mfish-layer", "icon-size": d(y2).getLayerCollapsed ? 16 : 12, "radio-data": l2, onTitleClick: C2, onDrop: t3[1] || (t3[1] = (e4) => b2(e4, r2.value.length)), onRadioChange: x2 }, { default: M(() => [0 === r2.value.length ? (s(), h(d(ke), { key: 0, "image-style": d(y2).getLayerCollapsed ? { height: "20px" } : {}, description: "暂无图层", image: d(ot) }, null, 8, ["image-style", "image"])) : (s(), h(d(vt), { key: 1 }, { default: M(() => [g(d(qt), { "item-key": "id", modelValue: r2.value, "onUpdate:modelValue": t3[0] || (t3[0] = (e4) => r2.value = e4), animation: "300", "ghost-class": "ghost", onChange: v2 }, { item: M(({ index: e4, element: t4 }) => [p("div", { onDrop: (t5) => b2(t5, e4), style: { "margin-top": "4px" } }, [t4.chart.type !== d(ns).MfCombine ? (s(), h(fg, { key: 0, item: t4, onMousedown: (o3) => k2(t4, e4, o3), onEnter: (e5) => {
    return o3 = t4, void f2.setCurHoverComponent(o3?.chart.id);
    var o3;
  }, onLeave: w2 }, null, 8, ["item", "onMousedown", "onEnter"])) : (s(), h(gg, { key: 1, item: t4, expand: u2.value, "show-child-lock": false, onMousedown: (o3) => k2(t4, e4, o3) }, null, 8, ["item", "expand", "onMousedown"]))], 40, mg)]), _: 1 }, 8, ["modelValue"])]), _: 1 }))]), _: 1 }, 8, ["class", "title", "icon-size"]));
} }), vg = to(yg, [["__scopeId", "data-v-3b66e5f3"]]), Cg = { class: "menu-item-hide-title" }, bg = { class: "title" }, Mg = to(e({ __name: "ChartMenus", props: { itemHeight: { type: Number }, width: { type: Number, default: 68 }, collapsed: { type: Boolean, default: false }, horizontal: { type: Boolean, default: false }, hideTitle: { type: Boolean, default: false }, backgroundColor: { type: Object, default: () => ({ light: "transparent", dark: "transparent" }) }, menus: { type: Array, default: () => [] } }, emits: ["menuClick", "menuChange"], setup(e2, { emit: o2 }) {
  ...
  return (t2, o3) => (s(), r("div", { class: c(d(f2)) }, [g(d(te), { class: c({ collapsed: e2.collapsed }), "selected-keys": C2.value, "onUpdate:selectedKeys": o3[0] || (o3[0] = (e3) => C2.value = e3), onClick: _2 }, { default: M(() => [g(d(vt), null, { default: M(() => [(s(true), r(y, null, v(e2.menus, (t3) => (s(), h(d(we), { id: t3.name, key: t3.value, style: u({ height: `${e2.itemHeight}px` }) }, { default: M(() => [e2.hideTitle ? (s(), h(d(G), { key: 0, title: t3.name, placement: "right" }, { default: M(() => [p("div", Cg, [g(d(Be), { style: u({ lineHeight: `${e2.itemHeight}px` }), icon: t3.icon }, null, 8, ["style", "icon"])])]), _: 2 }, 1032, ["title"])) : (s(), r("div", { key: 1, class: c(e2.horizontal ? "menu-item-horizontal" : "menu-item-vertical") }, [g(d(Be), { icon: t3.icon }, null, 8, ["icon"]), p("div", bg, S(t3.name), 1)], 2))]), _: 2 }, 1032, ["id", "style"]))), 128))]), _: 1 })]), _: 1 }, 8, ["class", "selected-keys"])], 2));
} }), [["__scopeId", "data-v-dea86191"]]), kg = ["onDragstart", "onDblclick"], wg = { class: "box-header" }, xg = { class: "box-header-text" }, Sg = { class: "box-content" }, _g = ["src"], $g = e({ __name: "ChartItems", props: { charts: { type: Array, default: () => [] }, mode: { type: String, default: "single" } }, setup(e2) {
  const t2 = e2, { prefixCls: o2 } = xe("chart-items"), a2 = Ar();
  return n(() => t2.charts, (e3) => {
    ...
    return s(), r("div", { draggable: "true", key: t4.type, class: "item-box", onDragstart: (e3) => function(e4, t5) {
      ...
      "img" === e4.target.className ? e4.dataTransfer?.setDragImage(a3, e4.offsetX + 15, e4.offsetY + 32) : e4.dataTransfer?.setDragImage(a3, e4.offsetX, e4.offsetY), e4.dataTransfer?.setData(Or, JSON.stringify(o4));
    }(e3, t4), onDblclick: (e3) => function(e4) {
      const t5 = pp(e4);
      t5 && rp.emit(Qr.CREATE_CHART, t5);
    }(t4) }, [p("div", wg, [g(d(Rl), { disabled: true, size: "single" === e2.mode ? "small" : "mini" }, null, 8, ["size"]), p("span", xg, S(t4.name), 1)]), p("div", Sg, [p("img", { class: "img", alt: "组件图片", src: (o3 = t4.type, a2.getChartImg(o3)) }, null, 8, _g)])], 40, kg);
    var o3;
  }), 128))], 2)]), _: 1 }, 8, ["class"]));
} }), Lg = to($g, [["__scopeId", "data-v-74651cba"]]), Ig = e({ name: "FrameChart", __name: "index", props: { collapsed: Nt.bool.def(false) }, setup(e2) {
  const t2 = e2, o2 = jr(), n2 = m(), l2 = m(), r2 = m(""), u2 = m(/* @__PURE__ */ new Map()), f2 = a(() => l2.value && l2.value.length > 0 ? l2.value.map((e3) => ({ name: e3.categoryName, icon: e3.icon, value: e3.id, children: e3.children })) : []), y2 = a(() => {
    if (n2.value) {
  ...
  return (t3, o3) => (s(), h(rg, { title: "组件", icon: "iconfont:icon-mfish-chart", "icon-size": 12, "radio-data": b2, onRadioChange: w2, class: c(k2.value), onTitleClick: S2 }, { default: M(() => [p("div", { class: c(`${d(v2)}-content`) }, [g(Mg, { menus: f2.value, "item-height": 58, "background-color": { light: "#f0f2f5", dark: "#232324" }, onMenuClick: x2, onMenuChange: _2 }, null, 8, ["menus"]), p("div", { class: c(["charts", { collapsed: e2.collapsed }]) }, [g(Mg, { menus: y2.value, collapsed: e2.collapsed, "hide-title": true, "background-color": { light: "#f8f8f9", dark: "#1e1e1f" }, horizontal: true, "item-height": 28, width: 40, onMenuChange: $2 }, null, 8, ["menus", "collapsed"]), g(Lg, { mode: C2.value, charts: u2.value.get(r2.value) }, null, 8, ["mode", "charts"])], 2)], 2)]), _: 1 }, 8, ["class"]));
} }), Dg = to(Ig, [["__scopeId", "data-v-3b8e6093"]]), Tg = ["onClick"], Ng = { class: "name" }, Bg = { class: "short-cut" }, Rg = e({ __name: "SubMenu", props: { subData: { type: Array, default: () => [] } }, setup(e2, { expose: t2 }) {
  const { prefixCls: a2 } = xe("frame-shortcut"), n2 = m(false), l2 = m(0), i2 = o("subMenuRef"), C2 = Se().getThemeColor;
  return t2({ show: function(e3) {
    n2.value = true;
  }, hidden: function() {
    n2.value = false;
  } }), (t3, o2) => (s(), h(P, { name: "shortcut" }, { default: M(() => [j(p("div", { ref_key: "subMenuRef", ref: i2, class: c(d(a2)), style: u({ top: `${l2.value}px`, left: "160px" }) }, [(s(true), r(y, null, v(e2.subData, (e3) => (s(), r(y, { key: e3.name }, [p("div", { class: "menu-item", onClick: e3.action }, [g(d(Be), { icon: e3.icon, color: d(C2) }, null, 8, ["icon", "color"]), p("span", Ng, S(e3.name), 1), p("span", Bg, S(e3.shortcut), 1)], 8, Tg), e3.divider ? (s(), r("div", { key: 0, class: c(`${d(a2)}__divider`) }, null, 2)) : f("", true)], 64))), 128))], 6), [[z, n2.value]])]), _: 1 }));
} }), qg = to(Rg, [["__scopeId", "data-v-f4307b07"]]), Ag = { class: "short-cut" }, jg = { class: "short-cut" }, Og = { class: "short-cut" }, zg = ["onClick"], Eg = { class: "name" }, Pg = { class: "short-cut" }, Fg = e({ name: "FrameShortcut", __name: "index", props: { menuTop: { type: Number, default: 0 }, menuLeft: { type: Number, default: 0 }, isUp: { type: Boolean, default: false } }, setup(e2, { expose: t2 }) {
  const n2 = e2, i2 = a(() => ({ top: `${n2.menuTop}px`, left: `${n2.menuLeft}px` })), m2 = Se().getThemeColor, { prefixCls: b2 } = xe("frame-shortcut"), w2 = Lp(), x2 = Ar(), _2 = o("frameShortcutRef"), $2 = o("canvasAlignMenuRef"), L2 = o("selectAlignMenuRef"), I2 = o("fitMenuRef"), { NoneShortcutKeyEnum: D2 } = jp(x2, w2);
  ...
  function q2() {
    z2(qp.CANVAS), $2.value?.show(n2.isUp);
  }
  function A2() {
    $2.value?.hidden();
  }
  function j2() {
    z2(qp.GROUP), L2.value?.show(n2.isUp);
  }
  function O2() {
    L2.value?.hidden();
  }
  function z2(e3) {
    w2.setAlignType(e3), 0 === x2.getSelectArea.components.length && x2.getCurComponent && w2.setAlignType(qp.CANVAS);
  }
  function E2() {
    I2.value?.show();
  }
  ...
  }, ["stop"])) }, [g(d(Be), { icon: "iconfont:icon-mfish-left-align", color: d(m2) }, null, 8, ["color"]), t3[4] || (t3[4] = p("span", { class: "name" }, "画布对齐", -1)), p("span", Ag, [g(d(Be), { icon: "ant-design:right-outlined" })]), g(qg, { ref_key: "canvasAlignMenuRef", ref: $2, "sub-data": B2 }, null, 8, ["sub-data"])], 32)) : f("", true), d(x2).getSelectArea.components.length > 1 ? (s(), r("div", { key: 1, class: "menu-item", onMouseenter: j2, onMouseleave: O2, onMouseup: t3[1] || (t3[1] = k(() => {
  }, ["stop"])) }, [g(d(Be), { icon: "iconfont:icon-mfish-left-align", color: d(m2) }, null, 8, ["color"]), t3[5] || (t3[5] = p("span", { class: "name" }, "选中对齐", -1)), p("span", jg, [g(d(Be), { icon: "ant-design:right-outlined" })]), g(qg, { ref_key: "selectAlignMenuRef", ref: L2, "sub-data": B2 }, null, 8, ["sub-data"])], 32)) : f("", true), d(x2).getCurComponent ? (s(), r("div", { key: 2, class: "menu-item", onMouseenter: E2, onMouseleave: F2, onMouseup: t3[2] || (t3[2] = k(() => {
  }, ["stop"])) }, [g(d(Be), { icon: "carbon:fit-to-screen", color: d(m2) }, null, 8, ["color"]), t3[6] || (t3[6] = p("span", { class: "name" }, "撑满", -1)), p("span", Og, [g(d(Be), { icon: "ant-design:right-outlined" })]), g(qg, { ref_key: "fitMenuRef", ref: I2, "sub-data": R2 }, null, 8, ["sub-data"])], 32)) : f("", true), d(x2).getCurComponent || d(x2).getSelectArea.components.length > 1 ? (s(), r("div", { key: 3, class: c(`${d(b2)}__divider`) }, null, 2)) : f("", true), (s(true), r(y, null, v(N2, (e4) => (s(), r(y, { key: e4.name }, [e4.show ? (s(), r("div", { key: 0, class: "menu-item", onClick: (t4) => {
    return o2 = e4.action, w2.setShowMenu(false), void C(() => {
      o2();
    });
    var o2;
  } }, [g(d(Be), { icon: e4.icon, color: d(m2) }, null, 8, ["icon", "color"]), p("span", Eg, S(e4.name), 1), p("span", Pg, S(e4.shortcut), 1)], 8, zg)) : f("", true), e4.show && e4.divider ? (s(), r("div", { key: 1, class: c(`${d(b2)}__divider`) }, null, 2)) : f("", true)], 64))), 128))], 38)) : f("", true)]), _: 1 }));
} }), Hg = to(Fg, [["__scopeId", "data-v-2dcb7415"]]);
export {
  fa as $,
  Ka as A,
  Xo as B,
