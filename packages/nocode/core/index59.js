import { defineComponent as e, ref as t, watch as n, reactive as l, openBlock as a, createElementBlock as o, normalizeClass as i, unref as r, createVNode as u, withCtx as s, Fragment as c, renderList as d, createBlock as v, useCssVars as g, computed as p, createElementVNode as f, createCommentVNode as y, mergeProps as m } from "vue";
...
const O = k(e({ __name: "TextHAlignStyle", props: { alignType: { type: String, default: void 0 } }, emits: ["alignChange"], setup(e2, { emit: g2 }) {
  ...
  }, { immediate: true, deep: true }), (t2, n2) => (a(), o("div", { class: i(r(d2)) }, [f("div", W, [e2.hideFont ? y("", true) : (a(), v(r(_), { key: 0, style: { flex: "1" }, value: k2.value, "onUpdate:value": n2[0] || (n2[0] = (e3) => k2.value = e3), options: r(I), onChange: G }, null, 8, ["value", "options"])), f("div", D, [u(r(T), { value: b2.value, "onUpdate:value": n2[1] || (n2[1] = (e3) => b2.value = e3), bordered: false, placeholder: "大小", controls: false, min: 6, maxlength: 4, onChange: J }, null, 8, ["value"]), n2[2] || (n2[2] = f("div", { class: "suffix" }, "px", -1))]), e2.hideAlign ? y("", true) : (a(), v(O, { key: 1, "align-type": e2.textStyle?.hAlignType, onAlignChange: w }, null, 8, ["align-type"]))]), f("div", L, [f("div", M, [u(r(F), { type: e2.colorType, "direct-confirm": true, value: z2.value, onConfirmChange: H, onInputChange: K }, null, 8, ["type", "value"])]), u($, m({ hide: e2.hideFontStyle }, R2.value, { onFontStyleChange: V }), null, 16, ["hide"])]), e2.verticalAlign ? (a(), o("div", N, [u(U, { "align-type": e2.textStyle?.vAlignType, onAlignChange: E }, null, 8, ["align-type"])])) : y("", true)], 2));
