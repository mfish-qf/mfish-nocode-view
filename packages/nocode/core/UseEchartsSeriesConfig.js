...
const z = { key: 0, class: "title" }, P = { key: 1, class: "title" }, T = { class: "title" }, U = _(e({ __name: "EchartsTooltipConfig", props: { hideTrigger: { type: Boolean, default: false } }, setup(e2) {
  ...
  return (t2, o2) => (a(), n("div", { class: l(r(h2)) }, [s(d, { title: "提示框", "default-expand": false, "allow-check": true, "title-check": r(_2).getCurConfigComponent.chart.options.tooltip?.show, onChecked: j }, { default: u(() => [e2.hideTrigger ? C("", true) : (a(), n("div", z, [o2[3] || (o2[3] = g(" 触发条件 ", -1)), p("div", null, [s(r(x), { size: "small", value: r(_2).getCurConfigComponent.chart.options.tooltip.trigger, "onUpdate:value": o2[0] || (o2[0] = (e3) => r(_2).getCurConfigComponent.chart.options.tooltip.trigger = e3) }, { default: u(() => [(a(), n(c, null, v(w2, (e3) => s(r(y), { key: e3.value, value: e3.value }, { default: u(() => [g(f(e3.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])])])), "axis" === r(_2).getCurConfigComponent.chart.options.tooltip?.trigger ? (a(), n("div", P, [o2[4] || (o2[4] = g(" 指示器类型 ", -1)), p("div", null, [s(r(x), { size: "small", value: U2.value, "onUpdate:value": o2[1] || (o2[1] = (e3) => U2.value = e3), onChange: A }, { default: u(() => [(a(), n(c, null, v(E2, (e3) => s(r(y), { key: e3.value, value: e3.value }, { default: u(() => [g(f(e3.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])])])) : C("", true), p("div", T, [o2[5] || (o2[5] = g(" 排序 ", -1)), p("div", null, [s(r(x), { size: "small", value: r(_2).getCurConfigComponent.chart.options.tooltip.order, "onUpdate:value": o2[2] || (o2[2] = (e3) => r(_2).getCurConfigComponent.chart.options.tooltip.order = e3) }, { default: u(() => [(a(), n(c, null, v(b, (e3) => s(r(y), { key: e3.value, value: e3.value }, { default: u(() => [g(f(e3.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])])])]), _: 1 }, 8, ["title-check"])], 2));
