...
import { u as U, d as R, M as j, ao as w, ap as A, _ as I } from "./index.js";
...
const J = { class: "title" }, N = { class: "title" }, z = { key: 0, class: "title" }, P = { key: 1, class: "title" }, W = { key: 2, class: "title" }, Y = { key: 3, class: "check-group" }, q = { class: "title" }, D = { class: "title" }, H = I(e({ __name: "EchartsSeriesConfig", props: { title: { type: String, default: "柱体样式" }, series: { type: Object, default: () => {
  ...
  return o(() => F2.getCurConfigComponent, (e3) => {
    e3 && le();
  }, { immediate: true }), (a2, l2) => (n(), i("div", { class: u(r(b2)) }, [s(R, { title: e2.title, "default-expand": false, "allow-copy": true, onCopy: te, onPaste: ie }, { default: v(() => [s(R, { title: "图形样式" }, { default: v(() => [c("div", J, [l2[10] || (l2[10] = m(" 图形类型 ", -1)), s(r(L), { size: "small", value: E2.value, "onUpdate:value": l2[0] || (l2[0] = (e3) => E2.value = e3), onChange: oe }, { default: v(() => [(n(), i(f, null, p(I2, (e3, a3) => s(r($), { key: a3, value: e3.value }, { default: v(() => [m(g(e3.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])]), c("div", N, [l2[11] || (l2[11] = m(" 图形颜色 ", -1)), c("div", null, [s(r(j), { placeholder: "设置图形颜色，格式#FFFFFF", value: H2.value, onConfirmChange: ue, onInputChange: re }, null, 8, ["value"])])]), "bar" === x2.value.type ? (n(), i("div", z, [l2[12] || (l2[12] = m(" 圆角 ", -1)), s(r(G), { value: Q.value, "onUpdate:value": l2[1] || (l2[1] = (e3) => Q.value = e3), min: 0, max: V.value, onChange: se }, null, 8, ["value", "max"])])) : d("", true), "bar" === x2.value.type ? (n(), i("div", P, [l2[13] || (l2[13] = m(" 左上 ", -1)), s(r(G), { "tip-formatter": (e3) => `左上圆角：${e3}`, value: T[0], "onUpdate:value": l2[2] || (l2[2] = (e3) => T[0] = e3), min: 0, max: V.value, onChange: ve }, null, 8, ["tip-formatter", "value", "max"]), l2[14] || (l2[14] = m(" 右上 ", -1)), s(r(G), { "tip-formatter": (e3) => `右上圆角：${e3}`, value: T[1], "onUpdate:value": l2[3] || (l2[3] = (e3) => T[1] = e3), min: 0, max: V.value, onChange: ve }, null, 8, ["tip-formatter", "value", "max"])])) : d("", true), "bar" === x2.value.type ? (n(), i("div", W, [l2[15] || (l2[15] = m(" 左下 ", -1)), s(r(G), { "tip-formatter": (e3) => `左下圆角：${e3}`, value: T[3], "onUpdate:value": l2[4] || (l2[4] = (e3) => T[3] = e3), min: 0, max: V.value, onChange: ve }, null, 8, ["tip-formatter", "value", "max"]), l2[16] || (l2[16] = m(" 右下 ", -1)), s(r(G), { "tip-formatter": (e3) => `右下圆角：${e3}`, value: T[2], "onUpdate:value": l2[5] || (l2[5] = (e3) => T[2] = e3), min: 0, max: V.value, onChange: ve }, null, 8, ["tip-formatter", "value", "max"])])) : d("", true), s(r(B), { checked: ae.value, "onUpdate:checked": l2[6] || (l2[6] = (e3) => ae.value = e3), onChange: ge }, { default: v(() => [m(" 堆叠" + g("line" === x2.value?.type ? "折线图" : "柱状图"), 1)]), _: 1 }, 8, ["checked"]), "line" === x2.value.type ? (n(), i("div", Y, [s(r(B), { checked: Z.value, "onUpdate:checked": l2[7] || (l2[7] = (e3) => Z.value = e3), onChange: fe }, { default: v(() => [...l2[17] || (l2[17] = [m(" 平滑折线", -1)])]), _: 1 }, 8, ["checked"]), s(r(B), { checked: ee.value, "onUpdate:checked": l2[8] || (l2[8] = (e3) => ee.value = e3), onChange: pe }, { default: v(() => [...l2[18] || (l2[18] = [m(" 面积折线", -1)])]), _: 1 }, 8, ["checked"])])) : d("", true)]), _: 1 }), s(O, { series: e2.series, onLabelChange: he }, null, 8, ["series"]), s(R, { title: "背景设置", "default-expand": false, "allow-check": true, "title-check": e2.series?.showBackground, onChecked: ne }, { default: v(() => [c("div", q, [l2[19] || (l2[19] = m(" 背景颜色 ", -1)), c("div", null, [s(r(j), { placeholder: "设置背景颜色，格式#FFFFFF", type: 1, value: K2.value, onConfirmChange: ce, onInputChange: de }, null, 8, ["value"])])]), c("div", D, [l2[20] || (l2[20] = m(" 圆角 ", -1)), s(r(G), { value: X.value, "onUpdate:value": l2[9] || (l2[9] = (e3) => X.value = e3), step: 1, min: 0, max: V.value, onChange: me }, null, 8, ["value", "max"])])]), _: 1 }, 8, ["title-check"])]), _: 1 }, 8, ["title"])], 2));
  ...
  return (e3, d2) => (n(), h(C, { class: u(r(a2)) }, { default: v(() => [s(x), s(k), s(E), s(b), s(_, { axis: r(l2).getCurConfigComponent.chart.options.xAxis, onAxisChange: o2 }, null, 8, ["axis"]), s(_, { "axis-type": "Y", axis: r(l2).getCurConfigComponent.chart.options.yAxis, onAxisChange: c2 }, null, 8, ["axis"]), (n(true), i(f, null, p(r(l2).getCurConfigComponent.chart.options?.series, (e4, a3) => (n(), h(H, { title: `${"line" === e4?.type ? "折线图" : "柱状图"}-${a3 + 1}`, key: a3, series: e4, onSeriesChange: (e5) => r(t2)(e5, a3) }, null, 8, ["title", "series", "onSeriesChange"]))), 128))]), _: 1 }, 8, ["class"]));
