...
import { u as c, i as f, _ as l } from "./index.js";
...
const d = l(o({ __name: "MfDecoration7Config", setup(o2) {
  ...
  return (o3, p2) => (e(), t(m, { class: i(s(l2)) }, { default: r(() => [p2[1] || (p2[1] = n("div", { class: "title" }, "标题", -1)), a(s(f), { value: s(d2).getCurConfigComponent.chart.options.title, "onUpdate:value": p2[0] || (p2[0] = (o4) => s(d2).getCurConfigComponent.chart.options.title = o4), "is-number": false, placeholder: "标题内容" }, null, 8, ["value"]), a(u)]), _: 1, __: [1] }, 8, ["class"]));
