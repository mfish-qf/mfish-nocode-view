...
const v = h(t({ __name: "MfMapLineDataConfig", setup(t2) {
  const h2 = C(), { setFields: v2, deleteFields: D, getFields: x, setDataTable: _ } = g(), { prefixCls: S } = u("map-line-data-config"), { resetDefault: j } = m(), F = a(() => h2.getCurConfigComponent.chart.data.fields ? h2.getCurConfigComponent.chart.data.fields?.start ?? [] : []), J = a(() => h2.getCurConfigComponent.chart.data.fields ? h2.getCurConfigComponent.chart.data.fields?.end ?? [] : []), b = a(() => h2.getCurConfigComponent.chart.data.fields ? h2.getCurConfigComponent.chart.data.fields?.value ?? [] : []), I = a(() => h2.getCurConfigComponent.chart.data.dataSet?.source ? JSON.stringify(h2.getCurConfigComponent.chart.data.dataSet.source) : "");
  function M() {
