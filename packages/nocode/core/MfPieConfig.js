...
import { d as x, T as U, an as _, _ as k, u as A } from "./index.js";
...
const I = { class: "title" }, F = { class: "title" }, O = { class: "title" }, P = { class: "title" }, R = { class: "title" }, J = { class: "title" }, M = { class: "title" }, N = { class: "title" }, W = k(e({ __name: "PieSeriesConfig", props: { title: { type: String, default: "柱体样式" }, series: { type: Object, default: () => {
  ...
  return a(() => {
    ...
    const g3 = u("AInput");
    return n(), t("div", { class: v(i(C2)) }, [o(x, { title: e2.title, "default-expand": false, "allow-copy": true, onCopy: ee, onPaste: le }, { default: s(() => [o(x, { title: "图形样式" }, { default: s(() => [r("div", I, [a2[13] || (a2[13] = d(" 内圈半径 ", -1)), o(i(E), { value: k2.value, "onUpdate:value": a2[0] || (a2[0] = (e3) => k2.value = e3), min: 0, max: 100, onChange: se }, null, 8, ["value"]), a2[14] || (a2[14] = d(" 外圈半径 ", -1)), o(i(E), { value: A2.value, "onUpdate:value": a2[1] || (a2[1] = (e3) => A2.value = e3), min: 0, max: 100, onChange: se }, null, 8, ["value"])]), r("div", F, [a2[15] || (a2[15] = d(" 横向偏移 ", -1)), o(i(E), { value: W2.value, "onUpdate:value": a2[2] || (a2[2] = (e3) => W2.value = e3), min: 0, max: 100, onChange: re }, null, 8, ["value"]), a2[16] || (a2[16] = d(" 纵向偏移 ", -1)), o(i(E), { value: B2.value, "onUpdate:value": a2[3] || (a2[3] = (e3) => B2.value = e3), min: 0, max: 100, onChange: re }, null, 8, ["value"])]), r("div", O, [a2[17] || (a2[17] = d(" 起始角度 ", -1)), o(i(E), { value: T.value, "onUpdate:value": a2[4] || (a2[4] = (e3) => T.value = e3), step: 5, min: 0, max: 360, onChange: de }, null, 8, ["value"]), a2[18] || (a2[18] = d(" 结束角度 ", -1)), o(i(E), { value: q.value, "onUpdate:value": a2[5] || (a2[5] = (e3) => q.value = e3), step: 5, min: 0, max: 360, onChange: ce }, null, 8, ["value"])]), r("div", P, [a2[19] || (a2[19] = d(" 圆角 ", -1)), o(i(E), { value: S2.value, "onUpdate:value": a2[6] || (a2[6] = (e3) => S2.value = e3), min: 0, max: 50, onChange: ae }, null, 8, ["value"]), a2[20] || (a2[20] = d(" 扇区间隔 ", -1)), o(i(E), { value: D.value, "onUpdate:value": a2[7] || (a2[7] = (e3) => D.value = e3), min: 0, max: 360, onChange: fe }, null, 8, ["value"])])]), _: 1 }), o(x, { title: "标签设置", "default-expand": false, "allow-check": true, "title-check": e2.series?.label?.show, onChecked: ue }, { default: s(() => [o(i(U), { "hide-font-style": [i(_).Underline, i(_).Strikethrough], "color-type": 1, "hide-align": true, "text-style": G.value, onFontChange: ne, onSizeChange: ne, onFontStyleChange: te, onColorChange: ne }, null, 8, ["hide-font-style", "text-style"]), r("div", R, [o(i(L), { checked: H.value, "onUpdate:checked": a2[8] || (a2[8] = (e3) => H.value = e3), onChange: ve }, { default: s(() => [...a2[21] || (a2[21] = [d(" 显示标签线", -1)])]), _: 1 }, 8, ["checked"]), a2[22] || (a2[22] = d(" 平滑度 ", -1)), o(i(E), { value: K.value, "onUpdate:value": a2[9] || (a2[9] = (e3) => K.value = e3), step: 0.1, min: 0, max: 1, onChange: ie }, null, 8, ["value"])]), r("div", J, [a2[23] || (a2[23] = d(" 标签位置 ", -1)), o(i($), { size: "small", value: X.value, "onUpdate:value": a2[10] || (a2[10] = (e3) => X.value = e3), onChange: he }, { default: s(() => [(n(), t(c, null, f(V, (e3, l3) => o(i(z), { key: l3, value: e3.value }, { default: s(() => [d(h(e3.title), 1)]), _: 2 }, 1032, ["value"])), 64))]), _: 1 }, 8, ["value"])]), r("div", M, [a2[24] || (a2[24] = d(" 标签角度 ", -1)), o(i(E), { value: Y.value, "onUpdate:value": a2[11] || (a2[11] = (e3) => Y.value = e3), min: -90, max: 90, onChange: ge }, null, 8, ["value"])]), r("div", N, [a2[25] || (a2[25] = d(" 标签格式 ", -1)), r("div", null, [o(g3, { value: Q.value, "onUpdate:value": a2[12] || (a2[12] = (e3) => Q.value = e3), placeholder: "格式{a}{b}{c}{d} 详情参考pie label formatter属性", onChange: oe }, null, 8, ["value"])])])]), _: 1 }, 8, ["title-check"])]), _: 1 }, 8, ["title"])], 2);
  };
