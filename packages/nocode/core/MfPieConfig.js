...
import { f as b, T as S, ao as x, _ as U, u as _ } from "./index.js";
...
const E = { class: "title" }, L = { class: "title" }, $ = { class: "title" }, z = { class: "title" }, F = { class: "title" }, I = U(e({ __name: "PieSeriesConfig", props: { title: { type: String, default: "柱体样式" }, series: { type: Object, default: () => {
} } }, emits: ["seriesChange"], setup(e2, { emit: d2 }) {
  const c2 = e2, g2 = d2, { prefixCls: h2 } = k("pie-series-config"), f2 = l(c2.series), { createMessage: m2 } = A(), p2 = l(0), C2 = l(0), y2 = l(50), U2 = l(50), _2 = l(50), I2 = l(), O2 = l(), P = l(), R = l({}), J = l(true), M = l(0);
  function N() {
    var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l;
    void 0 !== ((_a = f2.value.itemStyle) == null ? void 0 : _a.borderRadius) && (p2.value = f2.value.itemStyle.borderRadius), void 0 !== f2.value.smooth && (M.value = f2.value.smooth), void 0 !== f2.value.radius && (C2.value = f2.value.radius[0].replace("%", ""), y2.value = f2.value.radius[1].replace("%", "")), void 0 !== f2.value.center && (U2.value = f2.value.center[0].replace("%", ""), _2.value = f2.value.center[1].replace("%", "")), void 0 !== f2.value.startAngle && (I2.value = f2.value.startAngle), void 0 !== f2.value.endAngle && (O2.value = f2.value.endAngle), R.value = {}, R.value.font = (_c = (_b = f2.value) == null ? void 0 : _b.label) == null ? void 0 : _c.fontFamily, R.value.fontSize = (_f = (_e = (_d = f2.value) == null ? void 0 : _d.label) == null ? void 0 : _e.fontSize) == null ? void 0 : _f.replace("px", ""), R.value.textColor = (_h = (_g = f2.value) == null ? void 0 : _g.label) == null ? void 0 : _h.color;
  ...
  function B(e3) {
    ...
    l2 && l2.series ? (f2.value = l2.series, N(), g2("seriesChange", f2.value)) : m2.warning("粘贴失败，无配置或不匹配");
  }
  function T() {
    var _a;
  ...
  function V() {
    f2.value.center = [`${U2.value}%`, `${_2.value}%`], g2("seriesChange", f2.value);
  }
  function X() {
