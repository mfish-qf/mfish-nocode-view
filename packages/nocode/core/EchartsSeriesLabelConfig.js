...
import { u as b, d as c, T as h, an as f, _ as d } from "./index.js";
...
const m = { class: "title" }, C = d(e({ __name: "EchartsSeriesLabelConfig", props: { series: { type: Object, default: () => {
  ...
  }, { immediate: true }), (l2, a2) => (o(), t("div", { class: i(n(S)) }, [u(c, { title: "标签设置", "default-expand": false, "allow-check": true, "title-check": e2.series?.label?.show, onChecked: w }, { default: s(() => [u(n(h), { "hide-font-style": [n(f).Underline, n(f).Strikethrough], "color-type": 1, "vertical-align": true, "text-style": k.value, onFontChange: F, onSizeChange: F, onFontStyleChange: B, onColorChange: F, onHAlignChange: L, onVAlignChange: z }, null, 8, ["hide-font-style", "text-style"]), v("div", m, [a2[1] || (a2[1] = r(" 标签位置 ", -1)), u(n(p), { value: A.value, "onUpdate:value": a2[0] || (a2[0] = (e3) => A.value = e3), options: T, "show-search": false, "filter-option": false, placeholder: "请选择", onChange: I }, null, 8, ["value"])])]), _: 1 }, 8, ["title-check"])], 2));
