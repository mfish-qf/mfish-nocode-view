...
import { u as p, T as g, ap as f, J as h, M as m, _ as y } from "./index.js";
import "lodash-es";
...
const S = y(t({ __name: "MfSegmentedStyleConfig", setup(t2) {
  const { prefixCls: y2 } = u("segmented-style-config"), S2 = p(), v = e({}), d = e({}), x = e(false), k = e();
  function _(t3) {
  ...
  }, { immediate: true }), (t3, e2) => (l(), n(c, { class: i(a(y2)) }, { default: s(() => [e2[1] || (e2[1] = r("div", { class: "title" }, "文本样式", -1)), C(a(g), { "color-type": 1, "text-style": v.value, "hide-align": true, "hide-font-style": [a(f).Strikethrough], onColorChange: _, onFontChange: z, onSizeChange: F, onFontStyleChange: I }, null, 8, ["text-style", "hide-font-style"]), e2[2] || (e2[2] = r("div", { class: "title" }, "选中样式", -1)), C(a(g), { "color-type": 1, "text-style": d.value, "hide-align": true, "hide-font-style": [a(f).Strikethrough], onColorChange: j, onFontChange: B, onSizeChange: M, onFontStyleChange: J }, null, 8, ["text-style", "hide-font-style"]), C(a(h), { checked: x.value, "onUpdate:checked": e2[0] || (e2[0] = (t4) => x.value = t4), title: "整体背景透明", tooltip: "设置背景透明后，可以通过通用配置-背景色设置背景颜色", onChange: T }, null, 8, ["checked"]), e2[3] || (e2[3] = r("div", { class: "title" }, "选中项背景色", -1)), C(a(m), { value: k.value, onConfirmChange: U, onInputChange: b }, null, 8, ["value"])]), _: 1, __: [1, 2, 3] }, 8, ["class"]));
