...
import { u as C, h as v, i as m, T as h, ao as y, I as _, _ as x } from "./index.js";
...
const I = { class: "title" }, w = { class: "title" }, A = { class: "title" }, F = { class: "title" }, H = { style: { display: "flex", gap: "6px" } }, L = { class: "title" }, E = x(e({ __name: "EchartsLegendConfig", setup(e2) {
  ...
  function J(e3) {
    var _a, _b;
    (_a = x2.getCurConfigComponent.chart.options.legend.textStyle) == null ? true : delete _a.fontStyle, (_b = x2.getCurConfigComponent.chart.options.legend.textStyle) == null ? true : delete _b.fontWeight, K(e3);
  }
  function K(e3) {
  ...
  return l(() => x2.getCurConfigComponent, (e3) => {
    e3 && function() {
      ...
      D.value = {};
      const e4 = (_b = (_a = x2.getCurConfigComponent) == null ? void 0 : _a.chart) == null ? void 0 : _b.options;
      if (!e4) return;
