...
import { API_SAVE as G, getDataFieldsById as Q, getApiParamsList as W } from "@mfish/custom-api";
import { _ as K, u as X, Q as Y, R as Z, s as ee, S as ae, U as te, I as ne, b as oe, V as re, W as ie, e as le, d as se } from "./index.js";
import "@vueuse/core";
...
const fe = e({ __name: "DataSelectModal", props: { selectData: { type: Object } }, emits: ["success", "register"], setup(e2, { emit: i2 }) {
...
} }), Ce = { key: 0, class: "placeholder" }, ge = { key: 0, class: "warning" }, ve = { key: 2, class: "icon-group" }, he = K(e({ __name: "DataSelect", props: { selectData: { type: Object }, dataId: { type: String, default: "" }, dataName: { type: String, default: "" }, isResource: { type: Boolean, default: false }, screenId: { type: String, default: "" } }, emits: ["dataChange", "dataRefresh"], setup(e2, { emit: y2 }) {
  i((e3) => ({ v719f0847: b2.value }));
  const k2 = e2, _2 = y2;
  s(() => k2.dataId, (e3) => {
    e3 ? (A2.id = e3, A2.name = k2.dataName) : (A2.id = "", A2.name = "");
  });
  const { prefixCls: N2 } = U("data-select"), { token: R2 } = D.useToken(), b2 = l(() => R2.value.colorBorder), I2 = d(""), [T2, { openModal: x2 }] = j(), A2 = u({ id: k2.dataId, name: k2.dataName }), V2 = d(false), { open: M2 } = z(G, H2);
  function O2() {
  ...
  return (i2, l2) => (t(), c("div", { class: m(n(N2)) }, [p("div", { class: "input", onMouseenter: O2, onMouseleave: S2, onClick: w2 }, [A2.id ? (t(), a(n(E), { key: 1, title: A2.name }, { default: o(() => [p("div", { class: "title", style: g(e2.isResource ? { textDecoration: "line-through", color: "#999" } : {}) }, v(A2.name), 5), e2.isResource ? (t(), c("div", ge, " 注意：请将样例数据更换为自己的数据")) : C("", true)]), _: 1 }, 8, ["title"])) : (t(), c("div", Ce, "请选择数据来源")), I2.value ? (t(), c("div", ve, [f(n(E), { title: e2.isResource ? "查看样例数据源配置" : "编辑数据源" }, { default: o(() => [f(n(L), { class: "icon", icon: e2.isResource ? "ant-design:search-outlined" : "ant-design:edit-outlined", onClick: h(J2, ["stop"]) }, null, 8, ["icon"])]), _: 1 }, 8, ["title"]), f(n(E), { title: "清空数据源" }, { default: o(() => [f(n(L), { class: "delete-icon", size: 14, icon: I2.value, onClick: h($2, ["stop"]) }, null, 8, ["icon"])]), _: 1 })])) : C("", true), f(fe, { onRegister: n(T2), onSuccess: P2, "select-data": e2.selectData }, { default: o(() => [r(i2.$slots, "default", {}, void 0, true)]), _: 3 }, 8, ["onRegister", "select-data"])], 32), f(n(E), { title: "刷新数据源" }, { default: o(() => [f(n(L), { class: "icon", icon: "ant-design:sync-outlined", onClick: n(F2), spin: V2.value }, null, 8, ["onClick", "spin"])]), _: 1 })], 2));
} }), [["__scopeId", "data-v-d0458915"]]), ye = ["draggable", "onMouseenter", "onDragstart"], ke = { class: "title" }, _e = K(e({ __name: "FieldConfig", props: { fieldList: { type: Array, default: () => [] } }, setup(e2) {
  i((e3) => ({ v362ddaab: b2.value }));
  const r2 = e2, s2 = d(-1), u2 = d(-1), g2 = d(""), { prefixCls: h2 } = U("field-config"), { token: R2 } = D.useToken(), b2 = l(() => R2.value.colorInfoBg), I2 = d(), T2 = X();
  function x2() {
    s2.value = -1;
  }
  function A2() {
  ...
  return (r3, i2) => {
    ...
    })(a2, e3) }, [f(n(L), { class: "icon", icon: n(Y)(e3.dataType) }, null, 8, ["icon"]), u2.value !== r4 ? (t(), a(n(E), { key: 0, title: e3.colName + (e3.comment ? `[${e3.comment}]` : ""), placement: "left" }, { default: o(() => [p("div", ke, v(e3.rename ?? e3.colName), 1)]), _: 2 }, 1032, ["title"])) : (t(), a(l2, { key: 1, bordered: false, value: g2.value, "onUpdate:value": i2[0] || (i2[0] = (e4) => g2.value = e4), ref_for: true, ref: (e4) => I2.value = e4, onPressEnter: (a2) => V2(e3), onBlur: M2 }, null, 8, ["value", "onPressEnter"])), s2.value === r4 && u2.value !== r4 ? (t(), a(n(E), { key: 2, title: "重命名" }, { default: o(() => [f(n(L), { class: "icon edit", icon: "ant-design:edit-outlined", onClick: A2 })]), _: 1 })) : C("", true), u2.value === r4 ? (t(), a(n(E), { key: 3, title: "保存" }, { default: o(() => [f(n(L), { class: "icon edit", icon: "ant-design:save-outlined", onClick: (a2) => V2(e3) }, null, 8, ["onClick"])]), _: 2 }, 1024)) : C("", true)], 40, ye))), 128))], 2);
  };
} }), [["__scopeId", "data-v-79b53fd9"]]), Ne = { class: "title" }, Re = { class: "param" }, be = { key: 0, style: { color: "red" } }, Ie = { key: 0 }, De = { key: 1 }, Ee = { key: 2 }, Te = K(e({ __name: "DataParamsConfig", props: { params: { type: Array, default: () => [] } }, emits: ["paramChange"], setup(e2, { emit: r2 }) {
  const i2 = r2, { prefixCls: l2 } = U("data-params-config"), s2 = X(), { createMessage: u2 } = w();
  const d2 = (e3, a2) => {
    const t2 = () => {
  ...
  const l2 = i2, g2 = X(), v2 = [{ label: "静态数据", value: 0 }, { label: "动态数据", value: 1 }], { prefixCls: h2 } = U("data-config"), y2 = d([]), _2 = d([]), N2 = u({ open: false, interval: 5 }), I2 = u({ open: false, events: [] });
  function D2(e3) {
  ...
  function x2() {
    ...
    if (e3) {
      const a2 = [], t2 = g2.getCurConfigComponent?.chart?.isResource ? re : Q;
  ...
  return b(() => {
    ...
    _2.value = e4;
  })(e3), onMouseleave: T2 }, [f(n(L), { class: "icon", icon: n(Y)(o2.dataType) }, null, 8, ["icon"]), p("div", Be, v(o2.rename ?? o2.colName), 1), _2.value === e3 ? (t(), a(n(L), { key: 0, class: "icon", icon: "ant-design:delete-outlined", onClick: (a2) => (function(e4) {
    k2.value.splice(e4, 1), h2("dataChange", k2.value);
  })(e3) }, null, 8, ["onClick"])) : C("", true)], 40, je)]), _: 1 }, 8, ["modelValue"])]), _: 1 }))], 38));
} }), qe = K(ze, [["__scopeId", "data-v-a508a4de"]]);
export {
  $e as D,
  qe as a
};
