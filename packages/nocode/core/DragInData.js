...
const pe = e({ __name: "DataSelectModal", props: { selectData: { type: Object } }, emits: ["success", "register"], setup(e2, { emit: r2 }) {
  ...
  const { prefixCls: N2 } = w("data-select"), { token: b2 } = R.useToken(), D2 = l(() => b2.value.colorBorder), I2 = d(""), [T2, { openModal: x2 }] = B(), A2 = u({ id: _2.dataId, name: _2.dataName }), V2 = d(false), { open: M2 } = z(F, J2);
  function O2() {
  ...
  function q2() {
    ...
    const a2 = P.resolve({ path: "/low-code/mf-api/config", query: e3 });
    M2(a2);
  }
  const H2 = oe(() => J2(), 200);
  function J2() {
  ...
  return (r2, l2) => (t(), c("div", { class: m(n(N2)) }, [p("div", { class: "input", onMouseenter: O2, onMouseleave: S2, onClick: U2 }, [A2.id ? (t(), a(n(E), { key: 1, title: A2.name }, { default: o(() => [p("div", { class: "title", style: g(e2.isResource ? { textDecoration: "line-through", color: "#999" } : {}) }, v(A2.name), 5), e2.isResource ? (t(), c("div", Ce, " 注意：请将样例数据更换为自己的数据")) : C("", true)]), _: 1 }, 8, ["title"])) : (t(), c("div", fe, "请选择数据来源")), I2.value ? (t(), c("div", ge, [f(n(E), { title: e2.isResource ? "查看样例数据源配置" : "编辑数据源" }, { default: o(() => [f(n(L), { class: "icon", icon: e2.isResource ? "ant-design:search-outlined" : "ant-design:edit-outlined", onClick: h(q2, ["stop"]) }, null, 8, ["icon"])]), _: 1 }, 8, ["title"]), f(n(E), { title: "清空数据源" }, { default: o(() => [f(n(L), { class: "delete-icon", size: 14, icon: I2.value, onClick: h(j2, ["stop"]) }, null, 8, ["icon"])]), _: 1 })])) : C("", true), f(pe, { onRegister: n(T2), onSuccess: $2, "select-data": e2.selectData }, { default: o(() => [i(r2.$slots, "default", {}, void 0, true)]), _: 3 }, 8, ["onRegister", "select-data"])], 32), f(n(E), { title: "刷新数据源" }, { default: o(() => [f(n(L), { class: "icon", icon: "ant-design:sync-outlined", onClick: n(H2), spin: V2.value }, null, 8, ["onClick", "spin"])]), _: 1 })], 2));
  ...
  const i2 = e2, s2 = d(-1), u2 = d(-1), g2 = d(""), { prefixCls: h2 } = w("field-config"), { token: b2 } = R.useToken(), D2 = l(() => b2.value.colorInfoBg), I2 = d(), T2 = H();
  function x2() {
    s2.value = -1;
  }
  function A2() {
  ...
  const d2 = (e3, a2) => {
    const t2 = () => {
      ...
      if (a3?.chart.data.params) {
        for (const e5 of Object.values(a3?.chart.data.params)) if (e5?.value) if (se(e5.value)) for (const a4 of e5.value) a4.id === s2.getCurConfigComponent.chart.id && t2(), n2(a4.id);
  ...
  const l2 = r2, g2 = H(), v2 = [{ label: "静态数据", value: 0 }, { label: "动态数据", value: 1 }], { prefixCls: h2 } = w("data-config"), y2 = d([]), k2 = d([]), N2 = u({ open: false, interval: 5 }), I2 = u({ open: false, events: [] });
  function R2(e3) {
  ...
  function x2() {
    ...
    if (e3) {
      const a2 = [], t2 = g2.getCurConfigComponent?.chart?.isResource ? Z : ee;
      a2.push(t2(e3).then((e4) => {
        ...
        const e4 = await ae({ apiId: g2.getCurConfigComponent?.chart.data.id, pageNum: 1, pageSize: 1e4 });
        e4.total > 0 ? (k2.value = e4.list, function(e5) {
          ...
          if (!g2.getCurConfigComponent.chart.data?.params) return void a3();
          let t3 = false;
  ...
  return D(() => {
    ...
    if (0 === e3) {
      const e4 = Y[g2.getCurConfigComponent?.chart.type];
...
} }), $e = q(Le, [["__scopeId", "data-v-a3530529"]]), je = ["onMouseenter"], Be = { class: "title" }, Pe = e({ __name: "DragInData", props: { fields: { type: Array, default: () => [] }, maxCount: { type: Number, default: 9999 }, height: { type: Number, default: 0 } }, emits: ["dataChange"], setup(e2, { emit: i2 }) {
  r((e3) => ({ "58b0ea90": b2.value }));
  const u2 = e2, h2 = i2, { prefixCls: y2 } = w("drag-in-data"), _2 = d(u2.fields), k2 = d(-1), { token: N2 } = R.useToken(), b2 = l(() => N2.value.colorInfoBg);
  s(() => u2.fields, () => {
    _2.value = u2.fields;
  });
  const E2 = (e3) => {
    const a2 = e3.dataTransfer?.getData(W);
    if (!a2) return;
  ...
  return D(() => {
    ...
    k2.value = e4;
  }(e3), onMouseleave: T2 }, [f(n(L), { class: "icon", icon: n(J)(o2.dataType) }, null, 8, ["icon"]), p("div", Be, v(o2.rename ?? o2.colName), 1), k2.value === e3 ? (t(), a(n(L), { key: 0, class: "icon", icon: "ant-design:delete-outlined", onClick: (a2) => function(e4) {
    _2.value.splice(e4, 1), h2("dataChange", _2.value);
  }(e3) }, null, 8, ["onClick"])) : C("", true)], 40, je)]), _: 1 }, 8, ["modelValue"])]), _: 1 }))], 38));
} }), ze = q(Pe, [["__scopeId", "data-v-a508a4de"]]);
export {
  $e as D,
  ze as a
};
