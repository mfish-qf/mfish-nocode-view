...
const ke = e({ __name: "DataSelectModal", props: { selectData: { type: Object } }, emits: ["success", "register"], setup(e2, { emit: i2 }) {
  ...
  function T2() {
    ...
    if (e3) {
      const a2 = [], t2 = ((_f = (_e2 = C2.getCurConfigComponent) == null ? void 0 : _e2.chart) == null ? void 0 : _f.isResource) ? ie : re;
...
} }), Qe = G(Ke, [["__scopeId", "data-v-cd858ddc"]]), We = ["onMouseenter"], Xe = { class: "title" }, Ye = e({ __name: "DragInData", props: { fields: { type: Array, default: () => [] }, maxCount: { type: Number, default: 9999 }, height: { type: Number, default: 0 } }, emits: ["dataChange"], setup(e2, { emit: l2 }) {
