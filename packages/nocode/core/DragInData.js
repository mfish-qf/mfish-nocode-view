...
const fe = e({ __name: "DataSelectModal", props: { selectData: { type: Object } }, emits: ["success", "register"], setup(e2, { emit: i2 }) {
  ...
  const { prefixCls: N2 } = L("data-select"), { token: R2 } = D.useToken(), b2 = l(() => R2.value.colorBorder), I2 = d(""), [T2, { openModal: x2 }] = j(), A2 = u({ id: _2.dataId, name: _2.dataName }), V2 = d(false), { open: O2 } = z(G, H2);
  function M2() {
...
} }), [["__scopeId", "data-v-d0458915"]]), ye = ["draggable", "onMouseenter", "onDragstart"], _e = { class: "title" }, ke = W(e({ __name: "FieldConfig", props: { fieldList: { type: Array, default: () => [] } }, setup(e2) {
  ...
  const l2 = i2, g2 = X(), v2 = [{ label: "静态数据", value: 0 }, { label: "动态数据", value: 1 }], { prefixCls: h2 } = L("data-config"), y2 = d([]), k2 = d([]), N2 = u({ open: false, interval: 5 }), I2 = u({ open: false, events: [] });
  function D2(e3) {
    ...
    if (e3) {
      ...
      a2.push(t2(e3).then((e4) => {
        ...
        if (t3) {
          ...
          if (n2.total > 0 || e4.length > 0) return k2.value = n2.list, k2.value.push(...e4), void (function(e5) {
            const a4 = () => {
              const a5 = {}, t5 = {};
              e5.forEach((e6) => {
        ...
        k2.value = [], g2.getCurConfigComponent.chart.data.params = void 0;
      })()), Promise.all(a2).then(() => {
        l2("refreshData");
      });
  ...
  }) }, null, 8, ["value"])]), f(n(V), { style: { margin: "0" } }), 0 === n(g2).getCurConfigComponent.chart.data.type ? r(i3.$slots, "static-data", { key: 0 }, void 0, true) : (t(), c(_, { key: 1 }, [p("div", Ae, [f(n(E), { title: "点击右侧输入框切换数据源", placement: "left" }, { default: o(() => s2[8] || (s2[8] = [R(" 数据来源", -1)])), _: 1, __: [8] }), f(he, { "select-data": e2.selectData, "data-id": n(g2).getCurConfigComponent.chart.data.id, "data-name": n(g2).getCurConfigComponent.chart.data.name, "is-resource": n(g2).getCurConfigComponent.chart.isResource, "screen-id": n(g2).getId, onDataChange: D2, onDataRefresh: x2 }, { default: o(() => [r(i3.$slots, "data-select", {}, void 0, true)]), _: 3 }, 8, ["select-data", "data-id", "data-name", "is-resource", "screen-id"])]), p("div", Ve, [f(n(E), { title: "接口允许返回数据的最大条数", placement: "left" }, { default: o(() => s2[9] || (s2[9] = [R(" 数据限制", -1)])), _: 1, __: [9] }), f(n(le), { value: n(g2).getCurConfigComponent.chart.data.limit, "onUpdate:value": s2[2] || (s2[2] = (e3) => n(g2).getCurConfigComponent.chart.data.limit = e3), max: n(g2).getCurConfigComponent.chart.data.maxLimit <= 0 ? 1 / 0 : n(g2).getCurConfigComponent.chart.data.maxLimit, min: 1, suffix: "条" }, null, 8, ["value", "max"])]), f(se, { title: "刷新设置" }, { default: o(() => [p("div", Oe, [f(n(E), { title: "数据按照刷新间隔时间更新数据（编辑环境不生效）", placement: "left" }, { default: o(() => [f(n(O), { checked: N2.open, "onUpdate:checked": s2[3] || (s2[3] = (e3) => N2.open = e3) }, { default: o(() => s2[10] || (s2[10] = [R(" 自动刷新", -1)])), _: 1, __: [10] }, 8, ["checked"])]), _: 1 }), N2.open ? (t(), c("div", Me, [f(n(M), { style: { margin: "0" }, "tip-formatter": (e3) => `刷新间隔 ${e3}（分钟）`, value: N2.interval, "onUpdate:value": s2[4] || (s2[4] = (e3) => N2.interval = e3), min: 0.5, max: 60, step: 0.5 }, null, 8, ["tip-formatter", "value"])])) : C("", true)]), p("div", Se, [f(n(E), { title: "通过其他组件事件触发数据更新", placement: "left" }, { default: o(() => [f(n(O), { checked: I2.open, "onUpdate:checked": s2[5] || (s2[5] = (e3) => I2.open = e3) }, { default: o(() => s2[11] || (s2[11] = [R(" 事件刷新", -1)])), _: 1, __: [11] }, 8, ["checked"])]), _: 1 }), I2.open ? (t(), a(de, { key: 0, "filter-self": true, "hide-param": true, events: I2.events, onOk: S2, onDelete: w2 }, null, 8, ["events"])) : C("", true)])]), _: 1 }), k2.value && k2.value.length > 0 ? (t(), a(se, { key: 0, title: "参数设置" }, { default: o(() => [f(Te, { params: k2.value, onParamChange: s2[6] || (s2[6] = () => {
    l2("refreshData");
  }) }, null, 8, ["params"])]), _: 1 })) : C("", true), y2.value && y2.value.length > 0 ? (t(), a(se, { key: 1, title: "数据设置", "allow-collapse": false }, { default: o(() => [p("div", we, [s2[12] || (s2[12] = p("div", null, "源数据", -1)), f(n(U), { icon: "ant-design:double-right-outlined" }), s2[13] || (s2[13] = p("div", null, "目标数据", -1))]), p("div", Le, [f(ke, { "field-list": y2.value }, null, 8, ["field-list"]), s2[14] || (s2[14] = p("div", { class: "divide-line" }, null, -1)), p("div", Ue, [r(i3.$slots, "target-data", {}, void 0, true)])])]), _: 3 })) : C("", true)], 64)), r(i3.$slots, "default", {}, void 0, true)], 2)]), _: 3 }));
  ...
  const u2 = e2, h2 = r2, { prefixCls: y2 } = L("drag-in-data"), _2 = d(u2.fields), k2 = d(-1), { token: N2 } = D.useToken(), R2 = l(() => N2.value.colorInfoBg);
  s(() => u2.fields, () => {
    _2.value = u2.fields;
  });
  const E2 = (e3) => {
    ...
    _2.value.some((e4) => e4.colName === t2.colName && e4.rename === t2.rename) || (_2.value.length >= u2.maxCount && _2.value.shift(), _2.value.push(H(t2, ["colName", "rename", "dataType"])), h2("dataChange", _2.value));
  };
  function T2() {
    k2.value = -1;
  }
  ...
  }), (r3, i2) => (t(), c("div", { class: m(n(y2)), style: g(e2.height > 0 ? { height: `${e2.height}px` } : {}), onDrop: E2 }, [0 === _2.value.length ? (t(), a(n(S), { key: 0, class: "empty", description: "拖动数据到此处", image: n(S).PRESENTED_IMAGE_SIMPLE }, null, 8, ["image"])) : (t(), a(n(me), { key: 1 }, { default: o(() => [f(n(pe), { "item-key": "id", modelValue: _2.value, "onUpdate:modelValue": i2[0] || (i2[0] = (e3) => _2.value = e3), animation: "300", "ghost-class": "ghost", class: "drag-data", onChange: A2 }, { item: o(({ index: e3, element: o2 }) => [p("div", { class: "field-block", onMouseenter: (a2) => (function(e4) {
    k2.value = e4;
  })(e3), onMouseleave: T2 }, [f(n(U), { class: "icon", icon: n(Y)(o2.dataType) }, null, 8, ["icon"]), p("div", Be, v(o2.rename ?? o2.colName), 1), k2.value === e3 ? (t(), a(n(U), { key: 0, class: "icon", icon: "ant-design:delete-outlined", onClick: (a2) => (function(e4) {
