...
import { K as F, _ as q, u as H, N as J, O as G, s as K, S as Q, Q as W, P as X, b as Y, R as Z, U as ee, V as ae, i as te, h as ne } from "./index.js";
import "@vueuse/core";
...
const pe = e({ __name: "DataSelectModal", props: { selectData: { type: Object } }, emits: ["success", "register"], setup(e2, { emit: r2 }) {
...
} }), fe = { key: 0, class: "placeholder" }, Ce = { key: 0, class: "warning" }, ge = { key: 2, class: "icon-group" }, ve = q(e({ __name: "DataSelect", props: { selectData: { type: Object }, dataId: { type: String, default: "" }, dataName: { type: String, default: "" }, isResource: { type: Boolean, default: false }, screenId: { type: String, default: "" } }, emits: ["dataChange", "dataRefresh"], setup(e2, { emit: y2 }) {
  r((e3) => ({ "54d92964": D2.value }));
  const _2 = e2, k2 = y2;
  s(() => _2.dataId, (e3) => {
    e3 ? (A2.id = e3, A2.name = _2.dataName) : (A2.id = "", A2.name = "");
  });
  const { prefixCls: N2 } = w("data-select"), { token: b2 } = I.useToken(), D2 = l(() => b2.value.colorBorder), R2 = d(""), [T2, { openModal: x2 }] = P(), A2 = u({ id: _2.dataId, name: _2.dataName }), V2 = d(false), { open: M2 } = z(F, J2);
  function O2() {
  ...
  return (r2, l2) => (t(), c("div", { class: m(n(N2)) }, [p("div", { class: "input", onMouseenter: O2, onMouseleave: S2, onClick: U2 }, [A2.id ? (t(), a(n(E), { key: 1, title: A2.name }, { default: o(() => [p("div", { class: "title", style: g(e2.isResource ? { textDecoration: "line-through", color: "#999" } : {}) }, v(A2.name), 5), e2.isResource ? (t(), c("div", Ce, " 注意：请将样例数据更换为自己的数据")) : C("", true)]), _: 1 }, 8, ["title"])) : (t(), c("div", fe, "请选择数据来源")), R2.value ? (t(), c("div", ge, [f(n(E), { title: e2.isResource ? "查看样例数据源配置" : "编辑数据源" }, { default: o(() => [f(n(L), { class: "icon", icon: e2.isResource ? "ant-design:search-outlined" : "ant-design:edit-outlined", onClick: h(q2, ["stop"]) }, null, 8, ["icon"])]), _: 1 }, 8, ["title"]), f(n(E), { title: "清空数据源" }, { default: o(() => [f(n(L), { class: "delete-icon", size: 14, icon: R2.value, onClick: h(j2, ["stop"]) }, null, 8, ["icon"])]), _: 1 })])) : C("", true), f(pe, { onRegister: n(T2), onSuccess: $2, "select-data": e2.selectData }, { default: o(() => [i(r2.$slots, "default", {}, void 0, true)]), _: 3 }, 8, ["onRegister", "select-data"])], 32), f(n(E), { title: "刷新数据源" }, { default: o(() => [f(n(L), { class: "icon", icon: "ant-design:sync-outlined", onClick: n(H2), spin: V2.value }, null, 8, ["onClick", "spin"])]), _: 1 })], 2));
} }), [["__scopeId", "data-v-3a060ac3"]]), he = ["draggable", "onMouseenter", "onDragstart"], ye = { class: "title" }, _e = q(e({ __name: "FieldConfig", props: { fieldList: { type: Array, default: () => [] } }, setup(e2) {
  r((e3) => ({ be0a35b0: D2.value }));
  const i2 = e2, s2 = d(-1), u2 = d(-1), g2 = d(""), { prefixCls: h2 } = w("field-config"), { token: b2 } = I.useToken(), D2 = l(() => b2.value.colorInfoBg), R2 = d(), T2 = H();
  function x2() {
    s2.value = -1;
  }
  function A2() {
  ...
  return (i3, r2) => {
    ...
    }(a2, e3) }, [f(n(L), { class: "icon", icon: n(J)(e3.dataType) }, null, 8, ["icon"]), u2.value !== i4 ? (t(), a(n(E), { key: 0, title: e3.colName + (e3.comment ? `[${e3.comment}]` : ""), placement: "left" }, { default: o(() => [p("div", ye, v(e3.rename ?? e3.colName), 1)]), _: 2 }, 1032, ["title"])) : (t(), a(l2, { key: 1, bordered: false, value: g2.value, "onUpdate:value": r2[0] || (r2[0] = (e4) => g2.value = e4), ref_for: true, ref: (e4) => R2.value = e4, onPressEnter: (a2) => V2(e3), onBlur: M2 }, null, 8, ["value", "onPressEnter"])), s2.value === i4 && u2.value !== i4 ? (t(), a(n(E), { key: 2, title: "重命名" }, { default: o(() => [f(n(L), { class: "icon edit", icon: "ant-design:edit-outlined", onClick: A2 })]), _: 1 })) : C("", true), u2.value === i4 ? (t(), a(n(E), { key: 3, title: "保存" }, { default: o(() => [f(n(L), { class: "icon edit", icon: "ant-design:save-outlined", onClick: (a2) => V2(e3) }, null, 8, ["onClick"])]), _: 2 }, 1024)) : C("", true)], 40, he))), 128))], 2);
  };
} }), [["__scopeId", "data-v-c9e8b19a"]]), ke = { class: "title" }, Ne = { class: "param" }, be = { key: 0, style: { color: "red" } }, De = { key: 0 }, Re = { key: 1 }, Ie = { key: 2 }, Ee = q(e({ __name: "DataParamsConfig", props: { params: { type: Array, default: () => [] } }, emits: ["paramChange"], setup(e2, { emit: i2 }) {
  const r2 = i2, { prefixCls: l2 } = w("data-params-config"), s2 = H(), { createMessage: u2 } = U();
  const d2 = (e3, a2) => {
    const t2 = () => {
...
} }), [["__scopeId", "data-v-9dc8528d"]]), Te = { class: "title" }, xe = { class: "title" }, Ae = { class: "title" }, Ve = { class: "title" }, Me = { key: 0 }, Oe = { class: "title" }, Se = { class: "data-header" }, Ue = { class: "data-set" }, we = { class: "target-data" }, Le = e({ __name: "DataConfig", props: { selectData: { type: Object } }, emits: ["refreshData"], setup(e2, { emit: r2 }) {
  const l2 = r2, g2 = H(), v2 = [{ label: "静态数据", value: 0 }, { label: "动态数据", value: 1 }], { prefixCls: h2 } = w("data-config"), y2 = d([]), k2 = d([]), N2 = u({ open: false, interval: 5 }), R2 = u({ open: false, events: [] });
  function I2(e3) {
    var _a;
  ...
  return D(() => {
    ...
    if (0 !== e3) x2();
      ...
      g2.getCurConfigComponent.chart.data.headers = e4.defaultHeaders && e4.defaultHeaders(g2.getCurConfigComponent.chart);
    }
  }, { immediate: true }), s(() => {
    var _a;
  ...
  }), (r3, s2) => (t(), a(n(ue), null, { default: o(() => [p("div", { class: m(n(h2)) }, [p("div", Te, [s2[6] || (s2[6] = b(" 数据类型 ")), f(n(T), { value: n(g2).getCurConfigComponent.chart.data.type, "onUpdate:value": s2[0] || (s2[0] = (e3) => n(g2).getCurConfigComponent.chart.data.type = e3), options: v2, "option-type": "button", "button-style": "solid", size: "small" }, null, 8, ["value"])]), f(n(V), { style: { margin: "0" } }), 0 === n(g2).getCurConfigComponent.chart.data.type ? i(r3.$slots, "static-data", { key: 0 }, void 0, true) : (t(), c(_, { key: 1 }, [p("div", xe, [f(n(E), { title: "点击右侧输入框切换数据源", placement: "left" }, { default: o(() => s2[7] || (s2[7] = [b(" 数据来源")])), _: 1, __: [7] }), f(ve, { "select-data": e2.selectData, "data-id": n(g2).getCurConfigComponent.chart.data.id, "data-name": n(g2).getCurConfigComponent.chart.data.name, "is-resource": n(g2).getCurConfigComponent.chart.isResource, "screen-id": n(g2).getId, onDataChange: I2, onDataRefresh: x2 }, { default: o(() => [i(r3.$slots, "data-select", {}, void 0, true)]), _: 3 }, 8, ["select-data", "data-id", "data-name", "is-resource", "screen-id"])]), p("div", Ae, [f(n(E), { title: "接口允许返回数据的最大条数", placement: "left" }, { default: o(() => s2[8] || (s2[8] = [b(" 数据限制")])), _: 1, __: [8] }), f(n(te), { value: n(g2).getCurConfigComponent.chart.data.limit, "onUpdate:value": s2[1] || (s2[1] = (e3) => n(g2).getCurConfigComponent.chart.data.limit = e3), max: n(g2).getCurConfigComponent.chart.data.maxLimit <= 0 ? 1 / 0 : n(g2).getCurConfigComponent.chart.data.maxLimit, min: 1, suffix: "条" }, null, 8, ["value", "max"])]), f(ne, { title: "刷新设置" }, { default: o(() => [p("div", Ve, [f(n(E), { title: "数据按照刷新间隔时间更新数据（编辑环境不生效）", placement: "left" }, { default: o(() => [f(n(M), { checked: N2.open, "onUpdate:checked": s2[2] || (s2[2] = (e3) => N2.open = e3) }, { default: o(() => s2[9] || (s2[9] = [b(" 自动刷新")])), _: 1, __: [9] }, 8, ["checked"])]), _: 1 }), N2.open ? (t(), c("div", Me, [f(n(O), { style: { margin: "0" }, "tip-formatter": (e3) => `刷新间隔 ${e3}（分钟）`, value: N2.interval, "onUpdate:value": s2[3] || (s2[3] = (e3) => N2.interval = e3), min: 0.5, max: 60, step: 0.5 }, null, 8, ["tip-formatter", "value"])])) : C("", true)]), p("div", Oe, [f(n(E), { title: "通过其他组件事件触发数据更新", placement: "left" }, { default: o(() => [f(n(M), { checked: R2.open, "onUpdate:checked": s2[4] || (s2[4] = (e3) => R2.open = e3) }, { default: o(() => s2[10] || (s2[10] = [b(" 事件刷新")])), _: 1, __: [10] }, 8, ["checked"])]), _: 1 }), R2.open ? (t(), a(de, { key: 0, "filter-self": true, "hide-param": true, events: R2.events, onOk: S2, onDelete: U2 }, null, 8, ["events"])) : C("", true)])]), _: 1 }), k2.value && k2.value.length > 0 ? (t(), a(ne, { key: 0, title: "参数设置" }, { default: o(() => [f(Ee, { params: k2.value, onParamChange: s2[5] || (s2[5] = () => {
    l2("refreshData");
  }) }, null, 8, ["params"])]), _: 1 })) : C("", true), y2.value && y2.value.length > 0 ? (t(), a(ne, { key: 1, title: "数据设置", "allow-collapse": false }, { default: o(() => [p("div", Se, [s2[11] || (s2[11] = p("div", null, "源数据", -1)), f(n(L), { icon: "ant-design:double-right-outlined" }), s2[12] || (s2[12] = p("div", null, "目标数据", -1))]), p("div", Ue, [f(_e, { "field-list": y2.value }, null, 8, ["field-list"]), s2[13] || (s2[13] = p("div", { class: "divide-line" }, null, -1)), p("div", we, [i(r3.$slots, "target-data", {}, void 0, true)])])]), _: 3 })) : C("", true)], 64)), i(r3.$slots, "default", {}, void 0, true)], 2)]), _: 3 }));
} }), $e = q(Le, [["__scopeId", "data-v-1696bf85"]]), je = ["onMouseenter"], Pe = { class: "title" }, Be = e({ __name: "DragInData", props: { fields: { type: Array, default: () => [] }, maxCount: { type: Number, default: 9999 }, height: { type: Number, default: 0 } }, emits: ["dataChange"], setup(e2, { emit: i2 }) {
  ...
  return D(() => {
    ...
    k2.value = e4;
  }(e3), onMouseleave: T2 }, [f(n(L), { class: "icon", icon: n(J)(o2.dataType) }, null, 8, ["icon"]), p("div", Pe, v(o2.rename ?? o2.colName), 1), k2.value === e3 ? (t(), a(n(L), { key: 0, class: "icon", icon: "ant-design:delete-outlined", onClick: (a2) => function(e4) {
    _2.value.splice(e4, 1), h2("dataChange", _2.value);
  }(e3) }, null, 8, ["onClick"])) : C("", true)], 40, je)]), _: 1 }, 8, ["modelValue"])]), _: 1 }))], 38));
} }), ze = q(Be, [["__scopeId", "data-v-a508a4de"]]);
export {
  $e as D,
  ze as a
};
