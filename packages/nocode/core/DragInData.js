...
import { _ as X, u as Y, Q as Z, s as ee, S as ae, R as te, I as ne, b as oe, U as ie, V as re, e as le, d as se } from "./index.js";
import "@vueuse/core";
...
const fe = e({ __name: "DataSelectModal", props: { selectData: { type: Object } }, emits: ["success", "register"], setup(e2, { emit: r2 }) {
  const l2 = e2, s2 = r2, [u2, { setModalProps: d2, closeModal: c2 }] = P(async () => {
  ...
  return (e3, r3) => (a(), t(n($), { width: "1200px", onRegister: n(u2), title: "数据来源", onOk: p2 }, { default: o(() => [i(e3.$slots, "default")]), _: 3 }, 8, ["onRegister"]));
  ...
  return (r2, l2) => (a(), c("div", { class: m(n(N2)) }, [p("div", { class: "input", onMouseenter: O2, onMouseleave: S2, onClick: w2 }, [A2.id ? (a(), t(n(E), { key: 1, title: A2.name }, { default: o(() => [p("div", { class: "title", style: f(e2.isResource ? { textDecoration: "line-through", color: "#999" } : {}) }, C(A2.name), 5), e2.isResource ? (a(), c("div", ge, " 注意：请将样例数据更换为自己的数据")) : g("", true)]), _: 1 }, 8, ["title"])) : (a(), c("div", Ce, "请选择数据来源")), b2.value ? (a(), c("div", ve, [v(n(E), { title: e2.isResource ? "查看样例数据源配置" : "编辑数据源" }, { default: o(() => [v(n(L), { class: "icon", icon: e2.isResource ? "ant-design:search-outlined" : "ant-design:edit-outlined", onClick: h(J2, ["stop"]) }, null, 8, ["icon"])]), _: 1 }, 8, ["title"]), v(n(E), { title: "清空数据源" }, { default: o(() => [v(n(L), { class: "delete-icon", size: 14, icon: b2.value, onClick: h($2, ["stop"]) }, null, 8, ["icon"])]), _: 1 })])) : g("", true), v(fe, { onRegister: n(T2), onSuccess: P2, "select-data": e2.selectData }, { default: o(() => [i(r2.$slots, "default", {}, void 0, true)]), _: 3 }, 8, ["onRegister", "select-data"])], 32), v(n(E), { title: "刷新数据源" }, { default: o(() => [v(n(L), { class: "icon", icon: "ant-design:sync-outlined", onClick: n(F2), spin: V2.value }, null, 8, ["onClick", "spin"])]), _: 1 })], 2));
  ...
  r((e3) => ({ v23c892b9: I2.value }));
  const i2 = e2, l2 = u(-1), d2 = u(-1), f2 = u(""), { prefixCls: h2 } = U("field-config"), { token: R2 } = D.useToken(), I2 = s(() => R2.value.colorInfoBg), b2 = u(), T2 = Y();
  function x2() {
    l2.value = -1;
  }
  function A2() {
    d2.value = l2.value, f2.value = i2.fieldList[l2.value].rename ?? i2.fieldList[l2.value].colName, N(() => {
  ...
  return (i3, r2) => {
    const s2 = y("AInput");
    return a(), c("div", { class: m(n(h2)) }, [(a(true), c(k, null, _(e2.fieldList, (e3, i4) => (a(), c("div", { class: "field-block", key: e3.id, draggable: d2.value !== i4, onMouseenter: (e4) => (function(e5) {
      l2.value = e5;
    })(i4), onMouseleave: x2, onDragstart: (a2) => (function(e4, a3) {
      e4.dataTransfer?.setData(te, JSON.stringify(a3));
    })(a2, e3) }, [v(n(L), { class: "icon", icon: n(Z)(e3.dataType) }, null, 8, ["icon"]), d2.value !== i4 ? (a(), t(n(E), { key: 0, title: e3.colName + (e3.comment ? `[${e3.comment}]` : ""), placement: "left" }, { default: o(() => [p("div", ke, C(e3.rename ?? e3.colName), 1)]), _: 2 }, 1032, ["title"])) : (a(), t(s2, { key: 1, bordered: false, value: f2.value, "onUpdate:value": r2[0] || (r2[0] = (e4) => f2.value = e4), ref_for: true, ref: (e4) => b2.value = e4, onPressEnter: (a2) => V2(e3), onBlur: M2 }, null, 8, ["value", "onPressEnter"])), l2.value === i4 && d2.value !== i4 ? (a(), t(n(E), { key: 2, title: "重命名" }, { default: o(() => [v(n(L), { class: "icon edit", icon: "ant-design:edit-outlined", onClick: A2 })]), _: 1 })) : g("", true), d2.value === i4 ? (a(), t(n(E), { key: 3, title: "保存" }, { default: o(() => [v(n(L), { class: "icon edit", icon: "ant-design:save-outlined", onClick: (a2) => V2(e3) }, null, 8, ["onClick"])]), _: 2 }, 1024)) : g("", true)], 40, ye))), 128))], 2);
  };
} }), [["__scopeId", "data-v-e1e66a29"]]), Ne = { class: "title" }, Re = { class: "param" }, Ie = { key: 0, style: { color: "red" } }, be = { key: 0 }, De = { key: 1 }, Ee = { key: 2 }, Te = X(e({ __name: "DataParamsConfig", props: { params: { type: Array, default: () => [] } }, emits: ["paramChange"], setup(e2, { emit: i2 }) {
  const r2 = i2, { prefixCls: l2 } = U("data-params-config"), s2 = Y(), { createMessage: u2 } = w();
  const d2 = (e3, a2) => {
    const t2 = () => {
  ...
  return (i3, r3) => (a(true), c(k, null, _(e2.params, (e3) => (a(), c("div", { class: m(n(l2)), key: e3.name }, [p("div", Ne, [v(n(E), { title: e3.remark }, { default: o(() => [p("div", Re, [1 === e3.required ? (a(), c("span", Ie, "*")) : g("", true), R(" " + C(e3.name), 1)])]), _: 2 }, 1032, ["title"]), v(n(E), { placement: "topRight" }, { title: o(() => [...r3[0] || (r3[0] = [p("div", null, [p("span", { style: { "font-weight": "700" } }, "常量："), R("设置固定参数")], -1), p("div", null, [p("span", { style: { "font-weight": "700" } }, "变量： "), R(" 设置其他组件数据或全局变量（第一次加载设置，不会跟随前者变化。全局变量来自于请求链接中的参数） ")], -1), p("div", null, [p("span", { style: { "font-weight": "700" } }, "事件："), R(" 其他组件事件触发设置（绑定多个事件时，以最后触发事件的组件为准） ")], -1)])]), default: o(() => [n(s2).getCurConfigComponent.chart.data.params && n(s2).getCurConfigComponent.chart.data.params[e3.name] ? (a(), t(n(T), { key: 0, class: "radio-group", size: "small", value: n(s2).getCurConfigComponent.chart.data.params[e3.name].type, "onUpdate:value": (a2) => n(s2).getCurConfigComponent.chart.data.params[e3.name].type = a2, onChange: (a2) => (function(e4, a3) {
    ...
    -1 === i4 ? (e4.modifyIndex >= 0 ? n2[a3.name].value.splice(e4.modifyIndex, 1, t2) : n2[a3.name].value.push(t2), o2 = true) : n2[a3.name].value.param !== t2.param && (n2[a3.name].value.splice(i4, 1, t2), o2 = true), o2 && (f2(d2(e4.event, a3)), s2.getCurConfigComponent.chart.data.params = n2);
...
} }), [["__scopeId", "data-v-76f8c848"]]), xe = { class: "title" }, Ae = { class: "title" }, Ve = { class: "title" }, Me = { class: "title" }, Oe = { key: 0 }, Se = { class: "title" }, we = { style: { "max-width": "200px" } }, Ue = { class: "data-header" }, Le = { class: "data-set" }, Pe = { class: "target-data" }, $e = e({ __name: "DataConfig", props: { selectData: { type: Object } }, emits: ["refreshData", "dataTypeChange"], setup(e2, { emit: r2 }) {
  const s2 = r2, f2 = Y(), C2 = [{ label: "静态数据", value: 0 }, { label: "动态数据", value: 1 }], { prefixCls: h2 } = U("data-config"), y2 = u([]), _2 = u([]), N2 = d({ open: false, interval: 5 }), b2 = d({ open: false, events: [] });
  function D2(e3) {
  ...
  function x2() {
    ...
    if (e3) {
      const a2 = [], t2 = f2.getCurConfigComponent?.chart?.isResource ? ie : K;
      a2.push(t2(e3).then((e4) => {
        ...
        if (t3) {
          const n2 = await W({ apiId: t3, pageNum: 1, pageSize: 1e4 }), o2 = await re(t3);
          if (o2) {
  ...
  }), (r3, l2) => (a(), t(n(me), null, { default: o(() => [p("div", { class: m(n(h2)) }, [p("div", xe, [l2[7] || (l2[7] = R(" 数据类型 ", -1)), v(n(T), { value: n(f2).getCurConfigComponent.chart.data.type, "onUpdate:value": l2[0] || (l2[0] = (e3) => n(f2).getCurConfigComponent.chart.data.type = e3), options: C2, "option-type": "button", "button-style": "solid", size: "small", onChange: l2[1] || (l2[1] = () => {
    s2("dataTypeChange", n(f2).getCurConfigComponent.chart.data.type);
  }) }, null, 8, ["value"])]), v(n(V), { style: { margin: "0" } }), 0 === n(f2).getCurConfigComponent.chart.data.type ? i(r3.$slots, "static-data", { key: 0 }, void 0, true) : (a(), c(k, { key: 1 }, [p("div", Ae, [v(n(E), { title: "点击右侧输入框切换数据源", placement: "left" }, { default: o(() => [...l2[8] || (l2[8] = [R(" 数据来源", -1)])]), _: 1 }), v(he, { "select-data": e2.selectData, "data-id": n(f2).getCurConfigComponent.chart.data.id, "data-name": n(f2).getCurConfigComponent.chart.data.name, "is-resource": n(f2).getCurConfigComponent.chart.isResource, "screen-id": n(f2).getId, onDataChange: D2, onDataRefresh: x2 }, { default: o(() => [i(r3.$slots, "data-select", {}, void 0, true)]), _: 3 }, 8, ["select-data", "data-id", "data-name", "is-resource", "screen-id"])]), p("div", Ve, [v(n(E), { title: "接口允许返回数据的最大条数", placement: "left" }, { default: o(() => [...l2[9] || (l2[9] = [R(" 数据限制", -1)])]), _: 1 }), v(n(le), { value: n(f2).getCurConfigComponent.chart.data.limit, "onUpdate:value": l2[2] || (l2[2] = (e3) => n(f2).getCurConfigComponent.chart.data.limit = e3), max: n(f2).getCurConfigComponent.chart.data.maxLimit <= 0 ? 1 / 0 : n(f2).getCurConfigComponent.chart.data.maxLimit, min: 1, suffix: "条" }, null, 8, ["value", "max"])]), v(se, { title: "数据刷新" }, { default: o(() => [p("div", Me, [v(n(E), { title: "数据按照刷新间隔时间更新数据（编辑环境不生效）", placement: "left" }, { default: o(() => [v(n(M), { checked: N2.open, "onUpdate:checked": l2[3] || (l2[3] = (e3) => N2.open = e3) }, { default: o(() => [...l2[10] || (l2[10] = [R(" 自动刷新", -1)])]), _: 1 }, 8, ["checked"])]), _: 1 }), N2.open ? (a(), c("div", Oe, [v(n(O), { style: { margin: "0" }, "tip-formatter": (e3) => `刷新间隔 ${e3}（分钟）`, value: N2.interval, "onUpdate:value": l2[4] || (l2[4] = (e3) => N2.interval = e3), min: 0.5, max: 60, step: 0.5 }, null, 8, ["tip-formatter", "value"])])) : g("", true)]), p("div", Se, [v(n(E), { title: "通过其他组件事件触发数据更新", placement: "left" }, { default: o(() => [v(n(M), { checked: b2.open, "onUpdate:checked": l2[5] || (l2[5] = (e3) => b2.open = e3) }, { default: o(() => [...l2[11] || (l2[11] = [R(" 事件刷新", -1)])]), _: 1 }, 8, ["checked"])]), _: 1 }), p("div", we, [b2.open ? (a(), t(de, { key: 0, "filter-self": true, "hide-param": true, events: b2.events, onOk: S2, onDelete: w2 }, null, 8, ["events"])) : g("", true)])])]), _: 1 }), _2.value && _2.value.length > 0 ? (a(), t(se, { key: 0, title: "参数设置", tooltip: "带参" }, { default: o(() => [v(Te, { params: _2.value, onParamChange: l2[6] || (l2[6] = () => {
    s2("refreshData");
  }) }, null, 8, ["params"])]), _: 1 })) : g("", true), y2.value && y2.value.length > 0 ? (a(), t(se, { key: 1, title: "数据设置", "allow-collapse": false }, { default: o(() => [p("div", Ue, [l2[12] || (l2[12] = p("div", null, "源数据", -1)), v(n(L), { icon: "ant-design:double-right-outlined" }), l2[13] || (l2[13] = p("div", null, "目标数据", -1))]), p("div", Le, [v(_e, { "field-list": y2.value }, null, 8, ["field-list"]), l2[14] || (l2[14] = p("div", { class: "divide-line" }, null, -1)), p("div", Pe, [i(r3.$slots, "target-data", {}, void 0, true)])])]), _: 3 })) : g("", true)], 64)), i(r3.$slots, "default", {}, void 0, true)], 2)]), _: 3 }));
} }), je = X($e, [["__scopeId", "data-v-6319f9ad"]]), Be = ["onMouseenter"], ze = { class: "title" }, qe = e({ __name: "DragInData", props: { fields: { type: Array, default: () => [] }, maxCount: { type: Number, default: 9999 }, height: { type: Number, default: 0 } }, emits: ["dataChange"], setup(e2, { emit: i2 }) {
  r((e3) => ({ v58b0ea90: R2.value }));
  const d2 = e2, h2 = i2, { prefixCls: y2 } = U("drag-in-data"), k2 = u(d2.fields), _2 = u(-1), { token: N2 } = D.useToken(), R2 = s(() => N2.value.colorInfoBg);
  l(() => d2.fields, () => {
    k2.value = d2.fields;
  });
  const E2 = (e3) => {
  ...
  }), (i3, r2) => (a(), c("div", { class: m(n(y2)), style: f(e2.height > 0 ? { height: `${e2.height}px` } : {}), onDrop: E2 }, [0 === k2.value.length ? (a(), t(n(S), { key: 0, class: "empty", description: "拖动数据到此处", image: n(S).PRESENTED_IMAGE_SIMPLE }, null, 8, ["image"])) : (a(), t(n(me), { key: 1 }, { default: o(() => [v(n(pe), { "item-key": "id", modelValue: k2.value, "onUpdate:modelValue": r2[0] || (r2[0] = (e3) => k2.value = e3), animation: "300", "ghost-class": "ghost", class: "drag-data", onChange: A2 }, { item: o(({ index: e3, element: o2 }) => [p("div", { class: "field-block", onMouseenter: (a2) => (function(e4) {
    _2.value = e4;
  })(e3), onMouseleave: T2 }, [v(n(L), { class: "icon", icon: n(Z)(o2.dataType) }, null, 8, ["icon"]), p("div", ze, C(o2.rename ?? o2.colName), 1), _2.value === e3 ? (a(), t(n(L), { key: 0, class: "icon", icon: "ant-design:delete-outlined", onClick: (a2) => (function(e4) {
    k2.value.splice(e4, 1), h2("dataChange", k2.value);
  })(e3) }, null, 8, ["onClick"])) : g("", true)], 40, Be)]), _: 1 }, 8, ["modelValue"])]), _: 1 }))], 38));
} }), Je = X(qe, [["__scopeId", "data-v-a508a4de"]]);
export {
  je as D,
  Je as a
};
