...
const _hoisted_4$6 = { class: "color-input-percentage" };
...
const _hoisted_4$5 = { class: "confirm" };
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        activeType.value === 2 && (__props.type === 2 || __props.type === 3) ? (openBlock(), createElementBlock("div", _hoisted_3$b, [
...
const _hoisted_4$4 = { class: "color-text" };
...
const _hoisted_4$3 = { style: { "flex": "1" } };
const _hoisted_5$3 = {
  key: 0,
  class: "line"
};
...
const comConfigDisplay = {
  ...
  advance: {
    ...
    payload: {
      ...
      component: shallowRef(
        createAsyncComponent(() => import("./index4.js"), {
          loading: true,
          size: "large"
        })
      )
...
const mfSegmentedData = {
  ...
  component: createAsyncComponent(() => import("./index55.js"), {
    loading: true
  }),
...
function decomposeComponent(component, editorRect, parentStyle, scale) {
  ...
  component.chartContain.dropInfo.width = Math.round(
    Number.parseFloat(component.chartContain.groupStyle.width) / 100 * parentStyle.width
  );
  component.chartContain.dropInfo.height = Math.round(
    Number.parseFloat(component.chartContain.groupStyle.height) / 100 * parentStyle.height
  );
  component.chartContain.dropInfo.x = Math.round(
    (center.x - component.chartContain.dropInfo.width * scale / 2) / scale
  );
  component.chartContain.dropInfo.y = Math.round(
    (center.y - component.chartContain.dropInfo.height * scale / 2) / scale
  );
      ...
      return openBlock(), createElementBlock("div", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(params.value, (item, index2) => {
          return openBlock(), createElementBlock("div", {
            ...
            isListParam(item.paramType) ? (openBlock(), createElementBlock("div", _hoisted_3$7, [
              createVNode(unref(Button), {
                type: "primary",
      ...
      setTimeout(() => {
        screenEditStore2.loadingScreen().then(() => {
          ...
          for (let i = 0; i < componentList.value.length; i++) {
            ...
            if (!component.chartContain.animations || !chartContainRef.value) return;
            ...
            default: withCtx(() => [
              createElementVNode("div", {
                ...
                createElementVNode("div", {
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(componentList.value, (item) => {
...
const _hoisted_3$5 = { class: "indicator-value" };
const _hoisted_4$2 = ["id", "height", "width"];
...
const _sfc_main$i = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const indicatorXStyle = ref();
    const indicatorYStyle = ref();
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", {
          ...
          createElementVNode("div", {
            ...
            createElementVNode("div", _hoisted_3$5, toDisplayString(lineValue.value), 1)
          ], 4),
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        isActive.value || isSelect.value || hover.value ? (openBlock(), createElementBlock("div", _hoisted_2$6, [
          hover.value ? (openBlock(), createElementBlock("div", _hoisted_3$4)) : createCommentVNode("", true)
        ])) : createCommentVNode("", true)
      ], 38);
    };
  }
          ...
          default: withCtx(() => [
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(componentList.value, (item, index2) => {
              ...
              return withDirectives((openBlock(), createBlock(ChartContain, {
                ...
                [vShow, (_b = item.chartContain) == null ? void 0 : _b.show]
              ]);
            }), 128))
          ]),
          _: 1
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", _hoisted_1$5, [
          ...
          createElementVNode("span", {
            class: "title",
            style: normalizeStyle(__props.showIcon ? { marginRight: "33px" } : {})
          }, toDisplayString((_a = __props.item) == null ? void 0 : _a.chart.name), 5),
          __props.showIcon && !unref(screenLayoutStore).getLayerCollapsed && (isEnter.value || !__props.item.chartContain.show) ? (openBlock(), createBlock(unref(Icon), {
            key: 2,
            class: "icon",
            style: { "right": "18px" },
            icon: __props.item.chartContain.show ? "ant-design:eye-outlined" : "ant-design:eye-invisible-outlined",
            onClick: _cache[0] || (_cache[0] = () => unref(screenShortcutStore).showHideComponent(!__props.item.chartContain.show))
          }, null, 8, ["icon"])) : createCommentVNode("", true),
          __props.showIcon && !unref(screenLayoutStore).getLayerCollapsed && (isEnter.value || __props.item.chartContain.lock) ? (openBlock(), createBlock(unref(Icon), {
            key: 3,
            class: "icon",
            icon: __props.item.chartContain.lock ? "ant-design:lock-outlined" : "ant-design:unlock-outlined",
            onClick: _cache[1] || (_cache[1] = () => unref(screenShortcutStore).lockUnLockComponent(!__props.item.chartContain.lock))
          }, null, 8, ["icon"])) : createCommentVNode("", true)
        ])
      ], 34);
    };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createVNode(LayerItem, {
          ...
          onClick: parentClick
        }, null, 8, ["item", "expand", "show-icon", "external-select", "is-select"]),
        createVNode(unref(NCollapseTransition), {
          ...
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.item.chart.options.components, (child, index2) => {
              ...
              }, null, 8, ["parent-item", "item", "index", "external-select", "is-select", "onSelect", "onEnter", "onClick"]);
            }), 128))
          ]),
          _: 1
        }, 8, ["show", "class"])
