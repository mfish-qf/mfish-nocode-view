...
const Yl = Rl({ name: "ApiParamsModal", components: { BasicModal: be, BasicForm: Ce }, emits: ["addSuccess", "updateSuccess", "register", "variableChange"], setup(e2, { emit: l2 }) {
  ...
  return u(() => a2.config, (e3) => {
    ...
    })(o3, u2) }, { icon: c(() => [b(d(ve), { icon: "ant-design:delete-outlined" })]), _: 2 }, 1032, ["onClick"])) : p("", true)]))), 128)), N2(e4.paramType) ? (s(), y("div", Sa, [b(d(L), { type: "primary", onClick: (e5) => (function(e6) {
    ...
    })(o3) }, { default: c(() => [...l3[0] || (l3[0] = [Q("增加参数", -1)])]), _: 2 }, 1032, ["onClick"])])) : p("", true)]))), 128))], 2);
  };
