...
const Yl = Rl({ name: "ApiParamsModal", components: { BasicModal: be, BasicForm: Ce }, emits: ["addSuccess", "updateSuccess", "register", "variableChange"], setup(e2, { emit: l2 }) {
  ...
  function F2(e3) {
    e3.tableAlias && e3.colName && (_2.value = e3, t2("inputChange", { ...e3, [ya]: "colName" }));
  }
  function x2(e3, l3) {
...
} }), Ma = { class: "formula" }, _a = { class: "title" }, Qa = { key: 0, class: "add" }, Sa = Rl(o({ __name: "FormulaConfig", props: ha, emits: ["formulaChange"], setup(e2, { emit: l2 }) {
  ...
  function A2(e3) {
    x2(e3), k2.value = ba(e3), _2.value++, t2("formulaChange", k2.value);
  }
  function R2(e3) {
  ...
  return u(() => a2.config, (e3) => {
    ...
    return s(), y("div", { class: h(d(m2)) }, [q("div", Ma, [b(qa, { "query-mode": a2.queryMode, class: "main", index: a2.index, "com-type": a2.comType, "param-type": a2.paramType, "param-value": a2.paramValue, config: k2.value, "sql-query": a2.sqlQuery, "show-radio": a2.showRadio, onInputChange: F2, onFormulaSelect: A2, onTypeChange: R2 }, null, 8, ["query-mode", "index", "com-type", "param-type", "param-value", "config", "sql-query", "show-radio"]), k2.value?.type !== d(yl).formula || a2.queryMode ? p("", true) : (s(), r(Ca, { key: 0, onSubmit: I2 }))]), (s(true), y(S, null, T(o2.value, (e4, o3) => (s(), y("div", { key: `${_2.value}${o3}` }, [(s(true), y(S, null, T(w2(o3), (l4, u2) => (s(), y("div", { class: "param", key: u2 }, [b(d(ve), { class: "icon", icon: "ant-design:arrow-up-outlined" }), q("span", _a, [b(d(U), { placement: "left", title: i2.value ? i2.value[o3] : "" }, { default: c(() => [Q(C(e4.name), 1)]), _: 2 }, 1032, ["title"])]), b(n2, { "query-mode": a2.queryMode, index: u2, "com-type": e4.comType, "param-type": e4.paramType, "param-value": e4.value, config: N2(e4.paramType) && k2.value?.value?.param && k2.value?.value?.param[o3]?.value ? k2.value?.value?.param[o3]?.value[u2] : k2.value?.value?.param[o3], "sql-query": a2.sqlQuery, onFormulaChange: (l5) => (function(e5, l6, a3, o4) {
  ...
  return (l3, a3) => (s(), y(S, null, [b(d(be), w(l3.$attrs, { onRegister: d(T2), title: "公式配置", onOk: x2 }), { centerFooter: c(() => [b(d(L), { onClick: R2, type: "primary", danger: "" }, { default: c(() => [...a3[1] || (a3[1] = [Q("测试", -1)])]), _: 1 })]), default: c(() => [u2.value ? (s(), r(d(ie), { key: 0, class: "mb-2", message: u2.value, type: "info", "show-icon": "" }, { icon: c(() => [b(d(ve), { icon: "ant-design:function-outlined" })]), _: 1 }, 8, ["message"])) : p("", true), (s(), r(Sa, { "query-mode": e2.queryMode, key: f2.value, "sql-query": d(m2), "show-radio": false, config: i2, onFormulaChange: A2 }, null, 8, ["query-mode", "sql-query", "config"])), b(Na, { "cur-query": k2.value, "cur-params": C2.value, open: M2.value, onClose: a3[0] || (a3[0] = () => M2.value = false) }, null, 8, ["cur-query", "cur-params", "open"])]), _: 1 }, 16, ["onRegister"]), b(Ta, { onRegister: d(h2), onSubmit: I2 }, null, 8, ["onRegister"])], 64));
