...
import { BasicForm as Ce, useForm as Me } from "@mfish/core/components/Form";
import { BasicTree as _e } from "@mfish/core/components/Tree";
...
}, _l = (e2) => e2 && (e2?.aggregates && e2.aggregates.length > 0 || e2.groups && e2.groups.length > 0 || e2.customColumns && e2.customColumns.length > 0), Ql = (e2, l2) => l2 === bl().getLevel && _l(e2), Sl = (e2, l2, a2) => {
...
const Fl = o({ __name: "HttpParamConfig", props: { httpParams: { type: Array, default: () => [] }, readOnly: { type: Boolean, default: false } }, setup(e2, { expose: l2 }) {
  ...
  return (l3, a3) => (s(), y("div", { class: h([d(o2), d(i2).getShowData && d(i2).getShowDataLevel === d(u2) ? "active" : ""]), style: k(e2.highlight ? { border: `1px solid ${d(t2)}` } : "") }, [d(i2).getShowData && d(i2).getShowDataLevel === d(u2) ? (s(), y("div", { key: 0, class: "select", style: k({ backgroundColor: d(t2) }) }, [b(d(ve), { icon: "ant-design:check-outlined", color: "#FFFFFF", size: 14 })], 4)) : p("", true), void 0 !== e2.iconfont ? (s(), r(d(ve), { key: 1, color: d(t2), icon: `iconfont:${e2.iconfont}`, size: 14 }, null, 8, ["color", "icon"])) : p("", true), void 0 !== e2.icon ? (s(), r(d(ve), { key: 2, color: d(t2), icon: e2.icon, size: 14 }, null, 8, ["color", "icon"])) : p("", true), q("div", Ol, C(e2.title), 1), e2.allowDelete && !e2.queryMode ? (s(), r(d(V), { key: 3, type: "vertical" })) : p("", true), e2.queryMode ? p("", true) : (s(), r(d(U), { key: 4, title: "删除" }, { default: c(() => [e2.allowDelete ? (s(), r(d(L), { key: 0, size: "small", type: "link", onClick: f2 }, { icon: c(() => [b(d(pe))]), _: 1 })) : p("", true)]), _: 1 })), q("div", { class: h(["config", e2.full ? "full" : ""]) }, [M(l3.$slots, "config", {}, void 0, true)], 2), b(d(U), { title: "执行" }, { default: c(() => [b(d(L), { size: "small", type: "link", style: { margin: "6px" }, onMouseenter: a3[0] || (a3[0] = (e3) => m2.value = true), onMouseleave: a3[1] || (a3[1] = (e3) => m2.value = false), onClick: v2 }, { icon: c(() => [!d(i2).getShowData || d(i2).getShowDataLevel !== d(u2) || m2.value ? (s(), r(d(me), { key: 0 })) : (s(), r(d(fe), { key: 1 }))]), _: 1 })]), _: 1 })], 6));
  ...
  const a2 = e2, t2 = l2, o2 = n([]), i2 = n(false), { prefixCls: p2 } = se("select-fields"), m2 = _(() => a2.tableFields ? a2.tableFields?.length < 10 ? 30 * a2.tableFields?.length : 300 : 30), f2 = n(false);
  u(() => a2.tableFields, (e3) => {
  ...
  return (l3, a3) => (s(), r(d(H), { trigger: ["click"], onOpenChange: g2, placement: "bottom", arrow: { pointAtCenter: true } }, { overlay: c(() => [b(d(K), null, { default: c(() => [b(d(K).Item, { disabled: "", style: { padding: "0", cursor: "default" } }, { default: c(() => [(s(), y("div", { class: h(`${d(p2)}-check-wrapper`), key: `all_check_${i2.value}` }, [b(d(z), { checked: i2.value, onChange: q2, disabled: e2.queryMode }, { default: c(() => [...a3[0] || (a3[0] = [Q("全选", -1)])]), _: 1 }, 8, ["checked", "disabled"])], 2)), b(d(V), { style: { margin: "4px 0" } }), b(d(ye), { style: k({ height: `${m2.value}px` }) }, { default: c(() => [(s(true), y(S, null, T(o2.value, (l4) => (s(), y("div", { key: l4.colName + l4.checked, class: h(`${d(p2)}-check-wrapper`) }, [b(d(z), { checked: l4.checked, id: l4.colName, onChange: M2, disabled: e2.queryMode }, { default: c(() => [Q(C(l4.colName + (l4.comment ? `[${l4.comment}]` : "")), 1)]), _: 2 }, 1032, ["checked", "id", "disabled"])], 2))), 128))]), _: 1 }, 8, ["style"])]), _: 1 })]), _: 1 })]), default: c(() => [b(d(L), { type: "primary" }, { default: c(() => [a3[1] || (a3[1] = Q(" 字段 ", -1)), b(d(ve), { icon: f2.value ? "ant-design:caret-up-outlined" : "ant-design:caret-down-outlined" }, null, 8, ["icon"])]), _: 1 })]), _: 1 }));
  ...
  return u(() => a2.sqlQuery?.sourceTable, (e3) => {
    e3 && (e3 === f2.getTableName ? (f2.addTableFieldsMap(e3, f2.getTableFields), m2.value = f2.getTableFields) : Ml(a2.sqlQuery).then((l3) => {
      f2.addTableFieldsMap(e3, l3), m2.value = l3;
    }));
  }, { immediate: true }), N(() => {
    a2.sqlQuery?.sqlQuery && a2.sqlQuery?.sourceTable && Ml(a2.sqlQuery).then((e3) => {
  ...
  const l2 = e2, { prefixCls: a2 } = se("config-button"), t2 = de().getThemeColor, o2 = bl(), n2 = _(() => l2.level < o2.getLevel ? 12 : 14);
  ...
  const a2 = e2, t2 = l2, o2 = K.Item, i2 = P, { prefixCls: m2 } = se("table-joins"), f2 = bl(), v2 = n([]), M2 = n([]), N2 = n([]), w2 = de().getThemeColor, A2 = { left: "左联", inner: "内联", right: "右联", full: "全联" }, R2 = _(() => {
  ...
  return (l3, n2) => {
    ...
    return s(), y("div", { class: h(d(m2)) }, [(s(true), y(S, null, T(e2.sqlQuery?.joins, (l4, p2) => (s(), r(jl, { iconfont: "icon-mfish-join", title: "关联", key: p2, "query-mode": e2.queryMode, onDeleteConfig: (e3) => (function(e4) {
      ...
      l5.type = e4.key;
    })(e3, l4), "selected-keys": [l4.type] }, { default: c(() => [(s(true), y(S, null, T(Object.keys(A2), (e3) => (s(), r(d(o2), { key: e3 }, { default: c(() => [q("div", null, [Q(C(A2[e3]) + " ", 1), b(d(ve), { icon: `iconfont:icon-mfish-${e3}-join`, color: d(w2), size: 14 }, null, 8, ["icon", "color"])])]), _: 2 }, 1024))), 128))]), _: 1 }, 8, ["onClick", "selected-keys"])]), default: c(() => [q("a", { onClick: n2[0] || (n2[0] = F(() => {
...
const Yl = Rl({ name: "ApiParamsModal", components: { BasicModal: be, BasicForm: Ce }, emits: ["addSuccess", "updateSuccess", "register", "variableChange"], setup(e2, { emit: l2 }) {
  const a2 = n(true), [t2, { resetFields: o2, setFieldsValue: u2, validate: i2 }] = Me({ name: "model_form_item", labelWidth: 100, baseColProps: { span: 24 }, schemas: Wl, showActionButtonGroup: false, autoSubmitOnEnter: true }), r2 = n(), [s2, { setModalProps: c2, closeModal: p2 }] = qe(async (e3) => {
    o2().then(), c2({ confirmLoading: false, width: "600px" }), a2.value = !!e3?.isUpdate, d(a2) && (r2.value = e3.index, u2({ ...e3.param }).then());
  }), m2 = bl(), f2 = _(() => d(a2) ? "编辑参数" : "新增参数"), { createMessage: v2 } = ce();
  ...
  const a2 = e2, t2 = l2, o2 = G.Option, i2 = de().getThemeColor, { prefixCls: m2 } = se("filter-variable"), [f2, { openModal: v2 }] = ke(), g2 = bl(), M2 = n();
  u(() => a2.value, (e3) => {
    M2.value = e3;
  }, { immediate: true });
  ...
  return u(() => a2.valueType, (e3) => {
    e3 && (g2.value = e3);
  }, { immediate: true }), (l3, a3) => (s(), y("div", { class: h(d(v2)) }, [b(d(i2), { size: "small", value: g2.value, "onUpdate:value": a3[0] || (a3[0] = (e3) => g2.value = e3), "button-style": "solid", onChange: k2, disabled: e2.queryMode }, { default: c(() => [b(d(m2), { value: "0" }, { default: c(() => [...a3[1] || (a3[1] = [Q("常量", -1)])]), _: 1 }), b(d(m2), { value: "1" }, { default: c(() => [...a3[2] || (a3[2] = [Q("变量", -1)])]), _: 1 }), b(d(m2), { value: "2" }, { default: c(() => [...a3[3] || (a3[3] = [Q("字段", -1)])]), _: 1 })]), _: 1 }, 8, ["value", "disabled"]), "0" === g2.value ? (s(), r(d(f2), { key: 0 }, { default: c(() => ["NUMBER" === e2.fieldType ? (s(), r(d(E), w({ key: 0 }, l3.$attrs, { disabled: e2.queryMode }), null, 16, ["disabled"])) : "DATE" === e2.fieldType && "between" !== e2.operator ? (s(), r(d(X), w({ key: 1, disabled: e2.queryMode }, l3.$attrs, { "show-time": true, "value-format": "YYYY-MM-DD HH:mm:ss" }), null, 16, ["disabled"])) : "DATE" === e2.fieldType && "between" === e2.operator ? (s(), r(d(Z), w({ key: 2, disabled: e2.queryMode }, l3.$attrs, { "show-time": true, placeholder: ["开始时间", "结束时间"], "value-format": "YYYY-MM-DD HH:mm:ss" }), null, 16, ["disabled"])) : (s(), r(d(o2), w({ key: 3 }, l3.$attrs, { disabled: e2.queryMode }), null, 16, ["disabled"]))]), _: 1 })) : p("", true), "1" === g2.value ? (s(), r(d(f2), { key: 1 }, { default: c(() => [b(Zl, { "query-mode": e2.queryMode, value: l3.$attrs.value, onVariableChange: C2 }, null, 8, ["query-mode", "value"])]), _: 1 })) : p("", true), "2" === g2.value ? (s(), r(d(f2), { key: 2 }, { default: c(() => [b(ea, { "query-mode": e2.queryMode, "table-fields": e2.tableFields, value: l3.$attrs.value, onChange: M2 }, null, 8, ["query-mode", "table-fields", "value"])]), _: 1 })) : p("", true)], 2));
  ...
  const a2 = l2, t2 = Y.Item, o2 = v({ field: void 0, operator: "", value: void 0 }), u2 = n(), i2 = n([]), m2 = v({ field: { dataType: "STRING" }, type: "1", valueType: "0", required: true }), f2 = n([]), g2 = n(true), y2 = n(), h2 = { STRING: [{ label: "是", value: "eq" }, { label: "不是", value: "ne" }, { label: "包含", value: "like" }, { label: "不包含", value: "notLike" }, { label: "以开始", value: "likeLeft" }, { label: "以结束", value: "likeRight" }, { label: "为空", value: "isNull" }, { label: "不为空", value: "isNotNull" }], NUMBER: [{ label: "等于", value: "eq" }, { label: "不等于", value: "ne" }, { label: "大于", value: "gt" }, { label: "大于等于", value: "ge" }, { label: "小于", value: "lt" }, { label: "小于等于", value: "le" }, { label: "包含", value: "like" }, { label: "不包含", value: "notLike" }, { label: "以开始", value: "likeLeft" }, { label: "以结束", value: "likeRight" }, { label: "为空", value: "isNull" }, { label: "不为空", value: "isNotNull" }], DATE: [{ label: "晚于", value: "gt" }, { label: "晚于等于", value: "ge" }, { label: "早于", value: "lt" }, { label: "早于等于", value: "le" }, { label: "为空", value: "isNull" }, { label: "不为空", value: "isNotNull" }] }, [q2, { setModalProps: k2, closeModal: C2 }] = qe(async (e3) => {
    if (k2({ confirmLoading: false, width: "600px" }), Pl(void 0, e3.sqlQuery).then((e4) => {
      i2.value = e4;
    }), e3.isUpdate) return m2.field = e3.field, m2.valueType = e3.valueType, m2.required = e3.required, _2(m2.field?.dataType), y2.value = e3.index, o2.field = [e3.field.tableAlias, e3.field.colName], o2.operator = e3.operator, e3.operator === vl.between ? o2.value = e3.value ? e3.value.split(",") : [] : o2.value = e3.value ?? "", e3.operator === vl.isNull || e3.operator === vl.isNotNull ? (g2.value = false, o2.value = "") : g2.value = true, void ("2" === e3.valueType && e3.value && (o2.value = JSON.parse(e3.value)));
  ...
  const a2 = e2, t2 = l2, o2 = n([]), i2 = _(() => void 0 === a2.sqlQuery?.filters && Ql(a2.sqlQuery, a2.level) && !a2.queryMode);
  ...
  return u(() => a2.sqlQuery?.aggregates, (e3) => {
    ...
    f2.value = e3 ? [...e3] : [];
  }, { immediate: true }), (l3, a3) => (s(), y("div", { class: h(d(i2)) }, [void 0 !== e2.sqlQuery?.aggregates ? (s(), r(jl, { key: 0, "query-mode": e2.queryMode, iconfont: "icon-mfish-sum", title: "聚合", onDeleteConfig: M2, onExecute: A2, full: true }, { config: c(() => [b(d(he), { "query-mode": e2.queryMode, items: m2.value, "add-title": "添加聚合指标", onAddBlock: _2, onEditBlock: S2, onDragChange: T2 }, null, 8, ["query-mode", "items"]), b(d(ve), { class: "groupIcon", icon: "ant-design:group-outlined", color: d(o2), style: { "font-size": "14px" } }, null, 8, ["color"]), a3[0] || (a3[0] = q("div", { class: "group" }, "分组", -1)), b(d(he), { "query-mode": e2.queryMode, items: f2.value, "add-title": "添加分组指标", onAddBlock: N2, onEditBlock: F2, onDragChange: x2 }, null, 8, ["query-mode", "items"])]), _: 1 }, 8, ["query-mode"])) : p("", true), b(oa, { "query-mode": e2.queryMode, onRegister: d(v2), onSubmit: Q2 }, null, 8, ["query-mode", "onRegister"]), b(na, { "query-mode": e2.queryMode, onRegister: d(k2), onSubmit: w2 }, null, 8, ["query-mode", "onRegister"])], 2));
  ...
  const a2 = l2, t2 = Y.Item, o2 = v({ field: void 0 }), u2 = v({ field: { dataType: "STRING" }, order: "ASC" }), i2 = n(), p2 = n([]), m2 = n(), f2 = bl(), [g2, { setModalProps: y2, closeModal: h2 }] = qe(async (e3) => {
    if (y2({ confirmLoading: false, width: "600px" }), _l(e3.sqlQuery) ? sl({ sourceId: f2.getSourceId, sourceType: f2.getSourceType, sqlQuery: e3.sqlQuery }).then((e4) => {
...
} }), ca = ["onClick"], pa = { key: 1, class: "fw-bold" }, ma = ["onClick"], fa = Rl(o({ __name: "FormulaManagement", props: { isShow: { type: Boolean, default: false }, curKey: { type: String, default: "" } }, emits: ["select"], setup(e2, { emit: l2 }) {
  ...
  }), (e3, l3) => (s(), r(d(Qe), { "default-size": x2.value, min: 0.1, max: 0.5, class: h(d(f2)) }, { 1: c(() => [b(d(_e), { title: "", toolbar: "", search: "", ref_key: "asyncTreeRef", ref: v2, "tree-wrapper-class-name": "h-[calc(100%-35px)] overflow-auto", "selected-keys": M2.value, "onUpdate:selectedKeys": l3[0] || (l3[0] = (e4) => M2.value = e4), "tree-data": R2.value || [], onSelect: j2 }, null, 8, ["selected-keys", "tree-data"])]), 2: c(() => [q("div", { class: h(`${d(f2)}-right h-full pt-2`) }, [b(d(le), { separator: ">", class: "breadcrumb" }, { default: c(() => [(s(true), y(S, null, T(I2.value, (e4, l4) => (s(), r(d(o2), { key: l4 }, { default: c(() => [b(d(ve), { icon: e4.icon }, null, 8, ["icon"]), l4 < I2.value.length - 1 ? (s(), y("a", { key: 0, onClick: (l5) => B2(e4.key) }, C(e4.title), 9, ca)) : (s(), y("span", pa, C(e4.title), 1))]), _: 2 }, 1024))), 128))]), _: 1 }), F2.value && "" === F2.value.parentId ? (s(), r(d(ye), { key: 0 }, { default: c(() => [b(d(te), { class: "ml-6" }, { default: c(() => [(s(true), y(S, null, T(D2.value, (e4, l4) => (s(), r(d(oe), { span: 22, key: l4, class: h(`${d(f2)}-card`) }, { default: c(() => [q("div", { class: h(`${d(f2)}-card-item`), onClick: (l5) => B2(e4.key) }, [q("div", { class: h(`${d(f2)}-card-item-info`) }, [b(d(U), { title: e4.formulaInfo?.cnName }, { default: c(() => [q("span", { style: k(`color: ${d(g2)};font-weight: bold`) }, [b(d(ve), { icon: "ant-design:function-outlined", color: d(g2) }, null, 8, ["color"]), Q(" " + C(e4.formulaInfo?.cnName) + " (" + C(e4.formulaInfo?.enName) + ") ", 1)], 4)]), _: 2 }, 1032, ["title"]), b(d(U), { title: e4.formulaInfo?.description }, { default: c(() => [q("span", null, C(e4.formulaInfo?.description), 1)]), _: 2 }, 1032, ["title"])], 2)], 10, ma)]), _: 2 }, 1032, ["class"]))), 128))]), _: 1 })]), _: 1 })) : p("", true), F2.value && F2.value.formulaInfo ? (s(), r(d(ye), { key: 1 }, { default: c(() => [b(d(ae), { class: "pt-3 pr-2", column: 1, bordered: true }, { default: c(() => [b(d(i2), { label: "描述" }, { default: c(() => [Q(C($2.value?.description), 1)]), _: 1 }), b(d(i2), { label: "参数" }, { default: c(() => [(s(true), y(S, null, T($2.value?.paramDesc, (e4, l4) => (s(), y("div", { key: l4 }, C(e4), 1))), 128))]), _: 1 }), b(d(i2), { label: "结果" }, { default: c(() => [Q(C($2.value?.returnDesc), 1)]), _: 1 })]), _: 1 })]), _: 1 })) : p("", true)], 2)]), _: 1 }, 8, ["default-size", "class"]));
} }), [["__scopeId", "data-v-dd8b4001"]]), va = { key: 0, class: "content" }, ga = { key: 1, class: "content placeholder" }, ya = Rl(o({ __name: "FormulaSelect", props: { formulaKey: { type: String, default: "" }, queryMode: { type: Boolean, default: false } }, emits: ["formulaChange"], setup(e2, { emit: l2 }) {
  const a2 = e2, t2 = l2, o2 = _(() => de().getDarkMode.value === Se.DARK), { prefixCls: i2 } = se("select-formula"), p2 = n(false);
  let m2;
  ...
  }, { immediate: true }), (l3, a3) => (s(), r(d(H), { disabled: e2.queryMode, trigger: ["click"], open: p2.value, onOpenChange: k2, placement: "bottom", arrow: { pointAtCenter: true }, "overlay-style": { width: "500px" } }, { overlay: c(() => [b(d(K), null, { default: c(() => [b(d(K).Item, { style: { padding: "0", cursor: "default", background: "transparent" } }, { default: c(() => [b(fa, { style: { height: "350px" }, "is-show": p2.value, "cur-key": g2.value?.key, onSelect: T2 }, null, 8, ["is-show", "cur-key"]), q("div", { class: h(`${d(i2)}-ok-button`) }, [b(d(L), { class: "mr-2", onClick: M2 }, { default: c(() => [...a3[0] || (a3[0] = [Q("清空", -1)])]), _: 1 }), b(d(L), { type: "primary", onClick: S2 }, { default: c(() => [...a3[1] || (a3[1] = [Q("确定", -1)])]), _: 1 })], 2)]), _: 1 })]), _: 1 })]), default: c(() => [b(d(L), { class: h(`${d(i2)}-drop-button`) }, { default: c(() => [g2.value?.cnName ? (s(), y("span", va, C(g2.value?.cnName), 1)) : (s(), y("span", ga, "选择公式")), b(d(ve), { size: 12, icon: p2.value ? "ant-design:up-outlined" : "ant-design:down-outlined", color: o2.value ? "rgba(255, 255, 255, 0.25)" : "rgba(0, 0, 0, 0.25)" }, null, 8, ["icon", "color"])]), _: 1 }, 8, ["class"])]), _: 1 }, 8, ["disabled", "open"]));
} }), [["__scopeId", "data-v-ce63b9b8"]]), ha = "displayName", ba = { config: { type: Object, default: () => ({ type: yl.param, value: "" }) }, comType: { type: String, default: "string" }, paramType: { type: String, default: "string" }, paramValue: { type: String, default: "" }, showRadio: { type: Boolean, default: true }, sqlQuery: { type: Object }, index: { type: Number, default: 0 }, queryMode: { type: Boolean, default: false } }, qa = (e2) => {
...
}, ka = Rl(o({ __name: "FormulaCompact", props: ba, emits: ["typeChange", "formulaSelect", "inputChange"], setup(e2, { emit: l2 }) {
  const a2 = e2, t2 = l2, { prefixCls: o2 } = se("formula-compact"), i2 = W.Group, m2 = W.Button, f2 = n("string"), v2 = n("string"), g2 = n(), k2 = n(yl.param), C2 = n(), M2 = n([]), _2 = n(), Q2 = n(false), S2 = n([]), T2 = n();
  function N2(e3) {
    t2("formulaSelect", e3 || "");
  }
  function w2() {
  ...
  function F2(e3) {
    e3.tableAlias && e3.colName && (_2.value = e3, t2("inputChange", { ...e3, [ha]: "colName" }));
  }
  function x2(e3, l3) {
  ...
  return (e3, l3) => (s(), r(d(H), { trigger: ["click"], open: u2.value, placement: "bottom", arrow: { pointAtCenter: true }, onOpenChange: m2 }, { overlay: c(() => [b(d(K), null, { default: c(() => [b(d(K).Item, { disabled: "", style: { padding: "0", cursor: "default" } }, { default: c(() => [b(d(ne), { title: "上层公式设置", bordered: false, style: { width: "240px" } }, { default: c(() => [b(ya, { onFormulaChange: f2 }), b(d(G), { style: { width: "100%", "margin-top": "6px" }, placeholder: "选择作为哪个参数", class: "select-com", value: o2.value, "onUpdate:value": l3[0] || (l3[0] = (e4) => o2.value = e4), options: t2.value }, null, 8, ["value", "options"]), q("div", Ca, [b(d(L), { size: "small", onClick: v2 }, { default: c(() => [...l3[1] || (l3[1] = [Q(" 取消", -1)])]), _: 1 }), b(d(L), { size: "small", type: "primary", style: { "margin-left": "6px" }, onClick: g2 }, { default: c(() => [...l3[2] || (l3[2] = [Q(" 确定", -1)])]), _: 1 })])]), _: 1 })]), _: 1 })]), _: 1 })]), default: c(() => [b(d(L), { style: { "margin-top": "-6px" }, size: "small", type: "link" }, { icon: c(() => [b(d(U), { placement: "left", title: "添加外层公式，当前层作为公式参数" }, { default: c(() => [b(d(ve), { icon: "ant-design:node-collapse-outlined" })]), _: 1 })]), _: 1 })]), _: 1 }, 8, ["open"]));
} }), _a = { class: "formula" }, Qa = { class: "title" }, Sa = { key: 0, class: "add" }, Ta = Rl(o({ __name: "FormulaConfig", props: ba, emits: ["formulaChange"], setup(e2, { emit: l2 }) {
  const a2 = e2, t2 = l2, o2 = n(), i2 = n(), { prefixCls: m2 } = se("formula-config"), f2 = bl(), k2 = n(), M2 = v({ type: yl.param, value: "" }), _2 = n(0), N2 = (e3) => e3.startsWith("list"), w2 = (e3) => k2?.value?.value?.param && Array.isArray(k2?.value.value.param[e3].value) ? k2?.value.value.param[e3].value : [0];
  function F2(e3) {
  ...
  function A2(e3) {
    x2(e3), k2.value = qa(e3), _2.value++, t2("formulaChange", k2.value);
  }
  function R2(e3) {
  ...
  return u(() => a2.config, (e3) => {
    ...
    return s(), y("div", { class: h(d(m2)) }, [q("div", _a, [b(ka, { "query-mode": a2.queryMode, class: "main", index: a2.index, "com-type": a2.comType, "param-type": a2.paramType, "param-value": a2.paramValue, config: k2.value, "sql-query": a2.sqlQuery, "show-radio": a2.showRadio, onInputChange: F2, onFormulaSelect: A2, onTypeChange: R2 }, null, 8, ["query-mode", "index", "com-type", "param-type", "param-value", "config", "sql-query", "show-radio"]), k2.value?.type !== d(yl).formula || a2.queryMode ? p("", true) : (s(), r(Ma, { key: 0, onSubmit: I2 }))]), (s(true), y(S, null, T(o2.value, (e4, o3) => (s(), y("div", { key: `${_2.value}${o3}` }, [(s(true), y(S, null, T(w2(o3), (l4, u2) => (s(), y("div", { class: "param", key: u2 }, [b(d(ve), { class: "icon", icon: "ant-design:arrow-up-outlined" }), q("span", Qa, [b(d(U), { placement: "left", title: i2.value ? i2.value[o3] : "" }, { default: c(() => [Q(C(e4.name), 1)]), _: 2 }, 1032, ["title"])]), b(n2, { "query-mode": a2.queryMode, index: u2, "com-type": e4.comType, "param-type": e4.paramType, "param-value": e4.value, config: N2(e4.paramType) && k2.value?.value?.param && k2.value?.value?.param[o3]?.value ? k2.value?.value?.param[o3]?.value[u2] : k2.value?.value?.param[o3], "sql-query": a2.sqlQuery, onFormulaChange: (l5) => (function(e5, l6, a3, o4) {
      ...
      k2.value?.type === yl.formula && k2.value.value && k2.value.value.param && (k2.value.value.param[e6].value.splice(l5, 1), _2.value++, t2("formulaChange", k2.value));
    })(o3, u2) }, { icon: c(() => [b(d(ve), { icon: "ant-design:delete-outlined" })]), _: 1 }, 8, ["onClick"])) : p("", true)]))), 128)), N2(e4.paramType) ? (s(), y("div", Sa, [b(d(L), { type: "primary", onClick: (e5) => (function(e6) {
...
} }), [["__scopeId", "data-v-cbde54bb"]]), Na = o({ __name: "ParamsModal", emits: ["register", "submit"], setup(e2, { emit: l2 }) {
  const a2 = l2, [t2, { resetFields: o2, setFieldsValue: u2, validate: i2, resetSchema: p2, getFieldsValue: m2 }] = Me({ name: "model_form_item", labelWidth: 180, baseColProps: { span: 24 }, showActionButtonGroup: false, autoSubmitOnEnter: true }), f2 = bl(), v2 = n(), [g2, { setModalProps: y2, closeModal: h2 }] = qe(async (e3) => {
...
} }), wa = o({ __name: "FormulaTest", props: { open: { type: Boolean, default: false }, curQuery: { type: Object }, curParams: { type: Object } }, emits: ["close"], setup(e2, { emit: l2 }) {
  ...
  return (e3, l3) => (s(), r(d(ue), { title: "测试结果", placement: "bottom", open: m2.value, onClose: M2, height: 450 }, { default: c(() => [b(d(j), { onRegister: d(v2) }, { bodyCell: c(({ column: e4, record: l4 }) => [e4?.key === d(kl) ? (s(), y("div", { key: 0, style: k({ color: d(o2) }) }, C(l4[d(kl)]), 5)) : p("", true)]), _: 1 }, 8, ["onRegister"])]), _: 1 }, 8, ["open"]));
} }), Fa = o({ __name: "FormulaColModal", props: { queryMode: { type: Boolean, default: false } }, emits: ["submit", "register"], setup(e2, { emit: l2 }) {
  const a2 = l2, t2 = n(), o2 = n(), u2 = n(), i2 = v({ type: yl.formula, value: null });
  let m2;
  const f2 = n(0), g2 = bl(), [h2, { openModal: q2 }] = ke(), k2 = n(), C2 = n(), M2 = n(false), _2 = (e3) => {
    let l3 = "";
    return Array.isArray(e3.value) ? (e3.value.forEach((e4) => {
      ...
      l3 += `${_2(e4)},`;
    }), l3.endsWith(",") && (l3 = l3.slice(0, Math.max(0, l3.lastIndexOf(",")))), l3 += ")", l3) : (e3.type === yl.param && (l3 += e3.value instanceof Object ? e3.value[e3.value[ha]] : e3.value), l3);
  ...
  return (l3, t3) => {
    ...
    })(e4, l4) }, { icon: c(() => [b(d(ge), { icon: l4.icon }, null, 8, ["icon"])]), _: 2 }, 1032, ["color", "onClick", "onDragstart"])]), _: 2 }, 1032, ["title"]))), 128))]), key: "0" }]), 1032, ["query-mode", "items"])]), _: 1 }, 8, ["onRegister"]), b(da, { onRegister: d(F2), onSubmit: G2 }, null, 8, ["onRegister"]), b(Fa, { "query-mode": e2.queryMode, onRegister: d(A2), onSubmit: W2 }, null, 8, ["query-mode", "onRegister"]), b(wa, { "cur-query": z2.value, "cur-params": E2.value, open: V2.value, onClose: t3[0] || (t3[0] = () => V2.value = false) }, null, 8, ["cur-query", "cur-params", "open"])]), _: 1 }, 16, ["onRegister"]), b(Na, { onRegister: d(D2), onSubmit: X2 }, null, 8, ["onRegister"])], 64);
  };
} }), [["__scopeId", "data-v-ffce7698"]]), Aa = o({ __name: "TableCustomCol", props: { sqlQuery: { type: Object }, level: { type: Number, default: 1 }, configMitt: { type: Object }, queryMode: { type: Boolean, default: false } }, emits: ["customColChange"], setup(e2, { emit: l2 }) {
  const a2 = e2, t2 = l2, o2 = n([]);
  function i2() {
    t2("customColChange");
  }
  const [m2, { openModal: f2 }] = ke(), v2 = _(() => void 0 === a2.sqlQuery?.customColumns && Ql(a2.sqlQuery, a2.level) && !a2.queryMode);
  function g2() {
  ...
  return u(() => a2.sqlQuery?.customColumns, (e3) => {
    o2.value = e3 ? [...e3] : [];
  }, { immediate: true }), (l3, a3) => (s(), y("div", null, [void 0 !== e2.sqlQuery?.customColumns ? (s(), r(jl, { key: 0, "query-mode": e2.queryMode, icon: "ant-design:insert-row-right-outlined", title: "自定义列", onDeleteConfig: i2, onExecute: C2, full: true }, { config: c(() => [b(d(he), { "query-mode": e2.queryMode, items: o2.value, "add-title": "添加自定义列", onAddBlock: g2, onEditBlock: h2, onDragChange: q2 }, null, 8, ["query-mode", "items"])]), _: 1 }, 8, ["query-mode"])) : p("", true), v2.value ? (s(), r(Ul, { key: 1, class: "config-button", title: "自定义列", icon: "ant-design:insert-row-right-outlined", level: 0, onClick: F(k2, ["prevent"]) })) : p("", true), b(xa, { "query-mode": e2.queryMode, onRegister: d(m2), "sql-query": e2.sqlQuery, onSubmit: M2 }, null, 8, ["query-mode", "onRegister", "sql-query"])]));
} }), Ra = { class: "btn-bar" }, Ia = Rl(o({ __name: "ApiConfig", props: { configKey: { type: Number, default: 0, require: true }, sqlQuery: { type: Object, require: true, default: void 0 }, level: { type: Number, default: 1 }, configMitt: { type: Object, default: void 0 }, queryMode: { type: Boolean, default: false } }, emits: ["configChange"], setup(e2, { emit: l2 }) {
  const a2 = e2, t2 = l2, { sqlQuery: o2 } = I(a2), { prefixCls: u2 } = se("api-config"), i2 = de().getThemeColor, c2 = n(), m2 = n(), { focused: f2 } = Ne(c2), { focused: v2 } = Ne(m2), C2 = bl(), M2 = n(false), Q2 = _(() => {
    if (0 !== C2.getSourceType || a2.queryMode) return false;
    if (a2.sqlQuery && a2.sqlQuery?.joins) {
      for (const e3 of a2.sqlQuery.joins) if (!El(e3)) return false;
    }
    return true;
  }), S2 = _(() => (void 0 === a2.sqlQuery?.filters || Ql(a2.sqlQuery, a2.level)) && !a2.queryMode), T2 = _(() => (void 0 === a2.sqlQuery?.customColumns || Ql(a2.sqlQuery, a2.level)) && !a2.queryMode), N2 = _(() => (void 0 === a2.sqlQuery?.aggregates || Ql(a2.sqlQuery, a2.level)) && !a2.queryMode), w2 = _(() => void 0 === a2.sqlQuery?.orders && !a2.queryMode), F2 = _(() => void 0 === a2.sqlQuery?.limit && !a2.queryMode);
  function x2(e3) {
  ...
  async function V2() {
    ...
    return e3.fields = await Ml(e3), e3;
  }
  async function U2() {
