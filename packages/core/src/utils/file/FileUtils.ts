...
import { RequestOptions } from "@mfish/types/src/type/axios";
 ...
 * @param option 请求参数
 */
export const imageSrc = async (url: string, option?: RequestOptions) => {
 ...
 * @param url
 */
export const imageBase64 = async (url: string) => {
 ...
 * @param level
 */
export function calcSize(fileSize: number, level: number) {
